...
/**
 * One saved arrangement of dashboard cards, per user, per store, per surface.
 *
 ...
 */
class LayoutPreference extends Model
{
    use HasTenant;

    protected $table = 'layout_preferences';
    ...
    /** The surface key used for the main workspace dashboard. */
