...
class MigrateV3Ledger extends Command
{
    ...
    private function migratePartyOpeningBalances()
    {
        ...
        $obeAccount = DB::table('accounts')->where('code', '7000')->first();
    ...
    private function migrateLegacyPurchases()
    {
        ...
        $inventoryAccount = DB::table('accounts')->where('code', '1100')->first();
        $apAccount = DB::table('accounts')->where('code', '2000')->first();
        $cashAccount = DB::table('accounts')->where('code', '1000')->first();
    ...
    private function migrateLegacySales()
    {
        ...
        $cashAccount = DB::table('accounts')->where('code', '1000')->first();
        $arAccount = DB::table('accounts')->where('code', '1200')->first();
        $revenueAccount = DB::table('accounts')->where('code', '4000')->first();
    ...
    private function migrateLegacyExpenses()
    {
        ...
        $expenseAccount = DB::table('accounts')->where('code', '6000')->first();
        $cashAccount = DB::table('accounts')->where('code', '1000')->first();
