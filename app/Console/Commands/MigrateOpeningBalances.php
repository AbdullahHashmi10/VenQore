...
class MigrateOpeningBalances extends Command
{
    ...
    public function handle(): int
    {
        ...
        $arAccount = DB::table('accounts')->where('code', '1200')->first(); // Accounts Receivable
        $apAccount = DB::table('accounts')->where('code', '2000')->first(); // Accounts Payable
        $obEquity  = DB::table('accounts')->where('code', '7000')->first(); // Opening Balance Equity
