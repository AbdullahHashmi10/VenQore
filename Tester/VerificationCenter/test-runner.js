/**
 * VenQore Test Runner — Verification Center Edition
 * Streams Pest output live to the dashboard via WebSocket.
 * Covers the full VerificationCenter registry (Feature + Golden + Production + V3/Scenarios + Performance + Unit).
 * Port 7823 (7821 = Tester/dashboard, 7822 = Tester/Golden/dashboard).
 */
