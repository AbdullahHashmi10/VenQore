...
class RouteParameterRegressionTest extends TestCase
{
    ...
    public function test_route_parameter_names_match_frontend_expectations(): void
    {
        $expectedRoutes = [
            ...
            // store.backups.delete, store.backups.download, and store.backups.email were removed
            // in the BL-01 remediation (unscoped file delete/download by filename).
            // Do not restore them — the encrypted, tenant-scoped export replaced them.
