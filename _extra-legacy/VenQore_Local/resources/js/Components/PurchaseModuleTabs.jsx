...
export default function PurchaseModuleTabs({ activeTab }) {
    ...
    return (
        <div className="flex flex-col lg:flex-row items-center gap-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-2 rounded-2xl shadow-sm">
            ...
            <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide flex-1 mask-linear-fade">
            ...
            <div className="shrink-0 self-stretch flex items-center">
                ...
                >
                    ...
                    <span className="hidden sm:inline relative z-10">New Purchase</span>
                </Link>
            </div>
        </div>
    );
