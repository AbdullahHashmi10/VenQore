@echo off
title VenQore Verification Center
color 0a
...
:: Kill any previous instance on port 7823
for /f "tokens=5" %%a in ('netstat -aon 2^>nul ^| find ":7823"') do (
...
echo  [SUCCESS] VenQore Verification Center is running.
echo  [SUCCESS] Dashboard opened in your browser at http://localhost:7823.
echo.
