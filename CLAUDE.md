...
| Dashboard frame geometry | `config/dashboard_frames.php` | Slots and spans only; never reading keys or business names. |
| Dashboard fill priorities | `config/dashboard_pool.php` | Reading priorities only; never geometry. |
