...
import { r as resolvePageComponent } from "./assets/vendor-core-4m-Uvb-d.js";
import React, { createContext, useState, useRef, useEffect, useCallback, Fragment, useContext } from "react";
import axios from "axios";
import { M as Modal, T as ThemeProvider, W as WorkspaceProvider } from "./assets/marketing-pages-CTBAvetE.js";
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col overflow-hidden relative z-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto p-6 space-y-4 custom-scrollbar", children: [
        messages.length === 0 && /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-full text-center p-6 space-y-2 opacity-60", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-2xs text-slate-400 max-w-[200px]", children: "Send a message and our support team will reply instantly." })
        ] }),
        messages.map((m2, i2) => {
          ...
          return /* @__PURE__ */ jsx("div", { className: `flex ${isVisitor ? "justify-end" : "justify-start"} animate-in fade-in slide-in-from-bottom-1 duration-150`, children: /* @__PURE__ */ jsxs("div", { className: `max-w-[75%] rounded-2xl px-4 py-3 text-xs shadow-sm ${isVisitor ? "bg-indigo-600 text-white rounded-tr-none font-medium" : isBot ? "bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-100 rounded-tl-none leading-relaxed" : "bg-indigo-50 dark:bg-indigo-950/20 text-indigo-950 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-900 rounded-tl-none leading-relaxed"}`, children: [
            /* @__PURE__ */ jsx("div", { className: "text-3xs font-black uppercase tracking-wider mb-1 opacity-70", children: isVisitor ? "You" : "Support" }),
            /* @__PURE__ */ jsx("p", { className: "whitespace-pre-line leading-relaxed", children: renderMessageBody(m2.body) })
          ] }) }, i2);
        }),
        typing && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-2xs text-slate-400 font-medium py-1.5 animate-pulse", children: [
  ...
  const renderHeader = (closeFn) => /* @__PURE__ */ jsxs("div", { className: "px-5 py-4 bg-slate-900 text-white shrink-0 relative flex items-center justify-between border-b border-slate-800/80", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 relative z-10", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-2xs text-indigo-300 font-bold uppercase tracking-wider mt-0.5", children: "Online" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 relative z-10", children: [
      started && (confirmNewChat ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsx("span", { className: "text-2xs text-slate-400 font-medium mr-1", children: "Start over?" }),
        /* @__PURE__ */ jsx(
          "button",
          {
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.jsx`,
      /* @__PURE__ */ Object.assign({ "./Pages/Accounting/BalanceSheet.jsx": () => import("./assets/BalanceSheet-D6tfH4UQ.js"), "./Pages/Accounting/ChartOfAccounts.jsx": () => import("./assets/ChartOfAccounts-CAbfOPjf.js"), "./Pages/Accounting/Dashboard.jsx": () => import("./assets/Dashboard-TAYasDUf.js"), "./Pages/Accounting/ProfitLoss.jsx": () => import("./assets/ProfitLoss-CZdAC-Uo.js"), "./Pages/ActivityLog.jsx": () => import("./assets/ActivityLog-INsGmwYq.js"), "./Pages/Admin/AgentInbox.jsx": () => import("./assets/AgentInbox-BTwwz_aR.js"), "./Pages/Admin/Backups.jsx": () => import("./assets/Backups-DUTJUGZb.js"), "./Pages/Admin/Dashboard.jsx": () => import("./assets/Dashboard-C-A2d3S_.js"), "./Pages/Admin/DataManagement.jsx": () => import("./assets/DataManagement-DYKz6Zah.js"), "./Pages/Admin/DataMapping.jsx": () => import("./assets/DataMapping-Bq_TLCXb.js"), "./Pages/Admin/Database.jsx": () => import("./assets/Database-DrmUwAII.js"), "./Pages/Admin/ExecutiveDashboard.jsx": () => import("./assets/ExecutiveDashboard-C_cXzXcv.js"), "./Pages/Admin/Logs.jsx": () => import("./assets/Logs-CvSCupqx.js"), "./Pages/Admin/Migration.jsx": () => import("./assets/Migration-Di2Z-3-1.js"), "./Pages/Admin/Settings.jsx": () => import("./assets/Settings-DltF7A5v.js"), "./Pages/Admin/Users.jsx": () => import("./assets/Users-D6rrwBhV.js"), "./Pages/Admin/VenaTicketDetail.jsx": () => import("./assets/VenaTicketDetail-wfxqM145.js"), "./Pages/Admin/VenaTickets.jsx": () => import("./assets/VenaTickets-B8PUoLnq.js"), "./Pages/Auth/AcceptInvite.jsx": () => import("./assets/AcceptInvite-Bo5_91Ea.js"), "./Pages/Auth/ConfirmPassword.jsx": () => import("./assets/ConfirmPassword-BJbasMJD.js"), "./Pages/Auth/ForgotPassword.jsx": () => import("./assets/ForgotPassword-Bk4CnT25.js"), "./Pages/Auth/Login.jsx": () => import("./assets/Login-qRkxtjtx.js"), "./Pages/Auth/Register.jsx": () => import("./assets/Register-DOITJBO9.js"), "./Pages/Auth/ResetPassword.jsx": () => import("./assets/ResetPassword-DtSPk9a6.js"), "./Pages/Auth/StaffLogin.jsx": () => import("./assets/StaffLogin-Dy0H3KOE.js"), "./Pages/Auth/TwoFactorSetup.jsx": () => import("./assets/TwoFactorSetup-D9RBIKdw.js"), "./Pages/Auth/TwoFactorVerify.jsx": () => import("./assets/TwoFactorVerify-Z39mLu4M.js"), "./Pages/Auth/VerifyEmail.jsx": () => import("./assets/VerifyEmail-CMGynZOs.js"), "./Pages/BankAccounts/BankAccountsList.jsx": () => import("./assets/BankAccountsList-6M4zZxW2.js"), "./Pages/BankAccounts/Transactions.jsx": () => import("./assets/Transactions-DHhoytFZ.js"), "./Pages/BankReconciliation/BankReconciliation.jsx": () => import("./assets/BankReconciliation-BcnmzGh0.js"), "./Pages/BatchTracking/BatchTracking.jsx": () => import("./assets/BatchTracking-C901XKnn.js"), "./Pages/Billing/Index.jsx": () => import("./assets/Index-kaHb-GYy.js"), "./Pages/Cookbook/Create.jsx": () => import("./assets/Create-CmKv3w3V.js"), "./Pages/Cookbook/RecipesList.jsx": () => import("./assets/RecipesList-CM217g-d.js"), "./Pages/Dashboard.jsx": () => import("./assets/Dashboard-D9WgWpv0.js"), "./Pages/Dashboards/AccountantDashboard.jsx": () => import("./assets/AccountantDashboard-B-RB1-13.js"), "./Pages/Dashboards/CashierDashboard.jsx": () => import("./assets/CashierDashboard-B6wdqt4q.js"), "./Pages/Dashboards/PurchasingDashboard.jsx": () => import("./assets/PurchasingDashboard-BVTNHeJT.js"), "./Pages/Dashboards/ViewerDashboard.jsx": () => import("./assets/ViewerDashboard-BhsUMOIy.js"), "./Pages/DebitNotes/Create.jsx": () => import("./assets/Create-BrF4Jp1E.js"), "./Pages/DebitNotes/DebitNotes.jsx": () => import("./assets/DebitNotes-A1Bub-VD.js"), "./Pages/DebitNotes/Show.jsx": () => import("./assets/Show-CVHYpL0O.js"), "./Pages/Demo/Landing.jsx": () => import("./assets/Landing-BSBJkNf2.js"), "./Pages/DemoExpired.jsx": () => import("./assets/DemoExpired-CqTxVXrq.js"), "./Pages/EInvoicing/EInvoicing.jsx": () => import("./assets/EInvoicing-zViqybRt.js"), "./Pages/Error.jsx": () => import("./assets/Error-DnoH944T.js"), "./Pages/Errors/StoreSuspended.jsx": () => import("./assets/StoreSuspended-WFMSayGn.js"), "./Pages/Errors/TrialExpired.jsx": () => import("./assets/TrialExpired-O0T2MuTy.js"), "./Pages/Expenses/ExpensesList.jsx": () => import("./assets/ExpensesList-DGV0xMBj.js"), "./Pages/Finance/FinanceDashboard.jsx": () => import("./assets/FinanceDashboard-BSSjIONp.js"), "./Pages/Finance/Payables.jsx": () => import("./assets/Payables-CJDVoOXG.js"), "./Pages/Finance/Receivables.jsx": () => import("./assets/Receivables-DTFg84A7.js"), "./Pages/Funds/CashHistory.jsx": () => import("./assets/CashHistory-Bw7j1a9n.js"), "./Pages/Funds/FundManagement.jsx": () => import("./assets/FundManagement-BnQcuZui.js"), "./Pages/Gift/Invalid.jsx": () => import("./assets/Invalid-Cu12xLrJ.js"), "./Pages/Gift/Show.jsx": () => import("./assets/Show-DQGNhM7A.js"), "./Pages/GrowthEngine/GrowthDashboard.jsx": () => import("./assets/GrowthDashboard-8YJtxEzr.js"), "./Pages/GrowthEngine/Settings.jsx": () => import("./assets/Settings-BKLipRPj.js"), "./Pages/Home.jsx": () => import("./assets/Home-en3t73st.js"), "./Pages/Hub/Index.jsx": () => import("./assets/Index-6csMEToE.js"), "./Pages/Installer/Index.jsx": () => import("./assets/Index-BJifZvqv.js"), "./Pages/Inventory/Attributes/AttributesList.jsx": () => import("./assets/AttributesList-CkJIIfnv.js"), "./Pages/Inventory/Categories.jsx": () => import("./assets/Categories-BA7VAvEA.js"), "./Pages/Inventory/Dashboard.jsx": () => import("./assets/Dashboard-CtSo7mLM.js"), "./Pages/Inventory/InventoryList.jsx": () => import("./assets/InventoryList-DUV6GWRn.js"), "./Pages/Inventory/Production/Create.jsx": () => import("./assets/Create-CRTZY6Lm.js"), "./Pages/Inventory/Production/ProductionRuns.jsx": () => import("./assets/ProductionRuns-Abi3L78B.js"), "./Pages/Inventory/Production/Show.jsx": () => import("./assets/Show-DmQFhKEZ.js"), "./Pages/Inventory/StockLevels.jsx": () => import("./assets/StockLevels-DCiURW0m.js"), "./Pages/Inventory/Variants/VariantsList.jsx": () => import("./assets/VariantsList-CHTeSzo8.js"), "./Pages/Invite/Accept.jsx": () => import("./assets/Accept-CBjW8CfK.js"), "./Pages/Invite/Invalid.jsx": () => import("./assets/Invalid-D1As10eU.js"), "./Pages/Labels/LabelPrinter.jsx": () => import("./assets/LabelPrinter-tN6r-YFn.js"), "./Pages/LandingPage.jsx": () => import("./assets/LandingPage-CB5J4ous.js"), "./Pages/Manufacturing/Rules.jsx": () => import("./assets/Rules-Bhn8Hzca.js"), "./Pages/Marketing/About.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.A), "./Pages/Marketing/Blog/Index.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.I), "./Pages/Marketing/Blog/Show.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.S), "./Pages/Marketing/Campaigns.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.C), "./Pages/Marketing/Compare/Index.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.i), "./Pages/Marketing/Compare/Show.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.j), "./Pages/Marketing/Contact.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.k), "./Pages/Marketing/DigitalProducts.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.D), "./Pages/Marketing/Docs/Show.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.l), "./Pages/Marketing/Features.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.n), "./Pages/Marketing/Features/Show.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.q), "./Pages/Marketing/Newsletter.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.N), "./Pages/Marketing/PartnerSupport.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.P), "./Pages/Marketing/Partners.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.s), "./Pages/Marketing/Pricing.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.t), "./Pages/Marketing/Roadmap.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.R), "./Pages/Marketing/Shared/FeatureDemos.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.m), "./Pages/Marketing/Shared/MarketingLayout.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.h), "./Pages/Marketing/SmartCapture.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.w), "./Pages/Marketing/Solutions/Index.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.x), "./Pages/Marketing/Solutions/Show.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.y), "./Pages/Marketing/Tools/Barcode.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.J), "./Pages/Marketing/Tools/BarcodeLabelSheet.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.L), "./Pages/Marketing/Tools/BarcodeValidator.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.Q), "./Pages/Marketing/Tools/CashDrawer.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.U), "./Pages/Marketing/Tools/CashDrawerCountSheet.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.V), "./Pages/Marketing/Tools/CreditNote.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.X), "./Pages/Marketing/Tools/FoodCostCalculator.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.Y), "./Pages/Marketing/Tools/Index.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.Z), "./Pages/Marketing/Tools/InventoryHealth.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2._), "./Pages/Marketing/Tools/Invoice.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.$), "./Pages/Marketing/Tools/LabelSheet.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.a0), "./Pages/Marketing/Tools/LeadConfirm.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.a1), "./Pages/Marketing/Tools/LeadUnsubscribe.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.a2), "./Pages/Marketing/Tools/MarginCalculator.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.a3), "./Pages/Marketing/Tools/PackingSlip.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.a4), "./Pages/Marketing/Tools/PaymentFeeCalculator.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.a5), "./Pages/Marketing/Tools/PosRoiCalculator.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.a6), "./Pages/Marketing/Tools/PriceTag.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.a7), "./Pages/Marketing/Tools/ProductCsvCleaner.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.a8), "./Pages/Marketing/Tools/PurchaseOrder.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.a9), "./Pages/Marketing/Tools/QrCode.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.aa), "./Pages/Marketing/Tools/QrMenu.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.ab), "./Pages/Marketing/Tools/QrMenuPublic.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.ac), "./Pages/Marketing/Tools/Quote.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.ad), "./Pages/Marketing/Tools/Receipt.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.ae), "./Pages/Marketing/Tools/Shared/EditableText.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.K), "./Pages/Marketing/Tools/Shared/EmailGate.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.G), "./Pages/Marketing/Tools/Shared/HousePromo.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.H), "./Pages/Marketing/Tools/Shared/Select.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.E), "./Pages/Marketing/Tools/Shared/ToolShell.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.B), "./Pages/Marketing/Tools/Shared/ToolsSidebar.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.z), "./Pages/Marketing/Tools/SkuGenerator.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.af), "./Pages/Marketing/Tools/StockCountSheet.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.ag), "./Pages/Marketing/VenSynQ.jsx": () => import("./assets/marketing-pages-CTBAvetE.js").then((n2) => n2.ah), "./Pages/Notifications/NotificationCenter.jsx": () => import("./assets/NotificationCenter-DT4y82V0.js"), "./Pages/OnlineStore/OnlineStore.jsx": () => import("./assets/OnlineStore-ClO7ybeR.js"), "./Pages/Parties/Ledger.jsx": () => import("./assets/Ledger-JIoByR9E.js"), "./Pages/Parties/PartiesList.jsx": () => import("./assets/PartiesList-DXSzs2qV.js"), "./Pages/Payments/In.jsx": () => import("./assets/In-BODEYU_8.js"), "./Pages/Payments/Out.jsx": () => import("./assets/Out-DT3pSARz.js"), "./Pages/Payments/PaymentsList.jsx": () => import("./assets/PaymentsList-2KmXCd1_.js"), "./Pages/Payments/Show.jsx": () => import("./assets/Show-cTX9Fd3J.js"), "./Pages/Platform/BlogPosts/Index.jsx": () => import("./assets/Index-BwLiVd69.js"), "./Pages/Platform/Overview.jsx": () => import("./assets/Overview-BS1KHtCa.js"), "./Pages/Platform/Views.jsx": () => import("./assets/Views-CpRkRe2g.js"), "./Pages/PlatformOwner/Login.jsx": () => import("./assets/Login-D9PBdPZt.js"), "./Pages/Pos.jsx": () => import("./assets/Pos-DMJriuzS.js"), "./Pages/PreSales/BestPreSales.jsx": () => import("./assets/BestPreSales-BgMin1MD.js"), "./Pages/PrivacyPolicy.jsx": () => import("./assets/PrivacyPolicy-CERmAUjv.js"), "./Pages/Profile/Edit.jsx": () => import("./assets/Edit-C-qqWZih.js"), "./Pages/Proposals/Create.jsx": () => import("./assets/Create-BhbiyYDZ.js"), "./Pages/Proposals/ProposalsList.jsx": () => import("./assets/ProposalsList-BTQ5FsB_.js"), "./Pages/Proposals/Show.jsx": () => import("./assets/Show-eMQu2cI4.js"), "./Pages/PurchaseOrders/Create.jsx": () => import("./assets/Create-B1COoTG6.js"), "./Pages/PurchaseOrders/PurchaseOrdersList.jsx": () => import("./assets/PurchaseOrdersList-CxfcZy9w.js"), "./Pages/PurchaseOrders/Show.jsx": () => import("./assets/Show-DGLNHke9.js"), "./Pages/Purchases/Create.jsx": () => import("./assets/Create-DQNeUDzX.js"), "./Pages/Purchases/PurchasesList.jsx": () => import("./assets/PurchasesList-DrpafnSM.js"), "./Pages/Purchases/Receive.jsx": () => import("./assets/Receive-C8sszJX-.js"), "./Pages/Purchases/Show.jsx": () => import("./assets/Show-B_NtXC_Q.js"), "./Pages/RecurringInvoices/Create.jsx": () => import("./assets/Create-C3UwmuvU.js"), "./Pages/RecurringInvoices/Edit.jsx": () => import("./assets/Edit-O5mkKd4t.js"), "./Pages/RecurringInvoices/RecurringInvoices.jsx": () => import("./assets/RecurringInvoices-XuWTSEAC.js"), "./Pages/RecycleBin.jsx": () => import("./assets/RecycleBin-BEE16ioL.js"), "./Pages/Redeem.jsx": () => import("./assets/Redeem-CJedJhIw.js"), "./Pages/RedeemSuccess.jsx": () => import("./assets/RedeemSuccess-CKpsP6nD.js"), "./Pages/RefundPolicy.jsx": () => import("./assets/RefundPolicy-CozUlmmP.js"), "./Pages/Reminders/Create.jsx": () => import("./assets/Create-DF73P2il.js"), "./Pages/Reminders/InvoiceReminders.jsx": () => import("./assets/InvoiceReminders-BWHgDIDj.js"), "./Pages/Reports/AccountLedger.jsx": () => import("./assets/AccountLedger-Dw_2np2D.js"), "./Pages/Reports/AllParties.jsx": () => import("./assets/AllParties-DfacYAbV.js"), "./Pages/Reports/BankStatement.jsx": () => import("./assets/BankStatement-CMD-gIah.js"), "./Pages/Reports/BillWiseProfit.jsx": () => import("./assets/BillWiseProfit-BoQCfUzh.js"), "./Pages/Reports/CashFlow.jsx": () => import("./assets/CashFlow-WBXCgYoX.js"), "./Pages/Reports/CategoryProfitability.jsx": () => import("./assets/CategoryProfitability-OlgXplBI.js"), "./Pages/Reports/Components/ReportPage.jsx": () => import("./assets/ReportPage-kXIq83oc.js"), "./Pages/Reports/CustomerInsights.jsx": () => import("./assets/CustomerInsights-CiJhuB7X.js"), "./Pages/Reports/Dashboard.jsx": () => import("./assets/Dashboard-kC2yDRc4.js"), "./Pages/Reports/DayBook.jsx": () => import("./assets/DayBook-D5JV48DP.js"), "./Pages/Reports/DiscountReport.jsx": () => import("./assets/DiscountReport-Dj0TERN0.js"), "./Pages/Reports/ExpenseByCategory.jsx": () => import("./assets/ExpenseByCategory-4BIHSKUD.js"), "./Pages/Reports/ExpenseByItem.jsx": () => import("./assets/ExpenseByItem-C0xAP7Ox.js"), "./Pages/Reports/Expenses.jsx": () => import("./assets/Expenses-BUSiBDpE.js"), "./Pages/Reports/ExpiryReport.jsx": () => import("./assets/ExpiryReport-hKAIKWp6.js"), "./Pages/Reports/GenericReport.jsx": () => import("./assets/GenericReport-DUYIenLN.js"), "./Pages/Reports/GraphAnalytics.jsx": () => import("./assets/GraphAnalytics-BRUMzmqA.js"), "./Pages/Reports/ItemCategoryWiseProfitLoss.jsx": () => import("./assets/ItemCategoryWiseProfitLoss-BoK5i7mS.js"), "./Pages/Reports/ItemDetail.jsx": () => import("./assets/ItemDetail-ByI-5Si-.js"), "./Pages/Reports/ItemReportByParty.jsx": () => import("./assets/ItemReportByParty-C6x4oVnV.js"), "./Pages/Reports/ItemWiseDiscount.jsx": () => import("./assets/ItemWiseDiscount-doVux2C2.js"), "./Pages/Reports/ItemWiseProfit.jsx": () => import("./assets/ItemWiseProfit-qQgMswKi.js"), "./Pages/Reports/LoanStatement.jsx": () => import("./assets/LoanStatement-CMWDcqbW.js"), "./Pages/Reports/LowStock.jsx": () => import("./assets/LowStock-BG289yBt.js"), "./Pages/Reports/MovementHistory.jsx": () => import("./assets/MovementHistory-DvyyEcQv.js"), "./Pages/Reports/OwnersDailyPulse.jsx": () => import("./assets/OwnersDailyPulse-DSpVeyuP.js"), "./Pages/Reports/PartyReportByItem.jsx": () => import("./assets/PartyReportByItem-DsQ7w4ra.js"), "./Pages/Reports/PartyStatement.jsx": () => import("./assets/PartyStatement-B_BoPSIN.js"), "./Pages/Reports/PartyWiseProfitLoss.jsx": () => import("./assets/PartyWiseProfitLoss-Cytn6UgH.js"), "./Pages/Reports/PointInTimeInventory.jsx": () => import("./assets/PointInTimeInventory-vDgvZvrH.js"), "./Pages/Reports/ProfitLoss.jsx": () => import("./assets/ProfitLoss-CTdvuwaj.js"), "./Pages/Reports/Purchases.jsx": () => import("./assets/Purchases-WfLW6leq.js"), "./Pages/Reports/ReportsHub.jsx": () => import("./assets/ReportsHub-CoYg6d_w.js"), "./Pages/Reports/SaleAging.jsx": () => import("./assets/SaleAging-Bv20e1Ww.js"), "./Pages/Reports/SaleOrderItems.jsx": () => import("./assets/SaleOrderItems-CCJeo78S.js"), "./Pages/Reports/SaleOrders.jsx": () => import("./assets/SaleOrders-BONZA7Cs.js"), "./Pages/Reports/SalePurchaseByItemCategory.jsx": () => import("./assets/SalePurchaseByItemCategory-CWhO4-6O.js"), "./Pages/Reports/SalePurchaseByParty.jsx": () => import("./assets/SalePurchaseByParty-Cm_j8q2k.js"), "./Pages/Reports/SalePurchaseByPartyGroup.jsx": () => import("./assets/SalePurchaseByPartyGroup-Bx5-l4fN.js"), "./Pages/Reports/Sales.jsx": () => import("./assets/Sales-Dqjh97BY.js"), "./Pages/Reports/StockAging.jsx": () => import("./assets/StockAging-Pj73LV40.js"), "./Pages/Reports/StockSummaryByCategory.jsx": () => import("./assets/StockSummaryByCategory-DRBXYS8K.js"), "./Pages/Reports/StockValuation.jsx": () => import("./assets/StockValuation-COvQJg9r.js"), "./Pages/Reports/SupplierInsights.jsx": () => import("./assets/SupplierInsights-B_h2BVgp.js"), "./Pages/Reports/Tax.jsx": () => import("./assets/Tax-Bm8ULAVm.js"), "./Pages/Reports/TaxRateReport.jsx": () => import("./assets/TaxRateReport-DnRrurpb.js"), "./Pages/Reports/Transactions.jsx": () => import("./assets/Transactions-CKg8rvWK.js"), "./Pages/Reports/TrialBalance.jsx": () => import("./assets/TrialBalance-CMvHWX7u.js"), "./Pages/Returns/Create.jsx": () => import("./assets/Create-BM2qNaQ8.js"), "./Pages/Returns/ReturnsHistory.jsx": () => import("./assets/ReturnsHistory-Dhaqt1zC.js"), "./Pages/Returns/Show.jsx": () => import("./assets/Show--4A5M-Gn.js"), "./Pages/Sales/Analytics.jsx": () => import("./assets/Analytics-Zj_LoJxs.js"), "./Pages/Sales/CreateInvoice.jsx": () => import("./assets/CreateInvoice-B3-p6IYK.js"), "./Pages/Sales/CreatePreSale.jsx": () => import("./assets/CreatePreSale-DORKk60Z.js"), "./Pages/Sales/Customers/CustomersList.jsx": () => import("./assets/CustomersList-BNtC-pIt.js"), "./Pages/Sales/Dashboard.jsx": () => import("./assets/Dashboard-CIJsou2I.js"), "./Pages/Sales/MasterSales.jsx": () => import("./assets/MasterSales-CzA3Umam.js"), "./Pages/Sales/Orders/SalesOrdersList.jsx": () => import("./assets/SalesOrdersList-d66AjuIK.js"), "./Pages/Sales/ParkedSales.jsx": () => import("./assets/ParkedSales-DcylDgoc.js"), "./Pages/Sales/SalesHistory.jsx": () => import("./assets/SalesHistory-BrXIbPFR.js"), "./Pages/Sales/Show.jsx": () => import("./assets/Show-DUVLsAff.js"), "./Pages/SalesOrders/CreatePreSale.jsx": () => import("./assets/CreatePreSale-DOEjVgZj.js"), "./Pages/SalesOrders/PreSales.jsx": () => import("./assets/PreSales-CiZtbEht.js"), "./Pages/SerialTracking/SerialTracking.jsx": () => import("./assets/SerialTracking-bMKE96gg.js"), "./Pages/SerialTracking/Show.jsx": () => import("./assets/Show-lQCpLAO2.js"), "./Pages/Settings/ChatbotSettings.jsx": () => import("./assets/ChatbotSettings-BZuT7xnC.js"), "./Pages/Settings/SettingsPanel.jsx": () => import("./assets/SettingsPanel-CQBRm6BR.js"), "./Pages/SetupWizard.jsx": () => import("./assets/SetupWizard-DD3erZf2.js"), "./Pages/Staff/Hub.jsx": () => import("./assets/Hub-Cl7ck99y.js"), "./Pages/StaffAttendance/Show.jsx": () => import("./assets/Show-xSoLZ702.js"), "./Pages/StaffAttendance/StaffAttendance.jsx": () => import("./assets/StaffAttendance-D27NWHKo.js"), "./Pages/StockOperations.jsx": () => import("./assets/StockOperations-BJIXZSdI.js"), "./Pages/StockTake/Create.jsx": () => import("./assets/Create-cuZeOkK-.js"), "./Pages/StockTake/Show.jsx": () => import("./assets/Show-BlIxEumD.js"), "./Pages/StockTake/StockTake.jsx": () => import("./assets/StockTake-DsFIr49A.js"), "./Pages/StockTransfers/Create.jsx": () => import("./assets/Create-CKeHgE2a.js"), "./Pages/StockTransfers/Show.jsx": () => import("./assets/Show-PdIGUVWQ.js"), "./Pages/StockTransfers/StockTransfers.jsx": () => import("./assets/StockTransfers-CT0dsrBq.js"), "./Pages/Store/Create.jsx": () => import("./assets/Create-chlPyio7.js"), "./Pages/Store/CreateOrJoin.jsx": () => import("./assets/CreateOrJoin-DDc4ddeE.js"), "./Pages/Store/Join.jsx": () => import("./assets/Join-Cdj3MLVS.js"), "./Pages/Store/SelectPlan.jsx": () => import("./assets/SelectPlan-BBJbDCgg.js"), "./Pages/Store/Staff/Index.jsx": () => import("./assets/Index-B-cETZTL.js"), "./Pages/SuperAdmin/AccessGrants/Index.jsx": () => import("./assets/Index-DSXaN7BJ.js"), "./Pages/SuperAdmin/AppSumo/Index.jsx": () => import("./assets/Index-1UVh5QO1.js"), "./Pages/SuperAdmin/Coupons/Index.jsx": () => import("./assets/Index-3-I8lSxs.js"), "./Pages/SuperAdmin/Dashboard.jsx": () => import("./assets/Dashboard-DFxmjZQN.js"), "./Pages/SuperAdmin/DigitalHub/Index.jsx": () => import("./assets/Index-CdrgMCt5.js"), "./Pages/SuperAdmin/Health/Contacts.jsx": () => import("./assets/Contacts-DHwzkSE9.js"), "./Pages/SuperAdmin/Health/Errors.jsx": () => import("./assets/Errors-C59SGg64.js"), "./Pages/SuperAdmin/NewsletterHub/Index.jsx": () => import("./assets/Index-Ca2bwt0E.js"), "./Pages/SuperAdmin/Plans/Index.jsx": () => import("./assets/Index-BYAcKIdA.js"), "./Pages/SuperAdmin/Platforms/Index.jsx": () => import("./assets/Index-mPc7lfzG.js"), "./Pages/SuperAdmin/Stores.jsx": () => import("./assets/Stores-K_U3jgHu.js"), "./Pages/SuperAdmin/Tenants/OverrideDetail.jsx": () => import("./assets/OverrideDetail-CnF2FeiY.js"), "./Pages/SuperAdmin/Tenants/Overrides.jsx": () => import("./assets/Overrides-Dtf29h-m.js"), "./Pages/SuperAdmin/Users.jsx": () => import("./assets/Users-CCLZRIqW.js"), "./Pages/Suppliers/SuppliersList.jsx": () => import("./assets/SuppliersList-D46S1F6S.js"), "./Pages/TermsOfService.jsx": () => import("./assets/TermsOfService-BmYLHCfw.js"), "./Pages/Transactions/TransactionsList.jsx": () => import("./assets/TransactionsList-CnIl43a7.js"), "./Pages/Updater/Index.jsx": () => import("./assets/Index-BcfCelNf.js"), "./Pages/V3/Products/Create.jsx": () => import("./assets/Create-DEYIvBfd.js"), "./Pages/V3/Products/Edit.jsx": () => import("./assets/Edit-DzGHn0pC.js"), "./Pages/V3/Products/Index.jsx": () => import("./assets/Index-CqHu87qR.js"), "./Pages/V3/Products/PriceTiers.jsx": () => import("./assets/PriceTiers-DIFqO3L9.js"), "./Pages/V3/Products/UomConversions.jsx": () => import("./assets/UomConversions-Cl6KoSlP.js"), "./Pages/V3/Purchases/Create.jsx": () => import("./assets/Create-gHTTTXBq.js"), "./Pages/V3/Purchases/Index.jsx": () => import("./assets/Index-DrJwrW_3.js"), "./Pages/V3/Purchases/Return.jsx": () => import("./assets/Return-t-kzRJdm.js"), "./Pages/V3/Purchases/Show.jsx": () => import("./assets/Show-CeZfZFMJ.js"), "./Pages/V3/Warehouses/Create.jsx": () => import("./assets/Create-BjeEqVI0.js"), "./Pages/V3/Warehouses/Edit.jsx": () => import("./assets/Edit-DuLlpDeI.js"), "./Pages/V3/Warehouses/Index.jsx": () => import("./assets/Index-B7UCsXK2.js"), "./Pages/VenSynQ/Components/AmazonSetupWizard.jsx": () => import("./assets/AmazonSetupWizard-CD9eVc4p.js"), "./Pages/VenSynQ/Components/MoneyPipeline.jsx": () => import("./assets/MoneyPipeline-CfDzHWS0.js"), "./Pages/VenSynQ/Components/SyncHealthPanel.jsx": () => import("./assets/SyncHealthPanel-DgVF552S.js"), "./Pages/VenSynQ/Dashboard.jsx": () => import("./assets/Dashboard-Cg81VEjb.js"), "./Pages/VenSynQ/Payouts.jsx": () => import("./assets/Payouts-udkganzb.js"), "./Pages/VenSynQ/Settings.jsx": () => import("./assets/Settings-gJ-PjtHS.js"), "./Pages/Welcome.jsx": () => import("./assets/Welcome-azVdJkmH.js"), "./Pages/WhatIsIncluded.jsx": () => import("./assets/WhatIsIncluded-DtllnIkW.js"), "./Pages/WooCommerce/ConnectionSetup.jsx": () => import("./assets/ConnectionSetup-CzIerVBN.js"), "./Pages/WooCommerce/Connections.jsx": () => import("./assets/Connections-Bu1xR9mO.js"), "./Pages/WooCommerce/SyncPage.jsx": () => import("./assets/SyncPage-CJKYmR7W.js"), "./Pages/WooCommerce/WooCommerce.jsx": () => import("./assets/WooCommerce-D9Fv0vSa.js") })
    ).then((module) => {
