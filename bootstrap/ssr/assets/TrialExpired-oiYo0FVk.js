...
function TrialExpired() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#02000f] text-white font-sans flex items-center justify-center p-6", children: [
...
function PlanCard({ plan, price, color, features, badge }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `rounded-xl border p-3 relative ${cfg.header}`, children: [
    badge && /* @__PURE__ */ jsx("div", { className: "absolute -top-2.5 left-1/2 -translate-x-1/2 px-2 py-0.5 rounded-full bg-indigo-500 text-[10px] font-bold text-white whitespace-nowrap", children: badge }),
    ...
    features.map((f) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-[10px] text-slate-400 mb-1", children: [
