  ...
  return /* @__PURE__ */ jsxs(PlatformShell, { title: "System Platforms", mode: "admin", activeMenu: "Platforms", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-8", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-ink-muted mt-1", children: "Define high-level software platforms (e.g. VenQore Cloud, VenQore On-Prem)" })
      ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-4", children: [
        platforms.map((p) => /* @__PURE__ */ jsxs(
          "div",
          {
            className: `p-6 rounded-2xl border transition-all flex items-center justify-between ${editingId === p.id ? "bg-brand-500/10 border-brand-500 shadow-xl " : "bg-neutral-900 border-neutral-800 hover:border-line-strong shadow-lg"}`,
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                /* @__PURE__ */ jsx("div", { className: `w-12 h-12 rounded-2xl flex items-center justify-center ${p.is_active ? "bg-emerald-500/10 text-emerald-500" : "bg-neutral-800 text-ink-muted"}`, children: /* @__PURE__ */ jsx(Database, { size: 24 }) }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("h3", { className: "font-bold text-lg text-white", children: p.name }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs font-mono text-ink-muted uppercase tracking-widest", children: p.slug })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                /* @__PURE__ */ jsx("span", { className: `px-3 py-1 rounded-full text-2xs font-bold uppercase tracking-widest ${p.is_active ? "bg-emerald-500/10 text-emerald-500 border border-emerald-500/20" : "bg-neutral-800 text-ink-muted border border-neutral-700"}`, children: p.is_active ? "Active" : "Disabled" }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    onClick: () => startEdit(p),
        ...
        platforms.length === 0 && /* @__PURE__ */ jsxs("div", { className: "p-20 text-center bg-neutral-900/50 rounded-2xl border border-dashed border-neutral-800", children: [
          /* @__PURE__ */ jsx(Database, { size: 48, className: "mx-auto mb-4 text-ink-secondary" }),
          /* @__PURE__ */ jsx("p", { className: "text-ink-muted font-medium", children: "No platforms defined yet." })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-1", children: isAdding || editingId ? /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 border border-neutral-800 rounded-2xl p-8 sticky top-28 shadow-2xl", children: [
        /* @__PURE__ */ jsxs("h3", { className: "text-xl font-bold text-white mb-6 flex items-center gap-3", children: [
          editingId ? /* @__PURE__ */ jsx(Edit2, { size: 20, className: "text-brand-400" }) : /* @__PURE__ */ jsx(Plus, { size: 20, className: "text-emerald-400" }),
          editingId ? "Edit Platform" : "New Platform"
        ] }),
        /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-ink-muted uppercase tracking-widest mb-2", children: "Platform Name" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-ink-muted uppercase tracking-widest mb-2", children: "Identifier (Slug)" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 bg-neutral-950 rounded-2xl border border-neutral-800", children: [
            /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-neutral-300", children: "Status Active" }),
            /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
      ...
      ] }) : /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900/30 border border-dashed border-neutral-800 rounded-2xl p-10 text-center", children: [
        /* @__PURE__ */ jsx(Shield, { size: 40, className: "mx-auto mb-4 text-ink-secondary opacity-50" }),
        /* @__PURE__ */ jsx("p", { className: "text-ink-secondary text-sm font-medium", children: "Select a platform to edit or add a new one." })
      ] }) })
    ] })
  ] });
}
