...
function QrCodeTool({ supportsRaster = true, supportsLogo = true, toolGroups = [] }) {
  ...
  return /* @__PURE__ */ jsx(
    ToolShell,
    {
      ...
      children: /* @__PURE__ */ jsx("div", { className: "vq-tool-panel vq-tool-panel--pad", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-6 lg:gap-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-5 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4 pt-2", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("input", { type: "color", value: foreground, onChange: (e) => setForeground(e.target.value), className: "w-11 h-11 rounded-lg border border-line bg-transparent cursor-pointer" }),
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("input", { type: "color", value: background, onChange: (e) => setBackground(e.target.value), className: "w-11 h-11 rounded-lg border border-line bg-transparent cursor-pointer" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("input", { type: "range", min: "100", max: "1000", step: "10", value: size, onChange: (e) => setSize(Number(e.target.value)), className: "w-full accent-brand-500" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("label", { className: labelBase, children: [
                "Margin (",
              ...
              /* @__PURE__ */ jsx("input", { type: "range", min: "0", max: "60", value: margin, onChange: (e) => setMargin(Number(e.target.value)), className: "w-full accent-brand-500" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "text-xs text-ink-muted mt-1.5 flex items-start gap-1.5", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-2.5", children: [
            ...
            logo && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 p-3 rounded-xl vq-tool-inset", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted flex-1 leading-snug", children: "Error correction was switched to High to keep the code scannable with a logo in the center." }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col min-w-0", children: [
          /* @__PURE__ */ jsxs(
            "div",
            {
              className: "vq-paper w-full aspect-square rounded-2xl border border-line flex items-center justify-center p-6 mb-3",
              ...
              children: [
                ...
                !loading && !result && /* @__PURE__ */ jsx("span", { className: "text-ink-muted text-sm text-center px-4", children: "Fill in the fields to see your QR code" })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
