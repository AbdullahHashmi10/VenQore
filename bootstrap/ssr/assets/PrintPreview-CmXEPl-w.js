...
import { f as formatCurrency, n as numberToWords } from "./format-131Nyq79.js";
...
function PrintPreview({ data, sale = null, type = "regular", mode = "light", forPrint = false }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `relative transition-all duration-slow ${mode === "dark" ? "brightness-90 contrast-125" : ""}`, children: [
    /* @__PURE__ */ jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxs("div", { className: `absolute -bottom-8 left-0 w-full text-center text-2xs font-mono opacity-50 ${mode === "dark" ? "text-ink-muted" : "text-ink-muted"}`, children: [
...
const ThemeRegularModern = ({ data, items, calculations, themeColor, sale, entityLabel, entityName, showEntity }) => {
  ...
  const headerContent = /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start border-b-2 pb-6 mb-6", style: { borderColor: themeColor }, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
      ...
      ) : /* @__PURE__ */ jsx("div", { className: "w-20 h-20 bg-sunken rounded-lg flex items-center justify-center text-xs text-ink-muted font-bold", children: "LOGO" })),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h1", { className: "font-bold text-left", style: { color: themeColor, fontSize: `${itemsHeadingSize(data.print_company_text_size)}rem` }, children: data.business_name || "Business Name" }),
        /* @__PURE__ */ jsxs("div", { className: "text-xs text-ink-secondary space-y-0.5 mt-2 text-left font-sans", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
      /* @__PURE__ */ jsx("div", { className: "font-bold text-neutral-100 uppercase tracking-tighter", style: { fontSize: "2.5rem" }, children: "Invoice" }),
      /* @__PURE__ */ jsxs("div", { className: "text-sm font-bold text-ink-secondary mt-1", children: [
        "# ",
        sale ? sale.invoice_no || sale.invoice_number || sale.reference_number || sale.id : `${data.sale_prefix}1001`
      ] }),
      data.print_original_copy && /* @__PURE__ */ jsx("div", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mt-1", children: "Original Copy" }),
      /* @__PURE__ */ jsxs("div", { className: "text-xs text-ink-muted mt-1", children: [
        "Date: ",
        sale ? new Date(sale.created_at || sale.date).toLocaleDateString() : (/* @__PURE__ */ new Date()).toLocaleDateString()
      ] })
    ] })
  ] });
  const billToContent = showEntity ? /* @__PURE__ */ jsxs("div", { className: "flex justify-between mb-8 bg-surface p-4 rounded-xl border border-line text-left", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { className: "text-xs font-bold text-ink-muted uppercase mb-1", children: entityLabel }),
      /* @__PURE__ */ jsx("div", { className: "font-bold text-ink", children: entityName }),
      sale?.contact?.address && /* @__PURE__ */ jsx("div", { className: "text-xs text-ink-muted", children: sale.contact.address })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
      /* @__PURE__ */ jsx("div", { className: "text-xs font-bold text-ink-muted uppercase mb-1", children: "Payment Status" }),
  ...
  const mainContent = /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("table", { className: "w-full mb-auto text-sm", children: [
      /* @__PURE__ */ jsx("thead", { className: "bg-sunken text-white rounded-t-lg", children: /* @__PURE__ */ jsxs("tr", { children: [
      ...
      /* @__PURE__ */ jsxs("tbody", { style: { fontSize: `${itemsBodySize(data.print_invoice_text_size)}rem` }, children: [
        items.map((item, i) => /* @__PURE__ */ jsxs("tr", { className: "border-b border-line last:border-0", children: [
          ...
          data.print_show_hsn && /* @__PURE__ */ jsx("td", { className: "p-3 text-ink-muted text-left", children: item.hsn }),
          data.print_show_description && /* @__PURE__ */ jsx("td", { className: "p-3 text-ink-muted text-xs text-left", children: item.desc }),
          data.print_show_mrp && /* @__PURE__ */ jsx("td", { className: "p-3 text-right text-ink-muted line-through", children: formatAmount(item.mrp || item.rate * 1.2) }),
          /* @__PURE__ */ jsx("td", { className: "p-3 text-center text-ink-secondary font-bold", children: data.print_show_free_qty && item.free_qty > 0 ? `${item.qty}+${item.free_qty}` : item.qty }),
          data.print_show_units && /* @__PURE__ */ jsx("td", { className: "p-3 text-center text-ink-muted", children: item.unit || "pc" }),
          /* @__PURE__ */ jsx("td", { className: "p-3 text-right text-ink-secondary", children: formatAmount(item.rate) }),
          ...
          data.print_tax_details && /* @__PURE__ */ jsx("td", { className: "p-3 text-right text-ink-secondary", children: formatAmount(item.tax || 0) }),
          /* @__PURE__ */ jsx("td", { className: "p-3 text-right font-bold", children: formatAmount(item.amount) })
        ] }, i)),
        Array.from({ length: Math.max(0, (parseInt(data.print_min_item_rows) || 0) - items.length) }).map((_, idx) => /* @__PURE__ */ jsxs("tr", { className: "h-8 border-b border-line last:border-0 opacity-10", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex justify-end mt-6 border-t pt-6", children: /* @__PURE__ */ jsxs("div", { className: "w-64 space-y-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm text-ink-muted", children: [
        /* @__PURE__ */ jsx("span", { children: "Sub Total" }),
        /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.subtotal) })
      ] }),
      data.print_total_quantity && /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm text-ink-muted", children: [
      ...
      data.print_show_delivery_charge !== false && calculations.delivery_charge > 0 && /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm text-ink-muted", children: [
        /* @__PURE__ */ jsx("span", { children: "Delivery Charges" }),
        /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.delivery_charge) })
      ] }),
      data.print_show_extra_charge !== false && getExtraChargesList(calculations).map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm text-ink-muted", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-lg font-bold mt-2 pt-2 border-t", style: { color: themeColor }, children: [
        /* @__PURE__ */ jsx("span", { children: "Total" }),
        /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.total) })
      ] }),
      data.print_received_amount && /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm text-ink-secondary mt-2", children: [
      ...
      data.print_party_balance && !data.print_show_previous_balance && /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm text-ink-muted", children: [
        /* @__PURE__ */ jsx("span", { children: "Party Balance" }),
        /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.net_balance) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "mt-12 pt-6 border-t text-center space-y-2", children: [
      data.print_amount_words !== "0" && /* @__PURE__ */ jsxs("div", { className: "text-sm font-bold italic text-ink-secondary bg-sunken py-1 rounded", children: [
        '"',
        numberToWords(calculations.total, data.print_amount_words),
        '"'
      ] }),
      data.print_description !== false && data.print_description !== "0" && data.print_description !== 0 && /* @__PURE__ */ jsx("div", { className: "text-xs text-ink-muted", children: data.print_terms || "Thank you for your business!" }),
      data.print_qr_code && /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center my-4", children: [
        /* @__PURE__ */ jsx(QRCodeSVG, { value: `https://verify.venqore.com/receipt/${data.id || "sample"}`, size: 64 }),
        /* @__PURE__ */ jsx("div", { className: "text-3xs text-ink-muted mt-1", children: "Scan to Verify" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "text-2xs text-ink-muted font-medium pt-2", children: [
        "Powered by",
        "",
        /* @__PURE__ */ jsx(
          "a",
      ...
      (data.print_received_by || data.print_delivered_by || data.print_acknowledgement || data.print_payment_mode) && /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-end text-xs mt-6 pt-4 border-t border-dashed border-line", children: [
        data.print_payment_mode && /* @__PURE__ */ jsxs("div", { className: "text-left", children: [
          /* @__PURE__ */ jsx("span", { className: "font-bold text-ink-muted", children: "Payment Mode: " }),
          /* @__PURE__ */ jsx("span", { className: "font-bold text-ink", children: sale ? (sale.payment_method || "Cash").toUpperCase() : "CASH" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex gap-6 ml-auto font-bold", children: [
          data.print_received_by && /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "w-28 border-b border-line h-6" }),
            /* @__PURE__ */ jsx("div", { className: "text-2xs text-ink-muted mt-1", children: "Received By" })
          ] }),
          data.print_delivered_by && /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "w-28 border-b border-line h-6" }),
            /* @__PURE__ */ jsx("div", { className: "text-2xs text-ink-muted mt-1", children: "Delivered By" })
          ] }),
          data.print_acknowledgement && /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "w-36 border-b border-line h-6" }),
            /* @__PURE__ */ jsx("div", { className: "text-2xs text-ink-muted mt-1", children: tt("Customer Acknowledgement") })
          ] })
        ] })
      ] }),
      data.print_signature_text && /* @__PURE__ */ jsx("div", { className: "flex justify-end mt-8", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "border-t border-line w-32" }),
        /* @__PURE__ */ jsx("div", { className: "text-2xs font-bold text-ink-muted mt-1", children: data.print_signature_text })
      ] }) })
    ] })
  ] });
...
const ThemeRegularClassic = ({ data, items, calculations, themeColor, sale, entityLabel, entityName, showEntity }) => {
  const tt = useTermText();
  const formatAmount = (amount) => formatCurrency(amount, data);
  const headerContent = /* @__PURE__ */ jsxs("div", { className: "text-center mb-8 border-b-4 double border-neutral-800 pb-4", children: [
  ...
  const mainContent = /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("table", { className: "w-full border-collapse border border-neutral-800 mb-6", children: [
      /* @__PURE__ */ jsx("thead", { className: "bg-sunken", children: /* @__PURE__ */ jsxs("tr", { children: [
        /* @__PURE__ */ jsx("th", { className: "border border-neutral-800 p-2 text-left", children: "DESCRIPTION" }),
        /* @__PURE__ */ jsx("th", { className: "border border-neutral-800 p-2 text-center", children: data.print_show_free_qty && items.some((i) => i.free_qty > 0) ? "QTY + FREE" : "QTY" }),
        /* @__PURE__ */ jsx("th", { className: "border border-neutral-800 p-2 text-right", children: "UNIT PRICE" }),
        /* @__PURE__ */ jsx("th", { className: "border border-neutral-800 p-2 text-right", children: "AMOUNT" })
      ] }) }),
      /* @__PURE__ */ jsxs("tbody", { children: [
        items.map((item, i) => /* @__PURE__ */ jsxs("tr", { children: [
          /* @__PURE__ */ jsxs("td", { className: "border border-neutral-800 p-2 text-left", children: [
            /* @__PURE__ */ jsx("div", { children: item.name }),
            (data.thermal_show_batch || data.thermal_show_expiry || data.thermal_show_mfg_date || data.thermal_show_size || data.thermal_show_model || data.thermal_show_serial) && (item.batch || item.exp || item.mfg_date || item.size || item.model || item.serial) && /* @__PURE__ */ jsxs("div", { className: "text-2xs text-ink-muted font-mono mt-0.5 flex flex-wrap gap-x-2 gap-y-0.5", children: [
              data.thermal_show_batch && item.batch && /* @__PURE__ */ jsxs("span", { children: [
                "Batch: ",
          ...
          /* @__PURE__ */ jsx("td", { className: "border border-neutral-800 p-2 text-center", children: data.print_show_free_qty && item.free_qty > 0 ? `${item.qty}+${item.free_qty}` : item.qty }),
          /* @__PURE__ */ jsx("td", { className: "border border-neutral-800 p-2 text-right", children: formatAmount(item.rate) }),
          /* @__PURE__ */ jsx("td", { className: "border border-neutral-800 p-2 text-right", children: formatAmount(item.amount) })
        ] }, i)),
        Array.from({ length: Math.max(0, (parseInt(data.print_min_item_rows) || 0) - items.length) }).map((_, idx) => /* @__PURE__ */ jsxs("tr", { children: [
          /* @__PURE__ */ jsx("td", { className: "border border-neutral-800 p-2 h-8" }),
          /* @__PURE__ */ jsx("td", { className: "border border-neutral-800 p-2 text-center h-8" }),
          /* @__PURE__ */ jsx("td", { className: "border border-neutral-800 p-2 text-right h-8" }),
          /* @__PURE__ */ jsx("td", { className: "border border-neutral-800 p-2 text-right h-8" })
        ] }, `empty-${idx}`))
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mt-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "w-1/2 ml-auto", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between border-b border-neutral-800 py-1", children: [
          /* @__PURE__ */ jsx("span", { children: "SUBTOTAL:" }),
          /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.subtotal) })
        ] }),
        calculations.invoiceDiscount > 0 && /* @__PURE__ */ jsxs("div", { className: "flex justify-between border-b border-neutral-800 py-1 text-red-600 font-bold", children: [
          /* @__PURE__ */ jsx("span", { children: "DISCOUNT:" }),
          /* @__PURE__ */ jsxs("span", { children: [
            "-",
            formatAmount(calculations.invoiceDiscount)
        ...
        data.print_show_delivery_charge !== false && calculations.delivery_charge > 0 && /* @__PURE__ */ jsxs("div", { className: "flex justify-between border-b border-neutral-800 py-1", children: [
          /* @__PURE__ */ jsx("span", { children: "DELIVERY:" }),
          /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.delivery_charge) })
        ] }),
        data.print_show_extra_charge !== false && getExtraChargesList(calculations).map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "flex justify-between border-b border-neutral-800 py-1", children: [
          /* @__PURE__ */ jsxs("span", { children: [
        ...
        data.print_received_amount && /* @__PURE__ */ jsxs("div", { className: "flex justify-between border-b border-neutral-800 py-1", children: [
          /* @__PURE__ */ jsx("span", { children: "RECEIVED:" }),
          /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.paid) })
        ] }),
        data.print_balance_amount && /* @__PURE__ */ jsxs("div", { className: "flex justify-between border-b border-neutral-800 py-1 font-bold", children: [
          /* @__PURE__ */ jsx("span", { children: "BALANCE DUE:" }),
          /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.balance) })
        ] }),
        data.print_show_previous_balance && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        data.print_party_balance && !data.print_show_previous_balance && /* @__PURE__ */ jsxs("div", { className: "flex justify-between border-b border-neutral-800 py-1", children: [
          /* @__PURE__ */ jsx("span", { children: "PARTY BALANCE:" }),
          /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.net_balance) })
        ] })
      ] })
    ] }),
    (data.print_received_by || data.print_delivered_by || data.print_acknowledgement || data.print_payment_mode) && /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-end text-xs mt-8 pt-4 border-t border-dashed border-neutral-800", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex gap-6 ml-auto font-bold", children: [
        data.print_received_by && /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsx("div", { className: "w-28 border-b border-neutral-800 h-6" }),
        ...
        data.print_acknowledgement && /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsx("div", { className: "w-36 border-b border-neutral-800 h-6" }),
          /* @__PURE__ */ jsx("div", { className: "text-2xs mt-1", children: tt("Customer Acknowledgement") })
        ] })
      ] })
    ] }),
    data.print_signature_text && /* @__PURE__ */ jsx("div", { className: "flex justify-end mt-8", children: /* @__PURE__ */ jsxs("div", { className: "text-center font-bold", children: [
      /* @__PURE__ */ jsx("div", { className: "h-10" }),
      /* @__PURE__ */ jsx("div", { className: "border-t border-neutral-800 w-32" }),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "font-serif h-full flex flex-col text-ink", children: [
    headerContent,
    billToContent,
    mainContent,
    /* @__PURE__ */ jsxs("div", { className: "text-2xs text-ink-muted font-medium pt-2 text-center mt-auto", children: [
      "Powered by",
      "",
      /* @__PURE__ */ jsx(
        "a",
...
const ThemeRegularBold = ({ data, items, calculations, themeColor, sale, entityLabel, entityName, showEntity }) => {
  const tt = useTermText();
  const formatAmount = (amount) => formatCurrency(amount, data);
  const headerContent = /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 text-white p-8 -mx-8 -mt-8 mb-8 flex justify-between items-center text-left", style: { backgroundColor: themeColor }, children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold", children: data.business_name }),
  ...
  const billToContent = /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-8 mb-10 text-left", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h3", { className: "font-bold text-ink-muted uppercase text-xs mb-2", children: entityLabel }),
      /* @__PURE__ */ jsx("div", { className: "text-xl font-bold text-ink", children: entityName })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
      /* @__PURE__ */ jsx("h3", { className: "font-bold text-ink-muted uppercase text-xs mb-2", children: "Invoice Info" }),
      ...
      /* @__PURE__ */ jsx("p", { className: "font-mono text-ink-muted", children: sale ? new Date(sale.created_at || sale.date).toLocaleDateString() : (/* @__PURE__ */ new Date()).toLocaleDateString() })
    ] })
  ] });
  const mainContent = /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("table", { className: "w-full mb-8", children: [
      /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b-2 border-neutral-900", children: [
        /* @__PURE__ */ jsx("th", { className: "text-left py-3 font-bold text-ink uppercase text-xs", children: "Item Description" }),
        /* @__PURE__ */ jsx("th", { className: "text-right py-3 font-bold text-ink uppercase text-xs", children: "Total" })
      ] }) }),
      /* @__PURE__ */ jsxs("tbody", { children: [
        items.map((item, i) => /* @__PURE__ */ jsxs("tr", { className: "border-b border-line", children: [
        ...
        Array.from({ length: Math.max(0, (parseInt(data.print_min_item_rows) || 0) - items.length) }).map((_, idx) => /* @__PURE__ */ jsxs("tr", { className: "border-b border-line h-12", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mt-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "w-1/2 ml-auto text-sm space-y-1", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between font-bold text-base border-t border-neutral-900 pt-1", children: [
        ...
        data.print_show_previous_balance && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between font-bold border-t border-neutral-900 pt-1", children: [
            /* @__PURE__ */ jsx("span", { children: "Net Balance:" }),
            /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.net_balance) })
          ] })
        ] }),
    ...
    (data.print_received_by || data.print_delivered_by || data.print_acknowledgement || data.print_payment_mode) && /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-end text-xs mt-8 pt-4 border-t-2 border-neutral-900", children: [
      data.print_payment_mode && /* @__PURE__ */ jsxs("div", { className: "text-left font-bold", children: [
        /* @__PURE__ */ jsx("span", { children: "Payment Mode: " }),
        /* @__PURE__ */ jsx("span", { children: sale ? (sale.payment_method || "Cash").toUpperCase() : "CASH" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex gap-6 ml-auto font-bold", children: [
        data.print_received_by && /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsx("div", { className: "w-28 border-b-2 border-neutral-900 h-6" }),
          /* @__PURE__ */ jsx("div", { className: "text-2xs mt-1", children: "Received By" })
        ] }),
        data.print_delivered_by && /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsx("div", { className: "w-28 border-b-2 border-neutral-900 h-6" }),
        ...
        data.print_acknowledgement && /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsx("div", { className: "w-36 border-b-2 border-neutral-900 h-6" }),
          /* @__PURE__ */ jsx("div", { className: "text-2xs mt-1", children: tt("Customer Acknowledgement") })
        ] })
      ] })
    ] }),
    data.print_signature_text && /* @__PURE__ */ jsx("div", { className: "flex justify-end mt-8", children: /* @__PURE__ */ jsxs("div", { className: "text-center font-bold", children: [
      /* @__PURE__ */ jsx("div", { className: "h-10" }),
      /* @__PURE__ */ jsx("div", { className: "border-t-2 border-neutral-900 w-32" }),
      /* @__PURE__ */ jsx("div", { className: "text-2xs mt-1", children: data.print_signature_text })
    ] }) })
  ] });
  if (data.print_header_all_pages) {
...
const ThemeThermalModern = ({ data, items, calculations, themeColor, sale, entityLabel, entityName, showEntity }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "font-sans text-black", style: { fontSize, fontWeight }, children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-4", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "font-bold text-lg mb-1 leading-tight", children: data.business_name }),
    ...
    data.thermal_show_headers && /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-[0.8em] font-bold border-b-2 border-black pb-1 mb-2 uppercase tracking-tight", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "space-y-3 mb-4", children: items.map((item, i) => /* @__PURE__ */ jsxs("div", { className: "flex flex-col border-b border-black pb-2 last:border-0 last:pb-0", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
        /* @__PURE__ */ jsx("div", { className: "flex-1 pr-1", children: /* @__PURE__ */ jsxs("span", { className: data.thermal_use_bold ? "font-bold" : "font-bold", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "p-2 rounded mb-4 border border-black", style: { fontSize: "1.1em" }, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between font-bold mt-2 pt-2 border-t border-black", children: [
        /* @__PURE__ */ jsx("span", { children: "TOTAL" }),
        /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.total) })
      ] }),
      ...
      data.print_show_previous_balance && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-[0.8em] text-ink-muted", children: [
          /* @__PURE__ */ jsx("span", { children: "Prev Balance" }),
          /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.prev_balance) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-[0.85em] font-bold border-t border-dashed border-black pt-1", children: [
          /* @__PURE__ */ jsx("span", { children: "Net Balance" }),
          /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.net_balance) })
        ] })
      ] }),
      data.print_party_balance && !data.print_show_previous_balance && /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-[0.8em] text-ink-muted", children: [
        /* @__PURE__ */ jsx("span", { children: "Party Balance" }),
        /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.net_balance) })
      ] }),
      data.print_you_saved && calculations.discount > 0 && /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-[1em] mt-2 pt-2 border-t border-dashed border-black font-bold", children: [
        /* @__PURE__ */ jsx("span", { children: "You Saved" }),
        /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.discount) })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "text-center space-y-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "text-[0.75em] opacity-60 mt-2", children: [
        "Powered by",
        "",
        /* @__PURE__ */ jsx("a", { href: "https://venqore.com?utm_source=invoice_footer", target: "_blank", rel: "noopener noreferrer", style: { color: "rgb(var(--vq-indigo-600))", fontWeight: "bold" }, children: "VenQore" })
      ] }),
      (data.print_received_by || data.print_delivered_by || data.print_acknowledgement || data.print_payment_mode) && /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center text-[0.85em] gap-1 border-t border-dashed border-black pt-2 mt-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 w-full mt-1", children: [
          ...
          data.print_acknowledgement && /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsx("span", { children: tt("Customer Sign:") }),
            /* @__PURE__ */ jsx("span", { children: "_________________" })
          ] })
        ] })
      ] }),
...
const ThemeThermalClassic = ({ data, items, calculations, themeColor, sale, entityLabel, entityName, showEntity }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "font-mono text-xs text-black", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "border-t-2 border-black border-dashed pt-2 mb-2", children: [
      ...
      data.print_party_balance && !data.print_show_previous_balance && /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-ink-muted", children: [
        /* @__PURE__ */ jsx("span", { children: "PARTY BALANCE" }),
        /* @__PURE__ */ jsx("span", { children: formatAmount(calculations.net_balance) })
      ] }),
...
const ThemeThermalBold = ({ data, items, calculations, themeColor, sale, entityLabel, entityName, showEntity }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "font-sans text-sm font-bold border-2 border-black p-1 text-black", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "px-1 mt-2 text-right text-xs space-y-0.5", children: [
      ...
      data.print_you_saved && calculations.discount > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-1 font-bold text-sm", children: [
        "SAVINGS: ",
