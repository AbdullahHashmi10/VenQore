      ...
      /* @__PURE__ */ jsxs("div", { className: "p-8 rounded-3xl bg-slate-900 border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-4 self-stretch md:self-auto", children: [
          /* @__PURE__ */ jsxs("div", { className: "px-6 py-4 bg-slate-950 border border-slate-800 rounded-2xl flex-1 md:flex-none text-center", children: [
            /* @__PURE__ */ jsx("span", { className: "block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1", children: "Active Chats" }),
            /* @__PURE__ */ jsx("span", { className: "text-xl font-black text-indigo-400", children: stats.open_chats })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "px-6 py-4 bg-slate-950 border border-slate-800 rounded-2xl flex-1 md:flex-none text-center", children: [
            /* @__PURE__ */ jsx("span", { className: "block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1", children: "Total Products" }),
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: `text-[9px] px-2 py-0.5 rounded-full border font-black uppercase tracking-wider ${chat.status === "open" ? "bg-amber-500/10 border-amber-500/20 text-amber-400" : chat.status === "in_progress" ? "bg-indigo-500/10 border-indigo-500/20 text-indigo-400" : "bg-emerald-500/10 border-emerald-500/20 text-emerald-400"}`, children: chat.status })
                  ] }),
                  /* @__PURE__ */ jsx("div", { className: "text-slate-400 text-xs truncate", children: chat.message }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center text-[10px] text-slate-500 gap-1.5 mt-1", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "lg:col-span-8 flex flex-col h-full overflow-hidden bg-slate-950/20", children: selectedChat ? /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "px-6 py-4 bg-slate-950/40 border-b border-slate-800 flex flex-wrap items-center justify-between gap-4 text-xs", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-6", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("span", { className: "text-slate-500 block text-[9px] font-bold uppercase tracking-wider mb-0.5", children: "Purchase Platform Source" }),
                  /* @__PURE__ */ jsx("span", { className: "text-white font-bold", children: selectedChat.purchase_source || "Unknown / General" })
                ] }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("span", { className: "text-slate-500 block text-[9px] font-bold uppercase tracking-wider mb-0.5", children: "Trial Selection Preference" }),
                  /* @__PURE__ */ jsx("span", { className: `font-bold uppercase text-[10px] ${selectedChat.trial_status === "started" ? "text-indigo-400" : "text-emerald-400"}`, children: selectedChat.trial_status === "started" ? "Already Started Trial (+30 days credit)" : "Not Started Trial (Full 45 days store)" })
                ] })
              ] }),
              ...
              selectedChat.replies && selectedChat.replies.map((reply, idx) => /* @__PURE__ */ jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxs("div", { className: `max-w-[75%] rounded-2xl p-4 text-xs leading-relaxed border ${reply.is_platform_owner ? "bg-indigo-600/10 border-indigo-500/20 text-indigo-200 rounded-tr-none" : "bg-slate-800/60 border-slate-700/50 text-slate-300 rounded-tl-none"}`, children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 mb-1 text-[10px]", children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "text-[9px] text-slate-500 ml-auto", children: new Date(reply.created_at).toLocaleTimeString() })
                    ] }),
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "space-y-1 text-xs flex-1 cursor-pointer", onClick: () => handleStartEdit(prod), children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "text-[10px] font-mono text-slate-500", children: prod.version })
                    ] }),
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-1.5 pt-1.5", children: [
                      /* @__PURE__ */ jsx("span", { className: `px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider border ${prod.status === "active" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : prod.status === "dev" ? "bg-indigo-500/10 border-indigo-500/25 text-indigo-400" : "bg-amber-500/10 border-amber-500/20 text-amber-400"}`, children: prod.status === "active" ? "Operational" : prod.status === "dev" ? "In Dev" : "Coming Soon" }),
                      prod.platforms && prod.platforms.map((plat, i) => /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 rounded-full bg-slate-900 border border-slate-800 text-slate-400 text-[9px]", children: plat.name }, i))
                    ] })
                  ] }),
                  /* @__PURE__ */ jsx(
                    "button",
