  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: `Ledger - ${party.name}`, activeMenu: "Contacts", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full bg-slate-50 dark:bg-slate-950 p-2 gap-1 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "sm:hidden flex items-center justify-between bg-white dark:bg-slate-900 px-3 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm shrink-0", children: [
        ...
        !isStatsExpanded && /* @__PURE__ */ jsx("div", { className: "text-[10px] font-bold text-slate-500 truncate", children: /* @__PURE__ */ jsxs("span", { className: "text-emerald-600", children: [
          "Net: ",
      ...
      /* @__PURE__ */ jsxs("div", { className: `grid grid-cols-2 sm:grid-cols-4 gap-2 shrink-0 ${isStatsExpanded ? "grid" : "hidden sm:grid"}`, children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 px-2.5 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-bold text-slate-500 uppercase tracking-tight truncate", children: "Opening" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 px-2.5 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-bold text-slate-500 uppercase tracking-tight truncate", children: "Credits" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 px-2.5 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-bold text-slate-500 uppercase tracking-tight truncate", children: "Debits" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 px-2.5 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-bold text-slate-500 uppercase tracking-tight truncate", children: "Net Balance" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-3 py-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: `px-1.5 py-0.5 text-[8px] font-bold uppercase rounded-full ${party.type === "customer" ? "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400" : "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400"}`, children: party.type })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-[9px] text-slate-400 font-mono mt-0.5", children: party.phone || "No Phone" })
          ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "hidden sm:flex flex-row items-center justify-between gap-2 bg-white dark:bg-slate-900 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsx("div", { className: "flex items-center gap-3 flex-wrap", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: `px-2 py-0.5 text-[10px] font-bold uppercase rounded-full ${party.type === "customer" ? "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400" : "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400"}`, children: party.type })
          ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-auto rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm bg-white dark:bg-slate-900", children: [
        /* @__PURE__ */ jsx("div", { className: "hidden sm:block", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-10", children: [
            /* @__PURE__ */ jsx("th", { className: "p-3 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider", children: "Date" }),
            ...
            /* @__PURE__ */ jsx("th", { className: "p-3 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider", children: "Reference" }),
            /* @__PURE__ */ jsx("th", { className: "p-3 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider text-right", children: "You Gave" }),
            /* @__PURE__ */ jsx("th", { className: "p-3 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider text-right", children: "You Received" }),
            /* @__PURE__ */ jsx("th", { className: "p-3 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider text-right", children: "Balance" })
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-slate-100 dark:divide-slate-800", children: filteredTransactions.length > 0 ? filteredTransactions.map((t, index) => {
            ...
            return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors", children: [
              ...
              /* @__PURE__ */ jsx("td", { className: "p-3 text-center", children: /* @__PURE__ */ jsxs("span", { className: `inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase ${typeStyle.color}`, children: [
              ...
              /* @__PURE__ */ jsxs("td", { className: "p-3", children: [
                ...
                t.description && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 truncate max-w-[200px]", children: t.description })
              ] }),
              ...
              /* @__PURE__ */ jsxs("td", { className: "p-3 text-right", children: [
                ...
                t.balance !== 0 && /* @__PURE__ */ jsx("span", { className: `text-[9px] font-bold ml-1 uppercase ${t.balance > 0 ? "text-emerald-600" : "text-red-600"}`, children: t.balance > 0 ? "To Receive" : "To Pay" })
              ] })
            ] }, index);
        ...
        /* @__PURE__ */ jsx("div", { className: "block sm:hidden divide-y divide-slate-100 dark:divide-slate-800", children: filteredTransactions.length > 0 ? filteredTransactions.map((t, index) => {
          ...
          return /* @__PURE__ */ jsxs("div", { className: "p-3 hover:bg-slate-50 dark:hover:bg-slate-800/10 flex flex-col gap-1.5", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsx("span", { className: "text-[10px] text-slate-500 font-medium font-mono", children: new Date(t.date).toLocaleDateString("en-PK", { day: "2-digit", month: "short", year: "numeric" }) }),
              /* @__PURE__ */ jsxs("span", { className: `inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-bold uppercase ${typeStyle.color}`, children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
              ...
              t.description && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 mt-0.5", children: t.description })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-[11px] pt-1.5 border-t border-dashed border-slate-100 dark:border-slate-800/60 mt-1", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                t.debit > 0 && /* @__PURE__ */ jsxs("span", { className: "text-red-650 dark:text-red-400 font-mono font-bold", children: [
                  "Gave: ",
                  formatCurrency(t.debit, store)
                ] }),
                t.credit > 0 && /* @__PURE__ */ jsxs("span", { className: "text-emerald-650 dark:text-emerald-400 font-mono font-bold", children: [
                  "Rec: ",
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                ...
                t.balance !== 0 && /* @__PURE__ */ jsx("span", { className: `text-[8px] font-bold ml-0.5 uppercase ${t.balance > 0 ? "text-emerald-600" : "text-red-600"}`, children: t.balance > 0 ? "Rec" : "Pay" })
              ] })
            ] })
          ] }, index);
