...
import { e as useWorkspace, O as OneGlanceLayout } from "./marketing-pages-CTBAvetE.js";
import { X, Plus, ArrowLeft, Settings, User, Wallet, CheckCircle2, Zap, ScanBarcode, ChevronRight, GripVertical, Trash2, Printer, TrendingUp, Package, Type, CreditCard, ArrowLeftRight } from "lucide-react";
...
const CreateReturn = ({ sale }) => {
  ...
  }, [isEditMode, currentInvoice, addInvoice]);
  ...
  const refreshReturnItems = async () => {
    ...
    try {
      ...
      const newItems = currentInvoice.items.map((item) => {
        ...
        if (latest) {
          const isFinalized = isEditMode || ["approved"].includes(currentInvoice.status);
          return {
            ...item,
            product: latest,
      ...
      console.error("Failed to refresh return items", error);
    }
  };
  useEffect(() => {
  ...
  const processSale = async (addToLedger = false, shouldPrint = false) => {
    ...
    if (validItems.length === 0) {
      showAlert({ title: "No Items", message: "Please add at least one product to return.", type: "warning" });
      return;
    }
    setSaving(true);
    try {
      const payload = {
        ...
        amount_refunded: currentInvoice.amountPaid,
        // Reused state variable name, mapped to correct API key
      ...
      let response;
      response = await axios.post(route("store.returns.store", { store_slug: store.slug }), payload);
      if (response.data.success) {
        ...
        setLastSaleId(response.data.return_id);
        if (isEditMode) {
          showAlert({ title: "Success", message: "Return updated successfully.", type: "success" });
          if (!shouldPrint) router.visit(route("store.returns-history.index", { store_slug: store.slug }));
        } else {
          if (shouldPrint) {
      ...
      showAlert({
        title: "System Error",
        message: error.response?.data?.message || "Failed to save return.",
        type: "error"
      });
    } finally {
      setSaving(false);
  ...
  if (!currentInvoice || isEditMode && !editState) {
    return /* @__PURE__ */ jsx("div", { className: "flex h-screen items-center justify-center bg-slate-50 dark:bg-slate-900", children: /* @__PURE__ */ jsx("p", { className: "text-slate-500 animate-pulse", children: "Initializing Return..." }) });
  }
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: isEditMode ? `Edit Return #${editState?.invoiceNumber || ""}` : "New Return", activeMenu: "Returns", fullScreen: false, hideHeader: true, noPadding: true, children: [
    /* @__PURE__ */ jsx(Head, { title: isEditMode ? "Edit Return" : "New Return" }),
    /* @__PURE__ */ jsxs("div", { className: `h-full flex-1 flex flex-col bg-slate-50 dark:bg-void-800 transition-all duration-500 ${isSeniorMode ? "text-[20px] senior-mode" : ""}`, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: `flex-1 flex flex-col lg:flex-row gap-2 min-h-0 px-2 pb-0 pt-2 lg:overflow-hidden overflow-y-auto text-scale-${textSize}`, children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-800 flex flex-col overflow-hidden min-h-[400px] lg:min-h-0", children: [
            ...
            activeInvoices.map((inv, idx) => /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-xs font-bold truncate", children: inv.customer?.name || `Return #${idx + 1}` }),
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      onClick: (e) => {
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "truncate", children: currentInvoice.customer?.name || `Return #${activeInvoices.findIndex((inv) => inv.id === currentInvoice.id) + 1}` })
                  ]
                }
              ),
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "relative group/accounts-mobile shrink-0 h-[36px]", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "absolute right-0 top-full pt-1 z-50 hidden group-hover/accounts-mobile:block", children: /* @__PURE__ */ jsxs("div", { className: "bg-slate-800 rounded-lg shadow-xl border border-slate-700 overflow-hidden w-36 p-1", children: [
                    /* @__PURE__ */ jsx("div", { className: "p-1 border-b border-slate-700 bg-slate-900/50", children: /* @__PURE__ */ jsx("p", { className: "text-4xs font-bold text-slate-500 uppercase", children: "Refund From" }) }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsx(Zap, { size: 15, className: showQuickEntry ? "fill-current" : "" })
                }
              ),
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  title: "Scanning Mode",
                  children: [
                    /* @__PURE__ */ jsx(ScanBarcode, { size: 15 }),
                    /* @__PURE__ */ jsx("span", { children: "Scan" })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsx("div", { className: "relative flex-1 max-w-md", children: currentInvoice.customer ? /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxs("div", { className: "w-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl pl-8 pr-8 py-1.5 flex items-center justify-between shadow-sm min-h-[36px]", children: [
                /* @__PURE__ */ jsxs("div", { className: "truncate", children: [
                  /* @__PURE__ */ jsx("p", { className: "font-bold text-slate-800 dark:text-white text-2xs leading-tight truncate", children: currentInvoice.customer.name }),
                  /* @__PURE__ */ jsx("p", { className: "text-3xs text-slate-500 leading-tight truncate", children: currentInvoice.customer.phone || "No Phone" })
                ] }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
              ...
              /* @__PURE__ */ jsx("div", { className: "absolute left-2.5 top-1/2 -translate-y-1/2 text-emerald-500", children: /* @__PURE__ */ jsx(User, { size: 13 }) })
            ] }) : /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx(
                AsyncPartyCombobox,
                {
              ...
              customerError && /* @__PURE__ */ jsx("p", { className: "absolute -bottom-2.5 left-3.5 bg-red-600 text-white text-4xs font-black uppercase px-1.5 py-0.5 rounded shadow-md z-20 animate-pulse", children: "Please select a registered customer" })
            ] }) }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
              /* @__PURE__ */ jsxs("div", { className: "hidden md:flex items-center gap-0.5 bg-slate-100 dark:bg-slate-800 rounded-xl p-0.5 border border-slate-200 dark:border-slate-700", children: [
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    onClick: () => patchInvoice({ paymentMethod: "credit" }),
                    className: `px-2.5 py-1 rounded-lg text-2xs font-black flex items-center gap-1 transition-all ${currentInvoice.paymentMethod === "credit" ? "bg-emerald-500 text-white shadow-sm" : "text-slate-500"}`,
                    children: "CREDIT"
                  }
                ),
                /* @__PURE__ */ jsx(
                  ...
                  {
                    onClick: () => patchInvoice({ paymentMethod: "cash" }),
                    className: `px-2.5 py-1 rounded-lg text-2xs font-black flex items-center gap-1 transition-all ${currentInvoice.paymentMethod === "cash" ? "bg-orange-500 text-white shadow-sm" : "text-slate-500"}`,
                    children: "CASH"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "hidden md:relative md:group/accounts", children: [
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1 truncate", children: [
                        /* @__PURE__ */ jsx(Wallet, { size: 12, className: "text-indigo-500 shrink-0" }),
                        /* @__PURE__ */ jsx("span", { className: "truncate", children: currentInvoice.selectedBankName || accounts.find((a) => a.id === (currentInvoice.paymentAccountId || 1))?.name || "Cash in Hand" })
                      ] }),
                      /* @__PURE__ */ jsx(ChevronRight, { size: 12, className: "rotate-90 text-slate-400 shrink-0" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsx("div", { className: "absolute top-full pt-2 right-0 w-48 z-50 overflow-hidden hidden group-hover/accounts:block animate-in fade-in slide-in-from-top-2", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-100 dark:border-slate-700 overflow-hidden", children: [
                  /* @__PURE__ */ jsx("div", { className: "p-2 border-b border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50", children: /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-slate-400 uppercase", children: "Refund From" }) }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "md:hidden flex items-center gap-1 shrink-0", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-0.5 bg-slate-800 rounded-lg p-0.5 border border-slate-700 h-[36px]", children: [
                  /* @__PURE__ */ jsx(
                    "button",
                    {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto hide-scrollbar px-2 py-2", children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: "py-3 text-right", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2", children: [
                    ...
                    /* @__PURE__ */ jsx(
                      "button",
                      {
                        ...
                        children: quickEntry.discountType === "percent" ? "%" : getCurrencySymbol(store)
                      }
                    )
                  ] }) }),
                  /* @__PURE__ */ jsx("td", { className: "py-3 text-right", children: /* @__PURE__ */ jsx(
                ...
                currentInvoice.items.map((item, idx) => /* @__PURE__ */ jsxs(
                  "tr",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx("td", { className: "bg-slate-50 dark:bg-slate-800/50 py-3 relative", children: /* @__PURE__ */ jsx(
                        AsyncProductCombobox,
                        {
                      ...
                      /* @__PURE__ */ jsx("td", { className: "bg-slate-50 dark:bg-slate-800/50 py-3 text-right align-middle", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2", children: [
                        ...
                        /* @__PURE__ */ jsx(
                          "button",
                          {
                            ...
                            children: item.discountType === "percent" ? "%" : getCurrencySymbol(store)
                          }
                        )
                      ] }) }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "md:hidden flex flex-col gap-2", children: [
              showQuickEntry && /* @__PURE__ */ jsxs("div", { className: "bg-indigo-50/30 dark:bg-indigo-900/10 p-3 rounded-xl border border-indigo-200/50 dark:border-indigo-800/50 flex flex-col gap-2 animate-in slide-in-from-top-2 duration-200", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-4 gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-3xs font-bold text-slate-400 uppercase", children: "Free" }),
                    /* @__PURE__ */ jsx(
                      "input",
                      {
                        type: "number",
              ...
              currentInvoice.items.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 rounded-xl p-8 text-center border border-slate-200 dark:border-slate-800", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-slate-700 dark:text-slate-350", children: "No items added to return" })
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
                      /* @__PURE__ */ jsx(
                        "button",
                        {
                          ...
                          children: getItemTotalMode(item.id) === "price" ? getCurrencySymbol(store) : "#"
                        }
                      ),
                      /* @__PURE__ */ jsx(
                        WheelInput,
          ...
          /* @__PURE__ */ jsxs("div", { className: "lg:hidden flex flex-col shrink-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-4 gap-1.5 px-3 py-1.5 bg-slate-50 dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 shrink-0", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("span", { className: "text-4xs text-slate-400 font-bold block mb-0.5 uppercase", children: "Refund" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "number",
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("div", { className: `w-full bg-slate-100 dark:bg-slate-800 rounded-lg px-1.5 h-9 text-xs font-extrabold text-right border ${balanceDue > 0 ? "text-red-500 border-red-500/20" : "text-emerald-500 border-emerald-500/20"} flex items-center justify-end`, children: formatCurrency(balanceDue, store) })
              ] })
            ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex w-full lg:w-80 bg-void-700 flex-col overflow-hidden rounded-2xl shadow-2xl border border-slate-800 shrink-0", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: `space-y-1 bg-slate-800/30 rounded-lg p-2 ${textSize >= 3 ? "text-sm" : "text-xs"}`, children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                ...
                /* @__PURE__ */ jsxs("span", { className: `font-black ${currentInvoice.customer.current_balance >= 0 ? "text-emerald-400" : "text-red-400"}`, children: [
                  currentInvoice.customer.current_balance >= 0 ? getCurrencySymbol(store) : `-${getCurrencySymbol(store)} `,
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 p-3 space-y-3 overflow-y-auto hide-scrollbar", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "text-3xs text-slate-500 font-bold uppercase block mb-1", children: "Return Ref" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2 pt-3 border-t border-slate-800/50", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-white font-bold text-base", children: formatCurrency(subtotal, store) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                ...
                /* @__PURE__ */ jsxs("span", { className: "text-red-400 font-bold text-sm", children: [
                  "- ",
                  formatCurrency(itemDiscounts, store)
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between bg-slate-800/30 rounded-xl p-3 border border-slate-700/50", children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs text-slate-400 font-bold", children: "Return Discount" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-slate-500 text-xs", children: getCurrencySymbol(store) }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "number",
            ...
            showDeliveryCharges && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-2 hover:bg-slate-800/20 rounded-lg transition-colors group", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-slate-600 text-2xs", children: getCurrencySymbol(store) }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "number",
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between bg-emerald-900/20 rounded-xl p-3 border border-emerald-800/30", children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs text-emerald-400 font-bold", children: "Refund Amount" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-emerald-600 text-xs", children: getCurrencySymbol(store) }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "number",
            ...
            /* @__PURE__ */ jsxs("div", { className: `flex items-center justify-between rounded-xl p-3 border ${balanceDue > 0 ? "bg-red-900/20 border-red-800/30" : "bg-emerald-900/20 border-emerald-800/30"}`, children: [
              ...
              /* @__PURE__ */ jsx("span", { className: `font-bold text-base ${balanceDue > 0 ? "text-red-400" : "text-emerald-400"}`, children: formatCurrency(balanceDue, store) })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "p-3 bg-slate-900 space-y-2 shrink-0 border-t border-slate-800", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-2xl font-black text-white", children: formatCurrency(grandTotal, store) })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx(CheckCircle2, { size: 16 }),
                    saving ? "PROCESSING..." : isEditMode ? "UPDATE RETURN" : "CONFIRM RETURN"
                  ]
                }
              ),
                ...
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    onClick: () => {
                      ...
                      showConfirm({
                        title: "Cancel Return?",
                        message: "Discard this return? Items will be lost.",
                        type: "warning",
    ...
    showProfit && !showProfitModal && /* @__PURE__ */ jsx("div", { className: "fixed bottom-4 left-1/2 -translate-x-1/2 z-50 animate-in slide-in-from-bottom-4 duration-200", children: /* @__PURE__ */ jsxs("div", { className: "bg-slate-900/95 backdrop-blur-lg rounded-2xl px-8 py-4 shadow-2xl border border-slate-700 flex items-center gap-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: `text-2xl font-black ${profit >= 0 ? "text-emerald-400" : "text-red-400"}`, children: formatCurrency(profit, store) })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsx(
      FormModal,
      {
        ...
        subtitle: "The return transaction has been saved.",
        size: "md",
    ...
    showProfitModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 w-full max-w-3xl overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[80vh]", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "p-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 shrink-0", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 rounded-xl p-3 border border-slate-100 dark:border-slate-700", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-slate-800 dark:text-white", children: formatCurrency(grandTotal, store) })
        ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50 dark:bg-slate-800/50", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-500", children: "Return preferences" })
            ] })
          ] }),
          /* @__PURE__ */ jsx(
            "button",
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 p-4 space-y-4 overflow-y-auto", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl space-y-2 border border-indigo-100 dark:border-indigo-800/50", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-slate-400 text-xs font-bold", children: getCurrencySymbol(store) }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "number",
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-slate-400 uppercase tracking-wide", children: "Return Settings" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl", children: [
                /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-slate-400 uppercase tracking-wide", children: "Return Logic" }),
      ...
      /* @__PURE__ */ jsx("div", { className: "fixed inset-0 flex items-center justify-center z-[210] p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-void-700 rounded-2xl shadow-2xl max-w-md w-full overflow-hidden animate-in zoom-in-95 duration-200 border border-slate-200 dark:border-slate-700/50", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-6 space-y-5 bg-gradient-to-b from-white to-slate-50 dark:from-void-700 dark:to-void-800", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center py-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-5xl font-black bg-gradient-to-r from-emerald-500 to-teal-500 dark:from-emerald-400 dark:to-teal-400 bg-clip-text text-transparent", children: formatCurrency(overpaymentDetails.amount) }),
