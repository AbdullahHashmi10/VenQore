    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full bg-app p-2 gap-1 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-4 gap-1 shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Total Batches" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-ink", children: stats?.total_batches || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Expiring Soon" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-amber-600", children: stats?.expiring_soon || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Expired" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-rose-600", children: stats?.expired || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Total Qty" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-emerald-600", children: Number(stats?.total_quantity || 0).toLocaleString() })
        ] })
      ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: `px-2.5 py-1 text-2xs font-bold uppercase rounded-full transition-all ${statusFilter === "valid" ? "bg-gradient-to-r from-emerald-500 to-green-600 text-white shadow-lg " : "bg-sunken text-ink-muted hover:bg-interactive-hover"}`,
              children: "Valid"
            }
          ),
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: `px-2.5 py-1 text-2xs font-bold uppercase rounded-full transition-all ${statusFilter === "expiring" ? "bg-gradient-to-r from-amber-500 to-orange-600 text-white shadow-lg " : "bg-sunken text-ink-muted hover:bg-interactive-hover"}`,
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: `px-2.5 py-1 text-2xs font-bold uppercase rounded-full transition-all ${statusFilter === "expired" ? "bg-gradient-to-r from-red-500 to-rose-600 text-white shadow-lg " : "bg-sunken text-ink-muted hover:bg-interactive-hover"}`,
              children: "Expired"
            }
          )
        ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-auto rounded-xl border border-line shadow-sm bg-surface", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-app border-b border-line sticky top-0 z-10", children: [
          ...
          /* @__PURE__ */ jsx("th", { className: "p-3 text-2xs font-bold text-ink-muted uppercase tracking-wider", children: "Mfg Date" }),
          /* @__PURE__ */ jsx(
            "th",
            {
        ...
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: filteredBatches.length > 0 ? filteredBatches.map((batch) => {
...
`,
              children: [
                /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsx("span", { className: "font-mono font-bold text-sm text-brand-600 dark:text-brand-400", children: batch.batch_number }) }),
                /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "font-medium text-sm text-ink", children: batch.product?.name }),
                  /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted font-mono", children: batch.product?.code || batch.product?.sku })
                ] }) }),
                /* @__PURE__ */ jsx("td", { className: "p-3 text-right", children: /* @__PURE__ */ jsx("span", { className: "font-bold text-sm text-ink", children: Number(batch.current_quantity).toLocaleString() }) }),
                /* @__PURE__ */ jsx("td", { className: "p-3 text-sm text-ink-muted", children: batch.manufacturing_date || "-" }),
                /* @__PURE__ */ jsx("td", { className: `p-3 text-sm font-medium ${isExpired ? "text-red-600" : isExpiring ? "text-amber-600" : "text-ink-muted"}`, children: batch.expiry_date || "-" }),
          ...
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-ink-secondary mb-1", children: "No batches found" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "No batch records match your search criteria" })
        ] }) }) }) })
      ] }) }),
      batches?.links && batches.links.length > 3 && /* @__PURE__ */ jsx("div", { className: "shrink-0 bg-surface rounded-xl border border-line shadow-sm px-3 py-2", children: /* @__PURE__ */ jsx(Pagination, { links: batches.links }) })
    ] })
  ] });
}
export {
