      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-5 sm:p-8 shadow-2xl", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 sm:gap-4 p-3.5 sm:p-4 bg-white/5 rounded-2xl border border-white/10 mb-3 sm:mb-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-slate-400 uppercase tracking-wider", children: "Store" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 sm:gap-4 p-3.5 sm:p-4 bg-white/5 rounded-2xl border border-white/10 mb-3 sm:mb-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-slate-400 uppercase tracking-wider", children: "Invited As" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 sm:gap-4 p-3.5 sm:p-4 bg-white/5 rounded-2xl border border-white/10 mb-6 sm:mb-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-slate-400 uppercase tracking-wider mb-2", children: "Your Role(s)" }),
            /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1.5 sm:gap-2", children: roles.map((r) => /* @__PURE__ */ jsx("span", { className: "px-2.5 py-0.5 sm:px-3 sm:py-1 bg-indigo-600/40 text-indigo-200 rounded-full text-[10px] sm:text-xs font-bold border border-indigo-500/30", children: roleLabels[r] || r }, r)) })
          ] })
        ] }),
