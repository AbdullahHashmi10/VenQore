  ...
  const columns = [
    {
      ...
      render: (row) => /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-[11px] text-slate-400 font-mono", children: new Date(row.created_at).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) })
      ] })
    },
    {
      key: "product",
      ...
      render: (row) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 py-1", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "text-[10px] font-mono text-slate-500", children: row.product?.sku || "NO-SKU" })
        ] })
      ] })
    },
    {
    ...
    },
    {
      ...
      render: (row) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "w-6 h-6 rounded-full bg-slate-200 dark:bg-slate-700 flex items-center justify-center text-[10px] font-bold text-slate-500", children: row.user?.name ? row.user.name.charAt(0) : "S" })
      ] })
    }
  ];
  const filterDefs = [
