            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[9px] font-black uppercase bg-red-100 text-red-700 dark:bg-red-500/20 dark:text-red-400 px-2 py-0.5 rounded border border-red-200/30", children: "Debit Note" }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-t border-slate-100 dark:border-slate-800/60 pt-2 mt-1", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6", children: [
                    ...
                    row.reason && /* @__PURE__ */ jsxs("div", { className: "max-w-[150px] truncate", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-[9px] text-slate-400 font-bold uppercase block tracking-wider", children: "Reason" }),
                      /* @__PURE__ */ jsx("span", { className: "text-[10px] text-slate-500 italic", children: row.reason })
                    ] })
                  ] }),
