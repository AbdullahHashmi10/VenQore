          ...
          /* @__PURE__ */ jsx("div", { className: "divide-y divide-slate-50 dark:divide-slate-800", children: recentEntries.length > 0 ? recentEntries.map((entry) => /* @__PURE__ */ jsxs("div", { className: "p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-2", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-[10px] uppercase tracking-wider text-slate-400 font-bold", children: "Total Amount" })
              ] })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: entry.items.map((item, idx) => /* @__PURE__ */ jsxs("span", { className: "px-2 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800 text-[10px] font-bold text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700", children: [
              item.account.name,
              ": ",
