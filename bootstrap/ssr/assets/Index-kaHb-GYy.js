...
import { p as preloadLemonCheckout, v as vq, O as OneGlanceLayout, M as Modal, o as openLemonCheckout, c as closeLemonCheckout } from "./marketing-pages-CTBAvetE.js";
...
function UsageMeter({ icon: Icon, label, used, limit, color }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-slate-950/40 border border-white/[0.06] rounded-2xl p-5 shadow-inner", children: [
    ...
    isUnlimited ? /* @__PURE__ */ jsx("div", { className: "text-2xs text-emerald-400 font-bold uppercase tracking-wider", children: "Unlimited" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: `text-2xs font-bold ${isCritical ? "text-red-500" : "text-slate-500"} uppercase tracking-wider`, children: [
        pct,
        "% used"
      ] })
    ] })
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        savingsNote && /* @__PURE__ */ jsx("div", { className: "absolute -top-3 right-6 px-3 py-1 rounded-full text-2xs font-black tracking-widest text-white bg-emerald-600", children: savingsNote }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "text-sm font-bold mt-1", style: { color: meta.color }, children: [
              displayMonthly,
              displayAnnualNote && /* @__PURE__ */ jsx("span", { className: "text-2xs text-slate-500 font-semibold block mt-0.5", children: displayAnnualNote }),
        ...
        isCurrent ? tenant?.status === "trial" || tenant?.status === "suspended" ? /* @__PURE__ */ jsx(
          ...
          "button",
          {
            ...
            className: `w-full py-3 rounded-2xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2 transition-transform active:scale-95 ${thisIdx > currentIdx ? "bg-white text-void-950 hover:bg-slate-100" : "border border-slate-700 hover:border-slate-500 text-slate-300 hover:bg-slate-800"}`,
            children: [
...
function BillingIndex({ tenant, plans, usage, feature_status, country, pk_verification, trial_credit = null }) {
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Billing & Subscription", mode: "admin", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto p-4 md:p-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: `mb-8 p-6 md:p-8 rounded-[2.5rem] border flex flex-col md:flex-row justify-between items-center gap-6 shadow-2xl relative overflow-hidden bg-gradient-to-b from-white/[0.03] to-void-950 border-white/[0.06]`, children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-5 relative z-10", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-2xs font-black text-slate-400 uppercase tracking-[0.2em] mb-1", children: "Active Plan" }),
            ...
            isTrial && !isViewOnly && trialDaysLeft !== null && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-1.5 flex-wrap", children: [
              /* @__PURE__ */ jsxs("span", { className: `text-1xs font-black uppercase tracking-wider px-2 py-0.5 rounded-md ${trialDaysLeft <= 3 ? "bg-red-500/10 text-red-400" : trialDaysLeft <= 7 ? "bg-amber-500/10 text-amber-400" : "bg-purple-500/10 text-purple-300"}`, children: [
                "Trial · ",
                trialDaysLeft,
                " ",
            ...
            !isTrial && !isLtd && !isViewOnly && subDaysLeft !== null && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-1.5 flex-wrap", children: [
              /* @__PURE__ */ jsxs("span", { className: `text-1xs font-black uppercase tracking-wider px-2 py-0.5 rounded-md ${subDaysLeft <= 3 ? "bg-red-500/10 text-red-400" : subDaysLeft <= 7 ? "bg-amber-500/10 text-amber-400" : "bg-emerald-500/10 text-emerald-400"}`, children: [
                subDaysLeft,
                " ",
          ...
          /* @__PURE__ */ jsx("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10 mb-8", children: !isLtd && /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-1 p-1 rounded-2xl bg-white/[0.04] border border-white/[0.07]", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `px-5 py-2.5 rounded-xl text-xs font-black uppercase tracking-wider transition-all ${billingCycle === "monthly" ? "bg-white text-void-950 shadow-md" : "text-slate-400 hover:text-white"}`,
                children: "Monthly"
              }
            ),
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  "Annual",
                  /* @__PURE__ */ jsx("span", { className: `text-3xs px-1.5 py-0.5 rounded-full font-black ${billingCycle === "annual" ? "bg-white/20 text-white" : "bg-emerald-500/20 text-emerald-400"}`, children: "SAVE ~17%" })
                ]
              }
            )
          ] }) }),
      ...
      activeTab === "payments" && /* @__PURE__ */ jsxs("div", { className: "space-y-6 animate-fadeIn", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between flex-wrap gap-3", children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-1xs font-black text-slate-400 uppercase tracking-[0.2em] flex items-center gap-2", children: [
        ...
        history && /* @__PURE__ */ jsxs(Fragment, { children: [
          history.subscription && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-5 rounded-2xl bg-white/[0.02] border border-white/[0.05]", children: [
              /* @__PURE__ */ jsxs("div", { className: "text-2xs font-black text-slate-500 uppercase tracking-wider mb-2 flex items-center gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-5 rounded-2xl bg-white/[0.02] border border-white/[0.05]", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-1xs font-bold text-slate-500 mt-1", children: [
          ...
          history.invoices?.length > 0 && /* @__PURE__ */ jsx("div", { className: "rounded-2xl bg-white/[0.02] border border-white/[0.05] overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { className: "border-b border-white/[0.06]", children: ["Paid On", "Period Covered", "Days", "Amount", "Credit Applied", "Status", ""].map((h) => /* @__PURE__ */ jsx("th", { className: "px-5 py-3.5 text-2xs font-black text-slate-500 uppercase tracking-wider whitespace-nowrap", children: h }, h)) }) }),
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-white/[0.04]", children: history.invoices.map((inv) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-white/[0.02] transition-colors", children: [
              /* @__PURE__ */ jsxs("td", { className: "px-5 py-4 whitespace-nowrap", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "text-2xs font-bold text-slate-500 capitalize mt-0.5", children: inv.billing_reason === "initial" ? "First payment" : inv.billing_reason === "renewal" ? "Renewal" : inv.billing_reason === "updated" ? "Plan change" : inv.billing_reason })
              ] }),
              ...
              /* @__PURE__ */ jsx("td", { className: "px-5 py-4 whitespace-nowrap", children: inv.period_days !== null ? /* @__PURE__ */ jsxs("span", { className: "px-2.5 py-1 rounded-lg bg-purple-500/10 border border-purple-500/20 text-purple-300 text-1xs font-black", children: [
                inv.period_days,
                " days"
              ] }) : /* @__PURE__ */ jsx("span", { className: "text-1xs font-bold text-slate-600", children: "—" }) }),
              /* @__PURE__ */ jsxs("td", { className: "px-5 py-4 whitespace-nowrap", children: [
                /* @__PURE__ */ jsx("div", { className: "text-xs font-black text-white", children: inv.total }),
                inv.has_discount && /* @__PURE__ */ jsx("div", { className: "text-2xs font-bold text-slate-500 mt-0.5 line-through", children: inv.subtotal })
              ] }),
              /* @__PURE__ */ jsx("td", { className: "px-5 py-4 whitespace-nowrap", children: inv.has_discount ? /* @__PURE__ */ jsxs("span", { className: "px-2.5 py-1 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-1xs font-black flex items-center gap-1 w-fit", children: [
                /* @__PURE__ */ jsx(Zap, { size: 10, className: "fill-emerald-400" }),
                " −",
                inv.discount_total
              ] }) : /* @__PURE__ */ jsx("span", { className: "text-1xs font-bold text-slate-600", children: "—" }) }),
              /* @__PURE__ */ jsx("td", { className: "px-5 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsx("span", { className: `px-2.5 py-1 rounded-lg text-1xs font-black border ${inv.refunded || inv.status === "refunded" ? "bg-slate-500/10 border-slate-500/20 text-slate-400" : inv.status === "paid" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : inv.status === "pending" ? "bg-amber-500/10 border-amber-500/20 text-amber-400" : "bg-red-500/10 border-red-500/20 text-red-400"}`, children: inv.status_formatted || inv.status }) }),
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-2xs font-bold text-slate-600 text-center", children: [
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                    ...
                    !feat.is_active && feat.is_locked && /* @__PURE__ */ jsx("span", { className: "px-2.5 py-0.5 rounded-full text-2xs font-bold uppercase tracking-wider bg-slate-800 text-slate-400 border border-slate-700", children: "Locked (Upgrade to unlock)" }),
                    !feat.is_active && !feat.is_locked && /* @__PURE__ */ jsx("span", { className: "px-2.5 py-0.5 rounded-full text-2xs font-bold uppercase tracking-wider bg-slate-800 text-emerald-400 border border-slate-700", children: "Available" })
                  ] }),
      ...
      activeTab === "addons" && /* @__PURE__ */ jsxs("div", { className: "space-y-8 animate-fadeIn", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-3xl bg-white/[0.02] border border-white/[0.06]", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "p-5 rounded-2xl bg-slate-950/40 border border-white/[0.05] mb-8", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-slate-500 uppercase tracking-widest", children: "Active Level" }),
            ...
            tenant?.ai_status === "managed" && /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                /* @__PURE__ */ jsx("div", { className: "text-2xs text-slate-500 font-bold uppercase", children: "Scans" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-right border-l border-white/10 pl-4", children: [
                /* @__PURE__ */ jsx("div", { className: "text-2xs text-slate-500 font-bold uppercase", children: "Queries" }),
                /* @__PURE__ */ jsxs("div", { className: "text-sm font-black text-white", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "lg:col-span-1 p-6 rounded-2xl bg-white/[0.02] border border-white/[0.05] hover:border-white/10 transition-all flex flex-col justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-1xs text-slate-400 leading-relaxed", children: "Bypass platform scanning fees forever. Provide your own API keys for Gemini, Claude, OpenAI, or DeepSeek and pay nothing else." })
              ] }),
            ...
            /* @__PURE__ */ jsx("div", { className: "lg:col-span-2 p-6 rounded-2xl bg-white/[0.02] border border-white/[0.05] hover:border-white/10 transition-all flex flex-col justify-between", children: /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-4", children: [
                /* @__PURE__ */ jsx("span", { className: "px-2.5 py-0.5 rounded-full text-3xs font-bold uppercase tracking-wider bg-purple-500/10 text-purple-400 border border-purple-500/20", children: "Managed API" }),
              ...
              /* @__PURE__ */ jsx("p", { className: "text-1xs text-slate-400 leading-relaxed mb-4", children: "No developer keys or setup required. Use our fast platform credentials directly. Pick the tier that matches your monthly volume:" }),
              /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: [
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "text-3xs text-slate-500", children: [
                      plan.scans,
                      " scans / ",
                      plan.queries,
                      " queries"
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-3xl bg-white/[0.02] border border-white/[0.06]", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-5 rounded-2xl bg-slate-950/40 border border-white/[0.05]", children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-slate-500 uppercase tracking-widest", children: "Subscribed Channels" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-5 rounded-2xl bg-white/[0.02] border border-white/[0.05] flex flex-col justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-indigo-400 uppercase tracking-widest", children: "Platform Sync Trial" }),
                /* @__PURE__ */ jsx("h4", { className: "text-sm font-black text-white mt-1", children: "Evaluate WooCommerce Sync" }),
                /* @__PURE__ */ jsx("p", { className: "text-1xs text-slate-500 mt-2 leading-relaxed", children: "Test automatic inventory syncing with WooCommerce for the remainder of your trial period." })
              ] }),
      ...
      activeTab === "services" && /* @__PURE__ */ jsx("div", { className: "space-y-6 animate-fadeIn", children: /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-8 rounded-3xl bg-gradient-to-b from-slate-950 to-black border border-white/[0.06]", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
          ...
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "text-2xs text-slate-500 mt-1 leading-relaxed", children: tier.desc })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-baseline mt-4 pt-3 border-t border-white/[0.04] w-full", children: [
                /* @__PURE__ */ jsx("span", { className: "text-2xs text-purple-400 font-semibold", children: tier.sla }),
                /* @__PURE__ */ jsxs("span", { className: "text-white font-black text-sm", children: [
                  fmt(tier.priceUSD, tier.pricePKR),
                  /* @__PURE__ */ jsx("span", { className: "text-2xs text-slate-500 font-medium", children: "/ea" })
                ] })
              ] })
            ]
          },
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 pt-6 border-t border-white/[0.06]", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("span", { className: "text-3xs text-slate-500 mt-1 block", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-5 rounded-2xl bg-white/[0.01] border border-white/[0.05] flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-slate-500 uppercase tracking-widest", children: "Cost Estimate Details" }),
      ...
      activeTab === "desktop_app" && /* @__PURE__ */ jsx("div", { className: "space-y-6 animate-fadeIn", children: /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-8 rounded-3xl bg-gradient-to-b from-slate-950 to-black border border-white/[0.06] relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "max-w-xl mb-8", children: /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl border border-white/[0.05] bg-white/[0.01] hover:border-purple-500/20 transition-all flex flex-col justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 rounded-full text-3xs font-bold uppercase bg-purple-500/10 text-purple-300 border border-purple-500/20", children: "Official Build" })
            ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "pt-6 border-t border-white/[0.06]", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-2xs text-slate-400 leading-relaxed", children: guide.desc })
          ] }, guide.step)) })
        ] })
      ] }) }),
      false
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-4 mb-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/[0.05]", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center flex-1", children: [
            /* @__PURE__ */ jsx("div", { className: "text-2xs text-slate-500 font-bold uppercase tracking-wider", children: "Current Plan" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-center flex-1", children: [
            /* @__PURE__ */ jsx("div", { className: "text-2xs text-purple-400 font-bold uppercase tracking-wider", children: "New Plan" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-white/[0.02] border border-white/[0.05]", children: [
          /* @__PURE__ */ jsx("div", { className: "text-2xs text-slate-400 font-bold uppercase tracking-wider mb-2", children: isUpgrade ? "🎁 Features You Will Unlock:" : "⚠️ Features You Will Lose after billing cycle:" }),
    ...
    /* @__PURE__ */ jsx(Modal, { show: cancelOpen, onClose: () => setCancelOpen(false), maxWidth: "md", children: /* @__PURE__ */ jsxs("div", { className: "p-8 bg-slate-950 text-white", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-1xs font-bold text-slate-500 uppercase tracking-wider", children: currentMeta.label })
        ] })
      ] }),
        ...
        (() => {
          ...
          return /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsx("div", { className: "text-2xs text-slate-400 font-bold uppercase tracking-wider mb-3", children: "What's Included in Your Plan:" }),
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-lg bg-white/[0.01] border border-white/[0.03] flex flex-col", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-3xs text-slate-500 font-bold uppercase tracking-wider", children: "Staff Limit" }),
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-black text-white mt-0.5", children: formatLimit(congratsPlan.limits?.staff_limit) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-lg bg-white/[0.01] border border-white/[0.03] flex flex-col", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-3xs text-slate-500 font-bold uppercase tracking-wider", children: "Product (SKU) Limit" }),
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-black text-white mt-0.5", children: formatLimit(congratsPlan.limits?.sku_limit) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-lg bg-white/[0.01] border border-white/[0.03] flex flex-col", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-3xs text-slate-500 font-bold uppercase tracking-wider", children: "Locations Limit" }),
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-black text-white mt-0.5", children: formatLimit(congratsPlan.limits?.locations) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-lg bg-white/[0.01] border border-white/[0.03] flex flex-col", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-3xs text-slate-500 font-bold uppercase tracking-wider", children: "Transactions/mo" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsx("div", { className: "text-2xs text-slate-400 font-bold uppercase tracking-wider mb-2", children: "Premium Upgrades Activated:" }),
