      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 bg-surface p-4 rounded-2xl border border-line shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h1", { className: "text-xl font-bold text-ink tracking-tight", children: "Point-In-Time Inventory" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted font-medium", children: "Historical inventory ledger valuation & snapshot builder" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 bg-app border border-line p-1.5 rounded-xl flex-wrap w-full lg:w-auto", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-ink-muted uppercase tracking-wide", children: "Target Moment:" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "date",
              ...
              className: "px-2 py-1 bg-surface border border-line rounded-lg text-xs focus:ring-1 focus:ring-brand-500 text-ink-secondary font-bold"
            }
          ),
          /* @__PURE__ */ jsx(Clock, { size: 13, className: "text-ink-muted" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "time",
              ...
              className: "px-2 py-1 bg-surface border border-line rounded-lg text-xs focus:ring-1 focus:ring-brand-500 text-ink-secondary font-bold w-24"
            }
          ),
          asOfTime && /* @__PURE__ */ jsx(
            ...
            {
              onClick: () => setAsOfTime(""),
              className: "text-ink-muted hover:text-ink-secondary dark:hover:text-neutral-200 text-xs px-1 font-bold",
              children: "✕"
            }
          ),
          /* @__PURE__ */ jsx("button", { onClick: applyDate, className: "px-4 py-1.5 bg-brand-600 hover:bg-brand-700 text-white rounded-lg text-xs font-bold uppercase transition-colors shadow-md ", children: "Reconstruct" })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-4 gap-6 flex-1 min-h-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "xl:col-span-2 bg-surface rounded-2xl border border-line shadow-sm flex flex-col overflow-hidden min-h-0", children: [
          /* @__PURE__ */ jsxs("div", { className: "p-4 border-b border-line flex flex-col sm:flex-row justify-between items-start sm:items-center bg-sunken/50 dark:bg-surface gap-4 shrink-0", children: [
            /* @__PURE__ */ jsx("h2", { className: "text-sm font-bold text-ink uppercase tracking-wider", children: "Inventory Snapshot" }),
          ...
          /* @__PURE__ */ jsx("div", { className: "px-4 py-2 border-b border-line bg-sunken/20 flex gap-1.5 overflow-x-auto shrink-0 scrollbar-none", children: [
            ...
            let activeStyles = "bg-surface border-line text-ink-muted " + opt.styles;
            if (isActive) {
          ...
          /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm text-left", children: [
            /* @__PURE__ */ jsx("thead", { className: "text-xs text-ink-muted uppercase bg-app sticky top-0 backdrop-blur-sm z-10 border-b border-line", children: /* @__PURE__ */ jsx("tr", { children: [
              ...
              "th",
              {
                ...
                className: `px-6 py-3 font-bold cursor-pointer select-none hover:text-brand-500 ${col.align === "right" ? "text-right" : ""}`,
                children: [
                  col.label,
                  " ",
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: filtered.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 3, className: "px-6 py-12 text-center text-ink-muted italic", children: "No inventory matches search criteria." }) }) : filtered.map((row, idx) => {
              const qty = row.quantity || 0;
              let statusBadge = null;
              if (qty <= 0) statusBadge = /* @__PURE__ */ jsx("span", { className: "text-3xs bg-rose-50 text-rose-600 dark:bg-rose-900/20 dark:text-rose-400 px-1.5 py-0.5 rounded font-bold uppercase tracking-wider shrink-0 ml-1.5", children: "Out" });
              else if (qty <= 15) statusBadge = /* @__PURE__ */ jsx("span", { className: "text-3xs bg-amber-50 text-amber-600 dark:bg-amber-900/20 dark:text-amber-400 px-1.5 py-0.5 rounded font-bold uppercase tracking-wider shrink-0 ml-1.5", children: "Low" });
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("td", { className: "px-6 py-3", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
                        /* @__PURE__ */ jsx("span", { className: "font-bold text-ink-secondary dark:text-ink group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors", children: row.name }),
                        statusBadge
                      ] }),
                      /* @__PURE__ */ jsxs("div", { className: "text-2xs text-ink-muted font-mono mt-0.5", children: [
                        row.sku,
                        " • ",
                        /* @__PURE__ */ jsx("span", { className: "font-sans font-medium text-ink-muted/80", children: row.category })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsx("td", { className: "px-6 py-3 text-right font-mono font-semibold text-ink-secondary", children: qty }),
                    /* @__PURE__ */ jsxs("td", { className: "px-6 py-3 text-right", children: [
                      /* @__PURE__ */ jsx("span", { className: "font-mono font-bold text-ink-secondary dark:text-ink block", children: formatCurrency(row.stock_value, store) }),
                      /* @__PURE__ */ jsxs("span", { className: "text-3xs text-ink-muted font-mono", children: [
                        "@",
        ...
        /* @__PURE__ */ jsx("div", { className: "xl:col-span-1 flex flex-col gap-4 h-full", children: /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-neutral-900 to-neutral-800 p-5 rounded-2xl border border-neutral-700 shadow-lg text-white h-full relative overflow-hidden flex flex-col justify-between", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            ...
            auditResult ? /* @__PURE__ */ jsxs("div", { className: "space-y-3 animate-in fade-in duration-slow", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between bg-white/5 p-3 rounded-xl border border-white/10", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("span", { className: "text-2xs text-ink-muted font-bold block uppercase", children: "Health Score" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2 text-2xs", children: [
                /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-2 rounded-lg text-center", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-ink-muted uppercase tracking-wide", children: "Out of stock" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-2 rounded-lg text-center", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-amber-400 font-bold text-sm block", children: auditResult.lowStockCount }),
                  /* @__PURE__ */ jsx("span", { className: "text-ink-muted uppercase tracking-wide", children: "Low stock" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-3 rounded-xl border border-white/10 space-y-1", children: [
                /* @__PURE__ */ jsxs("h4", { className: "text-2xs font-bold text-emerald-300 uppercase flex items-center gap-1.5", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-1xs text-neutral-300 leading-relaxed", children: "Run the automated snapshot auditor to evaluate inventory turnover and capital leaks." })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-2 pt-2 border-t border-white/10", children: [
              /* @__PURE__ */ jsx("h4", { className: "text-2xs font-bold uppercase text-ink-muted tracking-wider", children: "Tied-Up Capital (Top Value)" }),
              topTiedProducts.map((p, idx) => /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { className: "text-neutral-300 font-medium truncate w-32 group-hover:text-brand-400", children: p.name }),
          ...
          /* @__PURE__ */ jsxs("button", { onClick: runInventoryAudit, disabled: isAuditing, className: "w-full mt-6 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-xs font-bold uppercase tracking-wide transition-all shadow-lg flex items-center justify-center gap-2 active:scale-95 disabled:opacity-50 disabled:cursor-wait shrink-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-brand-600 p-5 text-white relative overflow-hidden shrink-0", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex justify-between items-center", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                ...
                /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold tracking-tight mt-1", children: selectedItem.name }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-6 space-y-6 overflow-y-auto flex-1 text-sm", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-4 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "bg-app p-4 rounded-xl border border-line", children: [
                /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Stock Quantity" }),
                /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-ink mt-1", children: selectedItem.quantity })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-app p-4 rounded-xl border border-line", children: [
                /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Unit Valuation Cost" }),
                /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-ink mt-1", children: formatCurrency(selectedItem.unit_cost, store) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-app p-4 rounded-xl border border-line", children: [
                /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Valuation Basis" }),
                /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-brand-500 dark:text-brand-400 mt-1", children: "FIFO cost" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-app p-4 rounded-xl border border-line", children: [
                /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Total Stock Value" }),
                /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-emerald-500 mt-1", children: formatCurrency(selectedItem.stock_value, store) })
              ] })
            ] }),
            isLoadingDetails ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-20 text-brand-500 gap-3", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "md:col-span-6 flex flex-col", children: [
                ...
                modalDetails.batches.length === 0 ? /* @__PURE__ */ jsx("div", { className: "p-8 rounded-xl bg-app border border-dashed border-line text-center text-ink-muted italic", children: "No cost layers—item is out of stock." }) : /* @__PURE__ */ jsx("div", { className: "border border-line rounded-xl overflow-hidden bg-surface", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-xs text-left", children: [
                  ...
                  /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: modalDetails.batches.map((b, idx) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-interactive-hover dark:hover:bg-interactive-hover", children: [
                    /* @__PURE__ */ jsxs("td", { className: "py-2.5 px-3 font-semibold text-ink-secondary dark:text-ink", children: [
                      b.id,
                      /* @__PURE__ */ jsxs("span", { className: "block text-3xs text-ink-muted font-mono", children: [
                        "Inwarded ",
                        b.date
                      ] })
                    ] }),
                    /* @__PURE__ */ jsx("td", { className: "py-2.5 px-3 text-right font-mono text-ink-muted font-bold", children: formatCurrency(b.cost, store) }),
                    /* @__PURE__ */ jsxs("td", { className: "py-2.5 px-3 text-right font-mono text-ink-muted font-semibold", children: [
                      b.qtyLeft,
                      " ",
                    ...
                    /* @__PURE__ */ jsx("td", { className: "py-2.5 px-3 text-right font-mono font-bold text-ink-secondary", children: formatCurrency(b.qtyLeft * b.cost, store) })
                  ] }, idx)) })
                ] }) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "md:col-span-6 flex flex-col", children: [
                ...
                modalDetails.ledger.length === 0 ? /* @__PURE__ */ jsx("div", { className: "p-8 rounded-xl bg-app border border-dashed border-line text-center text-ink-muted italic", children: "No stock movement ledger transactions found." }) : /* @__PURE__ */ jsx("div", { className: "border border-line rounded-xl overflow-hidden bg-surface", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-xs text-left", children: [
                  /* @__PURE__ */ jsx("thead", { className: "bg-app text-ink-muted uppercase border-b border-line", children: /* @__PURE__ */ jsxs("tr", { children: [
                  ...
                  /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: modalDetails.ledger.map((l, idx) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-interactive-hover dark:hover:bg-interactive-hover", children: [
                    /* @__PURE__ */ jsx("td", { className: "py-2.5 px-3 text-ink-muted font-mono", children: l.date }),
                    /* @__PURE__ */ jsxs("td", { className: "py-2.5 px-3 font-semibold text-ink-secondary dark:text-ink", children: [
                      l.type,
                      /* @__PURE__ */ jsxs("span", { className: "block text-3xs text-ink-muted font-sans", children: [
                        "by ",
                        l.user
                      ] })
                    ] }),
                    /* @__PURE__ */ jsx("td", { className: "py-2.5 px-3 font-mono text-ink-muted", children: l.ref }),
