...
import { p as parseHex, g as useTheme } from "../ssr.js";
import { g as gradients, r as role, a as getSemanticTokens, v as vq } from "./runtime-DwSFgQZq.js";
...
const GRADIENTS = {
  ...
  brandSoft: gradients["brand-soft"],
  revenue: gradients.success,
  gmv: gradients.info,
...
function Skeleton({ w = "100%", h = 14, r = 8, style }) {
  ...
  return /* @__PURE__ */ jsx("div", { style: {
    ...
    height: h,
    borderRadius: r,
    background: t.isDark ? "linear-gradient(90deg, var(--vq-line-soft) 25%, var(--vq-line) 37%, var(--vq-line-soft) 63%)" : "linear-gradient(90deg, var(--vq-line-soft) 25%, var(--vq-line) 37%, var(--vq-line-soft) 63%)",
...
function Drawer({ open, onClose, title, subtitle, children, footer, width = 480 }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { position: "fixed", inset: 0, zIndex: 1e3 }, children: [
    /* @__PURE__ */ jsx("div", { onClick: onClose, style: { position: "absolute", inset: 0, background: "var(--vq-scrim)", backdropFilter: "blur(4px)", animation: "vq-fade-soft .25s ease" } }),
