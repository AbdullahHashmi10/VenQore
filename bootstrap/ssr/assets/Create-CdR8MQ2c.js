    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-ink", children: "Schedule Payment Reminder" }),
          /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-sm mt-1", children: "Set up automated notifications for your unpaid invoices" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-6", children: [
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-7 bg-surface rounded-2xl p-6 border border-line", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxs("label", { className: "block text-sm font-bold text-ink-secondary", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-ink-muted", children: /* @__PURE__ */ jsx(FileText, { size: 18 }) })
            ] }),
          ...
          selectedInvoice && /* @__PURE__ */ jsxs("div", { className: "p-4 bg-orange-50 dark:bg-orange-950/20 rounded-xl border border-orange-100 dark:border-orange-900/30 grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted block", children: tt("Customer") }),
              /* @__PURE__ */ jsxs("span", { className: "font-bold text-ink flex items-center gap-1.5 mt-0.5", children: [
                /* @__PURE__ */ jsx(User, { size: 14, className: "text-ink-muted" }),
                selectedInvoice.party?.name || "Unknown"
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted block", children: "Amount Due" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `p-4 rounded-xl border flex flex-col items-center justify-center gap-2 transition-all ${data.type === "email" ? "border-orange-500 bg-orange-50/50 dark:bg-orange-950/10 text-orange-600 dark:text-orange-400 font-bold" : "border-line text-ink-secondary hover:bg-interactive-hover dark:hover:bg-interactive-hover"}`,
                  children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-5 space-y-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-app border border-line rounded-2xl p-5", children: [
          /* @__PURE__ */ jsxs("h3", { className: "font-bold text-ink flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsx(Info, { size: 18, className: "text-ink-muted" }),
            "Reminder Preview"
          ] }),
          data.type === "whatsapp" ? (
            /* WhatsApp Mock */
            /* @__PURE__ */ jsxs("div", { className: "bg-[#efeae2] dark:bg-void-800 rounded-xl p-4 min-h-[220px] flex flex-col justify-between border border-emerald-100 dark:border-emerald-950/30", children: [
              /* @__PURE__ */ jsx("div", { className: "space-y-2", children: /* @__PURE__ */ jsxs("div", { className: "inline-block bg-white dark:bg-surface text-ink rounded-2xl rounded-tl-none p-3.5 text-sm shadow-sm max-w-[85%] whitespace-pre-wrap leading-relaxed relative", children: [
                getMessagePreview(),
                /* @__PURE__ */ jsx("span", { className: "block text-2xs text-ink-muted text-right mt-1.5", children: (/* @__PURE__ */ new Date()).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) })
              ] }) }),
              /* @__PURE__ */ jsx("div", { className: "text-center text-xs text-ink-muted mt-4 italic", children: "Simulated WhatsApp delivery" })
            ] })
          ) : (
            /* Email Mock */
            /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-xl p-4 min-h-[220px] flex flex-col justify-between border border-line", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxs("div", { className: "border-b border-line pb-2 text-xs text-ink-muted space-y-1", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "text-ink-secondary text-sm whitespace-pre-wrap leading-relaxed", children: getMessagePreview() })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "text-center text-xs text-ink-muted mt-4 italic", children: "Simulated Email delivery" })
            ] })
          )
        ] }) })
      ] })
