...
function CopyLinkButton({ url, primary = false }) {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      onClick: copy,
      className: primary ? "flex items-center gap-2 px-4 py-2.5 bg-brand-600 hover:bg-brand-500 text-white rounded-xl text-sm font-bold transition-all" : "flex items-center gap-1.5 px-3 py-1.5 bg-white/5 hover:bg-white/10 text-neutral-300 rounded-lg text-xs font-bold transition-all border border-white/10",
      children: [
...
function NewGrantDrawer({ open, onClose, plans, onCreated }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-50 flex", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "w-[480px] bg-neutral-900 border-l border-white/10 overflow-y-auto shadow-2xl", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-7 py-5 border-b border-white/10", children: [
        /* @__PURE__ */ jsxs("h2", { className: "text-lg font-bold text-white flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(Gift, { size: 18, className: "text-brand-400" }),
          " New Gift Link"
        ] }),
        /* @__PURE__ */ jsx("button", { onClick: onClose, className: "text-ink-muted hover:text-white text-xl", children: "✕" })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "px-7 py-6 space-y-5", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Plan to Grant" }),
          /* @__PURE__ */ jsx(
            "select",
            {
              value: data.plan_id,
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Duration — type any amount you want" }),
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-1.5", children: "e.g. 1 Month, 18 Months, 5 Years — anything you want." }),
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Your Note (private — never shown to the customer)" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Max Uses" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "number",
            ...
            /* @__PURE__ */ jsx("p", { className: "text-1xs text-ink-muted mt-1", children: "1 = single customer only" })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Link Expires" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "date",
            ...
            /* @__PURE__ */ jsx("p", { className: "text-1xs text-ink-muted mt-1", children: "Blank = never" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 pt-4 border-t border-white/10", children: [
          /* @__PURE__ */ jsx("button", { type: "button", onClick: onClose, className: "flex-1 bg-white/5 text-ink-muted px-6 py-3 rounded-xl font-bold text-sm hover:bg-white/10 transition-all", children: "Cancel" }),
          /* @__PURE__ */ jsx("button", { type: "submit", disabled: processing, className: "flex-1 bg-brand-600 text-white px-6 py-3 rounded-xl font-bold text-sm hover:bg-brand-500 transition-all disabled:opacity-50", children: processing ? "Creating…" : "Create Gift Link" })
        ] })
      ] })
    ] })
  ] });
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-emerald-500/10 border border-emerald-500/20 rounded-2xl p-5 flex items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-xs text-neutral-300 font-mono truncate mt-0.5", children: url })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
      /* @__PURE__ */ jsx(CopyLinkButton, { url, primary: true }),
      /* @__PURE__ */ jsx("button", { onClick: onDismiss, className: "text-ink-muted hover:text-white text-lg px-2", children: "✕" })
    ] })
  ] });
}
function AccessGrantsIndex({ grants, plans }) {
  ...
  return /* @__PURE__ */ jsxs(PlatformShell, { title: "Gift Access Links", mode: "admin", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-slower", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("h1", { className: "text-2xl font-bold text-ink flex items-center gap-3", children: [
            /* @__PURE__ */ jsx(Gift, { className: "text-brand-400" }),
            "Gift Access Links"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-sm mt-1", children: "Generate a link that gives a customer any plan for any duration you choose — no payment required." })
        ] }),
        /* @__PURE__ */ jsxs(
          "button",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-white/5 border border-line dark:border-white/10 p-6 rounded-2xl", children: [
          /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-xs font-bold uppercase tracking-widest mb-1", children: "Total Links" }),
          /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold text-ink", children: stats.total })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-emerald-500/5 border border-emerald-500/10 p-6 rounded-2xl", children: [
          /* @__PURE__ */ jsx("p", { className: "text-emerald-500/60 text-xs font-bold uppercase tracking-widest mb-1", children: "Active" }),
          /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold text-emerald-400", children: stats.active })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-brand-500/5 border border-brand-500/10 p-6 rounded-2xl", children: [
          /* @__PURE__ */ jsx("p", { className: "text-brand-500/60 text-xs font-bold uppercase tracking-widest mb-1", children: "Redemptions" }),
          /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold text-brand-400", children: stats.redeemed })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-red-500/5 border border-red-500/10 p-6 rounded-2xl", children: [
          /* @__PURE__ */ jsx("p", { className: "text-red-500/60 text-xs font-bold uppercase tracking-widest mb-1", children: "Revoked" }),
          /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold text-red-400", children: stats.revoked })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "bg-white/5 border border-white/10 rounded-2xl overflow-hidden backdrop-blur-sm", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left", children: [
        /* @__PURE__ */ jsx("thead", { className: "bg-white/5 text-2xs font-bold uppercase tracking-[0.2em] text-ink-muted border-b border-white/5", children: /* @__PURE__ */ jsxs("tr", { children: [
        ...
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-white/5", children: grants.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 6, className: "px-6 py-16 text-center", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-3 text-ink-muted", children: [
          ...
          return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-white/5 transition-colors", children: [
            /* @__PURE__ */ jsxs("td", { className: "px-6 py-4", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "text-xs text-ink-muted mt-0.5", children: durationLabel(grant) })
            ] }),
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-sm text-ink-muted max-w-[180px] truncate", children: grant.label || /* @__PURE__ */ jsx("span", { className: "text-ink-secondary", children: "—" }) }),
            ...
            /* @__PURE__ */ jsxs("td", { className: "px-6 py-4 text-sm text-ink-muted", children: [
              grant.redemption_count,
              " / ",
              grant.max_redemptions
            ] }),
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-sm text-ink-muted", children: new Date(grant.created_at).toLocaleDateString() }),
