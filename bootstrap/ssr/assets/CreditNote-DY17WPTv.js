...
function CreditNoteTool({
  ...
  return /* @__PURE__ */ jsxs(
    ToolShell,
    {
      ...
      wide: true,
      children: [
        /* @__PURE__ */ jsx(SmartCaptureNudge, { documentType: "credit note" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3 mb-5 p-3 vq-tool-panel", children: [
          ...
          /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => logoInputRef.current?.click(), className: "flex items-center gap-1.5 px-3 py-2 rounded-xl vq-tool-inset text-xs font-bold text-ink-secondary hover:border-red-400/40 transition-colors", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: `vq-paper rounded-2xl overflow-hidden shadow-xl shadow-neutral-900/10 dark:shadow-black/40 border border-line bg-white transition-all ${orientation === "landscape" ? "max-w-none" : ""}`, children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: `p-6 sm:p-10 text-ink ${isCompact ? "text-[13px]" : "text-sm"}`, style: { fontFamily: "Helvetica, Arial, sans-serif" }, children: [
            /* @__PURE__ */ jsxs("div", { className: `flex flex-col sm:flex-row justify-between gap-6 mb-6 ${isClassic ? "border-b-2 border-neutral-900 pb-4" : ""}`, children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-left sm:text-right", children: [
                /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold tracking-tight", style: { color: accent }, children: "CREDIT NOTE" }),
                /* @__PURE__ */ jsxs("div", { className: "mt-2 text-xs space-y-0.5", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex sm:justify-end gap-2", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-ink-muted", children: "Credit Note #" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "mb-6 p-4 rounded-xl bg-red-50 border border-red-200", children: [
              /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-3 mb-3 text-xs", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-baseline", children: [
                  /* @__PURE__ */ jsxs("span", { className: "text-ink-muted shrink-0", children: [
                    "Original Invoice # ",
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-baseline sm:justify-end", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-ink-muted shrink-0", children: "Original Invoice Date" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-3", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("label", { className: "block text-2xs font-bold uppercase tracking-wide text-ink-muted mb-1", children: [
                    "Reason for Credit ",
                    /* @__PURE__ */ jsx("span", { className: "text-red-500", children: "*" })
                  ] }),
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-wide text-ink-muted mb-1", children: "Refund / Settlement Method" }),
                  /* @__PURE__ */ jsx(Select, { value: meta.refund_method, onChange: (v) => setMeta((m) => ({ ...m, refund_method: v })), options: refundMethodOptions })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Credited To" }),
              ...
              /* @__PURE__ */ jsx(EditableText, { value: client.address, onChange: (v) => setClient((c) => ({ ...c, address: v })), placeholder: "Client address", as: "textarea", rows: 2, className: "block text-ink-muted text-xs mt-0.5", inline: false }),
              /* @__PURE__ */ jsx(EditableText, { value: client.email, onChange: (v) => setClient((c) => ({ ...c, email: v })), placeholder: "Client email (optional)", className: "block text-ink-muted text-xs mt-0.5", inline: false })
            ] }),
            /* @__PURE__ */ jsxs("table", { className: "w-full mb-2", children: [
              /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: `text-left text-2xs font-bold uppercase tracking-wide text-ink-muted ${isClassic ? "border-b-2 border-neutral-900" : "border-b border-neutral-900"}`, children: [
                /* @__PURE__ */ jsx("th", { className: "pb-2 pr-2", children: /* @__PURE__ */ jsx(EditableText, { value: headers.description, onChange: (v) => setHeaders((h) => ({ ...h, description: v })), className: "text-2xs font-bold uppercase tracking-wide text-ink-muted", pulse: false }) }),
                /* @__PURE__ */ jsx("th", { className: "pb-2 px-2 text-right w-16", children: /* @__PURE__ */ jsx(EditableText, { value: headers.qty, onChange: (v) => setHeaders((h) => ({ ...h, qty: v })), className: "text-2xs font-bold uppercase tracking-wide text-ink-muted text-right", pulse: false }) }),
                /* @__PURE__ */ jsx("th", { className: "pb-2 px-2 text-right w-24", children: /* @__PURE__ */ jsx(EditableText, { value: headers.unit_price, onChange: (v) => setHeaders((h) => ({ ...h, unit_price: v })), className: "text-2xs font-bold uppercase tracking-wide text-ink-muted text-right", pulse: false }) }),
                /* @__PURE__ */ jsx("th", { className: "pb-2 px-2 text-right w-16", children: /* @__PURE__ */ jsx(EditableText, { value: headers.discount, onChange: (v) => setHeaders((h) => ({ ...h, discount: v })), className: "text-2xs font-bold uppercase tracking-wide text-ink-muted text-right", pulse: false }) }),
                /* @__PURE__ */ jsx("th", { className: "pb-2 px-2 text-right w-20", children: /* @__PURE__ */ jsx(EditableText, { value: headers.tax, onChange: (v) => setHeaders((h) => ({ ...h, tax: v })), className: "text-2xs font-bold uppercase tracking-wide text-ink-muted text-right", pulse: false }) }),
                /* @__PURE__ */ jsx("th", { className: "pb-2 pl-2 text-right w-24", children: /* @__PURE__ */ jsx(EditableText, { value: headers.amount, onChange: (v) => setHeaders((h) => ({ ...h, amount: v })), className: "text-2xs font-bold uppercase tracking-wide text-ink-muted text-right", pulse: false }) }),
            ...
            /* @__PURE__ */ jsxs("button", { type: "button", onClick: addItem, disabled: items.length >= maxItems, className: "flex items-center gap-1 text-xs font-bold text-ink-muted hover:text-red-500 disabled:opacity-40 transition-colors mb-6", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "flex justify-end mb-8", children: /* @__PURE__ */ jsxs("div", { className: "w-56 space-y-1 text-sm", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between font-bold text-base pt-1.5 border-t-2 border-neutral-900", style: { color: accent }, children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-6 text-xs text-ink-muted", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink-secondary mb-1", children: "Settlement / Credit Terms" }),
