...
function BarcodeValidatorTool({ prefill = "", toolGroups = [] }) {
  ...
  return /* @__PURE__ */ jsx(
    ToolShell,
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad", children: [
        ...
        result && /* @__PURE__ */ jsxs("div", { className: `p-5 rounded-2xl border ${result.valid ? "bg-emerald-500/10 border-emerald-500/20" : "bg-red-500/10 border-red-500/20"}`, children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: `font-bold ${result.valid ? "text-emerald-700 dark:text-emerald-300" : "text-red-700 dark:text-red-300"}`, children: result.valid ? `Valid ${result.format_name}` : `Invalid ${result.format_name}` })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-secondary leading-relaxed mb-4", children: result.explanation }),
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-3 mb-4 text-sm", children: [
            /* @__PURE__ */ jsxs("p", { className: "text-ink-muted", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "font-mono text-ink", children: result.supplied_check_digit })
            ] }),
            /* @__PURE__ */ jsxs("p", { className: "text-ink-muted", children: [
              "Computed check digit: ",
              /* @__PURE__ */ jsx("span", { className: "font-mono text-ink", children: result.computed_check_digit })
            ] }),
            /* @__PURE__ */ jsxs("p", { className: "text-ink-muted sm:col-span-2", children: [
              "GTIN-14 form: ",
              /* @__PURE__ */ jsx("span", { className: "font-mono text-ink", children: result.gtin14 })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("details", { className: "text-sm", children: [
            /* @__PURE__ */ jsx("summary", { className: "cursor-pointer font-bold text-ink-secondary mb-2", children: "Show the arithmetic" }),
            /* @__PURE__ */ jsxs("div", { className: "mt-2 font-mono text-xs text-ink-muted space-y-1", children: [
              ...
              /* @__PURE__ */ jsxs("p", { className: "pt-2 border-t border-line text-ink-secondary", children: [
                "sum = ",
                result.sum,
                " → check digit = (10 − (",
                result.sum,
          ...
          !result.valid && /* @__PURE__ */ jsx("div", { className: "mt-4 pt-4 border-t border-line", children: /* @__PURE__ */ jsx("a", { href: "/tools/barcode-generator", className: "text-sm font-bold text-brand-600 dark:text-brand-400 hover:underline", children: "Regenerate this as a new, valid barcode →" }) })
        ] })
      ] })
    }
  );
