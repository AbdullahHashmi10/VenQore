...
const PermissionsSelector = ({ selectedPermissions = [], onChange, disabled = false }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "space-y-4 flex-1 overflow-y-auto pr-2 custom-scrollbar relative z-10 max-h-[500px]", children: PERMISSION_CATEGORIES.map((cat) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "bg-slate-800/30 border border-slate-700/30 rounded-2xl p-4 transition-all hover:border-slate-650/40", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4 mb-3 pb-3 border-b border-slate-800/60", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-[9px] text-slate-500 leading-tight mt-0.5", children: cat.desc })
          ] })
        ] }),
        /* @__PURE__ */ jsx(
          "button",
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5", children: catPerms.map((perm) => {
        ...
        return /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: `w-4 h-4 rounded border flex items-center justify-center shrink-0 transition-all ${isActive ? "bg-indigo-600 border-indigo-500 text-white" : "border-slate-705 bg-[#1e293b]"}`, children: isActive && /* @__PURE__ */ jsx(Check, { size: 8, strokeWidth: 3 }) }),
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-center min-w-0", children: [
                /* @__PURE__ */ jsx("div", { className: `text-[10px] font-bold leading-tight truncate ${isActive ? "text-white" : "text-slate-400 group-hover/mod:text-slate-300"}`, children: perm.name }),
                /* @__PURE__ */ jsx("div", { className: "text-[8px] text-slate-500 leading-tight mt-0.5 truncate", children: perm.desc })
              ] })
            ]
          },
          perm.id
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Team & Access Control", mode: "admin", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "h-full flex flex-col gap-3 max-w-[1600px] mx-auto", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row justify-between items-start md:items-center bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-3 rounded-2xl shadow-sm gap-4 shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
          ...
          activeTab === "summaries" ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[9px] font-black text-slate-400 uppercase tracking-widest mr-1", children: "Sort:" }),
            /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => setSortConfig("sales"),
                className: `px-2.5 py-1 text-[10px] font-bold uppercase rounded-md transition-all ${sortConfig === "sales" ? "bg-emerald-600 text-white shadow-sm font-black" : "bg-slate-100 dark:bg-slate-800 text-slate-500 hover:bg-slate-200 dark:hover:bg-slate-700"}`,
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `px-2.5 py-1 text-[10px] font-bold uppercase rounded-md transition-all ${sortConfig === "transactions" ? "bg-indigo-600 text-white shadow-sm font-black" : "bg-slate-100 dark:bg-slate-800 text-slate-500 hover:bg-slate-200 dark:hover:bg-slate-700"}`,
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `px-2.5 py-1 text-[10px] font-bold uppercase rounded-md transition-all ${sortConfig === "avg" ? "bg-purple-600 text-white shadow-sm font-black" : "bg-slate-100 dark:bg-slate-800 text-slate-500 hover:bg-slate-200 dark:hover:bg-slate-700"}`,
                children: "Avg. Ticket"
              }
            )
          ] }) : /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1 bg-slate-100 dark:bg-slate-800 p-0.5 rounded-lg text-[10px] font-extrabold uppercase", children: /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 bg-indigo-600 text-white rounded-md shadow-sm", children: "All" }) })
        ] }),
      ...
      activeTab === "summaries" && /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-4 h-full min-h-0 overflow-y-auto", children: /* @__PURE__ */ jsx("div", { className: "pb-4", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4", children: filteredSummaries.length > 0 ? filteredSummaries.map((staff, index) => /* @__PURE__ */ jsxs("div", { className: "relative bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm p-4 hover:shadow-md hover:border-indigo-200 dark:hover:border-indigo-800 transition-all group", children: [
        index === 0 && sortConfig === "sales" && /* @__PURE__ */ jsxs("div", { className: "absolute top-3 right-3 px-2 py-0.5 bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 rounded-full text-[10px] font-bold flex items-center gap-1 shadow-sm", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-2 rounded-xl bg-slate-50 dark:bg-slate-800/50", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-slate-500 dark:text-slate-400 mb-1", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold uppercase", children: "Txns" })
              ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-2 rounded-xl bg-slate-50 dark:bg-slate-800/50", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-slate-500 dark:text-slate-400 mb-1", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold uppercase", children: "Avg" })
              ] }),
    ...
    showAddModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 md:p-8 overflow-y-auto custom-scrollbar", children: /* @__PURE__ */ jsxs("div", { className: "bg-[#0f172a] rounded-[2rem] shadow-2xl w-full max-w-[1200px] border border-slate-700/50 flex flex-col md:flex-row relative mt-auto mb-auto", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: () => {
      ...
      /* @__PURE__ */ jsxs("div", { className: "w-full md:w-[450px] shrink-0 p-8 md:p-10 border-b md:border-b-0 md:border-r border-slate-700/50 flex flex-col bg-[#0f172a] rounded-l-[2rem]", children: [
        ...
        /* @__PURE__ */ jsxs("form", { id: "invite-form", onSubmit: handleSubmit, className: "flex flex-col gap-10 flex-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
            /* @__PURE__ */ jsxs("h4", { className: "flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 focus-within:text-indigo-400 transition-colors text-slate-500", children: [
                /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider ml-1", children: "Name" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
                ...
                errors.invitee_name && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-red-400 ml-1", children: errors.invitee_name })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 focus-within:text-indigo-400 transition-colors text-slate-500", children: [
                /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider ml-1", children: "Email" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "email",
                ...
                errors.invitee_email && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-red-400 ml-1", children: errors.invitee_email })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 focus-within:text-indigo-400 transition-colors text-slate-500", children: [
              /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider ml-1", children: "Phone Number" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "text",
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-indigo-400 tracking-wider", children: data.roles.length > 0 ? ROLES[data.roles[0]]?.name?.toUpperCase() : "NONE" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: Object.entries(ROLES).map(([key, role]) => {
              ...
              return /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `p-3 rounded-xl border flex gap-3 text-left transition-all ${isSelected ? "bg-indigo-600 border-indigo-500 shadow-xl shadow-indigo-600/20" : "bg-[#1e293b] border-[#334155] hover:border-indigo-400/50 hover:bg-[#1e293b]/80"}`,
                  children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: `text-[9px] font-medium leading-tight mt-0.5 ${isSelected ? "text-indigo-200" : "text-slate-500"}`, children: role.description })
                    ] })
                  ]
                },
                key
            ...
            errors.roles && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-red-400 ml-1", children: errors.roles })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex-1 p-8 md:p-10 bg-[#0f172a] rounded-r-[2rem] flex flex-col relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-8 relative z-10", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxs("h4", { className: "flex items-center gap-2 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]", children: [
              /* @__PURE__ */ jsx(Shield, { size: 14, className: "text-indigo-400" }),
              " System Visibility"
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-500 font-bold uppercase tracking-widest pl-6", children: "Module Access Control" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "px-4 py-2 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 text-[10px] font-black text-indigo-400 flex items-center gap-2 tracking-widest uppercase", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-8 pt-8 border-t border-slate-800/50 flex items-center justify-between relative z-10", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsx("div", { className: "text-[10px] font-black text-slate-500 uppercase tracking-widest", children: "Summary" }),
    ...
    /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-slate-100 dark:divide-slate-800", children: invitations.map((inv) => {
      ...
      return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors group", children: [
        ...
        /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1", children: roles.map((r) => {
          ...
          return /* @__PURE__ */ jsxs("span", { className: `inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase ${ri.badge}`, children: [
          ...
          children: [
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 uppercase font-bold tracking-wider", children: user.role })
              ] })
            ] }) }),
            ...
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsxs("span", { className: `inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase border ${isActive ? "bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 border-emerald-200" : "bg-slate-50 dark:bg-slate-800 text-slate-400 border-slate-200"}`, children: [
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-black/60 backdrop-blur-md z-[60] flex items-center justify-center p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl w-full max-w-4xl border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col h-[650px]", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("div", { className: "flex bg-slate-200/50 dark:bg-slate-800 p-1 rounded-xl", children: ["7", "14", "30"].map((range) => /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            className: `px-3 py-1 text-[10px] font-black uppercase rounded-lg transition-all ${dateRange === range ? "bg-white dark:bg-slate-700 text-indigo-600 shadow-sm" : "text-slate-500"}`,
            children: [
              range,
              " Days"
            ]
    ...
    /* @__PURE__ */ jsx("div", { className: "flex-1 p-8 overflow-y-auto", children: /* @__PURE__ */ jsxs("div", { className: "space-y-8 h-full flex flex-col", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-end", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black uppercase text-slate-500 tracking-wider", children: "Arrival Time" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "w-3 h-3 rounded-full bg-rose-500" }),
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black uppercase text-slate-500 tracking-wider", children: "Departure Time" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex-1 min-h-[300px] w-full bg-slate-50/50 dark:bg-slate-800/20 rounded-3xl border border-slate-100 dark:border-slate-800 p-6 relative overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "absolute inset-6", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", minWidth: 100, minHeight: 100, children: /* @__PURE__ */ jsxs(AreaChart, { data: chartData, children: [
        ...
        /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3", vertical: false, stroke: "#e2e8f0", opacity: 0.5 }),
        /* @__PURE__ */ jsx(XAxis, { dataKey: "date", axisLine: false, tickLine: false, tick: { fontSize: 10, fontWeight: 700, fill: "#64748b" }, dy: 10 }),
        /* @__PURE__ */ jsx(YAxis, { domain: [0, 24], axisLine: false, tickLine: false, tick: { fontSize: 9, fontWeight: 700, fill: "#94a3b8" }, tickFormatter: formatYAxis, ticks: [0, 4, 8, 12, 16, 20, 24] }),
            ...
            return /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-4 rounded-2xl shadow-2xl", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 justify-between", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-slate-500 uppercase", children: "First In:" }),
                  /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-indigo-600", children: payload[0].payload.inLabel || "—" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 justify-between", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-slate-500 uppercase", children: "Last Out:" }),
        ...
        /* @__PURE__ */ jsx(Area, { type: "monotone", dataKey: "in", stroke: "#6366f1", strokeWidth: 3, fillOpacity: 1, fill: "url(#colorIn)" }),
        /* @__PURE__ */ jsx(Area, { type: "monotone", dataKey: "out", stroke: "#f43f5e", strokeWidth: 3, fillOpacity: 1, fill: "url(#colorOut)" }),
        /* @__PURE__ */ jsx(ReferenceLine, { y: 9, stroke: "#6366f1", strokeDasharray: "3 3", opacity: 0.3, label: { position: "right", value: "9 AM", fill: "#6366f1", fontSize: 10 } }),
        /* @__PURE__ */ jsx(ReferenceLine, { y: 18, stroke: "#f43f5e", strokeDasharray: "3 3", opacity: 0.3, label: { position: "right", value: "6 PM", fill: "#f43f5e", fontSize: 10 } })
      ] }) }) }) }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-2xl border border-indigo-100 dark:border-indigo-800", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black text-indigo-600 uppercase", children: "Average In" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-rose-50 dark:bg-rose-900/20 p-4 rounded-2xl border border-rose-100 dark:border-rose-800", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black text-rose-600 uppercase", children: "Average Out" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-slate-50 dark:bg-slate-800/50 p-4 rounded-2xl border border-slate-200 dark:border-slate-700", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-1 text-slate-500", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black uppercase", children: "Punctuality" })
          ] }),
...
function EditMemberModal({ member, onClose }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[60] flex items-center justify-center p-4 md:p-8 overflow-y-auto custom-scrollbar", children: /* @__PURE__ */ jsxs("div", { className: "bg-[#0f172a] rounded-[2rem] shadow-2xl w-full max-w-[1200px] border border-slate-700/50 flex flex-col md:flex-row relative mt-auto mb-auto", children: [
    /* @__PURE__ */ jsx(
      "button",
      {
        onClick: onClose,
    ...
    /* @__PURE__ */ jsxs("div", { className: "w-full md:w-[450px] shrink-0 p-8 md:p-10 border-b md:border-b-0 md:border-r border-slate-700/50 flex flex-col bg-[#0f172a] rounded-l-[2rem] max-h-[85vh] overflow-y-auto", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-10", children: [
      ...
      /* @__PURE__ */ jsxs("form", { id: "edit-member-form", onSubmit: submit, className: "flex flex-col gap-10 flex-1", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 focus-within:text-indigo-400 transition-colors text-slate-500", children: [
            /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider ml-1", children: "Display Name" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "text",
            ...
            errors.display_name && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-red-400 ml-1", children: errors.display_name })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 focus-within:text-indigo-400 transition-colors text-slate-500", children: [
              /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider ml-1", children: "Status" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  value: data.status,
              ...
              errors.status && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-red-400 ml-1", children: errors.status })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 focus-within:text-indigo-400 transition-colors text-slate-500", children: [
              /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider ml-1", children: "Passcode PIN" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "password",
              ...
              errors.passcode && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-red-400 ml-1", children: errors.passcode })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-indigo-400 tracking-wider", children: data.role ? ROLES[data.role]?.name?.toUpperCase() : "NONE" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: Object.entries(ROLES).map(([key, role]) => {
            ...
            return /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                disabled: isOwner,
                onClick: () => toggleRole(key),
                className: `p-3 rounded-xl border flex gap-3 text-left transition-all ${isSelected ? "bg-indigo-600 border-indigo-500 shadow-xl shadow-indigo-600/20" : "bg-[#1e293b] border-[#334155] hover:border-indigo-400/50 hover:bg-[#1e293b]/80"} ${isOwner ? "opacity-50 cursor-not-allowed" : ""}`,
                children: [
                  /* @__PURE__ */ jsx("div", { className: `mt-0.5 shrink-0 ${isSelected ? "text-white" : "text-slate-500"}`, children: /* @__PURE__ */ jsx(role.icon, { size: 16 }) }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("div", { className: `text-xs font-bold leading-tight ${isSelected ? "text-white" : "text-slate-300"}`, children: role.name }),
          ...
          errors.role && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-red-400 ml-1", children: errors.role })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex-1 p-8 md:p-10 bg-[#0f172a] rounded-r-[2rem] flex flex-col relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("p", { className: "font-bold text-slate-700 dark:text-slate-200 text-sm", children: [
                ...
                user.role === "owner" && /* @__PURE__ */ jsx("span", { className: "ml-2 text-[10px] font-black bg-amber-500/10 text-amber-500 px-2 py-0.5 rounded-full border border-amber-500/20 uppercase tracking-widest", children: "Owner" })
              ] }),
...
function StatCard({ title, value, icon, color, subtext }) {
  return /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 px-3 py-1.5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center justify-between group hover:shadow-md transition-all", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-wider", children: title }),
        subtext && /* @__PURE__ */ jsx("p", { className: "text-[8px] text-amber-500 font-semibold", children: subtext })
      ] })
    ] }),
