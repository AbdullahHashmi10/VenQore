      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 z-20 flex flex-col items-center justify-center gap-2 bg-slate-900/20 dark:bg-black/40 backdrop-blur-[2px]", children: [
            ...
            /* @__PURE__ */ jsxs("span", { className: "text-[11px] font-black uppercase tracking-wider text-slate-700 dark:text-slate-300 px-2.5 py-1 bg-white/95 dark:bg-slate-800/95 rounded-full shadow-sm border border-slate-100 dark:border-slate-700", children: [
              "Upgrade to ",
  ...
  return /* @__PURE__ */ jsxs(
    Link,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative p-6 flex flex-col h-full z-10 bg-white/5 dark:bg-[#0f172a]/90 backdrop-blur-3xl h-full", children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
