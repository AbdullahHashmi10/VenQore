...
const SmartCombobox = ({
  ...
  const getTypeBadge = (item) => {
    if (item.type === "customer") {
      return /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-2xs font-black uppercase bg-blue-100 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-500/30", children: [
        /* @__PURE__ */ jsx(ShoppingBag, { size: 10 }),
        "Customer"
      ] });
    }
    if (item.type === "supplier") {
      return /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-2xs font-black uppercase bg-purple-100 dark:bg-purple-500/20 text-purple-600 dark:text-purple-400 border border-purple-200 dark:border-purple-500/30", children: [
  ...
  const getStockBadge = (item) => {
    ...
    return /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 flex-wrap", children: [
      available <= 0 ? /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-2xs font-black bg-red-100 dark:bg-red-500/20 text-red-600 dark:text-red-400 border border-red-200 dark:border-red-500/30", children: [
        /* @__PURE__ */ jsx(AlertTriangle, { size: 10 }),
        " OUT OF STOCK"
      ...
      reserved > 0 && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-2xs font-bold bg-purple-100 dark:bg-purple-500/20 text-purple-600 dark:text-purple-400 border border-purple-200 dark:border-purple-500/30", children: [
        "🔒 Reserved: ",
        reserved
      ] })
    ] });
  ...
  const getProfitMargin = (item) => {
    ...
    return /* @__PURE__ */ jsxs("span", { className: "text-2xs text-slate-400", children: [
      "Margin: ",
  ...
  const getLastActivity = (item) => {
    ...
    return /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 text-2xs text-slate-400", children: [
  ...
  return /* @__PURE__ */ jsxs("div", { id, className: `relative ${className}`, ref: wrapperRef, children: [
    ...
    isOpen && filteredItems.length > 0 && /* @__PURE__ */ jsxs("div", { className: `absolute right-0 text-3xs text-slate-400 flex items-center gap-2 ${openUpwards ? "-top-5" : "-bottom-5"}`, children: [
    ...
    isOpen && /* @__PURE__ */ jsxs("div", { className: `absolute ${openUpwards ? "bottom-full mb-1" : "top-full mt-1"} left-1/2 -translate-x-1/2 min-w-full w-max max-w-[350px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/50 rounded-2xl shadow-2xl z-[120] animate-in fade-in zoom-in-95 duration-100`, children: [
      filteredItems.length > 0 && /* @__PURE__ */ jsxs("div", { className: "px-4 py-2 bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("span", { className: "text-2xs font-bold text-slate-400 uppercase tracking-wider", children: [
          filteredItems.length,
          " Result",
          filteredItems.length !== 1 ? "s" : ""
        ] }),
        query && /* @__PURE__ */ jsxs("span", { className: "text-2xs text-slate-400", children: [
          'Searching: "',
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                      ...
                      isProduct(item) && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap mb-1", children: [
                        item.sku && /* @__PURE__ */ jsxs("span", { className: "font-mono text-slate-400 bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded text-2xs", children: [
                          "SKU: ",
                          item.sku
                        ] }),
                        item.category?.name && /* @__PURE__ */ jsx("span", { className: "text-2xs px-1.5 py-0.5 rounded bg-indigo-100 dark:bg-indigo-500/20 text-indigo-600 dark:text-indigo-400 font-bold", children: item.category.name }),
                        getStockBadge(item)
                      ] }),
                      isProduct(item) && !hideCostAndMargin && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                        item.cost !== void 0 && /* @__PURE__ */ jsxs("span", { className: "text-1xs text-slate-400", children: [
                          "Cost: ",
        ...
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "text-left", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-2xs text-slate-400", children: "Create a new entry" })
            ] })
          ]
        }
      ) })
