...
function PinDots({ value, maxLen = 8, hasError }) {
  ...
  return /* @__PURE__ */ jsx("div", { style: { display: "flex", justifyContent: "center", gap: 10, minHeight: 20 }, children: Array.from({ length: maxLen }, (_, i) => /* @__PURE__ */ jsx("div", { style: {
    ...
    height: 14,
    borderRadius: "50%",
    background: i < filled ? hasError ? "#ef4444" : "#6366f1" : "rgba(255,255,255,0.1)",
      ...
      /* @__PURE__ */ jsxs("div", { className: "pin-card", style: {
        ...
        /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", marginBottom: 32 }, children: [
          /* @__PURE__ */ jsxs("div", { className: "logo-container", style: {
            ...
            /* @__PURE__ */ jsx("div", { style: { display: "none", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsx(Shield, { size: 22, color: "#6366f1" }) })
          ] }),
          /* @__PURE__ */ jsx("div", { style: {
            fontSize: 10,
            fontWeight: 800,
          ...
          /* @__PURE__ */ jsx("h1", { style: { fontSize: 24, fontWeight: 800, color: "#f1f5f9", letterSpacing: "-0.02em", marginBottom: 6 }, children: "Welcome back, Abdullah" }),
        ...
        mode === "pin" && /* @__PURE__ */ jsxs("div", { style: { animation: "fade-in 0.3s ease" }, children: [
          /* @__PURE__ */ jsxs("div", { style: { marginBottom: 24, textAlign: "center" }, children: [
            /* @__PURE__ */ jsx("p", { style: { fontSize: 12, color: "#94a3b8", marginBottom: 16, letterSpacing: "0.04em", textTransform: "uppercase", fontWeight: 700 }, children: "Enter your PIN" }),
        ...
        /* @__PURE__ */ jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsx(Shield, { size: 12, color: "#64748b" }),
          /* @__PURE__ */ jsx("span", { style: { fontSize: 11, color: "#64748b", letterSpacing: "0.02em" }, children: "Rate-limited · Session-encrypted · Platform-restricted" })
        ] })
      ] })
    ] })
  ] });
