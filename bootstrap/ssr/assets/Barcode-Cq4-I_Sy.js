...
import EmailGate from "./EmailGate-BsTy97if.js";
...
function BarcodeTool({
  ...
  return /* @__PURE__ */ jsxs(
    ToolShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "vq-tool-panel vq-tool-panel--pad", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-6 lg:gap-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-5 min-w-0", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Format" }),
              /* @__PURE__ */ jsx(Select, { value: format, onChange: (v) => {
                setValue("");
                setFormat(v);
              }, options: formatOptions }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-1.5", children: isTextCapable ? "Accepts any text — a product name, SKU or description works fine." : "Digits only. Pick Code128 if you want to encode text." })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: isTextCapable ? "Value or text to encode" : "Value to encode" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "text",
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Bar width" }),
                /* @__PURE__ */ jsx("input", { type: "range", min: "1", max: "6", value: widthFactor, onChange: (e) => setWidthFactor(Number(e.target.value)), className: "w-full accent-brand-500" })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Height" }),
                /* @__PURE__ */ jsx("input", { type: "range", min: "40", max: "200", value: height, onChange: (e) => setHeight(Number(e.target.value)), className: "w-full accent-brand-500" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Image format" }),
              /* @__PURE__ */ jsx("div", { className: "flex gap-2 flex-wrap", children: ["png", "svg", "jpg"].map((fmt) => {
                ...
                return /* @__PURE__ */ jsx(
                  "button",
                  {
                    ...
                    className: `px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wide transition-colors disabled:opacity-35 disabled:cursor-not-allowed ${output === fmt ? "bg-accent-fill text-accent-on hover:bg-accent-fill-hover" : "vq-tool-inset text-ink-muted hover:text-ink"}`,
                    children: fmt
                  },
                  fmt
                );
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2.5 pt-1", children: [
              /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-2.5 cursor-pointer", children: [
                /* @__PURE__ */ jsx("input", { type: "checkbox", checked: showValue, onChange: (e) => setShowValue(e.target.checked), className: "w-4 h-4 rounded accent-brand-500" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm text-ink-secondary", children: "Show the number under the barcode" })
              ] }),
              ...
              logo && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 p-3 rounded-xl vq-tool-inset", children: [
                /* @__PURE__ */ jsx("img", { src: logo, alt: "", className: "w-9 h-9 object-contain rounded bg-white" }),
                /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted flex-1 leading-snug", children: "Keep it small — a large logo over the bars can stop the code scanning." }),
                /* @__PURE__ */ jsx("button", { onClick: () => setLogo(null), className: "text-ink-muted hover:text-red-500 transition-colors", children: /* @__PURE__ */ jsx(X, { size: 16 }) })
              ] })
            ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col min-w-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "vq-paper w-full aspect-[3/2] rounded-2xl bg-white border border-line flex items-center justify-center p-6 mb-3", children: [
              loading && /* @__PURE__ */ jsx(Loader2, { size: 20, className: "text-ink-muted animate-spin" }),
              ...
              !loading && !result && /* @__PURE__ */ jsx("span", { className: "text-ink-muted text-sm text-center px-4", children: "Enter a value to see your barcode" })
            ] }),
            /* @__PURE__ */ jsxs(
              "button",
              {
            ...
            /* @__PURE__ */ jsx("p", { className: "text-1xs text-ink-muted text-center mt-2", children: "Free — no email, no watermark." })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxs("div", { className: "mt-6 vq-tool-panel vq-tool-panel--pad", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-5", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-brand-500/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(Printer, { size: 17, className: "text-brand-500 dark:text-brand-300" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "Print a sheet of labels" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Same barcode repeated at an exact label size — thermal rolls or A4 sheets, as a print-ready PDF." })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-4 mb-5", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Label size" }),
              /* @__PURE__ */ jsx(Select, { value: preset, onChange: setPreset, options: presetOptions })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "How many labels" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "number",
          ...
          /* @__PURE__ */ jsx("p", { className: "text-1xs text-ink-muted mt-2.5 leading-relaxed", children: `Print at 100% / "Actual size" — never "Fit to page", or the labels won't line up with your stock.` })
        ] }),
        /* @__PURE__ */ jsxs("section", { className: "mt-12", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold mb-6 text-ink", children: "Supported formats" }),
          /* @__PURE__ */ jsx("div", { className: "overflow-x-auto rounded-2xl border border-line", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm min-w-[560px]", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { className: "bg-sunken text-left", children: ["Format", "Character set", "Length", "Typical retail use"].map((h) => /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-ink-secondary", children: h }, h)) }) }),
            /* @__PURE__ */ jsx("tbody", { children: FORMAT_TABLE.map((row) => /* @__PURE__ */ jsx("tr", { className: "border-t border-line", children: row.map((cell, i) => /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-ink-secondary", children: cell }, i)) }, row[0])) })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxs("section", { className: "mt-10", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink-secondary mb-4", children: "Generate a specific format" }),
