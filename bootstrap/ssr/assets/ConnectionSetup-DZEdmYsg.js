    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto space-y-6 px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx(Link, { href: route("store.woo.connections.index", { store_slug }), className: "text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors text-sm font-medium", children: "← Back to Connections" }),
          /* @__PURE__ */ jsx(ChevronRight, { size: 14, className: "text-slate-300 dark:text-slate-600" }),
          /* @__PURE__ */ jsxs("span", { className: "text-slate-500 text-sm", children: [
            "Store: ",
            /* @__PURE__ */ jsx("strong", { className: "text-slate-700 dark:text-white font-semibold", children: connection.name })
          ] })
        ] }),
      ...
      status === "pending" ? /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-7 space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900/60 dark:backdrop-blur-xl border border-slate-100 dark:border-slate-800/80 rounded-2xl p-6 shadow-sm", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
              /* @__PURE__ */ jsx(Sparkles, { className: "text-violet-500 w-5 h-5 animate-pulse" }),
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-slate-800 dark:text-white", children: "Zero-Configuration Setup" })
            ] }),
            /* @__PURE__ */ jsxs("p", { className: "text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-6 relative before:absolute before:left-6 before:top-2 before:bottom-2 before:w-[2px] before:bg-slate-100 dark:before:bg-slate-800/60", children: [
              /* @__PURE__ */ jsxs("div", { className: "relative flex gap-5 items-start group", children: [
                /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-2xl bg-violet-50 dark:bg-violet-950/30 border border-violet-100 dark:border-violet-800/50 flex items-center justify-center font-bold text-violet-600 dark:text-violet-400 text-base z-10 shadow-sm transition-transform group-hover:scale-105", children: /* @__PURE__ */ jsx(Download, { className: "w-5 h-5" }) }),
                /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-2.5", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("h3", { className: "font-semibold text-slate-800 dark:text-white text-sm", children: "Download your Custom Plugin" }),
                    /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 text-xs mt-0.5", children: "Contains pre-configured security handshakes and credentials baked directly inside." })
                  ] }),
                  /* @__PURE__ */ jsxs(
                    "a",
                    {
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative flex gap-5 items-start group", children: [
                /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-800/60 flex items-center justify-center font-bold text-slate-600 dark:text-slate-400 text-base z-10 shadow-sm transition-transform group-hover:scale-105", children: /* @__PURE__ */ jsx(Globe, { className: "w-5 h-5" }) }),
                /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-2", children: [
                  /* @__PURE__ */ jsx("h3", { className: "font-semibold text-slate-800 dark:text-white text-sm", children: "Install & Activate on WordPress" }),
                  /* @__PURE__ */ jsxs("p", { className: "text-slate-500 dark:text-slate-400 text-xs leading-relaxed", children: [
                    "Go to your WordPress Admin Dashboard, click ",
                    /* @__PURE__ */ jsx("strong", { className: "text-slate-700 dark:text-slate-300", children: "Plugins → Add New → Upload Plugin" }),
                    ", choose the downloaded ZIP, and click ",
                    /* @__PURE__ */ jsx("strong", { className: "text-slate-700 dark:text-slate-300", children: "Activate" }),
                    "."
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "relative flex gap-5 items-start group", children: [
                /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-800/60 flex items-center justify-center font-bold text-slate-600 dark:text-slate-400 text-base z-10 shadow-sm transition-transform group-hover:scale-105", children: /* @__PURE__ */ jsx(Zap, { className: "w-5 h-5 animate-pulse text-amber-500" }) }),
                /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                  /* @__PURE__ */ jsx("h3", { className: "font-semibold text-slate-800 dark:text-white text-sm", children: "Watch the connection happen" }),
                  /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 text-xs mt-0.5 leading-relaxed", children: "Once active, the plugin securely reaches back to VenQore, generates API keys, sets up hooks, and validates the connection instantly." })
                ] })
              ] })
            ] })
          ] }),
        ...
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-5", children: /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-b from-slate-900 to-slate-950 dark:from-slate-950 dark:to-black text-white rounded-3xl p-8 text-center relative overflow-hidden border border-slate-850 dark:border-slate-900/60 shadow-xl shadow-slate-900/10 flex flex-col justify-between min-h-[480px] gap-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-2 mt-2 relative z-10", children: [
            ...
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-slate-100", children: "Connecting to WooCommerce" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400 max-w-[280px] mx-auto", children: "Ensure your WordPress site is public and online. We are listening for the secure handshake payload." })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "relative flex items-center justify-center my-2 h-24 z-10", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-gradient-to-tr from-violet-600 to-indigo-600 text-white flex items-center justify-center shadow-lg shadow-violet-500/30 relative z-20", children: /* @__PURE__ */ jsx(Loader2, { className: "w-5 h-5 animate-spin text-white" }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-4 relative z-10 mb-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-slate-900/50 border border-slate-800/80 rounded-2xl p-4 space-y-3 text-left", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-slate-500 uppercase tracking-wider", children: "WordPress Site URL" }),
              ...
              isEditingUrl ? /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "text-xs font-mono text-slate-300 break-all bg-slate-950/40 p-2 rounded-lg border border-slate-850 truncate select-all", title: siteUrl, children: siteUrl }),
                /* @__PURE__ */ jsxs(
                  "a",
                  {
                ...
                /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400", children: "Not provided. Add site URL to enable remote handshake execution." }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    onClick: () => setIsEditingUrl(true),
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx("div", { className: "text-xs font-semibold text-slate-400", children: "STATUS" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "max-w-3xl mx-auto py-8", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900/60 dark:backdrop-blur-xl border border-emerald-100 dark:border-emerald-950/60 rounded-3xl p-8 md:p-12 text-center shadow-xl shadow-emerald-500/5 relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative z-10 space-y-6", children: [
            /* @__PURE__ */ jsx("div", { className: "w-20 h-20 rounded-3xl bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-100 dark:border-emerald-800/40 flex items-center justify-center mx-auto shadow-md animate-bounce", children: /* @__PURE__ */ jsx(Check, { className: "text-emerald-500 w-10 h-10 stroke-[3px]" }) }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ jsx("h2", { className: "text-2xl md:text-3xl font-extrabold text-slate-850 dark:text-white", children: "Store Successfully Synced! 🎉" }),
              /* @__PURE__ */ jsxs("p", { className: "text-slate-500 dark:text-slate-400 text-sm max-w-lg mx-auto leading-relaxed", children: [
                "Secure handshake completed with WooCommerce at ",
                /* @__PURE__ */ jsx("span", { className: "font-semibold text-slate-700 dark:text-slate-200", children: siteUrl }),
                ". VenQore has automatically initiated the initial product import."
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "py-2.5 max-w-sm mx-auto bg-slate-50 dark:bg-slate-800/40 rounded-2xl border border-slate-100 dark:border-slate-800/40 flex items-center justify-center gap-3", children: [
              /* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 animate-spin text-emerald-500" }),
              /* @__PURE__ */ jsx("span", { className: "text-xs text-slate-650 dark:text-slate-355 font-medium", children: "Redirecting to operations control..." })
            ] }),
      ...
      showManual && /* @__PURE__ */ jsxs("div", { className: "border border-slate-150 dark:border-slate-800/80 bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm animate-slide-up space-y-5", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsx(AlertCircle, { className: "text-amber-500 w-5 h-5 flex-shrink-0 mt-0.5" }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h4", { className: "font-bold text-slate-800 dark:text-white text-sm", children: "Manual Setup Protocol" }),
            /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 text-xs mt-0.5", children: "If firewall rules or local network configurations prevent the automated handshake, you can configure the plugin manually." })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsx("label", { className: "text-xs font-semibold text-slate-500 uppercase tracking-wider", children: "VenQore Host URL" }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 bg-slate-50 dark:bg-slate-800 rounded-xl p-3 border border-slate-100 dark:border-slate-800/40", children: [
              /* @__PURE__ */ jsx("code", { className: "text-xs font-mono text-slate-700 dark:text-slate-300 flex-1 truncate", children: window.location.origin }),
              /* @__PURE__ */ jsx(
                "button",
                {
                  onClick: copyApiUrl,
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsx("label", { className: "text-xs font-semibold text-slate-500 uppercase tracking-wider", children: "Authentication Token" }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 bg-slate-50 dark:bg-slate-800 rounded-xl p-3 border border-slate-100 dark:border-slate-800/40", children: [
              /* @__PURE__ */ jsx("code", { className: "text-xs font-mono text-slate-700 dark:text-slate-300 flex-1 truncate", children: plain_token ?? "(token expired - recreate connection)" }),
              /* @__PURE__ */ jsx(
                "button",
                {
                  onClick: copyToken,
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-4 bg-slate-50 dark:bg-slate-800/30 rounded-xl text-xs text-slate-500 dark:text-slate-400 leading-relaxed border border-slate-100 dark:border-slate-800/30", children: [
          /* @__PURE__ */ jsx("strong", { children: "How to use manual credentials:" }),
          " Open your WordPress Dashboard, navigate to ",
          /* @__PURE__ */ jsx("strong", { className: "text-slate-700 dark:text-slate-300", children: "VenQore Sync" }),
          ", scroll to the bottom, paste the Host URL and the Authentication Token, and click ",
          /* @__PURE__ */ jsx("strong", { className: "text-slate-700 dark:text-slate-300", children: "Save & Connect" }),
          "."
        ] })
      ] })
    ] })
