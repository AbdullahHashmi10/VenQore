  ...
  return /* @__PURE__ */ jsxs(
    ToolShell,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: `rounded-2xl overflow-hidden shadow-xl shadow-slate-900/10 dark:shadow-black/40 border border-slate-900/10 dark:border-white/10 bg-white mx-auto ${isThermal ? "max-w-xs" : "max-w-md"}`, children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(
                EditableText,
                {
                  ...
                  className: `block text-center font-bold uppercase ${isThermal ? "text-sm" : "text-base"}`
                }
              ),
              /* @__PURE__ */ jsx(
                EditableText,
                {
                  ...
                  as: "textarea",
                  rows: 1,
                  className: "block text-center text-slate-500 text-[10px] mt-0.5"
                }
              ),
              ...
              /* @__PURE__ */ jsxs("table", { className: "w-full mb-1", children: [
                /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "text-left text-[9px] font-bold uppercase tracking-wide text-slate-400 border-b border-slate-900", children: [
                  /* @__PURE__ */ jsx("th", { className: "pb-1 pr-1", children: "Item" }),
                  /* @__PURE__ */ jsx("th", { className: "pb-1 px-1 text-right w-10", children: "Qty" }),
                  /* @__PURE__ */ jsx("th", { className: "pb-1 pl-1 text-right w-16", children: "Total" }),
