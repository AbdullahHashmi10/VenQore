...
import { LayoutDashboard, Users, Settings, ShieldCheck, Activity, Database } from "lucide-react";
import "axios";
import "../ssr.js";
...
function AdminHome({ stats, auth }) {
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Admin Hub", mode: "admin", children: [
    /* @__PURE__ */ jsx(Head, { title: "Admin Hub" }),
    /* @__PURE__ */ jsxs("div", { className: "h-full flex flex-col relative overflow-y-auto custom-scrollbar p-6 md:p-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10", children: [
        /* @__PURE__ */ jsx(
          FeatureCard,
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-8 bg-white dark:bg-black/20 rounded-3xl p-8 border border-slate-200 dark:border-white/5 backdrop-blur-sm relative z-10 flex flex-col shadow-sm", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-0 flex justify-between items-center mb-6 border-b-0", children: [
          /* @__PURE__ */ jsxs("h3", { className: "font-bold text-xl text-slate-800 dark:text-white flex items-center gap-3", children: [
            /* @__PURE__ */ jsx(Activity, { className: "w-6 h-6 text-indigo-500 dark:text-indigo-400" }),
            "Recent System Activity"
          ] }),
          /* @__PURE__ */ jsx("button", { className: "text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 font-bold transition-colors", children: "View All Logs" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "text-center text-slate-400 py-8", children: /* @__PURE__ */ jsx("p", { children: "No recent system activity to display." }) })
      ] })
    ] })
  ] });
}
