  ...
  return /* @__PURE__ */ jsx("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }, children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { style: { fontWeight: 800, fontSize: 18, color: "var(--text-main,rgb(var(--vq-slate-900)))" }, children: "Invite a Team Member" }),
      ...
      /* @__PURE__ */ jsx("button", { onClick: onClose, style: { padding: 6, borderRadius: 8, border: "1px solid rgb(var(--vq-slate-200))", background: "transparent", cursor: "pointer", color: vq.slate[500] }, children: /* @__PURE__ */ jsx(X, { size: 16 }) })
    ] }),
...
function EditMemberModal({ member, storeId, onClose }) {
  ...
  return /* @__PURE__ */ jsx("div", { style: { position: "fixed", inset: 0, zIndex: 50, background: "rgba(0,0,0,0.5)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }, children: /* @__PURE__ */ jsxs("div", { style: { background: "var(--card-bg,#fff)", border: "1px solid rgb(var(--vq-slate-200))", borderRadius: 24, padding: 30, width: "100%", maxWidth: 400, boxShadow: "0 24px 60px rgba(0,0,0,0.15)" }, children: [
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }, children: [
      /* @__PURE__ */ jsxs("div", { style: { fontWeight: 800, fontSize: 16, color: "var(--text-main,rgb(var(--vq-slate-900)))" }, children: [
        "Edit ",
        member.name
      ] }),
      /* @__PURE__ */ jsx("button", { onClick: onClose, style: { padding: 6, borderRadius: 8, border: "1px solid rgb(var(--vq-slate-200))", background: "transparent", cursor: "pointer", color: vq.slate[500] }, children: /* @__PURE__ */ jsx(X, { size: 14 }) })
    ] }),
      ...
      "tr",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("td", { style: { padding: "14px 20px" }, children: /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { style: { fontWeight: 700, fontSize: 13, color: "var(--text-main,rgb(var(--vq-slate-900)))", display: "flex", alignItems: "center", gap: 6 }, children: [
          ...
          /* @__PURE__ */ jsx("td", { style: { padding: "14px 16px", textAlign: "right" }, children: canManage && !isOwner && /* @__PURE__ */ jsxs("div", { style: { position: "relative", display: "inline-block" }, children: [
            ...
            menuOpen && /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              /* @__PURE__ */ jsxs("div", { style: { position: "absolute", right: 0, top: "100%", marginTop: 4, zIndex: 40, background: "var(--card-bg,#fff)", border: "1px solid rgb(var(--vq-slate-200))", borderRadius: 12, boxShadow: "0 8px 24px rgba(0,0,0,0.1)", minWidth: 160, overflow: "hidden" }, children: [
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    onClick: () => {
...
function StaffIndex({ members, join_code, store_id }) {
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { mode: "admin", activeMenu: "Staff Management", children: [
    /* @__PURE__ */ jsx(Head, { title: tt("Staff Management") }),
    ...
    /* @__PURE__ */ jsxs("div", { style: { maxWidth: 1100, margin: "0 auto", padding: "28px 24px 64px" }, children: [
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 28, flexWrap: "wrap", gap: 12 }, children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("h1", { style: { fontSize: 22, fontWeight: 800, color: "var(--text-main,rgb(var(--vq-slate-900)))", margin: 0, display: "flex", alignItems: "center", gap: 10 }, children: [
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 14, marginBottom: 20, flexWrap: "wrap" }, children: [
        /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 200, display: "flex", alignItems: "center", gap: 10, background: "var(--card-bg,#fff)", border: "1px solid var(--card-border,rgb(var(--vq-slate-200)))", borderRadius: 12, padding: "0 14px" }, children: [
        ...
        canManage && join_code && /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, background: "var(--card-bg,#fff)", border: "1px solid rgb(var(--vq-slate-200))", borderRadius: 12, padding: "8px 16px" }, children: [
          /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: vq.slate[400], maxWidth: 120 }, children: tt("Staff can join instantly at the Join page") })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { style: { background: "var(--card-bg,#fff)", border: "1px solid var(--card-border,rgb(var(--vq-slate-200)))", borderRadius: 20, overflow: "hidden", boxShadow: "0 2px 12px rgba(0,0,0,0.04)" }, children: /* @__PURE__ */ jsxs("table", { style: { width: "100%", borderCollapse: "collapse" }, children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { style: { borderBottom: "1px solid var(--card-border,rgb(var(--vq-slate-100)))" }, children: ["Member", "Role", "Status", "POS PIN", "Joined", "Actions"].map((h) => /* @__PURE__ */ jsx("th", { style: { padding: "12px 16px", textAlign: h === "Actions" ? "right" : "left", fontSize: 11, fontWeight: 700, color: vq.slate[400], letterSpacing: "0.05em", textTransform: "uppercase" }, children: h === "Actions" && !canManage ? "" : h }, h)) }) }),
        /* @__PURE__ */ jsxs("tbody", { children: [
          filtered.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsxs("td", { colSpan: 6, style: { padding: "48px", textAlign: "center" }, children: [
            ...
            /* @__PURE__ */ jsx("div", { style: { color: vq.slate[400], fontSize: 14 }, children: search ? "No members match your search." : tt("No team members yet. Invite your first staff member!") })
          ] }) }),
      ...
      /* @__PURE__ */ jsxs("div", { style: { marginTop: 24, padding: "16px 20px", background: "var(--card-bg,#fff)", border: "1px solid var(--card-border,rgb(var(--vq-slate-200)))", borderRadius: 16 }, children: [
