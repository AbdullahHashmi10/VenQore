...
function DiscountReport({ invoices = [], filters = {} }) {
  ...
  const severityData = useMemo(() => {
    ...
    return [
      { name: "Light (<5%)", value: low, color: "#10b981" },
      // Emerald
      { name: "Standard (5-15%)", value: medium, color: "#3b82f6" },
      // Blue
      { name: "Heavy (>15%)", value: high, color: "#f43f5e" }
      // Rose
    ].filter((d) => d.value > 0);
  }, [processedData]);
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 h-full min-h-0 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-sm flex-1 min-h-0 flex flex-col", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "flex-1 w-full h-full min-h-0", children: topCustomers.length > 0 ? /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", minWidth: 1, minHeight: 1, children: /* @__PURE__ */ jsxs(BarChart, { data: topCustomers, layout: "vertical", margin: { left: 10, right: 30 }, children: [
              ...
              /* @__PURE__ */ jsx(Bar, { dataKey: "value", fill: "#f43f5e", radius: [0, 4, 4, 0], barSize: 16, background: { fill: "transparent" } })
            ] }) }) : /* @__PURE__ */ jsx("div", { className: "h-full flex items-center justify-center text-xs text-slate-400 italic", children: "No data" }) })
          ] })
        ] })
      ] })
  ...
  return /* @__PURE__ */ jsx(
    "th",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: `flex items-center gap-1.5 ${align === "right" ? "justify-end" : "justify-start"}`, children: [
        label,
        /* @__PURE__ */ jsxs("div", { className: `flex flex-col text-[8px] leading-none ${isActive ? "text-rose-500" : "text-slate-300 group-hover:text-slate-400"}`, children: [
...
function DiscountBadge({ pct }) {
  if (pct < 5) return /* @__PURE__ */ jsxs("span", { className: "px-2 py-0.5 bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 text-[10px] font-bold rounded", children: [
    pct.toFixed(1),
    "%"
  ] });
  if (pct < 15) return /* @__PURE__ */ jsxs("span", { className: "px-2 py-0.5 bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 text-[10px] font-bold rounded", children: [
    pct.toFixed(1),
    "%"
  ] });
  return /* @__PURE__ */ jsxs("span", { className: "px-2 py-0.5 bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-400 text-[10px] font-bold rounded animate-pulse", children: [
    pct.toFixed(1),
    "%"
  ] });
}
