      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-brand-500/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(Calculator, { size: 17, className: "text-brand-500 dark:text-brand-300" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "Solve any two" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Type into any two fields — cost, price, margin % or markup % — and the other two update live." })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-5", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "absolute right-3.5 top-1/2 -translate-y-1/2 text-ink-muted text-sm", children: "%" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
          ...
          ].map(([label, val]) => /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-2xl vq-tool-inset text-center", children: [
            /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: label }),
            /* @__PURE__ */ jsx("p", { className: "text-xl font-bold text-ink", children: val })
          ] }, label)) }),
          Number.isFinite(parseFloat(solved.cost)) && Number.isFinite(parseFloat(solved.price)) && /* @__PURE__ */ jsxs("p", { className: "text-xs text-ink-muted mt-3 text-center", children: [
            "Profit per unit: ",
            /* @__PURE__ */ jsx("strong", { className: "text-ink-secondary", children: fmtMoney(parseFloat(solved.price) - parseFloat(solved.cost)) })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-6 vq-tool-panel vq-tool-panel--pad", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-brand-500/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(TrendingUp, { size: 17, className: "text-brand-500 dark:text-brand-300" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "Price to hit a target" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Give a cost and a goal, get the price that hits it exactly." })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-5", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-2xl vq-tool-inset", children: [
              ...
              targetByMargin.error ? /* @__PURE__ */ jsx("p", { className: "text-xs text-amber-600 dark:text-amber-400", children: targetByMargin.error }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Suggested price" }),
                /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-ink", children: fmtMoney(targetByMargin.price) }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-2xl vq-tool-inset", children: [
              ...
              targetByMarkup.error ? /* @__PURE__ */ jsx("p", { className: "text-xs text-amber-600 dark:text-amber-400", children: targetByMarkup.error }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Suggested price" }),
                /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-ink", children: fmtMoney(targetByMarkup.price) }),
                /* @__PURE__ */ jsxs("p", { className: "text-xs text-ink-muted mt-1", children: [
                  "Profit per unit: ",
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-6 vq-tool-panel vq-tool-panel--pad", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "Bulk mode" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Price a whole product list at once, then export the results as CSV." })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsx("div", { className: "overflow-x-auto rounded-2xl border border-line", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm min-w-[720px]", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { className: "bg-sunken text-left", children: ["Product", "Cost", "Price", "Profit", "Margin %", "Markup %", ""].map((h) => /* @__PURE__ */ jsx("th", { className: "px-3 py-2.5 font-bold text-ink-secondary text-xs uppercase tracking-wide", children: h }, h)) }) }),
            /* @__PURE__ */ jsx("tbody", { children: bulkResults.map((r, i) => /* @__PURE__ */ jsxs("tr", { className: "border-t border-line", children: [
              ...
              /* @__PURE__ */ jsx("td", { className: "px-3 py-2 text-ink-secondary whitespace-nowrap", children: fmtMoney(r.profit) }),
              /* @__PURE__ */ jsx("td", { className: "px-3 py-2 text-ink-secondary whitespace-nowrap", children: r.note ? /* @__PURE__ */ jsx("span", { className: "text-amber-600 dark:text-amber-400 text-xs", children: r.note }) : fmtPct(r.marginPct) }),
              /* @__PURE__ */ jsx("td", { className: "px-3 py-2 text-ink-secondary whitespace-nowrap", children: r.note ? "—" : fmtPct(r.markupPct) }),
        ...
        /* @__PURE__ */ jsxs("section", { className: "mt-12", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold mb-4 text-ink", children: "Margin vs. markup — what's the difference?" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-4 mb-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad", children: [
              /* @__PURE__ */ jsx("p", { className: "font-bold text-ink mb-1", children: "Margin formula" }),
              /* @__PURE__ */ jsx("p", { className: "font-mono text-sm text-brand-600 dark:text-brand-300", children: "margin % = (price − cost) ÷ price × 100" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad", children: [
              /* @__PURE__ */ jsx("p", { className: "font-bold text-ink mb-1", children: "Markup formula" }),
              /* @__PURE__ */ jsx("p", { className: "font-mono text-sm text-brand-600 dark:text-brand-300", children: "markup % = (price − cost) ÷ cost × 100" })
            ] })
          ] }),
