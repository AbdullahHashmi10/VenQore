...
function CouponsIndex({ coupons, plans }) {
  ...
  return /* @__PURE__ */ jsxs(PlatformShell, { title: "Coupon Management", mode: "admin", activeMenu: "Coupons", children: [
    /* @__PURE__ */ jsxs("div", { style: { padding: "32px 40px", minHeight: "100vh", background: vq.slate[950] }, children: [
      ...
      ].map((stat) => /* @__PURE__ */ jsxs("div", { style: { background: vq.slate[900], borderRadius: 12, border: "1px solid #1e293b", padding: "16px 20px" }, children: [
      ...
      /* @__PURE__ */ jsx("div", { style: { background: vq.slate[900], borderRadius: 16, border: "1px solid #1e293b", overflow: "hidden" }, children: /* @__PURE__ */ jsxs("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: 14 }, children: [
