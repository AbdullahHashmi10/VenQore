...
import { P as PrintButton } from "./PrintButton-BUFh9uH-.js";
import "marked";
                ...
                switch (col.key) {
                  ...
                  case "invoice_number":
                    return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      ...
                      vensynq_enabled && row.is_jit && row.approval_status === "draft" && /* @__PURE__ */ jsx("span", { className: "text-2xs font-black bg-amber-50 border border-amber-200/50 text-amber-600 dark:bg-amber-950/40 dark:border-amber-900/40 dark:text-amber-400 px-1.5 py-0.5 rounded uppercase tracking-wide", children: "JIT Draft" })
                    ] });
                  case "supplier_name":
                  ...
                  case "status": {
                    ...
                    return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
                      /* @__PURE__ */ jsx("span", { className: `px-2 py-1 rounded-md text-2xs font-bold uppercase w-fit ${statusStyles[paymentStatus] || "bg-slate-100 text-slate-700"}`, children: paymentStatus }),
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-3xs font-black uppercase bg-orange-100 text-orange-700 dark:bg-orange-500/20 dark:text-orange-400 px-2 py-0.5 rounded border border-orange-200/30", children: "Purchase" }),
                  isJitDraft && /* @__PURE__ */ jsx("span", { className: "text-3xs font-black bg-amber-50 border border-amber-200/50 text-amber-600 dark:bg-amber-950/40 dark:border-amber-900/40 dark:text-amber-400 px-2 py-0.5 rounded uppercase tracking-wide", children: "JIT Draft" }),
                  /* @__PURE__ */ jsx("span", { className: `px-2 py-0.5 rounded text-3xs font-bold uppercase ${statusStyles[paymentStatus] || "bg-slate-100 text-slate-700"}`, children: paymentStatus })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-t border-slate-100 dark:border-slate-800/60 pt-2 mt-1", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      balance > 1 ? /* @__PURE__ */ jsx("span", { className: "text-xs font-black text-red-500", children: renderCurrency(balance) }) : /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-emerald-600 dark:text-emerald-450 bg-emerald-50 dark:bg-emerald-950/40 px-2 py-0.5 rounded border border-emerald-500/10", children: "Settled" })
                    ] })
                  ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-slate-50 to-white dark:from-slate-800 dark:to-slate-900 shrink-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              ...
              (() => {
                ...
                return /* @__PURE__ */ jsx("span", { className: `px-2 py-1 rounded-full text-2xs font-bold uppercase ${statusStyles[ps] || "bg-slate-100 text-slate-700"}`, children: ps });
              })()
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(
            ...
            /* @__PURE__ */ jsxs("div", { className: "border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "bg-slate-50 dark:bg-slate-800 px-4 py-3 border-t border-slate-200 dark:border-slate-700", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-6", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "text-right border-l border-slate-200 dark:border-slate-700 pl-6", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-2xs text-slate-400 uppercase", children: "Paid" }),
                  /* @__PURE__ */ jsx("p", { className: "font-bold text-emerald-600", children: renderCurrency(quickViewItem.paid || 0) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-2xs text-slate-400 uppercase", children: "Balance" }),
