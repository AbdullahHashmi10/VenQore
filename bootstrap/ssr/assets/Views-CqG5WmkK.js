...
const LINE_COLORS$1 = {
  ...
  summary: vq.slate[100],
  // near-white
  duration: vq.slate[600],
  // muted
  error: vq.red[400],
  // light red
  trace: vq.slate[500],
  // slate
  divider: vq.slate[800],
  // barely visible
  info: vq.slate[400]
  // default slate
};
function StatusBadge({ status }) {
  const configs = {
    [STATUS$1.IDLE]: { color: vq.slate[500], bg: "rgba(100,116,139,0.1)", label: "Idle" },
    [STATUS$1.RUNNING]: { color: vq.amber[500], bg: "rgba(245,158,11,0.1)", label: "Running…" },
    [STATUS$1.PASSED]: { color: vq.emerald[500], bg: "rgba(16,185,129,0.1)", label: "All Passed" },
    [STATUS$1.FAILED]: { color: vq.red[500], bg: "rgba(239,68,68,0.1)", label: "Failed" }
  };
...
function LineRow({ item, index }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    item.type === "pass" && /* @__PURE__ */ jsx("span", { style: { color: vq.emerald[500], marginRight: 4 }, children: "✓" }),
    item.type === "fail" && /* @__PURE__ */ jsx("span", { style: { color: vq.red[500], marginRight: 4 }, children: "✗" }),
    item.type === "skip" && /* @__PURE__ */ jsx("span", { style: { color: vq.amber[500], marginRight: 4 }, children: "–" }),
    item.text.replace(/^[✓✗⨯]\s*/, "")
  ] });
}
function SmokeTestRunner({ category = "all", onComplete }) {
  ...
  const borderColor = {
    [STATUS$1.IDLE]: vq.slate[700],
    [STATUS$1.RUNNING]: vq.amber[500],
    [STATUS$1.PASSED]: vq.emerald[500],
    [STATUS$1.FAILED]: vq.red[500]
  }[status];
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "12px" }, children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
            /* @__PURE__ */ jsx("h3", { style: { color: vq.slate[100], margin: 0, fontSize: "0.9rem", fontWeight: 700 }, children: "Production Smoke Tests" }),
            /* @__PURE__ */ jsx(StatusBadge, { status })
          ] }),
          /* @__PURE__ */ jsx("p", { style: { color: vq.slate[600], margin: "2px 0 0", fontSize: "0.75rem" }, children: "38 read-only checks · safe to run on live server" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
        isRunning && /* @__PURE__ */ jsxs("span", { style: { color: vq.slate[500], fontSize: "0.78rem", fontVariantNumeric: "tabular-nums" }, children: [
          "⏱ ",
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            style: {
              ...
              border: `1px solid ${isRunning ? vq.amber[500] : status === STATUS$1.PASSED ? vq.emerald[500] : status === STATUS$1.FAILED ? vq.red[500] : vq.indigo[500]}`,
              color: isRunning ? vq.amber[500] : status === STATUS$1.PASSED ? vq.emerald[500] : status === STATUS$1.FAILED ? vq.red[500] : "#fff",
              padding: "8px 18px",
              borderRadius: "10px",
    ...
    status === STATUS$1.IDLE && lines.length === 0 && /* @__PURE__ */ jsxs("div", { style: {
      ...
      "Click ",
      /* @__PURE__ */ jsx("strong", { style: { color: vq.indigo[500] }, children: "Run Smoke Tests" }),
      " to verify the production environment is healthy.",
      /* @__PURE__ */ jsx("br", {}),
      /* @__PURE__ */ jsx("span", { style: { fontSize: "0.72rem", color: vq.slate[800], marginTop: 6, display: "block" }, children: "Checks DB · Tables · Cache · Storage · Routes · API · Logs" })
    ] }),
    isDone && /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { style: {
          color: status === STATUS$1.PASSED ? vq.emerald[500] : vq.red[500],
          fontSize: "0.84rem",
          fontWeight: 600
        ...
        /* @__PURE__ */ jsxs("div", { style: { color: vq.slate[600], fontSize: "0.72rem", marginTop: "2px" }, children: [
          counts.pass,
          " passed · ",
          counts.fail,
          " failed · ",
...
function StatCard({ label, value, icon: Icon, color = vq.indigo[500], sub }) {
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { style: { fontSize: 22, fontWeight: 700, color: vq.slate[50], lineHeight: 1 }, children: value ?? "—" }),
      /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: vq.slate[400], marginTop: 3 }, children: label }),
      sub && /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: vq.slate[500], marginTop: 2 }, children: sub })
    ] })
  ] });
}
...
This takes 10–30 seconds.`;
  ...
  if (loading) {
    return /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", height: 240, gap: 10, color: vq.slate[400] }, children: [
  ...
  if (!data?.exists) {
    return /* @__PURE__ */ jsxs("div", { style: { maxWidth: "600px", margin: "40px auto", display: "flex", flexDirection: "column", gap: 20 }, children: [
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsx(Monitor, { size: 40, style: { margin: "0 auto 16px", color: vq.indigo[500], opacity: 0.8 } }),
        /* @__PURE__ */ jsx("h3", { style: { fontWeight: 700, fontSize: "1.25rem", color: vq.slate[50], marginBottom: 8 }, children: "No Demo Store Found" }),
        /* @__PURE__ */ jsxs("p", { style: { fontSize: 14, color: vq.slate[400], marginBottom: 24 }, children: [
          "No tenant with ",
        ...
        ) : /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 8, color: vq.slate[300], fontSize: 14, fontWeight: 600 }, children: [
          /* @__PURE__ */ jsx(RefreshCw, { size: 16, className: "animate-spin", style: { color: vq.indigo[500] } }),
          /* @__PURE__ */ jsx("span", { children: "Deploying Demo Store..." }),
          /* @__PURE__ */ jsxs("span", { style: { color: vq.slate[500], fontWeight: 400, marginLeft: 6 }, children: [
            "⏱ ",
      ...
      deployLines.length > 0 && /* @__PURE__ */ jsxs("div", { style: {
        ...
        backdropFilter: "blur(12px)",
        border: `1px solid ${deployStatus === STATUS.RUNNING ? vq.amber[500] : deployStatus === STATUS.PASSED ? vq.emerald[500] : vq.red[500]}`,
        borderRadius: "16px",
        padding: "20px 24px",
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
          /* @__PURE__ */ jsx("span", { style: { fontSize: 13, fontWeight: 700, color: vq.slate[50] }, children: "🛠️ Seeding Logs" }),
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 24 }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
        /* @__PURE__ */ jsx("div", { style: { width: 44, height: 44, borderRadius: 12, background: vq.indigo[500], display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsx(Monitor, { size: 20, style: { color: vq.indigo[500] } }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, fontWeight: 700, fontSize: 16, color: vq.slate[50] }, children: [
            "🎭 Demo Store",
            /* @__PURE__ */ jsxs("span", { style: {
              display: "inline-flex",
              alignItems: "center",
          ...
          /* @__PURE__ */ jsxs("div", { style: { fontSize: 12, color: vq.slate[400], marginTop: 2 }, children: [
    ...
    deployStatus !== STATUS.IDLE && /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "16px", flexWrap: "wrap", gap: 12 }, children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "12px" }, children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { style: { color: vq.slate[50], margin: 0, fontSize: "0.95rem", fontWeight: 700 }, children: "Demo Store Seeding & Deploy Logs" }),
            /* @__PURE__ */ jsx("p", { style: { color: vq.slate[400], margin: "2px 0 0", fontSize: "0.75rem" }, children: "Wiping and seeding data modules in real-time" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
          deployStatus === STATUS.RUNNING && /* @__PURE__ */ jsxs("span", { style: { color: vq.slate[500], fontSize: "0.78rem", fontVariantNumeric: "tabular-nums" }, children: [
            "⏱ ",
            deployElapsed < 60 ? `${deployElapsed}s` : `${Math.floor(deployElapsed / 60)}m ${deployElapsed % 60}s`
          ] }),
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(170px, 1fr))", gap: 12 }, children: [
      /* @__PURE__ */ jsx(StatCard, { label: "Live Right Now", value: data.live_now, icon: Activity, color: vq.emerald[500], sub: "Active demo sessions" }),
      /* @__PURE__ */ jsx(StatCard, { label: "Visitors Today", value: data.today?.toLocaleString(), icon: Users, color: vq.indigo[500] }),
      /* @__PURE__ */ jsx(StatCard, { label: "This Month", value: data.this_month?.toLocaleString(), icon: TrendingUp, color: vq.violet[500] }),
      /* @__PURE__ */ jsx(StatCard, { label: "All Time", value: data.total_all?.toLocaleString(), icon: Globe, color: vq.amber[500] })
    ] }),
    /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 280px", gap: 16 }, children: [
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsx("div", { style: { fontWeight: 700, fontSize: 14, color: vq.slate[100], marginBottom: 16 }, children: "Daily Visitors — Last 30 Days" }),
        /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 180, children: /* @__PURE__ */ jsxs(BarChart, { data: data.visitor_chart, margin: { top: 4, right: 4, left: -20, bottom: 0 }, children: [
          ...
          /* @__PURE__ */ jsx(XAxis, { dataKey: "date", tick: { fontSize: 10, fill: vq.slate[400] }, interval: 4 }),
          /* @__PURE__ */ jsx(YAxis, { tick: { fontSize: 10, fill: vq.slate[400] } }),
          /* @__PURE__ */ jsx(Tooltip, { contentStyle: { borderRadius: 8, border: "1px solid rgba(255, 255, 255, 0.08)", background: vq.slate[900], color: vq.slate[50], fontSize: 12 } }),
          /* @__PURE__ */ jsx(Bar, { dataKey: "total", fill: vq.indigo[500], radius: [3, 3, 0, 0], name: "Visitors" })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxs("div", { style: {
        background: "linear-gradient(135deg, rgba(30, 41, 59, 0.4) 0%, rgba(15, 23, 42, 0.55) 100%)",
        ...
        /* @__PURE__ */ jsx("div", { style: { fontWeight: 700, fontSize: 14, color: vq.slate[100], marginBottom: 16 }, children: "Role Breakdown (30d)" }),
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
          (data.role_breakdown ?? []).map((r) => {
            ...
            return /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", fontSize: 12, marginBottom: 3 }, children: [
                /* @__PURE__ */ jsx("span", { style: { fontWeight: 600, color: vq.slate[300], textTransform: "capitalize" }, children: r.role.replace("_", " ") }),
                /* @__PURE__ */ jsxs("span", { style: { color: vq.slate[400] }, children: [
                  r.total,
                  " (",
                  pct,
                  "%)"
          ...
          (!data.role_breakdown || data.role_breakdown.length === 0) && /* @__PURE__ */ jsx("p", { style: { fontSize: 12, color: vq.slate[400], textAlign: "center", padding: "20px 0" }, children: "No visitor data yet. Role breakdown will appear after the first demo login." })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsx("div", { style: { fontWeight: 700, fontSize: 14, color: vq.slate[100], marginBottom: 16 }, children: "📦 Data Population Coverage" }),
      /* @__PURE__ */ jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 10 }, children: [
        ...
        return /* @__PURE__ */ jsxs("div", { style: {
          ...
          populated ? /* @__PURE__ */ jsx(CheckCircle2, { size: 14, style: { color: vq.emerald[500], flexShrink: 0 } }) : /* @__PURE__ */ jsx(AlertTriangle$1, { size: 14, style: { color: vq.amber[500], flexShrink: 0 } }),
          /* @__PURE__ */ jsxs("div", { style: { minWidth: 0 }, children: [
            /* @__PURE__ */ jsx("div", { style: { fontSize: 12, fontWeight: 600, color: vq.slate[300] }, children: label }),
            /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: vq.slate[400] }, children: count > 0 ? `${count.toLocaleString()} records` : "Not seeded yet" })
          ] })
        ] }, key);
      }) }),
      Object.values(data.data_counts ?? {}).every((v) => v === 0) && /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", padding: "20px 0 4px", fontSize: 13, color: vq.slate[500] }, children: [
        "Run ",
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 16 }, children: [
      ...
      activeTestTab === "page-health" ? /* @__PURE__ */ jsxs("div", { style: {
        ...
        backdropFilter: "blur(12px)",
        WebkitBackdropFilter: "blur(12px)",
        border: `1px solid ${runnerStatus === STATUS.RUNNING ? vq.amber[500] : runnerStatus === STATUS.PASSED ? vq.emerald[500] : runnerStatus === STATUS.FAILED ? vq.red[500] : "rgba(255, 255, 255, 0.08)"}`,
        borderRadius: "16px",
        padding: "20px 24px",
        boxShadow: "0 8px 32px 0 rgba(0, 0, 0, 0.1)",
          ...
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "12px" }, children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px", flexWrap: "wrap" }, children: [
                /* @__PURE__ */ jsx("h3", { style: { color: vq.slate[50], margin: 0, fontSize: "0.95rem", fontWeight: 700 }, children: "Demo Store Page Health Tests" }),
                /* @__PURE__ */ jsx(RunnerStatusBadge, { status: runnerStatus })
              ] }),
              /* @__PURE__ */ jsx("p", { style: { color: vq.slate[400], margin: "2px 0 0", fontSize: "0.75rem" }, children: "35+ Authenticated GET checks across all active module sections" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
            runnerStatus === STATUS.RUNNING && /* @__PURE__ */ jsxs("span", { style: { color: vq.slate[500], fontSize: "0.78rem", fontVariantNumeric: "tabular-nums" }, children: [
              "⏱ ",
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                style: {
                  ...
                  border: `1px solid ${runnerStatus === STATUS.RUNNING ? vq.amber[500] : runnerStatus === STATUS.PASSED ? vq.emerald[500] : runnerStatus === STATUS.FAILED ? vq.red[500] : vq.emerald[500]}`,
        ...
        runnerStatus === STATUS.IDLE && runnerLines.length === 0 && /* @__PURE__ */ jsxs("div", { style: {
          ...
          "Click ",
          /* @__PURE__ */ jsx("strong", { style: { color: vq.emerald[500] }, children: "Run Page Tests" }),
          " to initiate a live health scan of all frontend routes.",
          /* @__PURE__ */ jsx("br", {}),
          /* @__PURE__ */ jsx("span", { style: { fontSize: "0.72rem", color: vq.slate[500], marginTop: 6, display: "block" }, children: "Simulates full Owner authentication · Scans P&L, POS, Staff, Inventory, Sales, CRM and 30+ pages" })
        ] }),
        runnerStatus !== STATUS.IDLE && runnerStatus !== STATUS.RUNNING && /* @__PURE__ */ jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { style: { color: vq.slate[500], fontSize: "0.72rem", marginTop: "2px" }, children: [
              runnerCounts.pass,
              " passed · ",
              runnerCounts.fail,
              " failed · ",
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 20 }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%,300px),1fr))", gap: 20 }, children: [
      ...
      /* @__PURE__ */ jsxs(Panel, { children: [
        ...
        totalEquityAllocated > 100 && /* @__PURE__ */ jsxs("div", { style: { padding: 10, background: "rgba(239,68,68,0.08)", border: "1px solid rgba(239,68,68,0.2)", borderRadius: 10, color: vq.red[400], fontSize: 12, display: "flex", gap: 8, alignItems: "center", marginBottom: 14 }, children: [
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    activeCategory && /* @__PURE__ */ jsx(
      Drawer,
      {
        ...
        width: 600,
        children: /* @__PURE__ */ jsx("div", { style: { background: vq.zinc[950], border: "1px solid rgba(255,255,255,0.06)", borderRadius: 12, padding: 10 }, children: /* @__PURE__ */ jsx(
          SmokeTestRunner,
          {
...
function SettingsView({ stats = {}, settings = {}, ai_keys = null }) {
  const t = useT();
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 20 }, children: [
    ...
    /* @__PURE__ */ jsx(AiKeysPanel, { t, aiKeys: ai_keys }),
    /* @__PURE__ */ jsxs(Note, { t, children: [
...
function KeyStatus({ slot }) {
  if (slot?.saved) return /* @__PURE__ */ jsxs(Badge, { color: BRAND.emerald, children: [
    "Saved · ends ",
    slot.last4
  ] });
  if (slot?.env) return /* @__PURE__ */ jsx(Badge, { color: BRAND.amber, children: "Using server .env key" });
  return /* @__PURE__ */ jsx(Badge, { color: BRAND.slate, children: "Not set" });
}
function KeyRow({ t, label, hint, field, slot, value, onChange, onRemove }) {
  return /* @__PURE__ */ jsx(Field, { label: /* @__PURE__ */ jsxs("span", { style: { display: "inline-flex", gap: 8, alignItems: "center" }, children: [
    label,
    " ",
    /* @__PURE__ */ jsx(KeyStatus, { slot })
  ] }), hint, children: /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 8 }, children: [
    /* @__PURE__ */ jsx(
      Input,
      {
        type: "password",
    ...
    slot?.saved && /* @__PURE__ */ jsx(Button, { type: "button", variant: "danger", size: "sm", onClick: () => onRemove(field), children: "Remove" })
  ] }) });
}
function AiKeysPanel({ t, aiKeys }) {
  ...
  return /* @__PURE__ */ jsxs(Panel, { children: [
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }, children: [
      /* @__PURE__ */ jsx(Bot, { size: 18, color: BRAND.emerald }),
      /* @__PURE__ */ jsx("span", { style: { fontSize: 14, fontWeight: 800, color: t.ink }, children: "AI provider keys" })
    ] }),
    /* @__PURE__ */ jsx("p", { style: { fontSize: 12.5, color: t.muted, margin: "0 0 16px" }, children: "Keys are stored encrypted and never shown again. A store's own key (BYOK) always wins over these. Owner only." }),
    /* @__PURE__ */ jsxs("form", { onSubmit: save, style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%,340px),1fr))", gap: 20 }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 12 }, children: [
        /* @__PURE__ */ jsx("span", { style: { fontSize: 12, fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.08em", color: t.sub }, children: "Free key" }),
        /* @__PURE__ */ jsx("span", { style: { fontSize: 12.5, color: t.muted }, children: "Public tools, the free plan, trials and staff previews." }),
        /* @__PURE__ */ jsx(
          KeyRow,
          {
            t,
            label: "Gemini free-tier key",
            hint: "Google AI Studio key on the free tier",
            field: "ai_free_gemini_api_key",
            slot: k.free,
            value: keys.ai_free_gemini_api_key,
            onChange: setKey,
            onRemove: remove
          }
        ),
        /* @__PURE__ */ jsx(Field, { label: "Free model (optional)", hint: "Blank = each feature's default Gemini model", children: /* @__PURE__ */ jsx(Input, { value: freeModel, onChange: (e) => setFreeModel(e.target.value), placeholder: "gemini-2.5-flash-lite" }) }),
        /* @__PURE__ */ jsx(
          ToggleRow,
          {
            t,
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 12 }, children: [
        /* @__PURE__ */ jsx("span", { style: { fontSize: 12, fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.08em", color: t.sub }, children: "Paid keys" }),
        /* @__PURE__ */ jsx("span", { style: { fontSize: 12.5, color: t.muted }, children: "Paying stores on managed AI (AI Shop / Pro / Max)." }),
        /* @__PURE__ */ jsx(Field, { label: "Active paid provider", children: /* @__PURE__ */ jsx(Select, { value: paidProvider, onChange: (e) => setPaidProvider(e.target.value), options: AI_PROVIDERS }) }),
        /* @__PURE__ */ jsx(Field, { label: "Paid model (optional)", hint: "Blank = each feature's default model for the provider", children: /* @__PURE__ */ jsx(Input, { value: paidModel, onChange: (e) => setPaidModel(e.target.value), placeholder: "e.g. claude-sonnet-4-5" }) }),
        /* @__PURE__ */ jsx(KeyRow, { t, label: "Gemini paid key", field: "ai_paid_gemini_api_key", slot: k.paid?.gemini, value: keys.ai_paid_gemini_api_key, onChange: setKey, onRemove: remove }),
        /* @__PURE__ */ jsx(KeyRow, { t, label: "Anthropic (Claude) key", field: "ai_paid_anthropic_api_key", slot: k.paid?.anthropic, value: keys.ai_paid_anthropic_api_key, onChange: setKey, onRemove: remove }),
        /* @__PURE__ */ jsx(KeyRow, { t, label: "OpenAI key", field: "ai_paid_openai_api_key", slot: k.paid?.openai, value: keys.ai_paid_openai_api_key, onChange: setKey, onRemove: remove }),
        /* @__PURE__ */ jsx(KeyRow, { t, label: "DeepSeek key", field: "ai_paid_deepseek_api_key", slot: k.paid?.deepseek, value: keys.ai_paid_deepseek_api_key, onChange: setKey, onRemove: remove })
      ] }),
      /* @__PURE__ */ jsx("div", { style: { gridColumn: "1 / -1" }, children: /* @__PURE__ */ jsx(Button, { type: "submit", children: "Save AI keys" }) })
    ] })
  ] });
}
function JobsView() {
...
function ToggleRow({ t, label, sub, active, onChange, last }) {
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12, padding: "12px 4px", borderBottom: last ? "none" : `1px solid ${t.rowBorder}` }, children: [
    ...
    /* @__PURE__ */ jsx("button", { type: "button", "aria-pressed": !!active, "aria-label": typeof label === "string" ? label : void 0, onClick: () => onChange?.(!active), className: "vq-press", style: { width: 44, height: 26, borderRadius: 999, border: "none", cursor: "pointer", background: active ? BRAND.emerald : t.border2, position: "relative", transition: "background .2s" }, children: /* @__PURE__ */ jsx("span", { style: { position: "absolute", top: 3, left: active ? 21 : 3, width: 20, height: 20, borderRadius: "50%", background: "#fff", transition: "left .2s", boxShadow: "0 1px 3px rgba(0,0,0,.3)" } }) })
  ] });
}
export {
  AppSumoView,
