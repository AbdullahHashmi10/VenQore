...
function PaymentFeeCalculator({ toolGroups = [] }) {
  ...
  return /* @__PURE__ */ jsxs(
    ToolShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(SmartCaptureNudge, { documentType: "payment fee details" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "flex gap-2 mb-6", children: [
          ...
          "button",
          {
            type: "button",
            onClick: () => setMode(key),
            className: `px-4 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wide transition-colors ${mode === key ? "bg-accent-fill text-accent-on" : "vq-tool-inset text-ink-secondary"}`,
            children: label
          },
          key
        )) }),
        /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-brand-500/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(CreditCard, { size: 17, className: "text-brand-500 dark:text-brand-300" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "Processor rates" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Illustrative defaults — edit any field to match your actual rate sheet." })
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "overflow-x-auto rounded-2xl border border-line mb-6", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm min-w-[640px]", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { className: "bg-sunken text-left", children: ["Processor", "Rate %", "Fixed fee", "Monthly fee"].map((h) => /* @__PURE__ */ jsx("th", { className: "px-3 py-2.5 font-bold text-ink-secondary text-xs uppercase tracking-wide", children: h }, h)) }) }),
            /* @__PURE__ */ jsx("tbody", { children: processors.map((p) => /* @__PURE__ */ jsxs("tr", { className: "border-t border-line", children: [
              /* @__PURE__ */ jsxs("td", { className: "px-3 py-2", children: [
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink", children: p.name }),
              ...
              /* @__PURE__ */ jsx("td", { className: "px-3 py-2 w-28", children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "absolute right-3 top-1/2 -translate-y-1/2 text-ink-muted text-xs", children: "%" })
              ] }) }),
              /* @__PURE__ */ jsx("td", { className: "px-3 py-2 w-28", children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsx("span", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-ink-muted text-xs", children: "$" }),
          ...
          mode === "single" ? /* @__PURE__ */ jsxs("div", { className: "max-w-xs mb-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx("span", { className: "absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-muted text-sm", children: "$" }),
          ...
          /* @__PURE__ */ jsx("div", { className: "overflow-x-auto rounded-2xl border border-line", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm min-w-[640px]", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { className: "bg-sunken text-left", children: (mode === "single" ? ["Processor", "Fee", "You receive"] : ["Processor", "Effective rate", "Total monthly fees", "Net revenue"]).map((h) => /* @__PURE__ */ jsx("th", { className: "px-3 py-2.5 font-bold text-ink-secondary text-xs uppercase tracking-wide", children: h }, h)) }) }),
            /* @__PURE__ */ jsx("tbody", { children: results.map((r) => {
              const isCheapest = cheapest && r.id === cheapest.id;
              return /* @__PURE__ */ jsxs("tr", { className: `border-t border-line ${isCheapest ? "bg-emerald-500/[0.06]" : ""}`, children: [
                /* @__PURE__ */ jsx("td", { className: "px-3 py-2.5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx("span", { className: "font-bold text-ink", children: r.name }),
                  isCheapest && /* @__PURE__ */ jsx("span", { className: "text-3xs font-bold uppercase tracking-wider px-1.5 py-0.5 rounded bg-emerald-500/20 text-emerald-700 dark:text-emerald-300", children: "Cheapest" })
                ] }) }),
                mode === "single" ? /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsx("td", { className: "px-3 py-2.5 text-ink-secondary whitespace-nowrap", children: fmtMoney(r.fee) }),
                  /* @__PURE__ */ jsx("td", { className: "px-3 py-2.5 font-bold text-ink whitespace-nowrap", children: fmtMoney(r.net) })
                ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsx("td", { className: "px-3 py-2.5 text-ink-secondary whitespace-nowrap", children: r.effectiveRate !== null ? `${round2(r.effectiveRate).toFixed(2)}%` : "—" }),
                  /* @__PURE__ */ jsx("td", { className: "px-3 py-2.5 text-ink-secondary whitespace-nowrap", children: fmtMoney(r.totalFees) }),
                  /* @__PURE__ */ jsx("td", { className: "px-3 py-2.5 font-bold text-ink whitespace-nowrap", children: fmtMoney(r.netRevenue) })
                ] })
              ] }, r.id);
            }) })
          ] }) }),
          mode === "monthly" && cheapest && /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-start gap-2 p-3 rounded-xl bg-brand-500/10 border border-brand-400/20", children: [
            /* @__PURE__ */ jsx(Info, { size: 16, className: "text-brand-500 dark:text-brand-300 mt-0.5 shrink-0" }),
            /* @__PURE__ */ jsxs("p", { className: "text-sm text-brand-700 dark:text-brand-300", children: [
              "At a ",
        ...
        /* @__PURE__ */ jsxs("section", { className: "mt-12", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold mb-4 text-ink", children: 'Why comparing "just the percentage" is misleading' }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl bg-brand-500/[0.06] dark:bg-brand-500/10 border border-brand-500/20 mb-6", children: [
            /* @__PURE__ */ jsx("p", { className: "font-bold text-ink mb-2", children: 'Worked example — the "cheapest" processor flips with ticket size' }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-secondary leading-relaxed mb-3", children: "Compare Processor A (2.6% + $0.10) against Processor B (2.9% + $0.30), 100 transactions per month:" }),
            /* @__PURE__ */ jsxs("p", { className: "text-sm text-ink-secondary leading-relaxed mb-2", children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold mb-4 text-ink", children: "Card-present vs. card-not-present rates" }),
