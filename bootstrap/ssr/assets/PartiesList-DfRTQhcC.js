...
import { L as LockedFeature, O as OneGlanceLayout } from "./OneGlanceLayout-D0x15wPs.js";
...
function PlanGate(props) {
  return /* @__PURE__ */ jsx(LockedFeature, { mode: "gate", ...props });
}
function PartiesIndex({ parties = {}, stats = {}, flash }) {
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Contacts", activeMenu: "Contacts", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full bg-app p-2 gap-1 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx(PlanGate, { feature: "outstanding_balance_grid", showUpgradeBadge: false, children: /* @__PURE__ */ jsxs("div", { className: `grid grid-cols-2 sm:grid-cols-4 gap-2 shrink-0 ${isStatsExpanded ? "grid" : "hidden sm:grid"}`, children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-2.5 py-2 rounded-xl border border-line shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1 bg-brand-100 dark:bg-brand-900/30 text-brand-600 dark:text-brand-400 rounded-lg shrink-0", children: /* @__PURE__ */ jsx(Users, { size: 14 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-2xs sm:text-xs font-bold text-ink-muted uppercase tracking-tight truncate", children: "Total Parties" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm sm:text-base md:text-lg font-bold text-ink leading-none mt-1 sm:mt-0", children: stats.total || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-2.5 py-2 rounded-xl border border-line shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:blue-400 rounded-lg shrink-0", children: /* @__PURE__ */ jsx(UserCheck, { size: 14 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-2xs sm:text-xs font-bold text-ink-muted uppercase tracking-tight truncate", children: tp("customer", "Customers") })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm sm:text-base md:text-lg font-bold text-blue-600 leading-none mt-1 sm:mt-0", children: stats.customers || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-2.5 py-2 rounded-xl border border-line shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-2xs sm:text-xs font-bold text-ink-muted uppercase tracking-tight truncate", children: "To Receive" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm sm:text-base md:text-lg font-bold text-emerald-600 leading-none mt-1 sm:mt-0", children: formatCurrency(stats.receivables) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-2.5 py-2 rounded-xl border border-line shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-2xs sm:text-xs font-bold text-ink-muted uppercase tracking-tight truncate", children: "Payables" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm sm:text-base md:text-lg font-bold text-rose-600 leading-none mt-1 sm:mt-0", children: formatCurrency(stats.payables) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxs("div", { className: "sm:hidden flex flex-col bg-surface rounded-xl border border-line shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-3 py-2", children: [
          /* @__PURE__ */ jsxs("h1", { className: "text-xs font-bold text-ink uppercase tracking-tight", children: [
            activeTab === "customers" ? tp("customer", "Customers") : activeTab === "suppliers" ? tp("supplier", "Suppliers") : "All",
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-brand-600", children: "Contacts" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center border-l border-line pl-1.5 ml-0.5", children: [
              ...
              /* @__PURE__ */ jsx("button", { className: "p-1 text-ink-muted hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded", title: "Print", children: /* @__PURE__ */ jsx(Printer, { size: 14 }) })
            ] }),
            /* @__PURE__ */ jsxs(
              "button",
              {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex bg-sunken rounded-lg p-1 gap-1 flex-1", children: [
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: tp("customer", "Customers")
              }
            ),
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: tp("supplier", "Suppliers")
              }
            )
          ] })
        ] }) })
      ...
      /* @__PURE__ */ jsxs("div", { className: "hidden sm:flex flex-row items-center justify-between gap-2 bg-surface px-3 py-2 rounded-xl border border-line shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between sm:justify-start gap-2 w-full sm:w-auto", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxs("h1", { className: "text-sm sm:text-lg font-bold text-ink uppercase tracking-tight shrink-0", children: [
              activeTab === "customers" ? tp("customer", "Customers") : activeTab === "suppliers" ? tp("supplier", "Suppliers") : "All",
              " ",
              /* @__PURE__ */ jsx("span", { className: "text-brand-600", children: "Contacts" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "hidden sm:block h-4 w-px bg-sunken mx-1" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 overflow-x-auto no-scrollbar py-0.5", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `px-2 py-0.5 text-3xs sm:text-2xs font-bold uppercase rounded-full transition-all shrink-0 ${typeFilter === "all" ? "bg-brand-600 text-white shadow-sm" : "bg-sunken text-ink-muted hover:bg-interactive-hover"}`,
                children: "All"
              }
            ),
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `px-2 py-0.5 text-3xs sm:text-2xs font-bold uppercase rounded-full transition-all shrink-0 ${typeFilter === "customer" ? "bg-gradient-to-r from-blue-500 to-cyan-600 text-white shadow-sm " : "bg-sunken text-ink-muted hover:bg-interactive-hover"}`,
                children: tp("customer", "Customers")
              }
            ),
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `px-2 py-0.5 text-3xs sm:text-2xs font-bold uppercase rounded-full transition-all shrink-0 ${typeFilter === "supplier" ? "bg-gradient-to-r from-amber-500 to-orange-600 text-white shadow-sm " : "bg-sunken text-ink-muted hover:bg-interactive-hover"}`,
                children: tp("supplier", "Suppliers")
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between sm:justify-end gap-2 w-full sm:w-auto", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-0.5 border-l border-line pl-1.5", children: [
              ...
              /* @__PURE__ */ jsx("button", { className: "p-1 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-lg text-ink-muted", title: "Print", children: /* @__PURE__ */ jsx(Printer, { size: 14 }) })
            ] }),
            /* @__PURE__ */ jsxs(
              "button",
              {
      ...
      selectedParties.length > 0 && /* @__PURE__ */ jsxs("div", { className: "bg-brand-600 text-white px-4 py-2 rounded-xl flex items-center justify-between shadow-lg animate-in slide-in-from-top-2 shrink-0", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-auto rounded-xl border border-line shadow-sm bg-surface", children: [
        /* @__PURE__ */ jsx("div", { className: "hidden sm:block", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-app border-b border-line sticky top-0 z-10", children: [
            ...
            /* @__PURE__ */ jsx("th", { className: "p-3 text-2xs font-bold text-ink-muted uppercase tracking-wider text-right", children: "Credit Limit" }),
            /* @__PURE__ */ jsx("th", { className: "p-3 text-2xs font-bold text-ink-muted uppercase tracking-wider", children: "Phone" }),
            /* @__PURE__ */ jsx("th", { className: "p-3 text-2xs font-bold text-ink-muted uppercase tracking-wider text-center", children: "Actions" })
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: sortedParties.length > 0 ? sortedParties.map((party) => {
 ...
 ${isOverdue ? "border-l-4 border-red-500 bg-rose-50/50 hover:bg-rose-100/50 dark:bg-rose-950/10 dark:hover:bg-rose-900/20" : party.type === "customer" ? "border-l-4 border-blue-500 hover:bg-brand-50/50 dark:hover:bg-brand-900/10" : "border-l-4 border-amber-500 hover:bg-brand-50/50 dark:hover:bg-brand-900/10"}
...
`,
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      party.email && /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted", children: party.email })
                    ] })
                  ] }) }),
                  /* @__PURE__ */ jsx("td", { className: "p-3 text-center", children: /* @__PURE__ */ jsx("span", { className: `inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-2xs font-bold uppercase ${party.type === "customer" ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400" : "bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400"}`, children: party.type === "customer" ? tt("Customer") : tt("Supplier") }) }),
                  /* @__PURE__ */ jsx("td", { className: "p-3 text-right", children: /* @__PURE__ */ jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted", children: party.current_balance > 0 ? party.type === "customer" ? "To Receive" : "To Pay" : party.current_balance < 0 ? party.type === "customer" ? "To Pay" : "To Receive" : "Settled" })
                  ] }) }),
                  /* @__PURE__ */ jsx("td", { className: "p-3 text-right text-sm text-ink-secondary", children: party.credit_limit ? formatCurrency(party.credit_limit) : "-" }),
                  /* @__PURE__ */ jsx("td", { className: "p-3 text-sm text-ink-secondary", children: party.phone || "-" }),
            ...
            /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-sunken rounded-full flex items-center justify-center mb-3", children: /* @__PURE__ */ jsx(Users, { size: 28, className: "text-ink-muted" }) }),
            /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-ink-secondary mb-1", children: "No parties found" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mb-3", children: tt("Add your first customer or supplier") }),
            /* @__PURE__ */ jsxs(
              "button",
              {
                onClick: handleCreate,
        ...
        /* @__PURE__ */ jsx("div", { className: "block sm:hidden divide-y divide-line", children: sortedParties.length > 0 ? sortedParties.map((party) => {
          const isOverdue = party.type === "customer" && party.credit_limit && parseFloat(party.current_balance || 0) > parseFloat(party.credit_limit);
          return /* @__PURE__ */ jsxs(
            "div",
            {
              onClick: () => handleViewLedger(party),
              className: `p-3 hover:bg-brand-50/20 dark:hover:bg-brand-900/10 flex flex-col gap-2 cursor-pointer relative ${isOverdue ? "border-l-4 border-red-500 bg-rose-50/50 hover:bg-rose-100/50 dark:bg-rose-950/10" : party.type === "customer" ? "border-l-4 border-blue-500" : "border-l-4 border-amber-500"} ${selectedParties.includes(party.id) ? "bg-brand-50/40 dark:bg-brand-900/10" : ""}`,
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-start", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("p", { className: "font-bold text-ink text-xs", children: party.name }),
                      party.phone && /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted font-mono mt-0.5", children: party.phone })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "text-right shrink-0", children: [
                    /* @__PURE__ */ jsx("span", { className: `font-bold text-xs ${party.type === "customer" && party.current_balance >= 0 || party.type === "supplier" && party.current_balance < 0 ? "text-emerald-600" : "text-red-600"}`, children: formatCurrency(Math.abs(party.current_balance || 0)) }),
                    /* @__PURE__ */ jsx("p", { className: "text-3xs text-ink-muted uppercase font-bold tracking-tight", children: party.current_balance > 0 ? party.type === "customer" ? "To Receive" : "To Pay" : party.current_balance < 0 ? party.type === "customer" ? "To Pay" : "To Receive" : "Settled" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-2xs text-ink-muted bg-surface/50 dark:bg-app p-1.5 rounded-lg border border-line", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex gap-1", onClick: (e) => e.stopPropagation(), children: [
                    /* @__PURE__ */ jsx("button", { onClick: () => handleViewLedger(party), className: "p-1 text-ink-muted hover:text-brand-600 rounded", children: /* @__PURE__ */ jsx(FileText, { size: 14 }) }),
                    /* @__PURE__ */ jsx("button", { onClick: () => handleEdit(party), className: "p-1 text-ink-muted hover:text-blue-600 rounded", children: /* @__PURE__ */ jsx(Edit2, { size: 14 }) }),
                    /* @__PURE__ */ jsx("button", { onClick: () => handleDelete(party), className: "p-1 text-ink-muted hover:text-red-600 rounded", children: /* @__PURE__ */ jsx(Trash2, { size: 14 }) })
                  ] })
                ] })
              ]
            },
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            ...
            /* @__PURE__ */ jsx(FormField, { label: "Type", required: true, children: /* @__PURE__ */ jsxs(
              FormSelect,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("option", { value: "customer", children: tt("Customer") }),
                  /* @__PURE__ */ jsx("option", { value: "supplier", children: tt("Supplier") })
                ]
              }
            ) })
          ] }),
