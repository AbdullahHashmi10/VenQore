...
import { V as VenaLogo, A as AiIsland } from "./AiIsland-qlixTg74.js";
...
function CharityButton({ showLabel = false, charityEnabled = false }) {
  const { store } = usePage().props;
...
` }),
 ...
 ${isPlatformAdmin && !store ? isEffectiveDarkMode ? "bg-neutral-950/95 backdrop-blur-2xl border-r border-white/5" : "bg-white border-r border-line" : "bg-surface border-r border-line dark:border-line"}
 ${showExpandedSidebar ? "w-[280px]" : "w-[280px] lg:w-[88px]"}
 ${isPlatformAdmin && !store ? isEffectiveDarkMode ? "m-4 rounded-xl h-[calc(100vh-32px)] border border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.5)]" : "border-r border-line shadow-sm transition-all" : ""}
`,
          children: [
...
`,
              ...
              isUserMenuOpen && /* @__PURE__ */ jsxs("div", { className: "absolute bottom-20 left-4 w-56 bg-surface rounded-[14px] shadow-xl border border-line p-2 z-50 animate-in fade-in slide-in-from-bottom-2", children: [
                ...
                store && /* @__PURE__ */ jsxs(Link, { href: route("store.ai-usage.index", { store_slug: store.slug }), className: "flex items-center justify-between w-full p-2 rounded-xl hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors text-sm font-medium text-ink-secondary dark:text-ink", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsx(Sparkles, { size: 16, className: "text-[#0BAA8F]" }),
                    /* @__PURE__ */ jsx("span", { children: "AI Usage" })
                  ] }),
                  aiWarningState === "limit" && /* @__PURE__ */ jsx("span", { className: "w-2.5 h-2.5 rounded-full bg-rose-500 shadow-[0_0_8px_rgba(244,63,94,0.6)] animate-pulse", title: "AI usage limit reached" }),
                  aiWarningState === "warning" && /* @__PURE__ */ jsx("span", { className: "w-2.5 h-2.5 rounded-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.6)] animate-pulse", title: "AI usage warning (≥80%)" })
                ] }),
                /* @__PURE__ */ jsxs(
                  "button",
                  {
      ...
      /* @__PURE__ */ jsxs("main", { className: `flex-1 flex flex-col h-full min-w-0 relative bg-[var(--vq-bg)] transition-opacity duration-slower ease-in-out opacity-100`, children: [
        ...
        !hideHeader && !fullScreen && /* @__PURE__ */ jsxs("header", { className: "h-16 px-6 flex items-center justify-between z-nav relative shrink-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2 sm:gap-3 min-w-[100px] z-10", children: [
            ...
            charityEnabled && /* @__PURE__ */ jsx("div", { className: "hidden lg:block", children: /* @__PURE__ */ jsx(CharityButton, { charityEnabled }) }),
              ...
              isDisplayMenuOpen && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-full mt-2 w-72 bg-surface rounded-[14px] shadow-xl border border-line z-dropdown overflow-hidden animate-in fade-in zoom-in-95 origin-top-right p-2.5 space-y-2", children: [
                ...
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    className: `w-full flex items-center justify-between p-2 rounded-xl transition-all ${charityEnabled ? "bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400" : "hover:bg-interactive-hover dark:hover:bg-interactive-hover text-ink-secondary"}`,
                    children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5", children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: `w-8 h-4 rounded-full relative transition-colors ${charityEnabled ? "bg-rose-500" : "bg-sunken"}`, children: /* @__PURE__ */ jsx("div", { className: `absolute top-0.5 w-3 h-3 bg-white rounded-full transition-all ${charityEnabled ? "left-4.5" : "left-0.5"}` }) })
                    ]
                  }
                ),
                /* @__PURE__ */ jsx("div", { className: "h-px bg-line my-1" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "lg:hidden relative", ref: mobileMenuRef, children: [
              ...
              isMobileMenuOpen && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-full mt-2 w-64 bg-surface rounded-[14px] shadow-xl border border-line z-dropdown overflow-hidden animate-in fade-in zoom-in-95 origin-top-right p-2 space-y-2", children: [
                (props.auth?.my_stores_count > 1 || charityEnabled) && /* @__PURE__ */ jsxs("div", { className: "p-2 border-b border-line flex items-center justify-between gap-3", children: [
                  props.auth?.my_stores_count > 1 ? /* @__PURE__ */ jsxs(
                    "button",
                    {
                      onClick: () => {
                  ...
                  charityEnabled && /* @__PURE__ */ jsx("div", { className: "flex-none", children: /* @__PURE__ */ jsx(CharityButton, { charityEnabled }) })
                ] }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "border-t border-line pt-2 space-y-1", children: [
                  ...
                  store && /* @__PURE__ */ jsxs(Link, { href: route("store.ai-usage.index", { store_slug: store.slug }), className: "flex items-center justify-between w-full p-2.5 rounded-xl hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors text-sm font-medium text-ink-secondary dark:text-ink", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                      /* @__PURE__ */ jsx(Sparkles, { size: 16, className: "text-[#0BAA8F]" }),
                      /* @__PURE__ */ jsx("span", { children: "AI Usage" })
                    ] }),
