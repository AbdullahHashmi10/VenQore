...
const PermissionsSelector = ({ selectedPermissions = [], onChange, disabled = false }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "space-y-4 flex-1 overflow-y-auto pr-2 custom-scrollbar relative z-10 max-h-[500px]", children: PERMISSION_CATEGORIES.map((cat) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "bg-neutral-800/30 border border-neutral-700/30 rounded-2xl p-4 transition-all hover:border-line-strong", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4 mb-3 pb-3 border-b border-neutral-800/60", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx("div", { className: `w-8 h-8 rounded-lg flex items-center justify-center bg-neutral-800 text-ink-faint`, children: /* @__PURE__ */ jsx(CatIcon, { size: 16 }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-white leading-tight", children: tt(cat.name) }),
            /* @__PURE__ */ jsx("p", { className: "text-3xs text-ink-muted leading-tight mt-0.5", children: tt(cat.desc) })
          ] })
        ] }),
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: `px-2 py-0.5 rounded-lg text-3xs font-bold uppercase tracking-wider transition-all border ${isCatActive ? "bg-brand-600/20 border-brand-500 text-brand-400" : isCatPartial ? "bg-amber-600/15 border-amber-500/50 text-amber-400" : "bg-sunken/50 border-neutral-700/50 text-ink-muted hover:text-white"} ${disabled ? "cursor-not-allowed opacity-50" : ""}`,
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5", children: catPerms.map((perm) => {
        ...
        return /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            className: `p-2.5 rounded-xl border flex items-center gap-2.5 text-left transition-all duration-normal group/mod ${isActive ? "bg-brand-600/10 border-brand-500/40 shadow-[0_0_15px_rgba(79,70,229,0.05)]" : "bg-sunken/20 border-neutral-900 opacity-60 hover:opacity-100 hover:border-line-strong hover:bg-interactive-hover"} ${disabled ? "cursor-not-allowed opacity-40" : ""}`,
            children: [
              /* @__PURE__ */ jsx("div", { className: `w-4 h-4 rounded border flex items-center justify-center shrink-0 transition-all ${isActive ? "bg-brand-600 border-brand-500 text-white" : "border-neutral-700 bg-neutral-800"}`, children: isActive && /* @__PURE__ */ jsx(Check, { size: 8, strokeWidth: 3 }) }),
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-center min-w-0", children: [
                /* @__PURE__ */ jsx("div", { className: `text-2xs font-bold leading-tight truncate ${isActive ? "text-white" : "text-ink-muted group-hover/mod:text-neutral-300"}`, children: tt(perm.name) }),
                /* @__PURE__ */ jsx("div", { className: "text-4xs text-ink-muted leading-tight mt-0.5 truncate", children: tt(perm.desc) })
              ] })
            ]
          },
          perm.id
...
`,
    ...
    showAddModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-neutral-900/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 md:p-8 overflow-y-auto custom-scrollbar", children: /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 rounded-xl shadow-2xl w-full max-w-[1200px] border border-neutral-700/50 flex flex-col md:flex-row relative mt-auto mb-auto", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: () => {
      ...
      /* @__PURE__ */ jsxs("div", { className: "w-full md:w-[450px] shrink-0 p-8 md:p-10 border-b md:border-b-0 md:border-r border-neutral-700/50 flex flex-col bg-neutral-900 rounded-l-xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-10", children: [
          /* @__PURE__ */ jsx("h3", { className: "font-bold text-2xl text-white tracking-tight", children: "Invite Member" }),
          /* @__PURE__ */ jsx("div", { className: "h-4 w-px bg-neutral-700" }),
        ...
        /* @__PURE__ */ jsxs("form", { id: "invite-form", onSubmit: handleSubmit, className: "flex flex-col gap-10 flex-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
            /* @__PURE__ */ jsxs("h4", { className: "flex items-center gap-2 text-2xs font-bold text-ink-muted uppercase tracking-widest", children: [
              /* @__PURE__ */ jsx(User, { size: 14 }),
              " CREDENTIALS"
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 focus-within:text-brand-400 transition-colors text-ink-muted", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-brand-400 tracking-wider", children: data.roles.length > 0 ? tt(ROLES[data.roles[0]]?.name || "")?.toUpperCase() : "NONE" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: Object.entries(ROLES).map(([key, role]) => {
              ...
              return /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `p-3 rounded-xl border flex gap-3 text-left transition-all ${isSelected ? "bg-brand-600 border-brand-500 shadow-xl " : "bg-neutral-800 border-neutral-700 hover:border-brand-400/50 hover:bg-interactive-hover"}`,
                  children: [
                    /* @__PURE__ */ jsx("div", { className: `mt-0.5 shrink-0 ${isSelected ? "text-white" : "text-ink-muted"}`, children: /* @__PURE__ */ jsx(role.icon, { size: 16 }) }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("div", { className: `text-xs font-bold leading-tight ${isSelected ? "text-white" : "text-neutral-300"}`, children: tt(role.name) }),
                      /* @__PURE__ */ jsx("div", { className: `text-3xs font-medium leading-tight mt-0.5 ${isSelected ? "text-brand-200" : "text-ink-muted"}`, children: tt(role.description) })
                    ] })
                  ]
                },
                key
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 p-8 md:p-10 bg-neutral-900 rounded-r-xl flex flex-col relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-8 relative z-10", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxs("h4", { className: "flex items-center gap-2 text-2xs font-bold text-ink-muted uppercase tracking-[0.2em]", children: [
              /* @__PURE__ */ jsx(Shield, { size: 14, className: "text-brand-400" }),
              " System Visibility"
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted font-bold uppercase tracking-widest pl-6", children: "Module Access Control" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "px-4 py-2 rounded-2xl bg-brand-500/10 border border-brand-500/20 text-2xs font-bold text-brand-400 flex items-center gap-2 tracking-widest uppercase", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-8 pt-8 border-t border-neutral-800/50 flex items-center justify-between relative z-10", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsx("div", { className: "text-2xs font-bold text-ink-muted uppercase tracking-widest", children: "Summary" }),
            /* @__PURE__ */ jsx("div", { className: "text-sm font-bold text-white", children: /* @__PURE__ */ jsxs("span", { className: data.permissions.length > 0 ? "text-brand-400" : "text-ink-muted", children: [
...
function AttendanceDetailModal({ user, history, onClose }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-black/60 backdrop-blur-md z-sticky flex items-center justify-center p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-2xl w-full max-w-4xl border border-line overflow-hidden flex flex-col h-[650px]", children: [
...
function EditMemberModal({ member, onClose }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-neutral-900/80 backdrop-blur-sm z-sticky flex items-center justify-center p-4 md:p-8 overflow-y-auto custom-scrollbar", children: /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 rounded-xl shadow-2xl w-full max-w-[1200px] border border-neutral-700/50 flex flex-col md:flex-row relative mt-auto mb-auto", children: [
    /* @__PURE__ */ jsx(
      "button",
      {
        onClick: onClose,
    ...
    /* @__PURE__ */ jsxs("div", { className: "w-full md:w-[450px] shrink-0 p-8 md:p-10 border-b md:border-b-0 md:border-r border-neutral-700/50 flex flex-col bg-neutral-900 rounded-l-xl max-h-[85vh] overflow-y-auto", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-10", children: [
        /* @__PURE__ */ jsx("h3", { className: "font-bold text-2xl text-white tracking-tight", children: "Edit Member" }),
        /* @__PURE__ */ jsx("div", { className: "h-4 w-px bg-neutral-700" }),
        /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-ink-muted uppercase tracking-widest", children: member.name })
      ] }),
      /* @__PURE__ */ jsxs("form", { id: "edit-member-form", onSubmit: submit, className: "flex flex-col gap-10 flex-1", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-brand-400 tracking-wider", children: data.role ? tt(ROLES[data.role]?.name || "")?.toUpperCase() : "NONE" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: Object.entries(ROLES).map(([key, role]) => {
            ...
            return /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                disabled: isOwner,
                onClick: () => toggleRole(key),
                className: `p-3 rounded-xl border flex gap-3 text-left transition-all ${isSelected ? "bg-brand-600 border-brand-500 shadow-xl " : "bg-sunken border-neutral-700 hover:border-brand-400/50 hover:bg-interactive-hover"} ${isOwner ? "opacity-50 cursor-not-allowed" : ""}`,
                children: [
                  /* @__PURE__ */ jsx("div", { className: `mt-0.5 shrink-0 ${isSelected ? "text-white" : "text-ink-muted"}`, children: /* @__PURE__ */ jsx(role.icon, { size: 16 }) }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("div", { className: `text-xs font-bold leading-tight ${isSelected ? "text-white" : "text-neutral-300"}`, children: tt(role.name) }),
          ...
          data.role === "custom" && /* @__PURE__ */ jsxs("div", { className: "mt-3", children: [
            /* @__PURE__ */ jsxs("label", { className: "text-xs font-bold text-ink-muted uppercase tracking-widest mb-1 block", children: [
              "Custom Role Name ",
