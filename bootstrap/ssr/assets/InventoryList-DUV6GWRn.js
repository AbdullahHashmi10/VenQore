      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "absolute -top-1 -right-1 bg-indigo-600 text-4xs font-black text-white px-1.5 py-0.5 rounded-full shadow", children: "33%" })
          ]
        }
      );
    }
    return /* @__PURE__ */ jsxs("div", { className: "fixed bottom-24 right-6 z-[100] max-w-sm w-full bg-slate-900/95 dark:bg-slate-950/98 border border-indigo-500/30 rounded-2xl shadow-[0_15px_40px_rgba(99,102,241,0.25)] p-5 backdrop-blur-md animate-in slide-in-from-bottom-4 duration-300 pointer-events-auto", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-2xs text-indigo-400 font-semibold uppercase tracking-wide", children: "Cataloging Mode (33%)" })
        ] })
      ] }),
              ...
              isCategoryCreationPath ? /* @__PURE__ */ jsxs(Fragment, { children: [
                ...
                currentStep === 7 && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                  ...
                  liveMargin ? /* @__PURE__ */ jsxs("div", { className: "p-2.5 rounded-xl bg-slate-800 border border-slate-700/50", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-slate-400 uppercase tracking-wider", children: "Live Profit Analysis" }),
          ...
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-slate-100 dark:divide-slate-800", children: sortedProducts.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: tableColumns.length + 1, className: "p-12 text-center text-slate-500", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center", children: [
            ...
            tableColumns.map((col) => /* @__PURE__ */ jsx("td", { className: "p-4 text-sm text-slate-700 dark:text-slate-300", children: (() => {
              switch (col.key) {
                ...
                case "status":
                  return /* @__PURE__ */ jsx("span", { className: `px-2 py-1 rounded-full text-2xs font-bold border ${row.status === "In Stock" ? "bg-emerald-50 text-emerald-600 border-emerald-200" : ""} ${row.status === "Low Stock" ? "bg-amber-50 text-amber-600 border-amber-200" : ""} ${row.status === "Out of Stock" ? "bg-red-50 text-red-600 border-red-200" : ""}`, children: row.status });
                case "actions":
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxs("p", { className: "text-2xs text-slate-400 font-semibold mt-0.5", children: [
                      row.unit || "pcs",
                      row.sku ? ` • ${row.sku}` : ""
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsx("span", { className: `px-2 py-0.5 rounded-full text-3xs font-black border shrink-0 ${row.status === "In Stock" ? "bg-emerald-50 text-emerald-600 border-emerald-200" : row.status === "Low Stock" ? "bg-amber-50 text-amber-600 border-amber-200" : "bg-red-50 text-red-600 border-red-200"}`, children: row.status })
              ] }),
              row.category && /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("span", { className: "text-3xs font-black uppercase bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400 px-2 py-0.5 rounded border border-slate-200/50", children: row.category }) }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-t border-slate-100 dark:border-slate-800/60 pt-2 mt-1", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-5", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-3xs text-slate-400 font-bold uppercase block tracking-wider", children: "Stock" }),
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-3xs text-slate-400 font-bold uppercase block tracking-wider", children: "Price" }),
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-3xs text-slate-400 font-bold uppercase block tracking-wider", children: "Cost" }),
