    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full bg-app p-2 gap-1 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: `grid grid-cols-2 md:grid-cols-4 gap-1 shrink-0 ${isStatsExpanded ? "grid" : "hidden md:grid"}`, children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1.5 bg-brand-100 dark:bg-brand-900/30 text-brand-600 dark:text-brand-400 rounded-lg", children: /* @__PURE__ */ jsx(ShoppingCart, { size: 16 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: tt("Total Orders") })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-ink", children: totalOrders })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-amber-600", children: pendingOrders })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Received" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-emerald-600", children: receivedOrders })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-ink", children: formatCurrency(totalValue, store) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex flex-wrap items-center justify-between gap-2 bg-surface px-3 py-2 rounded-xl border border-line shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
          /* @__PURE__ */ jsx("h1", { className: "text-lg font-bold text-ink uppercase tracking-tight shrink-0", children: tt("Purchase Orders") }),
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: `px-2.5 py-1 text-2xs font-bold uppercase rounded-full transition-all ${activeFilter === "ordered" ? "bg-blue-500 text-white" : "bg-sunken text-ink-muted hover:bg-interactive-hover"}`,
              children: "Ordered"
            }
          ),
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: `px-2.5 py-1 text-2xs font-bold uppercase rounded-full transition-all ${activeFilter === "received" ? "bg-emerald-500 text-white" : "bg-sunken text-ink-muted hover:bg-interactive-hover"}`,
              children: "Received"
            }
          )
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex lg:hidden flex-col gap-2 bg-surface px-3 py-2 rounded-xl border border-line shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between w-full", children: [
          /* @__PURE__ */ jsx("h1", { className: "text-sm font-bold text-ink uppercase tracking-tight", children: "Pre-Purchases" }),
        ...
        showMobileFilters && /* @__PURE__ */ jsx("div", { className: "w-full mt-1 border-t border-line pt-2 flex flex-col gap-2", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-1.5", children: [
          ...
          /* @__PURE__ */ jsx(
            ...
            {
              onClick: () => handleFilterChange("pending"),
              className: `px-2.5 py-1 text-2xs font-bold uppercase rounded-full transition-all ${activeFilter === "pending" ? "bg-amber-500 text-white" : "bg-sunken text-ink-muted"}`,
              children: "Pending"
            }
          ),
          /* @__PURE__ */ jsx(
            ...
            {
              onClick: () => handleFilterChange("ordered"),
              className: `px-2.5 py-1 text-2xs font-bold uppercase rounded-full transition-all ${activeFilter === "ordered" ? "bg-blue-500 text-white" : "bg-sunken text-ink-muted"}`,
              children: "Ordered"
            }
          ),
          /* @__PURE__ */ jsx(
            ...
            {
              onClick: () => handleFilterChange("received"),
              className: `px-2.5 py-1 text-2xs font-bold uppercase rounded-full transition-all ${activeFilter === "received" ? "bg-emerald-500 text-white" : "bg-sunken text-ink-muted"}`,
              children: "Received"
            }
          )
        ] }) })
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-auto md:rounded-xl md:border md:border-line md:dark:border-line md:shadow-sm bg-transparent md:bg-white md:dark:bg-app", children: [
        /* @__PURE__ */ jsxs("table", { className: "hidden md:table w-full text-left border-collapse", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { className: "bg-app border-b border-line sticky top-0 z-10", children: tableColumns.map((col) => /* @__PURE__ */ jsx(
            "th",
            {
              onClick: () => col.key !== "actions" && handleSort(col.key),
              className: "p-4 text-xs font-bold text-ink-muted uppercase tracking-wider cursor-pointer select-none hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors",
          ...
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: sortedOrders.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: tableColumns.length, className: "p-12", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "w-20 h-20 bg-sunken rounded-full flex items-center justify-center mb-4", children: /* @__PURE__ */ jsx(ShoppingCart, { size: 32, className: "text-ink-muted" }) }),
            /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-ink-secondary mb-1", children: tt("No purchase orders found") }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mb-4", children: tt("Create your first purchase order to get started") }),
            /* @__PURE__ */ jsxs(
              Link,
              {
                href: route("store.purchase-orders.create", { store_slug: store.slug }),
...
`,
              children: [
                /* @__PURE__ */ jsx("td", { className: "p-4 text-sm text-ink-secondary", children: /* @__PURE__ */ jsx("span", { className: "font-medium", children: formatDate(row.order_date) }) }),
                /* @__PURE__ */ jsx("td", { className: "p-4 text-sm", children: /* @__PURE__ */ jsx("span", { className: "font-mono text-brand-600 dark:text-brand-400 font-semibold", children: row.reference_number }) }),
                /* @__PURE__ */ jsx("td", { className: "p-4 text-sm text-ink-secondary", children: /* @__PURE__ */ jsx("p", { className: "font-semibold", children: row.supplier?.name || tt("Unknown Supplier") }) }),
                /* @__PURE__ */ jsx("td", { className: "p-4 text-sm text-ink-secondary", children: /* @__PURE__ */ jsx("span", { className: "font-bold", children: row.items?.length || 0 }) }),
                /* @__PURE__ */ jsx("td", { className: "p-4 text-sm", children: /* @__PURE__ */ jsx("span", { className: "font-bold text-ink", children: formatCurrency(row.total_amount, store) }) }),
                /* @__PURE__ */ jsx("td", { className: "p-4 text-sm", children: (() => {
                  ...
                  return /* @__PURE__ */ jsx("span", { className: `px-2 py-1 rounded-md text-xs font-bold uppercase ${statusStyles[row.status] || "bg-sunken text-ink-secondary"}`, children: row.status });
                })() }),
                /* @__PURE__ */ jsx("td", { className: "p-4 text-sm", onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2", children: [
                  ...
                  /* @__PURE__ */ jsx(
                    Link,
                    {
                      ...
                      className: "p-1.5 hover:bg-brand-50 dark:hover:bg-brand-900/20 rounded-lg text-brand-600 transition-colors",
        ...
        /* @__PURE__ */ jsx("div", { className: "md:hidden flex flex-col gap-2 px-0 py-1.5 bg-transparent", children: sortedOrders.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-xl p-8 text-center border border-line", children: [
          /* @__PURE__ */ jsx(ShoppingCart, { size: 32, className: "mx-auto text-ink-muted mb-2" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary", children: tt("No purchase orders found") })
          ...
          return /* @__PURE__ */ jsxs(
            "div",
            {
              onClick: () => handleRowClick(row),
              className: `
 p-3 bg-surface rounded-xl border border-line shadow-sm flex flex-col gap-2 relative cursor-pointer hover:border-brand-400 transition-colors
...
`,
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "text-2xs text-ink-muted font-semibold block mt-0.5", children: formatDate(row.order_date || row.created_at) })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-3xs font-bold uppercase bg-brand-100 text-brand-700 dark:bg-brand-500/20 dark:text-brand-400 px-2 py-0.5 rounded border border-brand-200/30", children: "Pre-Purchase" }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-t border-line pt-2 mt-1", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-ink", children: formatCurrency(row.total_amount, store) })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("span", { className: "text-3xs text-ink-muted font-bold uppercase block tracking-wider", children: "Items" }),
                      /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-ink-secondary", children: row.items?.length || 0 })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", onClick: (e) => e.stopPropagation(), children: [
                    row.status !== "received" && /* @__PURE__ */ jsx(
                      ...
                      {
                        href: route("store.purchase-orders.edit", row.id),
                        className: "p-1.5 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-lg text-amber-600 transition-colors",
                        title: "Edit",
                        children: /* @__PURE__ */ jsx(Edit, { size: 16 })
                      }
                    ),
                    /* @__PURE__ */ jsx(
                      ...
                      {
                        href: route("store.purchase-orders.show", row.id),
                        className: "p-1.5 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-lg text-brand-600 dark:text-brand-400 transition-colors",
                        title: "View",
                        children: /* @__PURE__ */ jsx(Eye, { size: 16 })
                      }
                    )
        ...
        /* @__PURE__ */ jsx("div", { ref: observerTarget, className: "p-4 text-center text-ink-muted text-sm border-t border-line opacity-0", children: nextPageUrl ? "Loading..." : sortedOrders.length > 0 ? "End of list" : "" })
      ] })
    ] }),
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 border-b border-line bg-gradient-to-r from-neutral-50 to-white dark:from-neutral-800 dark:to-neutral-900 shrink-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase tracking-wider", children: tt("Purchase Order") }),
                /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-brand-600", children: quickViewItem.reference_number })
              ] }),
              (() => {
                const statusStyles = {
                  received: "bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400",
                ...
                return /* @__PURE__ */ jsx("span", { className: `px-2 py-1 rounded-full text-2xs font-bold uppercase ${statusStyles[quickViewItem.status] || "bg-sunken text-ink-secondary"}`, children: quickViewItem.status });
              })()
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxs("button", { className: "px-3 py-1.5 bg-sunken text-ink-secondary text-xs font-bold rounded-lg hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors flex items-center gap-1", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-auto p-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-3 mb-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "bg-app p-3 rounded-xl", children: [
                /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-ink-muted uppercase mb-1", children: tt("Order Date") }),
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink text-sm", children: formatDate(quickViewItem.order_date) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-brand-100 dark:bg-brand-900/30 p-3 rounded-xl border border-brand-200 dark:border-brand-800", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "font-bold text-brand-600 text-lg", children: formatCurrency(quickViewItem.total_amount, store) })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "border border-line rounded-xl overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "bg-app px-4 py-3 border-t border-line", children: /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                /* @__PURE__ */ jsx("p", { className: "text-2xs text-brand-600 uppercase font-bold", children: "Grand Total" }),
                /* @__PURE__ */ jsx("p", { className: "font-bold text-lg text-brand-600", children: formatCurrency(quickViewItem.total_amount, store) })
              ] }) }) })
            ] }),
