...
function DemoLanding() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-void-950 text-white flex flex-col items-center justify-center p-6 relative overflow-hidden", children: [
