...
function BankAccountTransactions({ bankAccount, transactions }) {
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Bank Transactions", activeMenu: "Money", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full bg-app p-2 gap-1 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between bg-surface p-3 rounded-xl border border-line shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx(Link, { href: route("store.bank-accounts.index", { store_slug: store.slug }), className: "p-2 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-lg transition-colors", children: /* @__PURE__ */ jsx(ArrowLeft, { size: 18, className: "text-ink-muted" }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h1", { className: "text-lg font-bold text-ink uppercase tracking-tight", children: bankAccount?.name }),
            /* @__PURE__ */ jsxs("p", { className: "text-xs font-bold text-ink-muted uppercase", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
          /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Current Balance" }),
          /* @__PURE__ */ jsx("p", { className: "text-xl font-bold text-brand-600", children: formatCurrency(bankAccount?.current_balance) })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-auto rounded-xl border border-line shadow-sm bg-surface", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
        /* @__PURE__ */ jsx("thead", { className: "bg-app border-b border-line sticky top-0 z-10 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("tr", { children: [
          /* @__PURE__ */ jsx("th", { className: "p-4 text-xs font-bold text-ink-muted uppercase tracking-wider", children: "Date" }),
          /* @__PURE__ */ jsx("th", { className: "p-4 text-xs font-bold text-ink-muted uppercase tracking-wider", children: "Description" }),
          /* @__PURE__ */ jsx("th", { className: "p-4 text-xs font-bold text-ink-muted uppercase tracking-wider", children: "Reference" }),
          /* @__PURE__ */ jsx("th", { className: "p-4 text-xs font-bold text-ink-muted uppercase tracking-wider", children: "Type" }),
          /* @__PURE__ */ jsx("th", { className: "p-4 text-xs font-bold text-ink-muted uppercase tracking-wider text-right", children: "Amount" })
        ] }) }),
        /* @__PURE__ */ jsxs("tbody", { className: "divide-y divide-line", children: [
          allTransactions.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "5", className: "p-12 text-center text-ink-muted", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-2", children: [
            ...
            return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors", children: [
              /* @__PURE__ */ jsx("td", { className: "p-4 text-sm font-medium text-ink-secondary whitespace-nowrap", children: formatDate(row.date) }),
              /* @__PURE__ */ jsx("td", { className: "p-4 text-sm text-ink-secondary font-medium", children: row.description }),
              /* @__PURE__ */ jsx("td", { className: "p-4 text-xs font-mono font-bold text-ink-muted", children: row.ref || "-" }),
              ...
              /* @__PURE__ */ jsx("td", { className: "p-4 text-right", children: /* @__PURE__ */ jsxs("span", { className: `text-sm font-bold font-mono ${row.type === "credit" ? "text-emerald-600" : "text-red-600"}`, children: [
                row.type === "credit" ? "+" : "-",
          ...
          loadingMore && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "5", className: "p-4 text-center", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 text-ink-muted", children: [
