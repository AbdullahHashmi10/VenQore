...
const EditRecurringInvoice = ({ invoice, customers = [], warehouses: initialWarehouses = [], products = [] }) => {
  ...
  useEffect(() => {
    if (invoice) {
      ...
      setEditState({
        ...
        next_run_date: invoice.next_run_date ? new Date(invoice.next_run_date).toISOString().split("T")[0] : new Date(Date.now() + 864e5 * 30).toISOString().split("T")[0],
  ...
  useEffect(() => {
    if (settings?.pos_auto_fill_cash === "1" && !isEditMode) ;
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: `Edit Sale #${editState?.invoiceNumber || ""}`, activeMenu: "Sales", fullScreen: false, hideHeader: true, noPadding: true, children: [
    /* @__PURE__ */ jsx(Head, { title: "Edit Sale" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex w-full lg:w-80 bg-[#1a1d2e] flex-col overflow-hidden rounded-2xl shadow-2xl border border-slate-800 shrink-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 p-3 space-y-3 overflow-y-auto hide-scrollbar", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "text-[9px] text-slate-500 font-bold uppercase block mb-1", children: "Warehouse" }),
                /* @__PURE__ */ jsxs(
                  "select",
                  {
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "text-[9px] text-slate-500 font-bold uppercase block mb-1", children: "Billing Frequency" }),
                /* @__PURE__ */ jsxs(
                  "select",
                  {
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "text-[9px] text-slate-500 font-bold uppercase block mb-1", children: "Next Run Date" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "date",
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "text-[9px] text-slate-500 font-bold uppercase block mb-1", children: "Status" }),
                /* @__PURE__ */ jsxs(
                  "select",
                  {
...
export {
  EditRecurringInvoice as default
};
