    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col gap-6 overflow-auto pb-6 p-6", children: [
        ...
        recipes.length === 0 ? /* @__PURE__ */ jsx(MidnightNebula, { className: "rounded-2xl p-12 text-center", primaryColor: "indigo", secondaryColor: "purple", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center max-w-md mx-auto", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-brand-200 mb-8", children: "Start by creating your first recipe to track manufacturing costs, wastage, and profit margins." }),
          /* @__PURE__ */ jsxs(
            Link,
            {
              href: route("store.cookbook.create", { store_slug: store.slug }),
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-4 space-y-4", children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted line-clamp-2", children: recipe.description || "No description provided" }),
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-3", children: [
                  /* @__PURE__ */ jsxs("div", { className: "text-center p-2 bg-app rounded-xl", children: [
                    /* @__PURE__ */ jsx(Package, { size: 16, className: "mx-auto text-ink-muted mb-1" }),
                    /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Ingredients" }),
                    /* @__PURE__ */ jsx("p", { className: "font-bold text-ink-secondary dark:text-ink", children: recipe.ingredients_count })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "text-center p-2 bg-app rounded-xl", children: [
                    /* @__PURE__ */ jsx(DollarSign, { size: 16, className: "mx-auto text-emerald-500 mb-1" }),
                    /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "COGM" }),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "text-center p-2 bg-app rounded-xl", children: [
                    ...
                    /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Yield" }),
                    /* @__PURE__ */ jsx("p", { className: "font-bold text-ink-secondary dark:text-ink", children: recipe.yield_quantity })
                  ] })
                ] }),
                (recipe.labor_cost > 0 || recipe.overhead_cost > 0) && /* @__PURE__ */ jsxs("div", { className: "flex gap-2 text-xs", children: [
                  recipe.labor_cost > 0 && /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1 px-2 py-1 bg-brand-50 dark:bg-brand-900/20 text-brand-600 rounded-lg", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "border-t border-line p-3 flex justify-end gap-2", children: [
                /* @__PURE__ */ jsxs(
                  "button",
                  {
      ...
      /* @__PURE__ */ jsx(Modal, { show: simulatorOpen, onClose: () => setSimulatorOpen(false), maxWidth: "2xl", children: /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-6", children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-xl font-bold text-ink flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(PlayCircle, { className: "text-brand-600" }),
            "Pre-Production Simulator"
          ] }),
          /* @__PURE__ */ jsx("button", { onClick: () => setSimulatorOpen(false), className: "text-ink-muted hover:text-ink-secondary", children: /* @__PURE__ */ jsx(XCircle, { size: 24 }) })
        ] }),
        selectedRecipe && /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-app p-4 rounded-xl space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h3", { className: "font-bold text-lg dark:text-white", children: selectedRecipe.name }),
                /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "How much do you want to produce?" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "font-medium text-ink-secondary", children: "Units" })
              ] })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
          ...
          simResult && /* @__PURE__ */ jsxs("div", { className: "space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-slow", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "border border-line rounded-xl overflow-hidden", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm text-left", children: [
              /* @__PURE__ */ jsx("thead", { className: "bg-sunken text-ink-secondary font-bold", children: /* @__PURE__ */ jsxs("tr", { children: [
              ...
              /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: simResult.ingredients.map((ing, idx) => /* @__PURE__ */ jsxs("tr", { className: "bg-surface", children: [
                /* @__PURE__ */ jsx("td", { className: "px-4 py-3 font-medium dark:text-white", children: ing.name }),
                /* @__PURE__ */ jsxs("td", { className: "px-4 py-3 text-right text-ink-secondary", children: [
      ...
      /* @__PURE__ */ jsx(Modal, { show: trainingOpen, onClose: () => setTrainingOpen(false), maxWidth: "4xl", children: /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-6", children: [
          ...
          /* @__PURE__ */ jsx("button", { onClick: () => setTrainingOpen(false), className: "text-ink-muted hover:text-ink-secondary", children: /* @__PURE__ */ jsx(XCircle, { size: 24 }) })
        ] }),
        selectedRecipe && selectedRecipe.media && /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: selectedRecipe.media.map((media, idx) => /* @__PURE__ */ jsxs("div", { className: "bg-app rounded-xl overflow-hidden border border-line", children: [
          ...
          media.type === "image" && /* @__PURE__ */ jsx("div", { className: "aspect-video bg-sunken", children: /* @__PURE__ */ jsx("img", { src: media.url, alt: media.title, className: "w-full h-full object-cover" }) }),
          /* @__PURE__ */ jsxs("div", { className: "p-3", children: [
            /* @__PURE__ */ jsx("h4", { className: "font-bold text-ink", children: media.title || `Resource #${idx + 1}` }),
        ...
        (!selectedRecipe?.media || selectedRecipe.media.length === 0) && /* @__PURE__ */ jsxs("div", { className: "text-center py-12 text-ink-muted", children: [
