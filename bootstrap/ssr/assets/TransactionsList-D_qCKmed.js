    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full bg-app p-2 gap-1 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "sm:hidden flex items-center justify-between bg-surface px-3 py-2.5 rounded-xl border border-line shadow-sm shrink-0", children: [
        ...
        !isStatsExpanded && /* @__PURE__ */ jsxs("div", { className: "text-2xs font-bold text-ink-muted truncate", children: [
          ...
          /* @__PURE__ */ jsxs("span", { className: "text-red-600 dark:text-red-400", children: [
            "Due: ",
      ...
      /* @__PURE__ */ jsxs("div", { className: `grid grid-cols-2 sm:grid-cols-4 gap-2 shrink-0 ${isStatsExpanded ? "grid" : "hidden sm:grid"}`, children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-2.5 py-2 rounded-xl border border-line shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1 bg-brand-100 dark:bg-brand-900/30 text-brand-600 dark:text-brand-400 rounded-lg shrink-0", children: /* @__PURE__ */ jsx(FileText, { size: 14 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-2xs sm:text-xs font-bold text-ink-muted uppercase tracking-tight truncate", children: "Count" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm sm:text-base md:text-lg font-bold text-ink leading-none mt-1 sm:mt-0", children: stats.count || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-2.5 py-2 rounded-xl border border-line shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-2xs sm:text-xs font-bold text-ink-muted uppercase tracking-tight truncate", children: "Total Sales" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm sm:text-base md:text-lg font-bold text-emerald-600 leading-none mt-1 sm:mt-0", children: formatCurrency(stats.total_debit || 0, store) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-2.5 py-2 rounded-xl border border-line shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-2xs sm:text-xs font-bold text-ink-muted uppercase tracking-tight truncate", children: "Received" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm sm:text-base md:text-lg font-bold text-blue-600 leading-none mt-1 sm:mt-0", children: formatCurrency(stats.total_credit || 0, store) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-2.5 py-2 rounded-xl border border-line shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-2xs sm:text-xs font-bold text-ink-muted uppercase tracking-tight truncate", children: "Unpaid / Due" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm sm:text-base md:text-lg font-bold text-red-600 leading-none mt-1 sm:mt-0", children: formatCurrency(stats.total_balance_due || 0, store) })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "hidden sm:flex flex-row items-center justify-between gap-2 bg-surface px-3 py-2 rounded-xl border border-line shadow-sm shrink-0", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-0.5 border-l border-line pl-1.5", children: [
            ...
            /* @__PURE__ */ jsx("button", { className: "p-1.5 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-lg text-ink-muted", title: "Print", children: /* @__PURE__ */ jsx(Printer, { size: 14 }) })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-auto rounded-xl border border-line shadow-sm bg-surface", children: [
        /* @__PURE__ */ jsx("div", { className: "hidden sm:block", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-app border-b border-line sticky top-0 z-10", children: [
            ...
            /* @__PURE__ */ jsx("th", { className: "p-3 text-2xs font-bold text-ink-muted uppercase tracking-wider text-right w-[10%]", children: "Actions" })
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: processData.length > 0 ? processData.map((row) => {
            const typeConfig = getTypeConfig(row.type);
            const Icon = typeConfig.icon;
            return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-brand-50/50 dark:hover:bg-brand-900/10 transition-all group", children: [
              /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-ink-secondary whitespace-nowrap", children: formatDate(row.date) }) }),
              /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsx("span", { className: "font-mono text-xs font-bold text-brand-600 dark:text-brand-400", children: row.reference }) }),
              /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink truncate max-w-[180px]", children: row.party?.name || "Walk-in Customer" }),
                row.party?.phone && /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted", children: row.party.phone })
              ] }) }),
              /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsxs("span", { className: `inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md text-2xs font-bold uppercase ${typeConfig.color}`, children: [
                /* @__PURE__ */ jsx(Icon, { size: 10 }),
                typeConfig.label
              ] }) }),
              /* @__PURE__ */ jsx("td", { className: "p-3 text-right", children: /* @__PURE__ */ jsx("span", { className: "text-xs font-mono font-bold text-ink", children: formatCurrency(row.amount, store) }) }),
              /* @__PURE__ */ jsx("td", { className: "p-3 text-right", children: row.balance_due > 0 ? /* @__PURE__ */ jsx("span", { className: "text-xs font-mono font-bold text-red-600 dark:text-red-400", children: formatCurrency(row.balance_due, store) }) : /* @__PURE__ */ jsx("span", { className: "inline-flex px-1.5 py-0.5 rounded bg-emerald-50 text-emerald-600 text-2xs font-bold uppercase", children: "Settled" }) }),
              /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsx("span", { className: `text-2xs font-bold uppercase ${row.payment_status === "paid" ? "text-emerald-600" : row.payment_status === "partial" ? "text-amber-600" : row.payment_status === "unpaid" ? "text-red-600" : "text-ink-muted"}`, children: row.payment_status || "-" }) }),
              /* @__PURE__ */ jsx("td", { className: "p-3 text-right text-ink-muted", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity", onClick: (e) => e.stopPropagation(), children: [
                /* @__PURE__ */ jsx("button", { className: "p-1.5 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-lg text-ink-muted hover:text-brand-600", title: "Print", children: /* @__PURE__ */ jsx(Printer, { size: 14 }) }),
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                  ...
                  activeActionMenu === row.id && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-full mt-1 w-40 bg-surface rounded-[14px] shadow-xl border border-line p-1 z-50 animate-in zoom-in-95", children: [
                    /* @__PURE__ */ jsxs("button", { className: "w-full text-left px-2 py-1.5 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-lg text-xs font-medium flex items-center gap-2 text-ink-secondary", children: [
                      /* @__PURE__ */ jsx(Eye, { size: 12 }),
                      " View Details"
                    ] }),
                    /* @__PURE__ */ jsxs("button", { className: "w-full text-left px-2 py-1.5 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded text-xs font-medium flex items-center gap-2 text-ink-secondary", children: [
          ...
          }) : /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: tableColumns.length + 1, className: "p-12 text-center text-ink-muted", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "block sm:hidden divide-y divide-line animate-in fade-in duration-normal", children: processData.length > 0 ? processData.map((row) => {
          const typeConfig = getTypeConfig(row.type);
          const Icon = typeConfig.icon;
          return /* @__PURE__ */ jsxs("div", { className: "p-3 hover:bg-interactive-hover dark:hover:bg-interactive-hover flex flex-col gap-1.5", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xs text-ink-muted font-medium font-mono", children: formatDate(row.date) }),
              /* @__PURE__ */ jsxs("span", { className: `inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md text-3xs font-bold uppercase ${typeConfig.color}`, children: [
                /* @__PURE__ */ jsx(Icon, { size: 8 }),
                typeConfig.label
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
              /* @__PURE__ */ jsxs("p", { className: "text-xs font-bold text-ink break-all", children: [
                "Ref: ",
                /* @__PURE__ */ jsx("span", { className: "text-brand-600 dark:text-brand-400 font-mono font-bold", children: row.reference })
              ] }),
              /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-ink-secondary mt-0.5", children: row.party?.name || "Walk-in Customer" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-1xs pt-1.5 border-t border-dashed border-line mt-1", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsxs("span", { className: "text-ink font-mono font-bold", children: [
                  "Amt: ",
                  formatCurrency(row.amount, store)
                ] }),
                row.balance_due > 0 && /* @__PURE__ */ jsxs("span", { className: "text-red-600 dark:text-red-400 font-mono font-bold", children: [
                  "Due: ",
                  formatCurrency(row.balance_due, store)
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: `text-3xs font-bold uppercase ${row.payment_status === "paid" ? "text-emerald-600" : row.payment_status === "partial" ? "text-amber-600" : "text-red-600"}`, children: row.payment_status || "-" }),
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    onClick: (e) => {
                    ...
                    children: [
                      ...
                      activeActionMenu === row.id && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-full mt-1 w-36 bg-surface rounded-[14px] shadow-xl border border-line p-1 z-50 animate-in zoom-in-95", children: [
                        /* @__PURE__ */ jsxs("button", { className: "w-full text-left px-2 py-1 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded text-2xs font-medium flex items-center gap-1.5 text-ink-secondary", children: [
                        ...
                        /* @__PURE__ */ jsx("div", { className: "h-px bg-sunken my-0.5" }),
                        /* @__PURE__ */ jsxs("button", { className: "w-full text-left px-2 py-1 hover:bg-red-50 dark:hover:bg-red-900/20 rounded text-2xs font-medium flex items-center gap-1.5 text-red-600", children: [
        ...
        /* @__PURE__ */ jsx("div", { ref: observerTarget, className: "p-4 text-center text-ink-muted text-sm border-t border-line opacity-0", children: nextPageUrl ? "Loading..." : allTransactions.length > 0 ? "End of list" : "" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between px-2 bg-surface py-2 rounded-xl border border-line shrink-0", children: /* @__PURE__ */ jsxs("div", { className: "text-xs text-ink-muted font-medium", children: [
        "Showing ",
