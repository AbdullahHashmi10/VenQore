          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 rounded-md text-[10px] font-black uppercase bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300", children: row.status })
              ] }),
