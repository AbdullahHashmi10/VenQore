  ...
  return /* @__PURE__ */ jsx(
    ToolShell,
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl vq-tool-inset shadow-sm space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-line pb-5", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold uppercase tracking-wider text-brand-600 dark:text-brand-400 block mb-1", children: "Quick Start Presets" }),
              /* @__PURE__ */ jsxs("h2", { className: "text-lg font-bold text-ink flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(ChefHat, { className: "text-brand-500", size: 20 }),
                "Sample Menu Recipes"
              ] })
            ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-ink-secondary mb-1.5", children: "Recipe / Dish Name" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "text",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-ink-secondary mb-1.5", children: "Display Currency" }),
              /* @__PURE__ */ jsx(
                Select,
                {
                  value: currency,
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-ink-secondary mb-1.5", children: "Recipe Yield (Portions)" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "number",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-ink-secondary mb-1.5", children: "Waste / Spoilage Buffer %" }),
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "absolute right-3 top-2.5 text-xs text-ink-muted font-bold", children: "%" })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl vq-tool-inset shadow-sm space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h3", { className: "text-base font-bold text-ink", children: "Recipe Ingredients & Unit Costs" }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Enter your bulk purchasing cost and the exact amount used in the recipe." })
            ] }),
            /* @__PURE__ */ jsxs(
              "button",
              {
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-3 overflow-x-auto", children: parsedIngredients.map((item, idx) => /* @__PURE__ */ jsxs(
            "div",
            {
              className: `p-4 rounded-2xl border transition-all ${item.unitMismatch ? "bg-amber-500/[0.04] border-amber-500/30" : "bg-sunken border-line"} flex flex-col lg:flex-row lg:items-center gap-3 min-w-[700px]`,
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-[160px]", children: [
                  /* @__PURE__ */ jsxs("label", { className: "block text-2xs font-bold uppercase text-ink-muted mb-1", children: [
                    "Ingredient #",
                    idx + 1,
                    " Name"
                  ] }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 min-w-[210px]", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted font-bold mt-4", children: "/" }),
                  /* @__PURE__ */ jsxs("div", { className: "w-16", children: [
                    /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase text-ink-muted mb-1", children: "Pur. Qty" }),
                    /* @__PURE__ */ jsx(
                      "input",
                      {
                        type: "number",
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "w-28", children: [
                    /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase text-ink-muted mb-1", children: "Pur. Unit" }),
                    /* @__PURE__ */ jsx(
                      Select,
                      {
                ...
                /* @__PURE__ */ jsx(ArrowRight, { size: 14, className: "hidden lg:block text-ink-muted mt-4 shrink-0" }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 min-w-[190px]", children: [
                  /* @__PURE__ */ jsxs("div", { className: "w-20", children: [
                    /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase text-ink-muted mb-1", children: "Recipe Qty" }),
                    /* @__PURE__ */ jsx(
                      "input",
                      {
                        type: "number",
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "w-28", children: [
                    /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase text-ink-muted mb-1", children: "Recipe Unit" }),
                    /* @__PURE__ */ jsx(
                      Select,
                      {
                ...
                /* @__PURE__ */ jsxs("div", { className: "min-w-[100px] text-right lg:ml-auto", children: [
                  /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase text-ink-muted mb-1", children: "Cost Share" }),
                  /* @__PURE__ */ jsx("span", { className: `text-sm font-bold ${item.unitMismatch ? "text-amber-500" : "text-ink"}`, children: item.unitMismatch ? "Invalid Unit" : formatMoney(item.lineCost, sym) })
                ] }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-5", children: [
          /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl vq-tool-inset shadow-sm text-ink flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold uppercase tracking-wider text-ink-muted", children: "Recipe Cost Structure" }),
              /* @__PURE__ */ jsxs("div", { className: "mt-3", children: [
                /* @__PURE__ */ jsx("span", { className: "text-3xl font-bold text-ink block", children: formatMoney(costPerPortion, sym) }),
                /* @__PURE__ */ jsxs("span", { className: "text-xs text-ink-secondary font-semibold block mt-1", children: [
                  "Cost Per Portion (",
                  yieldPortions,
                  " portion",
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-6 pt-4 border-t border-line space-y-2 text-xs", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-ink-secondary", children: [
                /* @__PURE__ */ jsx("span", { children: "Raw Ingredients Total:" }),
                /* @__PURE__ */ jsx("span", { className: "font-bold text-ink", children: formatMoney(rawBatchCost, sym) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-ink-secondary", children: [
                /* @__PURE__ */ jsxs("span", { children: [
                  "Waste Allowance (",
                ...
                /* @__PURE__ */ jsxs("span", { className: "font-bold text-emerald-600 dark:text-emerald-400", children: [
                  "+",
                  formatMoney(totalBatchCostWithWaste - rawBatchCost, sym)
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-ink-secondary font-bold", children: [
                /* @__PURE__ */ jsx("span", { children: "Total Batch Cost:" }),
                /* @__PURE__ */ jsx("span", { className: "text-ink", children: formatMoney(totalBatchCostWithWaste, sym) })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl vq-tool-inset shadow-sm flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold uppercase tracking-wider text-brand-600 dark:text-brand-400", children: "Target Pricing Solver" }),
              /* @__PURE__ */ jsxs("div", { className: "mt-3", children: [
                /* @__PURE__ */ jsx("span", { className: "text-3xl font-bold text-ink block", children: formatMoney(suggestedPricePerPortion, sym) }),
                /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted font-medium block mt-1", children: "Suggested Price / Portion" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mt-6 pt-4 border-t border-line", children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-ink-secondary mb-1.5", children: "Target Food Cost %" }),
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsx(
                  "input",
                  {
                ...
                /* @__PURE__ */ jsx("span", { className: "absolute right-3 top-2 text-xs text-ink-muted font-bold", children: "%" })
              ] }),
              /* @__PURE__ */ jsx("p", { className: "text-1xs text-ink-muted mt-2", children: "Standard restaurant benchmark: 28% - 35%." })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl vq-tool-inset shadow-sm flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold uppercase tracking-wider text-brand-600 dark:text-brand-400", children: "Menu Margin Analysis" }),
              /* @__PURE__ */ jsxs("div", { className: "mt-3", children: [
                /* @__PURE__ */ jsx("span", { className: "text-3xl font-bold text-emerald-600 dark:text-emerald-400 block", children: formatMoney(grossProfitPerPortion, sym) }),
                /* @__PURE__ */ jsxs("span", { className: "text-xs text-ink-muted font-medium block mt-1", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-6 pt-4 border-t border-line space-y-3", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsxs("label", { className: "block text-xs font-bold text-ink-secondary mb-1", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-xs pt-1", children: [
                /* @__PURE__ */ jsx("span", { className: "text-ink-muted", children: "Actual Food Cost:" }),
                /* @__PURE__ */ jsxs("span", { className: `font-bold ${actualFoodCostPct > 35 ? "text-amber-500" : "text-emerald-500"}`, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl vq-tool-inset shadow-sm space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("h3", { className: "text-base font-bold text-ink flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Layers, { size: 18, className: "text-brand-500" }),
                "Multi-Recipe Menu Summary"
              ] }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Save current calculation to compile a full menu cost breakdown and export as CSV." })
            ] }),
          ...
          savedRecipes.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "p-8 text-center rounded-2xl bg-sunken border border-dashed border-line", children: [
            /* @__PURE__ */ jsx(BookOpen, { className: "mx-auto text-ink-muted mb-2", size: 24 }),
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-secondary", children: "No saved recipes in summary yet." }),
            /* @__PURE__ */ jsx("p", { className: "text-1xs text-ink-muted mt-1", children: 'Click "Add to Summary" above to save multiple menu items side-by-side.' })
          ] }) : /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left text-xs", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b border-line text-ink-muted font-bold uppercase text-2xs", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line dark:divide-white/5", children: savedRecipes.map((r) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-sunken", children: [
              /* @__PURE__ */ jsx("td", { className: "py-3 px-3 font-bold text-ink", children: r.name }),
              /* @__PURE__ */ jsxs("td", { className: "py-3 px-3 text-ink-secondary", children: [
                r.portions,
                " ptn"
              ] }),
              /* @__PURE__ */ jsx("td", { className: "py-3 px-3 text-ink-secondary", children: formatMoney(r.batchCost, sym) }),
              /* @__PURE__ */ jsx("td", { className: "py-3 px-3 font-bold text-ink", children: formatMoney(r.costPerPortion, sym) }),
              /* @__PURE__ */ jsx("td", { className: "py-3 px-3 text-brand-600 dark:text-brand-400 font-semibold", children: formatMoney(r.suggestedPrice, sym) }),
              /* @__PURE__ */ jsx("td", { className: "py-3 px-3 font-bold text-ink", children: formatMoney(r.sellingPrice, sym) }),
