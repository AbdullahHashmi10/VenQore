  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { mode: "admin", title: "Agent Inbox", activeMenu: storeSlug ? "Store Settings" : "Agent Inbox", noPadding: true, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "w-80 h-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] shadow-xl flex flex-col overflow-hidden relative shrink-0", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "px-6 py-3 border-b border-slate-100 dark:border-slate-800 flex gap-1 bg-slate-50/50 dark:bg-slate-900/50 overflow-x-auto shrink-0 scrollbar-none", children: [
          ...
          "button",
          {
            ...
            className: `px-2.5 py-1.5 rounded-full text-[9px] font-black uppercase tracking-wider transition-all shrink-0 ${activeTab === tab.id ? "bg-indigo-600 text-white shadow-md" : "bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-500 dark:text-slate-400"}`,
            children: tab.label
          },
          tab.id
        )) }),
        /* @__PURE__ */ jsx("div", { className: "flex-1 chat-scroll p-3 space-y-2", children: loadingSessions ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-48 text-slate-400", children: [
          ...
          if (filteredSessions.length === 0) {
            return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-48 text-slate-400 text-center px-4", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-[10px] text-slate-400 mt-1", children: "No chats in this category" })
            ] });
          }
          const grouped = {};
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black uppercase tracking-wider", children: groupName })
                    ] }),
                    /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-indigo-100 dark:bg-indigo-950/40 text-indigo-600 dark:text-indigo-400 text-[9px] font-black rounded-full", children: groupSessions.length })
                  ]
                }
              ),
                  ...
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between w-full", children: [
                        ...
                        /* @__PURE__ */ jsx("span", { className: "text-[9px] text-slate-400 font-medium", children: s.last_message_at ? new Date(s.last_message_at).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) : "" })
                      ] }),
                      s.messages?.length > 0 && /* @__PURE__ */ jsx("p", { className: `text-[10px] truncate ${isSelected ? "text-slate-300" : "text-slate-400"}`, children: s.messages[s.messages.length - 1].body }),
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mt-1 flex-wrap gap-1", children: [
                        isUnclaimed && /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-rose-100 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 text-[8px] font-black uppercase tracking-wider rounded-full", children: "Action Required" }),
                        isClaimedByMe && /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-emerald-100 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 text-[8px] font-black uppercase tracking-wider rounded-full", children: "Claimed by me" }),
                        isClaimedByOther && /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-amber-100 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400 text-[8px] font-black uppercase tracking-wider rounded-full max-w-[120px] truncate", children: s.claimed_by_name || "Other" }),
                        s.referred_to === currentUser.id && /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-violet-100 dark:bg-violet-950/40 text-violet-600 dark:text-violet-400 text-[8px] font-black uppercase tracking-wider rounded-full", children: "Referred to me" }),
                        s.sub_status && /* @__PURE__ */ jsx("span", { className: `px-2 py-0.5 text-[8px] font-black uppercase tracking-wider rounded-full ${s.sub_status === "fixed" ? "bg-emerald-100 dark:bg-emerald-950/20 text-emerald-600" : "bg-amber-100 dark:bg-amber-950/20 text-amber-600"}`, children: s.sub_status }),
                        s.status === "resolved" && /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-500 text-[8px] font-black uppercase tracking-wider rounded-full", children: "Resolved" })
                      ] })
                    ]
                  },
                  s.session_uuid
        ...
        selectedSession ? /* @__PURE__ */ jsxs("div", { className: "flex-1 flex overflow-hidden relative z-10", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col overflow-hidden border-r border-slate-100 dark:border-slate-800/80", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-6 border-b border-slate-100 dark:border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl shrink-0", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                selectedSession.escalation_reason && /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-rose-500 font-bold uppercase tracking-wider mt-1 flex items-center gap-1", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "flex items-center bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-1 gap-2 shrink-0", children: selectedSession.status === "bot_active" ? /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsxs("span", { className: "px-2.5 py-1 bg-purple-500/10 border border-purple-500/20 text-purple-600 dark:text-purple-400 text-[10px] font-black uppercase tracking-wider rounded-lg flex items-center gap-1", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 bg-indigo-500/10 border border-indigo-500/20 text-indigo-600 dark:text-indigo-400 text-[10px] font-black uppercase tracking-wider rounded-lg", children: "Human Active" }),
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      type: "button",
                ...
                /* @__PURE__ */ jsx("div", { className: "flex bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-0.5 shrink-0", children: [
                  ...
                  "button",
                  {
                    ...
                    className: `px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all ${selectedSession.sub_status === tag.id || !selectedSession.sub_status && tag.id === "active" ? "bg-white dark:bg-slate-700 shadow-sm text-slate-900 dark:text-white" : "text-slate-400 hover:text-slate-600 dark:hover:text-slate-300"}`,
                    children: tag.label
                  },
                  tag.id
                )) }),
                ...
                return /* @__PURE__ */ jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxs("div", { className: `max-w-md rounded-2xl px-5 py-3.5 shadow-sm text-sm ${isVisitor ? "bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-100 rounded-bl-none" : isBot ? "bg-purple-600 text-white rounded-br-none font-medium" : "bg-indigo-600 text-white rounded-br-none font-medium"}`, children: [
                      /* @__PURE__ */ jsx("div", { className: "text-[10px] font-black uppercase tracking-wider mb-1 opacity-70", children: m.sender_name || (isVisitor ? "Guest" : isBot ? "Vena (AI)" : "Agent") }),
                      /* @__PURE__ */ jsx("p", { className: "leading-relaxed whitespace-pre-wrap", children: m.body }),
                      /* @__PURE__ */ jsx("div", { className: "text-[9px] mt-1.5 opacity-60 text-right", children: new Date(m.created_at).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) })
                    ] })
                  },
                  m.id
                );
            ...
            /* @__PURE__ */ jsx("div", { className: "p-6 border-t border-slate-100 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto relative", children: [
              slashSuggestions.length > 0 && /* @__PURE__ */ jsxs("div", { className: "absolute bottom-full left-0 right-0 mb-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-2xl p-2 z-50 max-h-48 overflow-y-auto custom-scrollbar animate-in fade-in slide-in-from-bottom-2", children: [
                /* @__PURE__ */ jsx("div", { className: "px-3 py-1.5 text-[10px] font-bold text-slate-400 uppercase tracking-widest border-b border-slate-100 dark:border-slate-700/60 mb-1", children: "Canned Responses (Tap to insert)" }),
                slashSuggestions.map((r, i) => /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "text-slate-400 text-[10px] truncate max-w-[300px]", children: r.title })
                    ]
                  },
                  i
                ))
                ...
                /* @__PURE__ */ jsxs("div", { className: "p-5 bg-slate-50/50 dark:bg-slate-850/20 border border-slate-100 dark:border-slate-800/80 rounded-2xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-xs font-semibold text-slate-600 dark:text-slate-400", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 mt-0.5", children: selectedSession.status === "bot_active" ? "Vena AI is currently handling the thread." : selectedSession.claimed_by ? `Owned by ${selectedSession.claimed_by_name || "another agent"}.` : "This session is waiting in the queue." })
                    ] })
                  ] }),
          ...
          showCopilot && /* @__PURE__ */ jsxs("div", { className: "w-96 h-full flex flex-col bg-slate-50/20 dark:bg-slate-900/10 overflow-hidden shrink-0 animate-in slide-in-from-right duration-300 border-l border-slate-100 dark:border-slate-800/80", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-6 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 shrink-0", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 mt-1", children: "Real-time co-pilot assist drawer" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1 chat-scroll p-4 space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-purple-500/10 bg-purple-500/[0.02] p-4 relative overflow-hidden flex flex-col gap-3", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsx("h4", { className: "text-[10px] font-black text-purple-400 uppercase tracking-wider flex items-center gap-1.5", children: "Suggested Draft" }),
                  copilotSuggestion && /* @__PURE__ */ jsxs("span", { className: `px-2 py-0.5 rounded-full text-[8px] font-black uppercase tracking-wider border ${copilotConfidence === "high" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : copilotConfidence === "medium" ? "bg-purple-500/10 border-purple-500/20 text-purple-400" : "bg-amber-500/10 border-amber-500/20 text-amber-400"}`, children: [
                    "Confidence: ",
                    copilotConfidence
                  ] })
                ] }),
                copilotLoading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-6 text-slate-400 gap-2", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-medium animate-pulse", children: "Analyzing context..." })
                ...
                ] }) : /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 py-4 text-center", children: "Waiting for next customer message..." })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-slate-100 dark:border-slate-800 bg-slate-50/30 dark:bg-slate-800/10 p-4", children: [
                /* @__PURE__ */ jsx("h4", { className: "text-[10px] font-black text-slate-400 uppercase tracking-wider mb-3", children: copilotSimilarKb.length > 0 ? "Verified KB Matches" : "Support Cheat Sheet" }),
                /* @__PURE__ */ jsx("div", { className: "space-y-3.5", children: copilotSimilarKb.length > 0 ? copilotSimilarKb.map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "border-b border-slate-100 dark:border-slate-800/60 pb-2.5 last:border-b-0 last:pb-0 flex flex-col gap-1", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxs("span", { className: "text-[9px] font-black text-slate-850 dark:text-slate-200 truncate max-w-[200px]", children: [
                      "Q: ",
                      item.question
                    ] }),
                    /* @__PURE__ */ jsxs("span", { className: "text-[8px] bg-slate-100 dark:bg-slate-800 text-slate-400 px-1.5 py-0.5 rounded font-black", children: [
                      "Seen ",
                      item.times_seen,
                      "x"
                    ] })
                  ] }),
                  /* @__PURE__ */ jsx("p", { className: "text-[9px] text-slate-500 dark:text-slate-400 leading-relaxed bg-white/[0.02] p-2 rounded-lg border border-white/[0.02]", children: item.agent_answer })
                ] }, idx)) : [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold text-slate-800 dark:text-slate-200", children: item.q }),
                  /* @__PURE__ */ jsx("p", { className: "text-[9px] text-slate-500 dark:text-slate-400 mt-1 leading-relaxed", children: item.a })
                ] }, idx)) })
              ] })
            ] })
          ] })
          ...
          /* @__PURE__ */ jsx("p", { className: "text-[11px] text-slate-400 mt-1 max-w-[280px]", children: "Click on a support session from the queue on the left to start conversing in real-time." })
        ] })
      ] })
    ] }),
    showResolveModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[100] bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-300", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-lg bg-slate-900 border border-slate-800 rounded-[2.5rem] shadow-2xl p-8 relative overflow-hidden flex flex-col gap-6 animate-in zoom-in-95 duration-300", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handleResolveSubmit, className: "flex-1 flex flex-col gap-5 overflow-y-auto custom-scrollbar", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-black uppercase tracking-[0.25em] text-slate-500 mb-2.5", children: "Ticket Category" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-black uppercase tracking-[0.25em] text-slate-500 mb-2.5", children: "Core Problem Encountered" }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
              required: true,
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-black uppercase tracking-[0.25em] text-slate-500 mb-2.5", children: "Verified Solution Provided" }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
              required: true,
