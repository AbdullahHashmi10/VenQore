...
function ReceiptTool({ paperPresets = {}, paymentMethods = [], currencies = {}, maxItems = 100, suggestedNumber = "", toolGroups = [] }) {
  ...
  return /* @__PURE__ */ jsxs(
    ToolShell,
    {
      ...
      wide: true,
      children: [
        /* @__PURE__ */ jsx(SmartCaptureNudge, { documentType: "receipt" }),
        ...
        meta.orientation === "landscape" && /* @__PURE__ */ jsx("p", { className: "text-1xs text-amber-600 dark:text-amber-400 mb-3 -mt-2 text-center", children: "Landscape printing is not yet supported for downloads — this previews the layout only. Your PDF will download in portrait." }),
        /* @__PURE__ */ jsx("div", { className: `vq-paper rounded-2xl overflow-hidden shadow-xl shadow-neutral-900/10 dark:shadow-black/40 border border-line bg-white mx-auto transition-[max-width] ${meta.orientation === "landscape" ? isThermal ? "max-w-md" : "max-w-2xl" : isThermal ? "max-w-xs" : "max-w-md"}`, children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-center text-ink-muted text-2xs mt-0.5", children: [
                "Tel: ",
                /* @__PURE__ */ jsx(EditableText, { value: store.phone, onChange: (v) => setStore((s) => ({ ...s, phone: v })), placeholder: "Phone number" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "border-t border-dashed border-line my-2.5" }),
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-2xs", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-2xs mt-0.5", children: [
                "Cashier: ",
              ...
              /* @__PURE__ */ jsxs("table", { className: "w-full mb-1", children: [
                /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "text-left text-3xs font-bold uppercase tracking-wide text-ink-muted border-b border-neutral-900", children: [
                  /* @__PURE__ */ jsx("th", { className: "pb-1 pr-1", children: /* @__PURE__ */ jsx(EditableText, { value: headers.item, onChange: (v) => setHeaders((h) => ({ ...h, item: v })), pulse: false, className: "text-3xs font-bold uppercase tracking-wide text-ink-muted" }) }),
                  /* @__PURE__ */ jsx("th", { className: "pb-1 px-1 text-right w-10", children: /* @__PURE__ */ jsx(EditableText, { value: headers.quantity, onChange: (v) => setHeaders((h) => ({ ...h, quantity: v })), pulse: false, className: "text-3xs font-bold uppercase tracking-wide text-ink-muted text-right" }) }),
                  /* @__PURE__ */ jsx("th", { className: "pb-1 pl-1 text-right w-16", children: /* @__PURE__ */ jsx(EditableText, { value: headers.total, onChange: (v) => setHeaders((h) => ({ ...h, total: v })), pulse: false, className: "text-3xs font-bold uppercase tracking-wide text-ink-muted text-right" }) }),
                ...
                /* @__PURE__ */ jsx("tbody", { children: items.map((item, idx) => {
                  ...
                  return /* @__PURE__ */ jsxs("tr", { className: "border-b border-line group align-top", children: [
                    /* @__PURE__ */ jsxs("td", { className: "py-1.5 pr-1", children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 text-3xs text-ink-muted mt-0.5", children: [
                    ...
                    /* @__PURE__ */ jsx("td", { className: "py-1.5 text-right", children: /* @__PURE__ */ jsx("button", { type: "button", onClick: () => removeItem(idx), disabled: items.length === 1, className: "opacity-0 group-hover:opacity-100 text-ink-secondary hover:text-red-500 disabled:opacity-0 transition-opacity", children: /* @__PURE__ */ jsx(Trash2, { size: 11 }) }) })
                  ] }, idx);
                }) })
              ] }),
              /* @__PURE__ */ jsxs("button", { type: "button", onClick: addItem, disabled: items.length >= maxItems, className: "flex items-center gap-1 text-2xs font-bold text-ink-muted hover:text-brand-500 disabled:opacity-40 transition-colors mb-2.5", children: [
                /* @__PURE__ */ jsx(Plus, { size: 11 }),
                " Add product"
              ] }),
              /* @__PURE__ */ jsx("div", { className: "border-t border-dashed border-line my-2.5" }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-1 text-2xs", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between font-bold text-xs pt-1.5 border-t border-neutral-900 border-b-2 border-double pb-1.5", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "border-t border-dashed border-line my-2.5" }),
              /* @__PURE__ */ jsxs("div", { className: "text-center text-3xs text-ink-muted space-y-1", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "text-4xs text-ink-secondary", children: "Generated free at venqore.com/tools" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "flex justify-between text-3xs text-ink-muted mt-3 gap-2", children: /* @__PURE__ */ jsx("button", { type: "button", onClick: () => logoInputRef.current?.click(), className: "hover:text-brand-500 transition-colors", children: isThermal ? "80mm Thermal Roll" : "Standard Letter / A4" }) })
            ]
          }
        ) }),
