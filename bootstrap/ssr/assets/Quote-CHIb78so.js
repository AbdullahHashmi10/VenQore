...
function QuotationTool({ templates = {}, currencies = {}, maxItems = 100, defaultValidityDays = 30, suggestedNumber = "", toolGroups = [] }) {
  ...
  return /* @__PURE__ */ jsxs(
    ToolShell,
    {
      ...
      wide: true,
      children: [
        /* @__PURE__ */ jsx(SmartCaptureNudge, { documentType: "quotation" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3 mb-5 p-3 vq-tool-panel", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx("label", { className: "text-xs font-bold text-ink-muted", children: "Valid for" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "number",
            ...
            /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted", children: "days" })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: `p-6 sm:p-10 text-ink ${isCompact ? "text-[13px]" : "text-sm"}`, style: { fontFamily: "Helvetica, Arial, sans-serif" }, children: [
            /* @__PURE__ */ jsxs("div", { className: `flex flex-col sm:flex-row justify-between gap-6 mb-8 ${isClassic ? "border-b-2 border-neutral-900 pb-4" : ""}`, children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-left sm:text-right", children: [
                /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold tracking-tight", style: { color: isModern ? accent : "rgb(var(--vq-slate-900))" }, children: meta.document_label }),
                /* @__PURE__ */ jsxs("div", { className: "mt-2 text-xs space-y-0.5", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex sm:justify-end gap-2", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-ink-muted", children: "Valid until" }),
                    /* @__PURE__ */ jsx(
                      EditableText,
                      {
                        as: "date",
            ...
            /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Prepared For" }),
            ...
            /* @__PURE__ */ jsxs("table", { className: "w-full mb-2", children: [
              /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: `text-left text-2xs font-bold uppercase tracking-wide text-ink-muted ${isClassic ? "border-b-2 border-neutral-900" : "border-b border-neutral-900"}`, children: [
                ...
                /* @__PURE__ */ jsx("th", { className: "pb-2 px-2 text-right w-16", children: /* @__PURE__ */ jsx(EditableText, { value: headers.tax, onChange: (v) => setHeaders((h) => ({ ...h, tax: v })), className: "text-2xs font-bold uppercase tracking-wide text-ink-muted text-right", pulse: false }) }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-6 text-xs text-ink-muted mb-6", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink-secondary mb-1", children: "Scope of Work / Inclusions" }),
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink-secondary mb-1", children: "Exclusions" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "text-xs text-ink-muted mb-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-10 pt-5 border-t border-line", children: [
              /* @__PURE__ */ jsxs("p", { className: "text-1xs text-ink-muted mb-8", children: [
                "To accept this ",
                isEstimate ? "estimate" : "quotation",
                ", please sign below or reply confirming acceptance. This ",
                isEstimate ? "estimate" : "quotation",
                " is valid until ",
                /* @__PURE__ */ jsx("span", { className: "font-bold text-ink-secondary", children: meta.valid_until || "—" }),
                "."
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-8", children: [
                /* @__PURE__ */ jsx("div", { className: "pt-10 border-t border-neutral-900 text-1xs text-ink-muted", children: "Signature" }),
                /* @__PURE__ */ jsx("div", { className: "pt-10 border-t border-neutral-900 text-1xs text-ink-muted", children: "Date" })
              ] })
            ] }),
