...
function UomConversions({ product, conversions }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-6 max-w-2xl", children: [
    ...
    conversions.length > 0 ? /* @__PURE__ */ jsxs("table", { className: "w-full border-collapse border border-line mb-6", children: [
      /* @__PURE__ */ jsx("thead", { className: "bg-sunken", children: /* @__PURE__ */ jsxs("tr", { children: [
        /* @__PURE__ */ jsx("th", { className: "border border-line px-4 py-2 text-left", children: "Sale UOM" }),
        /* @__PURE__ */ jsx("th", { className: "border border-line px-4 py-2 text-left", children: "Factor" }),
        /* @__PURE__ */ jsx("th", { className: "border border-line px-4 py-2 text-left", children: "Example" }),
        /* @__PURE__ */ jsx("th", { className: "border border-line px-4 py-2" })
      ] }) }),
      /* @__PURE__ */ jsx("tbody", { children: conversions.map((c) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-interactive-hover", children: [
        /* @__PURE__ */ jsx("td", { className: "border border-line px-4 py-2 font-mono", children: c.sale_uom }),
        /* @__PURE__ */ jsx("td", { className: "border border-line px-4 py-2", children: c.conversion_factor }),
        /* @__PURE__ */ jsxs("td", { className: "border border-line px-4 py-2 text-ink-muted text-sm", children: [
          "1000 ",
          c.sale_uom,
          " = ",
    ...
    ] }) : /* @__PURE__ */ jsxs("p", { className: "text-ink-muted text-sm mb-6", children: [
