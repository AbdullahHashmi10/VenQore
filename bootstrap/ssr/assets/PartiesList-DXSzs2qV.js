      ...
      /* @__PURE__ */ jsxs("div", { className: `grid grid-cols-2 sm:grid-cols-4 gap-2 shrink-0 ${isStatsExpanded ? "grid" : "hidden sm:grid"}`, children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 px-2.5 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-2xs sm:text-xs font-bold text-slate-500 uppercase tracking-tight truncate", children: "Total Parties" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 px-2.5 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-2xs sm:text-xs font-bold text-slate-500 uppercase tracking-tight truncate", children: "Customers" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 px-2.5 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-2xs sm:text-xs font-bold text-slate-500 uppercase tracking-tight truncate", children: "To Receive" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 px-2.5 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-2xs sm:text-xs font-bold text-slate-500 uppercase tracking-tight truncate", children: "Payables" })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 overflow-x-auto no-scrollbar py-0.5", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `px-2 py-0.5 text-3xs sm:text-2xs font-bold uppercase rounded-full transition-all shrink-0 ${typeFilter === "all" ? "bg-indigo-600 text-white shadow-sm" : "bg-slate-100 dark:bg-slate-800 text-slate-500 hover:bg-slate-200"}`,
                children: "All"
              }
            ),
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `px-2 py-0.5 text-3xs sm:text-2xs font-bold uppercase rounded-full transition-all shrink-0 ${typeFilter === "customer" ? "bg-gradient-to-r from-blue-500 to-cyan-600 text-white shadow-sm shadow-blue-500/20" : "bg-slate-100 dark:bg-slate-800 text-slate-500 hover:bg-slate-200"}`,
                children: "Customers"
              }
            ),
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `px-2 py-0.5 text-3xs sm:text-2xs font-bold uppercase rounded-full transition-all shrink-0 ${typeFilter === "supplier" ? "bg-gradient-to-r from-amber-500 to-orange-600 text-white shadow-sm shadow-amber-500/20" : "bg-slate-100 dark:bg-slate-800 text-slate-500 hover:bg-slate-200"}`,
                children: "Suppliers"
              }
            )
          ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-auto rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm bg-white dark:bg-slate-900", children: [
        /* @__PURE__ */ jsx("div", { className: "hidden sm:block", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-10", children: [
            ...
            /* @__PURE__ */ jsx("th", { className: "p-3 text-2xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider text-right", children: "Credit Limit" }),
            /* @__PURE__ */ jsx("th", { className: "p-3 text-2xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider", children: "Phone" }),
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    ...
                    party.email && /* @__PURE__ */ jsx("p", { className: "text-2xs text-slate-400", children: party.email })
                  ] })
                ] }) }),
                /* @__PURE__ */ jsx("td", { className: "p-3 text-center", children: /* @__PURE__ */ jsx("span", { className: `inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-2xs font-bold uppercase ${party.type === "customer" ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400" : "bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400"}`, children: party.type === "customer" ? "Customer" : "Supplier" }) }),
                /* @__PURE__ */ jsx("td", { className: "p-3 text-right", children: /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-2xs text-slate-400", children: party.current_balance > 0 ? party.type === "customer" ? "To Receive" : "To Pay" : party.current_balance < 0 ? party.type === "customer" ? "To Pay" : "To Receive" : "Settled" })
                ] }) }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-start", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    ...
                    party.phone && /* @__PURE__ */ jsx("p", { className: "text-2xs text-slate-500 font-mono mt-0.5", children: party.phone })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "text-right shrink-0", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-3xs text-slate-400 uppercase font-bold tracking-tight", children: party.current_balance > 0 ? party.type === "customer" ? "To Receive" : "To Pay" : party.current_balance < 0 ? party.type === "customer" ? "To Pay" : "To Receive" : "Settled" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-2xs text-slate-500 bg-slate-50/50 dark:bg-slate-900/50 p-1.5 rounded-lg border border-slate-100 dark:border-slate-800/50", children: [
