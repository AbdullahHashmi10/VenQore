...
` });
const Background = ({ active }) => /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 overflow-hidden bg-neutral-950 z-0", children: [
  ...
  /* @__PURE__ */ jsx("div", { className: `absolute top-[-20%] left-[20%] w-[600px] h-[600px] bg-brand-600/10 rounded-full blur-[120px] mix-blend-screen transition-all duration-slower ${active ? "opacity-80 scale-150" : "animate-pulse"}` }),
...
const StatusIcon = ({ status }) => {
  if (status === "running") return /* @__PURE__ */ jsx(Loader, { size: 16, className: "text-brand-400 spin-slow" });
  ...
  if (status === "pending") return /* @__PURE__ */ jsx("div", { className: "w-4 h-4 rounded-full border border-neutral-600" });
  return null;
};
function Updater({ currentVersion, versionHistory = [] }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen w-full flex items-center justify-center font-sans text-neutral-200 overflow-hidden relative p-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 w-full max-w-4xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "glass-panel rounded-2xl relative overflow-hidden border-t border-white/10", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "h-16 border-b border-white/5 flex items-center justify-between px-8 bg-black/20 relative", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "h-4 w-px bg-white/10" }),
              /* @__PURE__ */ jsx("span", { className: "text-xs font-mono text-ink-muted tracking-wider", children: "VENQORE_UPDATER_V1.0" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxs("div", { className: "px-3 py-1 rounded text-2xs font-mono text-ink-muted bg-white/5 uppercase tracking-widest border border-white/5", children: [
                "Current: v",
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-8 md:p-12", children: [
            phase === "select" && /* @__PURE__ */ jsxs("div", { style: { animation: "slide-up 0.4s ease" }, children: [
              /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
                  /* @__PURE__ */ jsx("div", { className: "p-2.5 rounded-xl bg-brand-500/20 text-brand-400", children: /* @__PURE__ */ jsx(Package, { size: 22 }) }),
                  /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-white tracking-tight", children: "System Update" })
                ] }),
                /* @__PURE__ */ jsxs("p", { className: "text-sm text-ink-muted leading-relaxed max-w-lg", children: [
              ...
              sysInfo?.update_in_progress && /* @__PURE__ */ jsxs("div", { className: "bg-rose-500/10 border border-rose-500/40 rounded-xl p-4 mb-6 flex gap-3", children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Another update is currently running on this server. Starting a second update simultaneously WILL corrupt your application. Wait for the current update to finish, or contact your server administrator if it appears stuck." })
                ] })
              ] }),
              ...
              sysInfo && sysInfo.max_zip_mb < 200 && /* @__PURE__ */ jsxs("div", { className: "bg-amber-500/10 border border-amber-500/30 rounded-xl p-4 mb-6 flex gap-3", children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxs("p", { className: "text-xs text-ink-muted mb-2", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 mb-10", children: [
                /* @__PURE__ */ jsxs("div", { className: "md:col-span-1 space-y-6", children: [
                  /* @__PURE__ */ jsxs("div", { className: "bg-black/30 rounded-xl border border-white/5 p-5 space-y-3", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs font-mono text-ink-muted uppercase tracking-widest mb-4", children: [
                      /* @__PURE__ */ jsx(Server, { size: 13 }),
                      " System Info"
                    ] }),
                    infoLoading ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-ink-muted", children: [
                      ...
                      /* @__PURE__ */ jsxs("span", { className: `text-xs font-mono ${ok === false ? "text-rose-400" : ok === true ? "text-emerald-400" : "text-neutral-300"}`, children: [
                        value,
                        action && " ⚠"
                      ] })
                    ] }, label)) }) : /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Could not load system info." })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "bg-black/30 rounded-xl border border-white/5 p-5 space-y-3", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs font-mono text-ink-muted uppercase tracking-widest mb-3", children: [
                      /* @__PURE__ */ jsx(RotateCcw, { size: 13 }),
                      " Update History"
                    ] }),
                    versionHistory.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted italic", children: "No update logs recorded yet." }) : /* @__PURE__ */ jsx("div", { className: "space-y-2 max-h-48 overflow-y-auto custom-scrollbar", children: versionHistory.map((h, i) => /* @__PURE__ */ jsxs("div", { className: "flex flex-col py-1.5 border-b border-white/5 last:border-0", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                        /* @__PURE__ */ jsxs("span", { className: "text-xs font-bold text-white", children: [
                          "v",
                          h.version
                        ] }),
                        /* @__PURE__ */ jsx("span", { className: "text-2xs text-ink-muted", children: new Date(h.updated_at).toLocaleDateString() })
                      ] }),
                      /* @__PURE__ */ jsxs("span", { className: "text-2xs text-ink-muted mt-0.5", children: [
                        "By ",
                        h.by
                      ] })
                    ] }, i)) })
                ...
                /* @__PURE__ */ jsxs("div", { className: "md:col-span-2 space-y-5", children: [
                  /* @__PURE__ */ jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        ] }) : /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-3 text-ink-muted", children: [
                          /* @__PURE__ */ jsx(Upload, { size: 40, className: "text-brand-500/40" }),
                          /* @__PURE__ */ jsxs("div", { children: [
                            /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-ink-muted", children: "Drop your update ZIP here" }),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex gap-3 items-end", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                      /* @__PURE__ */ jsx("label", { className: "block text-xs font-mono text-ink-muted uppercase tracking-widest mb-2", children: "New Version Number" }),
                      /* @__PURE__ */ jsx(
                        "input",
                        {
                          type: "text",
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "text-xs text-ink-secondary pb-3.5 font-mono", children: [
                      "from v",
                      currentVersion || "?"
                    ] })
                  ] })
              ...
              /* @__PURE__ */ jsxs("div", { className: "bg-emerald-500/5 border border-emerald-500/20 rounded-xl p-4 mb-8 flex gap-3", children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxs("p", { className: "text-xs text-ink-muted leading-relaxed", children: [
                    "The following are ",
                    /* @__PURE__ */ jsx("strong", { className: "text-ink-muted", children: "never overwritten" }),
                    " during an update:",
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `w-full py-4 rounded-xl font-bold text-sm uppercase tracking-[0.15em] transition-all duration-slow flex items-center justify-center gap-3 ${zipFile && !sysInfo?.update_in_progress && (!sysInfo || sysInfo.zip_extension) ? "bg-brand-600 hover:bg-brand-500 text-white shadow-[0_0_25px_rgba(99,102,241,0.35)] hover:shadow-[0_0_40px_rgba(99,102,241,0.5)]" : "bg-sunken text-ink-secondary cursor-not-allowed"}`,
                  children: [
            ...
            phase === "confirm" && /* @__PURE__ */ jsxs("div", { style: { animation: "slide-up 0.4s ease" }, children: [
              /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Review what will happen before proceeding." })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "bg-black/30 rounded-xl border border-white/5 p-6 mb-6 space-y-4", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex-1 flex items-center justify-between", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted", children: label }),
                  /* @__PURE__ */ jsx("span", { className: "text-xs font-mono text-neutral-300", children: value })
                ] })
              ] }, label)) }),
              /* @__PURE__ */ jsxs("div", { className: "bg-black/20 rounded-xl border border-white/5 p-5 mb-8", children: [
                /* @__PURE__ */ jsx("p", { className: "text-2xs font-mono text-ink-muted uppercase tracking-widest mb-4", children: "Deployment Steps" }),
                /* @__PURE__ */ jsx("div", { className: "space-y-2", children: steps.map((s, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-sm text-ink-muted", children: [
                  /* @__PURE__ */ jsx("div", { className: "w-5 h-5 rounded-full bg-neutral-800 border border-neutral-700 flex items-center justify-center text-2xs text-ink-muted font-bold shrink-0", children: i + 1 }),
            ...
            (phase === "updating" || phase === "error") && /* @__PURE__ */ jsxs("div", { style: { animation: "slide-up 0.4s ease" }, children: [
              /* @__PURE__ */ jsxs("div", { className: "mb-8 flex items-center gap-3", children: [
                /* @__PURE__ */ jsx("div", { className: `p-2.5 rounded-xl ${phase === "error" ? "bg-rose-500/20 text-rose-400" : "bg-brand-500/20 text-brand-400"}`, children: phase === "error" ? /* @__PURE__ */ jsx(AlertTriangle, { size: 22 }) : /* @__PURE__ */ jsx(Terminal, { size: 22 }) }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("h2", { className: "text-xl font-bold text-white", children: phase === "error" ? "Update Failed" : "Deploying Update..." }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-0.5", children: phase === "error" ? "An error occurred. See details below." : "Do not close this window." })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-xs font-mono text-ink-muted", children: "Progress" }),
                  /* @__PURE__ */ jsxs("span", { className: "text-xs font-mono text-brand-400", children: [
                    Math.round(progress),
                    "%"
                  ] })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "h-2 bg-neutral-800 rounded-full overflow-hidden", children: /* @__PURE__ */ jsx(
                  "div",
                  {
              ...
              /* @__PURE__ */ jsx("div", { className: "grid grid-cols-5 gap-2 mb-6", children: steps.map((s) => /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1.5", children: [
                /* @__PURE__ */ jsx("div", { className: `w-9 h-9 rounded-full flex items-center justify-center border transition-all duration-slower ${s.status === "done" ? "bg-emerald-500/20 border-emerald-500/50 text-emerald-400" : s.status === "running" ? "bg-brand-500/20  border-brand-500/50  text-brand-400  pulse-glow" : s.status === "error" ? "bg-rose-500/20    border-rose-500/50    text-rose-400" : "bg-neutral-800      border-neutral-700      text-ink-secondary"}`, children: /* @__PURE__ */ jsx(StatusIcon, { status: s.status }) }),
                /* @__PURE__ */ jsx("span", { className: "text-3xs text-center text-ink-muted leading-tight font-mono", children: s.label })
              ] }, s.id)) }),
              /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    logs.map((l, i) => /* @__PURE__ */ jsxs("div", { className: `log-line flex gap-2 ${l.type === "error" ? "text-rose-400" : l.type === "warning" ? "text-amber-400" : l.type === "success" ? "text-emerald-400" : l.type === "dim" ? "text-ink-secondary" : "text-ink-muted"}`, children: [
                      /* @__PURE__ */ jsx("span", { className: "text-ink-secondary shrink-0", children: l.time }),
                      /* @__PURE__ */ jsx("span", { children: l.text })
                    ] }, i)),
                    logs.length === 0 && /* @__PURE__ */ jsx("span", { className: "text-ink-secondary", children: "Initializing update sequence..." })
                  ]
                }
              ),
            ...
            phase === "done" && /* @__PURE__ */ jsxs("div", { className: "text-center py-8", style: { animation: "slide-up 0.5s ease" }, children: [
              ...
              /* @__PURE__ */ jsxs("p", { className: "text-ink-muted text-sm mb-2", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-ink-secondary text-xs mb-10", children: "All your data, customer records, and configurations remain intact." }),
        ...
        /* @__PURE__ */ jsx("p", { className: "text-center text-xs text-ink-secondary mt-4 font-mono", children: "VENQORE — Secure Update Channel. Protected by server-side validation." })
      ] })
    ] }),
    showLimitHelp && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4", onClick: () => setShowLimitHelp(false), children: /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 border border-white/10 rounded-2xl shadow-2xl max-w-xl w-full max-h-[85vh] overflow-y-auto", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ jsxs("div", { className: "sticky top-0 bg-neutral-900 border-b border-white/10 px-6 py-4 flex items-center justify-between rounded-t-2xl z-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsx("button", { onClick: () => setShowLimitHelp(false), className: "text-ink-muted hover:text-white transition-colors p-1 rounded-lg hover:bg-white/10", children: /* @__PURE__ */ jsx(X, { size: 18 }) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "px-6 py-5 space-y-6 text-xs text-neutral-300", children: [
        /* @__PURE__ */ jsxs("p", { className: "text-ink-muted leading-relaxed", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-brand-500/10 border border-brand-500/20 rounded-xl p-4", children: [
          /* @__PURE__ */ jsxs("h4", { className: "font-bold text-brand-400 mb-3 flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "w-5 h-5 rounded bg-brand-500/30 flex items-center justify-center text-2xs font-bold", children: "1" }),
            "XAMPP / WAMP (Local Windows Server)"
          ] }),
          /* @__PURE__ */ jsxs("ol", { className: "space-y-2 text-ink-muted list-decimal list-inside", children: [
            /* @__PURE__ */ jsxs("li", { children: [
              "Open ",
              /* @__PURE__ */ jsx("code", { className: "text-brand-300 bg-brand-500/10 px-1.5 py-0.5 rounded", children: "php.ini" }),
              " file. In XAMPP it is usually at:",
              /* @__PURE__ */ jsx("code", { className: "block mt-1 text-neutral-300 bg-black/40 px-3 py-1.5 rounded font-mono", children: "D:\\Software\\XAMPP\\php\\php.ini" })
            ] }),
            /* @__PURE__ */ jsxs("li", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-2xs text-ink-muted", children: "Note: Some shared hosts may have lower hard limits. Contact your hosting provider if the values don't change." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-brand-500/10 border border-brand-500/20 rounded-xl p-4", children: [
          /* @__PURE__ */ jsxs("h4", { className: "font-bold text-brand-400 mb-3 flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "w-5 h-5 rounded bg-brand-500/30 flex items-center justify-center text-2xs font-bold", children: "3" }),
            "Linux Server (VPS / Dedicated)"
          ] }),
          /* @__PURE__ */ jsxs("ol", { className: "space-y-2 text-ink-muted list-decimal list-inside", children: [
            /* @__PURE__ */ jsxs("li", { children: [
              "Find your PHP config file:",
              /* @__PURE__ */ jsx("code", { className: "block mt-1 text-neutral-300 bg-black/40 px-3 py-1.5 rounded font-mono", children: 'php -i | grep "php.ini"' })
            ] }),
            /* @__PURE__ */ jsxs("li", { children: [
              "Edit the file:",
              /* @__PURE__ */ jsx("code", { className: "block mt-1 text-neutral-300 bg-black/40 px-3 py-1.5 rounded font-mono", children: "sudo nano /etc/php/8.2/fpm/php.ini" })
            ] }),
            /* @__PURE__ */ jsxs("li", { children: [
              "Update these values:",
              /* @__PURE__ */ jsx("code", { className: "block mt-1 text-emerald-300 bg-black/40 px-3 py-1.5 rounded font-mono whitespace-pre", children: "upload_max_filesize = 300M\npost_max_size = 300M" })
            ...
            /* @__PURE__ */ jsxs("li", { children: [
              ...
              /* @__PURE__ */ jsx("code", { className: "block mt-1 text-neutral-300 bg-black/40 px-3 py-1.5 rounded font-mono whitespace-pre", children: "sudo systemctl restart php8.2-fpm\nsudo systemctl restart nginx" })
            ] }),
            /* @__PURE__ */ jsx("li", { children: "Refresh this page to verify." })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "bg-neutral-800/50 border border-white/5 rounded-xl p-4 text-center", children: /* @__PURE__ */ jsxs("p", { className: "text-ink-muted text-2xs", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "sticky bottom-0 bg-neutral-900 border-t border-white/10 px-6 py-3 rounded-b-2xl", children: /* @__PURE__ */ jsx(
        "button",
        {
