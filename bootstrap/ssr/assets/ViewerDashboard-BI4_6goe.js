  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      style: {
        ...
        border: "1px solid var(--card-border,rgb(var(--vq-slate-100)))",
        boxShadow: "0 2px 8px rgba(0,0,0,0.03)",
        cursor: "pointer",
        transition: "border-color 0.15s, transform 0.15s"
      },
      onMouseEnter: (e) => {
        e.currentTarget.style.borderColor = "rgb(var(--vq-indigo-300))";
        e.currentTarget.style.transform = "translateY(-1px)";
      },
      onMouseLeave: (e) => {
        e.currentTarget.style.borderColor = "var(--card-border, rgb(var(--vq-slate-100)))";
        e.currentTarget.style.transform = "none";
      },
      children: [
        /* @__PURE__ */ jsx("div", { style: { width: 36, height: 36, borderRadius: 10, background: "#ede9fe", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }, children: /* @__PURE__ */ jsx(Icon, { size: 17, color: "#6366f1" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { style: { fontSize: 13, fontWeight: 700, color: "var(--text-main,rgb(var(--vq-slate-900)))" }, children: label }),
    ...
    /* @__PURE__ */ jsxs("div", { style: { maxWidth: 700, margin: "0 auto", padding: "32px 24px" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { marginBottom: 28 }, children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }, children: [
          /* @__PURE__ */ jsx(Eye, { size: 20, color: "#6366f1" }),
          /* @__PURE__ */ jsx("h1", { style: { fontSize: 22, fontWeight: 800, color: "var(--text-main,rgb(var(--vq-slate-900)))", margin: 0 }, children: "Read-Only Reports" })
        ] }),
        /* @__PURE__ */ jsxs("p", { style: { fontSize: 13, color: "rgb(var(--vq-slate-500))", margin: 0 }, children: [
          store?.name,
          " · You have view-only access. No transactions can be created."
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "12px 16px", borderRadius: 12, background: "#f0f9ff", border: "1px solid #bae6fd", marginBottom: 28, fontSize: 13, color: "#0369a1" }, children: [
      ...
      ].map((t) => /* @__PURE__ */ jsxs("div", { style: { background: "var(--card-bg,#fff)", border: "1px solid var(--card-border,rgb(var(--vq-slate-100)))", borderRadius: 16, padding: "18px 20px", boxShadow: "0 2px 8px rgba(0,0,0,0.03)", textAlign: "center" }, children: [
        /* @__PURE__ */ jsx("div", { style: { fontSize: 20, fontWeight: 800, color: t.color }, children: t.value }),
        /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: "rgb(var(--vq-slate-500))", marginTop: 6, fontWeight: 600 }, children: t.label })
      ] }, t.label)) }),
      /* @__PURE__ */ jsxs("div", { style: { background: "var(--card-bg,#fff)", border: "1px solid var(--card-border,rgb(var(--vq-slate-100)))", borderRadius: 20, padding: "18px 22px", display: "flex", justifyContent: "space-between", alignItems: "center", boxShadow: "0 2px 8px rgba(0,0,0,0.03)", marginBottom: 28 }, children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { style: { fontSize: 13, fontWeight: 700, color: "var(--text-main,rgb(var(--vq-slate-900)))" }, children: "Total Inventory Value (FIFO)" }),
          /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: "rgb(var(--vq-slate-400))", marginTop: 3 }, children: "Current cost-based valuation" })
        ] }),
        /* @__PURE__ */ jsx("div", { style: { fontSize: 22, fontWeight: 800, color: "rgb(var(--vq-indigo-500))" }, children: fmt(inventoryValue ?? 0) })
      ] }),
      /* @__PURE__ */ jsx("div", { style: { fontWeight: 700, fontSize: 14, color: "var(--text-main,rgb(var(--vq-slate-900)))", marginBottom: 12 }, children: "Available Reports" }),
