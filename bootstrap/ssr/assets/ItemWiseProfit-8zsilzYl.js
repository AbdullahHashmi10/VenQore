        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 pl-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("h1", { className: "text-xl font-bold text-ink tracking-tight flex items-center gap-2", children: [
              "Profit ",
              /* @__PURE__ */ jsx("span", { className: "text-ink-muted font-medium text-sm", children: "By Item" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted font-medium", children: tt("Product-level profitability analysis") })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-4 gap-6 flex-1 min-h-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "xl:col-span-2 bg-surface rounded-2xl border border-line shadow-sm flex flex-col overflow-hidden", children: [
          /* @__PURE__ */ jsxs("div", { className: "p-5 border-b border-line flex flex-col sm:flex-row justify-between items-start sm:items-center bg-sunken/50 dark:bg-surface gap-4", children: [
            /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink shrink-0", children: "Item Breakdown" }),
          ...
          productFilter.length > 0 && /* @__PURE__ */ jsxs("div", { className: "px-5 py-2 bg-brand-50 dark:bg-brand-900/10 border-b border-brand-100 dark:border-brand-900/30 flex items-center justify-between text-xs", children: [
            /* @__PURE__ */ jsxs("span", { className: "text-brand-600 dark:text-brand-400 font-bold", children: [
              productFilter.length,
              " product(s) selected"
            ] }),
            /* @__PURE__ */ jsx("button", { onClick: clearProductFilter, className: "text-brand-500 hover:text-brand-700 font-bold underline", children: "Clear filter" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm text-left", children: [
            /* @__PURE__ */ jsx("thead", { className: "text-xs text-ink-muted uppercase bg-app sticky top-0 backdrop-blur-sm z-10", children: /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("th", { className: "px-6 py-3 font-bold", children: tt("Product Name") }) }) }),
              ...
              filteredItems.map((item, idx) => {
                return /* @__PURE__ */ jsx(
                  "tr",
                  {
                    ...
                    children: /* @__PURE__ */ jsxs("td", { className: "px-6 py-4 font-medium text-ink-secondary dark:text-ink flex justify-between items-center", children: [
                      /* @__PURE__ */ jsx("span", { children: item.name }),
                      /* @__PURE__ */ jsx("span", { className: "text-xs text-brand-500 font-bold transition-colors", children: "View Details →" })
                    ] })
                  },
                  item.product_id || idx
                );
              }),
              filteredItems.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { className: "px-6 py-8 text-center text-ink-muted italic", children: "No products found matching the search." }) })
            ] })
          ] }) })
        ] }),
        ...
        /* @__PURE__ */ jsx("div", { className: "xl:col-span-1 flex flex-col gap-4 h-full", children: /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-neutral-900 to-neutral-800 p-5 rounded-2xl border border-neutral-700 shadow-lg text-white h-full relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 backdrop-blur-sm p-3 rounded-xl border border-white/10", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-1xs text-neutral-300 mobile-relaxed", children: "Run the AI analyzer to detect margin leaks and find hidden pricing opportunities in your catalog." })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 backdrop-blur-sm p-3 rounded-xl border border-white/10", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-1xs text-neutral-300", children: 'Identify "Loss Leaders" that are draining your overall profitability.' })
            ] })
          ] }),
      ...
      analysisResult && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-900/60 backdrop-blur-sm animate-in fade-in duration-normal", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface w-full max-w-md rounded-2xl shadow-2xl border border-line overflow-hidden animate-in zoom-in-95 duration-normal", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-brand-600 p-6 text-white relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
            ...
            /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold tracking-tight", children: "Catalog Intelligence" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-brand-600 p-6 text-white relative overflow-hidden shrink-0", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex justify-between items-center", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                ...
                /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold tracking-tight mt-1", children: activeProduct.name }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-6 space-y-6 overflow-y-auto flex-1", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-6", children: [
              /* @__PURE__ */ jsxs("div", { className: "bg-app p-4 rounded-xl border border-line", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold text-ink mt-1", children: formatCurrency(activeProduct.revenue, store) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-app p-4 rounded-xl border border-line", children: [
                /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Profit in Period" }),
                /* @__PURE__ */ jsx("p", { className: `text-3xl font-bold mt-1 ${activeProduct.profit < 0 ? "text-rose-500" : "text-emerald-500"}`, children: formatCurrency(activeProduct.profit, store) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-app p-4 rounded-xl border border-line", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "xl:col-span-5", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "bg-app rounded-xl border border-line overflow-hidden", children: /* @__PURE__ */ jsx("table", { className: "w-full text-xs sm:text-sm", children: /* @__PURE__ */ jsxs("tbody", { className: "divide-y divide-line", children: [
                  /* @__PURE__ */ jsxs("tr", { children: [
                    ...
                    /* @__PURE__ */ jsx("td", { className: "py-3 px-4 text-right font-mono text-ink-secondary dark:text-ink font-bold", children: formatCurrency(activeProduct.revenue, store) })
                  ] }),
                  /* @__PURE__ */ jsxs("tr", { children: [
                  ...
                  /* @__PURE__ */ jsxs("tr", { className: "border-t border-line bg-sunken/50 dark:bg-surface", children: [
                    ...
                    /* @__PURE__ */ jsx("td", { className: "py-3 px-4 text-right font-mono text-ink-muted", children: formatCurrency(activeProduct.purchase_cost || 0, store) })
                  ] }),
                  /* @__PURE__ */ jsxs("tr", { className: "bg-sunken/50 dark:bg-surface", children: [
                    ...
                    /* @__PURE__ */ jsx("td", { className: "py-3 px-4 text-right font-mono text-ink-muted", children: formatCurrency(activeProduct.stock_value || 0, store) })
                  ] })
                ] }) }) })
              ] }),
...
function ProductMultiSelect({ allProducts, selected, onToggle }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    ...
    isOpen && /* @__PURE__ */ jsxs("div", { className: "absolute top-full left-0 mt-2 w-72 bg-surface rounded-[14px] shadow-xl border border-line z-30 overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "p-2 border-b border-line", children: /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
          autoFocus: true,
      ...
      /* @__PURE__ */ jsx("div", { className: "max-h-64 overflow-y-auto p-1", children: filtered.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted text-center py-4", children: tt("No products found") }) : filtered.map((p) => /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-interactive-hover dark:hover:bg-interactive-hover cursor-pointer text-xs", children: [
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ jsx("span", { className: "text-ink-secondary truncate", children: p.name })
      ] }, p.id)) }),
      /* @__PURE__ */ jsx("div", { className: "p-2 border-t border-line flex justify-end", children: /* @__PURE__ */ jsx("button", { onClick: () => setIsOpen(false), className: "px-3 py-1 bg-brand-600 hover:bg-brand-700 text-white rounded-lg text-xs font-bold", children: "Done" }) })
    ] })
  ] });
}
