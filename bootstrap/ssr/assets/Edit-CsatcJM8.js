...
function ProductEdit({ product, uomConversions, priceTiers }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-6 max-w-2xl", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
      /* @__PURE__ */ jsxs(Link, { href: route("store.v3.products.index", { store_slug: store?.slug }), className: "text-ink-muted hover:text-ink", children: [
        "← ",
        tt("Products")
      ] }),
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium mb-1", children: tt("Supplier SKU Mapping") }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
      ...
      uomConversions.length > 0 && /* @__PURE__ */ jsxs("div", { className: "border rounded p-4 bg-sunken", children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-medium mb-2", children: "UOM Conversions" }),
        uomConversions.map((c) => /* @__PURE__ */ jsxs("p", { className: "text-sm text-ink-secondary", children: [
          "1 ",
          data.base_unit,
          " = ",
          c.conversion_factor,
      ...
      priceTiers.length > 0 && /* @__PURE__ */ jsxs("div", { className: "border rounded p-4 bg-sunken", children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-medium mb-2", children: "Price Tiers" }),
        priceTiers.map((t) => /* @__PURE__ */ jsxs("p", { className: "text-sm text-ink-secondary", children: [
          t.min_qty,
          "–",
          t.max_qty ?? "∞",
          " units: ",
