...
import { M as Modal, O as OneGlanceLayout, e as useWorkspace, f as Toast } from "./marketing-pages-DYgr6x02.js";
...
import { f as db$1, F as FormModal } from "../ssr.js";
import { P as PrintService } from "./PrintService-CcoxuDF9.js";
import { r as roundTotal, s as shouldStopNegativeStock, g as getProductPrice } from "./settings-DUqQ1JdE.js";
import { C as ConfirmModal } from "./ConfirmModal-BhPRFIAG.js";
...
import "./PrintPreview-DUtO9WXW.js";
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-slate-400 text-2xs", children: "▼" })
                ]
              }
            ),
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "text-slate-400 text-4xs ml-1", children: "▼" })
                  ]
                }
              ),
...
const POSInterface = ({ settings, recalledSale, bankAccounts = [], warehouses = [] }) => {
      ...
      const messageElement = /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-5 py-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-slate-950 p-4 rounded-2xl border-2 border-slate-800 flex flex-col items-center justify-center", children: [
            /* @__PURE__ */ jsx("span", { className: "text-1xs font-black text-slate-400 uppercase block tracking-wider mb-1.5", children: "Change Due" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-slate-950 p-4 rounded-2xl border-2 border-slate-800 text-center", children: [
            /* @__PURE__ */ jsx("span", { className: "text-1xs font-black text-slate-400 uppercase block tracking-wider mb-1.5", children: "Total Items" }),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "h-full w-full flex flex-col pl-3 pr-0 pb-0 pt-3 animate-in fade-in zoom-in-95 duration-300", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 flex gap-0 min-h-0 bg-slate-50 dark:bg-slate-950 rounded-t-3xl rounded-b-none shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden z-0 relative", children: [
                  ...
                  children: [
                    ...
                    categories.filter((cat) => cat.products_count > 0 || cat.product_count > 0).map((cat) => /* @__PURE__ */ jsxs(
                      "button",
                      {
                        ...
                        className: `px-3 py-1.5 rounded-full text-1xs font-black transition-all shrink-0 border flex items-center gap-1.5 ${selectedCategory === cat.id ? "bg-indigo-600 text-white border-indigo-600 shadow-sm" : "bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700"}`,
                        children: [
                          /* @__PURE__ */ jsx("span", { children: cat.name }),
                          /* @__PURE__ */ jsx("span", { className: `text-3xs px-1 py-0.2 rounded-full shrink-0 ${selectedCategory === cat.id ? "bg-white/20 text-white" : "bg-slate-200 dark:bg-slate-700 text-slate-500 dark:text-slate-400"}`, children: cat.products_count ?? cat.product_count ?? 0 })
                        ]
                      },
                      cat.id
                    ))
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 min-w-0 flex-1", children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                        ...
                        /* @__PURE__ */ jsx("span", { className: "text-2xs text-slate-400 font-bold uppercase tracking-wider block mt-0.5", children: product.category?.name || product.category_name || "General" })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "text-right shrink-0 flex items-center gap-4", children: [
                      /* @__PURE__ */ jsxs("div", { children: [
                        /* @__PURE__ */ jsx("span", { className: "text-4xs font-black text-slate-400 uppercase tracking-wider block mb-0.5 leading-none", children: "Stock" }),
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "min-w-[75px]", children: [
                        /* @__PURE__ */ jsx("span", { className: "text-4xs font-black text-slate-400 uppercase tracking-wider block mb-0.5 leading-none", children: "Price" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: `w-full lg:w-[40%] shrink-0 flex flex-col bg-slate-50 dark:bg-slate-950 border-l border-slate-100 dark:border-slate-800 ${activeMobileTab !== "cart" ? "hidden lg:flex" : ""}`, children: [
          /* @__PURE__ */ jsxs("div", { className: "h-14 px-3 bg-slate-50/50 dark:bg-slate-800/30 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              hasDiscountPerm && /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-1.5 cursor-pointer select-none", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-slate-500 dark:text-slate-400", children: "FREE QTY" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("span", { className: `px-2 py-0.5 rounded-lg font-black text-2xs bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400`, children: [
              activeSale.cart.length,
              " ITEMS • ",
          ...
          returnMode && /* @__PURE__ */ jsxs("div", { className: "mx-3 mb-2 mt-2 p-3 bg-red-500/10 border border-red-500/30 rounded-xl", children: [
            ...
            posReturnMode === "open" ? /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs text-red-400 mb-2", children: "Add items to return. Optionally enter a reference number to link to the original sale." }),
              ...
              /* @__PURE__ */ jsx("p", { className: "text-2xs text-red-400 mb-2", children: "Search by customer or enter a reference number." }),
              /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsx(
                  "input",
                  {
              ...
              /* @__PURE__ */ jsx("p", { className: "text-2xs text-red-400 mb-2", children: "Enter the original sale reference number to load items for return." }),
              /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsx(
                  "input",
                  {
          ...
          /* @__PURE__ */ jsxs("div", { ref: cartListRef, className: "flex-1 overflow-y-auto custom-scrollbar p-3 space-y-2", children: [
            activeSale.cart.map((item, index) => /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-800 px-3 py-2.5 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm flex items-center justify-between gap-3 text-xs relative group overflow-hidden", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5 min-w-0 flex-1", children: [
                /* @__PURE__ */ jsx("span", { className: "text-2xs font-black text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-700 rounded-full w-5 h-5 flex items-center justify-center shrink-0", children: index + 1 }),
                /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-0.5", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-3xs text-slate-400 font-bold uppercase tracking-wider", children: item.category }),
                    item.qty > item.stock && /* @__PURE__ */ jsxs("span", { className: "text-3xs font-black text-red-500 bg-red-100 dark:bg-red-900/30 px-1 py-0.5 rounded animate-pulse", children: [
                      "⚠️ Over Stock (",
                      item.stock,
                      ")"
                    ] })
                  ...
                  hasDiscountPerm ? /* @__PURE__ */ jsx(
                    "button",
                    {
                      ...
                      children: item.discount > 0 ? /* @__PURE__ */ jsxs(Fragment, { children: [
                        /* @__PURE__ */ jsx("span", { className: "line-through text-3xs text-slate-400 opacity-70", children: formatCurrency(item.original_price, store || settings) }),
                        /* @__PURE__ */ jsx("span", { children: formatCurrency(item.price, store || settings) })
                      ] }) : formatCurrency(item.price, store || settings)
                    }
                  ) : /* @__PURE__ */ jsx("span", { className: "text-1xs font-black text-slate-900 dark:text-white", children: formatCurrency(item.price, store || settings) }),
                  item.discount > 0 && /* @__PURE__ */ jsxs("span", { className: "text-3xs font-black text-emerald-600 dark:text-emerald-400 mt-0.5", children: [
                    "Disc: -",
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
                /* @__PURE__ */ jsxs("div", { className: "text-right min-w-[75px]", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-4xs font-black text-slate-400 uppercase tracking-wider block leading-none mb-0.5", children: "Line Total" }),
                  ...
                  (settings?.show_margin_percentage === "1" || settings?.show_margin_percentage === true) && item.cost_price > 0 && /* @__PURE__ */ jsxs("span", { className: "text-4xs font-bold text-emerald-600 dark:text-emerald-400 block leading-none mt-0.5", children: [
                    "Margin: ",
        ...
        /* @__PURE__ */ jsxs("div", { className: `w-full lg:w-[20%] shrink-0 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white flex flex-col shadow-2xl relative overflow-hidden border-l border-slate-200 dark:border-slate-800 ${activeMobileTab !== "checkout" ? "hidden lg:flex" : ""}`, children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "h-14 px-4 bg-slate-50/50 dark:bg-slate-800/30 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxs("span", { className: "px-2 py-0.5 rounded-lg font-black text-2xs bg-slate-200 dark:bg-slate-800/40 text-slate-600 dark:text-slate-400 border border-slate-300 dark:border-slate-700/50", children: [
              "#",
              activeSale.id
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1 p-3 space-y-3 overflow-y-auto custom-scrollbar", children: [
              ...
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase font-black text-slate-500 block mb-0.5", children: "Customer / Party" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
              hasDiscountPerm && /* @__PURE__ */ jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("label", { className: "text-3xs uppercase font-bold text-slate-500 block mb-0.5", children: "Discount" }),
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-4 h-4 rounded-full bg-amber-500/20 text-amber-600 dark:text-amber-500 flex items-center justify-center text-2xs font-bold", children: "%" }),
              ...
              /* @__PURE__ */ jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsxs("div", { className: "group relative h-full", children: [
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    className: "w-full bg-white dark:bg-white/5 p-3 rounded-xl text-left hover:bg-slate-50 dark:hover:bg-white/10 transition-colors border border-slate-200 dark:border-white/5 shadow-sm h-16 flex flex-col justify-center",
                    children: [
                      /* @__PURE__ */ jsx("label", { className: "text-3xs uppercase font-bold text-slate-500 block mb-0.5", children: "Method" }),
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
            ...
            ["bank", "card", "online"].includes(paymentMethod) && (bankAccounts.length > 0 ? /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-xl border border-white/5 shadow-inner animate-in fade-in slide-in-from-top-1 duration-200", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-2 px-1", children: [
                /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase font-black text-slate-500 block", children: "Deposit To Account" }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-2xs uppercase font-black text-rose-500", children: "No Bank Accounts Found" })
              ] }),
              /* @__PURE__ */ jsx("p", { className: "text-1xs text-slate-400 mb-3 leading-tight", children: "You need at least one bank/online account to receive digital payments." }),
              /* @__PURE__ */ jsxs(
                "button",
                {
                  onClick: () => setShowQuickAccountModal(true),
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-3", children: /* @__PURE__ */ jsxs("div", { id: "tour-pos-paid", className: "bg-white dark:bg-white/5 p-4 rounded-xl border border-slate-200 dark:border-white/5 shadow-sm transition-all", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-2", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-2xs bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 px-1.5 py-0.5 rounded font-bold", children: paymentMethod.toUpperCase() })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            ...
            !returnMode && /* @__PURE__ */ jsx("div", { className: `p-4 rounded-xl border transition-colors ${changeDue >= 0 ? "bg-emerald-500/10 border-emerald-500/20" : "bg-red-500/10 border-red-500/20"}`, children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
              /* @__PURE__ */ jsx("span", { className: `text-xs font-bold uppercase ${changeDue >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`, children: changeDue >= 0 ? "Change Due" : "Shortage" }),
              /* @__PURE__ */ jsx("span", { className: `text-2xl font-black ${changeDue >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`, children: formatCurrency(Math.abs(changeDue), store || settings) })
            ] }) })
          ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-slate-900 dark:bg-slate-950 border-t border-slate-800 flex items-center justify-between px-6 py-1.5 text-1xs font-bold text-slate-400 shadow-lg shrink-0 z-10 select-none", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsx("span", { className: "bg-slate-800 text-white px-1.5 py-0.5 rounded text-3xs font-mono border border-slate-700", children: "F1" }),
          /* @__PURE__ */ jsx("span", { children: "Search" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "w-px h-4 bg-slate-800" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsx("span", { className: "bg-slate-800 text-white px-1.5 py-0.5 rounded text-3xs font-mono border border-slate-700", children: "F2" }),
          /* @__PURE__ */ jsx("span", { children: "Qty" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "w-px h-4 bg-slate-800" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsx("span", { className: "bg-slate-800 text-white px-1.5 py-0.5 rounded text-3xs font-mono border border-slate-700", children: "F3" }),
          /* @__PURE__ */ jsx("span", { children: "Item Disc" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "w-px h-4 bg-slate-800" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsx("span", { className: "bg-slate-800 text-white px-1.5 py-0.5 rounded text-3xs font-mono border border-slate-700", children: "F4" }),
          /* @__PURE__ */ jsx("span", { children: "Remove" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "w-px h-4 bg-slate-800" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsx("span", { className: "bg-slate-800 text-white px-1.5 py-0.5 rounded text-3xs font-mono border border-slate-700", children: "F5" }),
          /* @__PURE__ */ jsx("span", { children: "Price" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "w-px h-4 bg-slate-800" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsx("span", { className: "bg-slate-800 text-white px-1.5 py-0.5 rounded text-3xs font-mono border border-slate-700", children: "F11" }),
          /* @__PURE__ */ jsx("span", { children: "Customer" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "w-px h-4 bg-slate-800" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsx("span", { className: "bg-slate-800 text-white px-1.5 py-0.5 rounded text-3xs font-mono border border-slate-700", children: "F12" }),
          /* @__PURE__ */ jsx("span", { children: "Remarks" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "w-px h-4 bg-slate-800" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsx("span", { className: "bg-slate-800 text-white px-1.5 py-0.5 rounded text-3xs font-mono border border-slate-700", children: "^S" }),
          /* @__PURE__ */ jsx("span", { children: "Save" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "w-px h-4 bg-slate-800" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsx("span", { className: "bg-slate-800 text-white px-1.5 py-0.5 rounded text-3xs font-mono border border-slate-700", children: "^P" }),
          /* @__PURE__ */ jsx("span", { children: "Print" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "w-px h-4 bg-slate-800" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsx("span", { className: "bg-slate-800 text-white px-1.5 py-0.5 rounded text-3xs font-mono border border-slate-700", children: "Alt+Z" }),
      ...
      globalDiscountModal.show && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[90] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-200", children: /* @__PURE__ */ jsxs("div", { className: "bg-slate-900 w-full max-w-sm rounded-2xl shadow-2xl border border-white/10 overflow-hidden text-white", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-5 border-b border-white/5 flex justify-between items-center bg-white/5", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-1xs text-slate-400", children: "Select type and discount value" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-5 space-y-4", children: [
          ...
          globalDiscountModal.type === "percentage" && /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsx("div", { className: "flex justify-between items-center", children: /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase font-bold text-slate-500 block", children: "Presets (Hold to Edit)" }) }),
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase font-bold text-slate-500 block mb-1.5", children: globalDiscountModal.type === "percentage" ? "Discount Percentage (%)" : `Discount Value (${getCurrencySymbol(store || settings)})` }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "number",
      ...
      showQuickAccountModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-200", children: /* @__PURE__ */ jsxs("div", { className: "bg-slate-900 w-full max-w-md rounded-2xl shadow-2xl border border-white/10 overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-6 space-y-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase font-bold text-slate-500 block mb-1.5", children: "Account Name" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                id: "quick-acc-name",
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase font-bold text-slate-500 block mb-1.5", children: "Type" }),
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase font-bold text-slate-500 block mb-1.5", children: "Bank Name" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  id: "quick-acc-bank",
      ...
      converterModal.show && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-800 rounded-3xl shadow-2xl w-full max-w-sm p-6 space-y-5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-slate-400 uppercase mb-2", children: "When Total changes, recalculate:" }),
          /* @__PURE__ */ jsxs("div", { className: "flex gap-2 bg-slate-100 dark:bg-slate-700 p-1 rounded-xl", children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
        ...
        [
          ...
          /* @__PURE__ */ jsx("label", { className: "text-2xs font-bold text-slate-400 uppercase block mb-1", children: label }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        ...
        offlineSales.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "py-12 text-center", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
              /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-2xs font-black uppercase text-slate-400 tracking-tighter", children: "OFFLINE" }),
