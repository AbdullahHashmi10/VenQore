      ...
      children: /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad space-y-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-sm font-semibold text-ink dark:text-ink", children: "1. Upload or paste your CSV" }),
            /* @__PURE__ */ jsxs("span", { className: "text-2xs text-ink-muted dark:text-ink-muted", children: [
              "Up to ",
          ...
          mode === "paste" ? /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setCsvText(SAMPLE_CSV), className: "text-xs text-brand-500 hover:underline", children: "Load a messy sample file" })
          ...
          /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-2.5 text-xs text-ink-secondary dark:text-ink-secondary cursor-pointer", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
        ...
        result && /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad space-y-4", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-sm font-semibold text-ink dark:text-ink", children: "2. Confirm column mapping" }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted dark:text-ink-muted", children: "We auto-detected which column is which. Fix any that guessed wrong." }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: fields.map((field) => /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-xs text-ink-muted dark:text-ink-secondary mb-1", children: FIELD_LABELS[field] || field }),
            /* @__PURE__ */ jsx(
              Select,
              {
        ...
        summary && /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad space-y-4", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-sm font-semibold text-ink dark:text-ink", children: "3. Cleanup report" }),
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-xl bg-white dark:bg-app border border-line dark:border-line", children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-ink", children: summary.rows_processed }),
              /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted dark:text-ink-muted uppercase tracking-wide", children: "Rows processed" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-xl bg-white dark:bg-app border border-line dark:border-line", children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-amber-500", children: summary.issues_found }),
              /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted dark:text-ink-muted uppercase tracking-wide", children: "Issues found" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-xl bg-white dark:bg-app border border-line dark:border-line", children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-emerald-500", children: summary.rows_auto_fixed }),
              /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted dark:text-ink-muted uppercase tracking-wide", children: "Rows auto-fixed" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-xl bg-white dark:bg-app border border-line dark:border-line", children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-ink-muted", children: summary.rows_skipped_empty }),
              /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted dark:text-ink-muted uppercase tracking-wide", children: "Empty rows skipped" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
            Object.entries(summary.issues_by_type).filter(([, count]) => count > 0).map(([type, count]) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-xs px-3 py-2 rounded-lg bg-white dark:bg-app border border-line dark:border-line", children: [
              /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-2 text-ink-secondary dark:text-ink-secondary", children: [
                /* @__PURE__ */ jsx(AlertTriangle, { className: "w-3.5 h-3.5 text-amber-500" }),
                ISSUE_LABELS[type] || type
              ] }),
              /* @__PURE__ */ jsx("span", { className: "font-bold text-ink", children: count })
            ] }, type)),
          ...
          /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse min-w-[700px] text-xs", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b border-line dark:border-line text-2xs font-semibold text-ink-muted dark:text-ink-secondary uppercase tracking-wider", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line dark:divide-line", children: result.preview.map((row) => /* @__PURE__ */ jsxs("tr", { children: [
              /* @__PURE__ */ jsx("td", { className: "py-2 pr-2 text-ink-muted", children: row.row_number }),
              /* @__PURE__ */ jsx("td", { className: "py-2 pr-2 text-ink dark:text-ink", children: row.name || "—" }),
              /* @__PURE__ */ jsxs("td", { className: "py-2 pr-2 font-mono text-ink dark:text-ink", children: [
                row.sku || "—",
                row.sku_generated && /* @__PURE__ */ jsx("span", { className: "ml-1 text-3xs text-brand-500", children: "(generated)" })
              ] }),
              /* @__PURE__ */ jsx("td", { className: "py-2 pr-2 text-ink dark:text-ink", children: row.price_clean !== null && row.price_clean !== void 0 ? Number(row.price_clean).toFixed(2) : row.price || "—" }),
              /* @__PURE__ */ jsx("td", { className: "py-2 pr-2 font-mono text-ink dark:text-ink", children: row.barcode || "—" }),
              /* @__PURE__ */ jsx("td", { className: "py-2", children: row.issues.length === 0 ? /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 text-emerald-500", children: [
                ...
                " OK"
              ] }) : /* @__PURE__ */ jsx("span", { className: "inline-flex flex-wrap gap-1", children: row.issues.map((issue) => /* @__PURE__ */ jsx("span", { className: "px-1.5 py-0.5 rounded bg-amber-500/10 text-amber-600 dark:text-amber-300 text-2xs", children: ISSUE_LABELS[issue] || issue }, issue)) }) })
            ] }, row.row_number)) })
          ] }) }),
          summary.rows_kept > result.preview.length && /* @__PURE__ */ jsxs("p", { className: "text-1xs text-ink-muted dark:text-ink-muted", children: [
            "Showing first ",
