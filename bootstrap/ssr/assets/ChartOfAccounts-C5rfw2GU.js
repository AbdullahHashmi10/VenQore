    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full bg-app p-2 gap-1 overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-4 gap-1 shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1.5 bg-brand-100 dark:bg-brand-900/30 text-brand-600 dark:text-brand-400 rounded-lg", children: /* @__PURE__ */ jsx(Briefcase, { size: 16 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Assets" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-brand-600", children: formatCurrency(stats.assets) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Liabilities" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-rose-600", children: formatCurrency(stats.liabilities) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Income (YTD)" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-emerald-600", children: formatCurrency(stats.income) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Expense (YTD)" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-amber-600", children: formatCurrency(stats.expenses) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2 bg-surface px-3 py-2 rounded-xl border border-line shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2 overflow-x-auto scrollbar-hide", children: ["all", "asset", "liability", "equity", "income", "expense"].map((type) => /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: `px-2.5 py-1 text-2xs font-bold uppercase rounded-full transition-all whitespace-nowrap ${typeFilter === type ? "bg-brand-600 text-white shadow-sm" : "bg-sunken text-ink-muted hover:bg-interactive-hover"}`,
            children: type
          },
          type
        )) }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("button", { className: "flex items-center gap-1 bg-brand-600 hover:bg-brand-700 text-white px-3 py-1.5 rounded-lg text-xs font-bold transition-all shadow-sm", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-auto rounded-xl border border-line shadow-sm bg-surface", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-app border-b border-line sticky top-0 z-10", children: [
          /* @__PURE__ */ jsx("th", { onClick: () => handleSort("code"), className: "p-3 text-2xs font-bold text-ink-muted uppercase tracking-wider cursor-pointer hover:bg-sunken dark:hover:bg-interactive-hover", children: "Code" }),
          /* @__PURE__ */ jsx("th", { onClick: () => handleSort("name"), className: "p-3 text-2xs font-bold text-ink-muted uppercase tracking-wider cursor-pointer hover:bg-sunken dark:hover:bg-interactive-hover", children: "Account Name" }),
          /* @__PURE__ */ jsx("th", { className: "p-3 text-2xs font-bold text-ink-muted uppercase tracking-wider", children: "Type" }),
          /* @__PURE__ */ jsx("th", { onClick: () => handleSort("balance"), className: "p-3 text-2xs font-bold text-ink-muted uppercase tracking-wider text-right cursor-pointer hover:bg-sunken dark:hover:bg-interactive-hover", children: "Balance" }),
          /* @__PURE__ */ jsx("th", { className: "p-3 text-2xs font-bold text-ink-muted uppercase tracking-wider text-right", children: "Actions" })
        ] }) }),
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: processedAccounts.length > 0 ? processedAccounts.map((account) => {
          ...
          return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors group", children: [
            /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsx("span", { className: "font-mono text-xs font-bold text-ink-muted bg-sunken px-1.5 py-0.5 rounded", children: account.code }) }),
            /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary dark:text-ink", children: account.name }) }),
            /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsxs("span", { className: `inline-flex items-center gap-1 px-2 py-0.5 rounded text-2xs font-bold uppercase ${typeConfig.color}`, children: [
              /* @__PURE__ */ jsx(Icon, { size: 10 }),
              typeConfig.label
            ] }) }),
            /* @__PURE__ */ jsx("td", { className: "p-3 text-right", children: /* @__PURE__ */ jsx("span", { className: "font-mono text-sm font-bold text-ink", children: formatCurrency(account.balance) }) }),
            /* @__PURE__ */ jsx("td", { className: "p-3 text-right", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity", children: [
              /* @__PURE__ */ jsx("button", { className: "p-1.5 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-lg text-ink-muted hover:text-brand-600", title: "View Ledger", children: /* @__PURE__ */ jsx(FileText, { size: 14 }) }),
              /* @__PURE__ */ jsx("button", { className: "p-1.5 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-lg text-ink-muted hover:text-brand-600", title: "Edit", children: /* @__PURE__ */ jsx(Eye, { size: 14 }) })
            ] }) })
          ] }, account.id);
        }) : /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "5", className: "p-12 text-center text-ink-muted", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-2", children: [
