...
import { ChevronDown, Loader2, Check, ArrowRight, Plus, Lock, ChevronRight, Home, ShoppingCart, Package, Users, BarChart2, Settings, Truck, CreditCard, DollarSign, FileText, Calculator, Tag, Search, Command, Box, Layers, ArrowRightLeft, Building2, Activity, BookOpen, TrendingUp, Receipt, Clock, UserPlus, Database, Percent, Shield, History, Trash2, Download, Sparkles, PlusCircle, FilePlus, Upload, Printer, Settings2, X, CheckCircle2, User, AlertTriangle, Camera, Mic, Type, FilePlus2, KeyRound, TestTube2, Minimize2, ExternalLink, Send, RefreshCw, UserCheck, HeartHandshake, Zap, Info, AlertCircle, CheckCircle, Crown, Eye, LogOut, LayoutDashboard, ShoppingBag, Wallet, RefreshCcw, Ticket, UserCog, Rss, Monitor, MessageSquare, Mail, HardDrive, ChevronLeft, ShieldCheck, Menu, Sun, Moon, MoreVertical, Bell, ChevronUp, Factory } from "lucide-react";
...
function SmartCapturePanel({ isOpen, onClose, initialTab = "image" }) {
        ...
        /* @__PURE__ */ jsxs(
          "select",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("option", { value: "sale", children: "Sales Invoice (Invoice/Sale)" }),
              /* @__PURE__ */ jsx("option", { value: "purchase", children: "Purchase (Bill/Purchase)" }),
  ...
  const renderSettingsDrawer = () => /* @__PURE__ */ jsx("div", { className: "absolute inset-0 z-50 flex justify-end bg-slate-950/60 backdrop-blur-sm animate-in fade-in duration-150", onClick: () => setShowSettings(false), children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md h-full bg-white dark:bg-slate-900 border-l border-slate-200 dark:border-slate-800 p-6 overflow-y-auto animate-in slide-in-from-right duration-200", onClick: (e) => e.stopPropagation(), children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "text-[10px] font-black uppercase tracking-wider text-slate-400 block mb-1.5", children: "Model (optional)" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "text",
        ...
        /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 mt-1.5 ml-1", children: "Leave empty to use the recommended default." })
      ] }),
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[999] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-200 font-sans", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-4xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] shadow-2xl flex flex-col overflow-hidden h-[720px] relative", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "p-6 bg-slate-900 text-white shrink-0 flex items-center justify-between border-b border-slate-800 relative z-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-indigo-300 font-bold uppercase tracking-wider mt-0.5", children: [
            "AI-Powered Transaction Entry",
            ctx?.entitlement?.mode === "managed" && ctx?.entitlement?.scans_limit > 0 && /* @__PURE__ */ jsxs("span", { className: "ml-2 text-slate-400 normal-case", children: [
              "(",
    ...
    /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-hidden flex flex-col relative z-10", children: ctxLoading && !ctx ? /* @__PURE__ */ jsx("div", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsx(Loader2, { className: "animate-spin text-indigo-500", size: 28 }) }) : locked && !extractedData && !successData ? renderLocked() : successData ? (
      /* SUCCESS STATE */
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col overflow-hidden animate-in fade-in duration-200", children: [
        ...
        (extractedData.date || extractedData.reference || extractedData.notes) && /* @__PURE__ */ jsxs("div", { className: "px-8 py-2 border-b border-slate-100 dark:border-slate-800 flex flex-wrap gap-4 text-[10px] font-semibold text-slate-400", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto p-8 custom-scrollbar", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-3", children: extractedData.items.map((item, idx) => {
            ...
            return /* @__PURE__ */ jsx(
              "div",
              {
                className: `p-4 rounded-2xl border transition-all flex flex-col gap-3 ${isNew ? "bg-indigo-500/5 border-indigo-500/20" : isHigh ? "bg-emerald-500/5 border-emerald-500/10" : isMedium ? "bg-amber-500/5 border-amber-500/10" : "bg-rose-500/5 border-rose-500/10"}`,
                children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                    /* @__PURE__ */ jsxs("span", { className: "text-[10px] font-bold text-slate-400 uppercase tracking-wider block", children: [
                      'AI read: "',
                      item.raw_name,
                      '"'
                    ] }),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 shrink-0", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "pt-4 flex items-center gap-2", children: [
                      /* @__PURE__ */ jsx("span", { className: `px-2 py-1 text-[8px] font-black uppercase rounded-full ${isNew ? "bg-indigo-150 text-indigo-700" : isHigh ? "bg-emerald-150 text-emerald-700" : isMedium ? "bg-amber-150 text-amber-700" : "bg-rose-150 text-rose-700"}`, children: isNew ? "New Product" : `${item.confidence}% Match` }),
                      /* @__PURE__ */ jsx(
                        "button",
                        {
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-6 border-t border-slate-100 dark:border-slate-800 shrink-0 flex items-center justify-between bg-slate-55/40 dark:bg-slate-900/60 backdrop-blur-md", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-sm", children: [
            ...
            !partyReady && /* @__PURE__ */ jsx("span", { className: "block text-[10px] text-rose-500 font-bold mt-0.5", children: isExpense ? "Select an expense category to continue." : `Select the ${partyType} to continue.` })
          ] }),
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: confirming ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { children: "Posting..." })
                ] }) : /* @__PURE__ */ jsx("span", { children: appendMode && appendDocId ? "Add to Document" : "Post Transaction" })
              }
            )
          ] })
        ] })
...
function OmniSearch({ onAskAi, isAiLoading = false }) {
  ...
  vensynq_enabled && (isFullAccess || userPerms.some((p) => p.startsWith("pos") || p.startsWith("sales") || p.startsWith("purchases")));
  ...
  const handleKeyDown = (e) => {
    const totalItems = results.length + dbResults.length + 0;
    if (e.key === "ArrowDown") {
      e.preventDefault();
      ...
      /* @__PURE__ */ jsxs("div", { className: "overflow-y-auto custom-scrollbar", children: [
        ...
        dbResults.length > 0 && /* @__PURE__ */ jsxs("div", { className: "p-2 border-t border-slate-100 dark:border-slate-800/30", children: [
          ...
          dbResults.map((item, idx) => {
            const actualIndex = 0 + results.length + idx;
            return /* @__PURE__ */ jsxs(
              Link,
              {
                href: item.url,
