...
function PartySearchField({ selectedParty, onSelect, onClear }) {
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "relative", children: [
    /* @__PURE__ */ jsxs("div", { style: { outline: "none" }, className: `flex items-center gap-2 w-full px-3 py-3 rounded-xl bg-app border ${selectedParty ? "border-rose-500" : "border-line"} transition-all focus-within:border-rose-500`, children: [
      ...
      loading && /* @__PURE__ */ jsx("div", { className: "w-4 h-4 border-2 border-line border-t-rose-500 rounded-full animate-spin shrink-0" }),
...
function PaymentOut({ parties = [], bankAccounts = [], selected_party_id = null }) {
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Payment Out", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "h-full flex flex-col items-center justify-center overflow-auto py-6 px-4", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-xl relative", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute -inset-1 bg-gradient-to-r from-rose-500/20 to-red-500/10 rounded-2xl blur-xl pointer-events-none" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative bg-gradient-to-r from-rose-600 to-red-600 px-6 py-5 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative flex items-center gap-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h1", { className: "text-xl font-bold text-white tracking-tight", children: "Record Payment Out" }),
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "p-6 space-y-5", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                ...
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    ...
                    className: "w-full pl-9 pr-3 py-2.5 text-sm rounded-xl bg-app border border-line text-ink outline-none focus:ring-2 ring-rose-500/20 focus:border-rose-500 transition"
                  }
                )
              ] }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                ...
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    ...
                    placeholder: "0",
                    className: "w-full pl-8 pr-3 py-2.5 text-sm rounded-xl bg-app border border-line text-ink outline-none focus:ring-2 ring-rose-500/20 focus:border-rose-500 transition"
                  }
                )
              ] }),
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-2", children: METHODS.map((m) => {
              ...
              return /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `flex flex-col items-center gap-1.5 py-2.5 px-2 rounded-xl border-2 transition-all text-2xs font-bold uppercase ${isSelected ? "border-rose-500 bg-rose-50 dark:bg-rose-900/20 text-rose-700 dark:text-rose-400" : "border-line text-ink-muted hover:border-line dark:hover:border-line-strong bg-app"}`,
                  children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsx(FileText, { size: 13, className: "absolute left-3 top-1/2 -translate-y-1/2 text-ink-muted" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: "flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-rose-600 to-red-600 hover:from-rose-700 hover:to-red-700 text-white font-bold text-sm rounded-xl shadow-lg transition-all disabled:opacity-60",
