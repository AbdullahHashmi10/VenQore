  ...
  return /* @__PURE__ */ jsxs("div", { className: `flex items-center justify-between py-4 ${upcoming || comingSoon || disabled ? "opacity-60 grayscale-[0.5]" : ""}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex-1 pr-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        upcoming && /* @__PURE__ */ jsx("span", { className: "px-1.5 py-0.5 bg-amber-100 dark:bg-amber-500/20 text-amber-600 dark:text-amber-400 text-4xs font-black uppercase tracking-wider rounded border border-amber-200 dark:border-amber-500/30", children: "Upcoming" }),
        comingSoon && /* @__PURE__ */ jsx("span", { className: "px-1.5 py-0.5 bg-blue-100 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 text-4xs font-black uppercase tracking-wider rounded border border-blue-200 dark:border-blue-500/30", children: "Coming Soon" }),
        variant === "danger" && /* @__PURE__ */ jsx("span", { className: "px-1.5 py-0.5 bg-red-100 dark:bg-red-500/20 text-red-600 dark:text-red-400 text-4xs font-black uppercase tracking-wider rounded border border-red-200 dark:border-red-500/30", children: "Risk" })
      ] }),
