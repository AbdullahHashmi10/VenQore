...
function PriceTiers({ product, tiers }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-6 max-w-2xl", children: [
    ...
    tiers.length > 0 ? /* @__PURE__ */ jsxs("table", { className: "w-full border-collapse border border-line mb-6", children: [
      /* @__PURE__ */ jsx("thead", { className: "bg-sunken", children: /* @__PURE__ */ jsxs("tr", { children: [
        /* @__PURE__ */ jsx("th", { className: "border border-line px-4 py-2 text-left", children: "Min Qty" }),
        /* @__PURE__ */ jsx("th", { className: "border border-line px-4 py-2 text-left", children: "Max Qty" }),
        /* @__PURE__ */ jsx("th", { className: "border border-line px-4 py-2 text-right", children: "Unit Price" }),
        /* @__PURE__ */ jsx("th", { className: "border border-line px-4 py-2" })
      ] }) }),
      /* @__PURE__ */ jsx("tbody", { children: tiers.map((t) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-interactive-hover", children: [
        /* @__PURE__ */ jsx("td", { className: "border border-line px-4 py-2", children: t.min_qty }),
        /* @__PURE__ */ jsx("td", { className: "border border-line px-4 py-2", children: t.max_qty ?? /* @__PURE__ */ jsx("span", { className: "text-ink-muted", children: "∞ (no limit)" }) }),
        /* @__PURE__ */ jsx("td", { className: "border border-line px-4 py-2 text-right", children: formatCurrency(t.unit_price, store) }),
        /* @__PURE__ */ jsx("td", { className: "border border-line px-4 py-2 text-center", children: /* @__PURE__ */ jsx(
          "button",
          {
            onClick: () => remove(t.id),
    ...
    ] }) : /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-sm mb-6", children: tt("No price tiers configured. Product uses flat sale price.") }),
    /* @__PURE__ */ jsxs("div", { className: "border rounded p-4 bg-sunken", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-4 mb-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("label", { className: "block text-sm font-medium mb-1", children: [
              "Max Qty ",
              /* @__PURE__ */ jsx("span", { className: "text-ink-muted", children: "(blank = no limit)" })
            ] }),
            /* @__PURE__ */ jsx(
              "input",
              {
