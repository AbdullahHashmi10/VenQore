  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch("/tools/purchase-order-generator/render", {
        ...
        body: JSON.stringify({ buyer, vendor, items, meta })
      });
      if (!res.ok) {
          ...
          /* @__PURE__ */ jsxs("div", { className: `p-6 sm:p-10 text-slate-900 text-sm`, style: { fontFamily: "Helvetica, Arial, sans-serif" }, children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-3 gap-6 mb-6", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx(EditableText, { value: vendor.name, onChange: (v) => setVendor((c) => ({ ...c, name: v })), placeholder: "Vendor / supplier name", className: "block font-bold" }),
                /* @__PURE__ */ jsx(EditableText, { value: vendor.contact_person, onChange: (v) => setVendor((c) => ({ ...c, contact_person: v })), placeholder: "Attn: contact person", className: "block text-slate-500 text-xs" }),
                /* @__PURE__ */ jsx(EditableText, { value: vendor.address, onChange: (v) => setVendor((c) => ({ ...c, address: v })), placeholder: "Vendor address", as: "textarea", rows: 2, className: "block text-slate-500 text-xs" }),
                /* @__PURE__ */ jsx(EditableText, { value: vendor.email, onChange: (v) => setVendor((c) => ({ ...c, email: v })), placeholder: "Vendor email", className: "block text-slate-500 text-xs" }),
                /* @__PURE__ */ jsx(EditableText, { value: vendor.phone, onChange: (v) => setVendor((c) => ({ ...c, phone: v })), placeholder: "Vendor phone", className: "block text-slate-500 text-xs" })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("table", { className: "w-full mb-2", children: [
              /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: `text-left text-[10px] font-bold uppercase tracking-wide text-slate-400 ${isClassic ? "border-b-2 border-slate-900" : "border-b border-slate-900"}`, children: [
                /* @__PURE__ */ jsx("th", { className: "pb-2 pr-2 w-24", children: "SKU / Code" }),
                /* @__PURE__ */ jsx("th", { className: "pb-2 px-2", children: "Description" }),
                /* @__PURE__ */ jsx("th", { className: "pb-2 px-2 text-right w-16", children: "Qty" }),
                /* @__PURE__ */ jsx("th", { className: "pb-2 px-2 text-right w-24", children: "Unit Cost" }),
                /* @__PURE__ */ jsx("th", { className: "pb-2 px-2 text-right w-16", children: "Tax" }),
                /* @__PURE__ */ jsx("th", { className: "pb-2 pl-2 text-right w-24", children: "Total" }),
