...
import { P as ProductModal } from "./ProductModal-BxqMXAh4.js";
import { Q as QuickPartyModal } from "./QuickPartyModal-BjRmNiLb.js";
import { A as AsyncProductCombobox } from "./AsyncProductCombobox-Ko7h5TLf.js";
import { A as AsyncPartyCombobox } from "./AsyncPartyCombobox-CkLJbIS3.js";
import "react-dom";
...
import "use-debounce";
import "./SmartCombobox-BQD2NCBq.js";
const CreatePreSale = ({ sale }) => {
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: isEditMode ? `Edit Quotation #${editState?.invoiceNumber || ""}` : "Create Pre-Sale", activeMenu: "Sales", fullScreen: false, hideHeader: true, noPadding: true, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: `h-full flex-1 flex flex-col bg-sunken dark:bg-void-800 transition-all duration-slower ${isSeniorMode ? "text-[20px] senior-mode" : ""}`, children: [
...
` }),
      /* @__PURE__ */ jsxs("div", { className: `flex-1 flex gap-2 min-h-0 px-2 pb-0 pt-2 overflow-hidden text-scale-${textSize}`, children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1 bg-surface rounded-2xl shadow-2xl border border-line flex flex-col overflow-hidden min-h-0", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 px-3 pt-2 pb-0 overflow-x-auto hide-scrollbar border-b border-line bg-sunken/50 dark:bg-surface shrink-0", children: [
 ...
 ${currentInvoiceId === inv.id ? "bg-surface text-brand-600" : "bg-sunken/50 dark:bg-surface text-ink-muted hover:bg-interactive-hover dark:hover:bg-interactive-hover"}
`,
                children: [
                  /* @__PURE__ */ jsx("div", { className: `w-2 h-2 rounded-full ${currentInvoiceId === inv.id ? "bg-brand-500 animate-pulse" : "bg-neutral-400"}` }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "px-3 py-2 border-b border-line flex items-center gap-3 bg-sunken/50 dark:bg-surface shrink-0", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative flex-1 max-w-xl", children: [
              /* @__PURE__ */ jsx("div", { className: "absolute left-4 top-1/2 -translate-y-1/2 text-ink-muted", children: /* @__PURE__ */ jsx(User, { size: 18 }) }),
              currentInvoice.customer ? /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxs("div", { className: "w-full bg-surface border border-line rounded-2xl pl-12 pr-10 py-3.5 flex items-center justify-between shadow-sm", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "font-bold text-ink text-sm", children: currentInvoice.customer.name }),
                    /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: currentInvoice.customer.phone || "No Phone" })
                  ] }),
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                ...
                customerError && /* @__PURE__ */ jsx("p", { className: "absolute -bottom-5 left-2 text-2xs font-bold text-red-500 animate-pulse", children: tt("Please select a registered customer") })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-0.5 bg-sunken rounded-xl p-1 border border-line", children: [
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    onClick: () => patchInvoice({ paymentMethod: "credit" }),
                    className: `px-3 py-1.5 rounded-lg text-2xs font-bold flex items-center gap-1.5 transition-all ${currentInvoice.paymentMethod === "credit" ? "bg-emerald-500 text-white shadow " : "text-ink-muted hover:text-ink-secondary"}`,
                    children: [
                ...
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    className: `px-3 py-1.5 rounded-lg text-2xs font-bold flex items-center gap-1.5 transition-all ${currentInvoice.paymentMethod === "cash" ? "bg-orange-500 text-white shadow shadow-glow" : "text-ink-muted hover:text-ink-secondary"}`,
                    children: [
                  ...
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5 truncate", children: [
                        /* @__PURE__ */ jsx(Wallet, { size: 12, className: "text-brand-500" }),
                        currentInvoice.selectedBankName || accounts.find((a) => a.id === (currentInvoice.paymentAccountId || 1))?.name || "Cash in Hand"
                      ] }),
                      /* @__PURE__ */ jsx(ChevronRight, { size: 12, className: "rotate-90 text-ink-muted" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsx("div", { className: "absolute top-full pt-2 right-0 w-48 z-50 overflow-hidden hidden group-hover/accounts:block animate-in fade-in slide-in-from-top-2", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-xl shadow-xl border border-line overflow-hidden", children: [
                  /* @__PURE__ */ jsx("div", { className: "p-2 border-b border-line bg-app", children: /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-ink-muted uppercase", children: "Deposit To" }) }),
                  /* @__PURE__ */ jsx("div", { className: "max-h-48 overflow-y-auto custom-scrollbar p-1", children: accounts.map((acc) => /* @__PURE__ */ jsxs(
                    "button",
                    {
                      ...
                      className: `w-full text-left px-3 py-2 rounded-lg text-xs font-bold transition-colors flex items-center justify-between ${(currentInvoice.paymentAccountId || 1) === acc.id ? "bg-brand-50 dark:bg-brand-900/20 text-brand-600 dark:text-brand-400" : "text-ink-secondary hover:bg-interactive-hover dark:hover:bg-interactive-hover"}`,
                      children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    className: `flex items-center gap-1.5 px-3 py-1.5 rounded-xl transition-all border text-2xs font-bold ${textSize > 1 ? "bg-brand-500 text-white border-brand-500 shadow " : "bg-brand-50 dark:bg-brand-900/20 text-brand-600 dark:text-brand-400 border-brand-200 dark:border-brand-800 hover:bg-brand-100 dark:hover:bg-brand-900/30"}`,
                ...
                showTextSizeMenu && /* @__PURE__ */ jsx("div", { className: "absolute top-full mt-2 right-0 w-32 bg-surface rounded-[14px] shadow-xl border border-line z-50 overflow-hidden animate-in fade-in slide-in-from-top-2", children: [1, 2, 3, 4, 5].map((size) => /* @__PURE__ */ jsx(
                  "button",
                  {
                    onClick: () => {
                      setTextSize(size);
          ...
          /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto hide-scrollbar px-4 py-3", children: /* @__PURE__ */ jsxs("table", { className: "w-full border-separate border-spacing-y-1.5", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "text-left text-xs font-bold text-ink-muted uppercase tracking-wide", children: [
            ...
            /* @__PURE__ */ jsxs("tbody", { children: [
              showQuickEntry && /* @__PURE__ */ jsxs("tr", { className: "bg-brand-50/50 dark:bg-brand-900/10 border border-brand-200 dark:border-brand-800/50 rounded-xl overflow-hidden animate-in slide-in-from-top-2 fade-in duration-normal", children: [
                /* @__PURE__ */ jsx("td", { className: "py-3" }),
                /* @__PURE__ */ jsx("td", { className: "py-3 pl-3", children: /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-lg bg-brand-100 dark:bg-brand-900/30 flex items-center justify-center", children: /* @__PURE__ */ jsx(Zap, { size: 16, className: "text-brand-600" }) }) }),
                  ...
                  children: [
                    /* @__PURE__ */ jsx(
                      "td",
                      {
                        ...
                        children: /* @__PURE__ */ jsx(GripVertical, { size: 16, className: "text-neutral-300 hover:text-ink-muted transition-colors" })
                      }
                    ),
                    /* @__PURE__ */ jsx("td", { className: "bg-app py-3 text-sm font-bold text-ink-muted text-center", children: idx + 1 }),
                    /* @__PURE__ */ jsx("td", { className: "bg-app py-3 relative px-2", children: /* @__PURE__ */ jsx(
                      AsyncProductCombobox,
                      {
                    ...
                    /* @__PURE__ */ jsx("td", { className: "bg-app py-3 text-center", children: /* @__PURE__ */ jsx(
                      "input",
                      {
                        type: "number",
                    ...
                    /* @__PURE__ */ jsx("td", { className: "bg-app py-3 text-right", children: /* @__PURE__ */ jsx(
                      "input",
                      {
                        type: "number",
                        value: item.price ?? 0,
                    ...
                    /* @__PURE__ */ jsx("td", { className: "bg-app py-3 text-right", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2", children: [
                      /* @__PURE__ */ jsx(
                        "input",
                        {
                          type: "number",
                    ...
                    /* @__PURE__ */ jsx("td", { className: "bg-app py-3 pr-3 align-middle", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-1.5", children: [
                      /* @__PURE__ */ jsx(
                        "button",
                        {
                          ...
                          className: `w-7 h-7 rounded-md text-2xs font-bold transition-all shrink-0 border flex items-center justify-center ${getItemTotalMode(item.id) === "price" ? "bg-brand-600 text-white border-brand-500 shadow " : "bg-emerald-600 text-white border-emerald-500 shadow "}`,
                      ...
                      /* @__PURE__ */ jsx(
                        "input",
                        {
                          ...
                          className: "w-24 bg-sunken border border-brand-300 dark:border-brand-600 rounded-lg text-right text-sm font-bold py-2 px-3 focus:ring-2 ring-brand-500/30 transition-all text-ink"
                        }
                      )
                    ] }) }),
                    /* @__PURE__ */ jsx("td", { className: "bg-app rounded-r-xl py-3 pr-3", children: /* @__PURE__ */ jsx(
                      "button",
                      {
          ...
          /* @__PURE__ */ jsx("div", { className: "shrink-0 px-4 py-3 border-t border-line bg-surface", children: /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: addItem,
        ...
        /* @__PURE__ */ jsxs("div", { className: "w-80 bg-void-700 flex flex-col overflow-hidden rounded-2xl shadow-2xl border border-neutral-800", children: [
          /* @__PURE__ */ jsx("div", { className: "p-4 border-b border-neutral-800/50 bg-neutral-900/30 shrink-0", children: currentInvoice.customer ? /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: `rounded-xl bg-gradient-brand flex items-center justify-center text-white font-bold shrink-0 ${textSize >= 4 ? "w-16 h-16 text-xl" : textSize >= 3 ? "w-14 h-14 text-lg" : "w-12 h-12 text-lg"}`, children: currentInvoice.customer.name.charAt(0) }),
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: `text-ink-muted font-medium ${textSize >= 4 ? "text-sm" : textSize >= 3 ? "text-xs" : "text-2xs"}`, children: currentInvoice.customer.phone || "No Phone" })
              ] }),
              /* @__PURE__ */ jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsxs("div", { className: `space-y-1 bg-neutral-800/30 rounded-lg p-2 ${textSize >= 3 ? "text-sm" : "text-xs"}`, children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                /* @__PURE__ */ jsx("span", { className: "text-ink-muted font-medium", children: "Balance:" }),
                /* @__PURE__ */ jsx("span", { className: `font-bold ${currentInvoice.customer.current_balance >= 0 ? "text-emerald-400" : "text-red-400"}`, children: currentInvoice.customer.current_balance >= 0 ? formatCurrency(Math.abs(currentInvoice.customer.current_balance || 0), store || settings) : "-" + formatCurrency(Math.abs(currentInvoice.customer.current_balance || 0), store || settings) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-ink-muted font-medium shrink-0", children: "Address:" }),
                /* @__PURE__ */ jsx("span", { className: `text-right ${currentInvoice.customer.address ? "text-neutral-300" : "text-ink-secondary italic"}`, children: currentInvoice.customer.address || "Not set" })
              ] })
            ] })
          ] }) : /* @__PURE__ */ jsxs("div", { className: "text-center py-4 border border-dashed border-neutral-700 rounded-xl", children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-full bg-neutral-800/50 flex items-center justify-center mx-auto mb-2 text-ink-muted", children: /* @__PURE__ */ jsx(User, { size: 20 }) }),
            /* @__PURE__ */ jsx("p", { className: `text-ink-muted font-bold ${textSize >= 3 ? "text-sm" : "text-xs"}`, children: tt("No Customer Selected") })
          ] }) }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1 p-3 space-y-3 overflow-y-auto hide-scrollbar", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "text-3xs text-ink-muted font-bold uppercase block mb-1", children: "Invoice #" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "text-3xs text-ink-muted font-bold uppercase block mb-1", children: "Date" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "date",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "text-3xs text-ink-muted font-bold uppercase block mb-1", children: "Terms" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
            ...
            currentInvoice.paymentAccountId === "CHEQUE" && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2 p-2 bg-brand-500/10 rounded-lg border border-brand-500/30 animate-in slide-in-from-top-2", children: [
              /* @__PURE__ */ jsx("div", { className: "col-span-2", children: /* @__PURE__ */ jsxs("p", { className: "text-2xs text-brand-400 font-bold uppercase mb-2 flex items-center gap-1", children: [
                /* @__PURE__ */ jsx(Wallet, { size: 12 }),
                " CHEQUE DETAILS"
              ] }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "text-3xs text-ink-muted font-bold uppercase block mb-1", children: "Cheque No" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "text-3xs text-ink-muted font-bold uppercase block mb-1", children: "Cheque Date" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "date",
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2 pt-3 border-t border-neutral-800/50", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted font-bold", children: "Subtotal" }),
                /* @__PURE__ */ jsx("span", { className: "text-white font-bold text-base", children: formatCurrency(subtotal, store || settings) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted font-bold", children: "Item Discounts" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between bg-neutral-800/30 rounded-xl p-3 border border-neutral-700/50", children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted font-bold", children: "Invoice Discount" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-ink-muted text-xs", children: getCurrencySymbol(store || settings) }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "number",
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between bg-neutral-800/30 rounded-xl p-3 border border-neutral-700/50", children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted font-bold", children: "Tax" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(
                  "input",
                  {
            ...
            showDeliveryCharges && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-2 hover:bg-interactive-hover rounded-lg transition-colors group", children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted font-bold group-hover:text-ink-muted", children: "Delivery Charges" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-ink-secondary text-2xs", children: getCurrencySymbol(store || settings) }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "number",
            ...
            showExtraField && /* @__PURE__ */ jsx(Fragment, { children: !enableMultipleExtras ? (
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-2 hover:bg-interactive-hover rounded-lg transition-colors group", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-2xs text-ink-secondary", children: "✎" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-ink-secondary text-2xs", children: getCurrencySymbol(store || settings) }),
                  /* @__PURE__ */ jsx(
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                (currentInvoice.extraFields || [{ id: 1, label: "", value: 0 }]).map((field, idx) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-2 hover:bg-interactive-hover rounded-lg transition-colors group", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
                    /* @__PURE__ */ jsx(
                      "input",
                      {
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-3 bg-neutral-900 space-y-2 shrink-0 border-t border-neutral-800", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xs text-ink-muted font-bold uppercase", children: "Total" }),
              /* @__PURE__ */ jsx("span", { className: "text-2xl font-bold text-white", children: formatCurrency(grandTotal, store || settings) })
            ] }),
    ...
    showProfit && !showProfitModal && /* @__PURE__ */ jsx("div", { className: "fixed bottom-4 left-1/2 -translate-x-1/2 z-50 animate-in slide-in-from-bottom-4 duration-normal", children: /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900/95 backdrop-blur-lg rounded-2xl px-8 py-4 shadow-2xl border border-neutral-700 flex items-center gap-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted font-bold uppercase", children: "Profit Margin" }),
          /* @__PURE__ */ jsx("p", { className: `text-2xl font-bold ${profit >= 0 ? "text-emerald-400" : "text-red-400"}`, children: formatCurrency(profit, store || settings) })
        ] })
      ] }),
      grandTotal > 0 && /* @__PURE__ */ jsxs("div", { className: "border-l border-neutral-700 pl-6", children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted font-bold uppercase", children: "Margin %" }),
        /* @__PURE__ */ jsxs("p", { className: `text-xl font-bold ${profit >= 0 ? "text-emerald-400" : "text-red-400"}`, children: [
          (profit / grandTotal * 100).toFixed(1),
          "%"
        ] })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted italic", children: "↓ Drag down for details" })
    ] }) }),
    /* @__PURE__ */ jsx(
      FormModal,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center py-6 text-center", children: [
          ...
          /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-ink mb-2", children: "Transaction Successful" }),
          /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-sm mb-8", children: "The receipt has been generated and stock updated." }),
    ...
    isScanning && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-neutral-900/80 backdrop-blur-md z-drawer flex items-center justify-center p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-2xl border border-line w-full max-w-2xl overflow-hidden animate-in zoom-in-95 duration-slow", children: [
      /* @__PURE__ */ jsxs("div", { className: "p-8 border-b border-line flex items-center justify-between bg-gradient-to-r from-neutral-50 to-white dark:from-neutral-800/50 dark:to-neutral-900", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-5", children: [
          /* @__PURE__ */ jsx("div", { className: "w-14 h-14 rounded-2xl bg-brand-600 text-white flex items-center justify-center shadow-xl ", children: /* @__PURE__ */ jsx(ScanBarcode, { size: 28 }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-ink", children: "Scanning Mode" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted font-bold", children: "Scan items one after another" })
          ] })
        ] }),
        /* @__PURE__ */ jsx("button", { onClick: () => setIsScanning(false), className: "p-4 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-2xl transition-all", children: /* @__PURE__ */ jsx(X, { size: 28, className: "text-ink-muted" }) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "p-8 space-y-8", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "max-h-80 overflow-y-auto space-y-4 custom-scrollbar pr-2", children: scannedItems.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-16 border-4 border-dashed border-line rounded-2xl", children: [
          /* @__PURE__ */ jsx(Package, { size: 64, className: "mx-auto text-neutral-200 mb-4" }),
          /* @__PURE__ */ jsx("p", { className: "text-ink-muted font-bold text-lg", children: "No items scanned yet" })
        ] }) : scannedItems.map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-5 bg-app rounded-2xl border-2 border-line animate-in slide-in-from-bottom-2 duration-normal", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-5", children: [
            /* @__PURE__ */ jsx("span", { className: "w-10 h-10 rounded-full bg-sunken flex items-center justify-center text-xs font-bold text-ink-muted shadow-sm", children: idx + 1 }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("p", { className: "font-bold text-ink text-lg", children: [
                item.name,
              ...
              /* @__PURE__ */ jsxs("p", { className: "text-sm text-brand-500 font-bold", children: [
                item.quantity,
                " @ ",
          ...
          /* @__PURE__ */ jsx("button", { onClick: () => setScannedItems((prev) => prev.filter((i) => i.id !== item.id)), className: "p-3 text-neutral-300 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-all", children: /* @__PURE__ */ jsx(Trash2, { size: 24 }) })
        ] }, item.id)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "p-8 bg-app flex items-center justify-between border-t border-line", children: [
        /* @__PURE__ */ jsxs("p", { className: "text-base font-bold text-ink-muted uppercase tracking-widest", children: [
          "Total: ",
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
          /* @__PURE__ */ jsx("button", { onClick: () => setScannedItems([]), className: "px-8 py-4 text-sm font-bold text-ink-muted hover:text-red-500 transition-colors uppercase tracking-widest", children: "Clear All" }),
          /* @__PURE__ */ jsx(
            "button",
            {
              onClick: confirmScan,
    ...
    showProfitModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-neutral-900/80 backdrop-blur-sm z-drawer flex items-center justify-center p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-2xl border border-line w-full max-w-3xl overflow-hidden animate-in zoom-in-95 duration-normal flex flex-col max-h-[80vh]", children: [
      /* @__PURE__ */ jsxs("div", { className: "p-4 border-b border-line flex justify-between items-center bg-app shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-ink", children: "Profit Analysis" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Per-item breakdown" })
          ] })
        ] }),
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx(X, { size: 20, className: "text-ink-muted" })
          }
        )
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto p-4", children: [
        /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "text-left text-2xs font-bold text-ink-muted uppercase border-b border-line", children: [
            /* @__PURE__ */ jsx("th", { className: "pb-2 pl-2", children: "#" }),
            /* @__PURE__ */ jsx("th", { className: "pb-2", children: tt("Product") }),
          ...
          /* @__PURE__ */ jsx("tbody", { children: currentInvoice.items.filter((item) => item.product).map((item, idx) => {
            ...
            return /* @__PURE__ */ jsxs("tr", { className: "border-b border-line hover:bg-interactive-hover dark:hover:bg-interactive-hover", children: [
              /* @__PURE__ */ jsx("td", { className: "py-2 pl-2 text-ink-muted text-xs", children: idx + 1 }),
              /* @__PURE__ */ jsxs("td", { className: "py-2", children: [
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink text-xs", children: item.product?.name || item.name }),
                /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted", children: item.product?.sku || "N/A" })
              ] }),
              /* @__PURE__ */ jsx("td", { className: "py-2 text-center text-xs", children: item.quantity }),
              /* @__PURE__ */ jsx("td", { className: "py-2 text-right text-xs text-ink-muted", children: formatCurrency(cost, store || settings) }),
        ...
        currentInvoice.items.filter((item) => item.product).length === 0 && /* @__PURE__ */ jsx("div", { className: "text-center py-8 text-ink-muted", children: /* @__PURE__ */ jsx("p", { className: "text-sm", children: tt("No products added yet") }) })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "p-4 bg-app border-t border-line shrink-0", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-xl p-3 border border-line", children: [
          /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted font-bold uppercase mb-1", children: "Total Cost" }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-ink-secondary", children: formatCurrency(totalCost, store || settings) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-xl p-3 border border-line", children: [
          /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted font-bold uppercase mb-1", children: "Total Revenue" }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-ink", children: formatCurrency(grandTotal, store || settings) })
        ] }),
    ...
    showSettingsDrawer && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "fixed top-0 right-0 h-full w-80 bg-surface shadow-2xl z-drawer animate-in slide-in-from-right duration-slow flex flex-col", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-4 border-b border-line flex items-center justify-between bg-app", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-sunken flex items-center justify-center", children: /* @__PURE__ */ jsx(Settings, { size: 20, className: "text-ink-secondary" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h3", { className: "font-bold text-ink", children: "Quick Settings" }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Invoice preferences" })
            ] })
          ] }),
          /* @__PURE__ */ jsx(
            "button",
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 p-4 space-y-4 overflow-y-auto", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-ink-muted uppercase tracking-wide", children: "Display" }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 bg-app rounded-xl", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsx(Type, { size: 18, className: "text-brand-500" }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary dark:text-white", children: "Large Text" }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Bigger fonts for better visibility" })
                ] })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "flex bg-sunken rounded-lg p-1", children: [1, 2, 3, 4, 5].map((s) => /* @__PURE__ */ jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 bg-app rounded-xl", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary dark:text-white", children: "Quick Entry" }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: tt("Fast product entry row") })
                ] })
              ] }),
              /* @__PURE__ */ jsx(
                "button",
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-ink-muted uppercase tracking-wide", children: "Permanent Defaults" }),
            /* @__PURE__ */ jsxs("div", { className: "p-3 bg-brand-50 dark:bg-brand-900/20 rounded-xl space-y-2 border border-brand-100 dark:border-brand-800/50", children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-brand-600 dark:text-brand-400 uppercase", children: "Default Delivery" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-ink-muted text-xs font-bold", children: window.amdSettings?.currency_symbol || "Rs" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "number",
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-3 bg-brand-50 dark:bg-brand-900/20 rounded-xl space-y-2 border border-brand-100 dark:border-brand-800/50", children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-brand-600 dark:text-brand-400 uppercase", children: "Default Extra Field" }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx(
                  "input",
                  {
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-100 dark:border-amber-800/50", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary dark:text-white", children: "Multiple Extra Fields" }),
                    /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted", children: "Add up to 10 custom charges" })
                  ] })
                ] }),
                /* @__PURE__ */ jsx(
                  "button",
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-ink-muted uppercase tracking-wide", children: "Show/Hide Fields" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 bg-app rounded-xl", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary dark:text-white", children: "Delivery Charges" }),
                  /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted", children: "Show delivery charges field" })
                ] }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 bg-app rounded-xl", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary dark:text-white", children: "Extra Field" }),
                  /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted", children: "Show extra charge field(s)" })
                ] }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-ink-muted uppercase tracking-wide", children: "Invoice Logic" }),
              /* @__PURE__ */ jsxs("div", { className: "p-3 bg-app rounded-xl space-y-2", children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary dark:text-white", children: "Payment Method" }),
                /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      onClick: () => patchInvoice({ paymentMethod: "credit" }),
                      className: `flex-1 py-2 rounded-lg text-xs font-bold transition-all ${currentInvoice.paymentMethod === "credit" ? "bg-emerald-500 text-white" : "bg-sunken text-ink-secondary border border-line dark:border-line"}`,
                      children: "Credit"
                    }
                  ),
                  /* @__PURE__ */ jsx(
                    ...
                    {
                      onClick: () => patchInvoice({ paymentMethod: "cash" }),
                      className: `flex-1 py-2 rounded-lg text-xs font-bold transition-all ${currentInvoice.paymentMethod === "cash" ? "bg-orange-500 text-white" : "bg-sunken text-ink-secondary border border-line dark:border-line"}`,
                      children: "Cash"
                    }
                  )
                ] })
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-3 bg-app rounded-xl space-y-2", children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary dark:text-white", children: "Default Tax Rate" }),
                /* @__PURE__ */ jsx("div", { className: "flex gap-2", children: [0, 5, 10, 17].map((rate) => /* @__PURE__ */ jsxs(
                  "button",
                  {
                    onClick: () => patchInvoice({ tax: rate }),
                    className: `flex-1 py-2 rounded-lg text-xs font-bold transition-all ${currentInvoice.tax === rate ? "bg-brand-500 text-white" : "bg-sunken text-ink-secondary border border-line dark:border-line"}`,
                    children: [
                      rate,
                      "%"
                    ]
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-3 bg-app rounded-xl space-y-2", children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary dark:text-white", children: "Payment Terms" }),
                /* @__PURE__ */ jsxs(
                  "select",
                  {
                    value: currentInvoice.paymentTerms || "net30",
        ...
        /* @__PURE__ */ jsx("div", { className: "p-4 border-t border-line bg-app", children: /* @__PURE__ */ jsx(
          "button",
          {
            onClick: () => setShowSettingsDrawer(false),
    ...
    showOverpaymentModal && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "fixed inset-0 flex items-center justify-center z-modal p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-void-700 rounded-2xl shadow-2xl max-w-md w-full overflow-hidden animate-in zoom-in-95 duration-normal border border-line", children: [
        /* @__PURE__ */ jsxs("div", { className: "relative bg-gradient-to-br from-amber-500 via-orange-500 to-orange-600 dark:from-amber-600 dark:via-orange-700 dark:to-orange-900 p-6 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative flex items-center gap-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-white/80 text-sm font-medium", children: tt("Customer paid extra") })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "p-6 space-y-5 bg-gradient-to-b from-white to-neutral-50 dark:from-void-700 dark:to-void-800", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center py-2", children: [
            /* @__PURE__ */ jsxs("p", { className: "text-ink-muted text-sm mb-2 font-medium", children: [
              overpaymentDetails.customerName,
              " paid"
            ] }),
            /* @__PURE__ */ jsx("div", { className: "text-brand-400 font-bold text-xl leading-none", children: formatCurrency(overpaymentDetails.amount, store || settings) }),
            /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-sm mt-2 font-medium", children: "more than the total" })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid gap-3", children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/40 dark:to-orange-900/40 flex items-center justify-center text-amber-600 dark:text-amber-400 transition-transform border border-amber-200 dark:border-amber-800/50", children: /* @__PURE__ */ jsx(ArrowLeftRight, { size: 24 }) }),
                  /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                    /* @__PURE__ */ jsx("p", { className: "font-bold text-ink", children: "Give Change" }),
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-900/40 dark:to-teal-900/40 flex items-center justify-center text-emerald-600 dark:text-emerald-400 transition-transform border border-emerald-200 dark:border-emerald-800/50", children: /* @__PURE__ */ jsx(Wallet, { size: 24 }) }),
                  /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                    /* @__PURE__ */ jsx("p", { className: "font-bold text-ink", children: "Credit to Ledger" }),
                    /* @__PURE__ */ jsxs("p", { className: "text-sm text-ink-muted", children: [
                      "Save ",
                      formatCurrency(overpaymentDetails.amount, store || settings),
                      " to ",
        ...
        /* @__PURE__ */ jsx("div", { className: "p-4 bg-sunken/50 dark:bg-app border-t border-line", children: /* @__PURE__ */ jsx(
          "button",
          {
            onClick: () => setShowOverpaymentModal(false),
