...
`,
    ...
    isOpen && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-full mt-2 w-56 bg-surface rounded-[14px] shadow-xl border border-line overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-fast", children: [
      /* @__PURE__ */ jsxs("div", { className: "p-1", children: [
        showRegular && /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-brand-50 dark:bg-brand-900/30 flex items-center justify-center text-brand-600 dark:text-brand-400 transition-transform", children: /* @__PURE__ */ jsx(FileText, { size: 20 }) }),
              /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxs("div", { className: "font-bold text-ink text-sm flex items-center gap-2", children: [
                  "Regular Print",
                  lastPrinted === "regular" && /* @__PURE__ */ jsx(Check, { size: 14, className: "text-emerald-500" })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "text-xs text-ink-muted", children: "A4 / Letter paper invoice" })
              ] })
            ]
          }
        ),
        showThermal && /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            className: "w-full flex items-center gap-3 px-4 py-3 text-left rounded-lg hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors group",
            children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-900/30 flex items-center justify-center text-emerald-600 dark:text-emerald-400 transition-transform", children: /* @__PURE__ */ jsx(Receipt, { size: 20 }) }),
              /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxs("div", { className: "font-bold text-ink text-sm flex items-center gap-2", children: [
                  "Thermal Receipt",
      ...
      /* @__PURE__ */ jsx("div", { className: "px-4 py-2 bg-app border-t border-line", children: /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted", children: "Configure paper size in Settings → Print" }) })
    ] })
  ] });
}
export {
