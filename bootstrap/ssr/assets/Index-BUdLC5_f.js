    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "p-8 rounded-2xl bg-neutral-900 border border-neutral-800 flex flex-col md:flex-row items-center justify-between gap-6", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-white mb-2", children: "VenQore Master Registry Control" }),
          /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-sm max-w-xl", children: "Communicate directly with offline license buyers using the Etsy Partner Support desk or manage listings on the public digital catalog catalog." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex gap-4 self-stretch md:self-auto", children: [
          /* @__PURE__ */ jsxs("div", { className: "px-6 py-4 bg-neutral-950 border border-neutral-800 rounded-2xl flex-1 md:flex-none text-center", children: [
            /* @__PURE__ */ jsx("span", { className: "block text-2xs font-bold text-ink-muted uppercase tracking-widest mb-1", children: "Active Chats" }),
            /* @__PURE__ */ jsx("span", { className: "text-xl font-bold text-brand-400", children: stats.open_chats })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "px-6 py-4 bg-neutral-950 border border-neutral-800 rounded-2xl flex-1 md:flex-none text-center", children: [
            /* @__PURE__ */ jsx("span", { className: "block text-2xs font-bold text-ink-muted uppercase tracking-widest mb-1", children: "Total Products" }),
            /* @__PURE__ */ jsx("span", { className: "text-xl font-bold text-emerald-400", children: products.length })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex border-b border-neutral-800 gap-6", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            className: `pb-4 text-sm font-bold tracking-wider uppercase flex items-center gap-2 border-b-2 transition-all ${activeTab === "chats" ? "border-brand-500 text-white" : "border-transparent text-ink-muted hover:text-neutral-300"}`,
            children: [
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            className: `pb-4 text-sm font-bold tracking-wider uppercase flex items-center gap-2 border-b-2 transition-all ${activeTab === "products" ? "border-brand-500 text-white" : "border-transparent text-ink-muted hover:text-neutral-300"}`,
            children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 border border-neutral-800 rounded-2xl overflow-hidden min-h-[500px]", children: [
        activeTab === "chats" && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 h-[600px] divide-y lg:divide-y-0 lg:divide-x divide-neutral-800", children: [
          /* @__PURE__ */ jsxs("div", { className: "lg:col-span-4 flex flex-col h-full overflow-hidden", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-4 bg-sunken border-b border-neutral-800 flex items-center gap-3", children: [
              /* @__PURE__ */ jsxs("div", { className: "relative flex-1", children: [
                /* @__PURE__ */ jsx(Search, { className: "absolute left-3 top-3.5 text-ink-secondary", size: 16 }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
            ...
            /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto divide-y divide-neutral-800/40 custom-scrollbar", children: loadingChats ? /* @__PURE__ */ jsx("div", { className: "p-8 text-center text-ink-muted text-xs", children: "Loading active channels..." }) : filteredChats.length === 0 ? /* @__PURE__ */ jsx("div", { className: "p-8 text-center text-ink-muted text-xs", children: "No active chat requests found." }) : filteredChats.map((chat) => /* @__PURE__ */ jsxs(
              "div",
              {
                onClick: () => setSelectedChat(chat),
                className: `p-4 cursor-pointer hover:bg-interactive-hover transition-colors flex flex-col gap-2 ${selectedChat?.id === chat.id ? "bg-neutral-800/60" : ""}`,
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsx("span", { className: "font-bold text-sm text-neutral-200", children: chat.requester_name }),
                    /* @__PURE__ */ jsx("span", { className: `text-3xs px-2 py-0.5 rounded-full border font-bold uppercase tracking-wider ${chat.status === "open" ? "bg-amber-500/10 border-amber-500/20 text-amber-400" : chat.status === "in_progress" ? "bg-brand-500/10 border-brand-500/20 text-brand-400" : "bg-emerald-500/10 border-emerald-500/20 text-emerald-400"}`, children: chat.status })
                  ] }),
                  /* @__PURE__ */ jsx("div", { className: "text-ink-muted text-xs truncate", children: chat.message }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center text-2xs text-ink-muted gap-1.5 mt-1", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "lg:col-span-8 flex flex-col h-full overflow-hidden bg-sunken", children: selectedChat ? /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsxs("div", { className: "p-6 border-b border-neutral-800 bg-neutral-900/50 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h3", { className: "font-bold text-white text-base", children: selectedChat.requester_name }),
                /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-xs", children: selectedChat.requester_email })
              ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "px-6 py-4 bg-neutral-950/40 border-b border-neutral-800 flex flex-wrap items-center justify-between gap-4 text-xs", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-6", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("span", { className: "text-ink-muted block text-3xs font-bold uppercase tracking-wider mb-0.5", children: "Purchase Platform Source" }),
                  /* @__PURE__ */ jsx("span", { className: "text-white font-bold", children: selectedChat.purchase_source || "Unknown / General" })
                ] }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("span", { className: "text-ink-muted block text-3xs font-bold uppercase tracking-wider mb-0.5", children: "Trial Selection Preference" }),
                  /* @__PURE__ */ jsx("span", { className: `font-bold uppercase text-2xs ${selectedChat.trial_status === "started" ? "text-brand-400" : "text-emerald-400"}`, children: selectedChat.trial_status === "started" ? "Already Started Trial (+30 days credit)" : "Not Started Trial (Full 45 days store)" })
                ] })
              ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto p-6 space-y-4 bg-neutral-950/40 custom-scrollbar", children: [
              selectedChat.replies && selectedChat.replies.map((reply, idx) => /* @__PURE__ */ jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxs("div", { className: `max-w-[75%] rounded-2xl p-4 text-xs leading-relaxed border ${reply.is_platform_owner ? "bg-brand-600/10 border-brand-500/20 text-brand-200 rounded-tr-none" : "bg-neutral-800/60 border-neutral-700/50 text-neutral-300 rounded-tl-none"}`, children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 mb-1 text-2xs", children: [
                      reply.is_platform_owner ? /* @__PURE__ */ jsx("span", { className: "font-bold text-brand-400 uppercase tracking-widest", children: "Hashmi Dashboard" }) : /* @__PURE__ */ jsx("span", { className: "font-bold text-ink-muted", children: "Partner Operator" }),
                      /* @__PURE__ */ jsx("span", { className: "text-3xs text-ink-muted ml-auto", children: new Date(reply.created_at).toLocaleTimeString() })
                    ] }),
            ...
            /* @__PURE__ */ jsxs("form", { onSubmit: handleSendReply, className: "p-4 border-t border-neutral-800 bg-neutral-900 flex items-center gap-3", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "text",
          ...
          ] }) : /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-full text-ink-muted text-xs", children: [
            /* @__PURE__ */ jsx(MessageSquare, { size: 32, className: "text-ink-secondary mb-3" }),
            /* @__PURE__ */ jsx("span", { children: "Select a chat thread from the column list to start messaging" })
          ] }) })
        ] }),
        activeTab === "products" && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x divide-neutral-800 min-h-[500px]", children: [
          /* @__PURE__ */ jsxs("div", { className: "lg:col-span-5 p-6 space-y-6", children: [
            /* @__PURE__ */ jsxs("h3", { className: "text-sm font-bold text-white uppercase tracking-wider flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Plus, { size: 16, className: "text-brand-400" }),
            ...
            /* @__PURE__ */ jsxs("form", { onSubmit: handleCreateProduct, className: "space-y-4 text-xs", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsx("label", { className: "text-ink-muted font-bold block", children: "Product Name" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsx("label", { className: "text-ink-muted font-bold block", children: "Product Description" }),
                /* @__PURE__ */ jsx(
                  "textarea",
                  {
                    rows: 3,
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsx("label", { className: "text-ink-muted font-bold block", children: "Version / Tag" }),
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      type: "text",
                ...
                /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsx("label", { className: "text-ink-muted font-bold block", children: "Development Status" }),
                  /* @__PURE__ */ jsxs(
                    "select",
                    {
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-3 pt-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsx("label", { className: "text-ink-muted font-bold", children: "Platform Purchase Links" }),
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      type: "button",
          ...
          /* @__PURE__ */ jsxs("div", { className: "lg:col-span-7 p-6 flex flex-col h-full overflow-hidden", children: [
            /* @__PURE__ */ jsxs("h3", { className: "text-sm font-bold text-white uppercase tracking-wider flex items-center gap-2 mb-4", children: [
              /* @__PURE__ */ jsx(Layers, { size: 16, className: "text-brand-400" }),
              "Active Digital Catalog (",
              products.length,
              ")"
            ] }),
            /* @__PURE__ */ jsx("div", { className: "space-y-3 overflow-y-auto max-h-[420px] custom-scrollbar pr-2", children: loadingProducts ? /* @__PURE__ */ jsx("div", { className: "p-8 text-center text-ink-muted text-xs", children: "Loading products catalog..." }) : products.length === 0 ? /* @__PURE__ */ jsx("div", { className: "p-8 text-center text-ink-muted text-xs", children: "No products cataloged. Add your first listing using the left panel." }) : products.map((prod) => /* @__PURE__ */ jsxs(
              "div",
              {
                className: `p-4 border rounded-2xl flex items-center justify-between gap-4 transition-all ${editingProduct?.id === prod.id ? "bg-brand-500/5 border-brand-500/30" : "bg-neutral-950/40 border-neutral-800"}`,
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "space-y-1 text-xs flex-1 cursor-pointer", onClick: () => handleStartEdit(prod), children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxs("h4", { className: "font-bold text-white text-sm hover:text-brand-400 transition-colors flex items-center gap-1.5", children: [
                        prod.name,
                        /* @__PURE__ */ jsx(Edit2, { size: 12, className: "text-ink-muted" })
                      ] }),
                      /* @__PURE__ */ jsx("span", { className: "text-2xs font-mono text-ink-muted", children: prod.version })
                    ] }),
                    /* @__PURE__ */ jsx("p", { className: "text-ink-muted line-clamp-2 leading-relaxed", children: prod.description }),
                    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-1.5 pt-1.5", children: [
                      /* @__PURE__ */ jsx("span", { className: `px-2 py-0.5 rounded-full text-3xs font-bold uppercase tracking-wider border ${prod.status === "active" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : prod.status === "dev" ? "bg-brand-500/10 border-brand-500/25 text-brand-400" : "bg-amber-500/10 border-amber-500/20 text-amber-400"}`, children: prod.status === "active" ? "Operational" : prod.status === "dev" ? "In Dev" : "Coming Soon" }),
                      prod.platforms && prod.platforms.map((plat, i) => /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 rounded-full bg-neutral-900 border border-neutral-800 text-ink-muted text-3xs", children: plat.name }, i))
                    ] })
                  ] }),
                  /* @__PURE__ */ jsx(
                    "button",
