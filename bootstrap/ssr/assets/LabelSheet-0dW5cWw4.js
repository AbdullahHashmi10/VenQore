      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3 mb-5 p-3 vq-tool-panel", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx("label", { className: "text-xs font-bold text-ink-muted", htmlFor: "ls-copies", children: "Copies" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                id: "ls-copies",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex bg-sunken p-1 rounded-xl shrink-0", children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                className: `px-3.5 py-1.5 rounded-lg text-xs font-bold transition-colors ${mode === "grid" ? "bg-surface text-ink shadow-sm" : "text-ink-secondary hover:text-ink"}`,
                children: [
                  "Grid (",
                  rows.length,
                  ")"
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                className: `px-3.5 py-1.5 rounded-lg text-xs font-bold transition-colors inline-flex items-center gap-1 ${mode === "bulk" ? "bg-surface text-ink shadow-sm" : "text-ink-secondary hover:text-ink"}`,
                children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "ml-auto flex items-center gap-3", children: [
            /* @__PURE__ */ jsxs("span", { className: "text-1xs text-ink-muted hidden sm:inline", children: [
              totalLabelsPreview,
              " labels total"
            ] }),
            /* @__PURE__ */ jsxs(
        ...
        mode === "bulk" ? /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad mb-4", children: [
          /* @__PURE__ */ jsxs("label", { className: "block text-xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-brand-500", children: "blank line" })
          ] }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-1xs text-ink-muted mt-2", children: [
            "Within a block: line 1, line 2, line 3 (up to 3 lines become one label). Add a trailing ",
            /* @__PURE__ */ jsx("code", { className: "font-mono text-brand-500", children: "x10" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "vq-paper rounded-2xl overflow-hidden shadow-xl shadow-neutral-900/10 dark:shadow-black/40 border border-line bg-white p-4 sm:p-6 mb-2", children: [
              ...
              rows.map((row) => /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-1 mt-2 pt-1.5 border-t border-line", children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", title: "Repeat this label N times", children: [
                        /* @__PURE__ */ jsx("span", { className: "text-3xs font-bold uppercase text-ink-secondary", children: "Qty" }),
                        /* @__PURE__ */ jsx(
                          EditableText,
                          {
                            as: "number",
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "text-1xs font-bold", children: "Add label" })
                  ]
                }
              )
            ] }),
        ...
        /* @__PURE__ */ jsx("p", { className: "text-center text-xs text-ink-muted mt-4", children: 'This preview matches your downloaded PDF layout — click any label above to edit it. Print at 100% / "Actual size".' })
      ]
    }
  );
}
