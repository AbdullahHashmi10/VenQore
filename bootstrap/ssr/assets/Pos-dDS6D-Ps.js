...
import { f as formatCurrency, g as getCurrencySymbol, a as formatNumber } from "./format-B_ph0Qec.js";
import { O as OneGlanceLayout, T as Toast } from "./OneGlanceLayout-DVMZFL-a.js";
import { c as approverOptions, d as describeApprovalLines, S as SetupWizardModal, w as withApproval, p as parseApprovalRequired } from "./approval-FzM0RsiL.js";
...
import { u as useAMDStation, P as PrintService } from "./PrintService-DTyYs1Qz.js";
  ...
  return /* @__PURE__ */ jsx(
    OneGlanceLayout,
    {
      ...
      children: /* @__PURE__ */ jsxs(React.Fragment, { children: [
        ...
        variantModalOpen && selectedProductForVariant && typeof document !== "undefined" && createPortal(/* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-modal flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-2xl w-full max-w-md overflow-hidden", children: [
        ...
        globalDiscountModal.show && typeof document !== "undefined" && createPortal(/* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-modal flex items-center justify-center bg-black/60 backdrop-blur-sm vq-anim-fade", children: /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 w-full max-w-sm rounded-2xl shadow-2xl border border-white/10 overflow-hidden text-white", children: [
        ...
        showQuickAccountModal && typeof document !== "undefined" && createPortal(/* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-modal flex items-center justify-center bg-black/60 backdrop-blur-sm vq-anim-fade", children: /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 w-full max-w-md rounded-2xl shadow-2xl border border-white/10 overflow-hidden", children: [
        ...
        itemDiscountModal.show && typeof document !== "undefined" && createPortal(/* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-command flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-2xl w-full max-w-sm p-6 space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { children: [
        ...
        converterModal.show && typeof document !== "undefined" && createPortal(/* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-command flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-2xl w-full max-w-sm p-6 space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { children: [
        ...
        showSyncHub && typeof document !== "undefined" && createPortal(/* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-modal flex items-center justify-center p-4 bg-neutral-900/60 backdrop-blur-sm vq-anim-fade", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden border border-line text-lg", children: [
        ...
        showRecentInvoices && typeof document !== "undefined" && createPortal(/* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-modal flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-lg shadow-2xl w-full max-w-2xl overflow-hidden border border-line flex flex-col max-h-[86vh]", children: [
        ...
        parkedDropdownOpen && typeof document !== "undefined" && createPortal(/* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-modal flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-lg shadow-2xl w-full max-w-lg overflow-hidden border border-line flex flex-col max-h-[80vh]", children: [
