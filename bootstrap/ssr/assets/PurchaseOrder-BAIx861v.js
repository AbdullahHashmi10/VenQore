...
function PurchaseOrderTool({ templates = {}, currencies = {}, maxItems = 100, suggestedNumber = "", toolGroups = [] }) {
  ...
  return /* @__PURE__ */ jsxs(
    ToolShell,
    {
      ...
      wide: true,
      children: [
        /* @__PURE__ */ jsx(SmartCaptureNudge, { documentType: "purchase order" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3 mb-5 p-3 vq-tool-panel", children: [
          ...
          buyer.logo_base64 && /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setBuyer((b) => ({ ...b, logo_base64: null })), className: "text-xs font-bold text-ink-muted hover:text-red-500 transition-colors", children: "Remove logo" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: `vq-paper rounded-2xl overflow-hidden shadow-xl shadow-neutral-900/10 dark:shadow-black/40 border border-line bg-white mx-auto transition-[max-width] ${meta.orientation === "landscape" ? "max-w-5xl" : "max-w-3xl"}`, children: [
          isModern && /* @__PURE__ */ jsx("div", { className: "h-3 w-full", style: { background: accent } }),
          /* @__PURE__ */ jsxs("div", { className: `p-6 sm:p-10 text-ink text-sm`, style: { fontFamily: "Helvetica, Arial, sans-serif" }, children: [
            /* @__PURE__ */ jsxs("div", { className: `flex flex-col sm:flex-row justify-between gap-6 mb-8 ${isClassic ? "border-b-2 border-neutral-900 pb-4" : ""}`, children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-left sm:text-right", children: [
                /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold tracking-tight", style: { color: isModern ? accent : "rgb(var(--vq-slate-900))" }, children: "PURCHASE ORDER" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-3 gap-6 mb-6", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Vendor / Supplier" }),
                ...
                /* @__PURE__ */ jsx(EditableText, { value: vendor.contact_person, onChange: (v) => setVendor((c) => ({ ...c, contact_person: v })), placeholder: "Attn: contact person", inline: false, className: "text-ink-muted text-xs mb-0.5" }),
                /* @__PURE__ */ jsx(EditableText, { value: vendor.address, onChange: (v) => setVendor((c) => ({ ...c, address: v })), placeholder: "Vendor address", as: "textarea", rows: 2, inline: false, className: "text-ink-muted text-xs mb-0.5" }),
                /* @__PURE__ */ jsx(EditableText, { value: vendor.email, onChange: (v) => setVendor((c) => ({ ...c, email: v })), placeholder: "Vendor email", inline: false, className: "text-ink-muted text-xs mb-0.5" }),
                /* @__PURE__ */ jsx(EditableText, { value: vendor.phone, onChange: (v) => setVendor((c) => ({ ...c, phone: v })), placeholder: "Vendor phone", inline: false, className: "text-ink-muted text-xs" })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Ship To" }),
                /* @__PURE__ */ jsx(EditableText, { value: buyer.ship_to, onChange: (v) => setBuyer((b) => ({ ...b, ship_to: v })), placeholder: "Ship-to address (optional, defaults to business address)", as: "textarea", rows: 4, className: "block text-ink-muted text-xs" })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Buyer Details" }),
                /* @__PURE__ */ jsx("p", { className: "font-bold", children: buyer.name || /* @__PURE__ */ jsx("span", { className: "italic text-ink-muted", children: "Your business name" }) }),
                buyer.email && /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-xs", children: buyer.email }),
                buyer.phone && /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-xs", children: buyer.phone })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("table", { className: "w-full mb-2", children: [
              /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: `text-left text-2xs font-bold uppercase tracking-wide text-ink-muted ${isClassic ? "border-b-2 border-neutral-900" : "border-b border-neutral-900"}`, children: [
                /* @__PURE__ */ jsx("th", { className: "pb-2 pr-2 w-24", children: /* @__PURE__ */ jsx(EditableText, { value: headers.sku, onChange: (v) => setHeaders((h) => ({ ...h, sku: v })), pulse: false, className: "text-2xs font-bold uppercase tracking-wide text-ink-muted" }) }),
                /* @__PURE__ */ jsx("th", { className: "pb-2 px-2", children: /* @__PURE__ */ jsx(EditableText, { value: headers.description, onChange: (v) => setHeaders((h) => ({ ...h, description: v })), pulse: false, className: "text-2xs font-bold uppercase tracking-wide text-ink-muted" }) }),
                ...
                /* @__PURE__ */ jsx("th", { className: "pb-2 px-2 text-right w-24", children: /* @__PURE__ */ jsx(EditableText, { value: headers.unit_cost, onChange: (v) => setHeaders((h) => ({ ...h, unit_cost: v })), pulse: false, className: "text-2xs font-bold uppercase tracking-wide text-ink-muted text-right" }) }),
                ...
                /* @__PURE__ */ jsx("th", { className: "pb-2 pl-2 text-right w-24", children: /* @__PURE__ */ jsx(EditableText, { value: headers.total, onChange: (v) => setHeaders((h) => ({ ...h, total: v })), pulse: false, className: "text-2xs font-bold uppercase tracking-wide text-ink-muted text-right" }) }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-6 text-xs text-ink-muted", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink-secondary mb-1", children: "Special Instructions / Notes" }),
                ...
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink-secondary mb-1 mt-4", children: "Authorized By" }),
              ...
              /* @__PURE__ */ jsx("div", { className: "flex flex-col items-end justify-end", children: /* @__PURE__ */ jsx("div", { className: "w-56 pt-10 text-right", children: /* @__PURE__ */ jsxs("div", { className: "border-t border-neutral-900 pt-1.5", children: [
                /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-secondary", children: "Authorized Signature" }),
                meta.authorized_by && /* @__PURE__ */ jsxs("p", { className: "text-1xs text-ink-muted", children: [
                  "(",
                  meta.authorized_by,
                  ")"
                ] })
