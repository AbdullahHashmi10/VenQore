  ...
  return /* @__PURE__ */ jsxs(PlatformShell, { title: "System Health", mode: "admin", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "h-full flex flex-col relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto p-8 relative z-0 hide-scrollbar flex gap-8", children: [
        ...
        selected && /* @__PURE__ */ jsxs("div", { className: "w-96 flex-shrink-0 bg-white dark:bg-[#1e293b] rounded-3xl border border-slate-200 dark:border-slate-700 p-6 shadow-xl sticky top-0 h-fit flex flex-col max-h-[calc(100vh-140px)]", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto hide-scrollbar space-y-6", children: [
            ...
            selected.stack_trace && /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("pre", { className: "text-[10px] font-mono whitespace-pre-wrap bg-slate-900 text-red-300 p-3 rounded-xl overflow-x-auto border border-slate-800 max-h-48", children: selected.stack_trace })
            ] }),
