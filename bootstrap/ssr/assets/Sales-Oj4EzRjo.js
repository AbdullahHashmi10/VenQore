    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full gap-4 w-full relative", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 pl-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("h1", { className: "text-xl font-bold text-ink tracking-tight flex items-center gap-2", children: [
              "Sales ",
              /* @__PURE__ */ jsx("span", { className: "text-ink-muted font-medium text-sm", children: "Overview" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted font-medium", children: "Revenue performance & trends" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row items-center gap-2", children: [
          /* @__PURE__ */ jsx("div", { className: "flex bg-sunken p-1 rounded-xl", children: [{ id: "this_month", label: "This Month" }, { id: "last_month", label: "Last Month" }, { id: "this_year", label: "This Year" }, { id: "custom", label: "Custom" }].map((opt) => /* @__PURE__ */ jsx(
            "button",
            {
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-4 gap-6 flex-1 min-h-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "xl:col-span-2 bg-surface rounded-2xl border border-line shadow-sm flex flex-col overflow-hidden", children: [
          /* @__PURE__ */ jsx("div", { className: "p-5 border-b border-line flex justify-between items-center bg-sunken/50 dark:bg-surface", children: /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "Recent Transactions" }) }),
          /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm text-left", children: [
            /* @__PURE__ */ jsx("thead", { className: "text-xs text-ink-muted uppercase bg-app sticky top-0 backdrop-blur-sm z-10", children: /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: sales.length > 0 ? sales.map((sale, idx) => {
              const total = Number(sale.total_amount) || 0;
              const paid = Number(sale.paid_amount) || 0;
              const due = total - paid;
              return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors cursor-pointer", onClick: () => setQuickViewSale(sale), children: [
                /* @__PURE__ */ jsxs("td", { className: "px-6 py-3 font-mono font-bold text-brand-600 dark:text-brand-400", children: [
                  "#",
                  sale.invoice_number || sale.reference_number
                ] }),
                /* @__PURE__ */ jsx("td", { className: "px-6 py-3 font-medium text-ink-secondary dark:text-ink", children: sale.party?.name || tt("Walk-in Customer") }),
                /* @__PURE__ */ jsx("td", { className: "px-6 py-3 text-right font-bold font-mono text-ink", children: formatCurrency(total, store) }),
            ...
            }) : /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "4", className: "px-6 py-8 text-center text-ink-muted italic", children: "No sales found for this period." }) }) })
          ] }) })
        ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-xs opacity-80 leading-relaxed space-y-2", children: [
                /* @__PURE__ */ jsxs("p", { children: [
                  ...
                  " ",
                  tt("customers into registered profiles to track repeat business.")
                ] }),
        ...
        /* @__PURE__ */ jsx("div", { className: "xl:col-span-1 flex flex-col gap-4 h-full", children: /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-neutral-900 to-neutral-800 p-5 rounded-2xl border border-neutral-700 shadow-lg text-white h-full relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 backdrop-blur-sm p-3 rounded-xl border border-white/10", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-1xs text-neutral-300 mobile-relaxed", children: "Monitor real-time sales velocity and detect dips before they become trends." })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 backdrop-blur-sm p-3 rounded-xl border border-white/10", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-1xs text-neutral-300", children: "Reducing total outstanding by 10% improves cash flow significantly." })
            ] })
          ] }),
      ...
      analysisResult && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-900/60 backdrop-blur-sm animate-in fade-in duration-normal", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface w-full max-w-md rounded-2xl shadow-2xl border border-line overflow-hidden animate-in zoom-in-95 duration-normal", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-brand-600 p-6 text-white relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
            ...
            /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold tracking-tight", children: "Sales Intelligence" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "p-6 space-y-4 max-h-[60vh] overflow-y-auto", children: analysisResult.insights.map((insight, idx) => /* @__PURE__ */ jsxs("div", { className: `p-4 rounded-xl border-l-4 ${insight.type === "danger" ? "bg-rose-50 border-rose-500 dark:bg-rose-900/10 text-rose-700" : insight.type === "warning" ? "bg-amber-50 border-amber-500 dark:bg-amber-900/10 text-amber-700" : insight.type === "success" ? "bg-emerald-50 border-emerald-500 dark:bg-emerald-900/10 text-emerald-700" : "bg-sunken border-brand-500 dark:bg-surface text-ink-secondary"}`, children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-3 sm:items-center justify-between p-4 border-b border-line bg-gradient-to-r from-neutral-50 to-white dark:from-neutral-800 dark:to-neutral-900 shrink-0", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx("h3", { className: "text-lg sm:text-xl font-bold text-brand-600 truncate", children: quickViewSale.reference_number || quickViewSale.invoice_number })
                ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-auto p-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "bg-app p-3 rounded-xl", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "font-bold text-ink text-sm", children: quickViewSale.party?.name || quickViewSale.customer?.name || "Walk-in" }),
                  quickViewSale.party?.phone && /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: quickViewSale.party.phone })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "bg-app p-3 rounded-xl", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: new Date(quickViewSale.created_at).toLocaleTimeString() })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "bg-app p-3 rounded-xl", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "bg-brand-100 dark:bg-brand-900/30 p-3 rounded-xl border border-brand-200 dark:border-brand-800", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "font-bold text-brand-600 text-lg", children: formatCurrency(quickViewSale.total_amount || quickViewSale.total, store) })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "border border-line rounded-xl overflow-hidden", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "hidden sm:block max-h-[300px] overflow-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
                  ...
                  /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: (quickViewSale.sale_items || quickViewSale.items || []).length > 0 ? (quickViewSale.sale_items || quickViewSale.items).map((item, idx) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-interactive-hover dark:hover:bg-interactive-hover", children: [
                    /* @__PURE__ */ jsx("td", { className: "p-3 text-ink-muted font-mono text-xs", children: idx + 1 }),
                    /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsx("p", { className: "font-semibold text-ink", children: item.product?.name || item.name || "Unknown Item" }) }),
                    /* @__PURE__ */ jsx("td", { className: "p-3 text-center font-bold text-ink-secondary", children: formatNumber(item.quantity) }),
                    /* @__PURE__ */ jsx("td", { className: "p-3 text-right text-ink-secondary", children: formatCurrency(item.unit_price || item.price || 0, store) }),
                    /* @__PURE__ */ jsx("td", { className: "p-3 text-right font-bold text-ink", children: formatCurrency(item.total_price || item.quantity * (item.unit_price || item.price || 0), store) })
                ...
                /* @__PURE__ */ jsx("div", { className: "block sm:hidden divide-y divide-line max-h-[300px] overflow-auto", children: (quickViewSale.sale_items || quickViewSale.items || []).length > 0 ? (quickViewSale.sale_items || quickViewSale.items).map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "p-3 hover:bg-interactive-hover dark:hover:bg-interactive-hover flex flex-col gap-2", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-start", children: [
                      ...
                      /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("p", { className: "font-semibold text-ink text-xs", children: item.product?.name || item.name || "Unknown Item" }) })
                    ] }),
                    /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink shrink-0", children: formatCurrency(item.total_price || item.quantity * (item.unit_price || item.price || 0), store) })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2 text-2xs bg-surface/50 dark:bg-app p-2 rounded-lg border border-line", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("span", { className: "text-ink-muted block uppercase", children: "Qty" }),
                      /* @__PURE__ */ jsx("span", { className: "font-bold text-ink-secondary", children: formatNumber(item.quantity) })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("span", { className: "text-ink-muted block uppercase", children: "Rate" }),
                      /* @__PURE__ */ jsx("span", { className: "font-semibold text-ink-secondary", children: formatCurrency(item.unit_price || item.price || 0, store) })
                    ] })
                  ] })
...
function RatioCard({ title, value, color, icon }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-surface px-4 py-3 rounded-xl border border-line shadow-sm flex items-center gap-3 hover:shadow-md transition-all group", children: [
    /* @__PURE__ */ jsx("div", { className: `p-2 rounded-lg ${colors[color]} shrink-0 transition-transform`, children: React.cloneElement(icon, { size: 16 }) }),
    /* @__PURE__ */ jsx("span", { className: "text-1xs font-bold text-ink-muted uppercase tracking-wider", children: title }),
    /* @__PURE__ */ jsx("span", { className: "ml-auto text-base font-bold text-ink tracking-tight", children: value })
  ] });
}
export {
