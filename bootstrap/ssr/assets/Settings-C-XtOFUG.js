...
import { O as OneGlanceLayout } from "./OneGlanceLayout-3W1KNwa4.js";
...
import { P as PrintPreview } from "./PrintPreview-CmXEPl-w.js";
import { T as Toggle$1 } from "./Toggle-Djmy2ap1.js";
...
<body>
 ${repeatedHtml}
  ...
  const content = /* @__PURE__ */ jsxs("div", { id: "fullscreen-portal-root", className: `flex flex-col bg-app border border-line rounded-2xl overflow-hidden shadow-sm transition-all duration-slow ${isFullScreen ? "fixed inset-0 z-command rounded-none" : "h-[calc(100vh-12rem)]"}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4 p-4 border-b border-line bg-surface z-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-ink", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "font-bold text-sm tracking-tight", children: "ADVANCED DESIGN PANEL" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex bg-sunken rounded-lg p-1", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: `px-3 py-1.5 text-xs font-bold rounded-md transition-all ${data._print_tab !== "thermal" ? "bg-sunken text-brand-600 shadow-sm" : "text-ink-muted hover:text-ink-secondary"}`,
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: `px-3 py-1.5 text-xs font-bold rounded-md transition-all ${data._print_tab === "thermal" ? "bg-sunken text-emerald-600 shadow-sm" : "text-ink-muted hover:text-ink-secondary"}`,
...
function BusinessSettingsSection({ data, setData }) {
  return /* @__PURE__ */ jsx("div", { className: "animate-in fade-in slide-in-from-bottom-2 duration-slow", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "col-span-12 xl:col-span-8 p-6 bg-surface rounded-xl border border-line shadow-sm", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
        /* @__PURE__ */ jsx("div", { className: "p-2 bg-brand-50 dark:bg-brand-900/20 rounded-lg text-brand-600", children: /* @__PURE__ */ jsx(Building2, { size: 18 }) }),
        /* @__PURE__ */ jsx("h3", { className: "font-bold text-ink", children: "Business Identity" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 group/input", children: [
          /* @__PURE__ */ jsx("label", { className: "text-2xs font-bold uppercase tracking-wider text-ink-muted ml-1", children: "Business Name" }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ jsx(Building2, { className: "absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-muted", size: 16 })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 group/input", children: [
          /* @__PURE__ */ jsx("label", { className: "text-2xs font-bold uppercase tracking-wider text-ink-muted ml-1", children: "Tax / NTN" }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
            ...
            /* @__PURE__ */ jsx(Hash, { className: "absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-muted", size: 16 })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 group/input", children: [
          /* @__PURE__ */ jsx("label", { className: "text-2xs font-bold uppercase tracking-wider text-ink-muted ml-1", children: "Official Email" }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                ...
                className: "w-full pl-10 pr-4 py-2.5 bg-app border border-line rounded-xl text-sm font-bold focus:ring-2 focus:ring-emerald-500 outline-none transition-all",
                placeholder: "email@company.com"
              }
            ),
            /* @__PURE__ */ jsx(Mail, { className: "absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-muted", size: 16 })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 group/input", children: [
          /* @__PURE__ */ jsx("label", { className: "text-2xs font-bold uppercase tracking-wider text-ink-muted ml-1", children: "Phone Line" }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
            ...
            /* @__PURE__ */ jsx(Phone, { className: "absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-muted", size: 16 })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "col-span-12 xl:col-span-4 p-6 bg-neutral-900 text-white rounded-xl shadow-xl relative overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-32 h-32 bg-brand-500/20 rounded-full blur-[40px] translate-x-1/2 -translate-y-1/2" }),
      /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsx(Globe, { size: 18, className: "text-brand-400" }),
          /* @__PURE__ */ jsx("h3", { className: "font-bold", children: "Regional Settings" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx("label", { className: "text-2xs font-bold uppercase tracking-wider text-ink-muted", children: "Currency" }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxs(
                "select",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "PKR", children: "PKR - Pakistani Rupee" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "USD", children: "USD - US Dollar" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "EUR", children: "EUR - Euro" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "GBP", children: "GBP - British Pound" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "AED", children: "AED - UAE Dirham" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "SAR", children: "SAR - Saudi Riyal" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "INR", children: "INR - Indian Rupee" })
                  ]
                }
              ),
              /* @__PURE__ */ jsx(CreditCard, { className: "absolute left-3.5 top-1/2 -translate-y-1/2 text-brand-400 pointer-events-none", size: 16 }),
              /* @__PURE__ */ jsx(ChevronRight, { className: "absolute right-3.5 top-1/2 -translate-y-1/2 text-ink-muted rotate-90 pointer-events-none", size: 14 })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx("label", { className: "text-2xs font-bold uppercase tracking-wider text-ink-muted", children: "Currency Symbol" }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
              ...
              /* @__PURE__ */ jsx("div", { className: "absolute left-3.5 top-1/2 -translate-y-1/2 text-brand-400 font-bold text-xs", children: "SYM" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx("label", { className: "text-2xs font-bold uppercase tracking-wider text-ink-muted", children: "Timezone" }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxs(
                "select",
                {
                  ...
                  className: "w-full pl-10 pr-4 py-3 bg-white/10 border border-white/10 rounded-xl text-sm font-bold focus:ring-2 focus:ring-brand-500 outline-none transition-all text-white appearance-none cursor-pointer hover:bg-white/20",
                  children: [
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "Asia/Karachi", children: "Asia/Karachi (PKT)" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "Asia/Dubai", children: "Asia/Dubai (GST)" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "Asia/Riyadh", children: "Asia/Riyadh (AST)" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "Asia/Kolkata", children: "Asia/Kolkata (IST)" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "Europe/London", children: "Europe/London (GMT)" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "America/New_York", children: "America/New_York (EST)" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "America/Chicago", children: "America/Chicago (CST)" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "America/Los_Angeles", children: "America/Los_Angeles (PST)" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "Australia/Sydney", children: "Australia/Sydney (AEST)" }),
                    /* @__PURE__ */ jsx("option", { className: "bg-neutral-800 text-white", value: "UTC", children: "Universal Time (UTC)" })
                  ]
                }
              ),
              /* @__PURE__ */ jsx(Clock, { className: "absolute left-3.5 top-1/2 -translate-y-1/2 text-brand-400 pointer-events-none", size: 16 }),
              /* @__PURE__ */ jsx(ChevronRight, { className: "absolute right-3.5 top-1/2 -translate-y-1/2 text-ink-muted rotate-90 pointer-events-none", size: 14 })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted mt-2", children: "Determines date rollovers for reports." })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "col-span-12 p-6 bg-surface rounded-xl border border-line shadow-sm relative group hover:border-brand-500/30 transition-all", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-2", children: [
        /* @__PURE__ */ jsx("label", { className: "text-2xs font-bold uppercase tracking-wider text-ink-muted", children: "Head Office Address" }),
        /* @__PURE__ */ jsx(
          "textarea",
          {
            value: data.business_address,
            onChange: (e) => setData("business_address", e.target.value),
            className: "w-full p-4 bg-app border border-line rounded-xl text-sm font-medium focus:ring-2 focus:ring-emerald-500 outline-none transition-all min-h-[80px] resize-none",
...
function GeneralSettingsSection({ data, setData }) {
  const SettingToggle = ({ label, description, checked, onChange, icon: Icon, color = "indigo" }) => /* @__PURE__ */ jsxs("div", { className: "p-6 bg-surface rounded-xl border border-line flex items-center justify-between group hover:border-brand-500/30 transition-all duration-slow", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsx("div", { className: `p-3 rounded-2xl ${checked ? `bg-${color}-50 dark:bg-${color}-900/20 text-${color}-600` : "bg-app text-ink-muted"}`, children: /* @__PURE__ */ jsx(Icon, { size: 24 }) }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h4", { className: "font-bold text-ink text-lg", children: label }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted font-medium", children: description })
      ] })
    ] }),
    /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: `absolute top-1 bg-white rounded-full transition-all duration-slow shadow-md w-6 h-6 ${checked ? "left-[calc(100%-28px)]" : "left-1"}` })
      }
    )
  ] });
  return /* @__PURE__ */ jsxs("div", { className: "animate-in fade-in slide-in-from-bottom-2 duration-slow space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-8 p-8 rounded-2xl bg-gradient-to-br from-neutral-900 via-neutral-800 to-brand-950 relative overflow-hidden shadow-2xl", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-96 h-96 bg-brand-500/10 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2" }),
      /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-2", children: [
          /* @__PURE__ */ jsx("div", { className: "p-2 bg-brand-500/20 rounded-lg backdrop-blur-md border border-white/10", children: /* @__PURE__ */ jsx(Layers, { className: "text-brand-400", size: 24 }) }),
          /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold text-white tracking-tight", children: "System Preferences" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-ink-muted font-medium ml-14 text-lg max-w-2xl", children: "Fine-tune your POS experience. Control security, inventory rules, and visual density." })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: `overflow-hidden transition-all duration-slow ${data.enable_passcode === "1" || data.enable_passcode === true ? "max-h-40 opacity-100" : "max-h-0 opacity-0"}`, children: /* @__PURE__ */ jsxs("div", { className: "p-6 bg-red-50 dark:bg-red-900/10 rounded-xl border border-red-100 dark:border-red-900/30 ml-4 border-l-[6px] border-l-red-500", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "px-4", children: /* @__PURE__ */ jsxs("p", { className: "text-xs text-ink-muted italic", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "p-8 bg-surface rounded-xl border border-line h-full", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-8", children: [
          /* @__PURE__ */ jsx("div", { className: "p-2.5 bg-brand-50 dark:bg-brand-900/20 rounded-xl text-brand-600", children: /* @__PURE__ */ jsx(Layout, { size: 20 }) }),
          /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-ink", children: "Visual & Format" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-end", children: [
              /* @__PURE__ */ jsx("label", { className: "text-sm font-bold text-ink-secondary", children: "Decimal Precision" }),
              /* @__PURE__ */ jsxs("span", { className: "text-xs font-mono bg-sunken px-2 py-1 rounded text-ink-muted", children: [
                "100.",
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-5 gap-2", children: [0, 1, 2, 3, 4].map((num) => /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `py-3 rounded-xl font-bold text-sm transition-all border-2 ${parseInt(data.decimal_places) === num ? "border-brand-600 bg-brand-50 dark:bg-brand-900/20 text-brand-700 dark:text-brand-300" : "border-transparent bg-app text-ink-muted hover:bg-interactive-hover dark:hover:bg-interactive-hover"}`,
                children: num
              },
              num
            )) })
          ] }),
          /* @__PURE__ */ jsx("hr", { className: "border-line" }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
              /* @__PURE__ */ jsx("label", { className: "text-sm font-bold text-ink-secondary", children: "Interface Scale" }),
              /* @__PURE__ */ jsxs("span", { className: "text-xs font-bold text-brand-500 bg-brand-50 dark:bg-brand-900/20 px-3 py-1 rounded-full", children: [
                data.ui_scale,
                "%"
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "relative h-12 flex items-center", children: [
              /* @__PURE__ */ jsx("div", { className: "absolute w-full h-2 bg-sunken rounded-full overflow-hidden", children: /* @__PURE__ */ jsx(
                "div",
                {
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-2xs font-bold text-ink-muted uppercase tracking-widest px-1", children: [
...
function AiSettingsSection({ data, setData, handleVerifyKey, verifyingKey, verificationResult }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-slow", children: [
    /* @__PURE__ */ jsxs("div", { className: "p-6 bg-gradient-brand rounded-xl shadow-xl relative overflow-hidden group", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex flex-col md:flex-row items-center gap-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 text-center md:text-left", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-white mb-2 tracking-tight", children: "Artificial Intelligence" }),
          /* @__PURE__ */ jsxs("p", { className: "text-brand-100/90 leading-snug", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            data.ai_provider === "gemini" && /* @__PURE__ */ jsx("div", { className: "absolute top-5 right-5 bg-brand-600 text-white text-2xs font-bold px-2 py-1 rounded-full uppercase tracking-widest shadow-lg ", children: "Active" }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white shadow-lg ", children: /* @__PURE__ */ jsx(Sparkles, { size: 20 }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h4", { className: "text-lg font-bold text-ink leading-tight", children: "Google Gemini" }),
                /* @__PURE__ */ jsx("span", { className: "inline-block mt-1 text-2xs font-bold text-emerald-600 bg-emerald-100 dark:bg-emerald-500/20 px-2 py-0.5 rounded uppercase tracking-wider", children: "Free Tier Available" })
              ] })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted font-medium leading-relaxed mb-6", children: "A fast and powerful option from Google. Includes a generous free tier for daily analytics." }),
            /* @__PURE__ */ jsxs("div", { className: `space-y-4 transition-all duration-slow ${data.ai_provider === "gemini" ? "opacity-100" : "opacity-50 pointer-events-none blur-[1px]"}`, children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-xs font-bold uppercase tracking-wider text-ink-muted ml-1", children: "Gemini API Key" }),
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsx(
                    "input",
                    {
              ...
              /* @__PURE__ */ jsxs("div", { className: "bg-white/80 dark:bg-app p-4 rounded-xl border border-brand-100 dark:border-brand-500/10", children: [
                /* @__PURE__ */ jsxs("p", { className: "text-xs font-bold text-brand-900 dark:text-brand-300 mb-2 flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsx("span", { className: "w-4 h-4 rounded-full bg-brand-100 dark:bg-brand-500/20 flex items-center justify-center text-2xs", children: "?" }),
                  "How to get Free Key:"
                ] }),
                /* @__PURE__ */ jsxs("ol", { className: "text-2xs text-ink-secondary space-y-1.5 list-decimal ml-3 marker:font-bold marker:text-brand-500", children: [
                  /* @__PURE__ */ jsxs("li", { children: [
                    "Go to ",
                    /* @__PURE__ */ jsx("a", { href: "https://aistudio.google.com/app/apikey", target: "_blank", className: "text-brand-600 font-bold underline hover:text-brand-700", children: "Google AI Studio" }),
                    "."
                  ] }),
                  /* @__PURE__ */ jsxs("li", { children: [
                    "Sign in & Click ",
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            data.ai_provider === "openai" && /* @__PURE__ */ jsx("div", { className: "absolute top-5 right-5 bg-emerald-600 text-white text-2xs font-bold px-2 py-1 rounded-full uppercase tracking-widest shadow-lg ", children: "Active" }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-emerald-600 flex items-center justify-center text-white shadow-lg ", children: /* @__PURE__ */ jsx(Globe, { size: 20 }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h4", { className: "text-lg font-bold text-ink leading-tight", children: "OpenAI GPT-4" }),
                /* @__PURE__ */ jsx("span", { className: "inline-block mt-1 text-2xs font-bold text-amber-600 bg-amber-100 dark:bg-amber-500/20 px-2 py-0.5 rounded uppercase tracking-wider", children: "Paid Subscription" })
              ] })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted font-medium leading-relaxed mb-6", children: "Industry leader in reasoning. Requires a paid API account." }),
            /* @__PURE__ */ jsxs("div", { className: `space-y-4 transition-all duration-slow ${data.ai_provider === "openai" ? "opacity-100" : "opacity-50 pointer-events-none blur-[1px]"}`, children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-xs font-bold uppercase tracking-wider text-ink-muted ml-1", children: "OpenAI API Key" }),
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsx(
                    "input",
                    {
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-xs font-bold uppercase tracking-wider text-ink-muted ml-1", children: "Model Selection" }),
                /* @__PURE__ */ jsxs(
                  "select",
                  {
                    value: data.ai_model,
    ...
    /* @__PURE__ */ jsxs("div", { className: "p-6 bg-surface rounded-xl border border-line shadow-sm space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
        /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-brand-100 dark:bg-brand-900/30 text-brand-600 dark:text-brand-400 flex items-center justify-center font-bold", children: /* @__PURE__ */ jsx(Globe, { size: 20 }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h4", { className: "text-base font-bold text-ink", children: "Data Privacy & Community Intelligence" }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Control data sharing and AI accuracy improvement settings" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-4 pt-2 border-t border-line", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between py-2", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-ink block", children: tt("Opt out of Shared Product Catalog") }),
            /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted", children: "Do not contribute anonymized SKU names/barcodes to global catalog matching" })
          ] }),
          /* @__PURE__ */ jsx(
            "input",
            {
              ...
              onChange: (e) => {
                ...
                const { router: router2 } = require("@inertiajs/react");
                router2.post(route("store.settings.data-privacy.update"), {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between py-2 border-t border-line", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-ink block", children: "Opt in to AI Accuracy Learning" }),
            /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted", children: "Allow anonymized receipt extraction corrections to train model prompts" })
          ] }),
          /* @__PURE__ */ jsx(
            "input",
            {
...
function TransactionSettingsSection({ data, setData }) {
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-slow", children: [
    /* @__PURE__ */ jsxs("div", { className: "p-8 rounded-xl bg-gradient-to-br from-brand-50 to-blue-50 dark:from-neutral-800 dark:to-neutral-900 border border-brand-100 dark:border-line relative overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-64 h-64 bg-brand-500/5 rounded-full blur-[80px] -translate-y-1/2 translate-x-1/2" }),
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex items-center gap-6", children: [
        /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-2xl bg-brand-600 text-white flex items-center justify-center shadow-lg ", children: /* @__PURE__ */ jsx(FileText, { size: 32 }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-ink tracking-tight mb-2", children: "On the Invoice" }),
          /* @__PURE__ */ jsx("p", { className: "text-ink-muted font-medium", children: "Control how your bills look and behave." })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "bg-surface rounded-xl border border-line p-6", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsx(
        Toggle$1,
        {
...
function TaxSettingsSection({ data, setData }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-slow", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-4 p-8 bg-surface rounded-xl border border-line shadow-sm", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-ink tracking-tight", children: "Tax Configuration" }),
          /* @__PURE__ */ jsx("p", { className: "text-ink-muted font-medium", children: "Manage GST, VAT, and other levies." })
        ] })
      ] }),
      /* @__PURE__ */ jsxs(
        "button",
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6", children: [
      ...
      (!data.tax_rates || data.tax_rates.length === 0) && /* @__PURE__ */ jsxs("div", { className: "col-span-full py-12 flex flex-col items-center justify-center text-ink-muted border-2 border-dashed border-line rounded-xl", children: [
...
function SystemSettingsSection({ data, setData, activeSubSection = "system" }) {
  ...
  const renderContent = () => {
    switch (activeSubSection) {
      case "notifications":
        return /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "p-8 bg-brand-50 dark:bg-brand-900/10 rounded-xl border border-brand-100 dark:border-brand-500/20", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-4", children: [
            /* @__PURE__ */ jsx("div", { className: "p-3 bg-brand-500 rounded-xl text-white", children: /* @__PURE__ */ jsx(Bell, { size: 24 }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-brand-900 dark:text-white", children: "Notification Center" }),
              /* @__PURE__ */ jsx("p", { className: "text-brand-600 dark:text-brand-300", children: "Control what alerts you receive." })
            ] })
          ] }),
      ...
      case "security":
        return /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "p-8 bg-app rounded-xl border border-line", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-4", children: [
            /* @__PURE__ */ jsx("div", { className: "p-3 bg-emerald-500 rounded-xl text-white", children: /* @__PURE__ */ jsx(Shield, { size: 24 }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-ink", children: "Security & Access" }),
              /* @__PURE__ */ jsx("p", { className: "text-ink-muted", children: "Protect your account and data." })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx("label", { className: "text-xs font-bold uppercase tracking-wider text-ink-muted ml-1", children: "Auto-Logout Timer (Minutes)" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "number",
      ...
      case "backup":
        return /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "p-8 bg-sky-50 dark:bg-sky-900/10 rounded-xl border border-sky-100 dark:border-sky-500/20", children: [
      ...
      case "integrations":
        return /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-surface p-8 rounded-2xl border border-line shadow-xl", children: [
            /* @__PURE__ */ jsx(
              Toggle$1,
              {
            ...
            data.fbr_integration && /* @__PURE__ */ jsx("div", { className: "mt-8 pt-8 border-t border-line space-y-4 animate-in slide-in-from-top-4 duration-slow", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsx("label", { className: "text-2xs font-bold uppercase tracking-[0.15em] text-ink-muted", children: "FBR POS ID" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsx("label", { className: "text-2xs font-bold uppercase tracking-[0.15em] text-ink-muted", children: "FBR USIN" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsx("div", { className: "p-8 bg-surface border-2 rounded-2xl opacity-60", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-5 mb-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("h5", { className: "text-lg font-bold text-ink leading-tight", children: "Stripe" }),
                /* @__PURE__ */ jsx("span", { className: "px-1.5 py-0.5 bg-amber-100 dark:bg-amber-500/20 text-amber-600 dark:text-amber-400 text-4xs font-bold uppercase tracking-wider rounded border border-amber-200 dark:border-amber-500/30", children: "Upcoming" })
              ] }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted font-medium", children: "Process card payments" })
            ] }),
            /* @__PURE__ */ jsx("button", { disabled: true, type: "button", className: "relative w-12 h-6 rounded-full bg-sunken cursor-not-allowed", children: /* @__PURE__ */ jsx("div", { className: "absolute top-1 left-1 w-4 h-4 bg-white rounded-full shadow-sm" }) })
          ] }) }) })
        ] });
      case "system":
      default:
        return /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "p-6 bg-surface rounded-2xl border border-line", children: [
            /* @__PURE__ */ jsx("h4", { className: "font-bold text-ink mb-4", children: "Localization" }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-xs font-bold uppercase tracking-wider text-ink-muted ml-1", children: "Language" }),
                /* @__PURE__ */ jsxs(
                  "select",
                  {
                    value: data.language,
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-xs font-bold uppercase tracking-wider text-ink-muted ml-1", children: "Date Format" }),
                /* @__PURE__ */ jsxs(
                  "select",
                  {
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-6 bg-surface rounded-2xl border border-line", children: [
            /* @__PURE__ */ jsx("h4", { className: "font-bold text-ink mb-4", children: "Appearance" }),
  ...
  return /* @__PURE__ */ jsx("div", { className: "animate-in fade-in slide-in-from-bottom-2 duration-slow", children: renderContent() });
}
function DangerSettingsSection({ data, setData }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "animate-in fade-in slide-in-from-bottom-2 duration-slow", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-8 p-8 rounded-2xl bg-gradient-to-br from-red-950 via-red-900 to-neutral-900 relative overflow-hidden shadow-2xl border border-red-900/50", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-2", children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold text-white tracking-tight", children: "Danger Zone" })
        ] }),
    ...
    /* @__PURE__ */ jsx("div", { className: "p-8 bg-red-50 dark:bg-red-900/10 rounded-xl border border-red-100 dark:border-red-500/20", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { className: "p-2 bg-sunken rounded-lg group-hover:bg-red-50 dark:group-hover:bg-red-900/20 transition-colors", children: /* @__PURE__ */ jsx(Trash2, { size: 20 }) }),
...
function AdminSettings({ settings = {} }) {
  ...
  const renderSection = () => {
    switch (activeSection) {
      ...
      case "preferences":
        return /* @__PURE__ */ jsxs("div", { className: "space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-slow", children: [
          /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(GeneralSettingsSection, { data, setData }) }),
          /* @__PURE__ */ jsxs("div", { className: "pt-6 border-t border-line", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "pt-6 border-t border-line", children: /* @__PURE__ */ jsx(SystemSettingsSection, { data, setData, activeSubSection: "notifications" }) })
        ] });
      ...
      case "sales":
        return /* @__PURE__ */ jsxs("div", { className: "space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-slow", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "bg-surface rounded-2xl border border-line p-6", children: /* @__PURE__ */ jsxs("div", { className: "divide-y divide-line", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold text-ink", children: "Round Off Invoice Totals" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl border border-line p-6 mt-6", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                ...
                data.pos_return_mode === "open" && /* @__PURE__ */ jsxs("div", { className: "p-4 bg-amber-500/10 border border-amber-500/20 rounded-2xl space-y-3", children: [
                  ...
                  /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-2 cursor-pointer select-none", children: [
                    /* @__PURE__ */ jsx("input", { type: "checkbox", checked: acknowledgeOpenReturn, onChange: (e) => setAcknowledgeOpenReturn(e.target.checked), className: "w-4 h-4 rounded text-brand-600 focus:ring-brand-500 border-line" }),
                ...
                data.pos_return_mode === "open" && /* @__PURE__ */ jsxs("div", { className: "space-y-4 pt-4 border-t border-line", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center py-2", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "block text-xs text-ink-muted", children: "Max days since purchase for returns (leave empty to disable)" })
                    ] }),
                    /* @__PURE__ */ jsx("input", { type: "number", min: "1", value: data.pos_return_window, onChange: (e) => setData("pos_return_window", e.target.value), placeholder: "e.g. 7, 14, 30", className: "w-64 px-4 py-2.5 bg-sunken border border-line dark:border-line rounded-xl text-sm focus:ring-2 focus:ring-brand-500 outline-none" })
                  ] }),
                  data.pos_return_window && /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center py-2", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "block text-xs text-ink-muted", children: "Action when return window has expired" })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "flex bg-sunken p-1 rounded-xl", children: [
                      /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setData("pos_return_window_behavior", "warn"), className: `px-4 py-2 text-xs font-bold rounded-lg transition-all ${data.pos_return_window_behavior === "warn" ? "bg-surface text-brand-600 dark:text-brand-400 shadow-sm" : "text-ink-muted"}`, children: "Soft Warning" }),
                      /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setData("pos_return_window_behavior", "block"), className: `px-4 py-2 text-xs font-bold rounded-lg transition-all ${data.pos_return_window_behavior === "block" ? "bg-surface text-brand-600 dark:text-brand-400 shadow-sm" : "text-ink-muted"}`, children: "Hard Block" })
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between py-4 border-t border-line", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setData("charity_enabled", !data.charity_enabled), className: `relative w-12 h-6 rounded-full transition-colors ${data.charity_enabled ? "bg-rose-500" : "bg-sunken"}`, children: /* @__PURE__ */ jsx("div", { className: `absolute top-1 w-4 h-4 bg-white rounded-full transition-all ${data.charity_enabled ? "right-1" : "left-1"}` }) })
                ] })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "pt-6 border-t border-line", children: /* @__PURE__ */ jsx(TransactionSettingsSection, { data, setData }) })
        ] });
      case "print":
      ...
      case "messages":
        return /* @__PURE__ */ jsxs("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-slow", children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 rounded-2xl p-6 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-14 h-14 rounded-2xl bg-emerald-500 flex items-center justify-center text-white shadow-lg ", children: /* @__PURE__ */ jsx(MessageSquare, { size: 28 }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h4", { className: "font-bold text-emerald-900 dark:text-emerald-400 text-lg", children: "WhatsApp Integration" }),
                /* @__PURE__ */ jsx("p", { className: "text-sm text-emerald-700 dark:text-emerald-500/80", children: tt("Send invoices directly to customer's WhatsApp") })
              ] })
            ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              ...
              /* @__PURE__ */ jsx(Toggle$1, { enabled: data.sms_to_party, onChange: (v) => setData("sms_to_party", v), label: "Send SMS to Party", description: tt("Notify customers on every transaction") }),
              /* @__PURE__ */ jsx(Toggle$1, { enabled: data.auto_send_sales, onChange: (v) => setData("auto_send_sales", v), label: "Auto-send for Sales" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "p-6 bg-sunken rounded-2xl border border-line", children: [
              /* @__PURE__ */ jsx("label", { className: "text-xs font-bold uppercase tracking-wider text-ink-muted mb-4 block", children: "Message Template" }),
              /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-xl p-4 text-sm text-ink-secondary border border-line dark:border-line", children: [
                "Greetings from ",
                /* @__PURE__ */ jsx("span", { className: "text-brand-500 font-bold", children: "[Firm_Name]" }),
                ". Your invoice for ",
                /* @__PURE__ */ jsx("span", { className: "text-brand-500 font-bold", children: "[Invoice_Amount]" }),
                " is ready. View here: [Link]"
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-center justify-between", children: [
                /* @__PURE__ */ jsxs("button", { className: "text-brand-600 text-sm font-bold flex items-center gap-2 hover:underline", children: [
          ...
          data.whatsapp_enabled && /* @__PURE__ */ jsxs("div", { className: "p-8 bg-surface rounded-xl border border-line shadow-xl animate-in zoom-in-95 duration-normal", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
              /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-2xl bg-emerald-500 flex items-center justify-center text-white shadow-lg ", children: /* @__PURE__ */ jsx(MessageSquare, { size: 24 }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h4", { className: "text-lg font-bold text-ink", children: "WhatsApp API Credentials" }),
                /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Configure your Meta Business for WhatsApp" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-xs font-bold uppercase tracking-wider text-ink-muted", children: "API URL" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-xs font-bold uppercase tracking-wider text-ink-muted", children: "Phone Number ID" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxs("div", { className: "md:col-span-2 space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-xs font-bold uppercase tracking-wider text-ink-muted", children: "Access Token" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "password",
      ...
      case "party":
        return /* @__PURE__ */ jsx("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-slow", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsx(SectionHeader, { title: tt("Customer Preferences"), description: "Manage how you interact with parties" }),
            /* @__PURE__ */ jsx(Toggle$1, { enabled: data.party_grouping, onChange: (v) => setData("party_grouping", v), label: "Enable Party Grouping", description: tt("Categorize customers by region or type") }),
            /* @__PURE__ */ jsx(Toggle$1, { enabled: data.loyalty_enabled, onChange: (v) => setData("loyalty_enabled", v), label: "Loyalty Points Program", description: tt("Reward frequent customers with points") }),
            /* @__PURE__ */ jsx(Toggle$1, { enabled: data.enable_credit_limit, onChange: (v) => setData("enable_credit_limit", v), label: "Enable Credit Limit", description: tt("Set maximum credit limits for customers") })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "p-6 bg-brand-50 dark:bg-brand-500/10 rounded-2xl border border-brand-100 dark:border-brand-500/20", children: [
            /* @__PURE__ */ jsxs("h4", { className: "font-bold text-brand-900 dark:text-brand-400 flex items-center gap-2 mb-4", children: [
              /* @__PURE__ */ jsx(Clock, { size: 18 }),
              " Payment Reminders"
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsx(Toggle$1, { enabled: data.payment_reminders, onChange: (v) => setData("payment_reminders", v), label: "Enable Payment Reminders", description: tt("Automatically email customers with outstanding invoices") }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-sm text-brand-700 dark:text-brand-300/80", children: "Send reminder after (days) past invoice date" }),
                /* @__PURE__ */ jsx("input", { type: "number", value: data.payment_reminder_days, onChange: (e) => setData("payment_reminder_days", e.target.value), className: "w-full px-4 py-3 bg-surface border border-brand-200 dark:border-brand-500/30 rounded-xl focus:ring-2 focus:ring-brand-500 outline-none" })
              ] })
            ] })
          ] })
        ] }) });
      case "item":
        return /* @__PURE__ */ jsxs("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-slow", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-6 bg-sunken rounded-2xl border border-line relative overflow-hidden group", children: [
              /* @__PURE__ */ jsx("div", { className: "absolute top-3 right-3", children: /* @__PURE__ */ jsx("span", { className: "px-2 py-1 bg-amber-100 dark:bg-amber-500/20 text-amber-600 dark:text-amber-400 text-2xs font-bold uppercase tracking-widest rounded border border-amber-200 dark:border-amber-500/30 shadow-sm", children: "Upcoming" }) }),
              /* @__PURE__ */ jsxs("h4", { className: "font-bold text-ink flex items-center gap-2 mb-4 opacity-50", children: [
                /* @__PURE__ */ jsx(Plus, { size: 18, className: "text-brand-500" }),
                " Custom Item Fields"
              ] }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mb-6 opacity-50", children: "Add up to 6 custom fields like Color, Material, or Brand to your products." })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "pt-4 border-t border-line grid grid-cols-1 md:grid-cols-2 gap-6 items-center", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx("label", { className: "text-sm font-bold text-ink-secondary", children: "Low Stock Threshold" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "number",
      ...
      case "accounting":
        return /* @__PURE__ */ jsx("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-slow", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsx(SectionHeader, { title: "Financial Cycles", description: "Manage your fiscal year and reporting" }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx("label", { className: "text-sm font-bold text-ink-secondary", children: "Fiscal Year Start" }),
            /* @__PURE__ */ jsx("input", { type: "date", value: data.fiscal_year_start || "2025-01-01", onChange: (e) => setData("fiscal_year_start", e.target.value), className: "w-full px-4 py-3 bg-sunken border border-line dark:border-line rounded-xl outline-none focus:ring-2 focus:ring-brand-500 shadow-sm" })
          ] })
        ] }) }) });
      case "security":
        return /* @__PURE__ */ jsx(SystemSettingsSection, { data, setData, activeSubSection: "security" });
      case "backup":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center text-center gap-4 bg-surface rounded-xl border border-line p-12 animate-in fade-in slide-in-from-bottom-2 duration-slow", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-ink mb-2", children: "Backups now live in Data & Backup" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted max-w-md", children: "Automatic daily backups, manual snapshots, cloud sync and restore are all in one place now, instead of split between Settings and Data Management." })
          ] }),
          /* @__PURE__ */ jsxs(
            "button",
            {
      ...
      case "reminders":
        return /* @__PURE__ */ jsx("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-slow", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface border border-line rounded-2xl overflow-hidden flex flex-col min-h-[400px]", children: [
          /* @__PURE__ */ jsxs("div", { className: "p-4 bg-sunken border-b border-line flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative flex-1 max-w-md", children: [
              ...
              /* @__PURE__ */ jsx("input", { type: "text", placeholder: tt("Search services for reminder..."), className: "w-full pl-10 pr-4 py-2 bg-surface border border-line dark:border-line rounded-xl text-sm outline-none" })
            ] }),
            /* @__PURE__ */ jsxs(
              "button",
              {
          ...
          /* @__PURE__ */ jsx("div", { className: "flex-1 divide-y divide-line", children: data.service_reminders.length > 0 ? data.service_reminders.map((reminder, idx) => /* @__PURE__ */ jsxs("div", { className: "p-4 flex items-center justify-between hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors group", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 flex-1", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-sunken flex items-center justify-center text-ink-muted", children: /* @__PURE__ */ jsx(Clock, { size: 20 }) }),
              /* @__PURE__ */ jsxs("div", { className: "flex-1 max-w-xs", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted uppercase font-bold tracking-widest mt-0.5", children: tt("Recurring Service") })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 bg-sunken px-3 py-1.5 rounded-xl", children: [
                /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-ink-muted uppercase tracking-tighter", children: "Every" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "number",
          ...
          ] }, reminder.id)) : /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col items-center justify-center text-ink-muted py-12", children: [
            /* @__PURE__ */ jsx(Clock, { size: 48, className: "mb-4 opacity-20" }),
            /* @__PURE__ */ jsx("p", { className: "font-bold text-sm tracking-tight mb-1", children: tt("No Service Reminders Yet") }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-center max-w-xs", children: tt('Click "Add New Reminder" above to schedule automatic recurring service notifications.') })
          ] }) })
        ] }) });
      default:
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "System Settings", mode: "admin", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "h-full flex gap-6 overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: `${sidebarCollapsed ? "w-20" : "w-80"} bg-neutral-900 rounded-2xl border border-neutral-800 shadow-2xl p-3 shrink-0 flex flex-col relative overflow-hidden transition-all duration-slow`, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: `${sidebarCollapsed ? "px-2 py-4 justify-center" : "px-4 py-5 justify-between"} flex items-center border-b border-neutral-800/50 mb-3 relative z-50`, children: [
          !sidebarCollapsed && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
            /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-lg bg-gradient-brand flex items-center justify-center text-white shadow-lg shrink-0", children: /* @__PURE__ */ jsx(Settings, { size: 18 }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-base font-bold text-white tracking-tight", children: "System" }),
              /* @__PURE__ */ jsx("p", { className: "text-3xs font-bold uppercase tracking-[0.2em] text-brand-400", children: "Control" })
            ] })
          ] }),
          /* @__PURE__ */ jsx(
            "button",
                ...
                "button",
                {
                  ...
                  children: [
                    ...
                    !sidebarCollapsed && /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex-1 min-w-0", children: [
                      ...
                      /* @__PURE__ */ jsx("p", { className: `text-3xs leading-tight ${isActive ? "text-brand-200" : "text-ink-muted"} line-clamp-1`, children: tt(section.description) })
                    ] }),
                    !sidebarCollapsed && /* @__PURE__ */ jsx(ChevronRight, { size: 14, className: `relative z-10 transition-all duration-normal shrink-0 ${isActive ? "text-white" : "text-ink-secondary opacity-0 group-hover:opacity-100"}` })
                  ]
                },
                section.id
              );
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col h-full relative z-10", children: [
          /* @__PURE__ */ jsx("div", { className: "p-10 border-b border-line shrink-0 bg-white/80 dark:bg-app backdrop-blur-xl", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-base text-ink-muted font-medium", children: tt(SETTINGS_SECTIONS.find((s) => s.id === activeSection)?.description || "") })
            ] }),
            /* @__PURE__ */ jsxs(
              "button",
              {
