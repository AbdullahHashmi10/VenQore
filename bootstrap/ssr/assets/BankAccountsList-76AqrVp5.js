    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full bg-app p-2 gap-1 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-1 shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1.5 bg-brand-100 dark:bg-brand-900/30 text-brand-600 dark:text-brand-400 rounded-lg", children: /* @__PURE__ */ jsx(Landmark, { size: 16 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Total Balance" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-ink", children: formatCurrency(stats.total_balance) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Cash on Hand" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-emerald-600", children: formatCurrency(stats.cash_balance) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Money In (Today)" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-blue-600", children: formatCurrency(stats.today_in) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Money Out (Today)" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-rose-600", children: formatCurrency(stats.today_out) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2 bg-surface px-3 py-2 rounded-xl border border-line shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxs("h1", { className: "text-lg font-bold text-ink uppercase tracking-tight shrink-0", children: [
            "Bank ",
            /* @__PURE__ */ jsx("span", { className: "text-brand-600", children: "Accounts" })
          ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-auto rounded-xl border border-line shadow-sm bg-surface", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-app border-b border-line sticky top-0 z-10", children: [
          /* @__PURE__ */ jsx("th", { className: "p-4 text-xs font-bold text-ink-muted uppercase tracking-wider w-[35%]", children: "Account Details" }),
          /* @__PURE__ */ jsx("th", { className: "p-4 text-xs font-bold text-ink-muted uppercase tracking-wider w-[20%]", children: "Number" }),
          /* @__PURE__ */ jsx("th", { className: "p-4 text-xs font-bold text-ink-muted uppercase tracking-wider w-[15%]", children: "Type" }),
          /* @__PURE__ */ jsx("th", { className: "p-4 text-xs font-bold text-ink-muted uppercase tracking-wider w-[20%] text-right", children: "Balance" }),
          /* @__PURE__ */ jsx("th", { className: "p-4 text-xs font-bold text-ink-muted uppercase tracking-wider w-[10%] text-right", children: "Actions" })
        ] }) }),
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: filteredAccounts.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 5, className: "p-12 text-center text-ink-muted", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center", children: [
          ...
          "tr",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsx("div", { className: `w-10 h-10 rounded-xl flex items-center justify-center text-white shadow-sm ${account.account_type === "cash" ? "bg-emerald-500" : "bg-brand-500"}`, children: account.account_type === "cash" ? /* @__PURE__ */ jsx(Wallet, { size: 18 }) : /* @__PURE__ */ jsx(Landmark, { size: 18 }) }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "font-bold text-ink text-sm", children: account.name }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: account.bank_name || "Cash Account" })
                ] })
              ] }) }),
              /* @__PURE__ */ jsx("td", { className: "p-4 font-mono text-sm text-ink-secondary hidden sm:table-cell", children: account.account_number ? `****${account.account_number.slice(-4)}` : "-" }),
              /* @__PURE__ */ jsx("td", { className: "p-4", children: /* @__PURE__ */ jsx("span", { className: `px-2 py-1 rounded-md text-2xs font-bold uppercase tracking-wide ${account.account_type === "cash" ? "bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400" : account.account_type === "savings" ? "bg-brand-100 text-brand-700 dark:bg-brand-500/20 dark:text-brand-400" : account.account_type === "credit" ? "bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-400" : "bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-400"}`, children: account.account_type }) }),
              /* @__PURE__ */ jsx("td", { className: "p-4 text-right", children: /* @__PURE__ */ jsx("p", { className: `text-sm font-bold ${parseFloat(account.current_balance) < 0 ? "text-red-500" : "text-ink"}`, children: formatCurrency(account.current_balance) }) }),
              /* @__PURE__ */ jsx("td", { className: "p-4 text-right", children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                ...
                activeActionMenu === account.id && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-full mt-2 w-48 bg-surface rounded-[14px] shadow-xl border border-line p-1 z-50 animate-in zoom-in-95", onClick: (e) => e.stopPropagation(), children: [
                  /* @__PURE__ */ jsxs(
                    "button",
                    {
                      onClick: () => {
