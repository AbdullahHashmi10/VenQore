        ...
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-5 space-y-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl p-5", children: [
          ...
          data.type === "whatsapp" ? (
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-[#efeae2] dark:bg-void-800 rounded-xl p-4 min-h-[220px] flex flex-col justify-between border border-emerald-100 dark:border-emerald-950/30", children: [
              /* @__PURE__ */ jsx("div", { className: "space-y-2", children: /* @__PURE__ */ jsxs("div", { className: "inline-block bg-white dark:bg-gray-800 text-slate-800 dark:text-slate-200 rounded-2xl rounded-tl-none p-3.5 text-sm shadow-sm max-w-[85%] whitespace-pre-wrap leading-relaxed relative", children: [
                getMessagePreview(),
                /* @__PURE__ */ jsx("span", { className: "block text-2xs text-slate-400 text-right mt-1.5", children: (/* @__PURE__ */ new Date()).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) })
              ] }) }),
