...
import { F as FeatureLockBadge } from "./marketing-pages-DYgr6x02.js";
        ...
        return /* @__PURE__ */ jsx(FeatureLockBadge, { isLocked: tab.locked, showBadge: false, children: tab.locked ? /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              tab.label,
              /* @__PURE__ */ jsx("span", { className: "text-3xs px-1 rounded bg-slate-200 dark:bg-slate-800 text-slate-500 ml-1", children: "LOCK" })
            ]
          }
        ) : /* @__PURE__ */ jsxs(
          Link,
