  ...
  const columns = [
    {
      ...
      render: (row) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 py-1", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-[10px] font-mono text-slate-500", children: [
            "Batch: ",
            row.batch || "N/A"
          ] })
        ] })
    ...
    },
    {
      ...
      render: (row) => {
        ...
        return /* @__PURE__ */ jsx("span", { className: `px-2.5 py-1 rounded-full text-[10px] font-bold border ${status.class} uppercase tracking-wide`, children: status.label });
      }
    },
    {
      key: "quantity",
