...
const GlobalStyles = () => /* @__PURE__ */ jsx("style", { children: `
    ...
    ` });
const Background = ({ isWarping }) => /* @__PURE__ */ jsxs("div", { className: `fixed inset-0 overflow-hidden bg-zinc-950 z-0 transition-all duration-1000 ${isWarping ? "warp-active" : ""}`, children: [
...
KEEP THIS FILE SECURE. DELETE AFTER USE.
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen w-full flex items-center justify-center font-sans text-slate-200 selection:bg-indigo-500/30 overflow-hidden relative", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: `fixed inset-y-0 right-0 w-96 bg-zinc-950/95 backdrop-blur-xl border-l border-white/10 shadow-2xl z-40 transform transition-transform duration-300 ease-out p-8 ${showHelp ? "translate-x-0" : "translate-x-full"}`, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "relative z-10 w-full max-w-4xl px-6", children: /* @__PURE__ */ jsxs("div", { className: "glass-panel rounded-xl relative overflow-hidden transition-all duration-500 min-h-[650px] flex flex-col border-t border-white/10", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "h-16 border-b border-white/5 flex items-center justify-between px-8 bg-black/20 relative", children: [
        ...
        step > 1 && step < 6 && /* @__PURE__ */ jsx("div", { className: "text-2xs font-mono text-slate-500 uppercase tracking-widest bg-white/5 px-3 py-1 rounded", children: step === 2 ? "License Check" : step === 3 ? "Config Protocol" : step === 4 ? "Deploy Sequence" : "Admin Init" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "p-8 md:p-12 flex-1 relative flex flex-col", children: [
        step < 6 && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-10 px-2 relative z-10", children: [
          ...
          [1, 2, 3, 4, 5, 6].map((num) => {
            ...
            return /* @__PURE__ */ jsx("div", { className: "relative flex flex-col items-center gap-2", children: /* @__PURE__ */ jsx("div", { className: `w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold border transition-all duration-500 ${isActive ? "bg-indigo-600 border-indigo-500 text-white shadow-[0_0_15px_rgba(99,102,241,0.5)]" : "bg-void-800 border-slate-700 text-slate-500"}`, children: isActive ? /* @__PURE__ */ jsx(Check, { size: 14 }) : num }) }, num);
          })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col justify-center", children: [
          step === 1 && /* @__PURE__ */ jsxs("div", { className: "animate-in fade-in slide-in-from-bottom-4 duration-500", children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-6 relative group", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative bg-zinc-950/90 border border-indigo-500/30 rounded-lg p-5 overflow-hidden", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "text-2xs font-mono text-slate-500", children: scanned ? "SCAN_COMPLETE" : "ANALYZING..." })
                ] }),
                ...
                children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: "text-2xs text-slate-500", children: req.value })
                    ] })
                  ] }),
            ...
            selectedFailedCheck && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4", onClick: () => setSelectedFailedCheck(null), children: /* @__PURE__ */ jsxs("div", { className: "bg-zinc-950 border border-indigo-500/30 rounded-xl p-6 max-w-2xl w-full animate-in zoom-in-95 max-h-[90vh] overflow-hidden flex flex-col", onClick: (e) => e.stopPropagation(), children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          step === 2 && /* @__PURE__ */ jsxs("div", { className: "animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-xl mx-auto w-full", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              /* @__PURE__ */ jsxs("div", { className: "tech-input-group", children: [
                /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase tracking-wider text-slate-500 font-bold mb-2 block", children: "License Key / Purchase Code" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsx("div", { className: "text-center", children: /* @__PURE__ */ jsx("a", { href: "#", className: "text-2xs text-slate-500 hover:text-white transition-colors", children: "Where do I find my purchase code?" }) })
            ] })
          ] }),
          step === 3 && /* @__PURE__ */ jsxs("div", { className: "animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-2xl mx-auto w-full", children: [
            dbRecommendations.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mb-6 p-4 bg-indigo-500/5 border border-indigo-500/20 rounded-lg", children: [
              /* @__PURE__ */ jsxs("div", { className: "text-2xs uppercase tracking-wider text-indigo-400 font-bold mb-3 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4 mb-6", children: [
              /* @__PURE__ */ jsxs("div", { className: "tech-input-group", children: [
                /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase tracking-wider text-slate-500 font-bold mb-2 block", children: "Host" }),
                /* @__PURE__ */ jsx("input", { type: "text", value: dbConfig.host, onChange: (e) => {
                  setDbConfig({ ...dbConfig, host: e.target.value });
                  setDbStatus("idle");
                  setDbError(null);
                }, placeholder: "127.0.0.1 or localhost", className: "w-full bg-zinc-950 border border-slate-700 rounded p-3 text-sm text-white font-mono outline-none focus:border-indigo-500" }),
                /* @__PURE__ */ jsx("div", { className: "text-3xs text-slate-600 mt-1", children: "Usually 127.0.0.1 or localhost" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "tech-input-group", children: [
                /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase tracking-wider text-slate-500 font-bold mb-2 block", children: "Port" }),
                /* @__PURE__ */ jsx("input", { type: "text", value: dbConfig.port, onChange: (e) => {
                  setDbConfig({ ...dbConfig, port: e.target.value });
                  setDbStatus("idle");
                  setDbError(null);
                }, placeholder: "3306", className: "w-full bg-zinc-950 border border-slate-700 rounded p-3 text-sm text-white font-mono outline-none focus:border-indigo-500" }),
                /* @__PURE__ */ jsx("div", { className: "text-3xs text-slate-600 mt-1", children: "Default MySQL port is 3306" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "col-span-2 tech-input-group", children: [
                /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase tracking-wider text-slate-500 font-bold mb-2 block", children: "Database Name" }),
                /* @__PURE__ */ jsx("input", { type: "text", value: dbConfig.name, onChange: (e) => {
                  setDbConfig({ ...dbConfig, name: e.target.value });
                  setDbStatus("idle");
                  setDbError(null);
                }, placeholder: "venqore", className: `w-full bg-zinc-950 border rounded p-3 text-sm text-white font-mono outline-none transition-colors ${dbError ? "border-rose-500" : "border-slate-700 focus:border-indigo-500"}` }),
                /* @__PURE__ */ jsx("div", { className: "text-3xs text-slate-600 mt-1", children: "On shared hosting: usually prefixed like username_dbname" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "tech-input-group", children: [
                /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase tracking-wider text-slate-500 font-bold mb-2 block", children: "Username" }),
                /* @__PURE__ */ jsx("input", { type: "text", value: dbConfig.user, onChange: (e) => {
                  setDbConfig({ ...dbConfig, user: e.target.value });
                  setDbStatus("idle");
                  setDbError(null);
                }, placeholder: "root", className: "w-full bg-zinc-950 border border-slate-700 rounded p-3 text-sm text-white font-mono outline-none focus:border-indigo-500" }),
                /* @__PURE__ */ jsx("div", { className: "text-3xs text-slate-600 mt-1", children: "Same prefix as database name" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "tech-input-group", children: [
                /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase tracking-wider text-slate-500 font-bold mb-2 block", children: "Password" }),
                /* @__PURE__ */ jsx("input", { type: "password", placeholder: "••••••••", onChange: (e) => {
                  setDbConfig({ ...dbConfig, pass: e.target.value });
                  setDbStatus("idle");
                  setDbError(null);
                }, className: "w-full bg-zinc-950 border border-slate-700 rounded p-3 text-sm text-white font-mono outline-none focus:border-indigo-500" })
              ] })
            ] }),
            dbError && /* @__PURE__ */ jsx("div", { className: "mb-6 p-4 bg-rose-500/10 border border-rose-500/20 rounded-lg animate-in slide-in-from-top-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "text-2xs text-slate-500", children: [
          ...
          step === 4 && /* @__PURE__ */ jsx("div", { className: "animate-in fade-in zoom-in-95 duration-500 relative z-20", children: !loading && logs.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "space-y-8 max-w-2xl mx-auto", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("p", { className: "text-2xs text-slate-400 leading-relaxed", children: backupFile ? `Selected: ${backupFile.name}` : "Restore from VenQore (.sql) or Vyapar Backup (.vyb). Unlimited (2GB+)" }),
                    ...
                    isAnalyzing && /* @__PURE__ */ jsxs("p", { className: "text-3xs text-indigo-400 mt-1 text-right", children: [
                      uploadProgress,
                      "% Uploaded"
                    ] }),
              ...
              /* @__PURE__ */ jsxs("div", { onClick: () => setInstallOptions({ ...installOptions, clean: !installOptions.clean }), className: `cursor-pointer p-6 rounded-lg border transition-all duration-300 relative group overflow-hidden ${installOptions.clean ? "bg-rose-600/10 border-rose-500/50" : "bg-slate-900/40 border-slate-700 hover:border-slate-500"}`, children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-2xs text-slate-400 leading-relaxed", children: "Wipe existing data and start zero (Recommended)." }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "mb-6 text-center animate-in fade-in slide-in-from-top-4 duration-700 min-h-[60px]", children: [
              /* @__PURE__ */ jsx("div", { className: "text-2xs uppercase tracking-widest text-indigo-400 font-bold mb-2", children: "Pro Tip" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxs("div", { className: "relative w-10 h-10 flex items-center justify-center", children: [
                  /* @__PURE__ */ jsxs("svg", { className: "w-full h-full -rotate-90", children: [
                    ...
                    /* @__PURE__ */ jsx("circle", { cx: "20", cy: "20", r: "18", stroke: installError ? vq.rose[500] : vq.indigo[500], strokeWidth: "3", fill: "none", strokeDasharray: "113", strokeDashoffset: 113 - 113 * installProgress / 100, className: "transition-all duration-300 ease-out" })
                  ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-zinc-950/80 backdrop-blur rounded-lg border border-slate-800 relative overflow-hidden font-mono text-xs", children: [
              /* @__PURE__ */ jsxs("div", { className: "h-8 bg-zinc-900 flex items-center px-4 border-b border-slate-800 justify-between", children: [
          ...
          step === 5 && /* @__PURE__ */ jsxs("div", { className: "animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-xl mx-auto w-full", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "tech-input-group", children: [
                /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase tracking-wider text-slate-500 font-bold mb-2 block", children: "Full Name" }),
                /* @__PURE__ */ jsx("input", { type: "text", placeholder: "Abdullah Hashmi", value: admin.name, onChange: (e) => setAdmin({ ...admin, name: e.target.value }), className: "w-full bg-zinc-950 border border-slate-700 rounded p-3 text-sm text-white font-mono outline-none focus:border-indigo-500" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "tech-input-group", children: [
                /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase tracking-wider text-slate-500 font-bold mb-2 block", children: "Email Address" }),
                /* @__PURE__ */ jsx("input", { type: "email", placeholder: "admin@venqore.com", value: admin.email, onChange: (e) => setAdmin({ ...admin, email: e.target.value }), className: "w-full bg-zinc-950 border border-slate-700 rounded p-3 text-sm text-white font-mono outline-none focus:border-indigo-500" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "tech-input-group", children: [
                /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase tracking-wider text-slate-500 font-bold mb-2 block", children: "Secure Password" }),
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsx("input", { type: admin.showPass ? "text" : "password", value: admin.password, onChange: (e) => setAdmin({ ...admin, password: e.target.value }), className: "w-full bg-zinc-950 border border-slate-700 rounded p-3 text-sm text-white font-mono outline-none focus:border-indigo-500 pr-10" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "tech-input-group", children: [
                /* @__PURE__ */ jsx("label", { className: "text-2xs uppercase tracking-wider text-slate-500 font-bold mb-2 block", children: "Quick PIN / Passcode (Optional)" }),
                /* @__PURE__ */ jsx("div", { className: "relative", children: /* @__PURE__ */ jsx("input", { type: admin.showPass ? "text" : "password", maxLength: 6, placeholder: "1234", value: admin.passcode, onChange: (e) => setAdmin({ ...admin, passcode: e.target.value }), className: "w-full bg-zinc-950 border border-slate-700 rounded p-3 text-sm text-white font-mono outline-none focus:border-indigo-500" }) })
              ] })
            ] }),
          ...
          step === 6 && /* @__PURE__ */ jsxs("div", { className: "text-center animate-in zoom-in-95 duration-700 flex flex-col items-center justify-center h-full", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative mb-8 group cursor-pointer", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative w-28 h-28 bg-zinc-950 border border-emerald-500/30 rounded-full flex items-center justify-center shadow-2xl group-hover:scale-105 transition-transform duration-500", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-px bg-slate-800/50 border border-slate-700/50 rounded-lg overflow-hidden mb-8 max-w-md w-full", children: [
              /* @__PURE__ */ jsxs("div", { className: "bg-zinc-950 p-4 flex flex-col gap-1", children: [
                /* @__PURE__ */ jsx("span", { className: "text-2xs text-slate-500 uppercase tracking-wider font-bold", children: "Time" }),
                /* @__PURE__ */ jsx("span", { className: "text-emerald-400 font-mono text-sm", children: "4.2s" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-zinc-950 p-4 flex flex-col gap-1", children: [
                /* @__PURE__ */ jsx("span", { className: "text-2xs text-slate-500 uppercase tracking-wider font-bold", children: "Memory" }),
                /* @__PURE__ */ jsx("span", { className: "text-indigo-400 font-mono text-sm", children: "12MB" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-zinc-950 p-4 flex flex-col gap-1", children: [
                /* @__PURE__ */ jsx("span", { className: "text-2xs text-slate-500 uppercase tracking-wider font-bold", children: "Status" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "absolute bottom-0 left-0 w-full h-10 border-t border-white/5 bg-black/40 flex items-center justify-between px-8 text-2xs font-mono text-slate-500 uppercase tracking-wider backdrop-blur-sm", children: [
