...
import { T as Toggle$1 } from "./Toggle-DaKypUcO.js";
...
const Label = ({ children }) => /* @__PURE__ */ jsx("div", { className: "text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wide mb-1.5", children });
...
const LogoUploader = ({ data, setData }) => /* @__PURE__ */ jsxs("div", { className: "mt-3 p-3 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700", children: [
  ...
  /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mt-2", children: [
    data.print_logo_path ? /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
      ...
      /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold", children: "No Logo" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 mt-2 leading-tight", children: "Recommended: PNG with transparent background. Max 2MB." })
    ] })
  ] })
] });
  ...
  return /* @__PURE__ */ jsx("div", { className: "animate-in fade-in slide-in-from-bottom-2 duration-300", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "col-span-12 xl:col-span-8 p-6 bg-white dark:bg-slate-800/50 rounded-[2rem] border border-slate-100 dark:border-slate-700 shadow-sm", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 group/input", children: [
          /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-400 ml-1", children: "Business Name" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 group/input", children: [
          /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-400 ml-1", children: "Tax / NTN" }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 group/input", children: [
          /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-400 ml-1", children: "Official Email" }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 group/input", children: [
          /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-400 ml-1", children: "Phone Line" }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-400", children: "Currency" }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxs(
                "select",
                {
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-400", children: "Currency Symbol" }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-400", children: "Timezone" }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxs(
                "select",
                {
            ...
            /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 mt-2", children: "Determines date rollovers for reports." })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "col-span-12 p-6 bg-white dark:bg-slate-800/50 rounded-[2rem] border border-slate-100 dark:border-slate-700 shadow-sm relative group hover:border-indigo-500/30 transition-all", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-2", children: [
        /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-400", children: "Head Office Address" }),
        /* @__PURE__ */ jsx(
          "textarea",
          {
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: `overflow-hidden transition-all duration-300 ${data.enable_passcode === "1" || data.enable_passcode === true ? "max-h-40 opacity-100" : "max-h-0 opacity-0"}`, children: /* @__PURE__ */ jsxs("div", { className: "p-6 bg-red-50 dark:bg-red-900/10 rounded-[2rem] border border-red-100 dark:border-red-900/30 ml-4 border-l-[6px] border-l-red-500", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-[10px] text-red-600 dark:text-red-400 mt-2 font-medium", children: "Used for refunds, voids, and settings." })
        ] }) }),
        /* @__PURE__ */ jsx(
          SettingToggle,
          {
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "p-8 bg-white dark:bg-slate-800/50 rounded-[2rem] border border-slate-100 dark:border-slate-700 h-full", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-[10px] font-bold text-slate-400 uppercase tracking-widest px-1", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            data.ai_provider === "gemini" && /* @__PURE__ */ jsx("div", { className: "absolute top-5 right-5 bg-indigo-600 text-white text-[10px] font-black px-2 py-1 rounded-full uppercase tracking-widest shadow-lg shadow-indigo-500/30", children: "Active" }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "inline-block mt-1 text-[10px] font-black text-emerald-600 bg-emerald-100 dark:bg-emerald-500/20 px-2 py-0.5 rounded uppercase tracking-wider", children: "Free Tier Available" })
              ] })
            ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: `space-y-4 transition-all duration-300 ${data.ai_provider === "gemini" ? "opacity-100" : "opacity-50 pointer-events-none blur-[1px]"}`, children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "bg-white/80 dark:bg-slate-900/50 p-4 rounded-xl border border-indigo-100 dark:border-indigo-500/10", children: [
                /* @__PURE__ */ jsxs("p", { className: "text-xs font-bold text-indigo-900 dark:text-indigo-300 mb-2 flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsx("span", { className: "w-4 h-4 rounded-full bg-indigo-100 dark:bg-indigo-500/20 flex items-center justify-center text-[10px]", children: "?" }),
                  "How to get Free Key:"
                ] }),
                /* @__PURE__ */ jsxs("ol", { className: "text-[10px] text-slate-600 dark:text-slate-400 space-y-1.5 list-decimal ml-3 marker:font-bold marker:text-indigo-500", children: [
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            data.ai_provider === "openai" && /* @__PURE__ */ jsx("div", { className: "absolute top-5 right-5 bg-emerald-600 text-white text-[10px] font-black px-2 py-1 rounded-full uppercase tracking-widest shadow-lg shadow-emerald-500/30", children: "Active" }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "inline-block mt-1 text-[10px] font-black text-amber-600 bg-amber-100 dark:bg-amber-500/20 px-2 py-0.5 rounded uppercase tracking-wider", children: "Paid Subscription" })
              ] })
            ] }),
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsx("label", { className: "text-[10px] uppercase font-black tracking-widest text-slate-400", children: "Tax Name" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-1", children: [
                  /* @__PURE__ */ jsx("label", { className: "text-[10px] uppercase font-black tracking-widest text-slate-400", children: "Rate" }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-1", children: [
                  /* @__PURE__ */ jsx("label", { className: "text-[10px] uppercase font-black tracking-widest text-slate-400", children: "Type" }),
                  /* @__PURE__ */ jsxs(
                    "select",
                    {
                      value: tax.type,
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 shadow-xl", children: [
            ...
            data.fbr_integration && /* @__PURE__ */ jsx("div", { className: "mt-8 pt-8 border-t border-slate-100 dark:border-slate-700 space-y-4 animate-in slide-in-from-top-4 duration-300", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsx("label", { className: "text-[10px] font-black uppercase tracking-[0.15em] text-slate-400", children: "FBR POS ID" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsx("label", { className: "text-[10px] font-black uppercase tracking-[0.15em] text-slate-400", children: "FBR USIN" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsx("div", { className: "p-8 bg-white dark:bg-slate-800 border-2 rounded-[2.5rem] opacity-60", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-5 mb-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "px-1.5 py-0.5 bg-amber-100 dark:bg-amber-500/20 text-amber-600 dark:text-amber-400 text-[8px] font-black uppercase tracking-wider rounded border border-amber-200 dark:border-amber-500/30", children: "Upcoming" })
              ] }),
                ...
                /* @__PURE__ */ jsx("div", { className: "grid grid-cols-6 gap-1 max-w-sm w-full", children: [
                  ...
                  return /* @__PURE__ */ jsx(
                    "button",
                    {
                      ...
                      className: `py-2 px-1 text-center font-bold text-[11px] rounded-lg border transition-all ${isActive ? "border-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300" : "border-transparent bg-slate-100 dark:bg-slate-700/50 text-slate-500 hover:bg-slate-200/50"}`,
                      children: opt.label
                    },
                    opt.value
                  );
        ...
        return /* @__PURE__ */ jsxs("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-6 bg-slate-50 dark:bg-slate-700/30 rounded-3xl border border-slate-100 dark:border-slate-700 relative overflow-hidden group", children: [
              /* @__PURE__ */ jsx("div", { className: "absolute top-3 right-3", children: /* @__PURE__ */ jsx("span", { className: "px-2 py-1 bg-amber-100 dark:bg-amber-500/20 text-amber-600 dark:text-amber-400 text-[10px] font-black uppercase tracking-widest rounded border border-amber-200 dark:border-amber-500/30 shadow-sm", children: "Upcoming" }) }),
          ...
          /* @__PURE__ */ jsx("div", { className: "flex-1 divide-y divide-slate-100 dark:divide-slate-700", children: data.service_reminders.length > 0 ? data.service_reminders.map((reminder, idx) => /* @__PURE__ */ jsxs("div", { className: "p-4 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors group", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 flex-1", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex-1 max-w-xs", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-500 uppercase font-black tracking-widest mt-0.5", children: "Recurring Service" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 bg-slate-100 dark:bg-slate-900 px-3 py-1.5 rounded-xl", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-slate-400 uppercase tracking-tighter", children: "Every" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "number",
        ...
        /* @__PURE__ */ jsxs("div", { className: `${sidebarCollapsed ? "px-2 py-4 justify-center" : "px-4 py-5 justify-between"} flex items-center border-b border-slate-800/50 mb-3 relative z-50`, children: [
          !sidebarCollapsed && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-[9px] font-bold uppercase tracking-[0.2em] text-indigo-400", children: "Control" })
            ] })
          ] }),
          /* @__PURE__ */ jsx(
            "button",
                ...
                "button",
                {
                  ...
                  children: [
                    ...
                    !sidebarCollapsed && /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex-1 min-w-0", children: [
                      ...
                      /* @__PURE__ */ jsx("p", { className: `text-[9px] leading-tight ${isActive ? "text-indigo-200" : "text-slate-500"} line-clamp-1`, children: section.description })
                    ] }),
          ...
          /* @__PURE__ */ jsx("div", { className: "p-10 border-b border-slate-100 dark:border-slate-800 shrink-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
                /* @__PURE__ */ jsx("span", { className: "px-3 py-1 bg-indigo-100 dark:bg-indigo-500/20 text-indigo-600 dark:text-indigo-400 text-[10px] font-black uppercase tracking-[0.2em] rounded-full", children: "Section" }),
