...
import { p as preloadLemonCheckout, o as openLemonCheckout, c as closeLemonCheckout } from "./AiIsland-DlkwqCwv.js";
import { v as vq } from "./runtime-DwSFgQZq.js";
import { n as normalizePlan, c as PLAN_PRICE_USD, p as planRank, S as SELF_SERVE_PLANS } from "./plans-CxabWI_P.js";
import { Sparkles, Monitor, Crown, Zap, Shield, ArrowRight, AlertTriangle, Download, CreditCard, RefreshCw, Receipt, History, Lock, Calendar, BarChart2, Users, Package, GitBranch, BadgeCheck, Clock, Info, FileText, CheckCircle2, Cpu, Loader2, Globe2, XCircle, MessageSquare, Infinity } from "lucide-react";
import "react-dom";
...
function formatLimit(val) {
  ...
  if (val === false) return /* @__PURE__ */ jsx(XCircle, { size: 14, color: vq.red[500], style: { display: "inline", verticalAlign: "middle" } });
  if (val === true) return /* @__PURE__ */ jsx(CheckCircle2, { size: 14, color: vq.emerald[500], style: { display: "inline", verticalAlign: "middle" } });
...
function UsageMeter({ icon: Icon, label, used, limit, color }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-neutral-950/40 border border-white/[0.06] rounded-2xl p-5 shadow-inner", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-neutral-300", children: label })
      ] }),
      isCritical && /* @__PURE__ */ jsx(AlertTriangle, { size: 14, className: "text-red-500" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: `text-2xl font-bold mb-1 ${isCritical ? "text-red-500" : "text-white"}`, children: isUnlimited ? /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5", children: [
      used,
      " ",
      /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted font-medium", children: "/ ∞" })
    ] }) : /* @__PURE__ */ jsxs("span", { children: [
      used,
      " ",
      /* @__PURE__ */ jsxs("span", { className: "text-sm font-medium text-ink-muted", children: [
        "/ ",
        limit
      ] })
    ] }) }),
    isUnlimited ? /* @__PURE__ */ jsx("div", { className: "text-2xs text-emerald-400 font-bold uppercase tracking-wider", children: "Unlimited" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("div", { className: "h-1.5 bg-white/[0.04] rounded-full overflow-hidden mb-1.5 mt-2", children: /* @__PURE__ */ jsx("div", { style: { width: `${pct}%`, backgroundColor: barColor }, className: "h-full rounded-full transition-all duration-slower" }) }),
      /* @__PURE__ */ jsxs("div", { className: `text-2xs font-bold ${isCritical ? "text-red-500" : "text-ink-muted"} uppercase tracking-wider`, children: [
        pct,
        "% used"
      ] })
    ] })
...
function PlanCard({ planKey, planConfig, isCurrent, storeSlug, tenant, onSelectPlan, onCheckout, checkoutBusy = null, plans, billingCycle = "monthly", currencyDisplay = "USD" }) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: `relative p-6 rounded-2xl border transition-all duration-slow ${isCurrent ? "bg-brand-950/10 border-brand-500/35 shadow-[0_0_30px_rgba(168,85,247,0.06)]" : "bg-white/[0.02] border-white/[0.05] hover:bg-white/[0.035] hover:border-white/10"}`,
      children: [
        ...
        savingsNote && /* @__PURE__ */ jsx("div", { className: "absolute -top-3 right-6 px-3 py-1 rounded-full text-2xs font-bold tracking-widest text-white bg-emerald-600", children: savingsNote }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "text-sm font-bold mt-1", style: { color: meta.color }, children: [
              displayMonthly,
              displayAnnualNote && /* @__PURE__ */ jsx("span", { className: "text-2xs text-ink-muted font-semibold block mt-0.5", children: displayAnnualNote }),
              pkrEstimate && /* @__PURE__ */ jsx("span", { className: "text-2xs text-emerald-400 font-semibold block mt-0.5", children: pkrEstimate })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "space-y-3 mb-8", children: FEATURES.map((f) => {
          ...
          return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-xs", children: [
            enabled ? /* @__PURE__ */ jsx(CheckCircle2, { size: 14, className: "text-emerald-400 shrink-0" }) : /* @__PURE__ */ jsx(XCircle, { size: 14, className: "text-ink-secondary shrink-0" }),
            /* @__PURE__ */ jsxs("span", { className: `font-medium ${enabled ? "text-neutral-300" : "text-ink-muted line-through opacity-50"}`, children: [
              tt(f.label),
        ...
        ) : /* @__PURE__ */ jsxs("div", { className: "text-center py-3 text-xs font-bold text-brand-400 uppercase tracking-widest bg-brand-500/5 border border-brand-500/10 rounded-2xl flex items-center justify-center gap-2", children: [
          /* @__PURE__ */ jsx(CheckCircle2, { size: 14 }),
          " Active Plan"
        ] }) : isLtd ? /* @__PURE__ */ jsx("div", { className: "text-center py-3 text-xs font-bold text-ink-muted uppercase tracking-widest bg-white/5 rounded-2xl", children: "Lifetime Supporter" }) : /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: () => onSelectPlan(planKey),
            className: `w-full py-3 rounded-2xl font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-2 transition-transform active:scale-95 ${thisIdx > currentIdx ? "bg-white text-void-950 hover:bg-interactive-hover" : "border border-neutral-700 hover:border-line-strong text-neutral-300 hover:bg-interactive-hover"}`,
            children: [
...
function BillingIndex({ tenant, plans, usage, feature_status, country, pk_verification, trial_credit = null, intended_plan = null, current_plan = null }) {
  const tt = useTermText();
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Billing & Subscription", mode: "admin", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto p-4 md:p-8", children: [
      intended_plan && isTrial && !isViewOnly && intended_plan.price_monthly > 0 && /* @__PURE__ */ jsxs("div", { className: "mb-8 flex flex-col gap-4 rounded-xl border border-accent bg-accent-quiet p-5 sm:flex-row sm:items-center sm:justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "text-sm font-semibold text-ink", children: [
            "You picked ",
            intended_plan.name,
            " when you signed up"
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-1 text-xs text-ink-secondary", children: [
            "$",
            intended_plan.price_monthly,
            "/mo after your trial. Activate it now or pick a different plan below — your free days carry over."
          ] })
        ] }),
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: checkoutBusy === intended_plan.key ? "Opening secure checkout…" : /* @__PURE__ */ jsxs(Fragment, { children: [
              "Activate ",
              intended_plan.name,
              " ",
      ...
      isViewOnly && /* @__PURE__ */ jsxs("div", { className: "mb-8 p-6 rounded-xl bg-gradient-to-r from-red-900/80 via-red-950 to-black border border-red-500/30 shadow-2xl relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex flex-col md:flex-row items-center justify-between gap-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-xl font-bold text-white leading-none mb-2", children: "View-Only Mode Active" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: `mb-8 p-6 md:p-8 rounded-2xl border flex flex-col md:flex-row justify-between items-center gap-6 shadow-2xl relative overflow-hidden bg-gradient-to-b from-white/[0.03] to-void-950 border-white/[0.06]`, children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-5 relative z-10", children: [
          /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-lg flex items-center justify-center shadow-lg", style: { background: currentMeta.color + "15" }, children: /* @__PURE__ */ jsx(currentMeta.Icon, { size: 32, color: currentMeta.color }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-2xs font-bold text-ink-muted uppercase tracking-[0.2em] mb-1", children: "Active Plan" }),
            /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-white", children: currentMeta.label }),
            /* @__PURE__ */ jsx("div", { className: "text-xs font-bold text-ink-muted mt-1", children: isViewOnly ? `Locked in View-Only (${viewOnlyDaysLeft} days until deletion)` : tenant?.status === "suspended" ? "Trial Expired / Suspended" : isTrial ? trialDaysLeft !== null ? `Free trial — ${trialDaysLeft} ${trialDaysLeft === 1 ? "day" : "days"} left. No payment taken yet.` : "Free trial — no payment taken yet." : isLtd ? "Lifetime License" : subEndsAt ? `Renews on ${subEndsAt}` : "Active Subscription" }),
            isTrial && !isViewOnly && trialDaysLeft !== null && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-1.5 flex-wrap", children: [
              /* @__PURE__ */ jsxs("span", { className: `text-1xs font-bold uppercase tracking-wider px-2 py-0.5 rounded-md ${trialDaysLeft <= 3 ? "bg-red-500/10 text-red-400" : trialDaysLeft <= 7 ? "bg-amber-500/10 text-amber-400" : "bg-brand-500/10 text-brand-300"}`, children: [
                "Trial · ",
                trialDaysLeft,
                " ",
            ...
            !isTrial && !isLtd && !isViewOnly && subDaysLeft !== null && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-1.5 flex-wrap", children: [
              /* @__PURE__ */ jsxs("span", { className: `text-1xs font-bold uppercase tracking-wider px-2 py-0.5 rounded-md ${subDaysLeft <= 3 ? "bg-red-500/10 text-red-400" : subDaysLeft <= 7 ? "bg-amber-500/10 text-amber-400" : "bg-emerald-500/10 text-emerald-400"}`, children: [
                subDaysLeft,
                " ",
            ...
            isTrial && !isViewOnly && trialCreditFor(billingCycle) && /* @__PURE__ */ jsxs("div", { className: "text-1xs font-bold text-emerald-400 mt-1.5 flex items-center gap-1.5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center gap-3 relative z-10", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "px-5 py-2 rounded-full font-bold text-xs tracking-widest uppercase border border-brand-500/20 bg-brand-500/10 text-brand-300", children: currentPlanKey })
        ] })
      ] }),
      tenant?.plan_limits?.pending_downgrade && /* @__PURE__ */ jsxs("div", { className: "mb-8 p-5 rounded-2xl bg-amber-500/10 border border-amber-500/25 flex flex-col sm:flex-row items-center justify-between gap-4 animate-fadeIn", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-white uppercase tracking-wider", children: "Scheduled Downgrade Pending" }),
            /* @__PURE__ */ jsxs("p", { className: "text-xs text-neutral-300 mt-1", children: [
 ...
 ${isActive ? "border-brand-500 text-white" : "border-transparent text-ink-muted hover:text-neutral-300"}`,
            children: [
      ...
      activeTab === "subscription" && /* @__PURE__ */ jsxs("div", { className: "space-y-8 animate-fadeIn", children: [
        PKR_ENABLED,
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "text-xs font-bold text-ink-muted uppercase tracking-[0.3em] mb-4 flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "pt-6", children: [
          /* @__PURE__ */ jsx("div", { className: "text-xs font-bold text-ink-muted uppercase tracking-[0.3em] mb-6 text-center", children: isLtd ? "Your Early Supporter Perks" : "🚀 Scale your system as you grow" }),
          isPK,
          /* @__PURE__ */ jsx("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10 mb-8", children: !isLtd && /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-1 p-1 rounded-2xl bg-white/[0.04] border border-white/[0.07]", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `px-5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all ${billingCycle === "monthly" ? "bg-white text-void-950 shadow-md" : "text-ink-muted hover:text-white"}`,
                children: "Monthly"
              }
            ),
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                className: `px-5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 ${billingCycle === "annual" ? "bg-emerald-600 text-white shadow-md" : "text-ink-muted hover:text-white"}`,
                children: [
                  "Annual",
                  /* @__PURE__ */ jsx("span", { className: `text-3xs px-1.5 py-0.5 rounded-full font-bold ${billingCycle === "annual" ? "bg-white/20 text-white" : "bg-emerald-500/20 text-emerald-400"}`, children: "SAVE ~17%" })
                ]
              }
            )
          ] }) }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-8", children: isTrial || isViewOnly ? SELF_SERVE_PLANS.map((key) => /* @__PURE__ */ jsx(
            PlanCard,
            {
              planKey: key,
      ...
      activeTab === "payments" && /* @__PURE__ */ jsxs("div", { className: "space-y-6 animate-fadeIn", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between flex-wrap gap-3", children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-1xs font-bold text-ink-muted uppercase tracking-[0.2em] flex items-center gap-2", children: [
        ...
        history && /* @__PURE__ */ jsxs(Fragment, { children: [
          history.subscription && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-5 rounded-2xl bg-white/[0.02] border border-white/[0.05]", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "text-lg font-bold text-white capitalize", children: history.subscription.status_formatted || history.subscription.status || "—" }),
              history.subscription.is_cancelled && /* @__PURE__ */ jsx("div", { className: "text-1xs font-bold text-amber-400 mt-1", children: "Cancelled — access runs to the date below" }),
              history.subscription.test_mode && /* @__PURE__ */ jsx("div", { className: "text-1xs font-bold text-amber-400 mt-1", children: "Test mode" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "p-5 rounded-2xl bg-white/[0.02] border border-white/[0.05]", children: [
              /* @__PURE__ */ jsxs("div", { className: "text-2xs font-bold text-ink-muted uppercase tracking-wider mb-2 flex items-center gap-1.5", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "text-lg font-bold text-white", children: fmtDay(history.subscription.expires_at) }),
              history.subscription.days_until_expiry !== null && /* @__PURE__ */ jsxs("div", { className: `text-1xs font-bold mt-1 ${history.subscription.days_until_expiry <= 3 ? "text-red-400" : history.subscription.days_until_expiry <= 7 ? "text-amber-400" : "text-emerald-400"}`, children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-5 rounded-2xl bg-white/[0.02] border border-white/[0.05]", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "text-lg font-bold text-white", children: history.subscription.card || "Not on file" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "p-5 rounded-2xl bg-white/[0.02] border border-white/[0.05]", children: [
              /* @__PURE__ */ jsxs("div", { className: "text-2xs font-bold text-ink-muted uppercase tracking-wider mb-2 flex items-center gap-1.5", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "text-lg font-bold text-white", children: history.lifetime_usd || "$0.00" }),
              /* @__PURE__ */ jsxs("div", { className: "text-1xs font-bold text-ink-muted mt-1", children: [
          ...
          lsIsTrialling && history.invoices?.length > 0 && /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-2xl bg-brand-500/5 border border-brand-500/20 text-xs leading-relaxed text-brand-200 flex items-start gap-2", children: [
          ...
          history.message && /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl bg-white/[0.02] border border-white/[0.05] text-center", children: [
            /* @__PURE__ */ jsx(Receipt, { size: 28, className: "mx-auto text-ink-secondary mb-3" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted", children: history.message })
          ] }),
          history.invoices?.length > 0 && /* @__PURE__ */ jsx("div", { className: "rounded-2xl bg-white/[0.02] border border-white/[0.05] overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { className: "border-b border-white/[0.06]", children: ["Paid On", "Period Covered", "Days", "Amount", "Credit Applied", "Status", ""].map((h) => /* @__PURE__ */ jsx("th", { className: "px-5 py-3.5 text-2xs font-bold text-ink-muted uppercase tracking-wider whitespace-nowrap", children: h }, h)) }) }),
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-white/[0.04]", children: history.invoices.map((inv) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-white/[0.02] transition-colors", children: [
              /* @__PURE__ */ jsxs("td", { className: "px-5 py-4 whitespace-nowrap", children: [
                /* @__PURE__ */ jsx("div", { className: "text-xs font-bold text-white", children: fmtDay(inv.paid_at) }),
                /* @__PURE__ */ jsx("div", { className: "text-2xs font-bold text-ink-muted capitalize mt-0.5", children: inv.billing_reason === "initial" ? "First payment" : inv.billing_reason === "renewal" ? "Renewal" : inv.billing_reason === "updated" ? "Plan change" : inv.billing_reason })
              ] }),
              /* @__PURE__ */ jsx("td", { className: "px-5 py-4 whitespace-nowrap text-xs font-bold text-neutral-300", children: inv.period_end ? `${fmtDay(inv.period_start)} → ${fmtDay(inv.period_end)}` : fmtDay(inv.period_start) }),
              /* @__PURE__ */ jsx("td", { className: "px-5 py-4 whitespace-nowrap", children: inv.period_days !== null ? /* @__PURE__ */ jsxs("span", { className: "px-2.5 py-1 rounded-lg bg-brand-500/10 border border-brand-500/20 text-brand-300 text-1xs font-bold", children: [
                inv.period_days,
                " days"
              ] }) : /* @__PURE__ */ jsx("span", { className: "text-1xs font-bold text-ink-secondary", children: "—" }) }),
              /* @__PURE__ */ jsxs("td", { className: "px-5 py-4 whitespace-nowrap", children: [
                /* @__PURE__ */ jsx("div", { className: "text-xs font-bold text-white", children: inv.total }),
                inv.has_discount && /* @__PURE__ */ jsx("div", { className: "text-2xs font-bold text-ink-muted mt-0.5 line-through", children: inv.subtotal })
              ] }),
              /* @__PURE__ */ jsx("td", { className: "px-5 py-4 whitespace-nowrap", children: inv.has_discount ? /* @__PURE__ */ jsxs("span", { className: "px-2.5 py-1 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-1xs font-bold flex items-center gap-1 w-fit", children: [
                /* @__PURE__ */ jsx(Zap, { size: 10, className: "fill-emerald-400" }),
                " −",
                inv.discount_total
              ] }) : /* @__PURE__ */ jsx("span", { className: "text-1xs font-bold text-ink-secondary", children: "—" }) }),
              /* @__PURE__ */ jsx("td", { className: "px-5 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsx("span", { className: `px-2.5 py-1 rounded-lg text-1xs font-bold border ${inv.refunded || inv.status === "refunded" ? "bg-neutral-500/10 border-line-strong text-ink-muted" : inv.status === "paid" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : inv.status === "pending" ? "bg-amber-500/10 border-amber-500/20 text-amber-400" : "bg-red-500/10 border-red-500/20 text-red-400"}`, children: inv.status_formatted || inv.status }) }),
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-2xs font-bold text-ink-secondary text-center", children: [
            "Read live from Lemon Squeezy · updated ",
            history.fetched_at ? new Date(history.fetched_at).toLocaleTimeString() : "—"
          ] })
        ] })
      ] }),
      activeTab === "extra_features" && /* @__PURE__ */ jsx("div", { className: "space-y-6 animate-fadeIn", children: /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-8 rounded-2xl bg-white/[0.02] border border-white/[0.06]", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
          /* @__PURE__ */ jsx(Lock, { className: "text-brand-400", size: 24 }),
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-white", children: "Extra Features Control" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted leading-relaxed mb-8 max-w-xl", children: "If you have configured features that are not included in your current plan, you can deactivate/remove them here to restore normal operations. Alternatively, upgrade your plan to unlock full access." }),
        /* @__PURE__ */ jsx("div", { className: "space-y-4", children: feature_status?.map((feat) => {
          ...
          return /* @__PURE__ */ jsxs(
            "div",
            {
              className: `p-5 rounded-2xl border transition-all duration-slow flex flex-col md:flex-row md:items-center justify-between gap-4 ${feat.is_active && feat.is_locked ? "bg-red-500/[0.02] border-red-500/20 shadow-[0_0_15px_rgba(239,68,68,0.03)]" : feat.is_active ? "bg-emerald-500/[0.02] border-emerald-500/20" : "bg-white/[0.01] border-white/[0.04]"}`,
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-white", children: feat.name }),
                    feat.is_active && feat.is_locked && /* @__PURE__ */ jsxs("span", { className: "px-2.5 py-0.5 rounded-full text-2xs font-bold uppercase tracking-wider bg-red-500/10 text-red-400 border border-red-500/20 flex items-center gap-1", children: [
                      /* @__PURE__ */ jsx(AlertTriangle, { size: 10 }),
                      " Active & Locked (Limits Exceeded)"
                    ] }),
                    feat.is_active && !feat.is_locked && /* @__PURE__ */ jsxs("span", { className: "px-2.5 py-0.5 rounded-full text-2xs font-bold uppercase tracking-wider bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 flex items-center gap-1", children: [
                      /* @__PURE__ */ jsx(CheckCircle2, { size: 10 }),
                      " Active & Subscribed"
                    ] }),
                    !feat.is_active && feat.is_locked && /* @__PURE__ */ jsx("span", { className: "px-2.5 py-0.5 rounded-full text-2xs font-bold uppercase tracking-wider bg-neutral-800 text-ink-muted border border-neutral-700", children: "Locked (Upgrade to unlock)" }),
                    !feat.is_active && !feat.is_locked && /* @__PURE__ */ jsx("span", { className: "px-2.5 py-0.5 rounded-full text-2xs font-bold uppercase tracking-wider bg-neutral-800 text-emerald-400 border border-neutral-700", children: "Available" })
                  ] }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-2 leading-relaxed max-w-xl", children: feat.description })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 self-end md:self-center", children: [
                  ...
                  !feat.is_locked && feat.is_active && /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold text-ink-muted", children: "Configured & Healthy" }),
                  !feat.is_locked && !feat.is_active && /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold text-ink-muted", children: "Not Configured" })
                ] })
              ]
            },
            feat.key
      ...
      activeTab === "addons" && /* @__PURE__ */ jsxs("div", { className: "space-y-8 animate-fadeIn", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl bg-white/[0.02] border border-white/[0.06]", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsx(Cpu, { className: "text-brand-400", size: 24 }),
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-white", children: "AI Engine Add-on" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted leading-relaxed mb-6", children: "Supercharge your store with AI-powered scanning (SmartCapture) and interactive assistant tools. Every store starts with 10 free credits to test out the capabilities." }),
          /* @__PURE__ */ jsx("div", { className: "p-5 rounded-2xl bg-neutral-950/40 border border-white/[0.05] mb-8", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-ink-muted uppercase tracking-widest", children: "Active Level" }),
              /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-white mt-1 capitalize", children: tenant?.ai_status === "none" ? "Free Starter Tier (10 Credits)" : tenant?.ai_status })
            ] }),
            tenant?.ai_status === "none" && /* @__PURE__ */ jsxs("div", { className: "flex-1 max-w-xs", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-xs text-ink-muted mb-1", children: [
                /* @__PURE__ */ jsx("span", { children: "Free Pages Used:" }),
                /* @__PURE__ */ jsxs("span", { className: "font-bold text-white", children: [
                  tenant?.ai_pages_used ?? tenant?.plan_limits?.ai_pages_used ?? 0,
                  " / 10"
                ] })
              ] }),
            ...
            tenant?.ai_status === "managed" && /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                /* @__PURE__ */ jsx("div", { className: "text-2xs text-ink-muted font-bold uppercase", children: "Pages" }),
                /* @__PURE__ */ jsxs("div", { className: "text-sm font-bold text-white", children: [
                  tenant?.ai_pages_used ?? tenant?.plan_limits?.ai_pages_used ?? 0,
                  " / ",
                  tenant?.ai_pages_limit ?? tenant?.plan_limits?.ai_pages_limit ?? 500
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "text-right border-l border-white/10 pl-4", children: [
                /* @__PURE__ */ jsx("div", { className: "text-2xs text-ink-muted font-bold uppercase", children: "Queries" }),
                /* @__PURE__ */ jsxs("div", { className: "text-sm font-bold text-white", children: [
                  tenant?.ai_queries_used ?? tenant?.plan_limits?.ai_queries_used ?? 0,
                  " / ",
                  tenant?.ai_queries_limit ?? tenant?.plan_limits?.ai_queries_limit ?? 2500
                ] })
              ] })
            ] }),
          ...
          /* @__PURE__ */ jsxs("h4", { className: "text-sm font-bold text-white mb-4 flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "lg:col-span-1 p-6 rounded-2xl bg-white/[0.02] border border-white/[0.05] hover:border-white/10 transition-all flex flex-col justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-4", children: [
                  /* @__PURE__ */ jsx("span", { className: "px-2.5 py-0.5 rounded-full text-3xs font-bold uppercase tracking-wider bg-amber-500/10 text-amber-400 border border-amber-500/20", children: "Bring Your Own Key" }),
                  /* @__PURE__ */ jsxs("div", { className: "text-xl font-bold text-white", children: [
                    "$5 ",
                    /* @__PURE__ */ jsx("span", { className: "text-xs font-normal text-ink-muted", children: "once" })
                  ] })
                ] }),
                /* @__PURE__ */ jsx("h5", { className: "text-sm font-bold text-white mb-2", children: "Lifetime BYOK License" }),
                /* @__PURE__ */ jsx("p", { className: "text-1xs text-ink-muted leading-relaxed", children: "Bypass platform scanning fees forever. Provide your own API keys for Gemini, Claude, OpenAI, or DeepSeek and pay nothing else." })
              ] }),
            ...
            /* @__PURE__ */ jsx("div", { className: "lg:col-span-2 p-6 rounded-2xl bg-white/[0.02] border border-white/[0.05] hover:border-white/10 transition-all flex flex-col justify-between", children: /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-4", children: [
                /* @__PURE__ */ jsx("span", { className: "px-2.5 py-0.5 rounded-full text-3xs font-bold uppercase tracking-wider bg-brand-500/10 text-brand-400 border border-brand-500/20", children: "Managed API" }),
                /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted", children: "Monthly Subscriptions" })
              ] }),
              /* @__PURE__ */ jsx("h5", { className: "text-sm font-bold text-white mb-2", children: "Managed AI Subscriptions" }),
              /* @__PURE__ */ jsx("p", { className: "text-1xs text-ink-muted leading-relaxed mb-4", children: "No developer keys or setup required. Use our fast platform credentials directly. Pick the tier that matches your monthly volume:" }),
              /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: Object.entries(aiTiers).filter(([, tier]) => Number(tier.price_monthly) > 0).map(([key, tier]) => /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-1", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-white group-hover:text-brand-300 transition-colors", children: tier.label || `AI ${key}` }),
                      /* @__PURE__ */ jsxs("span", { className: "text-xs font-bold text-brand-400", children: [
                        "$",
                        tier.price_monthly
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "text-3xs text-ink-muted", children: [
                      (tier.credits || 0).toLocaleString(),
                      " AI credits / month"
                    ] })
                  ]
                },
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl bg-white/[0.02] border border-white/[0.06]", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsx(Globe2, { className: "text-brand-400", size: 24 }),
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-white", children: "Platform Sync Channels" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted leading-relaxed mb-6", children: "Keep your inventory in sync with WooCommerce and other platforms automatically." }),
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-5 rounded-2xl bg-neutral-950/40 border border-white/[0.05]", children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-ink-muted uppercase tracking-widest", children: "Subscribed Channels" }),
              /* @__PURE__ */ jsx("div", { className: "space-y-2 mt-3", children: tenant?.sync_channels && tenant.sync_channels.length > 0 ? tenant.sync_channels.map((ch) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs font-bold text-white uppercase tracking-wider", children: [
                ...
                ch,
                " Channel"
              ] }, ch)) : /* @__PURE__ */ jsx("div", { className: "text-xs text-ink-muted", children: "No active sync channels." }) })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "p-5 rounded-2xl bg-white/[0.02] border border-white/[0.05] flex flex-col justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-brand-400 uppercase tracking-widest", children: "Platform Sync" }),
                /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold text-white mt-1", children: "WooCommerce Sync Add-on" }),
                /* @__PURE__ */ jsx("p", { className: "text-1xs text-ink-muted mt-2 leading-relaxed", children: "Automatic inventory and order syncing with WooCommerce." })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "mt-4", children: tenant?.sync_channels && tenant.sync_channels.includes("woocommerce") ? /* @__PURE__ */ jsxs("span", { className: "text-xs text-emerald-400 font-bold flex items-center gap-1.5", children: [
                ...
                "button",
                {
                  ...
                  children: "Subscribe to WooCommerce Sync ($10/mo)"
                }
              ) })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "p-5 rounded-2xl bg-white/[0.02] border border-white/[0.05] flex flex-col justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-amber-400 uppercase tracking-widest", children: "Marketplace Sync" }),
                /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold text-white mt-1", children: "Amazon SP-API Sync Add-on" }),
                /* @__PURE__ */ jsx("p", { className: "text-1xs text-ink-muted mt-2 leading-relaxed", children: "2-way stock, order, and FBA/FBM inventory sync with Amazon." })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "mt-4", children: tenant?.sync_channels && tenant.sync_channels.includes("amazon") ? /* @__PURE__ */ jsxs("span", { className: "text-xs text-emerald-400 font-bold flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsx(CheckCircle2, { size: 14 }),
                " Amazon Sync Active"
              ] }) : /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  children: "Subscribe to Amazon Sync ($10/mo)"
                }
              ) })
            ] })
          ] })
      ...
      activeTab === "services" && /* @__PURE__ */ jsx("div", { className: "space-y-6 animate-fadeIn", children: /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-8 rounded-2xl bg-gradient-to-b from-neutral-950 to-black border border-white/[0.06]", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
          /* @__PURE__ */ jsx(Calendar, { className: "text-brand-400", size: 24 }),
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-white", children: tt("Professional Product Upload Service") })
        ] }),
        /* @__PURE__ */ jsxs("p", { className: "text-xs text-ink-muted leading-relaxed mb-8 max-w-xl", children: [
          "Let our catalog engineering team structure and upload your inventory. Use the calculator below to estimate the dynamic cost of importing your ",
          tt("products"),
          "."
        ] }),
 ...
 ${selectedService === key ? "bg-brand-600/10 border-brand-500/60 shadow-[0_0_20px_rgba(168,85,247,0.06)]" : "bg-white/[0.02] border-white/[0.04] hover:bg-white/[0.04] hover:border-white/10"}`,
            children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { className: "text-white font-bold text-sm", children: tier.name }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-baseline mt-4 pt-3 border-t border-white/[0.04] w-full", children: [
                /* @__PURE__ */ jsx("span", { className: "text-2xs text-brand-400 font-semibold", children: tier.sla }),
                /* @__PURE__ */ jsxs("span", { className: "text-white font-bold text-sm", children: [
                  fmt(tier.priceUSD, tier.pricePKR),
                  /* @__PURE__ */ jsx("span", { className: "text-2xs text-ink-muted font-medium", children: "/ea" })
                ] })
              ] })
            ]
          },
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 pt-6 border-t border-white/[0.06]", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-ink-muted uppercase tracking-wider mb-2", children: tt("How many products?") }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "number",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-ink-muted uppercase tracking-wider mb-2", children: "Average variants per product?" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "number",
              ...
              /* @__PURE__ */ jsxs("span", { className: "text-3xs text-ink-muted mt-1 block", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-5 rounded-2xl bg-white/[0.01] border border-white/[0.05] flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-ink-muted uppercase tracking-widest", children: "Cost Estimate Details" }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-2 mt-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-xs text-ink-muted", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-xs text-ink-muted", children: [
                  /* @__PURE__ */ jsx("span", { children: tt("Final Price Per Product:") }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "pt-4 border-t border-white/[0.05] flex justify-between items-center mt-4", children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-ink-muted uppercase tracking-wider", children: "Estimated Total" }),
              /* @__PURE__ */ jsx("span", { className: "text-2xl font-bold text-brand-400", children: fmt(usdTotalSetupCost, pkrTotalSetupCost) })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "flex justify-end pt-4 border-t border-white/[0.06]", children: /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: isOrderingService ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("span", { className: "w-3.5 h-3.5 border-2 border-void-950 border-t-transparent rounded-full animate-spin" }),
              "Redirecting..."
            ] }) : `${tt("Order Setup Service")} (${fmt(usdTotalSetupCost, pkrTotalSetupCost)})`
          }
        ) })
      ] }) }),
      activeTab === "desktop_app" && /* @__PURE__ */ jsx("div", { className: "space-y-6 animate-fadeIn", children: /* @__PURE__ */ jsxs("div", { className: "p-6 md:p-8 rounded-2xl bg-gradient-to-b from-neutral-950 to-black border border-white/[0.06] relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mb-8", children: [
          /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-2xl bg-brand-500/10 flex items-center justify-center shrink-0 border border-brand-500/20", children: /* @__PURE__ */ jsx(Monitor, { className: "text-brand-400", size: 24 }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-white", children: "VenQore Station for Windows" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted leading-relaxed mt-1 max-w-2xl", children: "VenQore Station is our native enterprise desktop application that acts as a direct hardware bridge to your registers. It enables raw receipt printing, automatic cash drawer kicks, barcode scanning, scale readings, and cashier security audits with focus-loss tracking." })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "max-w-xl mb-8", children: /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl border border-white/[0.05] bg-white/[0.01] hover:border-brand-500/20 transition-all flex flex-col justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
              /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-white", children: "Windows Setup Installer" }),
              /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 rounded-full text-3xs font-bold uppercase bg-brand-500/10 text-brand-300 border border-brand-500/20", children: "Official Build" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted leading-relaxed mb-6", children: "Official setup installer. Establishes secure system directories, registers start menu entries, registers shell protocol endpoints, and supports silent auto-updates. Requires standard system installation to prevent unapproved cashier portable copies." })
          ] }),
          /* @__PURE__ */ jsxs(
            "a",
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: "pt-6 border-t border-white/[0.06]", children: [
          /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-white uppercase tracking-wider mb-4", children: "Quick Setup & Pairing Instructions" }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "w-6 h-6 rounded-full bg-brand-500/10 border border-brand-500/20 flex items-center justify-center text-brand-400 font-bold text-xs mb-3", children: guide.step }),
    ...
    /* @__PURE__ */ jsx(Modal, { show: isChangeModalOpen, onClose: () => setIsChangeModalOpen(false), maxWidth: "md", children: /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden bg-neutral-900 border border-neutral-700 rounded-2xl shadow-2xl p-6 text-white animate-fadeIn", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-48 h-48 bg-brand-600/10 rounded-full blur-3xl pointer-events-none" }),
      /* @__PURE__ */ jsxs("h3", { className: "text-lg font-bold tracking-tight flex items-center gap-2 mb-4", children: [
        /* @__PURE__ */ jsx(Sparkles, { className: "text-brand-400", size: 20 }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-4 mb-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/[0.05]", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center flex-1", children: [
            /* @__PURE__ */ jsx("div", { className: "text-2xs text-ink-muted font-bold uppercase tracking-wider", children: "Current Plan" }),
            /* @__PURE__ */ jsx("div", { className: "text-sm font-bold mt-1 capitalize text-neutral-300", children: currentPlanKey }),
            /* @__PURE__ */ jsxs("div", { className: "text-xs text-ink-muted mt-0.5", children: [
              fmt(currentPriceUSD, currentPricePKR),
              "/mo"
            ] })
          ] }),
          /* @__PURE__ */ jsx(ArrowRight, { className: "text-ink-secondary shrink-0", size: 16 }),
          /* @__PURE__ */ jsxs("div", { className: "text-center flex-1", children: [
            /* @__PURE__ */ jsx("div", { className: "text-2xs text-brand-400 font-bold uppercase tracking-wider", children: "New Plan" }),
            /* @__PURE__ */ jsx("div", { className: "text-sm font-bold mt-1 capitalize text-brand-300", children: selectedPlan }),
            /* @__PURE__ */ jsxs("div", { className: "text-xs text-brand-400 mt-0.5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-white/[0.02] border border-white/[0.05]", children: [
          /* @__PURE__ */ jsx("div", { className: "text-2xs text-ink-muted font-bold uppercase tracking-wider mb-2", children: isUpgrade ? "🎁 Features You Will Unlock:" : "⚠️ Features You Will Lose after billing cycle:" }),
          /* @__PURE__ */ jsx("div", { className: "space-y-2", children: modalFeatures.map((feat, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2 text-xs", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-neutral-300", children: feat })
          ] }, i)) })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "p-4 rounded-xl bg-brand-500/5 border border-brand-500/10 text-xs leading-relaxed text-neutral-300", children: isTrial ? /* @__PURE__ */ jsxs("p", { children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-emerald-400 font-bold text-sm", children: fmt(proratedEstUSD, proratedEstPKR) }),
          " for the remaining ",
          ...
          /* @__PURE__ */ jsx("span", { className: "text-amber-400 font-bold", children: nextBillingDateStr }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex gap-3 justify-end", children: [
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            className: `px-5 py-2.5 rounded-xl text-black font-bold text-xs uppercase tracking-wider transition-all hover:shadow-lg ${isUpgrade ? "bg-white hover:bg-interactive-hover" : "bg-amber-500 hover:bg-amber-400"}`,
            children: [
              "Confirm ",
              isUpgrade ? "Upgrade" : "Downgrade"
            ]
    ...
    /* @__PURE__ */ jsx(Modal, { show: !!pendingCreditSummary, onClose: () => setPendingCheckout(null), maxWidth: "md", children: pendingCreditSummary && /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden bg-neutral-900 border border-neutral-700 rounded-2xl shadow-2xl p-6 text-white animate-fadeIn", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-48 h-48 bg-emerald-500/10 rounded-full blur-3xl pointer-events-none" }),
      /* @__PURE__ */ jsxs("h3", { className: "text-lg font-bold tracking-tight flex items-center gap-2 mb-2", children: [
      ...
      /* @__PURE__ */ jsxs("p", { className: "text-xs text-ink-muted leading-relaxed mb-5", children: [
        "You still have ",
        pendingCreditSummary.daysRemaining,
        " unused ",
        pendingCreditSummary.daysRemaining === 1 ? "day" : "days",
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-white/[0.02] border border-white/[0.05] divide-y divide-white/[0.05] mb-5", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 py-3", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-neutral-300", children: pendingCreditSummary.fullPrice })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 py-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 py-3.5 bg-white/[0.02]", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-white", children: "Due today" }),
          /* @__PURE__ */ jsx("span", { className: "text-lg font-bold text-white", children: pendingCreditSummary.dueToday })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-emerald-500/5 border border-emerald-500/10 text-xs leading-relaxed text-neutral-300 mb-6", children: [
    ...
    /* @__PURE__ */ jsx(Modal, { show: cancelOpen, onClose: () => setCancelOpen(false), maxWidth: "md", children: /* @__PURE__ */ jsxs("div", { className: "p-8 bg-neutral-950 text-white", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold", children: "Cancel your subscription?" }),
          /* @__PURE__ */ jsx("p", { className: "text-1xs font-bold text-ink-muted uppercase tracking-wider", children: currentMeta.label })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "p-4 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 mb-4", children: /* @__PURE__ */ jsxs("p", { className: "text-xs font-bold text-emerald-300 leading-relaxed flex items-start gap-2", children: [
        ...
        /* @__PURE__ */ jsxs("span", { children: [
          ...
          paidUntilLabel ? /* @__PURE__ */ jsxs(Fragment, { children: [
            " until ",
            /* @__PURE__ */ jsx("span", { className: "font-bold", children: paidUntilLabel })
          ] }) : " until the end of your current paid period",
          ". Nothing is lost today and no refund is needed — you already paid for this time."
        ] })
      ] }) }),
      /* @__PURE__ */ jsxs("ul", { className: "space-y-2 mb-6 text-xs font-bold text-ink-muted", children: [
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx(XCircle, { size: 13, className: "shrink-0 mt-0.5 text-ink-secondary" }),
        ...
        /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx(RefreshCw, { size: 13, className: "shrink-0 mt-0.5 text-ink-secondary" }),
    ...
    /* @__PURE__ */ jsx(Modal, { show: congratsModalOpen, onClose: () => setCongratsModalOpen(false), maxWidth: "md", children: /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden bg-neutral-900 border border-neutral-700 rounded-2xl shadow-2xl p-8 text-white animate-fadeIn", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-48 h-48 bg-brand-600/20 rounded-full blur-3xl pointer-events-none" }),
      /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 w-48 h-48 bg-brand-600/25 rounded-full blur-3xl pointer-events-none" }),
      ...
      /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 w-full h-[1px] bg-gradient-hairline opacity-50" }),
      /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center text-center mb-6", children: [
          /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-2xl bg-brand-500/10 border border-brand-500/30 flex items-center justify-center mb-4 animate-bounce", children: /* @__PURE__ */ jsx(Crown, { className: "text-brand-400", size: 32 }) }),
          /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-brand", children: "Congratulations!" }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-1", children: "Your store is successfully upgraded and active" })
        ] }),
        (() => {
          ...
          return /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-white/[0.02] border border-white/[0.05] mb-5", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3 border-b border-white/[0.05] pb-3", children: [
                /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted font-bold", children: "ACTIVE PLAN" }),
                /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-brand-400 uppercase tracking-widest", children: congratsPlan.name || congratsPlanSlug })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted font-bold", children: "RENEWAL DATE" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsx("div", { className: "text-2xs text-ink-muted font-bold uppercase tracking-wider mb-3", children: "What's Included in Your Plan:" }),
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-lg bg-white/[0.01] border border-white/[0.03] flex flex-col", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-3xs text-ink-muted font-bold uppercase tracking-wider", children: tt("Staff Limit") }),
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-white mt-0.5", children: formatLimit(congratsPlan.limits?.staff_limit) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-lg bg-white/[0.01] border border-white/[0.03] flex flex-col", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-3xs text-ink-muted font-bold uppercase tracking-wider", children: tt("Product (SKU) Limit") }),
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-white mt-0.5", children: formatLimit(congratsPlan.limits?.sku_limit) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-lg bg-white/[0.01] border border-white/[0.03] flex flex-col", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-3xs text-ink-muted font-bold uppercase tracking-wider", children: "Locations Limit" }),
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-white mt-0.5", children: formatLimit(congratsPlan.limits?.locations) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-lg bg-white/[0.01] border border-white/[0.03] flex flex-col", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-3xs text-ink-muted font-bold uppercase tracking-wider", children: "Transactions/mo" }),
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-white mt-0.5", children: formatLimit(congratsPlan.limits?.transactions_per_month) })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsx("div", { className: "text-2xs text-ink-muted font-bold uppercase tracking-wider mb-2", children: "Premium Upgrades Activated:" }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                congratsPlanSlug === "scale" && /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs text-neutral-300", children: [
                ...
                congratsPlanSlug === "core" && /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs text-neutral-300", children: [
                    /* @__PURE__ */ jsx(CheckCircle2, { size: 12, className: "text-emerald-400 shrink-0" }),
