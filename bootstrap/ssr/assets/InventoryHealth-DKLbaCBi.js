...
import ToolShell from "./ToolShell-Bs5cX3RK.js";
import Select from "./Select-BvHKwZfu.js";
import "@inertiajs/react";
import "./MarketingLayout-BFa6J1ZE.js";
import "../ssr.js";
...
import "./CookieConsent-Q80sWRlc.js";
import "motion/react";
import "./SiteChrome-DOyuw3mz.js";
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: cardCls, children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-brand-500/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(Shield, { size: 17, className: "text-brand-500 dark:text-brand-300" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "Safety Stock" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Simple method: buffer stock = worst-case demand-during-lead-time minus average demand-during-lead-time." })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-6", children: [
            /* @__PURE__ */ jsxs("div", { className: resultCardCls, children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Safety Stock" }),
              /* @__PURE__ */ jsxs("p", { className: "text-2xl font-bold text-ink", children: [
                fmtNum(safetyStockClamped),
                " units"
              ] })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-3 text-center", children: "This is the buffer stock to hold on top of expected demand so a slower delivery or a sales spike doesn't cause a stockout." })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-5 leading-relaxed", children: "Note: this simple method is easy to use with numbers most small retailers already track. A more statistically rigorous approach uses the standard deviation of daily demand and lead time combined with a service-level Z-score (e.g. 1.65 for 95% service level) — that method exists and is worth knowing about, but it needs more historical data than most small retailers have on hand, so this tool intentionally keeps to the simple method for usability." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: `${cardCls} mt-6`, children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-brand-500/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(Boxes, { size: 17, className: "text-brand-500 dark:text-brand-300" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "Reorder Point" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "The stock level that should trigger a new purchase order." })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-5", children: [
            /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-2", children: [
              ...
              /* @__PURE__ */ jsxs("label", { className: "mt-2 flex items-center gap-2 text-xs text-ink-muted cursor-pointer", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-6", children: [
            /* @__PURE__ */ jsxs("div", { className: resultCardCls, children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Reorder Point" }),
              /* @__PURE__ */ jsxs("p", { className: "text-2xl font-bold text-ink", children: [
                fmtNum(reorderPoint.value),
                " units"
              ] })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-3 text-center", children: "Reorder when stock hits this level to avoid running out before the next delivery arrives." })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: `${cardCls} mt-6`, children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-brand-500/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(Package, { size: 17, className: "text-brand-500 dark:text-brand-300" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "Economic Order Quantity (EOQ)" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "The order size that minimizes total ordering + holding cost." })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-3 gap-5", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsx("span", { className: "absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-muted text-sm", children: sym }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-6", children: [
            /* @__PURE__ */ jsxs("div", { className: resultCardCls, children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Optimal Order Quantity" }),
              /* @__PURE__ */ jsxs("p", { className: "text-2xl font-bold text-ink", children: [
                fmtNum(eoq.value),
                " units"
              ] })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-3 text-center", children: "This is the order size that minimizes the combined total of ordering costs (placing more orders costs more in fixed fees) and holding costs (carrying more inventory costs more in storage, capital and shrinkage risk)." })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: `${cardCls} mt-6`, children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-brand-500/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(PiggyBank, { size: 17, className: "text-brand-500 dark:text-brand-300" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "GMROI" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Gross Margin Return on Inventory Investment — dollars of margin per dollar tied up in stock." })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mb-5 flex gap-2", children: [
            /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setGmroiMode("direct"), className: `px-3.5 py-2 rounded-xl text-xs font-bold uppercase tracking-wide transition-colors ${gmroiMode === "direct" ? "vq-tool-on" : "vq-tool-inset text-ink-muted"}`, children: "Enter gross margin $" }),
            /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setGmroiMode("salesCogs"), className: `px-3.5 py-2 rounded-xl text-xs font-bold uppercase tracking-wide transition-colors ${gmroiMode === "salesCogs" ? "vq-tool-on" : "vq-tool-inset text-ink-muted"}`, children: "Compute from sales − COGS" })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-6 grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxs("div", { className: resultCardCls, children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Gross Margin" }),
              /* @__PURE__ */ jsx("p", { className: "text-xl font-bold text-ink", children: fmtMoney(gmroi.grossMargin) })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: resultCardCls, children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "GMROI" }),
              /* @__PURE__ */ jsx("p", { className: "text-xl font-bold text-ink", children: gmroi.value !== null && Number.isFinite(gmroi.value) ? round2(gmroi.value).toFixed(2) : "—" })
            ] })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-3 text-center", children: 'A GMROI above 1.0 generally means the inventory investment is being recovered with some profit on top, and higher is generally better — but "good" varies a lot by industry, so track your own trend rather than chasing a universal number.' })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: `${cardCls} mt-6`, children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-brand-500/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(RefreshCw, { size: 17, className: "text-brand-500 dark:text-brand-300" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "Inventory Turnover" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "How many times inventory is sold and replaced over a period, and the equivalent days of stock on hand." })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-5", children: [
            /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-6 grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxs("div", { className: resultCardCls, children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Turnover Ratio" }),
              /* @__PURE__ */ jsx("p", { className: "text-xl font-bold text-ink", children: turnover.turns !== null ? `${round2(turnover.turns).toFixed(2)}×` : "—" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: resultCardCls, children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Days of Inventory" }),
              /* @__PURE__ */ jsxs("p", { className: "text-xl font-bold text-ink", children: [
                turnover.days !== null ? fmtNum(round2(turnover.days), 1) : "—",
                " days"
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-3 text-center", children: "These are two views of the same number: turnover says how many times stock cycles per year, days of inventory says how many days of sales you're carrying on the shelf right now — a lower days figure means cash is tied up for less time." })
        ] }),
        /* @__PURE__ */ jsxs("section", { className: "mt-12", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold mb-4 text-ink", children: "How these five numbers fit together" }),
          /* @__PURE__ */ jsxs("p", { className: "text-sm text-ink-secondary leading-relaxed mb-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-4 mb-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad", children: [
              /* @__PURE__ */ jsx("p", { className: "font-bold text-ink mb-1", children: "Reorder Point" }),
              /* @__PURE__ */ jsx("p", { className: "font-mono text-xs text-brand-600 dark:text-brand-300", children: "ROP = (Avg Daily Sales × Lead Time Days) + Safety Stock" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad", children: [
              /* @__PURE__ */ jsx("p", { className: "font-bold text-ink mb-1", children: "Safety Stock (simple method)" }),
              /* @__PURE__ */ jsx("p", { className: "font-mono text-xs text-brand-600 dark:text-brand-300", children: "SS = (Max Daily Sales × Max Lead Time) − (Avg Daily Sales × Avg Lead Time)" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad", children: [
              /* @__PURE__ */ jsx("p", { className: "font-bold text-ink mb-1", children: "Economic Order Quantity" }),
              /* @__PURE__ */ jsx("p", { className: "font-mono text-xs text-brand-600 dark:text-brand-300", children: "EOQ = √((2 × Annual Demand × Order Cost) ÷ Holding Cost per Unit)" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad", children: [
              /* @__PURE__ */ jsx("p", { className: "font-bold text-ink mb-1", children: "GMROI" }),
              /* @__PURE__ */ jsx("p", { className: "font-mono text-xs text-brand-600 dark:text-brand-300", children: "GMROI = Gross Margin ($) ÷ Average Inventory Cost Value ($)" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad sm:col-span-2", children: [
              /* @__PURE__ */ jsx("p", { className: "font-bold text-ink mb-1", children: "Inventory Turnover & Days of Inventory" }),
              /* @__PURE__ */ jsx("p", { className: "font-mono text-xs text-brand-600 dark:text-brand-300", children: "Turnover = COGS ÷ Average Inventory Value  ·  Days of Inventory = 365 ÷ Turnover" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl bg-brand-500/[0.06] dark:bg-brand-500/10 border border-brand-500/20 mb-6", children: [
            /* @__PURE__ */ jsx("p", { className: "font-bold text-ink mb-2", children: "Worked example — reorder point and safety stock together" }),
            /* @__PURE__ */ jsxs("p", { className: "text-sm text-ink-secondary leading-relaxed", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-secondary leading-relaxed", children: "Why this matters for a small retailer: without a reorder point, restocking decisions become guesswork — either too reactive (stockouts, lost sales, unhappy customers) or too cautious (excess cash tied up in slow-moving stock, higher shrinkage and obsolescence risk). EOQ then refines *how much* to order once you've decided *when* to order, balancing the fixed cost of placing an order against the ongoing cost of holding inventory. Finally, GMROI and turnover are the scorecards — they tell you, after the fact, whether your reorder and order-quantity decisions actually turned into efficient use of the cash tied up on your shelves." })
        ] })
      ]
    }
  );
