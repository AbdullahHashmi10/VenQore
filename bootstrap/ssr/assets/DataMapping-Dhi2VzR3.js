...
function DataMapping({ file_path, type, file_headers, preview_data, expected_fields }) {
  ...
  const EditColumn = ({ title, subtitle, data, onChange, disabled }) => /* @__PURE__ */ jsxs("div", { className: `flex-1 space-y-4 p-4 rounded-xl ${disabled ? "bg-white/5 opacity-50" : "bg-white/5 border border-white/5"}`, children: [
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted mt-1 uppercase tracking-wider", children: subtitle })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-3", children: currentFields.map((f) => /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("label", { className: "text-2xs text-ink-muted block mb-1", children: f.label }),
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Import Column Mapping", activeMenu: "Setup", children: [
    ...
    editingContext && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-sticky flex items-center justify-center bg-black/70 backdrop-blur-md p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 border border-white/10 rounded-2xl p-8 w-full max-w-4xl shadow-2xl animate-in zoom-in-95 duration-normal", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-6", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-white", children: "Resolve Data Conflict" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mt-1", children: "Compare and edit rows to ensure they are unique." })
        ] }),
        /* @__PURE__ */ jsx("button", { onClick: () => setEditingContext(null), className: "text-ink-muted hover:text-white transition-colors", children: /* @__PURE__ */ jsx(XCircle, { className: "w-8 h-8" }) })
      ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-[1600px] mx-auto h-full flex flex-col gap-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-4", children: [
          /* @__PURE__ */ jsx(Link, { href: route("store.admin.data", { store_slug: store.slug }), className: "text-ink-muted hover:text-white transition-colors", children: /* @__PURE__ */ jsx(ArrowLeft, { className: "w-6 h-6" }) }),
        ...
        validationData && /* @__PURE__ */ jsx("div", { className: "flex items-center gap-4 bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-lg", children: /* @__PURE__ */ jsxs("span", { className: "text-emerald-400 text-sm font-medium", children: [
          ...
          " Updates",
          ignoredRows.length > 0 && /* @__PURE__ */ jsxs("span", { className: "text-ink-muted ml-2", children: [
            "• ",
            ignoredRows.length,
            " Skipped"
          ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-3 gap-6 pb-6", children: [
        /* @__PURE__ */ jsxs("div", { id: "tour-mapping-container", className: "lg:col-span-1 border border-white/10 rounded-xl bg-neutral-900 p-6 shadow-2xl flex flex-col min-h-0", children: [
          /* @__PURE__ */ jsxs("div", { className: "mb-4 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mt-1", children: "Select columns to map to fields." })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex-1 space-y-4 overflow-y-auto pr-2 custom-scrollbar min-h-0", children: expected_fields.map((field) => /* @__PURE__ */ jsxs("div", { className: "flex flex-col space-y-1 bg-white/5 p-3 rounded-lg shrink-0", children: [
            /* @__PURE__ */ jsx("label", { className: "text-sm font-medium text-neutral-200 flex justify-between", children: /* @__PURE__ */ jsxs("span", { children: [
              field.label,
              " ",
          ...
          type === "products" && /* @__PURE__ */ jsx("div", { className: "mb-6 p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl shrink-0", children: /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-3 cursor-pointer group", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative inline-flex items-center", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "w-11 h-6 bg-neutral-700 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-line after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-600" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted", children: "If unchecked, negative opening quantities will be set to 0" })
            ] })
          ] }) }),
          validationData?.exceeds_limit && /* @__PURE__ */ jsxs("div", { className: "mb-6 p-5 bg-amber-500/10 border border-amber-500/25 rounded-2xl shrink-0 space-y-4 text-left", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxs("p", { className: "text-xs text-neutral-300 mt-1 leading-relaxed", children: [
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `w-full py-2.5 px-4 rounded-xl text-left border transition-all text-xs font-semibold flex items-center justify-between
                                            ${importAction === "truncate" ? "border-brand-500 bg-brand-500/10 text-white" : "border-white/10 bg-white/5 text-ink-muted hover:border-white/20"}`,
                  children: [
                    ...
                    /* @__PURE__ */ jsx("div", { className: `w-4 h-4 rounded-full border flex items-center justify-center shrink-0 ${importAction === "truncate" ? "border-brand-500 bg-brand-500 text-white" : "border-line-strong"}`, children: importAction === "truncate" && /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 bg-white rounded-full" }) })
                  ]
                }
              ),
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `w-full py-2.5 px-4 rounded-xl text-left border transition-all text-xs font-semibold flex items-center justify-between
                                            ${importAction === "import_all" ? "border-amber-500 bg-amber-500/10 text-white" : "border-white/10 bg-white/5 text-ink-muted hover:border-white/20"}`,
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "pr-4", children: [
                    ...
                    /* @__PURE__ */ jsx("div", { className: `w-4 h-4 rounded-full border flex items-center justify-center shrink-0 ${importAction === "import_all" ? "border-amber-500 bg-amber-500 text-white" : "border-line-strong"}`, children: importAction === "import_all" && /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 bg-white rounded-full" }) })
                  ]
                }
              )
            ] })
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `w-full flex justify-center items-center py-3 px-4 rounded-xl text-white font-medium transition-all duration-slow
                                ${isProcessing || !validationData ? "bg-sunken cursor-not-allowed opacity-50" : "bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 shadow-lg "}
`,
                children: isProcessing ? "Importing..." : "Confirm & Process Import"
              }
            ),
            !validationData && /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted text-center", children: "Run validation before importing" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 flex flex-col gap-6 min-h-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 border border-white/10 rounded-xl bg-neutral-900 p-6 shadow-2xl flex flex-col min-h-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-4 shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-auto rounded-lg border border-white/10 custom-scrollbar min-h-0", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left text-sm whitespace-nowrap", children: [
              /* @__PURE__ */ jsx("thead", { className: "bg-sunken sticky top-0 z-10", children: /* @__PURE__ */ jsxs("tr", { children: [
                /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-neutral-300 border-b border-white/10 font-medium", children: "#" }),
                expected_fields.map((field) => /* @__PURE__ */ jsx("th", { className: `px-4 py-3 border-b border-white/10 font-medium ${mapping[field.key] != null ? "text-brand-300" : "text-ink-muted"}`, children: field.label }, field.key))
              ] }) }),
              /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-white/5 bg-neutral-900", children: preview_data.map((row, index) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-white/5 transition-colors", children: [
                /* @__PURE__ */ jsx("td", { className: "px-4 py-2 text-ink-muted", children: index + 1 }),
                expected_fields.map((field) => {
                  const fileColIndex = mapping[field.key];
                  const value = fileColIndex != null ? row[fileColIndex] : null;
                  return /* @__PURE__ */ jsx("td", { className: `px-4 py-2 ${value ? "text-neutral-200" : "text-ink-secondary italic text-xs"}`, children: value || "-" }, field.key);
                })
              ] }, index)) })
            ] }) })
          ] })
