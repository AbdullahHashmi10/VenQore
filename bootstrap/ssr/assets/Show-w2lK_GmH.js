...
import MarketingLayout, { RelatedPages } from "./MarketingLayout-BFa6J1ZE.js";
import { GrowthEngineDemo, CookbookDemo, ProfitLossDemo, PosInvoiceDemo, DemoStyles } from "./FeatureDemos-CARWNhF9.js";
import { ArrowRight, X, CheckCircle2, TrendingUp, Pause, ArrowLeftRight, TrendingDown, Gift, Zap, ShieldCheck, FileText, Scale, RefreshCw, Calendar, List, Landmark, BarChart3, GitMerge, Warehouse, Palette, Smartphone, Repeat, Database, Lock, Printer, CreditCard, Layers, ScanBarcode, WifiOff, Package, BookOpen, ShoppingCart, ChevronDown } from "lucide-react";
import "../ssr.js";
...
const DEMO_BY_FEATURE = {
  "point-of-sale": {
    ...
    title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "Ring up a sale ",
      /* @__PURE__ */ jsx("span", { className: "vq-accent-text", children: "right here." })
    ] }),
  ...
  "offline-pos": {
    ...
    title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "The same terminal, ",
      /* @__PURE__ */ jsx("span", { className: "vq-accent-text", children: "with or without a line." })
    ] }),
  ...
  accounting: {
    ...
    title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "A Profit & Loss that ",
      /* @__PURE__ */ jsx("span", { className: "vq-accent-text", children: "reconciles." })
    ] }),
  ...
  "inventory-management": {
    ...
    title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "Watch FIFO costing ",
      /* @__PURE__ */ jsx("span", { className: "vq-accent-text", children: "actually happen." })
    ] }),
  ...
  "growth-engine": {
    ...
    title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "Every insight ",
      /* @__PURE__ */ jsx("span", { className: "vq-accent-text", children: "shows its working." })
    ] }),
  ...
  return /* @__PURE__ */ jsxs(MarketingLayout, { children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "vq-section vq-mkt-hero", children: /* @__PURE__ */ jsxs("div", { className: "vq-container", children: [
      /* @__PURE__ */ jsxs("div", { className: "vq-section-head vq-section-head--center", style: { marginBottom: 0, maxWidth: 900 }, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "vq-row vq-gap-3 vq-wrap vq-mt-4", style: { justifyContent: "center" }, children: [
          /* @__PURE__ */ jsx("span", { className: `vq-badge ${statusColors[data.status] || ""}`, children: statusLabel[data.status] }),
          /* @__PURE__ */ jsx("span", { className: "vq-caption", children: data.category })
        ] }),
        /* @__PURE__ */ jsx("h1", { className: "vq-display vq-mt-5", children: data.headline }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "vq-row vq-wrap vq-gap-3 vq-mt-8", style: { justifyContent: "center" }, children: [
          ...
          /* @__PURE__ */ jsx(Link, { href: "/pricing", className: "vq-btn vq-btn--secondary vq-btn--lg", children: "See pricing — from $49/month or free" })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "vq-section", style: { paddingTop: 0 }, children: /* @__PURE__ */ jsx("div", { className: "vq-container vq-container--narrow", children: /* @__PURE__ */ jsxs("div", { className: "vq-card vq-card--xl vq-mkt-answer", children: [
      /* @__PURE__ */ jsx("span", { className: "vq-eyebrow vq-eyebrow--accent", children: "Quick answer" }),
      /* @__PURE__ */ jsx("h2", { className: "vq-h2 vq-mt-3", children: data.answerBlock.question }),
      /* @__PURE__ */ jsx("p", { className: "vq-mt-4", children: data.answerBlock.answer })
    ] }) }) }),
    demo && /* @__PURE__ */ jsxs("section", { className: "vq-section vq-section--alt", children: [
      /* @__PURE__ */ jsxs("div", { className: "vq-container", children: [
        /* @__PURE__ */ jsxs("div", { className: "vq-section-head vq-section-head--center", children: [
          /* @__PURE__ */ jsx("span", { className: "vq-eyebrow vq-eyebrow--accent vq-eyebrow--dot", children: demo.eyebrow }),
          /* @__PURE__ */ jsx("h2", { className: "vq-h1 vq-mt-4", children: demo.title }),
          /* @__PURE__ */ jsx("p", { className: "vq-lede", children: demo.lead })
        ] }),
        /* @__PURE__ */ jsx(demo.Component, {}),
        /* @__PURE__ */ jsxs("p", { className: "vq-small vq-text-2 vq-center vq-mt-6", style: { marginInline: "auto" }, children: [
          "Simulated with sample data — nothing you do here is saved.",
          " ",
          /* @__PURE__ */ jsx(Link, { href: "/demo", children: "Want the full store? Launch the live demo →" })
        ] })
      ] }),
      /* @__PURE__ */ jsx(DemoStyles, {})
    ] }),
    /* @__PURE__ */ jsx("section", { className: "vq-section", children: /* @__PURE__ */ jsxs("div", { className: "vq-container", children: [
      /* @__PURE__ */ jsxs("div", { className: "vq-section-head", children: [
        /* @__PURE__ */ jsx("span", { className: "vq-eyebrow vq-eyebrow--accent vq-eyebrow--dot", children: "The gaps" }),
        /* @__PURE__ */ jsx("h2", { className: "vq-h1 vq-mt-4", children: "Where generic software falls short" }),
        /* @__PURE__ */ jsx("p", { className: "vq-lede", children: "The gaps that cost retailers money every day — and how VenQore closes them." })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "vq-grid vq-grid--2", children: data.painPoints.map((item, i) => /* @__PURE__ */ jsxs("article", { className: "vq-card vq-card--xl vq-mkt-pain", children: [
        /* @__PURE__ */ jsxs("div", { className: "vq-mkt-pain__row vq-mkt-pain__row--problem", children: [
          /* @__PURE__ */ jsxs("span", { className: "vq-mkt-pain__label", children: [
            /* @__PURE__ */ jsx(X, { size: 16, "aria-hidden": "true" }),
            " Without VenQore"
          ] }),
          /* @__PURE__ */ jsx("p", { children: item.pain })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "vq-mkt-pain__row vq-mkt-pain__row--fix vq-mt-3", children: [
          ...
          /* @__PURE__ */ jsx("p", { children: item.fix })
        ] })
      ] }, i)) })
    ] }) }),
    /* @__PURE__ */ jsx("section", { className: "vq-section vq-section--alt", children: /* @__PURE__ */ jsxs("div", { className: "vq-container", children: [
      /* @__PURE__ */ jsxs("div", { className: "vq-section-head", children: [
        /* @__PURE__ */ jsx("span", { className: "vq-eyebrow vq-eyebrow--accent vq-eyebrow--dot", children: "What's included" }),
        /* @__PURE__ */ jsx("h2", { className: "vq-h1 vq-mt-4", children: "Every capability, shipped" }),
        /* @__PURE__ */ jsx("p", { className: "vq-lede", children: "Every capability below is shipped and live in VenQore today. No plugins, no add-ons." })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "vq-grid vq-grid--3", children: data.features.map((feat, i) => {
        ...
        return /* @__PURE__ */ jsxs("div", { className: "vq-card vq-card--xl vq-tile", children: [
          /* @__PURE__ */ jsxs("div", { className: "vq-row", style: { justifyContent: "space-between", alignItems: "flex-start", gap: 12 }, children: [
            ...
            feat.tag && /* @__PURE__ */ jsx("span", { className: "vq-badge vq-badge--success", children: feat.tag })
          ] }),
          /* @__PURE__ */ jsx("h3", { className: "vq-tile__title", style: { fontSize: 20 }, children: feat.title }),
          /* @__PURE__ */ jsx("p", { className: "vq-tile__body", children: feat.description })
        ] }, i);
      }) })
    ] }) }),
    /* @__PURE__ */ jsx("section", { className: "vq-section", children: /* @__PURE__ */ jsxs("div", { className: "vq-container", children: [
      /* @__PURE__ */ jsxs("div", { className: "vq-section-head", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "vq-h1 vq-mt-4", children: data.comparisonTable.title })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "vq-mkt-table-wrap", children: /* @__PURE__ */ jsxs("table", { className: "vq-mkt-table", children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
          /* @__PURE__ */ jsx("th", { scope: "col", style: { width: "34%" }, children: "Feature" }),
          /* @__PURE__ */ jsx("th", { scope: "col", className: "is-us", children: "VenQore" }),
          /* @__PURE__ */ jsx("th", { scope: "col", children: "Typical alternative" })
        ] }) }),
        /* @__PURE__ */ jsx("tbody", { children: data.comparisonTable.rows.map((row, i) => /* @__PURE__ */ jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsx("td", { className: "is-us", children: /* @__PURE__ */ jsxs("span", { className: "vq-row vq-gap-2", style: { alignItems: "flex-start" }, children: [
            /* @__PURE__ */ jsx(CheckCircle2, { size: 16, className: "vq-cmp-tick", "aria-hidden": "true" }),
    ...
    /* @__PURE__ */ jsx("section", { className: "vq-section vq-section--alt", children: /* @__PURE__ */ jsxs("div", { className: "vq-container vq-container--narrow", children: [
      /* @__PURE__ */ jsxs("div", { className: "vq-section-head", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "vq-h1 vq-mt-4", children: "Frequently asked questions" })
      ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "vq-section vq-section--tight", children: /* @__PURE__ */ jsxs("div", { className: "vq-container", children: [
      /* @__PURE__ */ jsx("div", { className: "vq-section-head vq-section-head--center", style: { marginBottom: "var(--vq-space-8)" }, children: /* @__PURE__ */ jsx("h2", { className: "vq-h2", children: "Explore related pages" }) }),
      /* @__PURE__ */ jsxs("div", { className: "vq-row vq-wrap vq-gap-3", style: { justifyContent: "center" }, children: [
        data.crossLinks.map((link, i) => /* @__PURE__ */ jsxs(Link, { href: link.href, className: "vq-chip", children: [
          link.label,
          " ",
          /* @__PURE__ */ jsx(ArrowRight, { size: 14, "aria-hidden": "true" })
        ] }, i)),
        /* @__PURE__ */ jsxs(Link, { href: "/features", className: "vq-chip vq-chip--on", children: [
          "All features ",
          /* @__PURE__ */ jsx(ArrowRight, { size: 14, "aria-hidden": "true" })
        ] })
      ] })
    ...
    /* @__PURE__ */ jsx("section", { className: "vq-section", style: { paddingTop: 0 }, children: /* @__PURE__ */ jsx("div", { className: "vq-container", children: /* @__PURE__ */ jsxs("div", { className: "vq-card vq-card--xl vq-mkt-cta", children: [
      /* @__PURE__ */ jsx("h2", { className: "vq-h1", children: "Ready to see it for yourself?" }),
      /* @__PURE__ */ jsx("p", { className: "vq-lede", children: "Walk into a fully loaded VenQore store — ring up sales, open the P&L, check inventory. No signup. Resets daily." }),
      /* @__PURE__ */ jsxs("div", { className: "vq-row vq-wrap vq-gap-3 vq-mkt-cta__actions", children: [
        /* @__PURE__ */ jsxs(Link, { href: "/demo", className: "vq-btn vq-btn--primary vq-btn--lg", children: [
          "Try the live demo — no signup ",
          /* @__PURE__ */ jsx(ArrowRight, { size: 16, className: "vq-btn__arrow", "aria-hidden": "true" })
        ] }),
        /* @__PURE__ */ jsx(Link, { href: "/build-workspace", className: "vq-btn vq-btn--secondary vq-btn--lg", children: "Start building" })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "vq-caption vq-mt-6", style: { marginInline: "auto" }, children: "Plans from $49/month (Starter) · $99/mo (Core) · $299/mo (Scale) · Free forever (Solo) · 14-day trial · Cancel anytime" })
    ] }) }) }),
    /* @__PURE__ */ jsx(RelatedPages, { title: "Related reading", items: related })
  ] });
}
export {
  FeatureShow as default
};
