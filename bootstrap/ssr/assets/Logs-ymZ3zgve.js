      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("h1", { className: "text-2xl font-bold text-ink flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Shield, { className: "text-brand-500" }),
            "Security Audit Log"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Real-time system activity tracking" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 w-full md:w-auto", children: [
          ...
          /* @__PURE__ */ jsx("button", { onClick: refreshPage, className: "p-2 bg-sunken rounded-xl text-ink-muted hover:text-brand-500 transition-colors", title: "Refresh Logs", children: /* @__PURE__ */ jsx(RefreshCw, { size: 20 }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4 shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-surface p-4 rounded-2xl border border-line shadow-sm flex items-center gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-brand-100 dark:bg-brand-900/20 flex items-center justify-center text-brand-600", children: /* @__PURE__ */ jsx(FileText, { size: 24 }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Total Events" }),
            /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-ink", children: displayLogs.length })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface p-4 rounded-2xl border border-line shadow-sm flex items-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Critical" }),
            /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-ink", children: displayLogs.filter((l) => l.level === "error").length })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface p-4 rounded-2xl border border-line shadow-sm flex items-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Warnings" }),
            /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-ink", children: displayLogs.filter((l) => l.level === "warning").length })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface p-4 rounded-2xl border border-line shadow-sm flex items-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Success" }),
            /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-ink", children: displayLogs.filter((l) => l.level === "success").length })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex-1 bg-surface border border-line rounded-2xl shadow-sm flex flex-col overflow-hidden min-h-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-4 border-b border-line flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(Filter, { size: 16, className: "text-ink-muted" }),
          /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-ink-secondary mr-2", children: "Status:" }),
          ["all", "info", "success", "warning", "error"].map((level) => /* @__PURE__ */ jsx(
            "button",
            {
              onClick: () => setFilterLevel(level),
              className: `px-3 py-1.5 rounded-lg text-xs font-bold uppercase tracking-wider transition-all
                                    ${filterLevel === level ? "bg-brand-600 text-white shadow-md " : "bg-sunken text-ink-muted hover:bg-interactive-hover dark:hover:bg-interactive-hover"}
`,
              children: level
            },
            level
        ...
        /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-auto custom-scrollbar", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
          ...
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: filteredLogs.length > 0 ? filteredLogs.map((log) => {
            ...
            return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors group", children: [
              /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-ink-secondary text-sm font-mono", children: [
                /* @__PURE__ */ jsx(Clock, { size: 14, className: "text-neutral-300" }),
                formatDate(log.created_at)
              ] }) }),
              /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsxs("span", { className: `inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-2xs font-bold uppercase tracking-wider ${status.color} ${status.bg}`, children: [
                /* @__PURE__ */ jsx(StatusIcon, { size: 12 }),
                status.label
              ] }) }),
              /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary dark:text-ink mb-0.5", children: log.action }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted font-mono", children: log.description })
              ] }) }),
              /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("div", { className: "w-6 h-6 rounded-full bg-sunken flex items-center justify-center text-xs font-bold text-ink-muted uppercase", children: log.user.charAt(0) }),
                /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-ink-secondary", children: log.user })
              ] }) })
            ] }, log.id);
          }) : /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "5", className: "py-32 text-center", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center text-ink-muted opacity-60", children: [
