...
import { ChevronDown, ShoppingBag, CheckSquare, Clock, History, Search, Plus, ChevronUp, Printer, MoreVertical, Edit, ShoppingCart, Truck, Wrench, XCircle, Trash2, X, CheckCircle2 } from "lucide-react";
...
function PreOrders({ orders, filters: rawFilters, stats }) {
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: tt("Pre-Orders"), activeMenu: "Sell", children: [
    /* @__PURE__ */ jsx(Head, { title: tt("Pre-Orders") }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col min-h-full lg:h-full bg-app p-1 md:p-2 gap-1 lg:overflow-hidden relative", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: `grid grid-cols-2 md:grid-cols-4 gap-1 shrink-0 ${isStatsExpanded ? "grid" : "hidden md:grid"}`, children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-ink", children: stats?.order_count || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Confirmed" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-emerald-600", children: stats?.confirmed_count || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-ink", children: formatCurrency(stats?.total_orders || 0, store) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex flex-wrap items-center justify-between gap-2 bg-surface px-3 py-2 rounded-xl border border-line shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
          /* @__PURE__ */ jsxs("h1", { className: "text-lg font-bold text-ink uppercase tracking-tight shrink-0", children: [
            "Pre-",
            /* @__PURE__ */ jsx("span", { className: "text-brand-600", children: tt("Orders") })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex items-center gap-0.5 border-l border-line pl-2", children: /* @__PURE__ */ jsxs(Link, { href: route("store.pre-sales.create", { store_slug: store?.slug }), className: "px-3 py-1.5 bg-brand-600 hover:bg-brand-700 text-white text-xs font-bold rounded-lg flex items-center gap-1.5 shadow-sm transition-colors", children: [
...
`,
          ...
          /* @__PURE__ */ jsxs("tbody", { className: "divide-y divide-line", children: [
            sortedData.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: tableColumns.length, className: "p-12", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center text-center", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-ink-secondary mb-1", children: tt("No pre-orders found") }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mb-4", children: tt("Create your first pre-order to get started") }),
              /* @__PURE__ */ jsxs(
                Link,
                {
                  href: route("store.pre-sales.create", { store_slug: store?.slug }),
...
`,
                children: tableColumns.map((col) => /* @__PURE__ */ jsx("td", { className: "p-4 text-sm text-ink-secondary", children: (() => {
                  switch (col.key) {
                    ...
                    case "order_number":
                      return /* @__PURE__ */ jsx("span", { className: "font-mono text-brand-600 dark:text-brand-400 font-semibold", children: row.order_number });
                    case "party_name":
                    ...
                    case "transaction":
                      return /* @__PURE__ */ jsx("span", { className: "text-xs font-bold uppercase bg-brand-100 text-brand-700 dark:bg-brand-500/20 dark:text-brand-400 px-2 py-1 rounded-md", children: tt("Pre-Order") });
                    case "total_amount":
                    ...
                    case "due_date":
                      return /* @__PURE__ */ jsx("span", { className: "text-ink-muted", children: row.due_date ? formatDate(row.due_date) : "-" });
                    case "status":
                      ...
                      return /* @__PURE__ */ jsx("span", { className: `px-2 py-1 rounded-md text-xs font-bold uppercase ${statusStyles[status] || "bg-sunken text-ink-secondary"}`, children: status === "completed" ? "converted" : status });
                    case "actions":
                      return /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2 relative", onClick: (e) => e.stopPropagation(), children: [
                        /* @__PURE__ */ jsx("a", { href: route("store.sales.print", { store_slug: store.slug, sale: row.id }), target: "_blank", className: "p-1.5 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-lg text-ink-muted hover:text-brand-600 transition-colors", children: /* @__PURE__ */ jsx(Printer, { size: 16 }) }),
                        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                          ...
                          activeActionMenu === row.id && /* @__PURE__ */ jsx("div", { className: "absolute right-0 top-full mt-2 w-56 bg-surface rounded-[14px] shadow-xl border border-line p-1 z-50 animate-in zoom-in-95", children: /* @__PURE__ */ jsxs("div", { className: "py-1", children: [
                            /* @__PURE__ */ jsxs(Link, { href: route("store.sales.orders.show", { store_slug: store?.slug, order: row.id }), className: "w-full text-left px-3 py-2 hover:bg-interactive-hover rounded dark:hover:bg-interactive-hover flex items-center gap-2 text-sm text-ink-secondary", children: [
                            ...
                            row.status !== "completed" && row.status !== "converted" && /* @__PURE__ */ jsxs(Fragment, { children: [
                              ...
                              /* @__PURE__ */ jsxs("button", { onClick: () => {
                                showConfirm?.({ title: "Delete Pre-Sale?", message: tt("Are you sure you want to delete this order? It will be moved to the Recycle Bin."), type: "error", confirmLabel: "Delete", onConfirm: () => router.delete(route("store.pre-sales.destroy", { store_slug: store?.slug, order: row.id }), { onSuccess: () => setAllOrders((prev) => prev.filter((o) => o.id !== row.id)) }) });
        ...
        /* @__PURE__ */ jsxs("div", { className: "md:hidden flex flex-col gap-2 px-0 py-1.5 bg-transparent", children: [
          sortedData.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-xl p-8 text-center border border-line", children: [
            /* @__PURE__ */ jsx(ShoppingBag, { size: 32, className: "mx-auto text-ink-muted mb-2" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary", children: tt("No pre-orders found") })
          ] }) : sortedData.map((row) => {
            const paid = parseFloat(row.paid_amount || 0);
            const balance = parseFloat(row.total_amount) - paid;
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("span", { className: "font-mono text-xs text-brand-600 dark:text-brand-400 font-bold", children: row.order_number }),
...
`, children: row.status || "pending" })
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center border-t border-b border-line py-2.5", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                      ...
                      /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink mt-0.5", children: formatCurrency(row.total_amount, store) })
                    ] })
                  ] }),
          ...
          /* @__PURE__ */ jsx("div", { ref: observerTarget, className: "py-4 text-center shrink-0", children: isLoading.current && /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted", children: "Loading more..." }) })
        ] })
      ] })
    ] }),
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 border-b border-line bg-gradient-to-r from-neutral-50 to-white dark:from-neutral-800 dark:to-neutral-900 shrink-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase tracking-wider", children: tt("Pre-Order Preview") }),
                /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-brand-600", children: quickViewItem.order_number })
              ] }),
              (() => {
                const statusStyles = {
                  confirmed: "bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-auto p-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-4 gap-3 mb-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "bg-app p-3 rounded-xl", children: [
                /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-ink-muted uppercase mb-1", children: "Due Date" }),
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink text-sm", children: formatDate(quickViewItem.due_date) || "Not set" })
              ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "border border-line rounded-xl overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "max-h-[300px] overflow-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
                ...
                /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: quickViewItem.items && quickViewItem.items.length > 0 ? quickViewItem.items.map((item, idx) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-interactive-hover dark:hover:bg-interactive-hover", children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: "p-3 text-center font-bold text-ink-secondary", children: item.quantity || item.quantity_requested }),
                  /* @__PURE__ */ jsx("td", { className: "p-3 text-right text-ink-secondary", children: formatCurrency(item.price || item.unit_price || 0, store) }),
                  /* @__PURE__ */ jsx("td", { className: "p-3 text-right font-bold text-ink", children: formatCurrency((item.quantity || item.quantity_requested) * (item.price || item.unit_price || 0), store) })
    ...
    conversionSuccessModal.show && /* @__PURE__ */ jsx(
      FormModal,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "p-6 text-center", children: [
          ...
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-ink mb-2", children: tt("Pre-Order Converted to Sale!") }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mb-6", children: tt("The Pre-Order has been successfully converted into a tax invoice.") }),
