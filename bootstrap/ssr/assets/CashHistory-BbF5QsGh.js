...
function CashHistory({ balance, ledger, store }) {
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Cash Ledger", activeMenu: "Money", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full bg-gray-50 dark:bg-slate-950 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-hidden px-6 pb-6 mt-2", children: /* @__PURE__ */ jsx("div", { className: "bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden flex flex-col h-full", children: /* @__PURE__ */ jsx("div", { className: "overflow-auto custom-scrollbar", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
        /* @__PURE__ */ jsx("thead", { className: "bg-gray-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800", children: /* @__PURE__ */ jsxs("tr", { children: [
          /* @__PURE__ */ jsx("th", { className: "px-4 py-4 text-1xs font-bold text-slate-400 uppercase tracking-tight border-r border-slate-50 dark:border-slate-800", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            "Type ",
          ...
          /* @__PURE__ */ jsx("th", { className: "px-4 py-4 text-1xs font-bold text-slate-400 uppercase tracking-tight text-right w-48", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            "Amount ",
            /* @__PURE__ */ jsx(Filter, { size: 12, className: "opacity-0 group-hover:opacity-100" })
          ] }) }),
        ...
        /* @__PURE__ */ jsxs("tbody", { className: "divide-y divide-slate-100 dark:divide-slate-800", children: [
          filteredLedger.map((item, idx) => /* @__PURE__ */ jsxs("tr", { className: `${idx % 2 === 0 ? "bg-white" : "bg-gray-50"} dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group`, children: [
            ...
            /* @__PURE__ */ jsxs("td", { className: "px-4 py-4 text-sm font-bold text-slate-600 dark:text-slate-300 border-r border-slate-50 dark:border-slate-800", children: [
              item.name,
              item.description && item.description !== item.name && /* @__PURE__ */ jsx("p", { className: "text-2xs text-slate-400 font-normal mt-0.5 line-clamp-1", children: item.description })
            ] }),
            ...
            /* @__PURE__ */ jsxs("td", { className: `px-4 py-4 text-right text-sm font-black tabular-nums ${item.mode === "in" ? "text-emerald-500" : "text-rose-500"}`, children: [
              getCurrencySymbol(),
              " ",
