    ...
    /* @__PURE__ */ jsxs("div", { style: { maxWidth: 760, margin: "0 auto", padding: "32px 24px" }, children: [
      ...
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          onMouseEnter: (e) => {
            e.currentTarget.style.background = vq.slate[100];
            e.currentTarget.style.borderColor = vq.indigo[500];
          },
          onMouseLeave: (e) => {
            e.currentTarget.style.background = vq.slate[50];
            e.currentTarget.style.borderColor = vq.slate[200];
          },
          children: [
            /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 14 }, children: [
              /* @__PURE__ */ jsx("div", { style: { width: 44, height: 44, borderRadius: 12, background: vq.slate[100], display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsx(RotateCcw, { size: 20, color: vq.indigo[500] }) }),
              /* @__PURE__ */ jsxs("div", { style: { textAlign: "left" }, children: [
            ...
            /* @__PURE__ */ jsx(ArrowRight, { size: 18, color: vq.slate[400] })
          ]
        }
      ),
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 14 }, children: [
          /* @__PURE__ */ jsx("div", { style: { width: 42, height: 42, borderRadius: 12, background: isWorking ? vq.emerald[500] : vq.slate[100], display: "flex", alignItems: "center", justifyContent: "center" }, children: isWorking ? /* @__PURE__ */ jsx(CheckCircle2, { size: 20, color: vq.emerald[500] }) : /* @__PURE__ */ jsx(LogIn, { size: 20, color: vq.slate[400] }) }),
          /* @__PURE__ */ jsxs("div", { children: [
        ...
        isWorking && /* @__PURE__ */ jsx("div", { style: { padding: "5px 12px", borderRadius: 8, background: vq.emerald[500], border: "1px solid #10b98125", color: vq.emerald[500], fontSize: 12, fontWeight: 700 }, children: "Active" })
      ] }),
      /* @__PURE__ */ jsxs("div", { style: { marginTop: 24, padding: "14px 18px", borderRadius: 14, background: vq.slate[50], border: "1px solid #e2e8f0", fontSize: 13, color: vq.slate[500], display: "flex", alignItems: "center", gap: 10 }, children: [
        /* @__PURE__ */ jsx(Package, { size: 14, color: vq.slate[400] }),
