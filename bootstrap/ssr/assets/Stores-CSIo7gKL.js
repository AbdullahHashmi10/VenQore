    ...
    /* @__PURE__ */ jsxs("div", { style: { padding: 24 }, children: [
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 12, marginBottom: 24 }, children: [
        /* @__PURE__ */ jsxs("form", { onSubmit: handleSearch, style: { display: "flex", gap: 12, flex: 1 }, children: [
          ...
          /* @__PURE__ */ jsx("button", { type: "submit", style: { padding: "0 24px", background: "#6366f1", color: "#fff", border: "none", borderRadius: 12, fontWeight: 700, cursor: "pointer" }, children: "Search" })
        ] }),
        selected.length > 0 && !trashed && /* @__PURE__ */ jsxs("button", { onClick: handleBulkDelete, style: { padding: "0 24px", background: "#ef4444", color: "#fff", border: "none", borderRadius: 12, fontWeight: 700, cursor: "pointer" }, children: [
          "Delete ",
          selected.length,
          " Selected"
        ] })
      ...
      /* @__PURE__ */ jsx("div", { style: { background: T.bgTable, border: `1px solid ${T.border}`, borderRadius: 16, overflow: "hidden" }, children: /* @__PURE__ */ jsxs("table", { style: { width: "100%", borderCollapse: "collapse" }, children: [
        ...
        /* @__PURE__ */ jsxs("tbody", { children: [
          tenants.data.map((t) => /* @__PURE__ */ jsxs("tr", { style: { borderBottom: `1px solid ${T.rowBorder}`, transition: "background 0.2s", background: selected.includes(t.id) ? "rgba(99,102,241,0.05)" : "transparent" }, children: [
            ...
            /* @__PURE__ */ jsx("td", { style: { padding: "16px 20px" }, children: /* @__PURE__ */ jsx("span", { style: { fontSize: 10, fontWeight: 800, color: "#6366f1", background: "rgba(99,102,241,0.1)", border: "1px solid rgba(99,102,241,0.2)", padding: "2px 8px", borderRadius: 4, textTransform: "uppercase" }, children: t.plan }) }),
            /* @__PURE__ */ jsx("td", { style: { padding: "16px 20px" }, children: /* @__PURE__ */ jsx("span", { style: { fontSize: 10, fontWeight: 800, color: t.status === "active" ? "#10b981" : "#f59e0b", background: (t.status === "active" ? "#10b981" : "#f59e0b") + "10", border: "1px solid " + (t.status === "active" ? "#10b981" : "#f59e0b") + "20", padding: "2px 8px", borderRadius: 4, textTransform: "uppercase" }, children: t.status }) }),
            trashed && /* @__PURE__ */ jsx("td", { style: { padding: "16px 20px", color: "#ef4444", fontSize: 12 }, children: t.deleted_at }),
            /* @__PURE__ */ jsx("td", { style: { padding: "16px 20px", textAlign: "right" }, children: trashed ? /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 8, justifyContent: "flex-end" }, children: [
              /* @__PURE__ */ jsxs("button", { onClick: () => onRestore(t.id), style: { padding: "6px 12px", borderRadius: 8, background: "rgba(16,185,129,0.1)", color: "#10b981", border: "1px solid rgba(16,185,129,0.2)", fontSize: 12, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 4 }, children: [
                /* @__PURE__ */ jsx(RotateCcw, { size: 14 }),
                " Restore"
              ] }),
              /* @__PURE__ */ jsxs("button", { onClick: () => onPurge(t.id), style: { padding: "6px 12px", borderRadius: 8, background: "rgba(239,68,68,0.1)", color: "#ef4444", border: "1px solid rgba(239,68,68,0.2)", fontSize: 12, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 4 }, children: [
              ...
              /* @__PURE__ */ jsxs(Dropdown.Content, { align: "right", width: "48", children: [
                ...
                /* @__PURE__ */ jsx(Dropdown.Link, { href: route("platform.store.destroy", t.id), method: "delete", as: "button", style: { fontSize: 13, fontWeight: 500, color: "#ef4444" }, children: "Trash Store" })
              ] })
            ] }) })
          ] }, t.id)),
          tenants.data.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsxs("td", { colSpan: trashed ? 6 : 5, style: { padding: 64, textAlign: "center", color: "#475569" }, children: [
