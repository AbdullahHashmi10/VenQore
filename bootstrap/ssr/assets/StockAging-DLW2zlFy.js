  ...
  const reportStats = [
    {
      ...
      icon: /* @__PURE__ */ jsx(DollarSign, { size: 20, className: "text-ink-muted" }),
      type: "neutral"
    },
    {
  ...
  const columns = [
    {
      ...
      render: (row) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 py-1", children: [
        /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-lg bg-app flex items-center justify-center shrink-0 border border-line overflow-hidden", children: /* @__PURE__ */ jsx(Package, { size: 16, className: "text-ink-muted" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "font-bold text-sm text-ink line-clamp-1", children: row.product }),
          /* @__PURE__ */ jsxs("div", { className: "text-2xs font-mono text-ink-muted", children: [
            "Batch: ",
            row.batch || "N/A"
          ] })
        ] })
      ...
      render: (row) => {
        ...
        return /* @__PURE__ */ jsxs("div", { className: "w-full max-w-[140px]", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-1xs mb-1 font-bold", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-ink-muted", children: "Target: 90" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "h-1.5 w-full bg-sunken rounded-full overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: `h-full ${color} transition-all duration-slower`, style: { width: `${percentage}%` } }) })
        ] });
      }
    },
    {
    ...
    },
    {
      ...
      align: "right",
      sortable: true,
      render: (row) => /* @__PURE__ */ jsx("span", { className: "font-mono text-sm font-bold text-ink-secondary", children: formatNumber(row.quantity) })
    },
    {
      key: "cost_value",
      ...
      render: (row) => {
        ...
        return /* @__PURE__ */ jsx("div", { className: "font-mono font-bold text-sm text-ink", children: formatCurrency(val) });
      }
    }
  ];
  const filterDefs = [
