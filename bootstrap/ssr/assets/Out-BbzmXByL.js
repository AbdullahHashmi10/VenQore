...
import { ArrowUpCircle, CalendarDays, Banknote, Building2, CreditCard, Smartphone, Hash, FileText, CheckCircle2, Search, X, User, Minus, TrendingUp, TrendingDown } from "lucide-react";
...
function PartySearchField({ selectedParty, onSelect, onClear }) {
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "relative", children: [
    /* @__PURE__ */ jsxs("div", { style: { outline: "none" }, className: `flex items-center gap-2 w-full px-3 py-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border ${selectedParty ? "border-rose-500" : "border-slate-200 dark:border-slate-700"} transition-all focus-within:border-rose-500`, children: [
      ...
      loading && /* @__PURE__ */ jsx("div", { className: "w-4 h-4 border-2 border-slate-300 border-t-rose-500 rounded-full animate-spin shrink-0" }),
    ...
    selectedParty && /* @__PURE__ */ jsxs("div", { className: "mt-1.5 flex items-center gap-2 px-1", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsx("div", { className: "w-5 h-5 rounded-full bg-rose-100 dark:bg-rose-900/40 flex items-center justify-center", children: /* @__PURE__ */ jsx(User, { size: 10, className: "text-rose-600" }) }),
...
function PaymentOut({ parties = [], bankAccounts = [], selected_party_id = null }) {
  const {
    store
  } = usePage().props;
  const [loading, setLoading] = useState(false);
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Payment Out", children: [
    /* @__PURE__ */ jsx(Head, { title: "Record Payment Out" }),
    /* @__PURE__ */ jsx("div", { className: "h-full flex flex-col items-center justify-center overflow-auto py-6 px-4", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-xl relative", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute -inset-1 bg-gradient-to-r from-rose-500/20 to-red-500/10 rounded-3xl blur-xl pointer-events-none" }),
      /* @__PURE__ */ jsxs("div", { className: "relative bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden", children: [
        /* @__PURE__ */ jsxs("div", { className: "relative bg-gradient-to-r from-rose-600 to-red-600 px-6 py-5 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative flex items-center gap-4", children: [
            /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-white/20 backdrop-blur flex items-center justify-center shadow-lg", children: /* @__PURE__ */ jsx(ArrowUpCircle, { size: 22, className: "text-white" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h1", { className: "text-xl font-black text-white tracking-tight", children: "Record Payment Out" }),
              /* @__PURE__ */ jsx("p", { className: "text-rose-100 text-sm", children: "Money paid out to a contact" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "p-6 space-y-5", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-2", children: METHODS.map((m) => {
              ...
              return /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `flex flex-col items-center gap-1.5 py-2.5 px-2 rounded-xl border-2 transition-all text-[10px] font-bold uppercase ${isSelected ? "border-rose-500 bg-rose-50 dark:bg-rose-900/20 text-rose-700 dark:text-rose-400" : "border-slate-200 dark:border-slate-700 text-slate-500 hover:border-slate-300 dark:hover:border-slate-600 bg-slate-50 dark:bg-slate-800/40"}`,
                  children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsx(FileText, { size: 13, className: "absolute left-3 top-1/2 -translate-y-1/2 text-slate-400" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
