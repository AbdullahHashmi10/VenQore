    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-slower", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("h1", { className: "text-2xl font-bold text-ink flex items-center gap-3", children: [
            /* @__PURE__ */ jsx(Ticket, { className: "text-brand-400" }),
            "AppSumo Code Bank"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-sm mt-1", children: "Manage one-time redemption codes for the AppSumo LTD campaign." })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-white/5 border border-line dark:border-white/10 p-6 rounded-2xl", children: [
          /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-xs font-bold uppercase tracking-widest mb-1", children: "Total Codes" }),
          /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold text-ink", children: stats.total.toLocaleString() })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-emerald-500/5 border border-emerald-500/10 p-6 rounded-2xl", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold text-emerald-400", children: stats.available.toLocaleString() })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-brand-500/5 border border-brand-500/10 p-6 rounded-2xl", children: [
          /* @__PURE__ */ jsx("p", { className: "text-brand-500/60 text-xs font-bold uppercase tracking-widest mb-1", children: "Redeemed" }),
          /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold text-brand-400", children: stats.redeemed.toLocaleString() })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-white/5 border border-white/10 rounded-2xl overflow-hidden backdrop-blur-sm", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-4 border-b border-white/10 flex items-center justify-between gap-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Filter, { size: 16, className: "text-ink-muted" }),
            /* @__PURE__ */ jsxs(
              "select",
              {
        ...
        /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left", children: [
          ...
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line dark:divide-white/5", children: codes.data.length > 0 ? codes.data.map((item) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-interactive-hover dark:hover:bg-white/5 transition-colors group", children: [
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsx("code", { className: "text-ink font-mono font-bold bg-sunken dark:bg-white/10 px-2 py-1 rounded text-sm", children: item.code }) }),
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsx("span", { className: "text-ink-secondary text-sm", children: item.plan_tier }) }),
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: item.is_redeemed ? /* @__PURE__ */ jsxs("div", { className: "space-y-0.5", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "text-2xs text-ink-muted break-all", children: item.redeemed_by_email })
            ] }) : /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-ink-muted text-xs font-bold", children: [
            ...
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-sm text-ink-muted text-right", children: new Date(item.created_at).toLocaleDateString() })
          ] }, item.id)) : /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "5", className: "px-6 py-12 text-center", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-3 text-ink-muted", children: [
            /* @__PURE__ */ jsx(Ticket, { size: 48, className: "opacity-20" }),
            /* @__PURE__ */ jsx("p", { children: "No codes found. Generate some above!" })
          ] }) }) }) })
        ] }) })
      ] }),
      showGenerate && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-neutral-900/60 dark:bg-void-950/95 backdrop-blur-md z-drawer flex items-center justify-center p-6", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface border border-line dark:border-white/10 rounded-2xl max-w-md w-full p-8 shadow-2xl animate-in zoom-in-95 duration-slow", children: [
        /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-bold text-ink mb-6 flex items-center gap-3", children: [
          /* @__PURE__ */ jsx(Plus, { className: "text-brand-400" }),
          "Bulk Generate Codes"
        ] }),
        /* @__PURE__ */ jsxs("form", { onSubmit: handleGenerate, className: "space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Count (Max 1,000)" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "number",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Plan Tier" }),
            /* @__PURE__ */ jsxs(
              "select",
              {
                value: data.tier,
      ...
      showImport && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-void-950/95 backdrop-blur-md z-drawer flex items-center justify-center p-6", children: /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 border border-white/10 rounded-2xl max-w-xl w-full p-8 shadow-2xl animate-in zoom-in-95 duration-slow", children: [
        /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-bold text-white mb-6 flex items-center gap-3 text-glow", children: [
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: handleImport, className: "space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Codes (Paste comma or newline separated)" }),
            /* @__PURE__ */ jsx(
              "textarea",
              {
                rows: "8",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: "Assign to Plan Tier" }),
            /* @__PURE__ */ jsxs(
              "select",
              {
                value: data.tier,
