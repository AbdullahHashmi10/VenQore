...
function PartySearchField({ value, selectedParty, onSelect, onClear, store }) {
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "relative", children: [
    ...
    selectedParty && /* @__PURE__ */ jsxs("div", { className: "mt-1.5 flex items-center gap-2 px-1", children: [
      ...
      selectedParty.type && /* @__PURE__ */ jsx("span", { className: "text-3xs font-bold uppercase px-1.5 py-0.5 rounded-full bg-white/10 text-slate-400", children: selectedParty.type })
    ] }),
    open && results.length > 0 && /* @__PURE__ */ jsx("div", { className: "absolute top-full left-0 right-0 mt-1 rounded-xl border border-white/10 shadow-2xl z-[60] max-h-52 overflow-auto", style: { background: vq.slate[800] }, children: results.map((party) => {
      ...
      return /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            ...
            settled && /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold px-1.5 py-0.5 rounded-full shrink-0 bg-white/10 text-slate-400", children: "Settled" })
          ]
        },
        party.id
      );
    }) }),
    open && results.length === 0 && !searching && query && /* @__PURE__ */ jsxs("div", { className: "absolute top-full left-0 right-0 mt-1 rounded-xl border border-white/10 shadow-xl z-[60] px-4 py-4 text-center text-sm text-slate-500", style: { background: vq.slate[800] }, children: [
      'No results for "',
      query,
      '"'
    ] })
...
function CustomSelect({ value, onChange, options, placeholder, error, onAddNew }) {
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "relative", children: [
    ...
    open && /* @__PURE__ */ jsxs("div", { className: "absolute top-full left-0 right-0 mt-1 rounded-xl shadow-2xl border border-white/10 z-[120] py-1 max-h-52 overflow-auto hide-scrollbar", style: { background: vq.slate[800] }, children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full bg-slate-50 dark:bg-slate-950 p-2 gap-1 overflow-y-auto md:overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "md:hidden flex flex-col gap-0 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm shrink-0", children: [
        ...
        showMobileFilters && /* @__PURE__ */ jsx("div", { className: "px-3 pb-2 border-t border-slate-100 dark:border-slate-800 pt-2 animate-in slide-in-from-top duration-200 flex flex-col gap-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-slate-400 uppercase tracking-wider shrink-0", children: "Period:" }),
          /* @__PURE__ */ jsxs("div", { className: "flex bg-slate-100 dark:bg-slate-800 rounded-lg p-1 gap-1 flex-1", children: [
            /* @__PURE__ */ jsx("button", { onClick: () => {
              handleFilterChange("all");
              setShowMobileFilters(false);
            }, className: `flex-1 text-center py-1 rounded text-2xs font-bold uppercase transition-colors ${activeFilter === "all" ? "bg-white dark:bg-slate-700 text-slate-900 dark:text-white shadow-sm" : "text-slate-400 hover:text-slate-600"}`, children: "All" }),
            /* @__PURE__ */ jsx("button", { onClick: () => {
              handleFilterChange("today");
              setShowMobileFilters(false);
            }, className: `flex-1 text-center py-1 rounded text-2xs font-bold uppercase transition-colors ${activeFilter === "today" ? "bg-rose-100 dark:bg-rose-900/20 text-rose-600" : "text-slate-400 hover:text-slate-600"}`, children: "Today" }),
            /* @__PURE__ */ jsx("button", { onClick: () => {
              handleFilterChange("month");
              setShowMobileFilters(false);
            }, className: `flex-1 text-center py-1 rounded text-2xs font-bold uppercase transition-colors ${activeFilter === "month" ? "bg-rose-100 dark:bg-rose-900/20 text-rose-600" : "text-slate-400 hover:text-slate-600"}`, children: "Month" }),
            /* @__PURE__ */ jsx("button", { onClick: () => {
              handleFilterChange("year");
              setShowMobileFilters(false);
            }, className: `flex-1 text-center py-1 rounded text-2xs font-bold uppercase transition-colors ${activeFilter === "year" ? "bg-rose-100 dark:bg-rose-900/20 text-rose-600" : "text-slate-400 hover:text-slate-600"}`, children: "Year" })
          ] })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "hidden md:flex flex-col flex-1 min-h-0 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between md:justify-start gap-2 w-full md:w-auto", children: [
            /* @__PURE__ */ jsxs("div", { className: "hidden md:flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-1", children: [
                /* @__PURE__ */ jsx("button", { onClick: () => handleFilterChange("all"), className: `px-3 py-1 rounded text-2xs font-bold uppercase transition-colors ${activeFilter === "all" ? "bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-white" : "text-slate-400 hover:text-slate-600"}`, children: "All Time" }),
                /* @__PURE__ */ jsx("button", { onClick: () => handleFilterChange("today"), className: `px-3 py-1 rounded text-2xs font-bold uppercase transition-colors ${activeFilter === "today" ? "bg-rose-100 dark:bg-rose-900/20 text-rose-600" : "text-slate-400 hover:text-slate-600"}`, children: "Today" })
              ] })
            ] }),
        ...
        showMobileFilters && /* @__PURE__ */ jsx("div", { className: "md:hidden px-3 py-2.5 border-b border-slate-150 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 animate-in slide-in-from-top duration-200 flex flex-col gap-2 w-full", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-slate-400 uppercase tracking-wider", children: "Time:" }),
          /* @__PURE__ */ jsxs("div", { className: "flex bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-1 flex-1", children: [
            /* @__PURE__ */ jsx("button", { onClick: () => {
              handleFilterChange("all");
              setShowMobileFilters(false);
            }, className: `flex-1 text-center py-1 rounded text-2xs font-bold uppercase transition-colors ${activeFilter === "all" ? "bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-white" : "text-slate-400 hover:text-slate-600"}`, children: "All Time" }),
            /* @__PURE__ */ jsx("button", { onClick: () => {
              handleFilterChange("today");
              setShowMobileFilters(false);
            }, className: `flex-1 text-center py-1 rounded text-2xs font-bold uppercase transition-colors ${activeFilter === "today" ? "bg-rose-100 dark:bg-rose-900/20 text-rose-600" : "text-slate-400 hover:text-slate-600"}`, children: "Today" })
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-auto hidden md:block", children: [
          /* @__PURE__ */ jsxs("table", { className: "hidden md:table w-full text-left border-collapse", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-slate-100 dark:divide-slate-800 bg-white dark:bg-slate-900", children: sortedExpenses.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsxs("td", { colSpan: 7, className: "p-12 text-center text-slate-400", children: [
              ...
              /* @__PURE__ */ jsx("td", { className: "p-4", children: /* @__PURE__ */ jsx("span", { className: `px-2.5 py-1 rounded-full text-2xs font-black uppercase tracking-wide border ${item.category_color ? `bg-${item.category_color}-50 text-${item.category_color}-600 border-${item.category_color}-200` : "bg-slate-100 text-slate-600 border-slate-200"} `, children: item.category || "Uncategorized" }) }),
              /* @__PURE__ */ jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
                ...
                item.payee && /* @__PURE__ */ jsxs("span", { className: "text-1xs font-semibold text-slate-500 flex items-center gap-1", children: [
              ...
              /* @__PURE__ */ jsxs("td", { className: "p-4 text-right", children: [
                ...
                item.tax_amount > 0 && /* @__PURE__ */ jsxs("p", { className: "text-3xs text-slate-400", children: [
                  "(Inc. Tax: ",
                  getCurrencySymbol(),
                  " ",
                  item.tax_amount,
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    ...
                    item.payee && /* @__PURE__ */ jsx("p", { className: "text-2xs text-slate-400 font-semibold mt-0.5", children: item.payee })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "text-right shrink-0 ml-2", children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "text-2xs text-slate-400 font-semibold block mt-0.5", children: formatDate(item.date) })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-3xs font-black uppercase bg-rose-100 text-rose-700 dark:bg-rose-500/20 dark:text-rose-400 px-2 py-0.5 rounded border border-rose-200/30", children: item.category || "Uncategorized" }),
                  item.payment_method && /* @__PURE__ */ jsx("span", { className: "text-3xs font-black uppercase bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400 px-2 py-0.5 rounded border border-slate-200/50 dark:border-slate-700/50", children: item.payment_method })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-t border-slate-100 dark:border-slate-800/60 pt-2 mt-1", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6", children: [
                    ...
                    parseFloat(item.tax_amount) > 0 && /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("span", { className: "text-3xs text-slate-400 font-bold uppercase block tracking-wider", children: "Tax" }),
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mt-1.5", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-3xs font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-widest", children: "Active V3 Sync" })
              ] }),
              /* @__PURE__ */ jsx("p", { className: "text-3xs font-black text-slate-400 uppercase tracking-widest opacity-80", children: "Verified Ledger Entry" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6", children: [
          grandTotalValue > 0 && /* @__PURE__ */ jsxs("div", { className: "hidden lg:block text-right px-6 py-2.5 rounded-2xl bg-indigo-50/50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800/50 shadow-inner", children: [
            /* @__PURE__ */ jsx("p", { className: "text-3xs font-black text-indigo-400 uppercase tracking-widest leading-none mb-1.5", children: "Grand Total Impact" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex-1 overflow-y-auto px-4 sm:px-8 py-4 sm:py-8 custom-scrollbar", children: [
        ...
        /* @__PURE__ */ jsx("form", { encType: "multipart/form-data", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8 xl:gap-12", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              /* @__PURE__ */ jsxs("div", { id: "tour-expense-category", className: "group", children: [
                /* @__PURE__ */ jsxs("label", { className: "block text-2xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 ml-1 group-focus-within:text-indigo-500 transition-colors", children: [
                  "Expense Category ",
              ...
              /* @__PURE__ */ jsxs("div", { id: "tour-expense-amount", className: "group p-6 rounded-[2rem] bg-indigo-600 text-white shadow-xl shadow-indigo-600/20 relative overflow-hidden", children: [
                ...
                /* @__PURE__ */ jsxs("label", { className: "block text-3xs font-black text-indigo-200 uppercase tracking-widest mb-3", children: [
                  "Amount (Excl. Tax) ",
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              /* @__PURE__ */ jsxs("div", { className: "group", children: [
                /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 ml-1", children: "Payee / Vendor" }),
                /* @__PURE__ */ jsx(
                  PartySearchField,
                  {
                    store,
              ...
              /* @__PURE__ */ jsxs("div", { className: "group", children: [
                /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 ml-1", children: "Payment Method" }),
              ...
              formData.payment_method === "bank" && /* @__PURE__ */ jsxs("div", { className: "animate-in fade-in slide-in-from-top-2 duration-300", children: [
                /* @__PURE__ */ jsxs("label", { className: "block text-2xs font-black text-blue-500 dark:text-blue-400 uppercase tracking-widest mb-2 ml-1", children: [
                  "Bank Account ",
                  /* @__PURE__ */ jsx("span", { className: "text-rose-500", children: "*" })
                ] }),
                /* @__PURE__ */ jsx(
                    ...
                    options: bankAccounts.map((b) => ({
                      ...
                      label: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2 w-full", children: [
                        /* @__PURE__ */ jsxs("span", { className: "truncate", children: [
                          b.name || b.bank_name,
                          " ",
                          b.account_number && /* @__PURE__ */ jsxs("span", { className: "text-slate-500 text-2xs ml-1", children: [
                            "(",
                            b.account_number,
                            ")"
                          ] })
                        ] }),
                        /* @__PURE__ */ jsxs("span", { className: "text-2xs font-bold text-slate-400 shrink-0", children: [
                          getCurrencySymbol(),
                          " ",
              ...
              formData.payment_method === "cash" && /* @__PURE__ */ jsxs("div", { className: "animate-in fade-in slide-in-from-top-2 duration-300", children: [
                /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black text-emerald-500 dark:text-emerald-400 uppercase tracking-widest mb-2 ml-1", children: "Current Liquidity" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "group", children: [
                /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 ml-1", children: "Tax Amount" }),
                /* @__PURE__ */ jsxs("div", { className: "relative flex items-center", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              /* @__PURE__ */ jsxs("div", { className: "group", children: [
                /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 ml-1", children: "Reference No." }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxs("div", { id: "tour-expense-description", className: "group", children: [
                /* @__PURE__ */ jsxs("label", { className: "block text-2xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 ml-1", children: [
                  "Description ",
                  /* @__PURE__ */ jsx("span", { className: "text-rose-500", children: "*" })
                ] }),
                /* @__PURE__ */ jsx(
              ...
              /* @__PURE__ */ jsxs("div", { className: "group", children: [
                /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 ml-1", children: "Physical Evidence" }),
                /* @__PURE__ */ jsxs(
                  "label",
                  {
                    ...
                    children: [
                      ...
                      formData.attachment ? /* @__PURE__ */ jsxs(Fragment, { children: [
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                          ...
                          /* @__PURE__ */ jsx("p", { className: "text-3xs text-slate-500 font-bold uppercase tracking-widest", children: "Captured Successfully" })
                        ] })
                      ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                          ...
                          /* @__PURE__ */ jsx("p", { className: "text-3xs text-slate-400 dark:text-slate-500 font-bold uppercase tracking-widest", children: "PDF or Image Transfer" })
                        ] })
                      ] })
                    ]
                  }
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-20 px-4 sm:px-8 py-4 sm:py-6 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 flex flex-col sm:flex-row items-center justify-between gap-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsx("p", { className: "text-3xs font-black text-slate-400 uppercase tracking-widest leading-none mb-2", children: "Total Payable" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "hidden md:flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest", children: formData.payment_method === "cash" ? "Direct Liquidity Reduction" : "Bank Reconciliation Pending" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 px-2 py-1 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-3xs text-slate-500 font-bold uppercase tracking-widest", children: "Automatic V3 Ledger Sync" })
            ] })
          ] })
        ] }),
