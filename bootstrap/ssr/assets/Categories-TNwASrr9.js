...
function Categories({ categories: serverCategories = [], stats, filters }) {
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Categories", activeMenu: "Stock", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full bg-app p-2 gap-1 overflow-hidden relative", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-1 shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1.5 bg-brand-100 dark:bg-brand-900/30 text-brand-600 dark:text-brand-400 rounded-lg", children: /* @__PURE__ */ jsx(Layers, { size: 16 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Total Categories" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-ink", children: stats?.total_categories || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Main Categories" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-ink", children: stats?.parent_categories || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: tt("Products Linked") })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-emerald-600", children: stats?.total_products || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1.5 bg-brand-100 dark:bg-brand-900/30 text-brand-600 dark:text-brand-400 rounded-lg shrink-0", children: /* @__PURE__ */ jsx(BarChart3, { size: 16 }) }),
            /* @__PURE__ */ jsx("div", { className: "min-w-0", children: /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase truncate", children: "Top Category" }) })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-brand-600 truncate max-w-[50%]", title: stats?.most_populated?.name, children: stats?.most_populated?.name || "-" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2 bg-surface px-3 py-2 rounded-xl border border-line shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
          /* @__PURE__ */ jsxs("h1", { className: "text-lg font-bold text-ink uppercase tracking-tight shrink-0", children: [
            tt("Product"),
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-brand-600", children: "Categories (Updated)" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex items-center gap-0.5 border-l border-line pl-2", children: /* @__PURE__ */ jsxs(
            "button",
            {
      ...
      selectedCategories.length > 0 && /* @__PURE__ */ jsxs("div", { className: "bg-brand-600 text-white px-4 py-2 rounded-xl flex items-center justify-between shadow-lg animate-in slide-in-from-top-2", children: [
...
`,
          ...
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: sortedCategories.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: tableColumns.length + 1, className: "p-12 text-center text-ink-muted", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center", children: [
            /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-sunken rounded-full flex items-center justify-center mb-4", children: /* @__PURE__ */ jsx(Tag, { size: 32, className: "text-ink-muted" }) }),
            /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-ink-secondary", children: "No categories found" })
...
`,
                  ...
                  switch (col.key) {
                    case "name":
                      return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                        /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-lg bg-brand-50 dark:bg-brand-500/10 flex items-center justify-center", children: /* @__PURE__ */ jsx(Tag, { size: 14, className: "text-brand-600 dark:text-brand-400" }) }),
                        /* @__PURE__ */ jsxs("div", { children: [
                          /* @__PURE__ */ jsx("p", { className: "font-semibold text-ink", children: row.name }),
                          row.parent && /* @__PURE__ */ jsxs("p", { className: "text-2xs text-ink-muted flex items-center gap-1", children: [
                    ...
                    case "description":
                      return /* @__PURE__ */ jsx("span", { className: "text-ink-muted truncate max-w-xs block", children: row.description || "-" });
                    case "products_count":
                      return /* @__PURE__ */ jsx("span", { className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-sunken text-ink dark:text-ink-secondary", children: row.products_count || 0 });
                    case "created_at":
                      return /* @__PURE__ */ jsx("span", { className: "text-ink-muted text-xs", children: new Date(row.created_at).toLocaleDateString() });
                    case "actions":
        ...
        /* @__PURE__ */ jsx("div", { ref: observerTarget, className: "p-4 text-center text-ink-muted text-sm border-t border-line opacity-0", children: nextPageUrl ? "Loading..." : sortedCategories.length > 0 ? "End of list" : "" })
      ] })
    ] }),
    /* @__PURE__ */ jsx(
      FormModal,
