  ...
  return /* @__PURE__ */ jsxs(
    ToolShell,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("section", { className: "mb-8 vq-tool-panel vq-tool-panel--pad", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold uppercase tracking-wide text-ink-muted mb-4", children: "Store & Register Shift Info" }),
        ...
        /* @__PURE__ */ jsxs("section", { className: "mb-8 p-5 rounded-2xl bg-brand-500/[0.03] border border-brand-500/10", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsxs("h3", { className: "text-sm font-bold uppercase tracking-wide text-brand-600 dark:text-brand-400 flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxs("section", { className: "mb-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsxs("h3", { className: "text-sm font-bold uppercase tracking-wide text-ink-muted flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-2 mb-4", children: denominations.map((d, idx) => {
            ...
            return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 p-2.5 rounded-xl vq-tool-well", children: [
              /* @__PURE__ */ jsx("span", { className: `text-2xs font-bold uppercase px-2 py-0.5 rounded ${d.type === "coin" ? "bg-amber-500/10 text-amber-600 dark:text-amber-400" : "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400"}`, children: d.type }),
              /* @__PURE__ */ jsx(
                "input",
                {
              ...
              /* @__PURE__ */ jsxs("div", { className: "w-28 text-right font-bold text-sm text-ink shrink-0", children: [
                symbol,
                subtotal.toFixed(2)
              ] }),
              /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsxs("section", { className: "mb-8 p-5 rounded-2xl vq-tool-well", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold uppercase tracking-wide text-ink-muted mb-4", children: "Till Summary & Variance" }),
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-4 gap-4 text-center", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-xl vq-tool-inset", children: [
              /* @__PURE__ */ jsx("span", { className: "block text-2xs font-bold uppercase text-ink-muted", children: "Bills Total" }),
              /* @__PURE__ */ jsxs("span", { className: "text-lg font-bold text-ink", children: [
                symbol,
                totals.totalBills.toFixed(2)
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-xl vq-tool-inset", children: [
              /* @__PURE__ */ jsx("span", { className: "block text-2xs font-bold uppercase text-ink-muted", children: "Coins Total" }),
              /* @__PURE__ */ jsxs("span", { className: "text-lg font-bold text-ink", children: [
                symbol,
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-xl vq-tool-inset", children: [
              /* @__PURE__ */ jsx("span", { className: "block text-2xs font-bold uppercase text-ink-muted", children: "Total Counted Cash" }),
              /* @__PURE__ */ jsxs("span", { className: "text-xl font-bold text-brand-600 dark:text-brand-400", children: [
                symbol,
            ...
            /* @__PURE__ */ jsxs("div", { className: `p-3 rounded-xl border ${totals.status === "exact" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-600 dark:text-emerald-400" : totals.status === "over" ? "bg-blue-500/10 border-blue-500/20 text-blue-600 dark:text-blue-400" : "bg-red-500/10 border-red-500/20 text-red-600 dark:text-red-400"}`, children: [
              /* @__PURE__ */ jsx("span", { className: "block text-2xs font-bold uppercase", children: "Variance (Over/Short)" }),
              /* @__PURE__ */ jsx("span", { className: "text-xl font-bold", children: totals.variance > 0 ? `+${symbol}${totals.variance.toFixed(2)} OVER` : totals.variance < 0 ? `-${symbol}${Math.abs(totals.variance).toFixed(2)} SHORT` : `${symbol}0.00 BALANCED` })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("section", { className: "mb-8", children: [
