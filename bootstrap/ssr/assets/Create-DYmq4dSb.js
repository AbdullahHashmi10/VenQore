...
import { Info, X, Plus, ArrowLeft, Settings, User, Package, Wallet, CheckCircle2, Zap, ScanBarcode, CreditCard, Banknote, ChevronRight, Type, GripVertical, Trash2, Printer } from "lucide-react";
...
const CreatePurchaseOrder = ({ purchaseOrder }) => {
  ...
  useEffect(() => {
    if (purchaseOrder) {
      setEditState({
        ...
        date: purchaseOrder.order_date || (/* @__PURE__ */ new Date()).toISOString().split("T")[0],
  ...
  const currentPurchase = isEditMode ? editState || { items: [], supplier: null, amountPaid: 0 } : activePurchases.find((p) => p.id === currentPurchaseId) || activePurchases[0];
  useEffect(() => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const cashAccount = {
          id: realCashAccount?.id || "",
          // Safe fallback to empty string if missing (backend validation will catch it)
        ...
        const bankGLId = generalBankAccount?.id;
  ...
  const processPurchase = async (shouldPrint = false) => {
    ...
    try {
      ...
      const url = isEditMode ? route("store.purchase-orders.update", currentPurchase.id) : route("store.purchase-orders.store", { store_slug: store.slug });
  ...
  if (!currentPurchase || isEditMode && !editState) {
    return /* @__PURE__ */ jsx("div", { className: "flex h-screen items-center justify-center bg-slate-50 dark:bg-slate-900", children: /* @__PURE__ */ jsx("p", { className: "text-slate-500 animate-pulse", children: "Initializing Purchase Order..." }) });
  }
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: isEditMode ? `Edit Purchase Order #${editState?.invoiceNumber || ""}` : "New Purchase Order", activeMenu: "Purchases", fullScreen: false, hideHeader: true, noPadding: true, children: [
    /* @__PURE__ */ jsx(Head, { title: isEditMode ? "Edit Purchase Order" : "New Purchase Order" }),
    /* @__PURE__ */ jsxs("div", { className: `h-full flex-1 flex flex-col bg-slate-50 dark:bg-[#0f121d] transition-all duration-500 ${isSeniorMode ? "text-[20px] senior-mode" : ""}`, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: `flex-1 flex flex-col lg:flex-row gap-2 min-h-0 px-2 pb-0 pt-2 lg:overflow-hidden overflow-y-auto text-scale-${textSize}`, children: [
        /* @__PURE__ */ jsxs("div", { className: `flex-1 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-800 flex flex-col overflow-hidden min-h-[400px] lg:min-h-0 ${isReadOnly ? "pointer-events-none opacity-85 select-none" : ""}`, children: [
          isReadOnly && /* @__PURE__ */ jsxs("div", { className: "bg-indigo-600 text-white font-bold text-xs px-4 py-2.5 text-center flex items-center justify-center gap-2 shrink-0", children: [
            /* @__PURE__ */ jsx(Info, { size: 14 }),
            " This Purchase Order has been received and is read-only."
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex items-center gap-1 px-3 pt-2 pb-0 overflow-x-auto hide-scrollbar border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 shrink-0", children: [
            activePurchases.map((purchase, idx) => /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                className: `
                                    ...
                                    ${currentPurchaseId === purchase.id ? "bg-white dark:bg-slate-900 text-indigo-600" : "bg-slate-200/50 dark:bg-slate-800/50 text-slate-500 hover:bg-slate-200 dark:hover:bg-slate-800"}
                                `,
                children: [
                  /* @__PURE__ */ jsx("div", { className: `w-2 h-2 rounded-full ${currentPurchaseId === purchase.id ? "bg-indigo-500 animate-pulse" : "bg-slate-400"}` }),
                  /* @__PURE__ */ jsx("span", { className: "text-xs font-bold truncate", children: purchase.supplier?.name || `PO #${idx + 1}` }),
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      onClick: (e) => {
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "truncate", children: currentPurchase.supplier?.name || `PO #${activePurchases.findIndex((inv) => inv.id === currentPurchase.id) + 1}` })
                  ]
                }
              ),
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative flex-1 min-w-0", children: [
                ...
                currentPurchase.supplier ? /* @__PURE__ */ jsx("div", { className: "relative", children: /* @__PURE__ */ jsxs("div", { className: "w-full bg-slate-800 border border-slate-700 rounded-lg pl-7 pr-7 py-1.5 flex items-center justify-between shadow-sm min-h-[36px]", children: [
                  /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                    ...
                    /* @__PURE__ */ jsx("p", { className: "text-[9px] text-slate-500 leading-none", children: currentPurchase.supplier.phone || "No Phone" })
                  ] }),
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                  ...
                  supplierError && /* @__PURE__ */ jsx("p", { className: "absolute -bottom-2 left-3.5 bg-red-600 text-white text-[8px] font-black uppercase px-1.5 py-0.5 rounded shadow-md z-20 animate-pulse", children: "Please select supplier" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsx(Package, { size: 13 })
                  }
                ),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-0.5 bg-slate-800 rounded-lg p-0.5 border border-slate-700 h-[36px]", children: [
                  ...
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      ...
                      className: `px-2 py-1 rounded text-[10px] font-black transition-all ${currentPurchase.paymentMethod === "cash" ? "bg-orange-655 text-white shadow-sm" : "text-slate-500"}`,
                      children: "CASH"
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "relative group/accounts-mobile shrink-0 h-[36px]", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "absolute right-0 top-full pt-1 z-50 hidden group-hover/accounts-mobile:block", children: /* @__PURE__ */ jsxs("div", { className: "bg-slate-800 rounded-lg shadow-xl border border-slate-700 overflow-hidden w-36 p-1", children: [
                    /* @__PURE__ */ jsx("div", { className: "p-1 border-b border-slate-700 bg-slate-900/50", children: /* @__PURE__ */ jsx("p", { className: "text-[8px] font-bold text-slate-500 uppercase", children: "Pay From" }) }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex px-3 py-2 border-b border-slate-100 dark:border-slate-800 items-center justify-between gap-3 bg-slate-50/50 dark:bg-slate-800/30 shrink-0", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative flex-1 max-w-xl", children: [
              ...
              supplierError && /* @__PURE__ */ jsx("p", { className: "absolute -bottom-5 left-2 text-[10px] font-bold text-red-500 animate-pulse", children: "Please select a supplier" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
                  onClick: () => patchPurchase({ isReceived: !currentPurchase.isReceived }),
                  className: `px-3 py-1.5 rounded-lg text-[10px] font-black flex items-center gap-1.5 transition-all ${currentPurchase.isReceived ? "bg-emerald-500 text-white shadow shadow-emerald-500/20" : "bg-slate-100 dark:bg-slate-800 text-slate-400 hover:bg-slate-200"}`,
                  title: "Toggle Received Status",
                  children: [
                    /* @__PURE__ */ jsx(Package, { size: 12 }),
                    " ",
                    currentPurchase.isReceived ? "RECEIVED" : "ORDERED"
                  ]
                }
              ),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-0.5 bg-slate-100 dark:bg-slate-800 rounded-xl p-1 border border-slate-200 dark:border-slate-700", children: [
                /* @__PURE__ */ jsxs(
                  ...
                  {
                    onClick: () => patchPurchase({ paymentMethod: "credit" }),
                    className: `px-3 py-1.5 rounded-lg text-[10px] font-black flex items-center gap-1.5 transition-all ${currentPurchase.paymentMethod === "credit" ? "bg-emerald-500 text-white shadow shadow-emerald-500/20" : "text-slate-500 hover:text-slate-700"} `,
                    children: [
                ...
                /* @__PURE__ */ jsxs(
                  ...
                  {
                    onClick: () => patchPurchase({ paymentMethod: "cash" }),
                    className: `px-3 py-1.5 rounded-lg text-[10px] font-black flex items-center gap-1.5 transition-all ${currentPurchase.paymentMethod === "cash" ? "bg-orange-500 text-white shadow shadow-orange-500/20" : "text-slate-500 hover:text-slate-700"} `,
                    children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative group/accounts", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "absolute top-full pt-2 right-0 w-48 z-50 overflow-hidden hidden group-hover/accounts:block animate-in fade-in slide-in-from-top-2", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-100 dark:border-slate-700 overflow-hidden", children: [
                  /* @__PURE__ */ jsx("div", { className: "p-2 border-b border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50", children: /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold text-slate-400 uppercase", children: "Pay From" }) }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto hide-scrollbar px-2 py-2", children: [
                ...
                showQuickEntry && /* @__PURE__ */ jsxs("tr", { className: "bg-gradient-to-r from-indigo-50/50 to-purple-50/50 dark:from-indigo-900/10 dark:to-purple-900/10 border border-indigo-200 dark:border-indigo-800/50 rounded-xl overflow-hidden animate-in slide-in-from-top-2 fade-in duration-200", children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: "py-3 text-right", children: /* @__PURE__ */ jsx(
                    "button",
                    {
                      ...
                      className: "w-8 h-8 bg-indigo-650 text-white rounded-lg hover:bg-indigo-700 transition-all shadow shadow-indigo-500/30 flex items-center justify-center active:scale-90",
            ...
            /* @__PURE__ */ jsxs("div", { className: "md:hidden flex flex-col gap-2", children: [
              ...
              currentPurchase.items.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 rounded-xl p-8 text-center border border-slate-200 dark:border-slate-800", children: [
                /* @__PURE__ */ jsx(Package, { size: 32, className: "mx-auto text-slate-400 mb-2" }),
                /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-slate-700 dark:text-slate-350", children: "No items added to note" })
              ] }) : currentPurchase.items.map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col gap-1.5", children: [
                ...
                item.product && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-1.5 mt-1 items-end", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "col-span-3 flex flex-col gap-0.5", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-0.5 bg-slate-50 dark:bg-slate-800 border border-slate-205 dark:border-slate-700 rounded-lg pr-0.5", children: [
                      /* @__PURE__ */ jsx(
                        WheelInput,
                        {
                          type: "number",
        ...
        /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex w-full lg:w-80 bg-[#1a1d2e] flex-col overflow-hidden rounded-2xl shadow-2xl border border-slate-800 shrink-0", children: [
          /* @__PURE__ */ jsx("div", { className: "p-4 border-b border-slate-800/50 bg-slate-900/30 shrink-0", children: currentPurchase.supplier ? /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: `text-slate-400 font-medium ${textSize >= 4 ? "text-sm" : textSize >= 3 ? "text-xs" : "text-[10px]"} `, children: currentPurchase.supplier.phone || "No Phone" })
              ] }),
              /* @__PURE__ */ jsx(
                "button",
                {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 p-3 space-y-3 overflow-y-auto hide-scrollbar", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "text-[9px] text-slate-500 font-bold uppercase block mb-1", children: "Po #" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
            ...
            showExtraField && /* @__PURE__ */ jsx(Fragment, { children: !enableMultipleExtras ? (
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                (currentPurchase.extraFields || [{ id: 1, label: "", value: 0 }]).map((field, idx) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-2 hover:bg-slate-800/20 rounded-lg transition-colors group", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
                    /* @__PURE__ */ jsx(
                      "input",
                      {
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                    ...
                    (currentPurchase.extraFields || []).length > 1 && /* @__PURE__ */ jsx(
                      "button",
                      {
                        onClick: () => {
                ...
                (currentPurchase.extraFields || []).length < 10 && /* @__PURE__ */ jsx(
                  "button",
                  {
                    onClick: () => {
    ...
    /* @__PURE__ */ jsx(
      FormModal,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center py-6 text-center", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 text-sm mb-8", children: "The purchase order has been generated and stock updated." }),
