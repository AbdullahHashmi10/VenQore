...
import { v as vq, r as role } from "./runtime-DwSFgQZq.js";
    ...
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        style: {
          ...
          borderRadius: 9,
          border: "none",
          background: saving || actual === "" ? vq.slate[800] : "linear-gradient(135deg, rgb(var(--vq-emerald-600)), rgb(var(--vq-emerald-700)))",
