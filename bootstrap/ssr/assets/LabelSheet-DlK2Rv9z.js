                    ...
                    /* @__PURE__ */ jsxs("div", { className: `flex-1 flex flex-col justify-center ${row.align === "center" ? "items-center text-center" : "items-start text-left"}`, children: [
                      /* @__PURE__ */ jsx(
                        EditableText,
                        {
                          ...
                          placeholder: "Line 1",
                          className: `block w-full text-[13px] leading-tight ${row.bold_first ? "font-black" : "font-semibold"} text-slate-800`
                        }
                      ),
                      /* @__PURE__ */ jsx(
                        EditableText,
                        {
                          ...
                          className: "block w-full text-[11px] leading-tight text-slate-700 mt-0.5"
                        }
                      ),
                      /* @__PURE__ */ jsx(
                        EditableText,
                        {
                          ...
                          className: "block w-full text-[10px] leading-tight text-slate-500 mt-0.5"
                        }
                      )
                    ] }),
