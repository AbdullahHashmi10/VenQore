        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold uppercase tracking-wider text-slate-400", children: getTypeLabel(rec.type) }),
              rec.priority === "urgent" && /* @__PURE__ */ jsx("span", { className: "px-1.5 py-0.5 text-2xs font-bold bg-red-500 text-white rounded", children: "URGENT" })
            ] }),
          ...
          rec.potential_revenue > 0 && /* @__PURE__ */ jsxs("div", { className: "text-right shrink-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-2xs text-slate-400", children: "Potential" })
          ] })
        ] })
      },
      rec.id
