...
function AddConnectionModal({ storeSlug, onClose }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-2xl w-full max-w-md border border-line", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-5 border-b border-line", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h2", { className: "font-bold text-ink", children: "Add WooCommerce Connection" }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-0.5", children: "$10/month per connection, billed to your store." })
      ] }),
      /* @__PURE__ */ jsx("button", { onClick: onClose, className: "text-ink-muted hover:text-ink-secondary dark:hover:text-neutral-200 text-xl font-bold", children: "×" })
    ] }),
    /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "p-5 space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs font-semibold text-ink-muted uppercase tracking-wider mb-1", children: "Connection Name" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs font-semibold text-ink-muted uppercase tracking-wider mb-1", children: "WordPress Site URL (Optional)" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "text",
        ...
        /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted mt-0.5", children: "Recommended. Allows triggering instant remote handshakes directly from the POS." }),
        errors.site_url && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 mt-1", children: errors.site_url })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs font-semibold text-ink-muted uppercase tracking-wider mb-1", children: "Conflict Priority" }),
        /* @__PURE__ */ jsxs(
          "select",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "pt-2 flex gap-2 justify-end", children: [
        /* @__PURE__ */ jsx("button", { type: "button", onClick: onClose, className: "px-4 py-2 text-sm text-ink-secondary bg-sunken rounded-xl hover:bg-interactive-hover transition-colors", children: "Cancel" }),
        /* @__PURE__ */ jsx(
          "button",
          {
            type: "submit",
...
function ConnectionCard({ connection, storeSlug }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl border border-line overflow-hidden hover:shadow-lg transition-all group relative", children: [
    showConfirm && /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 bg-neutral-950/85 backdrop-blur-sm z-10 flex flex-col items-center justify-center p-4 text-center animate-in fade-in duration-normal", children: [
      ...
      /* @__PURE__ */ jsxs("p", { className: "text-1xs text-ink-muted mt-1 max-w-[210px] leading-relaxed", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "p-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3 mb-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "font-bold text-ink text-sm", children: connection.name }),
      ...
      ].map((stat) => /* @__PURE__ */ jsxs("div", { className: "bg-app rounded-xl p-2.5 text-center", children: [
        /* @__PURE__ */ jsx("div", { className: `font-bold text-sm ${stat.color} capitalize`, children: stat.value }),
        /* @__PURE__ */ jsx("div", { className: "text-xs text-ink-muted", children: stat.label })
      ] }, stat.label)) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6 max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between flex-wrap gap-3", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mt-0.5", children: "Bidirectional product sync between VenQore and your WooCommerce stores. $10/month per connection." })
        ] }),
        /* @__PURE__ */ jsxs(
          "button",
          {
      ...
      connections.length === 0 && /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl border border-line p-16 text-center", children: [
        ...
        /* @__PURE__ */ jsx("h3", { className: "font-bold text-ink mb-2", children: "No WooCommerce connections yet" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mb-6 max-w-sm mx-auto", children: "Connect your WooCommerce store to sync products, prices, and stock automatically — in both directions." }),
        /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: () => setShowAdd(true),
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-app rounded-2xl p-6 border border-line", children: [
        /* @__PURE__ */ jsx("h3", { className: "font-bold text-ink-secondary text-sm mb-3", children: "How it works" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "font-semibold text-ink-secondary text-sm", children: item.title }),
            /* @__PURE__ */ jsx("div", { className: "text-xs text-ink-muted mt-0.5", children: item.desc })
          ] })
        ] }, item.step)) })
      ] })
    ] }),
