...
import { V as VenaLogo } from "./AiIsland-DlkwqCwv.js";
...
function AgentInbox() {
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { mode: "admin", title: "Agent Inbox", activeMenu: storeSlug ? "Store Settings" : "Agent Inbox", noPadding: true, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "h-full w-full flex gap-6 overflow-hidden p-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "w-80 h-full bg-surface border border-line rounded-2xl shadow-xl flex flex-col overflow-hidden relative shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-6 border-b border-line bg-sunken/50 dark:bg-app", children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-lg font-bold text-ink tracking-tight flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(MessageSquare, { className: "text-brand-500", size: 20 }),
            "Support Queue"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-1", children: "Real-time customer inquiries" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "px-6 py-3 border-b border-line flex gap-1 bg-sunken/50 dark:bg-app overflow-x-auto shrink-0 scrollbar-none", children: [
          ...
          "button",
          {
            ...
            className: `px-2.5 py-1.5 rounded-full text-3xs font-bold uppercase tracking-wider transition-all shrink-0 ${activeTab === tab.id ? "bg-brand-600 text-white shadow-md" : "bg-sunken hover:bg-interactive-hover dark:bg-surface dark:hover:bg-interactive-hover text-ink-muted"}`,
            children: tab.label
          },
          tab.id
        )) }),
        /* @__PURE__ */ jsx("div", { className: "flex-1 chat-scroll p-3 space-y-2", children: loadingSessions ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-48 text-ink-muted", children: [
          ...
          if (filteredSessions.length === 0) {
            return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-48 text-ink-muted text-center px-4", children: [
              /* @__PURE__ */ jsx(CheckCircle2, { className: "text-emerald-400 mb-2", size: 32 }),
              /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-ink-secondary", children: "All clear!" }),
              /* @__PURE__ */ jsx("span", { className: "text-2xs text-ink-muted mt-1", children: "No chats in this category" })
            ] });
          }
          const grouped = {};
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      isCollapsed ? /* @__PURE__ */ jsx(ChevronRight, { size: 14, className: "text-ink-muted" }) : /* @__PURE__ */ jsx(ChevronDown, { size: 14, className: "text-ink-muted" }),
                      /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold uppercase tracking-wider", children: groupName })
                    ] }),
                    /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-brand-100 dark:bg-brand-950/40 text-brand-600 dark:text-brand-400 text-3xs font-bold rounded-full", children: groupSessions.length })
                  ]
                }
              ),
              !isCollapsed && /* @__PURE__ */ jsx("div", { className: "space-y-2 pl-1.5 border-l border-line ml-2 animate-in fade-in slide-in-from-top-1 duration-fast", children: groupSessions.map((s) => {
                ...
                return /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    className: `w-full text-left p-4 rounded-2xl border transition-all duration-normal relative overflow-hidden group flex flex-col gap-1.5 ${isSelected ? "bg-neutral-900 border-neutral-900 dark:bg-surface dark:border-line text-white shadow-lg" : "bg-sunken/60 dark:bg-surface border-line hover:bg-interactive-hover dark:hover:bg-interactive-hover text-ink-secondary"}`,
                    children: [
                      /* @__PURE__ */ jsx("div", { className: `absolute top-0 left-0 bottom-0 w-1.5 ${isUnclaimed ? "bg-rose-500 animate-pulse" : isClaimedByMe ? "bg-emerald-500" : isClaimedByOther ? "bg-amber-500" : "bg-sunken"}` }),
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between w-full", children: [
                        /* @__PURE__ */ jsx("span", { className: `text-xs font-bold truncate ${isSelected ? "text-white" : "text-ink"}`, children: s.visitor_name || "Website Guest" }),
                        /* @__PURE__ */ jsx("span", { className: "text-3xs text-ink-muted font-medium", children: s.last_message_at ? new Date(s.last_message_at).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) : "" })
                      ] }),
                      s.messages?.length > 0 && /* @__PURE__ */ jsx("p", { className: `text-2xs truncate ${isSelected ? "text-neutral-300" : "text-ink-muted"}`, children: s.messages[s.messages.length - 1].body }),
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mt-1 flex-wrap gap-1", children: [
                        isUnclaimed && /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-rose-100 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 text-4xs font-bold uppercase tracking-wider rounded-full", children: "Action Required" }),
                        isClaimedByMe && /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-emerald-100 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 text-4xs font-bold uppercase tracking-wider rounded-full", children: "Claimed by me" }),
                        isClaimedByOther && /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-amber-100 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400 text-4xs font-bold uppercase tracking-wider rounded-full max-w-[120px] truncate", children: s.claimed_by_name || "Other" }),
                        s.referred_to === currentUser.id && /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-brand-100 dark:bg-brand-950/40 text-brand-600 dark:text-brand-400 text-4xs font-bold uppercase tracking-wider rounded-full", children: "Referred to me" }),
                        s.sub_status && /* @__PURE__ */ jsx("span", { className: `px-2 py-0.5 text-4xs font-bold uppercase tracking-wider rounded-full ${s.sub_status === "fixed" ? "bg-emerald-100 dark:bg-emerald-950/20 text-emerald-600" : "bg-amber-100 dark:bg-amber-950/20 text-amber-600"}`, children: s.sub_status }),
                        s.status === "resolved" && /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-sunken text-ink-muted text-4xs font-bold uppercase tracking-wider rounded-full", children: "Resolved" })
                      ] })
                    ]
                  },
                  s.session_uuid
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 h-full bg-surface border border-line rounded-2xl shadow-xl flex flex-col overflow-hidden relative", children: [
        ...
        selectedSession ? /* @__PURE__ */ jsxs("div", { className: "flex-1 flex overflow-hidden relative z-10", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col overflow-hidden border-r border-line", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-6 border-b border-line flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/80 dark:bg-app backdrop-blur-xl shrink-0", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsx("h3", { className: "text-base font-bold text-ink tracking-tight", children: selectedSession.visitor_name || "Website Guest" }),
                  selectedSession.visitor_email && /* @__PURE__ */ jsxs("span", { className: "text-xs text-ink-muted", children: [
                    "(",
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    className: `px-3 py-1.5 rounded-xl text-2xs font-bold uppercase tracking-wider transition-all flex items-center gap-1.5 border active:scale-95 shrink-0 ${showCopilot ? "bg-brand-600/10 border-brand-500/30 text-brand-600 dark:text-brand-400 shadow-sm" : "bg-sunken border-line dark:bg-surface dark:border-line text-ink-muted hover:text-ink-secondary dark:hover:text-neutral-300"}`,
                    children: [
                      /* @__PURE__ */ jsx(Sparkles, { size: 11, className: showCopilot ? "animate-pulse text-brand-500" : "" }),
                      /* @__PURE__ */ jsx("span", { children: "AI Co-Pilot" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsx("div", { className: "flex items-center bg-app border border-line rounded-xl p-1 gap-2 shrink-0", children: selectedSession.status === "bot_active" ? /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsxs("span", { className: "px-2.5 py-1 bg-brand-500/10 border border-brand-500/20 text-brand-600 dark:text-brand-400 text-2xs font-bold uppercase tracking-wider rounded-lg flex items-center gap-1.5", children: [
                    /* @__PURE__ */ jsx(VenaLogo, { size: 12, className: "animate-pulse" }),
                    "Vena AI Active"
                  ] }),
                  /* @__PURE__ */ jsx(
                    "button",
                  ...
                  /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 bg-brand-500/10 border border-brand-500/20 text-brand-600 dark:text-brand-400 text-2xs font-bold uppercase tracking-wider rounded-lg", children: "Human Active" }),
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      type: "button",
                ...
                staffMembers.length > 0 && /* @__PURE__ */ jsx("div", { className: "relative shrink-0", children: /* @__PURE__ */ jsxs(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("option", { value: "", children: tt("Refer to Staff...") }),
                ...
                /* @__PURE__ */ jsx("div", { className: "flex bg-app border border-line rounded-xl p-0.5 shrink-0", children: [
                  ...
                  "button",
                  {
                    ...
                    className: `px-3 py-1.5 rounded-lg text-2xs font-bold uppercase tracking-wider transition-all ${selectedSession.sub_status === tag.id || !selectedSession.sub_status && tag.id === "active" ? "bg-sunken shadow-sm text-ink" : "text-ink-muted hover:text-ink-secondary dark:hover:text-neutral-300"}`,
                    children: tag.label
                  },
                  tag.id
                )) }),
            ...
            /* @__PURE__ */ jsx("div", { ref: chatScrollRef, className: "flex-1 chat-scroll p-8 space-y-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto space-y-4", children: [
              messages.map((m) => {
                ...
                if (isSystem) {
                  return /* @__PURE__ */ jsx("div", { className: "flex justify-center my-2", children: /* @__PURE__ */ jsx("span", { className: "px-4 py-1.5 bg-sunken border border-line dark:border-line rounded-full text-2xs text-ink-muted font-bold uppercase tracking-wider text-center max-w-md", children: m.body }) }, m.id);
                }
                return /* @__PURE__ */ jsx(
                  "div",
                  {
                    className: `flex ${isVisitor ? "justify-start" : "justify-end"} animate-in fade-in slide-in-from-bottom-1 duration-normal`,
                    children: /* @__PURE__ */ jsxs("div", { className: `max-w-md rounded-2xl px-5 py-3.5 shadow-sm text-sm ${isVisitor ? "bg-sunken text-ink rounded-bl-none" : isBot ? "bg-brand-600 text-white rounded-br-none font-medium" : "bg-brand-600 text-white rounded-br-none font-medium"}`, children: [
                      /* @__PURE__ */ jsxs("div", { className: "text-2xs font-bold uppercase tracking-wider mb-1 opacity-70 flex items-center gap-1.5", children: [
              ...
              visitorTyping && /* @__PURE__ */ jsxs("div", { className: "flex justify-start items-center gap-2 text-xs text-ink-muted font-medium py-2 animate-pulse", children: [
                /* @__PURE__ */ jsx(Loader2, { size: 12, className: "animate-spin text-neutral-300" }),
                /* @__PURE__ */ jsx("span", { children: typingText })
              ] })
            ] }) }),
            /* @__PURE__ */ jsx("div", { className: "p-6 border-t border-line bg-white/80 dark:bg-app backdrop-blur-xl", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto relative", children: [
              slashSuggestions.length > 0 && /* @__PURE__ */ jsxs("div", { className: "absolute bottom-full left-0 right-0 mb-2 bg-surface border border-line rounded-[14px] shadow-2xl p-2 z-50 max-h-48 overflow-y-auto custom-scrollbar animate-in fade-in slide-in-from-bottom-2", children: [
                /* @__PURE__ */ jsx("div", { className: "px-3 py-1.5 text-2xs font-bold text-ink-muted uppercase tracking-widest border-b border-line mb-1", children: "Canned Responses (Tap to insert)" }),
                slashSuggestions.map((r, i) => /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("span", { className: "font-bold text-ink group-hover:text-brand-500", children: [
                        "/",
                        r.shortcode
                      ] }),
                      /* @__PURE__ */ jsx("span", { className: "text-ink-muted text-2xs truncate max-w-[300px]", children: r.title })
                    ]
                  },
                  i
                ))
              ] }),
              selectedSession.status === "resolved" ? /* @__PURE__ */ jsxs("div", { className: "p-4 bg-app border border-line rounded-2xl text-ink-muted flex items-center gap-3 text-xs font-semibold", children: [
                /* @__PURE__ */ jsx(CheckCircle2, { size: 16, className: "text-ink-muted shrink-0" }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "p-5 bg-surface/50 dark:bg-surface border border-line rounded-2xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-xs font-semibold text-ink-secondary", children: [
                    /* @__PURE__ */ jsx(ShieldAlert, { size: 16, className: "text-brand-500 shrink-0 animate-pulse" }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("p", { className: "font-bold text-ink", children: "Supervision Mode (Read-Only)" }),
                      /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted mt-0.5", children: selectedSession.status === "bot_active" ? "Vena AI is currently handling the thread." : selectedSession.claimed_by ? `Owned by ${selectedSession.claimed_by_name || "another agent"}.` : "This session is waiting in the queue." })
                    ] })
                  ] }),
          ...
          showCopilot && /* @__PURE__ */ jsxs("div", { className: "w-96 h-full flex flex-col bg-sunken/20 dark:bg-app overflow-hidden shrink-0 animate-in slide-in-from-right duration-slow border-l border-line", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-6 border-b border-line bg-sunken/50 dark:bg-app shrink-0", children: [
              /* @__PURE__ */ jsxs("h3", { className: "text-sm font-bold text-ink tracking-tight flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(VenaLogo, { className: "animate-pulse", size: 16 }),
                "Vena Assist Co-Pilot"
              ] }),
              /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted mt-1", children: "Real-time co-pilot assist drawer" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1 chat-scroll p-4 space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-brand-500/10 bg-brand-500/[0.02] p-4 relative overflow-hidden flex flex-col gap-3", children: [
                /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-24 h-24 bg-brand-500/5 rounded-full blur-xl pointer-events-none" }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsx("h4", { className: "text-2xs font-bold text-brand-400 uppercase tracking-wider flex items-center gap-1.5", children: "Suggested Draft" }),
                  copilotSuggestion && /* @__PURE__ */ jsxs("span", { className: `px-2 py-0.5 rounded-full text-4xs font-bold uppercase tracking-wider border ${copilotConfidence === "high" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : copilotConfidence === "medium" ? "bg-brand-500/10 border-brand-500/20 text-brand-400" : "bg-amber-500/10 border-amber-500/20 text-amber-400"}`, children: [
                    "Confidence: ",
                    copilotConfidence
                  ] })
                ] }),
                copilotLoading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-6 text-ink-muted gap-2", children: [
                  /* @__PURE__ */ jsx(Loader2, { className: "animate-spin text-brand-400", size: 18 }),
                ...
                ] }) : /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted py-4 text-center", children: "Waiting for next customer message..." })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-line bg-surface/30 dark:bg-surface p-4", children: [
                /* @__PURE__ */ jsx("h4", { className: "text-2xs font-bold text-ink-muted uppercase tracking-wider mb-3", children: copilotSimilarKb.length > 0 ? "Verified KB Matches" : "Support Cheat Sheet" }),
                /* @__PURE__ */ jsx("div", { className: "space-y-3.5", children: copilotSimilarKb.length > 0 ? copilotSimilarKb.map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "border-b border-line pb-2.5 last:border-b-0 last:pb-0 flex flex-col gap-1", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxs("span", { className: "text-3xs font-bold text-ink truncate max-w-[200px]", children: [
                      "Q: ",
                      item.question
                    ] }),
                    /* @__PURE__ */ jsxs("span", { className: "text-4xs bg-sunken text-ink-muted px-1.5 py-0.5 rounded font-bold", children: [
                      "Seen ",
                      item.times_seen,
                      "x"
                    ] })
                  ] }),
                  /* @__PURE__ */ jsx("p", { className: "text-3xs text-ink-muted leading-relaxed bg-white/[0.02] p-2 rounded-lg border border-white/[0.02]", children: item.agent_answer })
                ] }, idx)) : [
                ...
                ].map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "border-b border-line pb-2 last:border-b-0 last:pb-0", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-ink", children: item.q }),
                  /* @__PURE__ */ jsx("p", { className: "text-3xs text-ink-muted mt-1 leading-relaxed", children: item.a })
                ] }, idx)) })
              ] })
            ] })
          ] })
        ] }) : /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col items-center justify-center text-ink-muted text-center px-6", children: [
          /* @__PURE__ */ jsx(MessageSquare, { className: "text-neutral-300 dark:text-ink mb-3", size: 64 }),
          /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold text-ink-secondary", children: "No Chat Selected" }),
          /* @__PURE__ */ jsx("p", { className: "text-1xs text-ink-muted mt-1 max-w-[280px]", children: "Click on a support session from the queue on the left to start conversing in real-time." })
        ] })
      ] })
    ] }),
    showResolveModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-drawer bg-neutral-950/80 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-slow", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-lg bg-neutral-900 border border-neutral-800 rounded-2xl shadow-2xl p-8 relative overflow-hidden flex flex-col gap-6 animate-in zoom-in-95 duration-slow", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-64 h-64 bg-brand-500/5 rounded-full blur-[80px] pointer-events-none -mt-32 -mr-32" }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 border-b border-neutral-800 pb-4 shrink-0", children: [
        /* @__PURE__ */ jsx("div", { className: "w-10 h-10 bg-brand-500/10 rounded-xl flex items-center justify-center border border-brand-500/20 text-brand-400", children: /* @__PURE__ */ jsx(Sparkles, { size: 18, className: "animate-pulse" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "text-base font-bold text-white tracking-tight", children: "AI Learning Engine Log" }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Teach Vena by documenting your verified resolution" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleResolveSubmit, className: "flex-1 flex flex-col gap-5 overflow-y-auto custom-scrollbar", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-[0.25em] text-ink-muted mb-2.5", children: "Ticket Category" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("option", { value: "checkout", children: tt("Checkout & Orders") }),
                /* @__PURE__ */ jsx("option", { value: "features", children: tt("Feature Requests & Products") }),
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-[0.25em] text-ink-muted mb-2.5", children: "Core Problem Encountered" }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
              required: true,
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-[0.25em] text-ink-muted mb-2.5", children: "Verified Solution Provided" }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
              required: true,
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 border-t border-neutral-800 pt-6 mt-4", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
