...
import { TrendingUp, BarChart3, BarChart2, FileText, Percent, Clock, ShoppingCart, Package, AlertTriangle, History, Hourglass, Layers, Box, Scale, RefreshCw, Landmark, CreditCard, PieChart, Hash, Activity, BookOpen, Calendar, Users, ArrowLeftRight, UserPlus, PackageSearch, Users2, Search, Lock, ArrowRight } from "lucide-react";
...
const Card3D = ({ report }) => {
  ...
  const requiredTier = Object.keys(report_tiers).find(
    (tier) => report_tiers[tier].includes(reportKey)
  ) || "growth";
  ...
  if (!isAllowed) {
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "relative p-6 flex flex-col h-full z-10 opacity-50 filter blur-[0.5px]", children: [
            /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(Icon, { size: 30, strokeWidth: 1.5, className: "text-slate-400" }) }),
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-center", children: [
                /* @__PURE__ */ jsx("h3", { className: "text-base font-bold text-slate-400 dark:text-slate-500 leading-tight", children: report.title }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400/80 font-medium line-clamp-1 mt-0.5", children: report.description })
              ] })
            ] }) }),
            /* @__PURE__ */ jsx("div", { className: "mt-4 pt-4 border-t border-slate-100 dark:border-slate-800/30 flex-grow", children: /* @__PURE__ */ jsx("p", { className: "text-[12px] text-slate-400/80 leading-relaxed font-medium", children: report.longDescription }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 z-20 flex flex-col items-center justify-center gap-2 bg-slate-900/20 dark:bg-black/40 backdrop-blur-[2px]", children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-full bg-white dark:bg-slate-800 flex items-center justify-center shadow-lg border border-slate-100 dark:border-slate-700 text-slate-500 dark:text-slate-400 group-hover/locked:scale-110 transition-transform duration-300", children: /* @__PURE__ */ jsx(Lock, { size: 16 }) }),
            /* @__PURE__ */ jsxs("span", { className: "text-1xs font-black uppercase tracking-wider text-slate-700 dark:text-slate-300 px-2.5 py-1 bg-white/95 dark:bg-slate-800/95 rounded-full shadow-sm border border-slate-100 dark:border-slate-700", children: [
              "Upgrade to ",
              requiredTier === "growth" ? "Growth" : "Business"
            ] })
          ] })
        ]
      }
  ...
  return /* @__PURE__ */ jsxs(
    Link,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative p-6 flex flex-col h-full z-10 bg-white/5 dark:bg-slate-900/90 backdrop-blur-3xl h-full", children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center shrink-0", style: { filter: isHovered ? `drop-shadow(0 0 12px ${glowColor})` : "none", transition: "filter 0.3s ease" }, children: /* @__PURE__ */ jsx(Icon, { size: 30, strokeWidth: 1.5, className: `${report.color} transition-transform duration-300 group-hover:scale-110` }) }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-center", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-base font-bold text-slate-800 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors leading-tight", children: report.title }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400 font-medium line-clamp-1 mt-0.5", children: report.description })
            ] })
          ] }) }),
          /* @__PURE__ */ jsx("div", { className: "mt-4 pt-4 border-t border-slate-50 dark:border-slate-800/50 flex-grow", children: /* @__PURE__ */ jsx("p", { className: "text-[12px] text-slate-500 dark:text-slate-400/80 leading-relaxed font-medium", children: report.longDescription }) }),
          /* @__PURE__ */ jsx("div", { className: "absolute bottom-4 right-4 text-slate-300 dark:text-slate-600 group-hover:text-indigo-500 group-hover:translate-x-1 transition-all duration-300 opacity-0 group-hover:opacity-100", children: /* @__PURE__ */ jsx(ArrowRight, { size: 18 }) })
        ] })
      ]
    }
  );
    ...
    /* @__PURE__ */ jsxs("div", { className: "h-full flex flex-col gap-8 pb-10", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid gap-10 px-4 sm:px-6", children: [
        filteredGroups.map((group, idx) => /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-end justify-between border-b border-slate-200 dark:border-slate-800 pb-2", children: /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-slate-800 dark:text-white uppercase tracking-widest", children: group.title }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-slate-500", children: group.description })
          ] }) }),
        ...
        filteredGroups.length === 0 && /* @__PURE__ */ jsxs("div", { className: "text-center py-20", children: [
          /* @__PURE__ */ jsx("div", { className: "inline-flex p-4 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-400 mb-4", children: /* @__PURE__ */ jsx(FileText, { size: 48 }) }),
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-slate-700 dark:text-slate-300", children: "No reports found" }),
          /* @__PURE__ */ jsx("p", { className: "text-slate-500", children: "Try adjusting your search terms" })
        ] })
      ] })
    ] })
  ] });
