...
function GraphAnalytics({ trendData, paymentStatus, stats, filters, module = "sales" }) {
  ...
  return /* @__PURE__ */ jsxs(ReportsLayout, { title: `${currentModule.label} Analytics`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full gap-2 overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row justify-between items-center gap-2 bg-surface p-2 rounded-2xl border border-line shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 pl-2", children: [
          /* @__PURE__ */ jsx(Link, { href: route("store.reports.index", {
            store_slug: store.slug
          }), className: "p-1.5 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-xl text-ink-muted transition-colors", children: /* @__PURE__ */ jsx(ArrowLeft, { size: 16 }) }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("h1", { className: "text-base font-bold text-ink uppercase tracking-tight flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx(currentModule.icon, { className: currentModule.color, size: 18 }),
                    " ",
                    currentModule.label,
                    " Analytics"
                  ] }),
                  /* @__PURE__ */ jsx(ChevronDown, { size: 14, className: `text-ink-muted transition-transform ${isModuleMenuOpen ? "rotate-180" : ""}` })
                ]
              }
            ),
            isModuleMenuOpen && /* @__PURE__ */ jsx("div", { className: "absolute top-full left-0 mt-2 w-48 bg-surface rounded-[14px] shadow-xl border border-line z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-normal", children: modules.map((m) => /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-sm text-ink-secondary dark:text-ink", children: m.label })
                ]
              },
              m.id
            )) })
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row items-center gap-2", children: [
          /* @__PURE__ */ jsx("div", { className: "flex bg-sunken p-1 rounded-xl", children: [
            ...
            "button",
            {
              ...
              className: `px-3 py-1 rounded-lg text-2xs font-bold uppercase transition-all ${range === opt.id ? "bg-sunken shadow-sm text-brand-600 dark:text-brand-400" : "text-ink-muted hover:text-ink-secondary dark:hover:text-neutral-300"}`,
              children: opt.label
            },
            opt.id
          )) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 min-h-0 flex flex-col gap-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-surface p-3 rounded-2xl border border-line shadow-sm flex flex-col relative overflow-hidden flex-[1.2]", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2 shrink-0", children: [
            /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("h3", { className: "text-xs font-bold text-ink uppercase tracking-tight", children: "Sales Trend Analysis" }) }),
            /* @__PURE__ */ jsxs("div", { className: `px-2 py-0.5 rounded-full text-2xs font-bold flex items-center gap-1 ${insights.trend === "up" ? "bg-emerald-50 text-emerald-600 dark:bg-emerald-900/30" : insights.trend === "down" ? "bg-rose-50 text-rose-600 dark:bg-rose-900/30" : "bg-sunken text-ink-secondary dark:bg-surface"}`, children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex-1 w-full min-h-0", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", minWidth: 1, minHeight: 1, children: /* @__PURE__ */ jsxs(AreaChart, { data: trendData, margin: { top: 5, right: 0, left: 0, bottom: 0 }, children: [
            /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: "colorSales", x1: "0", y1: "0", x2: "0", y2: "1", children: [
              /* @__PURE__ */ jsx("stop", { offset: "5%", stopColor: vq.indigo[500], stopOpacity: 0.6 }),
              /* @__PURE__ */ jsx("stop", { offset: "95%", stopColor: vq.indigo[500], stopOpacity: 0 })
            ] }) }),
            /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3", vertical: false, stroke: vq.slate[200], opacity: 0.3 }),
            /* @__PURE__ */ jsx(
              XAxis,
              {
                dataKey: "name",
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-surface p-3 rounded-2xl border border-line shadow-sm relative overflow-hidden flex-1 flex flex-col", children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between mb-2 shrink-0", children: /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("h3", { className: "text-xs font-bold text-ink uppercase tracking-tight", children: "Payment Recovery" }) }) }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1 flex items-center justify-between min-h-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative h-full flex-1", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "absolute inset-0 flex items-center justify-center pointer-events-none pb-2", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted font-bold uppercase tracking-wider mb-0.5", children: "Recovery" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-center gap-3 pr-6 flex-[1.2]", children: [
              paymentStatus.map((status, idx) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 rounded-xl bg-app", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsx("div", { className: "w-3 h-3 rounded-full", style: { backgroundColor: status.fill } }),
                  /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary", children: status.name }) })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "text-right", children: /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink", children: formatCurrency(status.value) }) })
              ] }, idx)),
              /* @__PURE__ */ jsxs("div", { className: "mt-1 p-2 rounded-xl bg-brand-50 dark:bg-brand-900/10 border border-brand-100 dark:border-brand-800/30 flex items-start gap-2", children: [
                /* @__PURE__ */ jsx(AlertCircle, { size: 14, className: "text-brand-600 mt-0.5 shrink-0" }),
                /* @__PURE__ */ jsxs("p", { className: "text-xs text-brand-700 dark:text-brand-300 leading-snug", children: [
...
function StatCard({ title, value, icon, color }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-surface border border-line rounded-xl p-2.5 flex items-center justify-between shadow-sm hover:shadow-md transition-all relative overflow-hidden group", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 relative z-10", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-ink-muted uppercase tracking-wide", children: title })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "relative z-10 text-right", children: /* @__PURE__ */ jsx("h3", { className: "text-base font-bold text-ink tracking-tight", children: value }) })
  ] });
}
export {
