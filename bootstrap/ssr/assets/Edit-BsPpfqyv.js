...
import { P as PlatformLayout } from "./PlatformLayout-l0DusZka.js";
...
function Edit({ mustVerifyEmail, status }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { ...store ? { title: "Profile Settings", activeMenu: "System" } : { title: "Profile Settings" }, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "h-full overflow-y-auto", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-8 pb-24", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-xl border border-line overflow-hidden", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-6 bg-gradient-brand text-white relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex items-center gap-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-brand-100 text-sm", children: "Update your account's profile information and email address." })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "p-6 space-y-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("label", { className: "block text-sm font-bold text-ink-secondary dark:text-ink mb-2", children: [
      ...
      store && /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-xl border border-line overflow-hidden", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-6 border-b border-line", children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-xl font-bold text-ink flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(CheckCircle, { className: "text-brand-500" }),
            "Onboarding Setup Progress"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mt-1", children: "Track the setup steps required to unlock your dashboard analytics." })
        ] }),
        ...
        ].map((item, idx) => /* @__PURE__ */ jsxs("div", { className: `p-4 rounded-2xl border transition-all ${item.isDone ? "bg-emerald-500/5 border-emerald-100 dark:border-emerald-950/50" : "bg-app border-line"}`, children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: `mt-0.5 w-5 h-5 rounded-full flex items-center justify-center ${item.isDone ? "bg-emerald-500/15 text-emerald-500" : "bg-sunken text-ink-muted"}`, children: item.isDone ? /* @__PURE__ */ jsx(CheckCircle, { size: 12, className: "fill-emerald-500/10" }) : /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-neutral-400 dark:bg-raised" }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: `font-bold text-sm ${item.isDone ? "text-ink-muted line-through" : "text-ink-secondary dark:text-ink"}`, children: item.label }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-0.5 leading-relaxed", children: item.desc })
              ] })
            ] }),
            /* @__PURE__ */ jsx("span", { className: `text-2xs font-bold uppercase tracking-wider px-2 py-0.5 rounded-full ${item.isDone ? "bg-emerald-500/10 text-emerald-500" : "bg-brand-500/10 text-brand-500"}`, children: item.isDone ? "Done" : "Pending" })
          ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-xl border border-line overflow-hidden", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-6 border-b border-line", children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-xl font-bold text-ink flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Smartphone, { size: 20, className: "text-brand-500" }),
            "Personal Preferences"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mt-1", children: "Customize your experience with these personal settings." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "p-6 space-y-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 bg-app rounded-2xl", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-sunken flex items-center justify-center", children: preferences.dark_mode ? /* @__PURE__ */ jsx(Moon, { size: 20, className: "text-brand-500" }) : /* @__PURE__ */ jsx(Sun, { size: 20, className: "text-amber-500" }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink", children: "Dark Mode" }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Switch between light and dark themes" })
              ] })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx("div", { className: `absolute top-1 w-5 h-5 bg-white rounded-full shadow-sm transition-all duration-slow ${preferences.dark_mode ? "left-8" : "left-1"}` })
              }
            )
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 bg-app rounded-2xl", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-sunken flex items-center justify-center", children: /* @__PURE__ */ jsx(Type, { size: 20, className: "text-brand-500" }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink", children: "Senior Mode (Large Text)" }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Increase text size for better readability" })
              ] })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx("div", { className: `absolute top-1 w-5 h-5 bg-white rounded-full shadow-sm transition-all duration-slow ${preferences.senior_mode ? "left-8" : "left-1"}` })
              }
            )
          ] })
        ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-xl border border-line overflow-hidden", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-6 border-b border-line", children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-xl font-bold text-ink flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Key, { size: 20, className: "text-brand-500" }),
            "Personal Passcode (Quick Login PIN)"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mt-1", children: "Set up a 4-6 digit PIN for quick login instead of email/password." })
        ] }),
        /* @__PURE__ */ jsxs("form", { onSubmit: submitPasscode, className: "p-6 space-y-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 bg-app rounded-2xl", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-brand-100 dark:bg-brand-900/30 flex items-center justify-center", children: /* @__PURE__ */ jsx(Shield, { size: 20, className: "text-brand-600" }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink", children: "Enable Quick Login PIN" }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: user.has_passcode ? "You have a passcode set. Update or disable it below." : "No passcode set yet." })
              ] })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx("div", { className: `absolute top-1 w-5 h-5 bg-white rounded-full shadow-sm transition-all duration-slow ${passcodeData.enable_passcode ? "left-8" : "left-1"}` })
              }
            )
          ] }),
          passcodeData.enable_passcode && /* @__PURE__ */ jsxs("div", { className: "space-y-4 animate-in fade-in slide-in-from-top-2 duration-slow", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-ink-secondary dark:text-ink mb-2", children: "New Passcode (4-6 digits)" }),
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-ink-secondary dark:text-ink mb-2", children: "Confirm Passcode" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: showPasscode ? "text" : "password",
            ...
            /* @__PURE__ */ jsx("div", { className: "p-4 bg-brand-50 dark:bg-brand-900/20 border border-brand-200 dark:border-brand-800 rounded-2xl", children: /* @__PURE__ */ jsxs("p", { className: "text-sm text-brand-700 dark:text-brand-300", children: [
          ...
          (passcodeData.enable_passcode || user.has_passcode) && /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              className: `inline-flex items-center gap-2 px-6 py-3 text-white font-bold rounded-xl shadow-lg transition-all disabled:opacity-50 ${passcodeData.enable_passcode ? "bg-brand-600 hover:bg-brand-700 " : "bg-red-500 hover:bg-red-600 "}`,
              children: [
      ...
      needsPasscode && /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-xl border border-line overflow-hidden", id: "security-pin-section", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-6 border-b border-line bg-brand-50/30 dark:bg-brand-900/10", children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-xl font-bold text-ink flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Shield, { size: 20, className: "text-brand-600" }),
            "Security Passcode (Transaction PIN)"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mt-1", children: "Set up a mandatory 6-digit PIN for sensitive tasks like adding capital, deleting records, or changing settings." })
        ] }),
        /* @__PURE__ */ jsxs("form", { onSubmit: submitSecurityPin, className: "p-6 space-y-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 bg-app rounded-2xl", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-brand-100 dark:bg-brand-900/30 flex items-center justify-center", children: /* @__PURE__ */ jsx(Lock, { size: 20, className: "text-brand-600" }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink", children: "Enable Transaction Security" }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: user.security_pin ? "Security PIN is currently active." : "Security PIN is not set yet." })
              ] })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx("div", { className: `absolute top-1 w-5 h-5 bg-white rounded-full shadow-sm transition-all duration-slow ${securityPinData.enable_security_pin ? "left-8" : "left-1"}` })
              }
            )
          ] }),
          securityPinData.enable_security_pin && /* @__PURE__ */ jsxs("div", { className: "space-y-4 animate-in fade-in slide-in-from-top-2 duration-slow", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-ink-secondary dark:text-ink mb-2", children: "New Security PIN (Exactly 6 digits)" }),
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsx(
                    "input",
                    {
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-ink-secondary dark:text-ink mb-2", children: "Confirm Security PIN" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: showSecurityPin ? "text" : "password",
          ...
          (securityPinData.enable_security_pin || user.security_pin) && /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              className: `inline-flex items-center gap-2 px-6 py-3 text-white font-bold rounded-xl shadow-lg transition-all disabled:opacity-50 ${securityPinData.enable_security_pin ? "bg-brand-600 hover:bg-brand-700 " : "bg-red-500 hover:bg-red-600 "}`,
              children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-xl border border-line overflow-hidden", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-6 border-b border-line", children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-xl font-bold text-ink flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Lock, { size: 20, className: "text-brand-500" }),
            "Update Password"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mt-1", children: "Ensure your account is using a long, random password to stay secure." })
        ] }),
        /* @__PURE__ */ jsxs("form", { onSubmit: submitPassword, className: "p-6 space-y-6", children: [
          ...
          !user.google_id && /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-ink-secondary dark:text-ink mb-2", children: "Current Password" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "password",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-ink-secondary dark:text-ink mb-2", children: "New Password" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "password",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-ink-secondary dark:text-ink mb-2", children: "Confirm Password" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "password",
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-xl border border-red-200 dark:border-red-900/50 overflow-hidden", children: [
    ...
    showDeleteModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl shadow-2xl border border-line w-full max-w-md p-6 m-4", children: [
      /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-ink mb-4", children: "Are you sure?" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mb-6", children: "Once your account is deleted, all of its resources and data will be permanently deleted. Please enter your password to confirm." }),
