  ...
  return /* @__PURE__ */ jsx(
    "th",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: `flex items-center gap-1.5 ${align === "center" ? "justify-center" : align === "right" ? "justify-end" : "justify-start"}`, children: [
        label,
        /* @__PURE__ */ jsxs("div", { className: `flex flex-col text-4xs leading-none ${isActive ? "text-sky-500" : "text-slate-300 group-hover:text-slate-400"}`, children: [
...
function StatusBadge({ status }) {
  ...
  return /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-400 text-2xs font-bold rounded", children: status });
}
export {
