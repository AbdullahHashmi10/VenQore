        ...
        platforms.map((p) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                /* @__PURE__ */ jsx("span", { className: `px-3 py-1 rounded-full text-2xs font-black uppercase tracking-widest ${p.is_active ? "bg-emerald-500/10 text-emerald-500 border border-emerald-500/20" : "bg-slate-800 text-slate-500 border border-slate-700"}`, children: p.is_active ? "Active" : "Disabled" }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    onClick: () => startEdit(p),
