...
const CreateInvoice = ({ sale }) => {
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: isEditMode ? `Edit Sale #${editState?.invoiceNumber || ""}` : "Add Sale", activeMenu: "Sales", fullScreen: false, hideHeader: true, noPadding: true, children: [
    ...
    aiPrefillNotice && /* @__PURE__ */ jsxs("div", { className: "mx-4 mt-3 px-5 py-3.5 rounded-2xl bg-indigo-500/10 border border-indigo-500/25 flex flex-wrap items-center gap-x-3 gap-y-1", children: [
      ...
      /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-amber-600 dark:text-amber-500", children: "Nothing is saved yet — check every line, then press Save. Once saved, this invoice cannot be edited." }),
      /* @__PURE__ */ jsx(
        "button",
        {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-800 flex flex-col overflow-hidden min-h-[400px] lg:min-h-0", children: [
                      ...
                      /* @__PURE__ */ jsx("td", { className: "bg-slate-50 dark:bg-slate-800/50 py-3 pr-3 align-middle", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-1.5", children: [
                        /* @__PURE__ */ jsx(
                          "button",
                          {
                            ...
                            disabled: isPosted,
                            className: `w-7 h-7 rounded-md text-2xs font-black transition-all shrink-0 border flex items-center justify-center disabled:opacity-60 disabled:cursor-not-allowed ${getItemTotalMode(item.id) === "price" ? "bg-indigo-600 text-white border-indigo-500 shadow shadow-indigo-500/30" : "bg-emerald-600 text-white border-emerald-500 shadow shadow-emerald-500/30"}`,
          ...
          /* @__PURE__ */ jsxs("div", { className: "lg:hidden flex flex-col shrink-0", children: [
            ...
            isPosted ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1 px-2 py-2 bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 shrink-0", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-center text-2xs font-bold text-red-500 uppercase tracking-wide", children: "Posted sales can't be modified" })
        ...
        /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex w-full lg:w-80 bg-void-700 flex-col overflow-hidden rounded-2xl shadow-2xl border border-slate-800 shrink-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-3 bg-slate-900 space-y-2 shrink-0 border-t border-slate-800", children: [
            ...
            isPosted ? /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-center text-2xs font-bold text-red-500 uppercase tracking-wide pt-0.5", children: "Posted sales can't be modified" })
