  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-void-950 text-white font-sans", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-6xl mx-auto px-6 py-10 sm:py-14", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-9", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center mt-7", children: /* @__PURE__ */ jsx("div", { className: "inline-flex items-center p-1 rounded-xl bg-white/[0.03] border border-white/[0.08]", children: INTERVALS.map((opt) => /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              opt.label,
              opt.badge && /* @__PURE__ */ jsx("span", { className: "absolute -top-2.5 -right-1 px-1.5 py-0.5 bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 text-4xs font-black rounded-full whitespace-nowrap", children: opt.badge })
            ]
          },
          opt.key
        )) }) })
        ...
        return /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              plan.popular && /* @__PURE__ */ jsx("div", { className: "absolute top-3 right-4", children: /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 rounded-full bg-indigo-500/15 border border-indigo-500/25 text-indigo-300 text-3xs font-black tracking-widest uppercase", children: "Most Popular" }) }),
              /* @__PURE__ */ jsxs("div", { className: "p-6 sm:p-7", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                    ...
                    isSelected && /* @__PURE__ */ jsx("span", { className: `text-3xs font-black tracking-[0.15em] uppercase px-2 py-0.5 rounded-full border ${style.badge}`, children: "Selected" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "mb-5", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-2xs text-slate-500 font-semibold mt-1 block", children: interval === "annual" ? `billed annually — ${fmt(plan.annual_total)}/yr` : "billed monthly" })
                ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto rounded-2xl border border-white/[0.07] bg-white/[0.02] p-5 sm:p-6", children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-center sm:text-left text-1xs text-slate-500 mt-4 flex items-center gap-1.5 justify-center sm:justify-start", children: [
