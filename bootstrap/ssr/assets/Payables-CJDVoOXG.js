...
import { ChevronDown, DollarSign, Users, TrendingDown, Search, Download, Printer, ChevronUp, Phone, Mail, CreditCard, FileText } from "lucide-react";
import "marked";
import "axios";
import "@headlessui/react";
import "driver.js";
import "./vendor-core-4m-Uvb-d.js";
function Payables({ parties = [] }) {
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Accounts Payable", activeMenu: "Money", children: [
    /* @__PURE__ */ jsx(Head, { title: "Payables" }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full bg-slate-50 dark:bg-slate-950 p-2 gap-1 overflow-hidden", children: [
      /* @__PURE__ */ jsx(MoneyModuleTabs, { activeTab: "payables" }),
      /* @__PURE__ */ jsxs("div", { className: "sm:hidden flex items-center justify-between bg-white dark:bg-slate-900 px-3 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm shrink-0", children: [
        ...
        !isStatsExpanded && /* @__PURE__ */ jsxs("div", { className: "text-2xs font-bold text-slate-500 truncate", children: [
          /* @__PURE__ */ jsxs("span", { className: "text-red-600 dark:text-red-400", children: [
            "Payable: ",
            formatCurrency(stats.totalPayable || 0, store)
          ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: `grid grid-cols-2 sm:grid-cols-4 gap-2 shrink-0 ${isStatsExpanded ? "grid" : "hidden sm:grid"}`, children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1.5 bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded-lg", children: /* @__PURE__ */ jsx(DollarSign, { size: 16 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-slate-500 uppercase", children: "Total Payable" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-black text-red-600", children: formatCurrency(stats.totalPayable, store) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-slate-500 uppercase", children: "Active Creditors" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-black text-indigo-600", children: stats.totalParties })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1.5 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg", children: /* @__PURE__ */ jsx(TrendingDown, { size: 16 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-slate-500 uppercase", children: "Avg Balance" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-black text-blue-600", children: formatCurrency(stats.avgPayable, store) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between items-start gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-slate-500 uppercase", children: "Highest Creditor" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end", children: [
            /* @__PURE__ */ jsx("p", { className: "text-lg font-black text-rose-600 leading-none", children: formatCurrency(parseFloat(stats.largestCreditor.balance ?? stats.largestCreditor.current_balance ?? 0), store) }),
            stats.largestCreditor.name && /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-slate-400 truncate max-w-[100px] mt-0.5", children: stats.largestCreditor.name })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "hidden sm:flex flex-wrap items-center justify-between gap-2 bg-white dark:bg-slate-900 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxs("h1", { className: "text-lg font-black text-slate-800 dark:text-white uppercase tracking-tight shrink-0", children: [
            "Accounts ",
            /* @__PURE__ */ jsx("span", { className: "text-red-600", children: "Payable" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "h-4 w-px bg-slate-200 dark:bg-slate-700 mx-1" }),
          /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-slate-400 uppercase", children: "Money Out" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "hidden sm:block flex-1 overflow-auto rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm bg-white dark:bg-slate-900", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-10", children: [
          ...
          /* @__PURE__ */ jsx("th", { className: "p-3 text-2xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider", children: "Contact" }),
          /* @__PURE__ */ jsx("th", { className: "p-3 text-2xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider text-center", children: "Since" }),
          /* @__PURE__ */ jsx(
            "th",
            {
          ...
          /* @__PURE__ */ jsx("th", { className: "p-3 text-2xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider text-right", children: "Actions" })
        ] }) }),
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-slate-100 dark:divide-slate-800", children: filteredParties.length > 0 ? filteredParties.map((party) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group", children: [
          /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-lg bg-rose-100 dark:bg-rose-900/30 flex items-center justify-center text-rose-600 dark:text-rose-400 font-bold text-sm", children: party.name.charAt(0) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "font-bold text-sm text-slate-900 dark:text-white", children: party.name }),
              /* @__PURE__ */ jsx("p", { className: "text-2xs text-slate-500", children: "Supplier" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5", children: [
            ...
            party.email && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-slate-400 text-2xs", children: [
          ...
          /* @__PURE__ */ jsx("td", { className: "p-3 text-right", children: /* @__PURE__ */ jsx("p", { className: "font-mono font-bold text-rose-600 dark:text-rose-400", children: formatCurrency(party.balance ?? party.current_balance ?? 0, store) }) }),
          ...
          /* @__PURE__ */ jsx(TrendingDown, { size: 32, className: "opacity-20" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium", children: "No pending payables found" }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-500", children: "Excellent! All suppliers are paid." })
        ] }) }) }) })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "block sm:hidden flex-1 overflow-auto space-y-1.5", children: filteredParties.length > 0 ? filteredParties.map((party) => /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 p-3 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col gap-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("p", { className: "text-2xs text-slate-500 mt-0.5", children: [
                "Since: ",
                new Date(party.updated_at || party.created_at).toLocaleDateString()
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "font-mono font-bold text-sm text-rose-600 dark:text-rose-400", children: formatCurrency(parseFloat(party.balance ?? party.current_balance ?? 0), store) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-t border-slate-100 dark:border-slate-800/80 pt-2 mt-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col text-2xs text-slate-500", children: [
