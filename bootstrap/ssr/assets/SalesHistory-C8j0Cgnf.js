...
import { f as formatCurrency, a as formatDate, c as formatTime } from "./format-131Nyq79.js";
...
import { S as SellModuleTabs } from "./SellModuleTabs-8HalJM1r.js";
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Sales History", activeMenu: "Sell", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col min-h-full lg:h-full bg-app p-1 md:p-2 gap-1 lg:overflow-hidden relative", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: `grid grid-cols-2 md:grid-cols-4 gap-1 shrink-0 ${isStatsExpanded ? "grid" : "hidden md:grid"}`, children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex flex-col items-start gap-1 justify-between sm:flex-row sm:items-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-muted uppercase", children: "Total Sale" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-ink", children: formatCurrency(stats?.total_sale || 0, store) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex flex-col items-start gap-1 justify-between sm:flex-row sm:items-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-emerald-600", children: formatCurrency(stats?.total_paid || 0, store) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex flex-col items-start gap-1 justify-between sm:flex-row sm:items-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-rose-600", children: formatCurrency(stats?.total_unpaid || 0, store) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex flex-col items-start gap-1 justify-between sm:flex-row sm:items-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-ink", children: stats?.transaction_count || 0 })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex flex-wrap items-center justify-between gap-2 bg-surface px-3 py-2 rounded-xl border border-line shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
          /* @__PURE__ */ jsxs("h1", { className: "text-lg font-bold text-ink uppercase tracking-tight shrink-0", children: [
            tp("sale", "Sales"),
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-brand-600", children: "Transactions" })
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-0.5 border-l border-line pl-2", children: [
            ...
            /* @__PURE__ */ jsx(Link, { href: route("store.reports.analytics", { store_slug: store?.slug }), className: "p-1.5 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-lg text-ink-muted", title: "Analytics", children: /* @__PURE__ */ jsx(BarChart3, { size: 18 }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex lg:hidden flex-col gap-2 bg-surface px-3 py-2 rounded-xl border border-line shadow-sm shrink-0", children: [
        ...
        showMobileFilters && /* @__PURE__ */ jsxs("div", { className: "w-full mt-1 border-t border-line pt-2 flex flex-col gap-2", children: [
      ...
      selectedSales.length > 0 && /* @__PURE__ */ jsxs("div", { className: "bg-brand-600 text-white px-4 py-2 rounded-xl flex items-center justify-between shadow-lg mb-2 animate-in slide-in-from-top-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 min-h-[calc(100vh-190px)] lg:min-h-0 overflow-auto md:rounded-xl md:border md:border-line md:dark:border-line md:shadow-sm bg-transparent md:bg-white md:dark:bg-app", children: [
...
`,
          ...
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: sortedSales.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: tableColumns.length, className: "p-12", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center text-center", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-ink-secondary mb-1", children: "No sales found" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mb-4", children: "Transactions will appear here once you create your first sale" }),
            /* @__PURE__ */ jsxs(
              Link,
              {
 ...
 ${row.source === "pos" ? "bg-orange-50/30 dark:bg-orange-900/5 border-l-4 border-orange-500" : "border-l-4 border-transparent hover:border-brand-400"}
 ${quickViewSale?.id === row.id ? "ring-2 ring-brand-500 ring-inset bg-brand-50 dark:bg-brand-900/20" : ""}
`,
              children: [
                /* @__PURE__ */ jsx("td", { className: "p-2 md:p-4 w-8 md:w-10 sticky left-0 z-10 bg-surface", onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "checkbox",
                    className: "rounded border-line text-brand-600 focus:ring-brand-600",
                ...
                tableColumns.map((col) => /* @__PURE__ */ jsx("td", { className: `p-2 md:p-4 text-xs md:text-sm text-ink-secondary ${col.className || ""}`, children: (() => {
                  switch (col.key) {
                    case "date":
                      return /* @__PURE__ */ jsx("span", { className: "font-medium", children: formatDate(row.created_at) });
                    case "reference":
                      return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsx("span", { className: "font-mono text-brand-600 dark:text-brand-400 font-semibold", children: row.reference_number }),
                        row.source === "pos" && /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400 px-1.5 py-0.5 rounded uppercase", children: "POS" }),
                        row.is_dropship && /* @__PURE__ */ jsxs("span", { className: "text-2xs font-bold bg-brand-50 border border-brand-100/50 text-brand-600 dark:bg-brand-950/40 dark:border-brand-900/40 dark:text-brand-400 px-1.5 py-0.5 rounded uppercase tracking-wide flex items-center gap-1.5", children: [
                    ...
                    case "due_date":
                      return /* @__PURE__ */ jsx("span", { className: "text-ink-muted", children: "-" });
                    case "status":
                      ...
                      return /* @__PURE__ */ jsx("span", { className: `px-2 py-1 rounded-md text-xs font-bold uppercase ${statusStyles[status] || "bg-sunken text-ink-secondary"}`, children: status });
                    case "actions":
                      return /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2 relative", children: [
                        /* @__PURE__ */ jsx("button", { onClick: (e) => {
                          e.stopPropagation();
                          PrintService.quickPrint(row);
                        }, className: "p-1.5 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-lg text-ink-muted hover:text-brand-600 transition-colors", children: /* @__PURE__ */ jsx(Printer, { size: 16 }) }),
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                          ...
                          activeActionMenu === row.id && /* @__PURE__ */ jsx("div", { className: "absolute right-0 top-full mt-2 w-64 bg-surface rounded-[14px] shadow-xl border border-line p-1 z-50 animate-in zoom-in-95", children: /* @__PURE__ */ jsxs("div", { className: "py-1", children: [
                            row.source === "pos" ? /* @__PURE__ */ jsxs("a", { href: route("store.pos", { store_slug: store?.slug }) + "?recall=" + row.id, className: "w-full text-left px-3 py-2 hover:bg-interactive-hover rounded dark:hover:bg-interactive-hover flex items-center gap-2 text-sm text-ink-secondary", children: [
                              /* @__PURE__ */ jsx(Edit, { size: 14 }),
                              " Open in POS"
                            ] }) : /* @__PURE__ */ jsxs(Link, { href: route("store.sales.edit", { store_slug: store?.slug, sale: row.id }), className: "w-full text-left px-3 py-2 hover:bg-interactive-hover rounded dark:hover:bg-interactive-hover flex items-center gap-2 text-sm text-ink-secondary", children: [
                              /* @__PURE__ */ jsx(Edit, { size: 14 }),
                              " View/Edit"
                            ] }),
                            /* @__PURE__ */ jsxs(Link, { href: route("store.sales.show", { store_slug: store?.slug, sale: row.id }) + "?action=return", className: "w-full text-left px-3 py-2 hover:bg-interactive-hover rounded dark:hover:bg-interactive-hover flex items-center gap-2 text-sm text-ink-secondary", children: [
                            ...
                            }, className: "w-full text-left px-3 py-2 hover:bg-interactive-hover rounded dark:hover:bg-interactive-hover flex items-center gap-2 text-sm text-red-600", children: [
                            ...
                            /* @__PURE__ */ jsxs("a", { href: route("store.sales.print", { store_slug: store?.slug, sale: row.id }), target: "_blank", className: "w-full text-left px-3 py-2 hover:bg-interactive-hover rounded dark:hover:bg-interactive-hover flex items-center gap-2 text-sm text-ink-secondary", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "md:hidden flex flex-col gap-2 px-0 py-1.5 bg-transparent", children: sortedSales.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-xl p-8 text-center border border-line", children: [
          /* @__PURE__ */ jsx(FileText, { size: 32, className: "mx-auto text-ink-muted mb-2" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink-secondary", children: "No sales found" })
        ] }) : sortedSales.map((row) => {
          const isReturn = row.status === "returned" || row.reference_number && row.reference_number.startsWith("RET");
...
`,
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("h3", { className: "font-bold text-ink text-sm", children: row.customer?.name || "Walk-in" }),
                    row.customer?.phone && /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted font-semibold", children: row.customer.phone })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                    /* @__PURE__ */ jsx("span", { className: "font-mono text-xs font-bold text-brand-600 dark:text-brand-400 block", children: row.reference_number }),
                    /* @__PURE__ */ jsx("span", { className: "text-2xs text-ink-muted font-semibold block mt-0.5", children: formatDate(row.created_at) })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                  isReturn ? /* @__PURE__ */ jsx("span", { className: "text-3xs font-bold uppercase bg-rose-100 text-rose-700 dark:bg-rose-500/20 dark:text-rose-400 px-2 py-0.5 rounded border border-rose-200/30", children: "Return" }) : isPos ? /* @__PURE__ */ jsx("span", { className: "text-3xs font-bold uppercase bg-orange-100 text-orange-700 dark:bg-orange-500/20 dark:text-orange-400 px-2 py-0.5 rounded border border-orange-200/30", children: "POS Sale" }) : /* @__PURE__ */ jsx("span", { className: "text-3xs font-bold uppercase bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400 px-2 py-0.5 rounded border border-emerald-200/30", children: "Sale" }),
                  (() => {
                    let status = row.payment_status;
                    const pAmt = parseFloat(row.paid_amount || (status === "paid" ? row.total : 0));
                    const tAmt = parseFloat(row.total);
                    ...
                    return /* @__PURE__ */ jsx("span", { className: `px-2 py-0.5 rounded text-3xs font-bold uppercase ${statusStyles[status] || "bg-sunken text-ink-secondary"}`, children: status });
                  })()
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-t border-line pt-2 mt-1", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-ink", children: formatCurrency(row.total, store) })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("span", { className: "text-3xs text-ink-muted font-bold uppercase block tracking-wider", children: "Balance" }),
                      balance > 1 ? /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-rose-600 dark:text-rose-450", children: formatCurrency(balance, store) }) : balance < -1 ? /* @__PURE__ */ jsxs("span", { className: "text-xs font-bold text-blue-600 dark:text-blue-400", children: [
                        "+",
                        formatCurrency(Math.abs(balance), store)
                      ] }) : /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 px-2 py-0.5 rounded border border-emerald-500/10", children: "Settled" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", onClick: (e) => e.stopPropagation(), children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                      ...
                      activeSharePopup === row.id && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 bottom-full mb-2 w-40 bg-surface rounded-[14px] shadow-xl border border-line p-1 z-50 animate-in zoom-in-95", children: [
                        /* @__PURE__ */ jsxs("button", { className: "w-full text-left px-3 py-2 hover:bg-interactive-hover rounded dark:hover:bg-interactive-hover flex items-center gap-2 text-sm", children: [
                          /* @__PURE__ */ jsx(Mail, { size: 14, className: "text-red-500" }),
                          " Email"
                        ] }),
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                      ...
                      activeActionMenu === row.id && /* @__PURE__ */ jsx("div", { className: "absolute right-0 bottom-full mb-2 w-64 bg-surface rounded-[14px] shadow-xl border border-line p-1 z-50 animate-in zoom-in-95", children: /* @__PURE__ */ jsxs("div", { className: "py-1", children: [
                        row.source === "pos" ? /* @__PURE__ */ jsxs("a", { href: route("store.pos", { store_slug: store?.slug }) + "?recall=" + row.id, className: "w-full text-left px-3 py-2 hover:bg-interactive-hover rounded dark:hover:bg-interactive-hover flex items-center gap-2 text-sm text-ink-secondary", children: [
                          /* @__PURE__ */ jsx(Edit, { size: 14 }),
                          " Open in POS"
                        ] }) : /* @__PURE__ */ jsxs(Link, { href: route("store.sales.edit", { store_slug: store?.slug, sale: row.id }), className: "w-full text-left px-3 py-2 hover:bg-interactive-hover rounded dark:hover:bg-interactive-hover flex items-center gap-2 text-sm text-ink-secondary", children: [
        ...
        /* @__PURE__ */ jsx("div", { ref: observerTarget, className: "p-4 text-center text-ink-muted text-sm opacity-0 h-4", children: sales.next_page_url ? "Loading..." : "" })
      ] })
    ] }),
    quickViewSale && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-modal flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-normal", onClick: () => setQuickViewSale(null), children: /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-3 sm:items-center justify-between p-4 border-b border-line bg-gradient-to-r from-neutral-50 to-white dark:from-neutral-800 dark:to-neutral-900 shrink-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-2xs sm:text-xs font-bold text-ink-muted uppercase tracking-wider", children: "Invoice Preview" }),
                /* @__PURE__ */ jsx("h3", { className: "text-lg sm:text-xl font-bold text-brand-600 truncate", children: quickViewSale.reference_number })
              ] }),
              quickViewSale.source === "pos" && /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400 px-2 py-1 rounded-full uppercase shrink-0", children: "POS" }),
              (() => {
                const statusStyles = {
                  paid: "bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400",
                  partial: "bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-400",
                ...
                return /* @__PURE__ */ jsx("span", { className: `px-2 py-1 rounded-full text-2xs font-bold uppercase ${statusStyles[quickViewSale.payment_status] || "bg-sunken text-ink-secondary"}`, children: quickViewSale.payment_status });
              })()
            ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-auto p-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "bg-app p-3 rounded-xl", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink text-sm", children: quickViewSale.customer?.name || "Walk-in" }),
                quickViewSale.customer?.phone && /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: quickViewSale.customer.phone })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-app p-3 rounded-xl", children: [
                /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-ink-muted uppercase mb-1", children: "Date & Time" }),
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink text-sm", children: formatDate(quickViewSale.created_at) }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: formatTime(quickViewSale.created_at) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-app p-3 rounded-xl", children: [
                /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-ink-muted uppercase mb-1", children: "Payment" }),
                /* @__PURE__ */ jsx("p", { className: "font-bold text-ink text-sm uppercase", children: quickViewSale.payment_method || "Cash" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-brand-100 dark:bg-brand-900/30 p-3 rounded-xl border border-brand-200 dark:border-brand-800", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "font-bold text-brand-600 text-lg", children: formatCurrency(quickViewSale.total, store) })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "border border-line rounded-xl overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "hidden sm:block max-h-[300px] overflow-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
                /* @__PURE__ */ jsx("thead", { className: "sticky top-0 bg-surface border-b border-line", children: /* @__PURE__ */ jsxs("tr", { children: [
                  ...
                  /* @__PURE__ */ jsx("th", { className: "text-center p-3 text-2xs font-bold text-ink-muted uppercase", children: quickViewSale.items?.some((i) => parseFloat(i.free_quantity || 0) > 0) ? "Qty + Free" : "Qty" }),
                  /* @__PURE__ */ jsx("th", { className: "text-right p-3 text-2xs font-bold text-ink-muted uppercase", children: "Rate" }),
                  /* @__PURE__ */ jsx("th", { className: "text-right p-3 text-2xs font-bold text-ink-muted uppercase", children: "Discount" }),
                  /* @__PURE__ */ jsx("th", { className: "text-right p-3 text-2xs font-bold text-ink-muted uppercase", children: "Total" })
                ] }) }),
                /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-line", children: quickViewSale.items && quickViewSale.items.length > 0 ? quickViewSale.items.map((item, idx) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-interactive-hover dark:hover:bg-interactive-hover", children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: "p-3 text-center font-bold text-ink-secondary", children: parseFloat(item.free_quantity || 0) > 0 ? `${parseFloat(item.quantity) || 0}+${parseFloat(item.free_quantity) || 0}` : parseFloat(item.quantity) || 0 }),
                  ...
                  /* @__PURE__ */ jsx("td", { className: "p-3 text-right font-bold text-ink", children: formatCurrency(item.quantity * (item.price || item.unit_price || 0) - parseFloat(item.discount_amount || item.discount || 0), store) })
                ] }, idx)) : /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 6, className: "p-6 text-center text-ink-muted", children: "No items data available" }) }) })
              ] }) }),
              /* @__PURE__ */ jsx("div", { className: "block sm:hidden divide-y divide-line max-h-[300px] overflow-auto", children: quickViewSale.items && quickViewSale.items.length > 0 ? quickViewSale.items.map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "p-3 hover:bg-interactive-hover dark:hover:bg-interactive-hover flex flex-col gap-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-start", children: [
                    /* @__PURE__ */ jsxs("span", { className: "text-ink-muted font-mono text-xs", children: [
                      idx + 1,
                      "."
                    ] }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("p", { className: "font-semibold text-ink text-xs", children: item.product?.name || item.name || "Unknown Item" }),
                      item.product?.sku && /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted font-mono mt-0.5", children: item.product.sku })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink shrink-0", children: formatCurrency(item.quantity * (item.price || item.unit_price || 0) - parseFloat(item.discount_amount || item.discount || 0), store) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-2 text-2xs bg-surface/50 dark:bg-app p-2 rounded-lg border border-line", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-ink-muted block uppercase", children: parseFloat(item.free_quantity || 0) > 0 ? "Qty + Free" : "Qty" }),
                    /* @__PURE__ */ jsx("span", { className: "font-bold text-ink-secondary", children: parseFloat(item.free_quantity || 0) > 0 ? `${parseFloat(item.quantity) || 0}+${parseFloat(item.free_quantity) || 0}` : parseFloat(item.quantity) || 0 })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-ink-muted block uppercase", children: "Rate" }),
                    /* @__PURE__ */ jsx("span", { className: "font-semibold text-ink-secondary", children: formatCurrency(item.price || item.unit_price || 0, store) })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("span", { className: "text-ink-muted block uppercase", children: "Discount" }),
              ...
              ] }, idx)) : /* @__PURE__ */ jsx("div", { className: "p-6 text-center text-ink-muted text-xs", children: "No items data available" }) }),
              /* @__PURE__ */ jsx("div", { className: "bg-app px-4 py-3 border-t border-line", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-between sm:justify-end gap-4 sm:gap-8", children: [
                /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted uppercase", children: "Subtotal" }),
                  /* @__PURE__ */ jsx("p", { className: "font-bold text-ink-secondary", children: formatCurrency(quickViewSale.subtotal_gross || quickViewSale.subtotal || quickViewSale.total, store) })
                ] }),
                parseFloat(quickViewSale.total_item_discounts || 0) > 0 && /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted uppercase", children: "Item Discounts" }),
                ...
                parseFloat(quickViewSale.global_discount || quickViewSale.discount || 0) > 0 && /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted uppercase", children: "Invoice Discount" }),
                  /* @__PURE__ */ jsxs("p", { className: "font-bold text-orange-600", children: [
                    "-",
                ...
                quickViewSale.tax > 0 && /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted uppercase", children: "Tax" }),
                  /* @__PURE__ */ jsx("p", { className: "font-bold text-ink-secondary", children: formatCurrency(quickViewSale.tax, store) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "text-right border-l border-line pl-8", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "font-bold text-lg text-brand-600", children: formatCurrency(quickViewSale.total, store) })
                ] })
              ] }) })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mt-4 flex flex-col sm:flex-row gap-3 justify-between sm:items-center p-3 bg-app rounded-xl", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex gap-6 justify-between w-full sm:w-auto", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted uppercase", children: "Paid Amount" }),
                ...
                (() => {
                  ...
                  if (balance > 1) {
                    return /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted uppercase", children: "Balance Due" }),
