...
function PartyStatement({ party, transactions = [], openingBalance = 0, filters = {}, parties = [] }) {
  ...
  const columns = [
    ...
    },
    {
      key: "ref",
      label: "Reference",
      render: (row) => /* @__PURE__ */ jsx("span", { className: "font-mono text-xs text-ink-muted", children: row.ref })
    },
    {
      key: "debit",
      label: "Debit",
      align: "right",
      render: (row) => row.debit > 0 ? /* @__PURE__ */ jsx("span", { className: "font-bold text-ink-secondary", children: formatCurrency(row.debit) }) : "-"
    },
    {
      key: "credit",
      label: "Credit",
      align: "right",
      render: (row) => row.credit > 0 ? /* @__PURE__ */ jsx("span", { className: "font-bold text-ink-secondary", children: formatCurrency(row.credit) }) : "-"
    },
    {
      key: "balance",
      label: "Balance",
  ...
  return /* @__PURE__ */ jsxs(ReportsLayout, { title: "Party Statement", children: [
    ...
    !party ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-[60vh] bg-surface rounded-2xl border border-dashed border-line dark:border-line", children: [
      /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-brand-50 dark:bg-brand-900/30 text-brand-500 rounded-full flex items-center justify-center mb-4", children: /* @__PURE__ */ jsx(Users, { size: 32 }) }),
      /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-ink mb-2", children: "Select a Party" }),
      /* @__PURE__ */ jsx("p", { className: "text-ink-muted mb-6 text-center max-w-md", children: "Please select a customer or supplier from the filters above to generate their detailed ledger statement." }),
