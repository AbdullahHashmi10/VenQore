                  ...
                  switch (col.key) {
                    ...
                    case "reference":
                      return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                        ...
                        row.source === "pos" && /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400 px-1.5 py-0.5 rounded uppercase", children: "POS" }),
                        row.is_dropship && /* @__PURE__ */ jsxs("span", { className: "text-[10px] font-black bg-indigo-50 border border-indigo-100/50 text-indigo-600 dark:bg-indigo-950/40 dark:border-indigo-900/40 dark:text-indigo-400 px-1.5 py-0.5 rounded uppercase tracking-wide flex items-center gap-1.5", children: [
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    ...
                    row.customer?.phone && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 font-semibold", children: row.customer.phone })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "text-[10px] text-slate-400 font-semibold block mt-0.5", children: formatDate(row.created_at) })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                  isReturn ? /* @__PURE__ */ jsx("span", { className: "text-[9px] font-black uppercase bg-rose-100 text-rose-700 dark:bg-rose-500/20 dark:text-rose-400 px-2 py-0.5 rounded border border-rose-200/30", children: "Return" }) : isPos ? /* @__PURE__ */ jsx("span", { className: "text-[9px] font-black uppercase bg-orange-100 text-orange-700 dark:bg-orange-500/20 dark:text-orange-400 px-2 py-0.5 rounded border border-orange-200/30", children: "POS Sale" }) : /* @__PURE__ */ jsx("span", { className: "text-[9px] font-black uppercase bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400 px-2 py-0.5 rounded border border-emerald-200/30", children: "Sale" }),
                  (() => {
                    let status = row.payment_status;
                    const pAmt = parseFloat(row.paid_amount || (status === "paid" ? row.total : 0));
                    const tAmt = parseFloat(row.total);
                    ...
                    return /* @__PURE__ */ jsx("span", { className: `px-2 py-0.5 rounded text-[9px] font-bold uppercase ${statusStyles[status] || "bg-slate-100 text-slate-700"}`, children: status });
                  })()
                ] }),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      balance > 1 ? /* @__PURE__ */ jsx("span", { className: "text-xs font-black text-rose-600 dark:text-rose-450", children: formatCurrency(balance, store) }) : balance < -1 ? /* @__PURE__ */ jsxs("span", { className: "text-xs font-black text-blue-600 dark:text-blue-400", children: [
                        "+",
                        formatCurrency(Math.abs(balance), store)
                      ] }) : /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-emerald-600 dark:text-emerald-450 bg-emerald-50 dark:bg-emerald-950/40 px-2 py-0.5 rounded border border-emerald-500/10", children: "Settled" })
                    ] })
                  ] }),
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-3 sm:items-center justify-between p-4 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-slate-50 to-white dark:from-slate-800 dark:to-slate-900 shrink-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-bold text-slate-400 uppercase tracking-wider", children: "Invoice Preview" }),
                /* @__PURE__ */ jsx("h3", { className: "text-lg sm:text-xl font-black text-indigo-600 truncate", children: quickViewSale.reference_number })
              ] }),
              quickViewSale.source === "pos" && /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400 px-2 py-1 rounded-full uppercase shrink-0", children: "POS" }),
              (() => {
                const statusStyles = {
                  paid: "bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400",
                  partial: "bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-400",
                ...
                return /* @__PURE__ */ jsx("span", { className: `px-2 py-1 rounded-full text-[10px] font-bold uppercase ${statusStyles[quickViewSale.payment_status] || "bg-slate-100 text-slate-700"}`, children: quickViewSale.payment_status });
              })()
            ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-auto p-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "bg-slate-50 dark:bg-slate-800 p-3 rounded-xl", children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold text-slate-400 uppercase mb-1", children: "Date & Time" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "hidden sm:block max-h-[300px] overflow-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
                /* @__PURE__ */ jsx("thead", { className: "sticky top-0 bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800", children: /* @__PURE__ */ jsxs("tr", { children: [
                  ...
                  /* @__PURE__ */ jsx("th", { className: "text-center p-3 text-[10px] font-bold text-slate-400 uppercase", children: quickViewSale.items?.some((i) => parseFloat(i.free_quantity || 0) > 0) ? "Qty + Free" : "Qty" }),
                  /* @__PURE__ */ jsx("th", { className: "text-right p-3 text-[10px] font-bold text-slate-400 uppercase", children: "Rate" }),
                  /* @__PURE__ */ jsx("th", { className: "text-right p-3 text-[10px] font-bold text-slate-400 uppercase", children: "Discount" }),
              ...
              /* @__PURE__ */ jsx("div", { className: "block sm:hidden divide-y divide-slate-150 dark:divide-slate-800 max-h-[300px] overflow-auto", children: quickViewSale.items && quickViewSale.items.length > 0 ? quickViewSale.items.map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "p-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 flex flex-col gap-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-start", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      item.product?.sku && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 font-mono mt-0.5", children: item.product.sku })
                    ] })
                  ] }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-2 text-[10px] bg-slate-50/50 dark:bg-slate-900/50 p-2 rounded-lg border border-slate-100 dark:border-slate-800/50", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "bg-slate-50 dark:bg-slate-800 px-4 py-3 border-t border-slate-200 dark:border-slate-700", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-between sm:justify-end gap-4 sm:gap-8", children: [
                ...
                parseFloat(quickViewSale.total_item_discounts || 0) > 0 && /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 uppercase", children: "Item Discounts" }),
                ...
                parseFloat(quickViewSale.global_discount || quickViewSale.discount || 0) > 0 && /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 uppercase", children: "Invoice Discount" }),
                  /* @__PURE__ */ jsxs("p", { className: "font-bold text-orange-600", children: [
                    "-",
                ...
                quickViewSale.tax > 0 && /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 uppercase", children: "Tax" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-4 flex flex-col sm:flex-row gap-3 justify-between sm:items-center p-3 bg-slate-50 dark:bg-slate-800 rounded-xl", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex gap-6 justify-between w-full sm:w-auto", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 uppercase", children: "Paid Amount" }),
                ...
                (() => {
                  ...
                  if (balance > 1) {
                    return /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 uppercase", children: "Balance Due" }),
