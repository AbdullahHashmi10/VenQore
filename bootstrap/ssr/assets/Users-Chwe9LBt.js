      ...
      /* @__PURE__ */ jsx("div", { style: { background: T.bgTable, border: `1px solid ${T.border}`, borderRadius: 16, overflow: "hidden" }, children: /* @__PURE__ */ jsxs("table", { style: { width: "100%", borderCollapse: "collapse" }, children: [
        ...
        /* @__PURE__ */ jsxs("tbody", { children: [
          users.data.map((u) => /* @__PURE__ */ jsxs("tr", { style: { borderBottom: `1px solid ${T.rowBorder}`, transition: "background 0.2s", background: selected.includes(u.id) ? "rgba(99,102,241,0.05)" : "transparent" }, children: [
            ...
            /* @__PURE__ */ jsx("td", { style: { padding: "16px 20px" }, children: u.is_platform_admin ? /* @__PURE__ */ jsxs("span", { style: { fontSize: 10, fontWeight: 800, color: "#10b981", background: "rgba(16,185,129,0.1)", border: "1px solid rgba(16,185,129,0.2)", padding: "2px 8px", borderRadius: 4, display: "inline-flex", alignItems: "center", gap: 4 }, children: [
            ...
            trashed && /* @__PURE__ */ jsx("td", { style: { padding: "16px 20px", color: "#ef4444", fontSize: 12 }, children: u.deleted_at }),
            /* @__PURE__ */ jsx("td", { style: { padding: "16px 20px", textAlign: "right" }, children: u.is_trashed ? /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 8, justifyContent: "flex-end" }, children: [
              /* @__PURE__ */ jsxs("button", { onClick: () => onRestore(u.id), style: { padding: "6px 12px", borderRadius: 8, background: "rgba(16,185,129,0.1)", color: "#10b981", border: "1px solid rgba(16,185,129,0.2)", fontSize: 12, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 4 }, children: [
                /* @__PURE__ */ jsx(RotateCcw, { size: 14 }),
                " Restore"
              ] }),
              /* @__PURE__ */ jsxs("button", { onClick: () => onPurge(u.id), style: { padding: "6px 12px", borderRadius: 8, background: "rgba(239,68,68,0.1)", color: "#ef4444", border: "1px solid rgba(239,68,68,0.2)", fontSize: 12, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 4 }, children: [
              ...
              /* @__PURE__ */ jsx(Dropdown.Content, { align: "right", width: "48", children: /* @__PURE__ */ jsx(Dropdown.Link, { href: route("platform.user.destroy", u.id), method: "delete", as: "button", style: { fontSize: 13, fontWeight: 500, color: "#ef4444" }, children: "Trash User" }) })
            ] }) })
          ] }, u.id)),
