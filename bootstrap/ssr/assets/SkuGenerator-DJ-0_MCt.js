      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-brand-500/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(ListPlus, { size: 17, className: "text-brand-500 dark:text-brand-300" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "Category & variant codes" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Map full names to short codes — these feed the scheme below." })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "space-y-2", children: categories.map((c, i) => /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                ...
                /* @__PURE__ */ jsx("button", { onClick: () => removeMapRow(setCategories, i), className: "text-ink-muted hover:text-red-500 transition-colors shrink-0", children: /* @__PURE__ */ jsx(Trash2, { size: 15 }) })
              ] }, i)) }),
              /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => addMapRow(setCategories), className: "mt-3 px-3 py-1.5 rounded-lg vq-tool-inset text-ink-secondary text-xs font-bold uppercase tracking-wide hover:border-brand-400/40 transition-colors inline-flex items-center gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "space-y-2", children: variants.map((v, i) => /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                ...
                /* @__PURE__ */ jsx("button", { onClick: () => removeMapRow(setVariants, i), className: "text-ink-muted hover:text-red-500 transition-colors shrink-0", children: /* @__PURE__ */ jsx(Trash2, { size: 15 }) })
              ] }, i)) }),
              /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => addMapRow(setVariants), className: "mt-3 px-3 py-1.5 rounded-lg vq-tool-inset text-ink-secondary text-xs font-bold uppercase tracking-wide hover:border-brand-400/40 transition-colors inline-flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsx(Plus, { size: 13 }),
                " Add variant"
              ] })
            ] })
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-6 vq-tool-panel vq-tool-panel--pad", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-brand-500/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(Layers, { size: 17, className: "text-brand-500 dark:text-brand-300" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "SKU scheme" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Add, reorder and configure segments. The preview updates live." })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-3", children: segments.map((seg, i) => /* @__PURE__ */ jsx("div", { className: "p-4 rounded-2xl vq-tool-inset", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
            /* @__PURE__ */ jsx(GripVertical, { size: 15, className: "text-ink-secondary dark:text-ink-secondary shrink-0" }),
            ...
            seg.type === "sequence" && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("label", { className: "text-xs text-ink-muted", children: "Start" }),
              ...
              /* @__PURE__ */ jsx("label", { className: "text-xs text-ink-muted", children: "Digits" }),
            ...
            seg.type === "random" && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("label", { className: "text-xs text-ink-muted", children: "Length" }),
              ...
              /* @__PURE__ */ jsx("span", { className: "text-1xs text-ink-muted", children: "no O/0 or I/1 ambiguity" })
            ] }),
            (seg.type === "category" || seg.type === "variant") && /* @__PURE__ */ jsxs("span", { className: "text-xs text-ink-muted", children: [
              "Looked up per-row from the ",
              seg.type,
              " map above."
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "ml-auto flex items-center gap-1 shrink-0", children: [
              /* @__PURE__ */ jsx("button", { type: "button", onClick: () => moveSegment(seg.id, -1), disabled: i === 0, className: "p-1.5 rounded-lg text-ink-muted hover:text-ink-secondary disabled:opacity-30 transition-colors", children: /* @__PURE__ */ jsx(ArrowUp, { size: 14 }) }),
              /* @__PURE__ */ jsx("button", { type: "button", onClick: () => moveSegment(seg.id, 1), disabled: i === segments.length - 1, className: "p-1.5 rounded-lg text-ink-muted hover:text-ink-secondary disabled:opacity-30 transition-colors", children: /* @__PURE__ */ jsx(ArrowDown, { size: 14 }) }),
              /* @__PURE__ */ jsx("button", { type: "button", onClick: () => removeSegment(seg.id), className: "p-1.5 rounded-lg text-ink-muted hover:text-red-500 transition-colors", children: /* @__PURE__ */ jsx(Trash2, { size: 14 }) })
            ] })
          ] }) }, seg.id)) }),
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2 mt-4", children: SEGMENT_TYPES.map((t) => /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => addSegment(t.value), className: "px-3.5 py-2 rounded-xl vq-tool-inset text-ink-secondary text-xs font-bold uppercase tracking-wide hover:border-brand-400/40 transition-colors inline-flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx(Plus, { size: 13 }),
            " ",
            t.label
          ] }, t.value)) }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-6 p-5 rounded-2xl bg-brand-500/[0.06] dark:bg-brand-500/10 border border-brand-500/20 text-center", children: [
            /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-brand-500 dark:text-brand-300 mb-1", children: "Live preview" }),
            /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold font-mono text-ink", children: previewSku })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-6 vq-tool-panel vq-tool-panel--pad", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-brand-500/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(Table, { size: 17, className: "text-brand-500 dark:text-brand-300" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-ink", children: "Generate in bulk" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Add products, then export the generated SKUs as CSV." })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsx("div", { className: "overflow-x-auto rounded-2xl border border-line", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm min-w-[720px]", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { className: "bg-sunken text-left", children: ["Product Name", "Category", "Variant", "Generated SKU", ""].map((h) => /* @__PURE__ */ jsx("th", { className: "px-3 py-2.5 font-bold text-ink-secondary text-xs uppercase tracking-wide", children: h }, h)) }) }),
            /* @__PURE__ */ jsx("tbody", { children: results.map((r, i) => /* @__PURE__ */ jsxs("tr", { className: "border-t border-line", children: [
              ...
              /* @__PURE__ */ jsxs("td", { className: "px-3 py-2 whitespace-nowrap", children: [
                /* @__PURE__ */ jsx("span", { className: `font-mono font-bold ${duplicateSkus.has(r.sku) ? "text-amber-600 dark:text-amber-400" : "text-ink-secondary dark:text-ink"}`, children: r.sku || "—" }),
              ...
              /* @__PURE__ */ jsx("td", { className: "px-3 py-2", children: /* @__PURE__ */ jsx("button", { onClick: () => removeRow(i), className: "text-ink-muted hover:text-red-500 transition-colors", children: /* @__PURE__ */ jsx(Trash2, { size: 15 }) }) })
            ] }, i)) })
          ] }) }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3 mt-4", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-1xs text-ink-muted", children: "Downloads directly from your browser — nothing is sent to a server." })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("section", { className: "mt-12", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold mb-4 text-ink", children: "What makes a good SKU scheme?" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-6 rounded-2xl bg-brand-500/[0.06] dark:bg-brand-500/10 border border-brand-500/20 mb-6", children: [
            /* @__PURE__ */ jsx("p", { className: "font-bold text-ink mb-2", children: "Worked example" }),
          ...
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold mb-4 text-ink", children: "SKU vs. barcode vs. UPC" }),
          /* @__PURE__ */ jsxs("p", { className: "text-sm text-ink-secondary leading-relaxed", children: [
            "A ",
            /* @__PURE__ */ jsx("strong", { children: "SKU" }),
            ...
            "",
            /* @__PURE__ */ jsx("a", { href: "/tools/barcode-generator", className: "text-brand-600 dark:text-brand-300 font-bold hover:underline", children: "Barcode Generator" }),
            "."
          ] })
        ] })
      ]
