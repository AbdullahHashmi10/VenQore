    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6 max-w-[1600px] mx-auto min-h-0", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted", children: "Track company spending and overheads" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex bg-sunken p-1 rounded-lg", children: ["this_month", "last_month", "this_year", "custom"].map((r) => /* @__PURE__ */ jsx(
            "button",
            {
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6 h-[500px]", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 bg-surface border border-line rounded-2xl shadow-sm flex flex-col overflow-hidden h-full", children: [
          /* @__PURE__ */ jsxs("div", { className: "p-4 border-b border-line flex justify-between items-center", children: [
            /* @__PURE__ */ jsx("h2", { className: "font-bold text-ink-secondary dark:text-ink", children: "Expense History" }),
          ...
          /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
            /* @__PURE__ */ jsx("thead", { className: "bg-app sticky top-0 z-10", children: /* @__PURE__ */ jsxs("tr", { children: [
              ...
              /* @__PURE__ */ jsx("th", { className: "p-3 text-xs font-semibold text-ink-muted uppercase tracking-wider", children: "Category" }),
            ...
            /* @__PURE__ */ jsxs("tbody", { className: "divide-y divide-line", children: [
              processedExpenses.map((expense, idx) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors cursor-pointer group", children: [
                /* @__PURE__ */ jsx("td", { className: "p-3 text-sm text-ink-muted font-mono", children: formatDate(expense.date) }),
                /* @__PURE__ */ jsx("td", { className: "p-3 text-sm font-bold text-ink-secondary font-mono group-hover:text-brand-500", children: expense.reference }),
                /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsx("span", { className: "px-2 py-1 rounded-full text-2xs font-bold uppercase bg-sunken text-ink-secondary", children: (typeof expense.category === "string" ? expense.category : expense.category?.name) || "Uncategorized" }) }),
                /* @__PURE__ */ jsx("td", { className: "p-3 text-sm text-ink-secondary", children: expense.description }),
              ...
              processedExpenses.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "5", className: "h-64 text-center text-ink-muted", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center opacity-60", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "h-full flex flex-col gap-4 overflow-hidden min-h-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-surface border border-line rounded-2xl p-4 shadow-sm flex-1 min-h-0 flex flex-col", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xs font-bold text-ink-muted uppercase mb-2", children: "Category Breakdown" }),
            /* @__PURE__ */ jsx("div", { className: "flex-1 w-full min-h-0", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", minWidth: 1, minHeight: 1, children: /* @__PURE__ */ jsxs(BarChart, { data: chartData, layout: "vertical", margin: { left: 0, right: 30 }, children: [
              ...
              /* @__PURE__ */ jsx(Bar, { dataKey: "value", radius: [0, 4, 4, 0], barSize: 20, children: chartData.map((entry, index) => /* @__PURE__ */ jsx(Cell, { fill: series.light[index % 8] }, `cell-${index}`)) })
            ] }) }) })
          ] })
        ] })
      ] })
