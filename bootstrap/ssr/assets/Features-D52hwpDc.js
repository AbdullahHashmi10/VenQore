...
import { Layers, Gauge, ShoppingCart, Receipt, Truck, Warehouse, Globe, Calculator, BarChart3, Cpu, Sparkles, ScanBarcode, Factory, ArrowRight, TrendingUp, Package, Wallet, Loader2, Brain, CheckCircle2, AlertTriangle, Search, Check, Minus, Plus, Trash2, Mic, Upload, RefreshCw, Boxes, Repeat, Bot, ChevronRight, X, Lock } from "lucide-react";
...
function DemoFrame({ title, url, badge = "LIVE DEMO", accent = "indigo", children }) {
  return /* @__PURE__ */ jsxs("div", { className: "relative rounded-[1.5rem] border border-white/[0.08] bg-[#0a0820]/85 backdrop-blur-2xl shadow-[0_40px_140px_-50px_rgba(99,102,241,0.55)] overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-white/[0.06]", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "hidden sm:flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.04] border border-white/[0.06]", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-[10px] font-mono text-slate-400", children: url })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-emerald-400 vqf-blink" }),
        /* @__PURE__ */ jsx("span", { className: `text-[9px] font-black uppercase tracking-[0.2em] ${ACCENTS[accent] || ACCENTS.indigo}`, children: badge })
      ] })
    ] }),
...
const Donut = ({ segments, size = 132 }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { ref, className: "relative inline-flex items-center justify-center", style: { width: size, height: size }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center", children: [
      /* @__PURE__ */ jsx("span", { className: "text-[9px] font-black uppercase tracking-widest text-slate-500", children: "Net Margin" }),
      /* @__PURE__ */ jsxs("span", { className: "text-xl font-black text-emerald-400", children: [
...
const ProfitLossDemo = () => {
  ...
  return /* @__PURE__ */ jsxs(DemoFrame, { title: "Profit & Loss", url: "app.venqore.com/reports/profit-loss", accent: "emerald", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4 flex-wrap gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "text-[15px] font-black text-white tracking-tight", children: "Profit & Loss Statement" }),
          /* @__PURE__ */ jsx("div", { className: "text-[10px] text-slate-500", children: "Verified from the double-entry ledger" })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-2.5 mb-4", children: kpis.map((k) => /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-white/[0.06] bg-white/[0.02] p-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-[9px] font-black uppercase tracking-wide text-slate-500", children: k.l })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: `text-base sm:text-lg font-black tabular-nums ${k.c}`, children: [
        "$",
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 rounded-xl border border-white/[0.06] bg-white/[0.015] p-4 flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2 text-[11px]", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-slate-400", children: "COGS" }),
            /* @__PURE__ */ jsxs("span", { className: "ml-auto text-slate-300 font-bold", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-slate-400", children: "Expenses" }),
            /* @__PURE__ */ jsxs("span", { className: "ml-auto text-slate-300 font-bold", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "pt-1 mt-1 border-t border-white/5 flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "text-slate-500", children: "Gross margin" }),
            /* @__PURE__ */ jsxs("span", { className: "ml-auto text-white font-bold", children: [
              gm,
              "%"
            ] })
          ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-3 rounded-xl border border-white/[0.06] bg-white/[0.015] p-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Sparkles, { size: 14, className: "text-violet-300" }),
            /* @__PURE__ */ jsx("span", { className: "text-[13px] font-bold text-white", children: "AI Analysis" })
          ] }),
        ...
        phase === "idle" && /* @__PURE__ */ jsxs("p", { className: "text-slate-500 text-[12px] leading-relaxed", children: [
          "Click ",
          /* @__PURE__ */ jsx("span", { className: "text-violet-300 font-semibold", children: "Analyze with AI" }),
        ...
        phase === "analyzing" && /* @__PURE__ */ jsxs("div", { className: "space-y-2 animate-pulse", children: [
          /* @__PURE__ */ jsx("div", { className: "h-3 w-3/4 bg-white/5 rounded" }),
          /* @__PURE__ */ jsx("div", { className: "h-3 w-2/3 bg-white/5 rounded" }),
          /* @__PURE__ */ jsx("div", { className: "h-3 w-1/2 bg-white/5 rounded" })
        ] }),
        phase === "done" && /* @__PURE__ */ jsxs("div", { className: "vqf-in space-y-2.5", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-1", children: [
            /* @__PURE__ */ jsxs("div", { className: "text-2xl font-black text-emerald-400", children: [
              Math.round(parseFloat(nm) + 50),
              /* @__PURE__ */ jsx("span", { className: "text-sm text-slate-500", children: "/100" })
            ] }),
            /* @__PURE__ */ jsx("span", { className: "text-[11px] font-bold text-emerald-300 bg-emerald-500/10 px-2 py-1 rounded-full", children: "Financially Healthy" })
          ] }),
          [
          ...
          ].map((x, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2.5 p-2.5 rounded-lg bg-white/[0.02] border border-white/5", children: [
            /* @__PURE__ */ jsx(x.ic, { size: 15, className: `${x.c} mt-0.5 shrink-0` }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "text-[12px] font-bold text-slate-200", children: x.t }),
              /* @__PURE__ */ jsx("div", { className: "text-[11px] text-slate-500 leading-snug", children: x.d })
            ] })
          ] }, i))
        ] })
      ] })
...
const PosInvoiceDemo = () => {
  ...
  return /* @__PURE__ */ jsx(DemoFrame, { title: "POS", url: "app.venqore.com/pos", accent: "indigo", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "lg:col-span-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ jsxs("div", { className: "relative flex-1 max-w-xs", children: [
          /* @__PURE__ */ jsx(Search, { size: 13, className: "absolute left-3 top-1/2 -translate-y-1/2 text-slate-500" }),
          /* @__PURE__ */ jsx("div", { className: "w-full pl-8 pr-3 py-2 rounded-lg bg-white/[0.04] border border-white/[0.06] text-[11px] text-slate-500", children: "Scan barcode or search…" })
        ] }),
        /* @__PURE__ */ jsx("span", { className: "text-[9px] font-black uppercase tracking-widest text-slate-600 ml-3 hidden sm:block", children: "F1 Search · F4 Pay" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-2", children: POS_PRODUCTS.map((p) => /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: "text-xl mb-1.5 group-hover:scale-110 transition-transform", children: p.e }),
            /* @__PURE__ */ jsx("div", { className: "text-[11px] font-bold text-slate-200 truncate", children: p.n }),
            /* @__PURE__ */ jsxs("div", { className: "text-[11px] font-black text-indigo-300", children: [
              "Rs ",
              p.p
            ] })
          ]
    ...
    /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 rounded-xl border border-white/[0.06] bg-[#0b0a1c] p-3 flex flex-col", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2", children: [
        /* @__PURE__ */ jsx("span", { className: "text-[11px] font-black uppercase tracking-wider text-slate-400", children: "Cart" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "w-14 h-14 rounded-full bg-emerald-500/15 flex items-center justify-center mb-3", children: /* @__PURE__ */ jsx(Check, { size: 28, className: "text-emerald-400" }) }),
        /* @__PURE__ */ jsx("div", { className: "text-white font-black", children: "Sale completed" }),
        /* @__PURE__ */ jsx("div", { className: "text-[11px] text-slate-500 mb-1", children: "Journal posted · stock deducted (FIFO)" }),
        /* @__PURE__ */ jsxs("div", { className: "text-[11px] text-emerald-400 font-mono", children: [
          "Rs ",
          group(total),
          " · ",
          pay
        ...
        }, className: "mt-4 text-[11px] font-bold text-indigo-300 hover:underline", children: "New sale" })
      ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-1.5 min-h-[120px] max-h-[180px] overflow-y-auto pr-1", children: [
          cart.length === 0 && /* @__PURE__ */ jsx("div", { className: "text-center text-[11px] text-slate-600 py-10", children: "Tap a product to add" }),
          cart.map((x) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 p-2 rounded-lg bg-white/[0.03] border border-white/5", children: [
            /* @__PURE__ */ jsx("span", { className: "text-base", children: x.e }),
            /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
              /* @__PURE__ */ jsx("div", { className: "text-[11px] font-bold text-slate-200 truncate", children: x.n }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ jsx("button", { onClick: () => dec(x.id), className: "w-5 h-5 rounded bg-white/5 hover:bg-white/10 flex items-center justify-center text-slate-300", children: /* @__PURE__ */ jsx(Minus, { size: 11 }) }),
              /* @__PURE__ */ jsx("span", { className: "w-5 text-center text-[11px] font-bold text-white tabular-nums", children: x.q }),
              /* @__PURE__ */ jsx("button", { onClick: () => add(x), className: "w-5 h-5 rounded bg-white/5 hover:bg-white/10 flex items-center justify-center text-slate-300", children: /* @__PURE__ */ jsx(Plus, { size: 11 }) }),
              /* @__PURE__ */ jsx("button", { onClick: () => del(x.id), className: "w-5 h-5 rounded bg-rose-500/10 hover:bg-rose-500/20 flex items-center justify-center text-rose-400 ml-0.5", children: /* @__PURE__ */ jsx(Trash2, { size: 11 }) })
            ] })
          ] }, x.id))
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-2 pt-2 border-t border-white/5 space-y-1 text-[11px]", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-white font-black text-sm pt-0.5", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-1.5 mt-2.5", children: ["Cash", "Card", "Split"].map((m) => /* @__PURE__ */ jsx("button", { onClick: () => setPay(m), className: `py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wide border transition-all ${pay === m ? "bg-indigo-500/20 border-indigo-400/50 text-indigo-200" : "bg-white/[0.03] border-white/10 text-slate-500"}`, children: m }, m)) }),
        /* @__PURE__ */ jsxs("button", { onClick: () => cart.length && setDone(true), className: "mt-2 w-full py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-[#05130c] font-black text-[12px] uppercase tracking-wide transition-colors flex items-center justify-center gap-2 disabled:opacity-50", disabled: !cart.length, children: [
...
const Waveform = ({ active }) => /* @__PURE__ */ jsx("div", { className: "flex items-end gap-1 h-10", children: Array.from({ length: 28 }).map((_, i) => /* @__PURE__ */ jsx(
  "span",
  {
    className: `w-1 rounded-full ${active ? "bg-violet-400 vqf-wave" : "bg-white/15"}`,
...
const SmartCaptureDemo = () => {
  ...
  return /* @__PURE__ */ jsxs(DemoFrame, { title: "Smart Capture", url: "app.venqore.com/capture", badge: "AI · BYOK", accent: "violet", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4 flex-wrap gap-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: "w-1.5 h-5 rounded-full bg-violet-500" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "text-[15px] font-black text-white tracking-tight", children: "Smart Capture" }),
          /* @__PURE__ */ jsx("div", { className: "text-[10px] text-slate-500", children: "Snap a bill or speak — AI turns it into a transaction" })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2", children: [
        /* @__PURE__ */ jsx("div", { className: "relative rounded-xl border border-dashed border-white/15 bg-white/[0.02] h-[208px] flex flex-col items-center justify-center overflow-hidden", children: tab === "Image" ? /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsxs("div", { className: "w-28 rounded-md bg-white/90 p-2 shadow-xl rotate-[-3deg]", children: [
            /* @__PURE__ */ jsx("div", { className: "h-1.5 w-10 bg-slate-800 rounded mb-1.5" }),
            Array.from({ length: 6 }).map((_, i) => /* @__PURE__ */ jsx("div", { className: "h-1 bg-slate-300 rounded mb-1", style: { width: `${90 - i * 9}%` } }, i)),
            /* @__PURE__ */ jsx("div", { className: "h-1.5 w-12 bg-emerald-500 rounded mt-1.5 ml-auto" })
          ] }),
          phase === "working" && !reduced && /* @__PURE__ */ jsx("div", { className: "absolute left-0 right-0 h-0.5 bg-violet-400 shadow-[0_0_14px_2px_rgba(167,139,250,0.9)] vqf-scan" }),
          /* @__PURE__ */ jsx("div", { className: "mt-3 text-[10px] text-slate-500", children: "Sample supplier invoice" })
        ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("div", { className: `w-16 h-16 rounded-full flex items-center justify-center mb-3 ${phase === "working" ? "bg-violet-500/20 vqf-pulse" : "bg-white/[0.04]"}`, children: /* @__PURE__ */ jsx(Mic, { size: 26, className: phase === "working" ? "text-violet-300" : "text-slate-400" }) }),
          /* @__PURE__ */ jsx(Waveform, { active: phase === "working" }),
          /* @__PURE__ */ jsx("div", { className: "mt-2 text-[11px] font-mono text-slate-500", children: phase === "working" ? `00:0${t}` : "00:00" })
        ] }) }),
        phase === "idle" && /* @__PURE__ */ jsx("button", { onClick: run, className: "mt-3 w-full py-2.5 rounded-xl bg-violet-500/15 border border-violet-400/30 text-violet-200 font-bold text-[12px] hover:bg-violet-500/25 transition-colors flex items-center justify-center gap-2", children: tab === "Image" ? /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        phase === "working" && /* @__PURE__ */ jsxs("div", { className: "mt-3 w-full py-2.5 rounded-xl bg-white/[0.03] border border-white/10 text-slate-400 font-bold text-[12px] flex items-center justify-center gap-2", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-3 rounded-xl border border-white/[0.06] bg-white/[0.015] p-4 min-h-[208px]", children: phase === "idle" || phase === "working" ? /* @__PURE__ */ jsxs("div", { className: "h-full flex flex-col items-center justify-center text-center", children: [
        /* @__PURE__ */ jsx(Sparkles, { size: 22, className: "text-violet-300 mb-2" }),
        /* @__PURE__ */ jsx("div", { className: "text-[13px] font-bold text-white mb-1", children: "AI extraction" }),
        /* @__PURE__ */ jsxs("p", { className: "text-[11px] text-slate-500 max-w-xs", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black uppercase tracking-widest text-slate-500", children: "Detected" }),
            /* @__PURE__ */ jsx("span", { className: `px-2 py-0.5 rounded-full text-[10px] font-black ${data.action === "Sale" ? "bg-emerald-500/15 text-emerald-300" : "bg-amber-500/15 text-amber-300"}`, children: data.action }),
            /* @__PURE__ */ jsxs("span", { className: "text-[11px] text-slate-400", children: [
              "→ ",
              data.supplier || data.party
            ] })
          ] }),
          phase === "confirmed" && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 text-[10px] font-bold text-emerald-300", children: [
            /* @__PURE__ */ jsx(Check, { size: 12 }),
            " Draft created"
          ] })
        ] }),
        data.transcript && /* @__PURE__ */ jsx("div", { className: "mb-2 text-[11px] italic text-violet-200/80", children: data.transcript }),
        /* @__PURE__ */ jsx("div", { className: "space-y-1.5 mb-3", children: data.items.map((it, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 p-2 rounded-lg bg-white/[0.02] border border-white/5 vqf-in", style: { animationDelay: `${i * 0.1}s` }, children: [
          /* @__PURE__ */ jsx(CheckCircle2, { size: 14, className: "text-emerald-400 shrink-0" }),
          /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsx("div", { className: "text-[12px] font-bold text-slate-200 truncate", children: it.n }),
            /* @__PURE__ */ jsxs("div", { className: "text-[9px] font-mono text-slate-500", children: [
              "matched · ",
              it.sku
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "text-[11px] text-slate-400 tabular-nums", children: [
            it.qty,
            " × ",
            it.price
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "text-[11px] font-bold text-white tabular-nums w-16 text-right", children: [
            "Rs ",
            group(it.qty * it.price)
          ] })
        ] }, i)) }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between pt-2 border-t border-white/5", children: [
          /* @__PURE__ */ jsxs("span", { className: "text-[12px] font-black text-white", children: [
            "Total ",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxs("span", { className: "text-[13px] font-black text-white tabular-nums", children: [
              "Rs ",
              group(total)
            ] }),
            phase === "extracted" && /* @__PURE__ */ jsxs("button", { onClick: () => setPhase("confirmed"), className: "px-3 py-1.5 rounded-lg bg-emerald-500 text-[#05130c] text-[11px] font-black hover:bg-emerald-400 transition-colors flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsx(Check, { size: 12 }),
              " Confirm & Record"
            ] }),
            phase === "confirmed" && /* @__PURE__ */ jsx("button", { onClick: () => setPhase("idle"), className: "text-[11px] font-bold text-indigo-300 hover:underline", children: "Try again" })
          ] })
        ] })
      ] }) })
    ] })
...
const VenSynQDemo = () => {
  ...
  return /* @__PURE__ */ jsxs(DemoFrame, { title: "VenSynQ", url: "app.venqore.com/vensynq", badge: "MULTI-CHANNEL", accent: "blue", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4 flex-wrap gap-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: "w-1.5 h-5 rounded-full bg-blue-500" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "text-[15px] font-black text-white tracking-tight", children: "VenSynQ — Channel Command Center" }),
          /* @__PURE__ */ jsx("div", { className: "text-[10px] text-slate-500", children: "One inventory, every marketplace, true net margin" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs(
        "button",
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-2.5 mb-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-white/[0.06] bg-white/[0.02] p-3", children: [
        /* @__PURE__ */ jsx("div", { className: "text-[9px] font-black uppercase tracking-wide text-slate-500 mb-1", children: "Gross Revenue" }),
        /* @__PURE__ */ jsxs("div", { className: "text-lg font-black text-white tabular-nums", children: [
          "Rs ",
          /* @__PURE__ */ jsx(Num, { end: totalRev })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-white/[0.06] bg-white/[0.02] p-3", children: [
        /* @__PURE__ */ jsx("div", { className: "text-[9px] font-black uppercase tracking-wide text-slate-500 mb-1", children: "Net Profit" }),
        /* @__PURE__ */ jsxs("div", { className: "text-lg font-black text-emerald-300 tabular-nums", children: [
          "Rs ",
          /* @__PURE__ */ jsx(Num, { end: totalNet })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-white/[0.06] bg-white/[0.02] p-3", children: [
        /* @__PURE__ */ jsx("div", { className: "text-[9px] font-black uppercase tracking-wide text-slate-500 mb-1", children: "Channels" }),
        /* @__PURE__ */ jsxs("div", { className: "text-lg font-black text-white", children: [
          VQ_CHANNELS.length,
          " ",
          /* @__PURE__ */ jsx("span", { className: "text-[10px] text-slate-500 font-bold", children: "connected" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-emerald-500/20 bg-emerald-500/[0.06] p-3", children: [
        /* @__PURE__ */ jsx("div", { className: "text-[9px] font-black uppercase tracking-wide text-emerald-300/80 mb-1", children: "Most profitable" }),
        /* @__PURE__ */ jsx("div", { className: "text-lg font-black text-emerald-300", children: best.k })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "space-y-2", children: VQ_CHANNELS.map((c) => /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 items-center gap-2 p-2.5 rounded-xl border border-white/[0.06] bg-white/[0.015] hover:bg-white/[0.03] transition-colors", children: [
      /* @__PURE__ */ jsxs("div", { className: "col-span-4 sm:col-span-3 flex items-center gap-2.5 min-w-0", children: [
        /* @__PURE__ */ jsx("span", { className: "w-7 h-7 rounded-lg flex items-center justify-center text-[11px] font-black shrink-0", style: { background: c.c + "22", color: c.c }, children: c.k[0] }),
        /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsx("div", { className: "text-[12px] font-bold text-white truncate", children: c.k }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "hidden sm:block col-span-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "text-[9px] text-slate-500 mt-1", children: [
          "net margin ",
      ...
      /* @__PURE__ */ jsxs("div", { className: "col-span-4 sm:col-span-2 text-right", children: [
        /* @__PURE__ */ jsx("div", { className: "text-[9px] text-slate-500", children: "Revenue" }),
        /* @__PURE__ */ jsxs("div", { className: "text-[12px] font-bold text-white tabular-nums", children: [
          "Rs ",
          group(c.rev)
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "col-span-12 sm:col-span-2 flex sm:justify-end", children: /* @__PURE__ */ jsx("span", { className: `px-2 py-1 rounded-full text-[9px] font-black ${STOCK_TONE[c.tone]}`, children: c.stock }) })
    ] }, c.k)) })
  ] });
};
...
const GrowthEngineDemo = () => {
  ...
  return /* @__PURE__ */ jsxs(DemoFrame, { title: "Growth Engine", url: "app.venqore.com/growth", badge: "AI ENGINE", accent: "violet", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
      /* @__PURE__ */ jsx("span", { className: "w-1.5 h-5 rounded-full bg-violet-500" }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "text-[15px] font-black text-white tracking-tight", children: "Growth Engine" }),
        /* @__PURE__ */ jsx("div", { className: "text-[10px] text-slate-500", children: "Three models watching your business so you act before problems do" })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { ref, className: "grid grid-cols-1 md:grid-cols-3 gap-2.5 mb-4", children: GROWTH_SIGNALS.map((s, i) => {
      const t = GTONE[s.tone];
      return /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-white/[0.06] bg-white/[0.02] p-3.5 flex flex-col", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
          /* @__PURE__ */ jsx("div", { className: `p-1.5 rounded-lg ${t.b} ${t.c}`, children: /* @__PURE__ */ jsx(s.ic, { size: 14 }) }),
          /* @__PURE__ */ jsx("span", { className: `text-[9px] font-black uppercase tracking-widest ${t.c}`, children: s.tag })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "text-[13px] font-bold text-white mb-1", children: s.title }),
        /* @__PURE__ */ jsx("p", { className: "text-[11px] text-slate-500 leading-snug mb-3 flex-1", children: s.text }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-[9px] text-slate-500 mb-1", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "h-1.5 rounded-full bg-white/[0.06] overflow-hidden mb-3", children: /* @__PURE__ */ jsx("div", { className: `h-full rounded-full ${t.bar}`, style: { width: reduced || v ? `${s.conf}%` : 0, transition: "width 1.1s cubic-bezier(0.22,1,0.36,1)" } }) }),
        /* @__PURE__ */ jsxs("button", { className: `w-full py-1.5 rounded-lg ${t.b} ${t.c} text-[10px] font-bold flex items-center justify-center gap-1.5 hover:brightness-125 transition-all`, children: [
          /* @__PURE__ */ jsx(s.actIc, { size: 11 }),
          " ",
          s.action
        ] })
      ] }, i);
    }) }),
    /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-white/[0.06] bg-[#0b0a1c] p-3.5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
        /* @__PURE__ */ jsx("div", { className: "w-7 h-7 rounded-lg bg-violet-500/20 flex items-center justify-center", children: /* @__PURE__ */ jsx(Bot, { size: 15, className: "text-violet-300" }) }),
        /* @__PURE__ */ jsx("span", { className: "text-[12px] font-bold text-white", children: "Ask in plain English" })
      ] }),
      /* @__PURE__ */ jsxs("button", { onClick: () => setAsked(true), className: "w-full text-left px-3 py-2 rounded-lg bg-white/[0.04] border border-white/10 text-[12px] text-slate-300 hover:border-violet-400/40 transition-colors mb-2", children: [
        "“Which 5 products made me the most profit this month?” ",
        /* @__PURE__ */ jsx("span", { className: "text-violet-300 font-bold", children: "↵" })
      ] }),
      asked && /* @__PURE__ */ jsxs("div", { className: "vqf-in p-3 rounded-lg bg-white/[0.03] border border-white/5", children: [
        /* @__PURE__ */ jsx("p", { className: "text-[12px] text-slate-200 mb-2", children: "Your top profit drivers this month:" }),
        [["Coffee Jar", 38400], ["Hand Wash", 29100], ["Dark Choco", 21850], ["Milk 1L", 18600], ["Cola 500ml", 15200]].map(([n, p], i) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-[11px] py-0.5", children: [
...
const CookbookDemo = () => {
  ...
  return /* @__PURE__ */ jsxs(DemoFrame, { title: "Cookbook", url: "app.venqore.com/cookbook", badge: "MANUFACTURING", accent: "amber", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4 flex-wrap gap-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: "w-1.5 h-5 rounded-full bg-amber-500" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "text-[15px] font-black text-white tracking-tight", children: "Cookbook — Auto-Assembly" }),
          /* @__PURE__ */ jsx("div", { className: "text-[10px] text-slate-500", children: "Build composite items from a recipe — raw stock deducts automatically" })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-3 rounded-xl border border-white/[0.06] bg-white/[0.015] p-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[11px] font-black uppercase tracking-widest text-slate-500", children: "Bill of Materials" }),
          /* @__PURE__ */ jsx("span", { className: "text-[10px] text-slate-500", children: "per 1 unit" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "space-y-2", children: RECIPE.raw.map((r, i) => {
          const used = r.per * qty;
          return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 p-2 rounded-lg bg-white/[0.02] border border-white/5", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
              /* @__PURE__ */ jsx("div", { className: "text-[12px] font-bold text-slate-200", children: r.n }),
              /* @__PURE__ */ jsxs("div", { className: "text-[9px] text-slate-500", children: [
                r.per,
                r.unit,
                " / unit · stock ",
            ...
            /* @__PURE__ */ jsxs("div", { className: `text-[11px] font-bold tabular-nums ${ran ? "text-rose-300 vqf-in" : "text-slate-400"}`, children: [
              "−",
              group(used),
              r.unit
            ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 rounded-xl border border-white/[0.06] bg-[#0b0a1c] p-4 flex flex-col", children: [
        /* @__PURE__ */ jsx("div", { className: "text-[11px] font-black uppercase tracking-widest text-slate-500 mb-2", children: "Output" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5 mb-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-[13px] font-bold text-white", children: RECIPE.out }),
            /* @__PURE__ */ jsxs("div", { className: "text-[10px] text-slate-500", children: [
              "finished good · stock ",
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[11px] text-slate-400", children: "Quantity" }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 ml-auto", children: [
            /* @__PURE__ */ jsx("button", { onClick: () => setQty((q) => Math.max(5, q - 5)), className: "w-6 h-6 rounded bg-white/5 hover:bg-white/10 flex items-center justify-center text-slate-300", children: /* @__PURE__ */ jsx(Minus, { size: 12 }) }),
            /* @__PURE__ */ jsx("span", { className: "w-8 text-center text-[13px] font-black text-white tabular-nums", children: qty }),
            /* @__PURE__ */ jsx("button", { onClick: () => setQty((q) => q + 5), className: "w-6 h-6 rounded bg-white/5 hover:bg-white/10 flex items-center justify-center text-slate-300", children: /* @__PURE__ */ jsx(Plus, { size: 12 }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white/[0.03] border border-white/5 p-2.5 mb-3 text-[11px]", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-slate-400", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-slate-400 mt-1", children: [
        ...
        ran ? /* @__PURE__ */ jsxs("div", { className: "mt-auto vqf-in rounded-lg bg-emerald-500/10 border border-emerald-500/20 p-2.5 text-center", children: [
          /* @__PURE__ */ jsx(Check, { size: 18, className: "text-emerald-400 mx-auto mb-1" }),
          /* @__PURE__ */ jsx("div", { className: "text-[12px] font-bold text-white", children: mode === "Make now" ? `${qty} units produced` : "Auto-assembled on sale" }),
          /* @__PURE__ */ jsx("div", { className: "text-[10px] text-slate-500", children: "Raw stock deducted · journal posted" })
        ] }) : /* @__PURE__ */ jsxs("button", { onClick: run, className: "mt-auto w-full py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-[#1a1200] font-black text-[12px] uppercase tracking-wide transition-colors flex items-center justify-center gap-2", children: [
...
const FeatureExplorer = () => {
  ...
  const filtered = useMemo(() => {
    ...
    return ALL_ITEMS.filter(
      (it) => (cat === "all" || it.ckey === cat) && (!ql || it.n.toLowerCase().includes(ql) || it.d.toLowerCase().includes(ql))
    );
  }, [q, cat]);
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 mb-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-md mx-auto w-full", children: [
        /* @__PURE__ */ jsx(Search, { size: 16, className: "absolute left-4 top-1/2 -translate-y-1/2 text-slate-500" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            value: q,
            onChange: (e) => setQ(e.target.value),
            placeholder: `Search all ${TOTAL_FEATURES} features…`,
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-center gap-2", children: [
        /* @__PURE__ */ jsxs("button", { onClick: () => setCat("all"), className: `px-3.5 py-1.5 rounded-full text-[11px] font-bold border transition-all ${cat === "all" ? "bg-white text-[#05030f] border-white" : "bg-white/[0.03] text-slate-400 border-white/10 hover:text-white"}`, children: [
          "All ",
          /* @__PURE__ */ jsx("span", { className: "opacity-60", children: TOTAL_FEATURES })
        ] }),
        FEATURE_CATS.map((c) => /* @__PURE__ */ jsxs("button", { onClick: () => setCat(c.key), className: `px-3.5 py-1.5 rounded-full text-[11px] font-bold border transition-all inline-flex items-center gap-1.5 ${cat === c.key ? CAT_COLOR[c.color] + " brightness-125" : "bg-white/[0.03] text-slate-400 border-white/10 hover:text-white"}`, children: [
          /* @__PURE__ */ jsx(c.icon, { size: 12 }),
          " ",
          c.label,
          " ",
          /* @__PURE__ */ jsx("span", { className: "opacity-60", children: c.items.length })
        ] }, c.key))
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5", children: filtered.map((it, i) => /* @__PURE__ */ jsxs(
      "button",
      {
        onClick: () => setSel(it),
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
            /* @__PURE__ */ jsx("span", { className: `w-7 h-7 rounded-lg flex items-center justify-center border ${CAT_COLOR[it.color]}`, children: /* @__PURE__ */ jsx(it.icon, { size: 13 }) }),
            /* @__PURE__ */ jsx("span", { className: "text-[8px] font-black uppercase tracking-widest text-slate-600", children: it.cat }),
            /* @__PURE__ */ jsx(ChevronRight, { size: 13, className: "ml-auto text-slate-700 group-hover:text-indigo-400 group-hover:translate-x-0.5 transition-all" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "text-[13px] font-bold text-white tracking-tight mb-1", children: it.n }),
          /* @__PURE__ */ jsx("div", { className: "text-[11px] text-slate-500 leading-snug line-clamp-2", children: it.d })
        ]
      },
      it.cat + it.n
    )) }),
    filtered.length === 0 && /* @__PURE__ */ jsxs("div", { className: "text-center py-12 text-slate-500 text-sm", children: [
      "No features match “",
      q,
      "”."
    ] }),
    sel && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[80] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm vqf-in", onClick: () => setSel(null), children: /* @__PURE__ */ jsxs("div", { className: "relative max-w-lg w-full rounded-3xl border border-white/10 bg-[#0b0a1c] p-7 shadow-2xl", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/25 to-transparent rounded-t-3xl" }),
      /* @__PURE__ */ jsx("button", { onClick: () => setSel(null), className: "absolute top-4 right-4 w-8 h-8 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center text-slate-400", children: /* @__PURE__ */ jsx(X, { size: 16 }) }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
        /* @__PURE__ */ jsx("span", { className: `w-12 h-12 rounded-2xl flex items-center justify-center border ${CAT_COLOR[sel.color]}`, children: /* @__PURE__ */ jsx(sel.icon, { size: 22 }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "text-[9px] font-black uppercase tracking-widest text-slate-500", children: sel.cat }),
          /* @__PURE__ */ jsx("h3", { className: "text-xl font-black text-white tracking-tight", style: { fontFamily: "'Space Grotesk',sans-serif" }, children: sel.n })
        ] })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-slate-300 leading-relaxed text-[15px] mb-5", children: sel.d }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 p-3 rounded-xl bg-emerald-500/[0.06] border border-emerald-500/15", children: [
        /* @__PURE__ */ jsx(CheckCircle2, { size: 15, className: "text-emerald-400 shrink-0" }),
        /* @__PURE__ */ jsx("span", { className: "text-[12px] text-slate-400", children: "Included in VenQore — verified by the same double-entry engine that powers every number." })
      ] })
    ] }) })
  ] });
};
const JumpPill = ({ href, icon: Ic, children }) => /* @__PURE__ */ jsxs("a", { href, className: "inline-flex items-center gap-1.5 px-3.5 py-2 rounded-full bg-white/[0.03] border border-white/10 text-[11px] font-bold text-slate-300 hover:text-white hover:border-indigo-400/40 hover:bg-white/[0.06] transition-all", children: [
  /* @__PURE__ */ jsx(Ic, { size: 13, className: "text-indigo-300" }),
  " ",
  children
] });
const DemoSection = ({ id, eyebrow, icon: Ic, title, accent, lead, hero, soon, children }) => /* @__PURE__ */ jsx("section", { id, className: "vqf-anchor py-16 md:py-24 px-6", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto", children: [
  /* @__PURE__ */ jsx(RevealOnScroll, { children: /* @__PURE__ */ jsxs("div", { className: "text-center mb-10 max-w-3xl mx-auto", children: [
    /* @__PURE__ */ jsx(SectionLabel, { icon: Ic, children: eyebrow }),
    hero && /* @__PURE__ */ jsx("div", { className: "inline-block ml-2 mb-8 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-400/20 text-amber-300 text-[10px] font-black tracking-widest uppercase align-middle", children: "★ Hero feature" }),
    soon && /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-1.5 ml-2 mb-8 px-3 py-1 rounded-full bg-amber-500/15 border border-amber-400/30 text-amber-300 text-[10px] font-black tracking-widest uppercase align-middle", children: [
      /* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-amber-400 vqf-blink" }),
      " Coming very soon"
    ] }),
    /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-5xl font-black text-white tracking-tighter leading-[0.95] font-display", children: title }),
    /* @__PURE__ */ jsx("p", { className: "text-slate-400 text-base md:text-lg mt-5", children: lead })
  ] }) }),
  /* @__PURE__ */ jsx(RevealOnScroll, { delay: 0.1, children })
] }) });
function Features() {
  const heroStats = [
  ...
  return /* @__PURE__ */ jsxs(MarketingLayout, { title: "Features - VenQore", description: "Explore every VenQore feature with live, interactive demos of the real product - Reports, POS, Smart Capture AI, VenSynQ, Growth Engine and Cookbook - plus a searchable catalog of all 226+ capabilities.", children: [
    /* @__PURE__ */ jsx("section", { className: "relative pt-36 md:pt-44 pb-12 px-6", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto text-center", children: [
      /* @__PURE__ */ jsx(RevealOnScroll, { children: /* @__PURE__ */ jsx(SectionLabel, { icon: Layers, children: "The whole machine" }) }),
      /* @__PURE__ */ jsx(RevealOnScroll, { delay: 0.08, children: /* @__PURE__ */ jsxs("h1", { className: "text-[2.5rem] xs:text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[0.95] sm:leading-[0.9] mb-8 font-display", children: [
        /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent", children: "Don’t take our word." }),
        /* @__PURE__ */ jsx("br", {}),
        /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-indigo-400 via-violet-400 to-cyan-300 bg-clip-text text-transparent vq-text-glow", children: "See it run." })
      ] }) }),
      /* @__PURE__ */ jsx(RevealOnScroll, { delay: 0.16, children: /* @__PURE__ */ jsxs("p", { className: "text-lg md:text-2xl text-slate-400 max-w-3xl mx-auto leading-relaxed font-medium", children: [
        "Six of VenQore’s flagship tools — playable right here as guided simulations of the real product. Then browse every one of the ",
        /* @__PURE__ */ jsxs("span", { className: "text-white font-semibold", children: [
          TOTAL_FEATURES,
          "+ features"
        ] }),
        ", each explained in a click."
      ] }) }),
      /* @__PURE__ */ jsx(RevealOnScroll, { delay: 0.24, children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto mt-12 border-t border-white/[0.06] pt-8", children: heroStats.map((s, i) => /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-3xl md:text-4xl font-black text-white tracking-tighter font-display", children: [
          /* @__PURE__ */ jsx(Num, { end: s.e }),
          s.s
        ] }),
        /* @__PURE__ */ jsx("div", { className: "text-[10px] text-slate-600 font-black uppercase tracking-[0.22em] mt-1", children: s.l })
      ] }, i)) }) }),
      /* @__PURE__ */ jsx(RevealOnScroll, { delay: 0.3, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-center gap-2 mt-10", children: [
        /* @__PURE__ */ jsx(JumpPill, { href: "#reports", icon: BarChart3, children: "Reports" }),
        /* @__PURE__ */ jsx(JumpPill, { href: "#pos", icon: ShoppingCart, children: "POS" }),
        /* @__PURE__ */ jsx(JumpPill, { href: "#capture", icon: ScanBarcode, children: "Smart Capture" }),
        /* @__PURE__ */ jsx(JumpPill, { href: "#vensynq", icon: Globe, children: "VenSynQ" }),
        /* @__PURE__ */ jsx(JumpPill, { href: "#growth", icon: Cpu, children: "Growth Engine" }),
        /* @__PURE__ */ jsx(JumpPill, { href: "#cookbook", icon: Factory, children: "Cookbook" }),
        /* @__PURE__ */ jsxs(JumpPill, { href: "#all", icon: Layers, children: [
          "All ",
          TOTAL_FEATURES
        ] })
      ] }) })
    ...
    /* @__PURE__ */ jsx(
      DemoSection,
      {
        ...
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          "Ring up a sale ",
          /* @__PURE__ */ jsx("span", { className: "text-indigo-400", children: "right now." })
        ] }),
        ...
        children: /* @__PURE__ */ jsx(PosInvoiceDemo, {})
      }
    ),
    /* @__PURE__ */ jsx(
      DemoSection,
      {
        id: "capture",
        eyebrow: "Smart Capture · AI",
        icon: ScanBarcode,
        accent: "violet",
        soon: true,
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          "Snap it. Say it. ",
          /* @__PURE__ */ jsx("span", { className: "text-violet-400", children: "Booked." })
        ] }),
        ...
        children: /* @__PURE__ */ jsx(SmartCaptureDemo, {})
      }
    ),
    /* @__PURE__ */ jsx(
      DemoSection,
      {
        id: "vensynq",
        eyebrow: "VenSynQ · Multi-Channel",
        icon: Globe,
        accent: "blue",
        soon: true,
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          "Every marketplace, ",
          /* @__PURE__ */ jsx("span", { className: "text-blue-400", children: "one truth." })
        ] }),
        ...
        children: /* @__PURE__ */ jsx(VenSynQDemo, {})
      }
    ),
    /* @__PURE__ */ jsx(
      DemoSection,
      {
        ...
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          "It watches, ",
          /* @__PURE__ */ jsx("span", { className: "text-violet-400", children: "so you can act." })
        ] }),
        ...
        children: /* @__PURE__ */ jsx(GrowthEngineDemo, {})
      }
    ),
    /* @__PURE__ */ jsx(
      DemoSection,
      {
        id: "cookbook",
        eyebrow: "Cookbook · Manufacturing",
        icon: Factory,
        accent: "amber",
        hero: true,
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          "Build products from ",
          /* @__PURE__ */ jsx("span", { className: "text-amber-400", children: "recipes." })
        ] }),
        ...
        children: /* @__PURE__ */ jsx(CookbookDemo, {})
      }
    ),
    /* @__PURE__ */ jsx("section", { id: "all", className: "vqf-anchor py-20 md:py-28 px-6 border-t border-white/5", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsx(RevealOnScroll, { children: /* @__PURE__ */ jsxs("div", { className: "text-center mb-12 max-w-3xl mx-auto", children: [
        /* @__PURE__ */ jsx(SectionLabel, { icon: Layers, children: "The complete catalog" }),
        /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-5xl font-black text-white tracking-tighter leading-[0.95] font-display", children: [
          "All ",
          TOTAL_FEATURES,
          "+ features.",
          /* @__PURE__ */ jsx("br", {}),
          /* @__PURE__ */ jsx("span", { className: "text-indigo-400", children: "Every one explained." })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-slate-400 text-base md:text-lg mt-5", children: "Search, filter by area, and click any feature to read exactly what it does." })
      ] }) }),
      /* @__PURE__ */ jsx(FeatureExplorer, {})
    ] }) }),
    /* @__PURE__ */ jsx("section", { className: "py-28 md:py-36 px-6 text-center", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto relative", children: [
      ...
      /* @__PURE__ */ jsxs(RevealOnScroll, { children: [
        /* @__PURE__ */ jsxs("h2", { className: "text-4xl md:text-7xl font-black text-white mb-8 tracking-tighter leading-[0.95] relative z-10 font-display", children: [
          "Now run it on ",
          /* @__PURE__ */ jsx("span", { className: "text-indigo-400", children: "your numbers." })
        ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10", children: [
          ...
          /* @__PURE__ */ jsx(MagneticButton, { href: "/demo", variant: "ghost", children: "Launch Live Demo" })
        ] })
      ] })
    ] }) }),
