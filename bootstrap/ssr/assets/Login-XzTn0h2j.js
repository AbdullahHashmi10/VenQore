...
const AuthInput = ({ icon: Icon, label, error, ...props }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("label", { className: `block text-[10px] font-black uppercase tracking-[0.25em] mb-2.5 transition-colors duration-300 ${focused ? "text-indigo-400" : "text-slate-400"}`, children: label }),
...
function Login({ status, canResetPassword, settings, passcode_login_available, flash }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen w-full flex bg-[#020010] font-sans selection:bg-indigo-500/40 selection:text-white", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex w-[45%] relative overflow-hidden items-center justify-center p-16", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 text-center max-w-md", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-12 grid grid-cols-3 gap-4", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "text-[9px] text-slate-600 font-bold uppercase tracking-widest mt-1", children: s.label })
        ] }, i)) })
      ] })
    ] }),
        ...
        data.loginMethod === "passcode" ? (
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "text-center mb-4", children: [
              /* @__PURE__ */ jsx("div", { className: "text-[10px] text-slate-600 font-black uppercase tracking-[0.3em] mb-6", children: "Enter Passcode" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "relative flex justify-center text-[10px]", children: /* @__PURE__ */ jsx("span", { className: "px-4 bg-[#020010] text-slate-500 font-bold uppercase tracking-widest", children: "or" }) })
            ] }),
            /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-5", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: `block text-[10px] font-black uppercase tracking-[0.25em] mb-2.5 text-slate-400`, children: "Password" }),
                /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
