...
function PackingSlipTool({ templates = {}, maxItems = 100, suggestedNumber = "", toolGroups = [] }) {
  ...
  return /* @__PURE__ */ jsxs(
    ToolShell,
    {
      ...
      wide: true,
      children: [
        /* @__PURE__ */ jsx(SmartCaptureNudge, { documentType: "packing slip" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3 mb-5 p-3 vq-tool-panel", children: [
          ...
          shipFrom.logo_base64 && /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setShipFrom((sf) => ({ ...sf, logo_base64: null })), className: "text-xs font-bold text-ink-muted hover:text-red-500 transition-colors", children: "Remove logo" }),
          /* @__PURE__ */ jsx("input", { ref: logoInputRef, type: "file", accept: "image/*", className: "hidden", onChange: onLogoChange }),
          /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-2 text-xs font-bold text-ink-muted cursor-pointer", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center rounded-xl vq-tool-inset p-0.5 text-xs font-bold", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
        ...
        /* @__PURE__ */ jsx("div", { className: `vq-paper rounded-2xl overflow-hidden shadow-xl shadow-neutral-900/10 dark:shadow-black/40 border border-line bg-white transition-all ${orientation === "landscape" ? "max-w-none" : ""}`, children: /* @__PURE__ */ jsxs("div", { className: `p-6 sm:p-10 text-ink ${isCompact ? "text-[13px]" : "text-sm"}`, style: { fontFamily: "Helvetica, Arial, sans-serif" }, children: [
          /* @__PURE__ */ jsxs("div", { className: `flex flex-col sm:flex-row justify-between gap-6 mb-6 ${isClassic ? "border-b-2 border-neutral-900 pb-4" : ""}`, children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-0.5 text-xs text-ink-muted mt-1", children: [
                /* @__PURE__ */ jsx(EditableText, { value: shipFrom.email, onChange: (v) => setShipFrom((sf) => ({ ...sf, email: v })), placeholder: "email@business.com", inline: false }),
                /* @__PURE__ */ jsx(EditableText, { value: shipFrom.phone, onChange: (v) => setShipFrom((sf) => ({ ...sf, phone: v })), placeholder: "Phone number", inline: false })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-left sm:text-right", children: [
              /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold tracking-tight text-ink", children: "PACKING SLIP" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-3 gap-6 mb-6", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Ship To (Recipient)" }),
              /* @__PURE__ */ jsx(EditableText, { value: shipTo.name, onChange: (v) => setShipTo((st) => ({ ...st, name: v })), placeholder: "Recipient name", className: "block font-bold", inline: false }),
              /* @__PURE__ */ jsx(EditableText, { value: shipTo.address, onChange: (v) => setShipTo((st) => ({ ...st, address: v })), placeholder: "Delivery address", as: "textarea", rows: 2, className: "block text-ink-muted text-xs mt-0.5", inline: false }),
              /* @__PURE__ */ jsx(EditableText, { value: shipTo.phone, onChange: (v) => setShipTo((st) => ({ ...st, phone: v })), placeholder: "Phone (optional)", className: "block text-ink-muted text-xs mt-0.5", inline: false }),
              /* @__PURE__ */ jsx(EditableText, { value: shipTo.email, onChange: (v) => setShipTo((st) => ({ ...st, email: v })), placeholder: "Email (optional)", className: "block text-ink-muted text-xs mt-0.5", inline: false })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Bill To" }),
              sameAsShipTo ? /* @__PURE__ */ jsx("p", { className: "text-ink-muted italic text-xs", children: "Same as Ship To" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsx(EditableText, { value: billTo.name, onChange: (v) => setBillTo((bt) => ({ ...bt, name: v })), placeholder: "Billing contact / company", className: "block font-bold", inline: false }),
                /* @__PURE__ */ jsx(EditableText, { value: billTo.address, onChange: (v) => setBillTo((bt) => ({ ...bt, address: v })), placeholder: "Billing address", as: "textarea", rows: 2, className: "block text-ink-muted text-xs mt-0.5", inline: false }),
                /* @__PURE__ */ jsx(EditableText, { value: billTo.phone, onChange: (v) => setBillTo((bt) => ({ ...bt, phone: v })), placeholder: "Phone (optional)", className: "block text-ink-muted text-xs mt-0.5", inline: false }),
                /* @__PURE__ */ jsx(EditableText, { value: billTo.email, onChange: (v) => setBillTo((bt) => ({ ...bt, email: v })), placeholder: "Email (optional)", className: "block text-ink-muted text-xs mt-0.5", inline: false })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold uppercase tracking-widest text-ink-muted mb-1", children: "Ship From" }),
              /* @__PURE__ */ jsx("p", { className: "font-bold", children: shipFrom.name || /* @__PURE__ */ jsx("span", { className: "italic text-ink-muted", children: "Your business name" }) }),
              shipFrom.address && /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-xs", children: shipFrom.address })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("table", { className: "w-full mb-2", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: `text-left text-2xs font-bold uppercase tracking-wide text-ink-muted ${isClassic ? "border-b-2 border-neutral-900" : "border-b border-neutral-900"}`, children: [
              /* @__PURE__ */ jsx("th", { className: "pb-2 pr-2 w-24", children: /* @__PURE__ */ jsx(EditableText, { value: headers.sku, onChange: (v) => setHeaders((h) => ({ ...h, sku: v })), className: "text-2xs font-bold uppercase tracking-wide text-ink-muted", pulse: false }) }),
              /* @__PURE__ */ jsx("th", { className: "pb-2 px-2", children: /* @__PURE__ */ jsx(EditableText, { value: headers.description, onChange: (v) => setHeaders((h) => ({ ...h, description: v })), className: "text-2xs font-bold uppercase tracking-wide text-ink-muted", pulse: false }) }),
              /* @__PURE__ */ jsx("th", { className: "pb-2 px-2 w-20", children: /* @__PURE__ */ jsx(EditableText, { value: headers.package_number, onChange: (v) => setHeaders((h) => ({ ...h, package_number: v })), className: "text-2xs font-bold uppercase tracking-wide text-ink-muted", pulse: false }) }),
              /* @__PURE__ */ jsx("th", { className: "pb-2 px-2 text-right w-20", children: /* @__PURE__ */ jsx(EditableText, { value: headers.quantity_ordered, onChange: (v) => setHeaders((h) => ({ ...h, quantity_ordered: v })), className: "text-2xs font-bold uppercase tracking-wide text-ink-muted text-right", pulse: false }) }),
              /* @__PURE__ */ jsx("th", { className: "pb-2 pl-2 text-right w-20", children: /* @__PURE__ */ jsx(EditableText, { value: headers.quantity_shipped, onChange: (v) => setHeaders((h) => ({ ...h, quantity_shipped: v })), className: "text-2xs font-bold uppercase tracking-wide text-ink-muted text-right", pulse: false }) }),
            ...
            /* @__PURE__ */ jsx("tbody", { children: items.map((item, idx) => {
              ...
              return /* @__PURE__ */ jsxs("tr", { className: "border-b border-line group align-top", children: [
                ...
                /* @__PURE__ */ jsxs("td", { className: "py-2 px-2", children: [
                  ...
                  /* @__PURE__ */ jsx(EditableText, { value: item.notes, onChange: (v) => updateItem(idx, "notes", v), placeholder: "Note (optional)", className: "block text-ink-muted text-xs" })
                ] }),
          ...
          /* @__PURE__ */ jsxs("button", { type: "button", onClick: addItem, disabled: items.length >= maxItems, className: "flex items-center gap-1 text-xs font-bold text-ink-muted hover:text-brand-500 disabled:opacity-40 transition-colors mb-8", children: [
            /* @__PURE__ */ jsx(Plus, { size: 12 }),
            " Add line item"
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-6 text-xs text-ink-muted", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("p", { className: "font-bold text-ink-secondary mb-1 flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsx(Package, { size: 12, className: "text-brand-500" }),
                " Gift Message"
              ] }),
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "font-bold text-ink-secondary mb-1", children: "Special Handling / Delivery Instructions" }),
