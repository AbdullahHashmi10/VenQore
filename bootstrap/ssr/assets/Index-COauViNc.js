  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-6 max-w-3xl", children: [
    ...
    /* @__PURE__ */ jsxs("table", { className: "w-full border-collapse border border-line", children: [
      /* @__PURE__ */ jsx("thead", { className: "bg-sunken", children: /* @__PURE__ */ jsxs("tr", { children: [
        ...
        /* @__PURE__ */ jsx("th", { className: "border border-line px-4 py-2 text-left", children: "Address" }),
        /* @__PURE__ */ jsx("th", { className: "border border-line px-4 py-2 text-center", children: "Default" }),
        /* @__PURE__ */ jsx("th", { className: "border border-line px-4 py-2 text-center", children: "Status" }),
        /* @__PURE__ */ jsx("th", { className: "border border-line px-4 py-2 text-center", children: "Actions" })
      ] }) }),
      /* @__PURE__ */ jsx("tbody", { children: warehouses.map((w) => /* @__PURE__ */ jsxs("tr", { className: `hover:bg-interactive-hover ${!w.is_active ? "opacity-50" : ""}`, children: [
        /* @__PURE__ */ jsx("td", { className: "border border-line px-4 py-2 font-medium", children: w.name }),
        /* @__PURE__ */ jsx("td", { className: "border border-line px-4 py-2 text-sm text-ink-muted", children: w.address ?? "—" }),
        /* @__PURE__ */ jsx("td", { className: "border border-line px-4 py-2 text-center", children: w.is_default ? /* @__PURE__ */ jsx("span", { className: "bg-green-100 text-green-700 text-xs px-2 py-1 rounded", children: "DEFAULT" }) : "—" }),
        /* @__PURE__ */ jsx("td", { className: "border border-line px-4 py-2 text-center", children: /* @__PURE__ */ jsx("span", { className: `text-xs px-2 py-1 rounded ${w.is_active ? "bg-green-100 text-green-700" : "bg-sunken text-ink-muted"}`, children: w.is_active ? "Active" : "Inactive" }) }),
