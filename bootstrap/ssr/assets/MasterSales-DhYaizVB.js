  ...
  return /* @__PURE__ */ jsxs("div", { className: "absolute top-14 left-0 w-full bg-slate-900 border-b border-indigo-500/30 p-4 shadow-2xl z-20 grid grid-cols-4 gap-4 animate-in slide-in-from-top-2", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "border-r border-slate-700 px-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-r from-amber-500/10 to-transparent p-2 rounded", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "text-[10px] text-amber-400/60", children: [
          "Redeemable Value: ",
    ...
    /* @__PURE__ */ jsxs("div", { className: "px-4 relative", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "text-[10px] text-slate-500 mb-2", children: "Invoice #INV-2024-001" }),
...
const AtomicRow = ({ item, index, onUpdate, onRemove, onMove, onDuplicate }) => {
  ...
  return /* @__PURE__ */ jsxs("tr", { className: "group border-b border-slate-700/50 hover:bg-slate-800/40 transition-colors relative", children: [
    ...
    /* @__PURE__ */ jsx("td", { className: "p-3", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2 text-[10px] text-slate-500 font-mono mt-1", children: [
    ...
    /* @__PURE__ */ jsx("td", { className: "w-24 p-2", children: item.product?.has_batch ? /* @__PURE__ */ jsxs("select", { className: "bg-slate-900 border border-slate-600 text-[10px] rounded p-1 w-full text-amber-400 cursor-pointer", children: [
    ...
    /* @__PURE__ */ jsx("td", { className: "w-32 p-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-1", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col text-[9px] text-slate-500 leading-tight", children: [
    ...
    /* @__PURE__ */ jsx("td", { className: "w-32 p-2", children: /* @__PURE__ */ jsxs("div", { className: "relative group/price", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "absolute top-full right-0 bg-slate-900 border border-slate-700 p-2 rounded shadow-xl z-50 hidden group-focus-within/price:block min-w-[150px]", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-[10px] text-slate-400 flex justify-between", children: [
...
function MasterSales() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "h-screen w-full bg-[#0B1121] text-slate-300 flex flex-col font-sans overflow-hidden", children: [
        ...
        activeInvoices.map((inv, idx) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            className: `
                                ...
                                ${inv.id === currentInvoiceId ? "bg-[#1e293b] border-indigo-500 text-white shadow-lg" : "bg-slate-900 border-transparent text-slate-500 hover:bg-slate-800"}
                            `,
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col truncate", children: [
                ...
                /* @__PURE__ */ jsxs("span", { className: "text-[9px] font-mono opacity-60 flex justify-between w-full", children: [
                  /* @__PURE__ */ jsxs("span", { children: [
                    inv.items?.length || 0,
                    " Items"
                  ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 flex overflow-hidden relative", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col bg-[#0f172a] relative", children: [
        /* @__PURE__ */ jsxs("div", { className: "h-16 border-b border-slate-800 bg-slate-900 flex items-center px-4 justify-between z-10 relative", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center w-1/3 relative", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsx("label", { className: "text-[10px] uppercase font-bold text-slate-500 tracking-wider", children: "Customer / Client" }),
              /* @__PURE__ */ jsx(
                AsyncPartyCombobox,
                {
                  partyType: "all",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-6 text-right", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "text-[10px] uppercase font-bold text-slate-500", children: "Date" }),
              /* @__PURE__ */ jsx("div", { className: "text-sm font-mono text-slate-300", children: (/* @__PURE__ */ new Date()).toLocaleDateString() })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "text-[10px] uppercase font-bold text-slate-500", children: "Salesman" }),
              /* @__PURE__ */ jsx("div", { className: "text-sm font-medium text-slate-300", children: "Admin User" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto bg-[#0f172a]", ref: tableRef, children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
          /* @__PURE__ */ jsx("thead", { className: "bg-[#1e293b] sticky top-0 z-10 border-b border-slate-700 shadow-md", children: /* @__PURE__ */ jsxs("tr", { className: "text-[10px] uppercase text-slate-400 font-bold tracking-wider", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-slate-900 border-t border-slate-800 p-4 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] z-20", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
            /* @__PURE__ */ jsxs("div", { className: "w-1/2 pr-10", children: [
              /* @__PURE__ */ jsxs("div", { className: "text-[10px] uppercase font-bold text-slate-500 mb-2 flex items-center", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "w-[350px] bg-[#020617] border-l border-slate-800 flex flex-col z-30 shadow-2xl", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "p-4 border-b border-slate-800 bg-gradient-to-b from-slate-900 to-[#020617]", children: scanMode ? /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "text-[10px] text-center text-emerald-600 mt-2 animate-pulse", children: "Running Barcode Listener..." })
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between mt-2 text-[10px] text-slate-500", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto p-2", children: [
          searchQuery && /* @__PURE__ */ jsx("div", { className: "space-y-1", children: [1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between mt-1 text-[10px] text-slate-500", children: [
          ...
          !searchQuery && !scanMode && /* @__PURE__ */ jsxs("div", { className: "mt-8 px-4 grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxs("button", { className: "aspect-square bg-slate-900 border border-slate-800 rounded flex flex-col items-center justify-center hover:bg-slate-800 hover:border-slate-700 text-slate-500 hover:text-indigo-400 transition-all", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-[10px] uppercase font-bold", children: "Calculator" })
            ] }),
            /* @__PURE__ */ jsxs("button", { className: "aspect-square bg-slate-900 border border-slate-800 rounded flex flex-col items-center justify-center hover:bg-slate-800 hover:border-slate-700 text-slate-500 hover:text-emerald-400 transition-all", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-[10px] uppercase font-bold", children: "Shipping" })
            ] }),
            /* @__PURE__ */ jsxs("button", { className: "aspect-square bg-slate-900 border border-slate-800 rounded flex flex-col items-center justify-center hover:bg-slate-800 hover:border-slate-700 text-slate-500 hover:text-amber-400 transition-all", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-[10px] uppercase font-bold", children: "Recent" })
            ] }),
            /* @__PURE__ */ jsxs("button", { className: "aspect-square bg-slate-900 border border-slate-800 rounded flex flex-col items-center justify-center hover:bg-slate-800 hover:border-slate-700 text-slate-500 hover:text-red-400 transition-all", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-[10px] uppercase font-bold", children: "Hold Bill" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "h-48 border-t border-slate-800 bg-[#020617] flex flex-col", children: [
          /* @__PURE__ */ jsxs("div", { className: "p-2 border-b border-slate-800 text-[10px] uppercase font-bold text-slate-500 flex justify-between items-center", children: [
            /* @__PURE__ */ jsx("span", { children: "System Activity Log" }),
            /* @__PURE__ */ jsx(RefreshCcw, { className: "w-3 h-3" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto p-2 space-y-2 font-mono text-[10px]", children: auditLog.map((log) => /* @__PURE__ */ jsxs("div", { className: "flex space-x-2 text-slate-500", children: [
