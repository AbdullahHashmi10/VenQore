...
function OverrideDrawer({ open, tenant, availableKeys, onClose }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { position: "fixed", inset: 0, zIndex: 50, display: "flex" }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { style: { width: 500, background: vq.slate[900], overflowY: "auto", boxShadow: "-4px 0 32px rgba(0,0,0,0.5)" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { padding: "24px 28px 16px", borderBottom: "1px solid rgb(var(--vq-slate-800))", display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { style: { margin: 0, fontSize: 18, fontWeight: 700, color: vq.slate[100] }, children: "Apply Override" }),
          /* @__PURE__ */ jsxs("p", { style: { margin: "4px 0 0", fontSize: 13, color: vq.slate[500] }, children: [
            tenant.name,
            " · Plan: ",
            /* @__PURE__ */ jsx("b", { style: { color: vq.slate[400] }, children: tenant.plan })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, style: { padding: "24px 28px", display: "flex", flexDirection: "column", gap: 16 }, children: [
        /* @__PURE__ */ jsxs("div", { style: { background: vq.slate[800], borderRadius: 10, padding: "12px 14px", fontSize: 13, color: vq.slate[400] }, children: [
          /* @__PURE__ */ jsx("b", { style: { color: vq.amber[500] }, children: "⚡ Live Override" }),
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
          /* @__PURE__ */ jsxs("label", { style: { display: "flex", alignItems: "center", gap: 10, cursor: "pointer" }, children: [
            ...
            /* @__PURE__ */ jsx("span", { style: { fontSize: 14, color: vq.slate[400] }, children: "Send in-app notification to tenant" })
          ] }),
  ...
  return /* @__PURE__ */ jsxs(PlatformShell, { title: "Tenant Overrides", mode: "admin", activeMenu: "Tenant Overrides", children: [
    /* @__PURE__ */ jsxs("div", { style: { padding: "32px 40px", minHeight: "100vh", background: vq.slate[950] }, children: [
      /* @__PURE__ */ jsx("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 32 }, children: /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h1", { style: { margin: 0, fontSize: 28, fontWeight: 800, color: vq.slate[100] }, children: "Tenant Overrides" }),
        /* @__PURE__ */ jsx("p", { style: { margin: "4px 0 0", color: vq.slate[500], fontSize: 14 }, children: "Apply per-tenant limit overrides. These take priority over any plan default." })
      ] }) }),
      ...
      /* @__PURE__ */ jsx("div", { style: { background: vq.slate[900], borderRadius: 16, border: "1px solid rgb(var(--vq-slate-800))", overflow: "hidden" }, children: /* @__PURE__ */ jsxs("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: 14 }, children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { style: { background: vq.slate[800] }, children: ["Store", "Plan", "Status", "Active Overrides", "Actions"].map((h) => /* @__PURE__ */ jsx("th", { style: { padding: "12px 16px", textAlign: "left", color: vq.slate[500], fontWeight: 600, fontSize: 12, textTransform: "uppercase", letterSpacing: "0.5px" }, children: h }, h)) }) }),
        /* @__PURE__ */ jsx("tbody", { children: tenants.data?.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 5, style: { padding: "48px 0", textAlign: "center", color: vq.slate[600] }, children: "No tenants found." }) }) : tenants.data?.map((tenant, i) => /* @__PURE__ */ jsxs(
          "tr",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("td", { style: { padding: "14px 16px" }, children: [
                /* @__PURE__ */ jsx("div", { style: { fontWeight: 700, color: vq.slate[100] }, children: tenant.name }),
                /* @__PURE__ */ jsxs("div", { style: { fontSize: 11, color: vq.slate[600] }, children: [
                  "ID #",
                  tenant.id
                ] })
              ] }),
              /* @__PURE__ */ jsx("td", { style: { padding: "14px 16px" }, children: /* @__PURE__ */ jsx("span", { style: { background: vq.indigo[500], color: vq.indigo[500], padding: "3px 10px", borderRadius: 99, fontSize: 12, fontWeight: 600 }, children: tenant.plan }) }),
              ...
              ] }, o.id)) }) : /* @__PURE__ */ jsx("span", { style: { color: vq.slate[600], fontSize: 12 }, children: "No overrides" }) }),
