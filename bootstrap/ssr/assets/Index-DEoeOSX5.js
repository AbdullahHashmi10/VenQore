    ...
    "tr",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("td", { style: { padding: "14px 16px" }, children: [
          /* @__PURE__ */ jsx("div", { style: { fontFamily: "monospace", fontWeight: 800, fontSize: 15, color: vq.slate[100], letterSpacing: 1 }, children: coupon.code }),
          /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: vq.slate[500], marginTop: 2 }, children: coupon.name })
        ] }),
        /* @__PURE__ */ jsxs("td", { style: { padding: "14px 16px", color: vq.slate[400], fontSize: 13 }, children: [
        ...
        /* @__PURE__ */ jsxs("td", { style: { padding: "14px 16px", color: vq.slate[400], fontSize: 12 }, children: [
...
function CouponForm({ onClose, plans }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { position: "fixed", inset: 0, zIndex: 50, display: "flex" }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { style: { width: 520, background: vq.slate[900], overflowY: "auto", boxShadow: "-4px 0 32px rgba(0,0,0,0.5)" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { padding: "24px 28px 16px", borderBottom: "1px solid rgb(var(--vq-slate-800))", display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
        /* @__PURE__ */ jsx("h2", { style: { margin: 0, fontSize: 18, fontWeight: 700, color: vq.slate[100] }, children: "New Coupon" }),
        /* @__PURE__ */ jsx("button", { onClick: onClose, style: { background: "none", border: "none", color: vq.slate[400], fontSize: 22, cursor: "pointer" }, children: "✕" })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, style: { padding: "24px 28px", display: "flex", flexDirection: "column", gap: 16 }, children: [
        ...
        data.applies_to === "specific_plans" && /* @__PURE__ */ jsx(Field, { label: "Restrict to Plans", error: errors.plan_ids, children: /* @__PURE__ */ jsx("div", { style: { display: "flex", flexDirection: "column", gap: 6, background: vq.slate[800], borderRadius: 8, padding: 12 }, children: plans.map((p) => /* @__PURE__ */ jsxs("label", { style: { display: "flex", alignItems: "center", gap: 8, color: vq.slate[400], fontSize: 13, cursor: "pointer" }, children: [
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "checkbox",
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "flex-end", gap: 12, paddingTop: 16, borderTop: "1px solid rgb(var(--vq-slate-800))" }, children: [
...
function CouponsIndex({ coupons, plans }) {
  ...
  return /* @__PURE__ */ jsxs(PlatformShell, { title: "Coupon Management", mode: "admin", activeMenu: "Coupons", children: [
    /* @__PURE__ */ jsxs("div", { style: { padding: "32px 40px", minHeight: "100vh", background: vq.slate[950] }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 32 }, children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { style: { margin: 0, fontSize: 28, fontWeight: 800, color: vq.slate[100] }, children: "Coupon Management" }),
          /* @__PURE__ */ jsx("p", { style: { margin: "4px 0 0", color: vq.slate[500], fontSize: 14 }, children: "Create and manage discount codes for subscriptions and lifetime deals." })
        ] }),
      ...
      /* @__PURE__ */ jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginBottom: 28 }, children: [
        ...
        { label: "Expiring Soon", value: coupons.filter((c) => c.valid_until && new Date(c.valid_until) < new Date(Date.now() + 14 * 864e5)).length, color: vq.amber[500] }
      ].map((stat) => /* @__PURE__ */ jsxs("div", { style: { background: vq.slate[900], borderRadius: 12, border: "1px solid rgb(var(--vq-slate-800))", padding: "16px 20px" }, children: [
        /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: vq.slate[500], marginBottom: 4 }, children: stat.label }),
        /* @__PURE__ */ jsx("div", { style: { fontSize: 24, fontWeight: 800, color: stat.color || vq.slate[100] }, children: stat.value })
      ] }, stat.label)) }),
      /* @__PURE__ */ jsx("div", { style: { background: vq.slate[900], borderRadius: 16, border: "1px solid rgb(var(--vq-slate-800))", overflow: "hidden" }, children: /* @__PURE__ */ jsxs("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: 14 }, children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { style: { background: vq.slate[800] }, children: ["Code", "Discount", "Applies To", "Uses", "Validity", "Valid?", "Status"].map((h) => /* @__PURE__ */ jsx("th", { style: { padding: "12px 16px", textAlign: "left", color: vq.slate[500], fontWeight: 600, fontSize: 12, textTransform: "uppercase", letterSpacing: "0.5px" }, children: h }, h)) }) }),
        /* @__PURE__ */ jsx("tbody", { children: coupons.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 7, style: { padding: "48px 0", textAlign: "center", color: vq.slate[600] }, children: "No coupons yet. Create your first one!" }) }) : coupons.map((c, i) => /* @__PURE__ */ jsx(CouponRow, { coupon: c, i }, c.id)) })
      ] }) })
    ] }),
...
const Field = ({ label, error, children }) => /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: [
  /* @__PURE__ */ jsx("label", { style: { fontSize: 12, color: vq.slate[500], fontWeight: 600 }, children: label }),
  children,
  error && /* @__PURE__ */ jsx("span", { style: { fontSize: 11, color: vq.red[500] }, children: error })
] });
const inp = {
  width: "100%",
  boxSizing: "border-box",
  background: vq.slate[800],
  border: "1px solid rgb(var(--vq-slate-700))",
  color: vq.slate[100],
  padding: "8px 12px",
  borderRadius: 8,
  fontSize: 14,
