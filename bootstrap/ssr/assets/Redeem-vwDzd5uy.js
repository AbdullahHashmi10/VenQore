...
function Redeem({ app_name = "VenQore" }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-void-950 text-white font-sans", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 pointer-events-none", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-1/4 left-1/4 w-96 h-96 bg-brand-900/20 rounded-full blur-[100px]" }),
      /* @__PURE__ */ jsx("div", { className: "absolute bottom-1/4 right-1/4 w-96 h-96 bg-brand-900/15 rounded-full blur-[100px]" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 min-h-screen flex flex-col lg:flex-row", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:w-[45%] p-10 lg:p-16 flex flex-col justify-center border-r border-white/5", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-12", children: [
          ...
          /* @__PURE__ */ jsxs("span", { className: "font-bold text-xl text-white", children: [
            "VenQore",
        ...
        /* @__PURE__ */ jsxs("h1", { className: "text-4xl lg:text-5xl font-bold tracking-tight mb-4 leading-tight", children: [
          "Activate Your",
          /* @__PURE__ */ jsx("span", { className: "block bg-gradient-brand bg-clip-text text-transparent", children: "Lifetime License" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-ink-muted leading-relaxed mb-10", children: "Stack up to 3 codes to unlock higher tiers. One code is all you need to get started — add more later from your account." }),
        /* @__PURE__ */ jsx("div", { className: "space-y-3", children: planTiers.map((tier) => /* @__PURE__ */ jsxs("div", { className: `rounded-2xl p-5 border border-white/10 ${tier.bg}`, children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
            /* @__PURE__ */ jsx("div", { className: "w-7 h-7 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-xs font-bold text-white", children: tier.codes }),
          ...
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-1.5", children: tier.features.map((f, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs text-ink-muted", children: [
            /* @__PURE__ */ jsx(Check, { size: 10, className: "text-emerald-400 shrink-0" }),
            " ",
            f
          ] }, i)) })
        ] }, tier.codes)) }),
        /* @__PURE__ */ jsxs("p", { className: "text-ink-secondary text-xs mt-6 flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "lg:w-[55%] p-10 lg:p-16 flex flex-col justify-center", children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-ink-muted text-sm mb-8", children: [
          "Already have an account?",
          "",
          /* @__PURE__ */ jsx(Link, { href: route("login"), className: "text-brand-400 hover:text-brand-300 underline", children: "Sign in to stack codes" })
        ] }),
        /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("label", { className: "text-sm font-semibold text-neutral-300 mb-2 flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(Zap, { size: 14, className: "text-brand-400" }),
              "AppSumo Code"
            ] }),
            /* @__PURE__ */ jsx(
              "input",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "text-sm font-semibold text-ink-muted mb-2 block", children: "Full Name" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                id: "redeem-name",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "text-sm font-semibold text-ink-muted mb-2 block", children: "Email Address" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                id: "redeem-email",
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "text-sm font-semibold text-ink-muted mb-2 block", children: "Password" }),
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                ...
                /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setShowPassword(!showPassword), className: "absolute right-3 top-1/2 -translate-y-1/2 text-ink-muted hover:text-neutral-300", children: showPassword ? /* @__PURE__ */ jsx(EyeOff, { size: 15 }) : /* @__PURE__ */ jsx(Eye, { size: 15 }) })
              ] }),
              errors.password && /* @__PURE__ */ jsx("p", { className: "text-red-400 text-xs mt-1", children: errors.password })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "text-sm font-semibold text-ink-muted mb-2 block", children: "Confirm" }),
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsx(
                  "input",
                  {
                ...
                /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setShowConfirm(!showConfirm), className: "absolute right-3 top-1/2 -translate-y-1/2 text-ink-muted hover:text-neutral-300", children: showConfirm ? /* @__PURE__ */ jsx(EyeOff, { size: 15 }) : /* @__PURE__ */ jsx(Eye, { size: 15 }) })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              type: "submit",
              disabled: processing,
              className: "w-full flex items-center justify-center gap-3 py-4 rounded-xl bg-gradient-brand text-white font-bold text-base transition-all hover:shadow-lg disabled:opacity-50 disabled:scale-100 mt-2",
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-ink-secondary text-xs mt-6 text-center leading-relaxed", children: [
          "By activating, you agree to VenQore's",
          "",
          /* @__PURE__ */ jsx(Link, { href: "/refund-policy", className: "text-ink-muted hover:text-neutral-300 underline", children: "Refund Policy" }),
