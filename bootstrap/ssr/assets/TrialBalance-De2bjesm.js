  ...
  const columns = [
    {
      ...
      label: "Code",
      sortable: true,
      render: (row) => /* @__PURE__ */ jsx("span", { className: "font-mono text-sm text-ink-muted", children: row.code })
    },
    {
      key: "name",
      label: "Account Name",
      sortable: true,
      render: (row) => /* @__PURE__ */ jsx("span", { className: "font-medium text-ink", children: row.name })
    },
    {
      key: "type",
      label: "Type",
      sortable: true,
      render: (row) => /* @__PURE__ */ jsx("span", { className: "capitalize text-xs px-2 py-0.5 rounded-full bg-sunken text-ink-secondary", children: row.type })
    },
    {
      key: "debit",
      label: "Debit",
      align: "right",
      sortable: true,
      render: (row) => /* @__PURE__ */ jsx("span", { className: "font-bold tabular-nums text-ink", children: row.debit > 0 ? formatCurrency(row.debit) : "—" })
    },
    {
      key: "credit",
      label: "Credit",
      align: "right",
      sortable: true,
      render: (row) => /* @__PURE__ */ jsx("span", { className: "font-bold tabular-nums text-ink", children: row.credit > 0 ? formatCurrency(row.credit) : "—" })
    },
    {
      key: "net",
      label: "Net (Dr − Cr)",
  ...
  const filters = [
    {
      ...
      render: () => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(Calendar, { size: 15, className: "text-ink-muted" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "date",
