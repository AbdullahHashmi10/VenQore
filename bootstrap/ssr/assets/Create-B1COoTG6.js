        ...
        /* @__PURE__ */ jsxs("div", { className: `flex-1 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-800 flex flex-col overflow-hidden min-h-[400px] lg:min-h-0 ${isReadOnly ? "pointer-events-none opacity-85 select-none" : ""}`, children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "relative group/accounts-mobile shrink-0 h-[36px]", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "absolute right-0 top-full pt-1 z-50 hidden group-hover/accounts-mobile:block", children: /* @__PURE__ */ jsxs("div", { className: "bg-slate-800 rounded-lg shadow-xl border border-slate-700 overflow-hidden w-36 p-1", children: [
                    /* @__PURE__ */ jsx("div", { className: "p-1 border-b border-slate-700 bg-slate-900/50", children: /* @__PURE__ */ jsx("p", { className: "text-4xs font-bold text-slate-500 uppercase", children: "Pay From" }) }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex px-3 py-2 border-b border-slate-100 dark:border-slate-800 items-center justify-between gap-3 bg-slate-50/50 dark:bg-slate-800/30 shrink-0", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative flex-1 max-w-xl", children: [
              ...
              supplierError && /* @__PURE__ */ jsx("p", { className: "absolute -bottom-5 left-2 text-2xs font-bold text-red-500 animate-pulse", children: "Please select a supplier" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
                  onClick: () => patchPurchase({ isReceived: !currentPurchase.isReceived }),
                  className: `px-3 py-1.5 rounded-lg text-2xs font-black flex items-center gap-1.5 transition-all ${currentPurchase.isReceived ? "bg-emerald-500 text-white shadow shadow-emerald-500/20" : "bg-slate-100 dark:bg-slate-800 text-slate-400 hover:bg-slate-200"}`,
        ...
        /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex w-full lg:w-80 bg-void-700 flex-col overflow-hidden rounded-2xl shadow-2xl border border-slate-800 shrink-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 p-3 space-y-3 overflow-y-auto hide-scrollbar", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "text-3xs text-slate-500 font-bold uppercase block mb-1", children: "Po #" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
