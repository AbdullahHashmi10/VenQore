...
function StatusBadge({ status }) {
  ...
  return /* @__PURE__ */ jsxs("span", { className: `inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-2xs font-black uppercase tracking-wider border ${cfg.color}`, children: [
...
function EscalationBadge({ type }) {
  ...
  if (!cfg) return null;
  const Icon = cfg.icon;
  return /* @__PURE__ */ jsxs("span", { className: `inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-3xs font-black uppercase tracking-wider border ${cfg.color}`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "h-full flex flex-col gap-4 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "shrink-0 flex items-center gap-3 flex-wrap", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 px-3 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-2xs font-black uppercase tracking-wider text-slate-500", children: "Status:" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              value: statusFilter,
        ...
        isPlatform && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 px-3 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm", children: [
          /* @__PURE__ */ jsx(Filter, { size: 12, className: "text-slate-400" }),
          /* @__PURE__ */ jsx("span", { className: "text-2xs font-black uppercase tracking-wider text-slate-500", children: "Reason:" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              ...
              /* @__PURE__ */ jsx("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mt-1 flex-wrap", children: [
                    /* @__PURE__ */ jsxs("span", { className: "text-1xs text-slate-500 dark:text-slate-400", children: [
                      /* @__PURE__ */ jsx("span", { className: "font-bold", children: ticket.requester_name }),
                      ticket.requester_email && ` · ${ticket.requester_email}`
                    ] }),
                    isPlatform && ticket.tenant && /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded-full border border-slate-200 dark:border-slate-700", children: ticket.tenant.name })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "shrink-0 flex flex-col items-end gap-2", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 text-2xs text-slate-400", children: [
    ...
    openModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[1500] flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-fade-in", style: { animation: "fadeIn 0.2s ease-out" }, children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl overflow-hidden shadow-2xl animate-scale-up", style: { animation: "scaleUp 0.25s cubic-bezier(0.34, 1.56, 0.64, 1)" }, children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "p-6 space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black uppercase tracking-wider text-slate-400 mb-1.5", children: "Customer Name" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black uppercase tracking-wider text-slate-400 mb-1.5", children: "Customer Email" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "email",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black uppercase tracking-wider text-slate-400 mb-1.5", children: "Subject / Summary" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black uppercase tracking-wider text-slate-400 mb-1.5", children: "Priority" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              value: formPriority,
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black uppercase tracking-wider text-slate-400 mb-1.5", children: "Issue details / notes" }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
              required: true,
