...
function Error({ status = 500, message }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen w-full flex items-center justify-center bg-app p-6", children: /* @__PURE__ */ jsxs("div", { className: "max-w-lg w-full", children: [
    /* @__PURE__ */ jsxs("div", { className: `bg-surface rounded-2xl shadow-2xl border ${colors.border} overflow-hidden`, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "p-10 text-center", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-ink mb-3 tracking-tight", children: config.title }),
        /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-base mb-8 max-w-sm mx-auto leading-relaxed", children: status === 500 ? "Our systems encountered an unexpected issue. We have been notified and are working on a fix." : message || "An unexpected error occurred. Your data is safe." }),
        /* @__PURE__ */ jsx("div", { className: "flex flex-col sm:flex-row gap-3 justify-center", children: status === 419 ? (
          ...
          /* @__PURE__ */ jsxs(
            ...
            {
              onClick: handleBack,
              className: "flex items-center justify-center gap-2 px-6 py-3 bg-surface text-ink-secondary dark:text-ink border border-line rounded-xl font-bold hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-all active:scale-95",
              children: [
        ...
        status === 500 && /* @__PURE__ */ jsx("p", { className: "mt-6 text-xs text-ink-muted font-mono", children: "This error has been automatically reported to our team." })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("p", { className: "text-center mt-4 text-1xs text-ink-muted font-mono", children: [
      "REF · ",
