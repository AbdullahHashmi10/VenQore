...
function BlankCell({ className = "" }) {
  return /* @__PURE__ */ jsx("div", { className: `border-b border-dotted border-line h-5 ${className}`, "aria-hidden": "true" });
}
      ...
      const res = await fetch("/tools/cash-drawer-count-sheet/render", {
        ...
        body: JSON.stringify({
          ...
          meta: {
            ...
            notes,
            orientation
            // preview/UI only — backend does not yet honor this
          }
        })
      });
      if (!res.ok) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3 mb-5 p-3 vq-tool-panel", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 px-1", children: [
            /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-ink-muted", children: "Registers" }),
            /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxs("span", { className: "text-xs text-ink-muted w-14 text-center", children: [
              registers.length,
              " of ",
              maxRegisters
            ] }),
        ...
        orientation === "landscape" && /* @__PURE__ */ jsx("p", { className: "text-center text-1xs text-amber-600 dark:text-amber-400 mb-3 -mt-2", children: "Landscape printing is not yet supported for downloads — this previews the layout only. The downloaded PDF will still print in portrait." }),
        /* @__PURE__ */ jsx("div", { className: `mx-auto transition-all ${orientation === "landscape" ? "max-w-none" : "max-w-3xl"}`, children: /* @__PURE__ */ jsx("div", { className: "vq-paper rounded-2xl overflow-hidden shadow-xl shadow-neutral-900/10 dark:shadow-black/40 border border-line bg-white", children: /* @__PURE__ */ jsxs("div", { className: "p-6 sm:p-10 text-ink text-sm", style: { fontFamily: "Helvetica, Arial, sans-serif" }, children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row justify-between gap-6 mb-8 border-b-2 border-neutral-900 pb-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("p", { className: "text-xs text-ink-muted mt-1.5", children: [
                "Currency: ",
                currency,
                " (",
                symbol,
            ...
            /* @__PURE__ */ jsxs("div", { className: "text-left sm:text-right", children: [
              /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold tracking-tight text-ink", children: "CASH DRAWER COUNT SHEET" }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-1", children: "End-of-Shift Till Reconciliation" })
            ] })
          ] }),
          /* @__PURE__ */ jsx(
            RegisterSection,
          ...
          extraCount > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-6 rounded-xl border border-dashed border-line bg-surface p-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-3 text-ink-secondary", children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "text-1xs text-ink-muted mb-3", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-2", children: registers.slice(1).map((r, i) => {
              const idx = i + 1;
              return /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-5 gap-2 items-center bg-white rounded-lg border border-line px-3 py-2 text-xs", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-8", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-ink-secondary mb-1", children: "Notes / Discrepancy Explanation" }),
            /* @__PURE__ */ jsx(EditableText, { value: notes, onChange: setNotes, placeholder: "Add a note (optional — the printed sheet always includes blank lines here too)", as: "textarea", rows: 2, className: "block text-xs text-ink-muted" }),
        ...
        /* @__PURE__ */ jsx("p", { className: "text-center text-xs text-ink-muted mt-4", children: "Denomination Count/Subtotal and Expected/Counted/Over-Short cells stay blank by design — click any other field above to edit it." })
      ]
    }
  );
}
function RegisterSection({ register, onChange, symbol, denominations, headers, onHeaderChange, first }) {
  return /* @__PURE__ */ jsxs("div", { className: first ? "" : "mt-8 pt-6 border-t border-line", children: [
    /* @__PURE__ */ jsx("div", { className: "bg-sunken border border-line px-3 py-2 mb-3", children: /* @__PURE__ */ jsx(EditableText, { value: register.name, onChange: (v) => onChange("name", v), placeholder: "Register 1", className: "text-sm font-bold" }) }),
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-x-4 gap-y-2 text-xs mb-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border border-line px-2 py-1.5", children: [
        /* @__PURE__ */ jsx("span", { className: "text-ink-muted w-24 shrink-0", children: "Date" }),
        /* @__PURE__ */ jsx(EditableText, { as: "date", value: register.date, onChange: (v) => onChange("date", v), className: "flex-1" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border border-line px-2 py-1.5", children: [
        /* @__PURE__ */ jsx("span", { className: "text-ink-muted w-24 shrink-0", children: "Shift" }),
        /* @__PURE__ */ jsx(EditableText, { value: register.shift, onChange: (v) => onChange("shift", v), placeholder: "Morning", className: "flex-1" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border border-line px-2 py-1.5", children: [
        /* @__PURE__ */ jsx("span", { className: "text-ink-muted w-24 shrink-0", children: "Counted By" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border border-line px-2 py-1.5", children: [
        /* @__PURE__ */ jsx("span", { className: "text-ink-muted w-24 shrink-0", children: "Verified By" }),
    ...
    /* @__PURE__ */ jsxs("table", { className: "w-full mb-4 border-collapse", children: [
      /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "text-left text-2xs font-bold uppercase tracking-wide text-ink-muted bg-sunken", children: [
        /* @__PURE__ */ jsx("th", { className: "border border-line px-2 py-1.5 w-[34%]", children: /* @__PURE__ */ jsx(EditableText, { value: headers.denomination, onChange: (v) => onHeaderChange("denomination", v), pulse: false, className: "normal-case font-bold" }) }),
        /* @__PURE__ */ jsx("th", { className: "border border-line px-2 py-1.5 w-[16%] text-right", children: /* @__PURE__ */ jsx(EditableText, { value: headers.value, onChange: (v) => onHeaderChange("value", v), pulse: false, className: "normal-case font-bold" }) }),
        /* @__PURE__ */ jsx("th", { className: "border border-line px-2 py-1.5 w-[20%] text-center", children: /* @__PURE__ */ jsx(EditableText, { value: headers.count, onChange: (v) => onHeaderChange("count", v), pulse: false, className: "normal-case font-bold" }) }),
        /* @__PURE__ */ jsx("th", { className: "border border-line px-2 py-1.5 w-[30%] text-center", children: /* @__PURE__ */ jsx(EditableText, { value: headers.subtotal, onChange: (v) => onHeaderChange("subtotal", v), pulse: false, className: "normal-case font-bold" }) })
      ] }) }),
      /* @__PURE__ */ jsxs("tbody", { children: [
        denominations ? denominations.map((row) => /* @__PURE__ */ jsxs("tr", { children: [
          /* @__PURE__ */ jsx("td", { className: "border border-line px-2 py-2 text-xs", children: row.label }),
          /* @__PURE__ */ jsx("td", { className: "border border-line px-2 py-2 text-xs text-right text-ink-muted", children: fmtValue(symbol, row.value) }),
          /* @__PURE__ */ jsx("td", { className: "border border-line px-2 py-2", children: /* @__PURE__ */ jsx(BlankCell, {}) }),
          /* @__PURE__ */ jsx("td", { className: "border border-line px-2 py-2", children: /* @__PURE__ */ jsx(BlankCell, {}) })
        ] }, row.label)) : /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsxs("tr", { children: [
            /* @__PURE__ */ jsx("td", { className: "border border-line px-2 py-2 text-xs", children: "Coins (all denominations)" }),
            /* @__PURE__ */ jsx("td", { className: "border border-line px-2 py-2 text-xs text-right text-ink-muted", children: "—" }),
            /* @__PURE__ */ jsx("td", { className: "border border-line px-2 py-2", children: /* @__PURE__ */ jsx(BlankCell, {}) }),
            /* @__PURE__ */ jsx("td", { className: "border border-line px-2 py-2", children: /* @__PURE__ */ jsx(BlankCell, {}) })
          ] }),
          /* @__PURE__ */ jsxs("tr", { children: [
            /* @__PURE__ */ jsx("td", { className: "border border-line px-2 py-2 text-xs", children: "Notes / Bills (all denominations)" }),
            /* @__PURE__ */ jsx("td", { className: "border border-line px-2 py-2 text-xs text-right text-ink-muted", children: "—" }),
            /* @__PURE__ */ jsx("td", { className: "border border-line px-2 py-2", children: /* @__PURE__ */ jsx(BlankCell, {}) }),
            /* @__PURE__ */ jsx("td", { className: "border border-line px-2 py-2", children: /* @__PURE__ */ jsx(BlankCell, {}) })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("tr", { className: "bg-sunken font-bold", children: [
          /* @__PURE__ */ jsx("td", { colSpan: 3, className: "border border-line px-2 py-2 text-xs", children: "Grand Total Counted" }),
          /* @__PURE__ */ jsx("td", { className: "border border-line px-2 py-2", children: /* @__PURE__ */ jsx(BlankCell, {}) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-2 text-xs mb-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 items-center border border-line px-2 py-2", children: [
        /* @__PURE__ */ jsx("span", { className: "text-ink-secondary", children: "Expected Amount (from POS / register)" }),
        /* @__PURE__ */ jsx(BlankCell, {})
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 items-center border border-line px-2 py-2", children: [
        /* @__PURE__ */ jsx("span", { className: "text-ink-secondary", children: "Total Counted (carried from above)" }),
        /* @__PURE__ */ jsx(BlankCell, {})
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 items-center border border-line px-2 py-2", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("span", { className: "text-ink-secondary block", children: "Over / Short" }),
          /* @__PURE__ */ jsx("span", { className: "text-2xs text-ink-muted", children: "Formula: Total Counted − Expected Amount. Positive = over, negative = short." })
        ] }),
        /* @__PURE__ */ jsx(BlankCell, {})
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-6 text-xs text-ink-muted mt-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "border-t border-neutral-900 pt-1.5", children: [
        "Counted By Signature",
        /* @__PURE__ */ jsx("div", { className: "text-ink-muted", children: "Time: ____________________" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "border-t border-neutral-900 pt-1.5 text-right", children: [
