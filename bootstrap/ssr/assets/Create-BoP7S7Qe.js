...
import { X, Plus, ArrowLeft, Settings, User, Wallet, Zap, ScanBarcode, CreditCard, Banknote, ChevronRight, CheckCircle2, TrendingUp, Type, GripVertical, Trash2, Package, Printer, ArrowLeftRight, ChevronUp, ShoppingCart, FileText } from "lucide-react";
...
const CreateProposal = ({ proposal, existingProposal }) => {
  const sale = proposal || existingProposal;
  const {
    activeInvoices,
    currentInvoiceId,
    setCurrentInvoiceId,
  ...
  const refreshProposalItems = async () => {
    ...
    try {
      ...
      console.error("Failed to refresh proposal items", error);
    }
  };
  useEffect(() => {
  ...
  const handleProductSubmit = async (data, onError) => {
    try {
      const url = productModalMode === "create" ? route("store.inventory.store", {
        store_slug: store.slug
      }) : editingProduct?.id ? route("store.inventory.update", [
        store.slug,
        editingProduct.id
      ]) : "";
  ...
  const toggleItemTotalMode = (id) => setItemTotalModes((prev) => ({
    ...prev,
  ...
  const subtotal = currentInvoice.items.reduce(
    (sum, item) => sum + (item.quantity + (item.freeQuantity || 0)) * item.price,
    0
  );
  const totalCost = currentInvoice.items.reduce(
    (sum, item) => sum + (item.quantity + (item.freeQuantity || 0)) * (item.cost || 0),
    0
  );
  ...
  return /* @__PURE__ */ jsxs(
    OneGlanceLayout,
    {
      title: isEditMode ? `Edit Proposal #${editState?.invoiceNumber || ""}` : "New Proposal",
      activeMenu: "Sales",
      fullScreen: false,
      hideHeader: true,
      noPadding: true,
      children: [
        /* @__PURE__ */ jsx(Head, { title: isEditMode ? "Edit Proposal" : "New Proposal" }),
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: `flex-1 flex flex-col lg:flex-row gap-2 min-h-0 px-2 pb-0 pt-2 lg:overflow-hidden overflow-y-auto text-scale-${textSize}`, children: [
                /* @__PURE__ */ jsxs("div", { className: "flex-1 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-800 flex flex-col overflow-hidden min-h-[400px] lg:min-h-0", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex lg:hidden flex-col gap-1.5 p-1.5 bg-[#0f121d] border-b border-slate-800/80 shrink-0", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between w-full relative", children: [
                      /* @__PURE__ */ jsx(
                        "button",
                        {
                          onClick: () => router.visit(route("store.proposals.index", { store_slug: store?.slug })),
                      ...
                      /* @__PURE__ */ jsxs(
                        "button",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsx("span", { className: "truncate", children: currentInvoice.customer?.name || `Proposal #${activeInvoices.findIndex((inv) => inv.id === currentInvoice.id) + 1}` })
                          ]
                        }
                      ),
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
                        ...
                        /* @__PURE__ */ jsx(
                          ...
                          {
                            onClick: () => {
                              if (window.confirm("Are you sure you want to cancel and discard this proposal?")) {
                                removeInvoice(currentInvoice.id);
                                if (activeInvoices.length === 1) {
                                  router.visit(route("store.proposals.index", { store_slug: store?.slug }));
                                }
                              }
                            },
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "relative group/accounts-mobile shrink-0 h-[36px]", children: [
                          ...
                          /* @__PURE__ */ jsx("div", { className: "absolute right-0 top-full pt-1 z-50 hidden group-hover/accounts-mobile:block", children: /* @__PURE__ */ jsxs("div", { className: "bg-slate-800 rounded-lg shadow-xl border border-slate-700 overflow-hidden w-36 p-1", children: [
                            ...
                            /* @__PURE__ */ jsx("div", { className: "max-h-32 overflow-y-auto custom-scrollbar p-0.5", children: accounts.map((acc) => /* @__PURE__ */ jsx(
                              "button",
                              {
                                type: "button",
                                onClick: () => {
                                ...
                                className: `w-full text-left px-2.5 py-1.5 rounded text-[10px] font-bold transition-colors flex items-center justify-between ${(currentInvoice.paymentAccountId || 1) === acc.id ? "bg-indigo-900/40 text-indigo-400" : "text-slate-350 hover:bg-slate-700/50"}`,
                                children: /* @__PURE__ */ jsx("span", { className: "truncate", children: acc.name })
                              },
                              acc.id
                            )) })
                          ] }) })
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex px-3 py-2 border-b border-slate-100 dark:border-slate-800 items-center gap-3 bg-slate-50/50 dark:bg-slate-800/30 shrink-0", children: [
                      ...
                      /* @__PURE__ */ jsx(
                        "button",
                        {
                          ...
                          children: /* @__PURE__ */ jsx(
                            ...
                            {
                              size: 20,
                              className: showQuickEntry ? "fill-current" : ""
                            }
                          )
                        }
                      ),
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "relative group/accounts", children: [
                        /* @__PURE__ */ jsxs("button", { className: "flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all border border-slate-200 dark:border-slate-700 text-[10px] font-black min-w-[120px] justify-between", children: [
                          /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5 truncate", children: [
                            ...
                            currentInvoice.selectedBankName || accounts.find(
                              (a) => a.id === (currentInvoice.paymentAccountId || 1)
                            )?.name || "Cash in Hand"
                          ] }),
                          /* @__PURE__ */ jsx(
                            ChevronRight,
                          ...
                          /* @__PURE__ */ jsx("div", { className: "max-h-48 overflow-y-auto custom-scrollbar p-1", children: accounts.map((acc) => /* @__PURE__ */ jsxs(
                            "button",
                            {
                              ...
                              children: [
                                ...
                                (currentInvoice.paymentAccountId || 1) === acc.id && /* @__PURE__ */ jsx(
                                  CheckCircle2,
                                  {
                                    size: 12
                                  }
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto hide-scrollbar px-4 py-3", children: [
                    /* @__PURE__ */ jsxs("table", { className: "hidden md:table w-full border-separate border-spacing-y-1.5", children: [
                      ...
                      /* @__PURE__ */ jsxs("tbody", { children: [
                        showQuickEntry && /* @__PURE__ */ jsxs("tr", { className: "bg-gradient-to-r from-indigo-50/50 to-purple-50/50 dark:from-indigo-900/10 dark:to-purple-900/10 border border-indigo-200 dark:border-indigo-800/50 rounded-xl overflow-hidden animate-in slide-in-from-top-2 fade-in duration-200", children: [
                          ...
                          /* @__PURE__ */ jsx("td", { className: "py-3 pl-3", children: /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center", children: /* @__PURE__ */ jsx(
                            Zap,
                            {
                              size: 16,
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsx("td", { className: "bg-slate-50 dark:bg-slate-800/50 py-3 relative px-2", children: /* @__PURE__ */ jsx(
                                AsyncProductCombobox,
                                {
                                  ...
                                  onSelect: (product) => selectProduct(
                                    product,
                                    item.id
                                  ),
                                  onCreateNew: (name) => {
                              ...
                              /* @__PURE__ */ jsx("td", { className: "bg-slate-50 dark:bg-slate-800/50 py-3 pr-3 align-middle", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-1.5", children: [
                                /* @__PURE__ */ jsx(
                                  "button",
                                  {
                                    onClick: () => toggleItemTotalMode(
                                      item.id
                                    ),
                                    title: getItemTotalMode(
                                      item.id
                                    ) === "price" ? "Recalculates: Price (scroll/click to change)" : "Recalculates: Qty (scroll/click to change)",
                                    className: `w-7 h-7 rounded-md text-[10px] font-black transition-all shrink-0 border flex items-center justify-center ${getItemTotalMode(
                                      item.id
                                    ) === "price" ? "bg-indigo-600 text-white border-indigo-500 shadow shadow-indigo-500/30" : "bg-emerald-600 text-white border-emerald-500 shadow shadow-emerald-500/30"}`,
                                    children: getItemTotalMode(
                                      item.id
                                    ) === "price" ? store?.currency_symbol || "₨" : "#"
                                  }
                                ),
                                /* @__PURE__ */ jsx(
                                  WheelInput,
                                  {
                                    ...
                                    onWheel: (e) => {
                                      e.preventDefault();
                                      const delta = e.deltaY < 0 ? 1 : -1;
                                      const currentTotal = calculateLineTotal(
                                        item
                                      );
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "md:hidden flex flex-col gap-2", children: [
                      ...
                      currentInvoice.items.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 rounded-xl p-8 text-center border border-slate-200 dark:border-slate-800", children: [
                        ...
                        /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-slate-700 dark:text-slate-350", children: "No items added" })
                      ] }) : currentInvoice.items.map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col gap-1.5 animate-in fade-in duration-200", children: [
                        ...
                        item.product && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-1.5 mt-1 items-end animate-in fade-in slide-in-from-top-1 duration-200", children: [
                          ...
                          /* @__PURE__ */ jsxs("div", { className: "col-span-2 flex flex-col gap-0.5", children: [
                            /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold text-emerald-600 dark:text-emerald-400 uppercase", children: "Free" }),
                            /* @__PURE__ */ jsx(
                              WheelInput,
                              {
                                type: "number",
                      ...
                      /* @__PURE__ */ jsxs(
                        "button",
                        {
                          ...
                          children: [
                            ...
                            saving ? "SAVING..." : `CONFIRM PROPOSAL (${formatCurrency(grandTotal, store)})`
                          ]
                        }
                      )
                    ] })
                ...
                /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex w-80 bg-[#1a1d2e] flex-col overflow-hidden rounded-2xl shadow-2xl border border-slate-800 shrink-0", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                      /* @__PURE__ */ jsx(
                        "div",
                        {
                          ...
                          children: currentInvoice.customer.name.charAt(
                            0
                          )
                        }
                      ),
                      /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                        /* @__PURE__ */ jsx(
                          "p",
                          {
                            ...
                            children: currentInvoice.customer.name
                          }
                        ),
                        /* @__PURE__ */ jsx(
                          "p",
                          {
                            ...
                            children: currentInvoice.customer.phone || "No Phone"
                          }
                        )
                      ] }),
                      /* @__PURE__ */ jsx(
                          ...
                          /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                            ...
                            /* @__PURE__ */ jsxs(
                              "span",
                              {
                                ...
                                children: [
                                  currentInvoice.customer.current_balance >= 0 ? getCurrencySymbol() : `-${getCurrencySymbol()} `,
                                  Math.abs(
                                    currentInvoice.customer.current_balance || 0
                                  ).toLocaleString()
                                ]
                              }
                            )
                          ...
                          /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start gap-2", children: [
                            ...
                            /* @__PURE__ */ jsx(
                              "span",
                              {
                                ...
                                children: currentInvoice.customer.address || "Not set"
                              }
                            )
                          ] })
                        ]
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex-1 p-3 space-y-3 overflow-y-auto hide-scrollbar", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "space-y-2 pt-3 border-t border-slate-800/50", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                        ...
                        /* @__PURE__ */ jsxs("span", { className: "text-white font-bold text-base", children: [
                          getCurrencySymbol(),
                          " ",
                    ...
                    showDeliveryCharges && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-2 hover:bg-slate-800/20 rounded-lg transition-colors group", children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsx("span", { className: "text-slate-600 text-[10px]", children: getCurrencySymbol() }),
                        /* @__PURE__ */ jsx(
                          "input",
                          {
                            type: "number",
                    ...
                    showExtraField && /* @__PURE__ */ jsx(Fragment, { children: !enableMultipleExtras ? (
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
                          /* @__PURE__ */ jsx(
                            "input",
                            {
                              ...
                              onChange: (e) => patchInvoice({
                                extra_charge_label: e.target.value
                              }),
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                                ...
                                (currentInvoice.extraFields || []).length > 1 && /* @__PURE__ */ jsx(
                                  ...
                                  {
                                    onClick: () => {
                                      const updated = (currentInvoice.extraFields || []).filter(
                                        (_, i) => i !== idx
                                      );
                                      patchInvoice(
                                        {
                        ...
                        (currentInvoice.extraFields || []).length < 10 && /* @__PURE__ */ jsx(
                          ...
                          {
                            onClick: () => {
                              const current = currentInvoice.extraFields || [
                                {
                                  id: 1,
                                  label: "",
                                  value: 0
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                        /* @__PURE__ */ jsxs(
                          "button",
                          {
                            ...
                            disabled: saving || currentInvoice.items.filter(
                              (i) => i.product
                            ).length === 0,
                        ...
                        showConvertMenu && /* @__PURE__ */ jsxs("div", { className: "absolute bottom-full left-0 right-0 mb-2 bg-slate-800 rounded-xl border border-slate-700 shadow-2xl overflow-hidden z-50 animate-in slide-in-from-bottom-2", children: [
                          /* @__PURE__ */ jsxs(
                            "button",
                            {
                              onClick: () => {
                              ...
                              children: [
                                /* @__PURE__ */ jsx("div", { className: "p-2 bg-emerald-500/20 rounded-lg", children: /* @__PURE__ */ jsx(
                                  ShoppingCart,
                                  {
                                    size: 18,
                                ...
                                /* @__PURE__ */ jsxs("div", { children: [
                                  /* @__PURE__ */ jsx("p", { className: "font-bold text-white text-sm", children: "Convert to Sale" }),
                                  /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400", children: "Deduct inventory immediately" })
                                ] })
                              ]
                            }
                          ),
                          /* @__PURE__ */ jsxs(
                            "button",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsx("div", { className: "p-2 bg-blue-500/20 rounded-lg", children: /* @__PURE__ */ jsx(
                                  FileText,
                                  {
                                    size: 18,
                                ...
                                /* @__PURE__ */ jsxs("div", { children: [
                                  /* @__PURE__ */ jsx("p", { className: "font-bold text-white text-sm", children: "Convert to Pre-Sale" }),
                                  /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400", children: "Reserve inventory (no deduction)" })
                                ] })
                              ]
                            }
                          )
        ...
        /* @__PURE__ */ jsx(
          FormModal,
          {
            ...
            subtitle: "Your proposal has been saved successfully",
            size: "md",
            children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center py-6 text-center", children: [
              ...
              /* @__PURE__ */ jsx("h3", { className: "text-xl font-black text-slate-800 dark:text-white mb-2", children: "Proposal Saved" }),
              /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 text-sm mb-8", children: "Your proposal has been saved. No inventory has been affected." }),
        ...
        isScanning && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-slate-900/80 backdrop-blur-md z-[100] flex items-center justify-center p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 rounded-[40px] shadow-2xl border border-slate-100 dark:border-slate-800 w-full max-w-2xl overflow-hidden animate-in zoom-in-95 duration-300", children: [
          /* @__PURE__ */ jsxs("div", { className: "p-8 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-gradient-to-r from-slate-50 to-white dark:from-slate-800/50 dark:to-slate-900", children: [
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx(X, { size: 28, className: "text-slate-400" })
              }
            )
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "p-8 space-y-8", children: [
            ...
            ] }) : scannedItems.map((item, idx) => /* @__PURE__ */ jsxs(
              "div",
              {
        ...
        showProfitModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 w-full max-w-3xl overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[80vh]", children: [
          /* @__PURE__ */ jsxs("div", { className: "p-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50 dark:bg-slate-800/50 shrink-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center", children: /* @__PURE__ */ jsx(
                TrendingUp,
                {
                ...
                return /* @__PURE__ */ jsxs(
                  "tr",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx("td", { className: "py-2 text-right", children: /* @__PURE__ */ jsxs(
                        "span",
                        {
                      ...
                      /* @__PURE__ */ jsx("td", { className: "py-2 text-right pr-2", children: /* @__PURE__ */ jsxs(
                        "span",
                        {
        ...
        showSettingsDrawer && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "fixed top-0 right-0 h-full w-80 bg-white dark:bg-slate-900 shadow-2xl z-[100] animate-in slide-in-from-right duration-300 flex flex-col", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50 dark:bg-slate-800/50", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center", children: /* @__PURE__ */ jsx(
                  Settings,
                  {
                    size: 20,
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "p-3 bg-purple-50 dark:bg-purple-900/20 rounded-xl space-y-2 border border-purple-100 dark:border-purple-800/50", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ jsx(
                      "input",
                      {
                        ...
                        onChange: (e) => setDefaultExtraLabel(
                          e.target.value
                        ),
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      ...
                      /* @__PURE__ */ jsx(
                        "input",
                        {
                          ...
                          onChange: (e) => setDefaultExtraValue(
                            parseFloat(
                              e.target.value
                            ) || 0
                          ),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-100 dark:border-amber-800/50", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-lg bg-amber-100 dark:bg-amber-900/40 flex items-center justify-center", children: /* @__PURE__ */ jsx(
                        Plus,
                        {
                          size: 16,
                    ...
                    /* @__PURE__ */ jsx(
                      "button",
                      {
                        onClick: () => setEnableMultipleExtras(
                          !enableMultipleExtras
                        ),
                ...
                /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl", children: [
                    ...
                    /* @__PURE__ */ jsx(
                      "button",
                      {
                        onClick: () => setShowDeliveryCharges(
                          !showDeliveryCharges
                        ),
          ...
          /* @__PURE__ */ jsx("div", { className: "fixed inset-0 flex items-center justify-center z-[210] p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-[#1a1d2e] rounded-2xl shadow-2xl max-w-md w-full overflow-hidden animate-in zoom-in-95 duration-200 border border-slate-200 dark:border-slate-700/50", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative bg-gradient-to-br from-amber-500 via-orange-500 to-orange-600 dark:from-amber-600 dark:via-orange-700 dark:to-orange-900 p-6 overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative flex items-center gap-4", children: [
                /* @__PURE__ */ jsx("div", { className: "w-14 h-14 rounded-xl bg-white/15 backdrop-blur-md flex items-center justify-center border border-white/30 shadow-xl", children: /* @__PURE__ */ jsx(
                  CreditCard,
                  {
                    size: 26,
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-6 space-y-5 bg-gradient-to-b from-white to-slate-50 dark:from-[#1a1d2e] dark:to-[#0f121d]", children: [
              /* @__PURE__ */ jsxs("div", { className: "text-center py-2", children: [
                ...
                /* @__PURE__ */ jsxs("p", { className: "text-5xl font-black bg-gradient-to-r from-emerald-500 to-teal-500 dark:from-emerald-400 dark:to-teal-400 bg-clip-text text-transparent", children: [
                  getCurrencySymbol(),
                  " ",
