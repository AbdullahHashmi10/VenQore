...
function QrMenuPublic({ restaurant_name, logo_base64, theme_color = vq.indigo[600], currency = "USD", categories = [] }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-app", style: { "--theme": theme_color }, children: [
      /* @__PURE__ */ jsxs(
        "header",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold tracking-tight", children: restaurant_name }),
      ...
      /* @__PURE__ */ jsxs("main", { className: "max-w-lg mx-auto px-4 py-6 pb-16", children: [
        categories.length === 0 && /* @__PURE__ */ jsx("p", { className: "text-center text-ink-muted py-16", children: "This menu doesn't have any items yet." }),
        categories.map((cat, ci) => /* @__PURE__ */ jsxs("section", { className: "mb-8", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-4", children: cat.items.map((item, ii) => /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4 bg-white rounded-2xl p-4 shadow-sm", children: [
            /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsx("p", { className: "font-bold text-ink text-base leading-snug", children: item.name }),
              item.description && /* @__PURE__ */ jsx("p", { className: "text-sm text-ink-muted mt-1 leading-snug", children: item.description })
            ] }),
            /* @__PURE__ */ jsxs("p", { className: "font-bold text-lg shrink-0", style: { color: theme_color }, children: [
              symbol,
      ...
      /* @__PURE__ */ jsxs("footer", { className: "text-center text-1xs text-ink-muted pb-8 px-4", children: [
        "Menu powered by ",
