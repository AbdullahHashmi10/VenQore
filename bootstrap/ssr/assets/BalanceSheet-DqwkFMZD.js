...
function SectionCard({ title, icon: Icon, accounts = [], total, colorClass, totalColorClass }) {
  return /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl border border-line overflow-hidden shadow-sm", children: [
    /* @__PURE__ */ jsx("div", { className: `p-6 border-b border-line ${colorClass}`, children: /* @__PURE__ */ jsxs("h3", { className: "text-lg font-bold flex items-center gap-2", children: [
      /* @__PURE__ */ jsx(Icon, { size: 20 }),
      title
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "divide-y divide-line", children: [
      accounts.length === 0 ? /* @__PURE__ */ jsx("p", { className: "p-6 text-sm text-ink-muted italic text-center", children: "No activity as of this date." }) : accounts.map((account) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsx("span", { className: "font-mono text-xs text-ink-muted w-12 shrink-0", children: account.code }),
              /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-ink-secondary", children: account.name })
            ] }),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-ink tabular-nums", children: formatCurrency(account.balance) })
          ]
        },
        account.id
      )),
      /* @__PURE__ */ jsxs("div", { className: "px-6 py-4 bg-app flex justify-between items-center", children: [
        /* @__PURE__ */ jsxs("span", { className: "text-xs font-bold text-ink-secondary dark:text-ink uppercase tracking-widest", children: [
          "Total ",
          title
        ] }),
        /* @__PURE__ */ jsx("span", { className: `text-lg font-bold tabular-nums ${totalColorClass}`, children: formatCurrency(total) })
      ] })
    ] })
  ] });
}
      ...
      /* @__PURE__ */ jsx(
        PageHeader,
        {
          ...
          actions: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 px-3 py-2 bg-surface\n border border-line rounded-xl shadow-sm", children: [
              /* @__PURE__ */ jsx(Calendar, { size: 15, className: "text-ink-muted shrink-0" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "date",
            ...
            /* @__PURE__ */ jsxs("button", { className: "flex items-center gap-2 px-4 py-2 bg-surface\n border border-line rounded-xl font-bold\n text-ink-secondary hover:bg-interactive-hover transition-all shadow-sm", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto custom-scrollbar space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-8 rounded-2xl bg-brand-600 text-white shadow-xl \n flex flex-col md:flex-row justify-between items-center gap-8 relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-center md:text-left relative z-10", children: [
            /* @__PURE__ */ jsx("p", { className: "text-brand-100 text-xs font-bold uppercase tracking-widest mb-2", children: "Total Assets" }),
            /* @__PURE__ */ jsx("h3", { className: "text-4xl font-bold tabular-nums", children: formatCurrency(total_assets) })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "text-3xl font-light text-brand-300 hidden md:block", children: "=" }),
          /* @__PURE__ */ jsxs("div", { className: "flex gap-10 text-center md:text-right relative z-10", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-brand-100 text-xs font-bold uppercase tracking-widest mb-2", children: "Liabilities" }),
              /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold tabular-nums", children: formatCurrency(total_liabilities) })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "text-2xl font-light text-brand-300 self-end pb-1", children: "+" }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-brand-100 text-xs font-bold uppercase tracking-widest mb-2", children: "Equity" }),
