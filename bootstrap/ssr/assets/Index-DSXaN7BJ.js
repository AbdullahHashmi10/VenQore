    ...
    /* @__PURE__ */ jsxs("div", { className: "w-[480px] bg-slate-900 border-l border-white/10 overflow-y-auto shadow-2xl", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "px-7 py-6 space-y-5", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black uppercase tracking-widest text-slate-500 mb-2", children: "Plan to Grant" }),
          /* @__PURE__ */ jsx(
            "select",
            {
              value: data.plan_id,
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black uppercase tracking-widest text-slate-500 mb-2", children: "Duration — type any amount you want" }),
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black uppercase tracking-widest text-slate-500 mb-2", children: "Your Note (private — never shown to the customer)" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black uppercase tracking-widest text-slate-500 mb-2", children: "Max Uses" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "number",
            ...
            /* @__PURE__ */ jsx("p", { className: "text-1xs text-slate-500 mt-1", children: "1 = single customer only" })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-2xs font-black uppercase tracking-widest text-slate-500 mb-2", children: "Link Expires" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "date",
            ...
            /* @__PURE__ */ jsx("p", { className: "text-1xs text-slate-500 mt-1", children: "Blank = never" })
          ] })
        ] }),
