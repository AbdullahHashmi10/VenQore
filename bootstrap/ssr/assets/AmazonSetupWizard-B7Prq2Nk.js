...
import { r as role, v as vq } from "./runtime-DwSFgQZq.js";
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 14 }, children: [
      ...
      step === 2 && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { style: labelStyle, children: "Amazon Region / Marketplace" }),
          /* @__PURE__ */ jsx("div", { style: { display: "flex", borderBottom: "1px solid #1e3a5f", marginBottom: 12, gap: 12, overflowX: "auto", paddingBottom: 4 }, children: AMAZON_MARKETPLACES.map((group) => {
          ...
          /* @__PURE__ */ jsx("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, maxHeight: 180, overflowY: "auto", padding: "2px 4px" }, children: AMAZON_MARKETPLACES.find((g) => g.region === activeRegionTab)?.markets.map((reg) => {
            ...
            return /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { style: { fontSize: 12, fontWeight: 700, color: isSelected ? "rgb(var(--vq-blue-400))" : vq.slate[100], marginBottom: 2 }, children: reg.label }),
      ...
      step < STEPS.length - 1 ? /* @__PURE__ */ jsxs(
        ...
        "button",
        {
          ...
          style: {
            ...
            borderRadius: 8,
            border: "none",
            background: saving || !canAdvance() ? vq.slate[800] : "linear-gradient(135deg, rgb(var(--vq-emerald-600)), rgb(var(--vq-emerald-700)))",
