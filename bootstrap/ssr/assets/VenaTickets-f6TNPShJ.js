...
import { Plus, Filter, Inbox, MessageSquare, Clock, ChevronRight, Zap, User, AlertCircle, Bot } from "lucide-react";
...
function StatusBadge({ status }) {
  ...
  return /* @__PURE__ */ jsxs("span", { className: `inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-2xs font-bold uppercase tracking-wider border ${cfg.color}`, children: [
...
function EscalationBadge({ type }) {
  ...
  if (!cfg) return null;
  const Icon = cfg.icon;
  return /* @__PURE__ */ jsxs("span", { className: `inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-3xs font-bold uppercase tracking-wider border ${cfg.color}`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "h-full flex flex-col gap-4 overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "shrink-0 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-2xl bg-brand-600/10 dark:bg-brand-500/20 border border-brand-200 dark:border-brand-800 flex items-center justify-center p-2 shadow-xs", children: /* @__PURE__ */ jsx(VenaLogo, { size: 22 }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h1", { className: "text-lg font-bold text-ink tracking-tight", children: "Vena Chat Tickets" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: isPlatform ? "Auto-generated tickets from Vena chat escalations across all stores" : tt("Customer support tickets raised through your store's Vena chat widget") })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          open_count > 0 && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 px-4 py-2 bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800 rounded-2xl", children: [
            ...
            /* @__PURE__ */ jsxs("span", { className: "text-xs font-bold text-rose-700 dark:text-rose-300", children: [
              open_count,
              " open ",
      ...
      /* @__PURE__ */ jsxs("div", { className: "shrink-0 flex items-center gap-3 flex-wrap", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 px-3 py-2 bg-surface border border-line rounded-xl shadow-sm", children: [
          /* @__PURE__ */ jsx(Filter, { size: 12, className: "text-ink-muted" }),
          /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold uppercase tracking-wider text-ink-muted", children: "Status:" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              value: statusFilter,
        ...
        isPlatform && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 px-3 py-2 bg-surface border border-line rounded-xl shadow-sm", children: [
          /* @__PURE__ */ jsx(Filter, { size: 12, className: "text-ink-muted" }),
          /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold uppercase tracking-wider text-ink-muted", children: "Reason:" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto custom-scrollbar", children: tickets.data.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-full py-24 text-center", children: [
        /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-2xl bg-brand-50 dark:bg-brand-900/20 border border-brand-100 dark:border-brand-800 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsx(Inbox, { size: 28, className: "text-brand-400" }) }),
        /* @__PURE__ */ jsx("h3", { className: "text-base font-bold text-ink-secondary dark:text-ink", children: "No tickets found" }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-1", children: "Vena tickets appear here when chat escalations occur and agents are offline." })
        ...
        return /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "shrink-0 w-10 h-10 rounded-xl bg-brand-50 dark:bg-brand-900/20 border border-brand-100 dark:border-brand-800 flex items-center justify-center", children: /* @__PURE__ */ jsx(MessageSquare, { size: 16, className: "text-brand-500 dark:text-brand-400" }) }),
              /* @__PURE__ */ jsx("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold text-ink truncate group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors", children: ticket.subject }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mt-1 flex-wrap", children: [
                    ...
                    isPlatform && ticket.tenant && /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold px-2 py-0.5 bg-sunken text-ink-muted rounded-full border border-line", children: ticket.tenant.name })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "shrink-0 flex flex-col items-end gap-2", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 text-2xs text-ink-muted", children: [
      ...
      tickets.last_page > 1 && /* @__PURE__ */ jsxs("div", { className: "shrink-0 flex items-center justify-between py-3 border-t border-line", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex gap-1.5", children: tickets.links.map((link, i) => /* @__PURE__ */ jsx(
          ...
          {
            href: link.url || "#",
            className: `px-3 py-1.5 rounded-xl text-xs font-bold border transition-all ${link.active ? "bg-brand-600 text-white border-brand-600 shadow-sm" : link.url ? "bg-surface text-ink-secondary border-line hover:border-brand-200" : "bg-app text-neutral-300 dark:text-ink-secondary border-line cursor-not-allowed"}`,
            preserveState: true,
...
` }),
    openModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-toast flex items-center justify-center p-4 bg-neutral-950/60 backdrop-blur-sm animate-fade-in", style: { animation: "fadeIn 0.2s ease-out" }, children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-lg bg-surface border border-line rounded-2xl overflow-hidden shadow-2xl animate-scale-up", style: { animation: "scaleUp 0.25s cubic-bezier(0.34, 1.56, 0.64, 1)" }, children: [
      /* @__PURE__ */ jsxs("div", { className: "px-6 py-5 border-b border-line flex items-center justify-between bg-sunken/50 dark:bg-surface", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "text-base font-bold text-ink tracking-tight", children: tt("Log New Customer Ticket") }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-0.5", children: tt("Record customer issues manually while on the call or in-store") })
        ] }),
        /* @__PURE__ */ jsx("button", { onClick: () => setOpenModal(false), className: "text-ink-muted hover:text-ink-secondary dark:hover:text-neutral-200 transition-colors text-lg p-1", children: "✕" })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "p-6 space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-wider text-ink-muted mb-1.5", children: tt("Customer Name") }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-wider text-ink-muted mb-1.5", children: tt("Customer Email") }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "email",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-wider text-ink-muted mb-1.5", children: "Subject / Summary" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-wider text-ink-muted mb-1.5", children: "Priority" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              value: formPriority,
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-2xs font-bold uppercase tracking-wider text-ink-muted mb-1.5", children: "Issue details / notes" }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
              required: true,
              rows: 4,
              placeholder: tt("Describe the customer inquiry or ticket details..."),
              value: formMessage,
        ...
        /* @__PURE__ */ jsxs("div", { className: "pt-2 flex justify-end gap-3", children: [
          /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setOpenModal(false), className: "px-4 py-2 border border-line rounded-xl text-xs font-bold uppercase tracking-wider text-ink-muted hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors", children: "Cancel" }),
          /* @__PURE__ */ jsx("button", { type: "submit", disabled: isSubmitting, className: "flex items-center gap-1.5 px-5 py-2 bg-brand-600 hover:bg-brand-700 active:bg-brand-800 text-white rounded-xl text-xs font-bold uppercase tracking-wider transition-all duration-fast shadow-sm ", children: isSubmitting ? "Logging..." : "Log Ticket" })
        ] })
      ] })
    ] }) })
  ] });
