...
function SetupWizard({ industries, userEmail, initialStoreName, store_slug, store_logo }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-neutral-950 text-white flex flex-col items-center justify-center p-6 relative overflow-hidden nebula-scrollbar", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute -top-[20%] -left-[10%] w-[50%] h-[50%] bg-brand-600/20 rounded-full blur-[100px]" }),
      /* @__PURE__ */ jsx("div", { className: "absolute top-[40%] -right-[10%] w-[40%] h-[40%] bg-brand-600/20 rounded-full blur-[100px]" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "w-full max-w-5xl z-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-10", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold mb-2 tracking-tight bg-gradient-to-r from-white via-neutral-200 to-neutral-400 bg-clip-text text-transparent", children: "Welcome to VENQORE" }),
        /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-lg", children: "Let's tailor the experience for your business." })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex justify-center gap-4 mb-10", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsx("div", { className: `h-1.5 rounded-full transition-all duration-slower ${step >= i ? "w-12 bg-brand-500 shadow-glow" : "w-4 bg-neutral-800"}` }, i)) }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "bg-neutral-900/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 overflow-hidden relative min-h-[600px] flex flex-col", children: [
        step === 1 && /* @__PURE__ */ jsxs("div", { className: "flex-1 p-8 md:p-12 animate-in fade-in slide-in-from-right-8 duration-slower", children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-bold mb-6 flex items-center gap-3 text-white", children: [
            /* @__PURE__ */ jsx("span", { className: "flex items-center justify-center w-8 h-8 rounded-full bg-brand-500/20 text-brand-400 text-sm font-bold border border-brand-500/30", children: "1" }),
            "Business Profile"
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsxs("label", { className: "block text-xs font-bold text-ink-muted mb-2 uppercase tracking-wide", children: [
                  "Business Name ",
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsx(Mail, { className: "absolute left-4 top-1/2 -translate-y-1/2 text-ink-muted", size: 18 }),
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      type: "email",
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                  /* @__PURE__ */ jsxs("div", { className: "relative w-1/3 min-w-[120px]", children: [
                    ...
                    /* @__PURE__ */ jsx(ChevronDown, { className: "absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-ink-muted", size: 16 })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "relative flex-1", children: [
                    /* @__PURE__ */ jsx(Phone, { className: "absolute left-4 top-1/2 -translate-y-1/2 text-ink-muted", size: 18 }),
                    /* @__PURE__ */ jsx(
                      "input",
                      {
                        type: "tel",
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsx(MapPin, { className: "absolute left-4 top-4 text-ink-muted", size: 18 }),
                  /* @__PURE__ */ jsx(
                    "textarea",
                    {
                      value: data.address,
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-ink-muted mb-4 uppercase tracking-wide", children: "Trading Currency" }),
        ...
        step === 2 && /* @__PURE__ */ jsxs("div", { className: "flex-1 p-8 md:p-12 animate-in fade-in slide-in-from-right-8 duration-slower flex flex-col", children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-bold mb-2 flex items-center gap-3 text-white", children: [
            /* @__PURE__ */ jsx("span", { className: "flex items-center justify-center w-8 h-8 rounded-full bg-brand-500/20 text-brand-400 text-sm font-bold border border-brand-500/30", children: "2" }),
            "Select Industry"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-ink-muted mb-8 pl-11", children: "We'll optimize the system for your specific business type." }),
          /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto pr-2 nebula-scrollbar max-h-[400px]", children: /* @__PURE__ */ jsx("div", { className: "space-y-8", children: Object.entries(industries).map(([groupKey, group]) => {
            ...
            return /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("h3", { className: "text-xs font-bold text-brand-300 uppercase tracking-widest mb-4 flex items-center gap-2 opacity-80 pl-1", children: [
        ...
        step === 3 && /* @__PURE__ */ jsxs("div", { className: "flex-1 p-8 md:p-12 animate-in fade-in slide-in-from-right-8 duration-slower flex flex-col", children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-bold mb-2 flex items-center gap-3 text-white", children: [
            /* @__PURE__ */ jsx("span", { className: "flex items-center justify-center w-8 h-8 rounded-full bg-brand-500/20 text-brand-400 text-sm font-bold border border-brand-500/30", children: "3" }),
            "Brand Identity"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-ink-muted mb-8 pl-11", children: "Choose a visual style or upload your own logo." }),
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-12 items-start", children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-neutral-800/50 rounded-2xl p-6 border border-white/5 relative overflow-hidden", children: [
              /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-32 h-32 bg-brand-500/10 rounded-full blur-3xl" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-6 border-b border-white/5 pb-6", children: [
                /* @__PURE__ */ jsx("div", { className: "transition-all duration-slow", children: data.logo_type === "upload" && data.logo_preview ? /* @__PURE__ */ jsx("img", { src: data.logo_preview, alt: "Logo", className: "w-16 h-16 object-contain" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                  (data.logo_style === "minimal" || data.logo_type === "upload") && !data.logo_preview && /* @__PURE__ */ jsx("div", { className: "w-16 h-16 flex items-center justify-center text-brand-400", children: /* @__PURE__ */ jsx(SelectedIndustryIcon, { size: 48, strokeWidth: 1.5 }) }),
                  data.logo_style === "framed" && data.logo_type !== "upload" && /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-full border-2 border-brand-500 flex items-center justify-center text-brand-400 bg-brand-500/10", children: /* @__PURE__ */ jsx(SelectedIndustryIcon, { size: 32 }) }),
                  data.logo_style === "modern" && data.logo_type !== "upload" && /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-2xl bg-gradient-brand flex items-center justify-center text-white shadow-lg ", children: /* @__PURE__ */ jsx(SelectedIndustryIcon, { size: 32 }) })
                ] }) }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("h3", { className: "font-bold text-xl text-white", children: data.business_name || "Business Name" }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: data.address || "123 Main St, City" }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: data.phone || "+123 456 7890" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-3 opacity-50 pointer-events-none select-none", children: [
                /* @__PURE__ */ jsx("div", { className: "h-4 w-1/3 bg-neutral-700/50 rounded" }),
                /* @__PURE__ */ jsx("div", { className: "h-20 w-full bg-neutral-700/30 rounded-lg border border-white/5" }),
                /* @__PURE__ */ jsx("div", { className: "h-20 w-full bg-neutral-700/30 rounded-lg border border-white/5" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-ink-muted mb-4 uppercase tracking-wide", children: "Custom Logo" }),
                /* @__PURE__ */ jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx(Upload, { className: "mb-2 text-ink-muted", size: 24 }),
                      /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-white", children: "Upload Photo" }),
                      /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted mt-1", children: "Max 1100x1100px. Will be resized for display." }),
                      /* @__PURE__ */ jsx(
                        "input",
                        {
                          id: "logo-upload",
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsx("div", { className: "absolute inset-0 flex items-center", children: /* @__PURE__ */ jsx("div", { className: "w-full border-t border-neutral-700" }) }),
                /* @__PURE__ */ jsx("div", { className: "relative flex justify-center text-xs uppercase", children: /* @__PURE__ */ jsx("span", { className: "bg-neutral-900 px-2 text-ink-muted", children: "Or Choose Style" }) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxs("button", { onClick: () => setData((d) => ({ ...d, logo_type: "preset", logo_style: "minimal" })), className: `w-full flex items-center gap-4 p-3 rounded-xl border transition-all ${data.logo_type === "preset" && data.logo_style === "minimal" ? "bg-brand-500/20 border-brand-500" : "bg-neutral-800/30 border-white/5 hover:bg-interactive-hover"}`, children: [
                  /* @__PURE__ */ jsx("div", { className: "w-8 h-8 flex items-center justify-center text-brand-400", children: /* @__PURE__ */ jsx(SelectedIndustryIcon, { size: 20 }) }),
                ...
                /* @__PURE__ */ jsxs("button", { onClick: () => setData((d) => ({ ...d, logo_type: "preset", logo_style: "framed" })), className: `w-full flex items-center gap-4 p-3 rounded-xl border transition-all ${data.logo_type === "preset" && data.logo_style === "framed" ? "bg-brand-500/20 border-brand-500" : "bg-neutral-800/30 border-white/5 hover:bg-interactive-hover"}`, children: [
                  /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-full border border-brand-500 flex items-center justify-center text-brand-400 bg-brand-500/10", children: /* @__PURE__ */ jsx(SelectedIndustryIcon, { size: 16 }) }),
                  /* @__PURE__ */ jsx("div", { className: "text-left", children: /* @__PURE__ */ jsx("div", { className: "font-bold text-white text-sm", children: "Framed" }) })
                ] }),
                /* @__PURE__ */ jsxs("button", { onClick: () => setData((d) => ({ ...d, logo_type: "preset", logo_style: "modern" })), className: `w-full flex items-center gap-4 p-3 rounded-xl border transition-all ${data.logo_type === "preset" && data.logo_style === "modern" ? "bg-brand-500/20 border-brand-500" : "bg-neutral-800/30 border-white/5 hover:bg-interactive-hover"}`, children: [
                  /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-lg bg-gradient-brand flex items-center justify-center text-white", children: /* @__PURE__ */ jsx(SelectedIndustryIcon, { size: 16 }) }),
        ...
        processing && /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 bg-neutral-900/95 backdrop-blur-md z-50 flex flex-col items-center justify-center text-center p-8 animate-in fade-in duration-slow", children: [
          /* @__PURE__ */ jsxs("div", { className: "relative mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "w-20 h-20 border-4 border-neutral-700 rounded-full" }),
            /* @__PURE__ */ jsx("div", { className: "w-20 h-20 border-4 border-brand-500 border-t-transparent rounded-full animate-spin absolute top-0 left-0" }),
            /* @__PURE__ */ jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2", children: /* @__PURE__ */ jsx(Zap, { className: "text-brand-500 fill-current", size: 24 }) })
          ] }),
          /* @__PURE__ */ jsxs("h3", { className: "text-2xl font-bold text-white mb-2", children: [
            "Setting up your ",
            data.business_name,
            "..."
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-8 space-y-2 text-sm text-ink-muted", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "text-center mt-8 text-ink-secondary text-sm", children: "© 2026 VENQORE System. All rights reserved." })
    ] }),
