...
function PaymentRow({ item, type, store }) {
  const isIn = type === "in";
  return /* @__PURE__ */ jsxs("tr", { className: "group hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors border-b border-line last:border-0", children: [
    /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-xs font-semibold text-ink-muted tabular-nums whitespace-nowrap", children: formatDate(item.date || item.created_at) }),
    /* @__PURE__ */ jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsx("div", { className: `w-7 h-7 rounded-full flex items-center justify-center text-2xs font-bold shrink-0 ${isIn ? "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-400" : "bg-rose-100 text-rose-700 dark:bg-rose-900/40 dark:text-rose-400"}`, children: (item.party?.name || "G")[0].toUpperCase() }),
      /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink truncate", children: item.party?.name || /* @__PURE__ */ jsx("span", { className: "text-ink-muted italic", children: "No party" }) }),
        item.reference && /* @__PURE__ */ jsx("span", { className: "text-2xs font-mono text-ink-muted bg-sunken px-1.5 py-0.5 rounded", children: item.reference })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-1 rounded-md bg-sunken text-2xs font-bold text-ink-secondary uppercase", children: [
      /* @__PURE__ */ jsx(MethodIcon, { method: item.method }),
      item.method || "—"
    ] }) }),
    /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-xs text-ink-muted max-w-[180px] truncate", children: item.notes || "—" }),
    /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-right", children: /* @__PURE__ */ jsxs("span", { className: `text-sm font-bold tabular-nums ${isIn ? "text-emerald-600 dark:text-emerald-400" : "text-rose-600 dark:text-rose-400"}`, children: [
      isIn ? "+" : "−",
      " ",
...
function PaymentPanel({ type, payments, sort, onSort, loading, observerRef, stats, store }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col rounded-2xl border border-line bg-surface shadow-sm overflow-hidden min-h-0 flex-1", children: [
    /* @__PURE__ */ jsxs("div", { className: `flex items-center justify-between px-4 py-3 border-b ${accent.border} ${accent.light}`, children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink", children: isIn ? "Payment In" : "Payment Out" }),
          /* @__PURE__ */ jsx("p", { className: "text-2xs text-ink-muted", children: isIn ? "Money received" : "Money sent" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
        /* @__PURE__ */ jsx("p", { className: `text-lg font-bold tabular-nums ${accent.text}`, children: formatCurrency(stats?.total || 0) }),
    ...
    /* @__PURE__ */ jsx("div", { className: "px-4 py-2 border-b border-line shrink-0", children: /* @__PURE__ */ jsxs(
      Link,
      {
    ...
    /* @__PURE__ */ jsx("div", { className: "overflow-auto flex-1 min-h-0", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left", children: [
      /* @__PURE__ */ jsx("thead", { className: "sticky top-0 z-10 bg-app border-b border-line", children: /* @__PURE__ */ jsxs("tr", { children: [
        ...
        /* @__PURE__ */ jsx("th", { className: "px-4 py-2.5 text-xs font-bold text-ink-muted uppercase", children: "Method" }),
        /* @__PURE__ */ jsx("th", { className: "px-4 py-2.5 text-xs font-bold text-ink-muted uppercase", children: "Notes" }),
      ...
      /* @__PURE__ */ jsxs("tbody", { children: [
        sorted.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsxs("td", { colSpan: 5, className: "py-16 text-center text-ink-muted", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "font-bold text-ink-muted text-sm", children: [
            "No ",
            isIn ? "incoming" : "outgoing",
            " payments yet"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-1", children: "Use the button above to record one" })
        ] }) }) : sorted.map((item) => /* @__PURE__ */ jsx(PaymentRow, { item, type, store }, item.id)),
        /* @__PURE__ */ jsx("tr", { ref: observerRef, className: "h-1", children: /* @__PURE__ */ jsx("td", { colSpan: 5, children: loading && /* @__PURE__ */ jsx("div", { className: "flex justify-center py-2", children: /* @__PURE__ */ jsx(RefreshCw, { size: 14, className: "text-ink-muted animate-spin" }) }) }) })
      ] })
    ] }) })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs(OneGlanceLayout, { title: "Payments", activeMenu: "Money", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full bg-app p-2 gap-2 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-2 shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-4 py-2.5 rounded-xl border border-line flex items-center justify-between shadow-sm", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-ink-muted uppercase", children: "Total Received" }),
              /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-emerald-600", children: formatCurrency(totalIn) })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("p", { className: "text-2xs text-ink-muted", children: [
            "Today: ",
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-surface px-4 py-2.5 rounded-xl border border-line flex items-center justify-between shadow-sm", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-ink-muted uppercase", children: "Total Paid Out" }),
              /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-rose-600", children: formatCurrency(totalOut) })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("p", { className: "text-2xs text-ink-muted", children: [
            "Today: ",
        ...
        /* @__PURE__ */ jsxs("div", { className: `px-4 py-2.5 rounded-xl border shadow-sm flex items-center justify-between ${netFlow >= 0 ? "bg-brand-50 dark:bg-brand-900/20 border-brand-200 dark:border-brand-800/40" : "bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-800/40"}`, children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: `p-1.5 rounded-lg ${netFlow >= 0 ? "bg-brand-100 dark:bg-brand-900/50 text-brand-600" : "bg-amber-100 dark:bg-amber-900/50 text-amber-600"}`, children: netFlow >= 0 ? /* @__PURE__ */ jsx(TrendingUp, { size: 15 }) : /* @__PURE__ */ jsx(TrendingDown, { size: 15 }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-ink-muted uppercase", children: "Net Cash Flow" }),
              /* @__PURE__ */ jsxs("p", { className: `text-base font-bold tabular-nums ${netFlow >= 0 ? "text-brand-600" : "text-amber-600"}`, children: [
                netFlow >= 0 ? "+" : "−",
                " ",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 bg-surface px-3 py-2 rounded-xl border border-line shadow-sm shrink-0", children: [
        /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1", children: periods.map((p) => /* @__PURE__ */ jsx(
          "button",
          {
            onClick: () => handlePeriod(p.val),
            className: `px-3 py-1 text-2xs font-bold uppercase rounded-full transition-all ${period === p.val ? "bg-brand-600 text-white shadow-sm" : "bg-sunken text-ink-muted hover:bg-interactive-hover dark:hover:bg-interactive-hover"}`,
            children: p.label
          },
          p.val
        )) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative ml-auto", children: [
          /* @__PURE__ */ jsx(Search, { size: 13, className: "absolute left-2.5 top-1/2 -translate-y-1/2 text-ink-muted" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
