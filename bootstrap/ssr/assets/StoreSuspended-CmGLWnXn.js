...
function StoreSuspended({ store_name, plan, billing_url }) {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-void-950 text-white font-sans flex items-center justify-center p-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 w-full max-w-md text-center", children: [
      ...
      /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-white mb-2", children: "Store Suspended" }),
      ...
      /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-xs mb-8", children: "This usually happens when a trial expires or a payment fails. Please update your billing to restore access." }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
        billing_url && /* @__PURE__ */ jsxs(
          "a",
          {
            href: billing_url,
            className: "flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-gradient-brand text-white font-bold transition-all",
            children: [
