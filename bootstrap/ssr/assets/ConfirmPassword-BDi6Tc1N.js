...
import { ShieldCheck, Lock, EyeOff, Eye, Loader2, ArrowRight } from "lucide-react";
...
function ConfirmPassword() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen w-full flex items-center justify-center bg-[#020010] font-sans selection:bg-indigo-500/40 p-4 sm:p-6 relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "absolute top-[-20%] right-[-10%] w-[50vw] h-[50vw] bg-indigo-900/15 rounded-full blur-[160px] pointer-events-none" }),
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-[-15%] left-[-5%] w-[40vw] h-[40vw] bg-violet-900/10 rounded-full blur-[140px] pointer-events-none" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 w-full max-w-md", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white/[0.02] border border-white/[0.06] rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-10 backdrop-blur-sm", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsx("div", { className: "w-11 h-11 rounded-xl bg-amber-500/10 flex items-center justify-center text-amber-400", children: /* @__PURE__ */ jsx(ShieldCheck, { size: 20 }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "text-xl font-black text-white tracking-tight", style: { fontFamily: "'Space Grotesk', 'Inter', sans-serif" }, children: "Confirm Password" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400", children: "Secure area — re-enter your password" })
          ] })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-slate-400 text-sm leading-relaxed mb-6 sm:mb-8", children: "This is a protected section of the application. Please confirm your password before continuing." }),
        /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-5 sm:space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: `block text-[10px] font-black uppercase tracking-[0.25em] mb-2.5 transition-colors duration-300 ${focused ? "text-indigo-400" : "text-slate-400"}`, children: "Password" }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx("div", { className: `absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-300 ${focused ? "text-indigo-400" : "text-slate-400"}`, children: /* @__PURE__ */ jsx(Lock, { size: 18 }) }),
              /* @__PURE__ */ jsx(
                "input",
                {
