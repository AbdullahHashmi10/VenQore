...
import { t as tokens, h as ensurePlatformStyles, G as GRADIENTS, B as BRAND, b as Badge } from "./ui-CcDUonPh.js";
import { LayoutDashboard, Store, Users, SlidersHorizontal, UserCog, BadgeCheck, Boxes, Layers, Ticket, Gift, DollarSign, TrendingUp, Tag, Cpu, Inbox, MessagesSquare, Bot, FlaskConical, Megaphone, Package, HeartPulse, ShieldCheck, Server, Webhook, HardDrive, ToggleRight, RefreshCw, Settings, KeyRound, Menu, Search, Sun, Moon, X, ChevronRight, ChevronLeft, LogOut, Command, ArrowRight, AlertTriangle } from "lucide-react";
import { A as AiIsland } from "./AiIsland-qlixTg74.js";
...
function PlatformLayout({ children, title = "Command Center" }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { position: "fixed", inset: 0, height: "100vh", width: "100vw", display: "flex", overflow: "hidden", background: t.appBg, color: t.ink, fontFamily: "'Figtree','Inter',system-ui,sans-serif" }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", height: "100%", minWidth: 0, minHeight: 0, position: "relative", zIndex: 1, overflow: "hidden" }, children: [
      /* @__PURE__ */ jsxs("header", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12, minWidth: 160 }, children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "vq-desktop-only", style: { display: "flex", alignItems: "center", gap: 8 }, children: [
            /* @__PURE__ */ jsx("span", { style: { fontSize: 13, fontWeight: 700, color: t.ink, letterSpacing: "-0.01em" }, children: "Platform HQ" }),
            /* @__PURE__ */ jsx("span", { style: { fontSize: 11, fontWeight: 600, color: t.muted, background: t.hover, padding: "2px 8px", borderRadius: 999, border: `1px solid ${t.border}` }, children: "Production" })
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, minWidth: 160, justifyContent: "flex-end", zIndex: 30 }, children: [
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("span", { children: "Quick Jump" }),
      ...
      /* @__PURE__ */ jsx("main", { className: "vq-scroll", style: { flex: 1, minHeight: 0, overflowY: "auto", overflowX: "hidden", padding: "26px clamp(16px, 3vw, 34px) 60px" }, children: /* @__PURE__ */ jsx("div", { style: { maxWidth: 1320, margin: "0 auto", animation: "vq-fade .35s ease both" }, children }) })
    ] }),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("aside", { "data-sidebar": true, className: mobileOpen ? "vq-open" : "", style: {
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs(Link, { href: route("platform.dashboard"), style: { display: "flex", alignItems: "center", gap: 12, textDecoration: "none" }, children: [
          /* @__PURE__ */ jsx(
            "img",
            {
              src: "/images/logo.png",
          ...
          !collapsed && /* @__PURE__ */ jsxs("div", { style: { lineHeight: 1.15, overflow: "hidden" }, children: [
            /* @__PURE__ */ jsx("div", { style: { fontSize: 16.5, fontWeight: 900, letterSpacing: "-0.02em", color: t.ink }, children: "VENQORE" }),
            /* @__PURE__ */ jsx("div", { style: { fontSize: 9.5, fontWeight: 800, letterSpacing: "0.14em", textTransform: "uppercase", color: BRAND.indigo2 }, children: "Command Center" })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsx("nav", { className: "vq-scroll", style: { flex: 1, overflowY: "auto", overflowX: "hidden", padding: "14px 10px 8px" }, children: NAV_GROUPS.map((group) => /* @__PURE__ */ jsxs("div", { style: { marginBottom: 14 }, children: [
      ...
      /* @__PURE__ */ jsxs("div", { style: { padding: collapsed ? "12px 6px" : "12px 10px", borderTop: `1px solid ${t.border}`, flexShrink: 0, position: "relative" }, ref: userMenuRef, children: [
        userMenuOpen && /* @__PURE__ */ jsxs("div", { style: {
          position: "absolute",
          bottom: "calc(100% + 8px)",
          left: collapsed ? 8 : 10,
          width: 240,
          ...
          /* @__PURE__ */ jsxs("div", { style: { padding: "8px 10px 10px", borderBottom: `1px solid ${t.border}` }, children: [
            /* @__PURE__ */ jsx("div", { style: { fontSize: 13.5, fontWeight: 800, color: t.ink, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: auth?.user?.name || "Administrator" }),
            /* @__PURE__ */ jsx("div", { style: { fontSize: 10, fontWeight: 800, color: BRAND.indigo2, letterSpacing: "0.06em", textTransform: "uppercase", marginTop: 2 }, children: "Hashmi Dashboard" }),
            /* @__PURE__ */ jsx("div", { style: { fontSize: 11, color: t.muted, marginTop: 2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: auth?.user?.email })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: { paddingTop: 6, display: "flex", flexDirection: "column", gap: 2 }, children: [
            /* @__PURE__ */ jsxs(Link, { href: "/", style: popupItemStyle(t), className: "vq-press", onClick: () => setUserMenuOpen(false), children: [
              /* @__PURE__ */ jsx(ChevronLeft, { size: 16, color: BRAND.indigo2 }),
              /* @__PURE__ */ jsx("span", { children: "Back to App" })
            ] }),
            /* @__PURE__ */ jsxs(Link, { href: "/updater", style: popupItemStyle(t), className: "vq-press", onClick: () => setUserMenuOpen(false), children: [
              /* @__PURE__ */ jsx(Package, { size: 16, color: BRAND.amber }),
              /* @__PURE__ */ jsx("span", { children: "System Updates" })
            ] }),
            /* @__PURE__ */ jsx("div", { style: { height: 1, background: t.border, margin: "4px 0" } }),
            /* @__PURE__ */ jsxs(Link, { href: route("logout"), method: "post", as: "button", style: { ...popupItemStyle(t), color: BRAND.rose }, className: "vq-press", children: [
              /* @__PURE__ */ jsx(LogOut, { size: 16, color: BRAND.rose }),
          ...
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { style: {
                ...
                flexShrink: 0
              }, children: (auth?.user?.name?.[0] || "A").toUpperCase() }),
              !collapsed && /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0, overflow: "hidden" }, children: [
                /* @__PURE__ */ jsx("div", { style: { fontSize: 13, fontWeight: 700, color: t.ink, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: auth?.user?.name || "Administrator" }),
