...
const AuthInput = ({ icon: Icon, label, error, ...props }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("label", { className: `block text-[10px] font-black uppercase tracking-[0.25em] mb-2.5 transition-colors duration-300 ${focused ? "text-violet-400" : "text-slate-500"}`, children: label }),
...
function StaffLogin({ status, flash }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen w-full flex bg-[#02000c] font-sans selection:bg-violet-500/40 selection:text-white", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "w-full lg:w-[55%] flex items-center justify-center p-6 sm:p-12 relative", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md relative z-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-10 text-center sm:text-left", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[10px] bg-violet-500/10 border border-violet-500/20 text-violet-400 font-bold px-3 py-1 rounded-full uppercase tracking-widest inline-block mb-3", children: "Platform Command Portal" }),
        ...
        /* @__PURE__ */ jsx("form", { onSubmit: submit, className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-black uppercase tracking-[0.25em] mb-2.5 text-slate-500", children: "Password" }),
            /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
