...
function StockValuation({ products = [], stats = {}, filters = {}, categories = [], warehouses = [] }) {
  ...
  const columns = [
    {
      ...
      render: (row) => /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "font-medium text-ink", children: row.name }),
        /* @__PURE__ */ jsx("div", { className: "text-xs text-ink-muted", children: row.sku })
      ] })
    },
    {
      key: "category",
    ...
    },
    {
      ...
      align: "right",
      sortable: true,
      render: (row) => /* @__PURE__ */ jsx("span", { className: "font-medium text-ink-secondary", children: formatCurrency(row.retail_value, store) })
    }
  ];
  const filterDefs = [
    {
  ...
  return /* @__PURE__ */ jsxs(ReportsLayout, { title: "Stock Valuation", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "hidden print:block p-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-10 border-b-2 border-neutral-900 pb-6", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold", children: store.name }),
        /* @__PURE__ */ jsx("h2", { className: "text-xl font-bold text-ink-secondary uppercase tracking-widest mt-2", children: "Stock Valuation Report" }),
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-4 mb-10", children: reportStats.map((s, idx) => /* @__PURE__ */ jsxs("div", { className: "border p-4 rounded-xl", children: [
        /* @__PURE__ */ jsx("p", { className: "text-2xs font-bold text-ink-muted uppercase", children: s.label }),
        /* @__PURE__ */ jsx("p", { className: "text-xl font-bold", children: s.value })
      ] }, idx)) }),
      /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b-2 border-neutral-900", children: [
          /* @__PURE__ */ jsx("th", { className: "py-2 text-xs font-bold uppercase", children: tt("Product / SKU") }),
        ...
        /* @__PURE__ */ jsx("tbody", { className: "divide-y border-b", children: products.map((row, idx) => /* @__PURE__ */ jsxs("tr", { children: [
          /* @__PURE__ */ jsxs("td", { className: "py-3", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "text-2xs text-ink-muted", children: row.sku })
          ] }),
          ...
          /* @__PURE__ */ jsx("td", { className: "py-3 text-right font-bold", children: formatCurrency(row.stock_value, store) })
        ] }, idx)) })
      ] })
    ] })
  ] });
