...
function Toggle({ value, onChange }) {
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      className: `w-11 h-6 rounded-full p-0.5 transition-all duration-normal ${value ? "bg-brand-600" : "bg-neutral-700"}`,
      children: /* @__PURE__ */ jsx("div", { className: `w-5 h-5 bg-white rounded-full shadow transition-all duration-normal ${value ? "translate-x-5" : "translate-x-0"}` })
    }
  );
}
function FieldRow({ label, icon: Icon, children }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 py-3.5 border-b border-neutral-800/60 last:border-0", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 w-48 shrink-0 pt-0.5", children: [
      Icon && /* @__PURE__ */ jsx(Icon, { size: 14, className: "text-ink-muted shrink-0" }),
      /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-ink-muted uppercase tracking-widest", children: label })
    ] }),
...
function EditableText({ value, onChange, placeholder, type = "text" }) {
  return /* @__PURE__ */ jsx(
    "input",
    {
      ...
      placeholder,
      className: "w-full bg-neutral-800/60 border border-neutral-700 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-all"
    }
  );
}
function EditableSelect({ value, onChange, options }) {
  return /* @__PURE__ */ jsx(
    "select",
    {
      value: value ?? "",
      onChange: (e) => onChange(e.target.value),
      className: "w-full bg-neutral-800/60 border border-neutral-700 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-brand-500 transition-all",
...
function LimitCard({ limitKey, info, tenant, availableKeys }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `rounded-2xl border p-4 transition-all ${hasOverride ? "bg-amber-500/5 border-amber-500/30" : "bg-neutral-900 border-neutral-800 hover:border-line-strong"}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2", children: [
      /* @__PURE__ */ jsx("span", { className: "font-mono text-xs text-ink-muted uppercase tracking-wider", children: limitKey }),
      /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1.5", children: hasOverride ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1 text-2xs font-bold text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded-full uppercase", children: [
      ...
      ] }) : /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1 text-2xs font-bold text-ink-secondary bg-neutral-800 px-2 py-0.5 rounded-full uppercase", children: [
    ...
    !editing ? /* @__PURE__ */ jsxs("div", { className: "flex items-end justify-between", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-white", children: displayValue }),
        hasOverride && /* @__PURE__ */ jsxs("div", { className: "text-xs text-ink-secondary mt-0.5", children: [
          "Plan default: ",
          /* @__PURE__ */ jsx("span", { className: "text-ink-muted", children: info.plan_default === null ? "∞" : String(info.plan_default) })
        ] }),
        info.reason && /* @__PURE__ */ jsx("p", { className: "text-xs text-amber-400/60 mt-1", children: info.reason }),
        info.expires_at && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 text-xs text-ink-secondary mt-1", children: [
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          className: "p-2 text-ink-secondary hover:text-brand-400 hover:bg-interactive-hover rounded-xl transition-all",
          title: "Edit",
      ...
      /* @__PURE__ */ jsx(
        "input",
        {
          ...
          className: "w-full bg-neutral-950 border border-neutral-700 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-brand-500"
        }
      ),
      /* @__PURE__ */ jsx(
        "input",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            type: "submit",
            disabled: processing,
            className: "flex-1 flex items-center justify-center gap-1.5 py-2 bg-brand-600 hover:bg-brand-500 text-white rounded-xl text-xs font-bold transition-all",
            children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: "px-3 py-2 bg-neutral-800 hover:bg-interactive-hover text-neutral-300 rounded-xl text-xs font-bold transition-all",
  ...
  return /* @__PURE__ */ jsxs(PlatformShell, { title: `Store — ${tenant.name}`, mode: "admin", activeMenu: "Tenant Overrides", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
      /* @__PURE__ */ jsxs(
        Link,
        {
          ...
          className: "flex items-center gap-2 text-ink-muted hover:text-neutral-300 transition-colors font-semibold text-sm",
          children: [
      ...
      /* @__PURE__ */ jsx("span", { className: "text-ink-secondary", children: "/" }),
      /* @__PURE__ */ jsx("span", { className: "text-neutral-300 font-bold", children: tenant.name })
    ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "xl:col-span-2 space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 rounded-2xl border border-neutral-800 overflow-hidden", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 px-6 py-4 border-b border-neutral-800", children: [
            /* @__PURE__ */ jsx(Building2, { size: 16, className: "text-brand-400" }),
            /* @__PURE__ */ jsx("h3", { className: "font-bold text-white text-sm uppercase tracking-widest", children: "Store Identity" })
          ] }),
          /* @__PURE__ */ jsxs("form", { onSubmit: saveProfile, className: "px-6 py-2", children: [
            ...
            /* @__PURE__ */ jsx(FieldRow, { label: "Owner", icon: User, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted", children: tenant.owner_email })
            ] }) }),
            /* @__PURE__ */ jsx(FieldRow, { label: "Store ID", icon: Hash, children: /* @__PURE__ */ jsxs("span", { className: "text-sm text-ink-muted font-mono", children: [
              "#",
              tenant.id
            ] }) }),
            /* @__PURE__ */ jsx(FieldRow, { label: "Slug", icon: Tag, children: /* @__PURE__ */ jsx("span", { className: "text-sm text-ink-muted font-mono", children: tenant.slug }) }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mt-4 mb-2 pt-4 border-t border-neutral-800", children: [
              /* @__PURE__ */ jsx(DollarSign, { size: 14, className: "text-emerald-400" }),
              /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-ink-muted uppercase tracking-widest", children: "Billing & Plan" })
            ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mt-4 mb-2 pt-4 border-t border-neutral-800", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-ink-muted uppercase tracking-widest", children: "Locale & Currency" })
            ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mt-4 mb-2 pt-4 border-t border-neutral-800", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-ink-muted uppercase tracking-widest", children: "Feature Flags" })
            ] }),
            [
              ...
              /* @__PURE__ */ jsx("span", { className: `text-xs font-bold ${data[key] ? "text-emerald-400" : "text-ink-secondary"}`, children: data[key] ? "Enabled" : "Disabled" })
            ] }) }, key)),
            /* @__PURE__ */ jsx("div", { className: "pt-5 pb-4 border-t border-neutral-800 mt-4", children: /* @__PURE__ */ jsxs(
              "button",
              {
                type: "submit",
                disabled: processing,
                className: "flex items-center gap-2 px-6 py-3 bg-brand-600 hover:bg-brand-500 disabled:bg-brand-800 text-white rounded-2xl font-bold transition-all shadow-lg text-sm",
                children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 rounded-2xl border border-neutral-800 overflow-hidden", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 px-6 py-4 border-b border-neutral-800", children: [
            ...
            /* @__PURE__ */ jsx("h3", { className: "font-bold text-white text-sm uppercase tracking-widest", children: "Override History" })
          ] }),
          override_history.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "p-12 text-center", children: [
            /* @__PURE__ */ jsx(Info, { size: 32, className: "mx-auto mb-3 text-ink-secondary" }),
            /* @__PURE__ */ jsx("p", { className: "text-ink-secondary font-medium", children: "No overrides applied yet." })
          ] }) : /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { className: "bg-neutral-800/50", children: ["Key", "Value", "Original", "Reason", "Expires", ""].map((h) => /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left text-xs font-bold text-ink-muted uppercase tracking-widest", children: h }, h)) }) }),
            /* @__PURE__ */ jsx("tbody", { children: override_history.map((o, i) => {
              const isExpired = o.expires_at && new Date(o.expires_at) < /* @__PURE__ */ new Date();
              return /* @__PURE__ */ jsxs("tr", { className: `border-t border-neutral-800 ${isExpired ? "opacity-40" : "hover:bg-interactive-hover"}`, children: [
                /* @__PURE__ */ jsx("td", { className: "px-4 py-3 font-mono text-xs text-brand-400", children: o.override_key }),
                /* @__PURE__ */ jsx("td", { className: "px-4 py-3 font-bold text-white", children: o.override_value ?? /* @__PURE__ */ jsx("span", { className: "text-ink-muted", children: "∞" }) }),
                /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-ink-muted", children: o.original_value ?? "—" }),
                /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-ink-muted max-w-[160px] truncate", children: o.reason || "—" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 rounded-2xl border border-neutral-800 p-5", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-xs font-bold text-ink-muted uppercase tracking-widest mb-4", children: "Live Usage" }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-3", children: [
            { label: "Staff", value: tenant.staff_count, icon: Users, color: "text-brand-400" },
          ...
          ].map(({ label, value, icon: Icon, color }) => /* @__PURE__ */ jsxs("div", { className: "bg-neutral-800/60 rounded-2xl p-3 text-center", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "text-2xs font-bold text-ink-muted uppercase", children: label })
          ] }, label)) }),
          /* @__PURE__ */ jsxs("div", { className: "mt-4 pt-4 border-t border-neutral-800 flex flex-wrap gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: `px-3 py-1 rounded-full text-xs font-bold border uppercase ${statusColor[tenant.status] ?? "bg-neutral-800 text-ink-muted border-neutral-700"}`, children: tenant.status }),
            /* @__PURE__ */ jsx("span", { className: "px-3 py-1 rounded-full text-xs font-bold border bg-brand-500/10 text-brand-400 border-brand-500/20 uppercase", children: tenant.plan }),
            /* @__PURE__ */ jsxs("span", { className: "px-3 py-1 rounded-full text-xs font-bold border bg-neutral-800 text-ink-muted border-neutral-700", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-neutral-900 rounded-2xl border border-neutral-800 overflow-hidden", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 px-5 py-4 border-b border-neutral-800", children: [
            /* @__PURE__ */ jsx(Zap, { size: 15, className: "text-amber-400" }),
            /* @__PURE__ */ jsx("h3", { className: "font-bold text-white text-sm uppercase tracking-widest", children: "Plan Limits" }),
            /* @__PURE__ */ jsxs("span", { className: "ml-auto text-xs text-ink-secondary font-semibold", children: [
