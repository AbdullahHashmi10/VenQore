      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3 mb-5 p-3 vq-tool-panel", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted", children: "Copies" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "number",
          ...
          /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-1.5 cursor-pointer", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-secondary font-medium", children: "Barcode" })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex bg-sunken p-1 rounded-xl shrink-0", children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
                type: "button",
                onClick: () => setMode("manual"),
                className: `px-3 py-1.5 rounded-lg text-xs font-bold transition-colors ${mode === "manual" ? "bg-surface text-ink shadow-sm" : "text-ink-secondary hover:text-ink"}`,
                children: [
                  "Grid (",
                  rows.length,
                  ")"
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `px-3 py-1.5 rounded-lg text-xs font-bold transition-colors ${mode === "bulk" ? "bg-surface text-ink shadow-sm" : "text-ink-secondary hover:text-ink"}`,
                children: "Bulk Paste"
              }
            )
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "ml-auto flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "text-1xs text-ink-muted hidden sm:inline", children: "Nothing sent until you download" }),
            /* @__PURE__ */ jsxs(
              "button",
              {
                type: "button",
        ...
        mode === "bulk" ? (
          ...
          /* @__PURE__ */ jsxs("div", { className: "vq-tool-panel vq-tool-panel--pad space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("label", { className: "block text-xs font-bold uppercase tracking-widest text-ink-muted mb-2", children: [
                "Paste CSV Lines (Format: ",
                /* @__PURE__ */ jsx("code", { className: "font-mono text-brand-500", children: "name,price,was_price,sku,badge" }),
                ")"
              ] }),
              /* @__PURE__ */ jsx(
                "textarea",
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted", children: "Lines starting with 'name,price' headers are auto-skipped. Parsing loads the grid below." }),
              /* @__PURE__ */ jsxs(
                "button",
                {
                  type: "button",
          ...
          /* @__PURE__ */ jsxs("div", { className: "vq-paper rounded-2xl overflow-hidden shadow-xl shadow-neutral-900/10 dark:shadow-black/40 border border-line bg-white p-4 sm:p-6", children: [
                ...
                return /* @__PURE__ */ jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-baseline gap-1.5 flex-wrap", children: [
                        onSale && /* @__PURE__ */ jsx(
                          EditableText,
                          {
                            as: "number",
                      ...
                      /* @__PURE__ */ jsx("div", { className: "mt-1.5 flex items-center gap-1 flex-wrap", children: QUICK_BADGES.map((b) => /* @__PURE__ */ jsx(
                        "button",
                        {
                          ...
                          className: `text-4xs font-bold px-1 py-0.5 rounded transition-colors ${row.badge === b ? "bg-red-500 text-white" : "bg-sunken text-ink-muted hover:bg-interactive-hover"}`,
                          children: b
                        },
                        b
                      )) }),
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "text-2xs font-bold uppercase tracking-wide", children: "Add tag" })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsxs("p", { className: "text-1xs text-ink-muted text-center mt-4", children: [
              rows.length,
              " / ",
              maxRows,
        ...
        /* @__PURE__ */ jsx("p", { className: "text-center text-xs text-ink-muted mt-4", children: 'This preview matches your downloaded PDF sheet layout — click anything above to edit it. Print at 100% / "Actual size".' })
      ]
    }
  );
}
