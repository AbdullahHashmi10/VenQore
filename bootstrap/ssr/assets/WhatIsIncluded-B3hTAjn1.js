...
const Feature = ({ label, starter, growth, business }) => /* @__PURE__ */ jsxs("tr", { className: "border-b border-white/5 hover:bg-white/[0.02] transition-colors", children: [
  /* @__PURE__ */ jsx("td", { className: "py-3.5 pr-6 text-sm text-neutral-300", children: label }),
  /* @__PURE__ */ jsx("td", { className: "py-3.5 text-center", children: starter === true ? /* @__PURE__ */ jsx(Check, { size: 15, className: "mx-auto text-emerald-400" }) : starter === false ? /* @__PURE__ */ jsx(X, { size: 15, className: "mx-auto text-ink-secondary" }) : /* @__PURE__ */ jsx("span", { className: "text-xs text-ink-muted", children: starter }) }),
  /* @__PURE__ */ jsx("td", { className: "py-3.5 text-center", children: growth === true ? /* @__PURE__ */ jsx(Check, { size: 15, className: "mx-auto text-brand-400" }) : growth === false ? /* @__PURE__ */ jsx(X, { size: 15, className: "mx-auto text-ink-secondary" }) : /* @__PURE__ */ jsx("span", { className: "text-xs text-neutral-300", children: growth }) }),
  /* @__PURE__ */ jsx("td", { className: "py-3.5 text-center", children: business === true ? /* @__PURE__ */ jsx(Check, { size: 15, className: "mx-auto text-amber-400" }) : business === false ? /* @__PURE__ */ jsx(X, { size: 15, className: "mx-auto text-ink-secondary" }) : /* @__PURE__ */ jsx("span", { className: "text-xs text-neutral-300", children: business }) })
] });
const Section = ({ title, children }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  /* @__PURE__ */ jsx("tr", { className: "bg-white/[0.03]", children: /* @__PURE__ */ jsx("td", { colSpan: 4, className: "py-3 px-0 text-xs font-bold text-ink-muted uppercase tracking-widest pt-6", children: title }) }),
  children
] });
function WhatIsIncluded() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-void-950 text-white font-sans", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 pointer-events-none", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-0 left-1/4 w-96 h-96 bg-brand-900/15 rounded-full blur-[120px]" }),
    ...
    /* @__PURE__ */ jsxs("nav", { className: "relative z-10 flex items-center justify-between gap-3 px-4 sm:px-8 py-5 sm:py-6 border-b border-white/5", children: [
      /* @__PURE__ */ jsxs(Link, { href: "/", className: "flex items-center gap-2 sm:gap-3 min-w-0", children: [
        ...
        /* @__PURE__ */ jsxs("span", { className: "font-bold text-base sm:text-lg text-white truncate", children: [
          "VenQore",
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-14", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-white mb-4", children: "What's Included" }),
        /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-base sm:text-xl max-w-2xl mx-auto", children: "One-time purchase. No hidden fees. Lifetime access to the software. 2 years of hosting on venqore.com FREE (then $9 to $30/mo after 2 years depending on plan tier)." })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "bg-white/5 border border-white/10 rounded-2xl overflow-hidden mb-6", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", style: { WebkitOverflowScrolling: "touch" }, children: /* @__PURE__ */ jsxs("div", { className: "min-w-[640px]", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-4 border-b border-white/10", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-4 sm:p-6 text-center border-l border-white/10", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted uppercase tracking-widest mb-1", children: "1 Code" }),
            /* @__PURE__ */ jsx("p", { className: "font-bold text-white", children: "Starter LTD" }),
            /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-white mt-1", children: "$199" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-1", children: "one-time" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "p-4 sm:p-6 text-center border-l border-brand-500/30 bg-brand-500/5", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-brand-400 uppercase tracking-widest mb-1", children: "2 Codes Stacked" }),
            /* @__PURE__ */ jsx("p", { className: "font-bold text-brand-300", children: "Growth LTD" }),
            /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-white mt-1", children: "$399" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-1", children: "one-time" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "p-4 sm:p-6 text-center border-l border-amber-500/20 bg-amber-500/5", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-white mt-1", children: "$699" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-ink-muted mt-1", children: "one-time" })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "p-4 sm:p-6", children: /* @__PURE__ */ jsx("table", { className: "w-full", children: /* @__PURE__ */ jsxs("tbody", { children: [
          /* @__PURE__ */ jsxs(Section, { title: "Limits", children: [
            /* @__PURE__ */ jsx(Feature, { label: tt("Products (SKUs)"), starter: "1,000", growth: "Unlimited", business: "Unlimited" }),
            /* @__PURE__ */ jsx(Feature, { label: tt("Staff Accounts"), starter: "3", growth: "10", business: "Unlimited" }),
          ...
          /* @__PURE__ */ jsxs(Section, { title: "Inventory", children: [
            /* @__PURE__ */ jsx(Feature, { label: tt("Product Catalog"), starter: true, growth: true, business: true }),
          ...
          /* @__PURE__ */ jsxs(Section, { title: "Sales & Purchasing", children: [
            ...
            /* @__PURE__ */ jsx(Feature, { label: tt("Purchase Orders"), starter: true, growth: true, business: true }),
          ...
          /* @__PURE__ */ jsxs(Section, { title: "Reports", children: [
            ...
            /* @__PURE__ */ jsx(Feature, { label: "Advanced Reports (40 total)", starter: "20", growth: "40+", business: "40+" }),
          ...
          /* @__PURE__ */ jsxs(Section, { title: "Intelligence & Growth", children: [
            ...
            /* @__PURE__ */ jsx(Feature, { label: tt("AI Customer Insights"), starter: false, growth: true, business: true }),
            /* @__PURE__ */ jsx(Feature, { label: "WooCommerce Sync", starter: "Add-on", growth: "Add-on", business: "Add-on" }),
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 mb-14", children: [
        ...
        /* @__PURE__ */ jsx(c.icon, { size: 22, className: "text-brand-400 mb-3" }),
        /* @__PURE__ */ jsx("p", { className: "font-bold text-white mb-1", children: c.title }),
        /* @__PURE__ */ jsx("p", { className: "text-ink-muted text-sm leading-relaxed", children: c.body })
      ] }, i)) }),
      /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-ink-secondary text-xs mt-4 px-4", children: "Already bought on AppSumo? Click above to activate your license." })
      ] })
    ] })
  ] });
}
