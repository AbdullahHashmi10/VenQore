          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between relative z-10 w-full", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                subValue && /* @__PURE__ */ jsx("p", { className: "text-[10px] font-medium text-slate-400", children: subValue })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 relative z-10 grow items-center", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: `text-center ${onLeftClick ? "cursor-pointer hover:scale-105 transition-transform" : ""}`, onClick: onLeftClick, children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] uppercase font-bold text-slate-400 mb-1 tracking-wider", children: leftLabel }),
          ...
          /* @__PURE__ */ jsxs("div", { className: `text-center ${onRightClick ? "cursor-pointer hover:scale-105 transition-transform" : ""}`, onClick: onRightClick, children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] uppercase font-bold text-slate-400 mb-1 tracking-wider", children: rightLabel }),
    ...
    /* @__PURE__ */ jsx("div", { className: "flex-1 w-full relative min-h-[300px]", children: /* @__PURE__ */ jsx("div", { className: "w-full h-[300px] lg:absolute lg:inset-0 lg:h-auto", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", minWidth: 100, minHeight: 100, children: /* @__PURE__ */ jsxs(AreaChart, { data: chartData, margin: { top: 10, right: 10, left: -20, bottom: 0 }, children: [
      /* @__PURE__ */ jsxs("defs", { children: [
        ...
        /* @__PURE__ */ jsxs("linearGradient", { id: "colorProfit", x1: "0", y1: "0", x2: "0", y2: "1", children: [
          ...
          /* @__PURE__ */ jsx("stop", { offset: "95%", stopColor: "#10b981", stopOpacity: 0.05 })
        ] })
      ] }),
      /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3", vertical: false, stroke: isDarkMode ? "#334155" : "#f1f5f9", strokeOpacity: 0.5 }),
      /* @__PURE__ */ jsx(
        XAxis,
        {
          dataKey: "name",
          ...
          content: ({ active, payload, label }) => {
            if (active && payload && payload.length) {
              return /* @__PURE__ */ jsxs("div", { style: {
                ...
                /* @__PURE__ */ jsx("p", { style: { fontSize: "11px", fontWeight: "bold", color: "#94a3b8", marginBottom: "4px" }, children: label }),
                /* @__PURE__ */ jsxs("p", { style: { fontSize: "13px", fontWeight: "bold", color: "#e2e8f0", margin: 0 }, children: [
                  "💰 Sales: ",
                  /* @__PURE__ */ jsx("span", { style: { color: "#6366f1" }, children: formatCurrency$1(payload.find((p) => p.dataKey === "sales")?.value || 0, store || settings) })
                ] }),
                /* @__PURE__ */ jsxs("p", { style: { fontSize: "13px", fontWeight: "bold", color: "#e2e8f0", margin: 0 }, children: [
                  "✨ Gross Profit: ",
                  /* @__PURE__ */ jsx("span", { style: { color: "#10b981" }, children: formatCurrency$1(payload.find((p) => p.dataKey === "profit")?.value || 0, store || settings) })
                ] })
              ] });
            }
            return null;
      ...
      /* @__PURE__ */ jsx(Area, { type: "monotone", dataKey: "profit", stroke: "#10b981", strokeWidth: 3, fillOpacity: 1, fill: "url(#colorProfit)" }),
      /* @__PURE__ */ jsx(Area, { type: "monotone", dataKey: "sales", stroke: "#6366f1", strokeWidth: 3, fillOpacity: 1, fill: "url(#colorSales)" })
    ] }) }) }) })
  ] });
};
...
function PartySearchField({ selectedParty, onSelect, onClear, store, isIn }) {
  ...
  const balanceBadge = () => {
    ...
    if (Math.abs(bal) < 0.01) return /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 text-[10px] font-bold", children: [
      /* @__PURE__ */ jsx(Minus, { size: 10 }),
      " Settled"
    ] });
    const isReceive = dir === "To Receive";
    return /* @__PURE__ */ jsxs("span", { className: `inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold ${isReceive ? "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400" : "bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400"}`, children: [
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "relative", children: [
    ...
    selectedParty && /* @__PURE__ */ jsxs("div", { className: "mt-1.5 flex items-center gap-2 px-1", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
        ...
        selectedParty.type && /* @__PURE__ */ jsx("span", { className: `text-[9px] font-bold uppercase px-1.5 py-0.5 rounded-full ${selectedParty.type === "customer" ? "bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400" : "bg-amber-100 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400"}`, children: selectedParty.type })
      ] }),
      balanceBadge()
    ] }),
      ...
      return /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            ...
            !settled && /* @__PURE__ */ jsxs("span", { className: `text-[10px] font-bold px-1.5 py-0.5 rounded-full shrink-0 ${dir === "To Receive" ? "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400" : "bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400"}`, children: [
              dir,
              ": ",
              formatCurrency(Math.abs(bal), store?.currency_symbol)
            ] }),
            settled && /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold px-1.5 py-0.5 rounded-full shrink-0 bg-slate-100 text-slate-500 dark:bg-slate-700 dark:text-slate-400", children: "Settled" })
          ]
        },
        party.id
      );
  ...
  return /* @__PURE__ */ jsx(
    FormModal,
    {
      ...
      children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("label", { className: "block text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-1.5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("label", { className: "block text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-2", children: [
            "Payment Method ",
            /* @__PURE__ */ jsx("span", { className: "text-red-500", children: "*" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-2", children: METHODS.map((m) => {
            ...
            return /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                className: `flex flex-col items-center gap-1.5 py-2.5 px-2 rounded-xl border-2 transition-all text-[10px] font-bold uppercase ${isSelected ? `${isIn ? "border-emerald-500 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400" : "border-rose-500 bg-rose-50 dark:bg-rose-900/20 text-rose-700 dark:text-rose-400"}` : "border-slate-200 dark:border-slate-700 text-slate-500 hover:border-slate-300 dark:hover:border-slate-600 bg-slate-50 dark:bg-slate-800/40"}`,
                children: [
        ...
        formData.payment_method === "bank" && /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-1.5", children: "Bank Account" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-1.5", children: "Reference No." }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-1.5", children: "Description" }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-1 max-h-64 overflow-y-auto custom-scrollbar", children: actions.map((action, i) => /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-[10px] font-medium text-slate-600 dark:text-slate-300 text-center leading-tight", children: action.label })
        ]
      },
      i
    )) })
  ...
  return /* @__PURE__ */ jsx("div", { className: "absolute inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 w-full max-w-sm rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden", onClick: (e) => e.stopPropagation(), children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "p-4 bg-slate-50 dark:bg-slate-900/50", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-2 max-h-64 overflow-y-auto custom-scrollbar", children: transactions && transactions.length > 0 ? transactions.map((tx, i) => /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center text-sm p-2 bg-white dark:bg-slate-800 rounded-lg border border-slate-100 dark:border-slate-700/50", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400", children: new Date(tx.date).toLocaleString("en-PK", { day: "2-digit", month: "short", year: "numeric", hour: "2-digit", minute: "2-digit" }) })
        ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "p-4 grid grid-cols-4 gap-2", children: [
      /* @__PURE__ */ jsxs("button", { onClick: () => {
        ...
        /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold text-emerald-600 dark:text-emerald-400", children: "Add" })
      ] }),
      /* @__PURE__ */ jsxs("button", { onClick: () => {
        onNavigate("store.funds.index");
        onClose();
        ...
        /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold text-red-600 dark:text-red-400", children: "Remove" })
      ] }),
      /* @__PURE__ */ jsxs("button", { onClick: () => {
        onNavigate("store.funds.index");
        onClose();
        ...
        /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold text-blue-600 dark:text-blue-400", children: "Transfer" })
      ] }),
      /* @__PURE__ */ jsxs("button", { onClick: () => {
        ...
        /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold text-slate-600 dark:text-slate-400", children: "History" })
      ] })
    ] })
  ] }) });
};
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-slate-900 text-white rounded-[2rem] p-6 h-full min-h-full flex flex-col relative overflow-visible shadow-2xl ring-1 ring-white/10", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-20 mb-8", ref: menuRef, children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-2 h-20", children: [
        /* @__PURE__ */ jsxs("button", { onClick: () => router.visit(route("store.sales.invoice.create", { store_slug: store?.slug })), className: "col-span-1 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/50 text-emerald-400 rounded-2xl flex flex-col items-center justify-center gap-1 transition-all active:scale-95 group backdrop-blur-sm", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold tracking-wider", children: "SALE" })
        ] }),
        /* @__PURE__ */ jsxs("button", { onClick: () => router.visit(route("store.purchases.create", { store_slug: store?.slug })), className: "col-span-1 bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/50 text-orange-400 rounded-2xl flex flex-col items-center justify-center gap-1 transition-all active:scale-95 group backdrop-blur-sm", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold tracking-wider", children: "PURCHASE" })
        ] }),
        /* @__PURE__ */ jsxs("button", { onClick: () => setIsMenuOpen(!isMenuOpen), className: `col-span-1 bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-500/50 text-indigo-400 rounded-2xl flex flex-col items-center justify-center gap-1 transition-all active:scale-95 group backdrop-blur-sm ${isMenuOpen ? "bg-indigo-500/20 ring-2 ring-indigo-500/30" : ""}`, children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold tracking-wider", children: "ACTIONS" })
        ] })
      ] }),
      /* @__PURE__ */ jsx(
        ActionMenu,
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 mb-8 flex-1 overflow-y-auto custom-scrollbar content-start space-y-3", children: [
      canViewBalances && /* @__PURE__ */ jsxs("div", { onClick: () => setIsCashModalOpen(true), className: "bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md rounded-2xl p-4 border border-white/10 hover:border-white/20 hover:scale-[1.02] transition-all cursor-pointer group", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-3", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-[9px] text-emerald-200 bg-emerald-500/20 px-2 py-0.5 rounded-full font-bold uppercase", children: "Main" })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h4", { className: "text-2xl font-bold tracking-tight text-white mb-1", children: formatMoney(glBalance) }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-[10px] text-emerald-400", children: [
      ...
      /* @__PURE__ */ jsxs("div", { id: "tour-stock-value", onClick: () => router.visit(route("store.inventory.index", { store_slug: store?.slug })), className: "bg-gradient-to-br from-indigo-500/10 to-purple-500/10 backdrop-blur-md rounded-2xl p-4 border border-indigo-500/20 hover:border-indigo-500/40 hover:scale-[1.02] transition-all cursor-pointer group", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-[10px] text-indigo-400", children: [
      ...
      canViewBalances && (bankAccounts.length > 0 ? /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold text-slate-400 uppercase tracking-wider pl-1", children: "Bank Accounts" }),
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-500", children: "Track your business banking" })
        ] })
      ] }))
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 mt-auto bg-black/20 rounded-2xl p-4 backdrop-blur-sm border border-white/5 max-h-48 flex flex-col", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-3 shrink-0", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-[9px] text-slate-500", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "text-[11px] font-semibold text-white/90", children: tx.type })
                  ] }),
                  /* @__PURE__ */ jsx("span", { className: "text-[9px] text-slate-500 leading-none", children: tx.time })
                ] })
              ] }),
              /* @__PURE__ */ jsx("span", { className: `text-[11px] font-bold ${isIncoming ? "text-emerald-400" : colors.amountColor}`, children: tx.amount })
            ]
          },
          i
        );
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-3", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold text-indigo-400", children: currentStep === "stock_value" ? "Step 1 of 2" : "Step 2 of 2" })
              ] })
            ] }),
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 relative z-10 grow items-center", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-center min-w-0", children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] uppercase font-bold text-slate-400 mb-1 tracking-wider truncate", children: "Current Status" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-center min-w-0", children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] uppercase font-bold text-slate-400 mb-1 tracking-wider truncate", children: formatCurrency$1(parseFloat(netProfit[netProfitPeriod]?.value || 0), store) }),
                /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-x-2 gap-y-0.5 justify-center mt-1 text-[9px] font-medium opacity-80 leading-none", children: [
            ...
            topSellingItems.map((item, i) => /* @__PURE__ */ jsxs("tr", { className: "group/row hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors cursor-default rounded-xl", children: [
              /* @__PURE__ */ jsx("td", { className: "py-3 pl-2 border-b border-slate-50 dark:border-slate-800/50 group-last/row:border-none", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 font-medium", children: item.category })
                ] })
              ] }) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto min-h-0 pr-1 custom-scrollbar space-y-3", children: [
          lowStockItems.map((item) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 bg-red-50 dark:bg-red-900/10 rounded-xl border border-red-100 dark:border-red-900/20", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-red-500 font-bold", children: [
                "Stock: ",
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1 pr-2", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-400 font-medium", children: item.date })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-orange-600 dark:text-orange-400", children: item.total_amount }),
                  /* @__PURE__ */ jsx("p", { className: "text-[9px] uppercase tracking-wider font-bold text-slate-400 leading-none mt-0.5", children: item.status })
                ] })
              ]
            },
            item.id
