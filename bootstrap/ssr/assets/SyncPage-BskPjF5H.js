...
function StatsBar({ stats, filter, onFilter }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1 p-1 bg-sunken rounded-xl", children: tabs.map((tab) => /* @__PURE__ */ jsxs(
    "button",
    {
      onClick: () => onFilter(tab.key),
      className: `flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-all ${filter === tab.key ? "bg-sunken text-ink shadow-sm" : "text-ink-muted hover:text-ink-secondary dark:hover:text-neutral-300"}`,
      children: [
        tab.label,
...
function StagedQueueRow({ entry, connectionId, storeSlug }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4 p-4 border-b border-line last:border-0 hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
      ...
      isFromWoo ? /* @__PURE__ */ jsx("div", { className: "text-sm text-ink-muted italic", children: "— not in VenQore yet —" }) : /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "font-semibold text-sm text-ink", children: venqoreData?.name ?? "Unknown" }),
        /* @__PURE__ */ jsxs("div", { className: "text-xs text-ink-muted font-mono", children: [
          "SKU: ",
          venqoreData?.sku ?? "—"
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
        ...
        !isFromWoo ? /* @__PURE__ */ jsx("div", { className: "text-sm text-ink-muted italic", children: "— not on WooCommerce yet —" }) : /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "font-semibold text-sm text-ink", children: wooProduct?.name ?? "Unknown" }),
          /* @__PURE__ */ jsxs("div", { className: "text-xs text-ink-muted font-mono", children: [
            "SKU: ",
            wooProduct?.sku ?? "—"
          ] }),
          wooProduct?.regular_price && /* @__PURE__ */ jsxs("div", { className: "text-xs text-ink-muted", children: [
            "$",
...
function LinkedProductRow({ link, connectionId, storeSlug }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: `border-b border-line last:border-0 ${isConflict ? "bg-orange-50/30 dark:bg-orange-900/10" : ""}`, children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4 p-4 hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
      /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-lg bg-violet-50 dark:bg-violet-900/20 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsx(Package, { size: 14, className: "text-violet-500" }) }),
      /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
          /* @__PURE__ */ jsx("span", { className: "font-semibold text-sm text-ink truncate", children: product?.name ?? "—" }),
        ...
        product?.price && /* @__PURE__ */ jsxs("div", { className: "text-xs text-ink-muted mt-0.5", children: [
          "Price: ",
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 min-w-0", children: [
        /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsx(ShoppingCart, { size: 14, className: "text-blue-500" }) }),
        /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsx("div", { className: "font-semibold text-sm text-ink truncate", children: product?.name ?? "—" }),
          /* @__PURE__ */ jsxs("div", { className: "text-xs text-ink-muted", children: [
            "Woo ID: #",
            link.woo_product_id
          ] }),
          /* @__PURE__ */ jsx("div", { className: "text-xs text-ink-muted mt-0.5", children: link.last_synced_at ? `Synced: ${new Date(link.last_synced_at).toLocaleDateString()}` : "Not yet synced" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between flex-wrap gap-3", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm text-ink-muted mb-1", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-ink-secondary font-medium", children: connection.name })
          ] }),
          /* @__PURE__ */ jsxs("h1", { className: "text-xl font-bold text-ink flex items-center gap-2", children: [
            "Sync Page",
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-xs text-ink-muted mt-0.5", children: [
            ...
            connection.site_url ? /* @__PURE__ */ jsxs("a", { href: connection.site_url, target: "_blank", rel: "noreferrer", className: "text-violet-500 hover:underline", children: [
              ...
              " ↗"
            ] }) : /* @__PURE__ */ jsx("span", { className: "text-ink-muted italic", children: "Site URL not configured" })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3 flex-wrap", children: [
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: handleSearch, className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("button", { type: "submit", className: "px-3 py-2 bg-sunken text-ink-secondary rounded-xl text-sm hover:bg-interactive-hover transition-colors", children: "Go" })
        ] })
      ] }),
      staged_queue.length > 0 && /* @__PURE__ */ jsxs("div", { className: "bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800 rounded-2xl overflow-hidden", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 border-b border-amber-200 dark:border-amber-800", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxs("span", { className: "font-bold text-ink text-sm", children: [
              "Staging Queue — ",
              staged_queue.length,
              " new product",
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4 px-4 py-2 bg-amber-100/60 dark:bg-amber-900/20 border-b border-amber-200 dark:border-amber-800", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-xs font-bold text-ink-muted uppercase tracking-wider flex items-center gap-1.5", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-surface rounded-2xl border border-line overflow-hidden", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4 px-4 py-3 bg-app border-b border-line", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-xs font-bold text-ink-muted uppercase tracking-wider flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx(Package, { size: 11 }),
            " VenQore Product"
          ] }),
        ...
        links.data?.length === 0 && /* @__PURE__ */ jsxs("div", { className: "text-center py-16 text-ink-muted", children: [
          /* @__PURE__ */ jsx(Package, { size: 28, className: "mx-auto mb-3 opacity-40" }),
          /* @__PURE__ */ jsxs("p", { className: "text-sm", children: [
            tt("No products found"),
        ...
        links.last_page > 1 && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-t border-line", children: [
      ...
      stats.conflicts > 0 && /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 p-4 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-xl", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-ink-secondary text-sm ml-1", children: "Both sides changed since last sync. Choose which version to keep." }),
          /* @__PURE__ */ jsx(
            "button",
            {
