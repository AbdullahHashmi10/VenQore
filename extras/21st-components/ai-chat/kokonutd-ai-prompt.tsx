/**
 * 21st.dev page : NOT VERIFIED - "ai-prompt" (docs title "AI Input Selector") is not in the 21st.dev
 *                 @kokonutd listing under that name; closest listed entries are
 *                 https://21st.dev/@kokonutd/components/animated-ai-input and .../ai-input (unconfirmed match).
 *                 Upstream docs: https://kokonutui.com/docs/components/ai-prompt
 * Author        : Kokonut UI (@kokonutd, kokonut-labs)
 * License       : MIT (Copyright (c) 2025 kokonutUI)
 * Code origin   : UPSTREAM GITHUB github.com/kokonut-labs/kokonutui components/kokonutui/ai-prompt.tsx @ 83eec6d, 2026-08-20
 * Dependencies  : react, lucide-react, motion (motion/react), shadcn Button, DropdownMenu (radix),
 *                 Textarea, cn, hook use-auto-resize-textarea (see kokonutd-ai-input-with-search.tsx),
 *                 icon components @/components/icons/anthropic(+ -dark) (NOT included; replace with own logos).
 */

// ============================================================
// FILE: kokonutui/components/kokonutui/ai-prompt.tsx  (verbatim, unmodified)
// ============================================================
"use client";
