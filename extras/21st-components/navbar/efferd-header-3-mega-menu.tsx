/**
 * 21st.dev page : NOT VERIFIED on 21st.dev (efferd publishes header-1 there; header-3 not checked).
 *                 Upstream demo: https://ui.efferd.com/header#header-3
 * Author        : Efferd UI (GitHub shabanhr / sshahaider)
 * License       : MIT (Copyright (c) 2025 sshahaider)
 * Code origin   : UPSTREAM GITHUB github.com/shabanhr/efferd-ui @ d0748f4, 2025-12-10 registry/blocks/header/3/header.tsx
 *                 Sticky blur header WITH dropdown mega-menu (shadcn NavigationMenu).
 * Dependencies  : react, react-dom, lucide-react, shadcn Button + NavigationMenu (@radix-ui/react-navigation-menu),
 *                 cn; shares logo / menu-toggle-icon / use-scroll with efferd-header-1.tsx (not duplicated here).
 */

// ============================================================
// FILE: efferd/registry/blocks/header/3/header.tsx  (verbatim, unmodified)
// ============================================================
"use client";
import {
  BarChart,
