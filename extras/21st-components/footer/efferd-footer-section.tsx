/**
 * 21st.dev page : https://21st.dev/@efferd/components/footer-section  (page links source to https://ui.efferd.com/footer#footer-2)
 * Author        : Efferd UI (@efferd; GitHub shabanhr / sshahaider)
 * License       : MIT (Copyright (c) 2025 sshahaider) - upstream LICENCE.md. 21st.dev page lists none.
 * 21st.dev deps : motion, lucide-react
 * Code origin   : UPSTREAM GITHUB github.com/shabanhr/efferd-ui @ d0748f4, 2025-12-10 - registry item "footer-2"
 *                 (registry/blocks/footer/2/footer.tsx + components/logo.tsx). Mapped via the 21st page's
 *                 own source link; the 21st.dev export name is Footer from '@/components/ui/footer-section'.
 * Dependencies  : react, lucide-react, motion (motion/react) incl. useReducedMotion
 */

// ============================================================
// FILE: efferd/registry/blocks/footer/2/footer.tsx  (verbatim, unmodified)
// ============================================================
"use client";
import {
  FacebookIcon,
...
// ============================================================
// FILE: efferd/components/logo.tsx  (verbatim, unmodified)
// ============================================================
import type React from "react";
