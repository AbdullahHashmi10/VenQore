Running Reckoner Census on tenant: VENQORE (ID: 116, Slug: scale-store)
Window: 2026-08-01 to 2026-08-31
# Reckoner Baseline Census Report

**Date:** 2026-09-16T12:41:30+00:00
...
|---|---|---|---|---|---|---|---|---|---|
| 1 | `core.revenue` | Qore | stat | Generic Resolver | verified | `ok` | 156,370.00 | 7,700.00 | NO |
| 2 | `core.revenue_trend` | Qore | trend | Generic Resolver | verified | `ok` | 11,200.00 | - | - |
| 3 | `core.net_profit` | Qore | stat | Generic Resolver | verified | `ok` | -42,750.00 | 500.00 | NO |
| 4 | `core.profit_trend` | Qore | trend | Generic Resolver | verified | `ok` | 3,900.00 | - | - |
| 5 | `core.gross_profit` | Qore | stat | Generic Resolver | verified | `ok` | 54,950.00 | 4,500.00 | NO |
| 6 | `core.gross_margin_pct` | Qore | gauge | Generic Resolver | verified | `ok` | 35.10 | 58.44 | NO |
| 7 | `core.net_margin_pct` | Qore | gauge | Generic Resolver | verified | `ok` | -27.30 | 6.49 | NO |
| 8 | `core.cogs` | Qore | stat | Generic Resolver | verified | `ok` | 101,420.00 | 3,200.00 | NO |
| 9 | `core.expenses_total` | Qore | stat | Generic Resolver | verified | `ok` | 97,700.00 | 4,000.00 | NO |
| 10 | `core.expense_ratio` | Qore | gauge | Generic Resolver | verified | `ok` | 62.50 | 51.95 | NO |
| 11 | `core.receivables` | Qore | stat | Generic Resolver | verified | `error` | - | 2,500.00 | NO |
| 12 | `core.receivables_aging` | Qore | breakdown | Generic Resolver | verified | `ok` | 0.00 | - | - |
...
| 22 | `core.transaction_count` | Qore | stat | Generic Resolver | verified | `ok` | 12.00 | - | - |
