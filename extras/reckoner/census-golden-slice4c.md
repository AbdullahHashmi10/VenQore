...
**Date:** 2026-09-16T20:46:47+00:00
...
| **Contract State: Unimplemented** | 78 |
| **Contract State: Implemented Unverified** | 208 |
| **Contract State: Verified** | 63 |
| **Dispatch: Generic Resolver** | 0 |
| **Dispatch: Legacy Source** | 78 |
| **Dispatch: Unmapped** | 0 |
...
|---|---|---|
| `ok` | **221** | Resolver executed and reported success |
| `empty` | **36** | Resolver executed, reported empty/no data |
| `locked` | **14** | Gated by plan, module, or user permissions |
| `unavailable` | **78** | Contract not implemented or data not captured |
