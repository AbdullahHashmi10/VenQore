...
**Date:** 2026-09-16T20:34:20+00:00
...
| **Verified and matching golden** | **53 / 349** |
| **Contract State: Unimplemented** | 174 |
| **Contract State: Implemented Unverified** | 121 |
| **Contract State: Verified** | 54 |
| **Dispatch: Generic Resolver** | 0 |
| **Dispatch: Legacy Source** | 174 |
| **Dispatch: Unmapped** | 0 |
...
|---|---|---|
| `ok` | **151** | Resolver executed and reported success |
| `unavailable` | **174** | Contract not implemented or data not captured |
| `empty` | **17** | Resolver executed, reported empty/no data |
| `locked` | **7** | Gated by plan, module, or user permissions |
...
| 33 | `products.count` | products | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 34 | `products.active_count` | products | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 35 | `products.by_category` | products | breakdown | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 36 | `products.catalogue_value` | products | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 37 | `products.avg_margin` | products | gauge | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 38 | `products.top_margin` | products | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 39 | `products.lowest_margin` | products | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 40 | `products.never_sold` | products | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 41 | `products.missing_cost` | products | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 42 | `products.new_this_period` | products | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
...
| 60 | `suppliers.count` | suppliers | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 61 | `suppliers.active` | suppliers | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 62 | `suppliers.top_suppliers` | suppliers | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 63 | `suppliers.spend_total` | suppliers | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 64 | `suppliers.spend_trend` | suppliers | trend | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 65 | `suppliers.owed_list` | suppliers | list | Legacy Source | unimplemented | `unavailable` | - | 3,000.00 | NO |
| 66 | `suppliers.concentration` | suppliers | gauge | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 67 | `suppliers.new` | suppliers | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
...
| 125 | `park.open_count` | park_recall | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 126 | `park.open_value` | park_recall | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
...
| 129 | `park.oldest` | park_recall | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 130 | `tables.occupied` | table_service | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 131 | `tables.occupancy_rate` | table_service | gauge | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 132 | `tables.kitchen_pending` | table_service | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 133 | `tables.avg_turn_minutes` | table_service | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
...
| 136 | `tables.revenue_per_table` | table_service | breakdown | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 137 | `tables.peak_occupancy` | table_service | heatmap | Legacy Source | unimplemented | `unavailable` | - | - | - |
...
| 144 | `inventory.stock_value_trend` | inventory | trend | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 145 | `inventory.product_count` | inventory | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 146 | `inventory.units_on_hand` | inventory | stat | Legacy Source | unimplemented | `unavailable` | - | 20.00 | NO |
...
| 150 | `inventory.dead_stock_value` | inventory | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 151 | `inventory.turnover_ratio` | inventory | gauge | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 152 | `inventory.days_of_cover` | inventory | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 153 | `inventory.value_by_category` | inventory | breakdown | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 154 | `inventory.top_by_value` | inventory | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
...
| 161 | `transfers.pending_count` | stock_transfers | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 162 | `transfers.pending_value` | stock_transfers | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 163 | `transfers.count` | stock_transfers | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 164 | `transfers.avg_transit_days` | stock_transfers | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 165 | `transfers.discrepancy_count` | stock_transfers | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 166 | `stocktakes.pending_count` | stock_takes | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 167 | `stocktakes.variance_value` | stock_takes | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 168 | `stocktakes.variance_pct` | stock_takes | gauge | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 169 | `stocktakes.last_count_days` | stock_takes | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 170 | `stocktakes.top_variances` | stock_takes | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 171 | `batches.count` | batches_expiry | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 172 | `batches.qty` | batches_expiry | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 173 | `batches.expiring_30` | batches_expiry | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 174 | `batches.expiring_value` | batches_expiry | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 175 | `batches.expired_value` | batches_expiry | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 176 | `batches.expiry_list` | batches_expiry | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 177 | `batches.write_off_trend` | batches_expiry | trend | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 178 | `serials.count` | serials | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 179 | `serials.in_stock` | serials | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 180 | `serials.under_warranty` | serials | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 181 | `serials.warranty_expiring` | serials | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 182 | `serials.returned` | serials | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 183 | `variants.count` | variants | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 184 | `variants.top_variants` | variants | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 185 | `variants.slow_variants` | variants | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 186 | `variants.out_of_stock` | variants | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 187 | `variants.size_colour_mix` | variants | breakdown | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 188 | `barcodes.coverage_pct` | barcodes_labels | gauge | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 189 | `barcodes.missing_count` | barcodes_labels | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
...
| 192 | `barcodes.duplicate_count` | barcodes_labels | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 193 | `uom.count` | units_of_measure | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 194 | `uom.conversion_count` | units_of_measure | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 195 | `uom.sales_by_uom` | units_of_measure | breakdown | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 196 | `uom.missing_conversion` | units_of_measure | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 197 | `uom.bulk_vs_retail` | units_of_measure | breakdown | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 198 | `purchases.spend` | purchases | stat | Legacy Source | unimplemented | `unavailable` | - | 2,500.00 | NO |
| 199 | `purchases.spend_trend` | purchases | trend | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 200 | `purchases.count` | purchases | stat | Legacy Source | unimplemented | `unavailable` | - | 1.00 | NO |
| 201 | `purchases.unpaid_value` | purchases | stat | Legacy Source | unimplemented | `unavailable` | - | 3,000.00 | NO |
| 202 | `purchases.overdue_value` | purchases | stat | Legacy Source | unimplemented | `unavailable` | - | 3,000.00 | NO |
| 203 | `purchases.paid_to_suppliers` | purchases | stat | Legacy Source | unimplemented | `unavailable` | - | 5,000.00 | NO |
| 204 | `purchases.by_supplier` | purchases | breakdown | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 205 | `purchases.by_category` | purchases | breakdown | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 206 | `purchases.price_increases` | purchases | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 207 | `po.open_count` | purchase_orders | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 208 | `po.open_value` | purchase_orders | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 209 | `po.pending_receipt_value` | purchase_orders | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 210 | `po.overdue_count` | purchase_orders | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 211 | `po.avg_lead_days` | purchase_orders | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 212 | `po.fill_rate` | purchase_orders | gauge | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 213 | `purchase_returns.count` | purchase_returns | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 214 | `purchase_returns.value` | purchase_returns | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 215 | `purchase_returns.credit_due` | purchase_returns | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 216 | `purchase_returns.by_supplier` | purchase_returns | breakdown | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 217 | `purchase_returns.rate` | purchase_returns | gauge | Legacy Source | unimplemented | `unavailable` | - | - | - |
...
| 231 | `production.output_qty` | production_runs | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 232 | `production.cost_per_unit` | production_runs | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 233 | `production.yield_pct` | production_runs | gauge | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 234 | `production.wastage_value` | production_runs | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 235 | `production.in_progress` | production_runs | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 236 | `production.output_trend` | production_runs | trend | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 237 | `composite.count` | composite_items | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 238 | `composite.revenue` | composite_items | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 239 | `composite.margin` | composite_items | gauge | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 240 | `composite.top_bundles` | composite_items | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 241 | `composite.component_shortage` | composite_items | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
...
| 307 | `assets.gross_value` | fixed_assets | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
...
| 313 | `loans.outstanding_total` | loans | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 314 | `loans.outstanding_trend` | loans | trend | Legacy Source | unimplemented | `unavailable` | - | - | - |
...
| 318 | `reports.pnl_shortcut` | reports | breakdown | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 319 | `reports.sales_shortcut` | reports | breakdown | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 320 | `reports.stock_shortcut` | reports | breakdown | Legacy Source | unimplemented | `unavailable` | - | - | - |
...
| 324 | `ai.top_insight` | ai_insights | status | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 325 | `ai.alerts_open` | ai_insights | stat | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 326 | `ai.anomalies` | ai_insights | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 327 | `ai.forecast_revenue` | ai_insights | trend | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 328 | `ai.forecast_cash` | ai_insights | trend | Legacy Source | unimplemented | `unavailable` | - | - | - |
| 329 | `ai.reorder_suggestions` | ai_insights | list | Legacy Source | unimplemented | `unavailable` | - | - | - |
