            ...
            <div class="vq-mega" style="min-width:660px">
              <div class="vq-mega__grid" style="grid-template-columns:1fr 1fr 1fr">
                <div class="vq-mega__col">
                  ...
                  <a class="vq-mega__link" href="index.html#assemble"><b>Watch it assemble</b><span>46 modules in, only yours out.</span></a>
                </div>
                <div class="vq-mega__col">
              ...
              <div class="vq-mega__foot">
                <a class="vq-link" href="smartcapture.html">SmartCapture — a photo in, a posted transaction out ${icon('arrow', 15)}</a>
              </div>
            </div>
          </li>
          <li class="vq-nav__item">
...
export const page = ({
  ...
  bare = false, canvas = false, cta = true, demos = false, extraHead = '', extraBody = '',
}) => `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
${demos ? '<script src="assets/demos.js" defer></script>' : ''}
${extraBody}
</body>
</html>
`;
