...
import { lineDiscount, lineGross, computeTotals } from './useInvoiceForm';
...
describe('computeTotals', () => {
    ...
    it('computes subtotal correctly', () => {
        ...
        // 2×100 + 1×200 = 400 + 200 = 600  (freeQty = 0 on both)
