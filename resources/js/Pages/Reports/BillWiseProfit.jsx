                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-surface p-3 rounded-2xl border border-line shadow-sm shrink-0">
                    <div className="flex items-center gap-3 pl-2">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-ink-muted font-medium">Profitability analysis per invoice</p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 min-h-0">
                    ...
                    <div className="lg:col-span-2 bg-surface border border-line rounded-2xl shadow-sm flex flex-col overflow-hidden">
                        <div className="p-4 border-b border-line bg-sunken/50 dark:bg-surface flex justify-between items-center">
                            <h3 className="text-sm font-bold text-ink-secondary dark:text-ink uppercase tracking-wide">Invoice Details</h3>
                                            ...
                                            <td colSpan="5" className="h-64">
                                                <div className="flex flex-col items-center justify-center h-full text-ink-muted gap-3">
                                                    <div className="bg-sunken p-4 rounded-full">
                                                        <Search size={32} className="text-neutral-300 opacity-50" />
                                                    </div>
                                        ...
                                        processedInvoices.map((inv, idx) => {
                                            ...
                                            return (
                                                <tr key={idx} className="group hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors">
                                                    <td className="px-6 py-3 font-bold text-ink-secondary text-sm font-mono border-l-4 border-transparent group-hover:border-brand-500">
                                                        <span className="text-ink-muted mr-1">#</span>{inv.invoice_number}
                                                    </td>
                                                    <td className="px-6 py-3 text-right text-sm text-ink-secondary">
                    ...
                    <div className="flex flex-col gap-4 h-full min-h-0 overflow-hidden">
                        ...
                        <div className="bg-surface border border-line rounded-2xl p-4 shadow-sm flex-1 min-h-0 flex flex-col relative">
                            <h3 className="text-xs font-bold text-ink-muted uppercase mb-2">Margin Health</h3>
                                ...
                                {marginDistribution.length > 0 ? (
                                    <>
                                        ...
                                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none pb-8">
                                            <div className="text-center">
                                                <p className="text-2xs text-ink-muted font-bold uppercase">Avg</p>
                                                <p className="text-xl font-bold text-ink-secondary dark:text-white">{stats.margin.toFixed(1)}%</p>
                                            </div>
                                        </div>
                                    </>
                                ) : (
                                    <div className="h-full flex items-center justify-center text-xs text-ink-muted italic">No margin data</div>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="bg-surface border border-line rounded-2xl p-4 shadow-sm flex-1 min-h-0 flex flex-col">
                            <h3 className="text-xs font-bold text-ink-muted uppercase mb-2">Top Profitable Bills</h3>
