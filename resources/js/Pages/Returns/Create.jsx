    ...
    if (!currentInvoice || (isEditMode && !editState)) {
        return (
            <div className="flex h-screen items-center justify-center bg-slate-50 dark:bg-slate-900">
                <p className="text-slate-500 animate-pulse">Initializing Return...</p>
            </div>
        );
    }
                        ...
                        <div className="fixed top-0 right-0 h-full w-80 bg-white dark:bg-slate-900 shadow-2xl z-[100] animate-in slide-in-from-right duration-300 flex flex-col">
                            ...
                            <div className="p-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50 dark:bg-slate-800/50">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500">Return preferences</p>
                                    </div>
                                </div>
                                <button
                                    onClick={() => setShowSettingsDrawer(false)}
                            ...
                            <div className="flex-1 p-4 space-y-4 overflow-y-auto">
                                ...
                                <div className="space-y-3">
                                    ...
                                    {/* Show/Hide Fields */}
                                    <div className="space-y-3">
                                        <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wide">Return Settings</h4>
                                    ...
                                    {/* Invoice Logic */}
                                    <div className="space-y-3">
                                        <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wide">Return Logic</h4>
