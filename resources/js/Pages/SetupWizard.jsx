...
export default function SetupWizard({ industries, userEmail, initialStoreName, store_slug, store_logo }) {
 ...
 <div className="absolute top-[40%] -right-[10%] w-[40%] h-[40%] bg-brand-600/20 rounded-full blur-[100px]"></div>
 ...
 <div className="w-16 h-16 rounded-2xl bg-gradient-brand flex items-center justify-center text-white shadow-lg ">
 <SelectedIndustryIcon size={32} />
 </div>
 )}
 </>
 ...
 <div className="w-8 h-8 rounded-lg bg-gradient-brand flex items-center justify-center text-white"><SelectedIndustryIcon size={16} /></div>
