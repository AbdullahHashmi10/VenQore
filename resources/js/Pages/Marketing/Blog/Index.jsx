...
const FeaturedPost = ({ post }) => (
    <RevealOnScroll>
        <Link href={`/blog/${post.slug}`} className="block group">
            <div className="relative rounded-[3rem] bg-white/[0.02] border border-white/[0.06] overflow-hidden hover:border-teal-500/20 hover:bg-white/[0.04] transition-all duration-700">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    {/* Image / Visual */}
                    <div className="relative aspect-[16/10] lg:aspect-auto bg-gradient-to-br from-teal-500/10 via-teal-500/5 to-transparent flex items-center justify-center overflow-hidden">
                        ...
                        <div className="relative text-center p-12">
                            ...
                            <BookOpen size={48} className="text-teal-500/20 mx-auto mt-4 group-hover:text-teal-500/30 group-hover:scale-110 transition-all duration-700" />
                        </div>
                    </div>
                    ...
                    <div className="p-8 md:p-12 flex flex-col justify-center">
                        <div className="flex items-center gap-4 mb-6">
                            <span className="px-3 py-1 rounded-full bg-teal-500/10 border border-teal-500/20 text-teal-400 text-[9px] font-black tracking-[0.2em] uppercase">
                                {post.category}
                            </span>
                        ...
                        <h2 className="text-2xl md:text-3xl font-black text-white tracking-tight leading-tight mb-4 font-display group-hover:text-teal-100 transition-colors">
                            {post.title}
                        </h2>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-teal-400 text-xs font-bold uppercase tracking-[0.15em] flex items-center gap-2 group-hover:gap-3 transition-all">
...
const PostCard = ({ post, index }) => (
    <RevealOnScroll delay={index * 0.1}>
        <Link href={`/blog/${post.slug}`} className="block group h-full">
            <div className="rounded-[2rem] bg-white/[0.02] border border-white/[0.06] overflow-hidden hover:border-teal-500/20 hover:bg-white/[0.04] hover:-translate-y-1 transition-all duration-500 h-full flex flex-col">
                {/* Visual Header */}
                <div className="relative aspect-[16/9] bg-gradient-to-br from-teal-500/5 to-teal-500/5 flex items-center justify-center overflow-hidden">
                ...
                <div className="p-7 flex flex-col flex-1">
                    ...
                    <h3 className="text-lg font-black text-white tracking-tight leading-snug mb-3 font-display group-hover:text-teal-100 transition-colors flex-1">
                        {post.title}
                    </h3>
                    ...
                    <div className="flex items-center justify-between mt-auto pt-4 border-t border-white/5">
                        ...
                        <ChevronRight size={14} className="text-slate-700 group-hover:text-teal-400 group-hover:translate-x-1 transition-all" />
                    </div>
                </div>
            </div>
        </Link>
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <RevealOnScroll delay={0.1}>
                        <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-[0.9] mb-6 font-display">
                            ...
                            <span className="bg-gradient-to-r from-teal-400 to-teal-400 bg-clip-text text-transparent vq-text-glow">Matter.</span>
                        </h1>
                    </RevealOnScroll>
                    ...
                    <RevealOnScroll>
                        <div className="bg-white/[0.02] border border-white/[0.06] rounded-[3rem] p-12 md:p-16 relative overflow-hidden">
                            ...
                            <h2 className="text-3xl md:text-4xl font-black text-white tracking-tighter font-display mb-4">
                                Stay <span className="text-teal-400">Sharp.</span>
                            </h2>
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-3 max-w-md mx-auto">
                                <input
                                    ...
                                    className="flex-1 w-full px-6 py-4 bg-white/[0.04] border border-white/[0.08] rounded-full text-white text-sm placeholder:text-slate-700 outline-none focus:border-teal-500/40 transition-colors"
                                />
