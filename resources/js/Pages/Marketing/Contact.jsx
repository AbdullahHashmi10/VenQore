...
const InputField = ({ label, type = 'text', name, placeholder, required, value, onChange, rows }) => {
    ...
    return (
        <div className="relative group">
            <label className={`block text-[10px] font-black uppercase tracking-[0.25em] mb-3 transition-colors duration-300 ${focused ? 'text-teal-400' : 'text-slate-600'}`}>
            ...
            <Tag
                ...
                className={`w-full px-5 py-4 bg-white/[0.03] border rounded-2xl text-white text-sm placeholder:text-slate-700 outline-none transition-all duration-500 resize-none
                    ${focused
                        ? 'border-teal-500/40 bg-teal-500/[0.03] shadow-lg shadow-teal-900/10'
                        : 'border-white/[0.06] hover:border-white/10'
                    }
                `}
            />
            {/* Focus glow line */}
            <div className={`absolute bottom-0 left-6 right-6 h-[1px] bg-gradient-to-r from-transparent via-teal-500 to-transparent transition-opacity duration-500 ${focused ? 'opacity-100' : 'opacity-0'}`} />
        </div>
    );
};
        ...
        >
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <RevealOnScroll delay={0.1}>
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[0.9] mb-8 font-display">
                            ...
                            <span className="bg-gradient-to-r from-teal-400 via-teal-400 to-teal-300 bg-clip-text text-transparent vq-text-glow">Talk.</span>
                        </h1>
                    </RevealOnScroll>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <RevealOnScroll delay={0.1}>
                            <GlassCard padding="p-8">
                                <Clock size={22} className="text-teal-400 mb-4" />
                                ...
                                <div className="flex items-center gap-2 text-[10px] text-teal-400 font-black uppercase tracking-[0.2em]">
                        ...
                        <RevealOnScroll delay={0.2}>
                            <GlassCard padding="p-8">
                                <MapPin size={22} className="text-teal-400 mb-4" />
                        ...
                        <RevealOnScroll delay={0.3}>
                            <GlassCard padding="p-8">
                                <BookOpen size={22} className="text-teal-400 mb-4" />
                                ...
                                <a href="mailto:partners@venqore.com" className="text-teal-400 text-xs font-bold uppercase tracking-[0.2em] flex items-center gap-2 hover:gap-3 transition-all">
            ...
            <section className="py-32 px-6 text-center border-t border-white/5">
                <div className="max-w-3xl mx-auto relative">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-teal-600/8 rounded-full blur-[120px] pointer-events-none" />
                    <RevealOnScroll>
                        <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tighter leading-tight relative z-10 font-display">
                            Not Ready to Talk?<br /><span className="text-teal-400">Try It First.</span>
                        </h2>
