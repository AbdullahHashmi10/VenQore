    ...
    return (
        ...
        >
            ...
            <div className="flex flex-wrap items-center gap-3 mb-5 p-3 rounded-2xl bg-slate-900/[0.02] dark:bg-white/[0.03] border border-slate-900/[0.06] dark:border-white/10">
                ...
                <label className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-white dark:bg-white/[0.04] border border-slate-900/10 dark:border-white/10 text-xs font-bold text-slate-600 dark:text-slate-300 cursor-pointer">
                    <input
                        type="checkbox"
            ...
            {pasteMode ? (
                ...
                <div className="rounded-2xl overflow-hidden shadow-xl shadow-slate-900/10 dark:shadow-black/40 border border-slate-900/10 dark:border-white/10 bg-white p-6 sm:p-10">
                    <div className="flex items-center gap-2 mb-3">
                        <FileText size={16} className="text-indigo-500" />
                        <h3 className="text-sm font-bold text-slate-900">Bulk paste items</h3>
                    </div>
                    <p className="text-xs text-slate-500 mb-3">
                        Paste one item per line, formatted as <code className="bg-slate-100 px-1 rounded">SKU, Name, Category, Unit</code>.
                    </p>
                    <textarea
                        value={csvInput}
                    ...
                    <div className="flex justify-between items-center pt-3">
                        <button type="button" onClick={() => setCsvInput(SAMPLE_CSV)} className="text-xs text-indigo-500 hover:underline font-bold">
                            Load sample data
                        </button>
                        <div className="flex gap-2">
                            <button type="button" onClick={() => setPasteMode(false)} className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-600 text-xs font-bold rounded-lg">
                                Cancel
                            </button>
                            <button type="button" onClick={handleParseCsv} className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-black rounded-lg">
                                Import Items
                            </button>
                        </div>
                    </div>
                ...
                <div className={`mx-auto transition-all ${isLandscape ? 'max-w-none' : 'max-w-3xl'}`}>
                    <div className="rounded-2xl overflow-hidden shadow-xl shadow-slate-900/10 dark:shadow-black/40 border border-slate-900/10 dark:border-white/10 bg-white">
                        <div className="p-6 sm:p-10 text-slate-900 text-sm" style={{ fontFamily: 'Helvetica, Arial, sans-serif' }}>
                            {/* Header */}
                            <div className="flex flex-col sm:flex-row justify-between gap-6 mb-6 pb-4 border-b-2 border-slate-900">
                                <div>
                            ...
                            <div className="text-xs text-slate-500 mb-8">
                                <p className="font-bold text-slate-700 mb-1">Notes / Discrepancy</p>
