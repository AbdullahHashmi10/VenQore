        ...
        <div ref={ref} className={`relative ${className}`}>
            ...
            >
                <span className="flex items-center gap-2 min-w-0">
                    ...
                    {selected?.badge && (
                        <span className="text-[9px] font-black uppercase tracking-wider px-1.5 py-0.5 rounded bg-slate-900/[0.06] dark:bg-white/[0.08] text-slate-500 dark:text-slate-400 shrink-0">
                            {selected.badge}
                        </span>
                    )}
                </span>
                                ...
                                return (
                                    ...
                                    >
                                        <span className="min-w-0">
                                            <span className={`block text-sm truncate ${isSelected ? 'font-bold text-indigo-600 dark:text-indigo-300' : 'text-slate-700 dark:text-slate-300'}`}>
                                                {opt.label}
                                            </span>
                                            {opt.hint && (
                                        ...
                                        <span className="flex items-center gap-2 shrink-0">
                                            {opt.badge && (
                                                <span className="text-[9px] font-black uppercase tracking-wider px-1.5 py-0.5 rounded bg-slate-900/[0.06] dark:bg-white/[0.08] text-slate-500 dark:text-slate-400">
                                                    {opt.badge}
                                                </span>
                                            )}
