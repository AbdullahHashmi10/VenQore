                        ...
                        <div className="grid grid-cols-2 gap-4 pt-2">
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <input type="color" value={foreground} onChange={(e) => setForeground(e.target.value)} className="w-11 h-11 rounded-lg border border-line bg-transparent cursor-pointer" />
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <input type="color" value={background} onChange={(e) => setBackground(e.target.value)} className="w-11 h-11 rounded-lg border border-line bg-transparent cursor-pointer" />
