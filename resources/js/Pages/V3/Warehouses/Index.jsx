            ...
            <table className="w-full border-collapse border border-line">
                <thead className="bg-sunken">
                    <tr>
                        ...
                        <th className="border border-line px-4 py-2 text-left">Address</th>
                        <th className="border border-line px-4 py-2 text-center">Default</th>
                        <th className="border border-line px-4 py-2 text-center">Status</th>
                        <th className="border border-line px-4 py-2 text-center">Actions</th>
                    </tr>
                </thead>
                <tbody>
                    {warehouses.map(w => (
                        <tr key={w.id} className={`hover:bg-interactive-hover ${!w.is_active ? 'opacity-50' : ''}`}>
                            <td className="border border-line px-4 py-2 font-medium">
                                {w.name}
                            </td>
