                    ...
                    <form onSubmit={submit} className="space-y-4 sm:space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="email" value={data.email} onChange={(e) => setData('email', e.target.value)}
                                    className="w-full pl-12 pr-4 py-3 sm:py-4 bg-white/[0.02] border border-white/[0.06] rounded-2xl text-slate-400 text-sm outline-none" readOnly />
                            </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-slate-200 transition-colors">
