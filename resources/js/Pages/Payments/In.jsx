...
function PartySearchField({ value, selectedParty, onSelect, onClear, accentClass, ringClass }) {
    ...
    return (
        <div ref={containerRef} className="relative">
            <div style={{ outline: 'none' }} className={`flex items-center gap-2 w-full px-3 py-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border ${selectedParty ? 'border-emerald-500' : 'border-slate-200 dark:border-slate-700'} transition-all focus-within:border-emerald-500`}>
                ...
                />
                {loading && <div className="w-4 h-4 border-2 border-slate-300 border-t-emerald-500 rounded-full animate-spin shrink-0" />}
        ...
        <OneGlanceLayout title="Payment In">
            ...
            <div className="h-full flex flex-col items-center justify-center overflow-auto py-6 px-4">
                ...
                <div className="w-full max-w-xl relative">
                    ...
                    {/* Glow */}
                    <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500/20 to-teal-500/10 rounded-3xl blur-xl pointer-events-none" />
                    ...
                    <div className="relative bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden">
                        ...
                        <div className="relative bg-gradient-to-r from-emerald-600 to-teal-600 px-6 py-5 overflow-hidden">
                            ...
                            <div className="relative flex items-center gap-4">
                                ...
                                <div>
                                    <h1 className="text-xl font-black text-white tracking-tight">Record Payment In</h1>
