...
export default function CreateRecurringInvoice({ customers = [], warehouses = [], products = [] }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        frequency: 'monthly',
        next_run_date: new Date(Date.now() + 86400000 * 30).toISOString().split('T')[0], // 30 days from now
        items: [],
        status: 'active',
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('store.recurring-invoices.store', { store_slug: store.slug }));
    };

    return (
        <OneGlanceLayout title="Create Recurring Invoice" activeMenu="Sell">
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div>
                    ...
                    <p className="text-slate-500 text-sm mt-1">Configure automated billing parameters and items</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-6">
                        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 shadow-sm space-y-6">
                            ...
                            >
                                <Save size={18} />
                                {processing ? 'Creating...' : 'Save Template'}
                            </button>
                        </div>
                    </div>
                </form>
