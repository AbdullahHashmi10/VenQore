                        ...
                        <div className="p-3 bg-slate-900 space-y-2 shrink-0 border-t border-slate-800">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    {showConvertMenu && (
                                        <div className="absolute bottom-full left-0 right-0 mb-2 bg-slate-800 rounded-xl border border-slate-700 shadow-2xl overflow-hidden z-50 animate-in slide-in-from-bottom-2">
                                            <button
                                                onClick={() => {
