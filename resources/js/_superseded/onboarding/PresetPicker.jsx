...
export default function PresetPicker({ presets = {}, onSelectPreset, onNext, onBack }) {
 ...
 isSelected
 ? 'bg-neutral-900/90 border-brand-500 shadow-2xl ring-1 ring-brand-500'
 ...
 {isSelected ? (
 <span className="px-3 py-1 bg-brand-500 text-white text-2xs font-bold rounded-full uppercase tracking-wider flex items-center gap-1">
 ...
 {item.terms && (
 <div className="text-ink-muted">
 <strong className="text-brand-300 font-mono">Adapts Terms:</strong> {item.terms}
 </div>
 )}
 </div>
 )}
