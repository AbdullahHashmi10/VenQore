...
10. [The terminal](#10-the-terminal) — six POS variants
11. [The document](#11-the-document) — one editor, thirteen types
12. [Edit mode](#12-edit-mode)
...
comfortable 5 lines. That asymmetry is why a short 1280×720 laptop gets one row
and a tall iPad gets two.

### The six terminals

#### Scan — *No catalog. Scanner and keyboard only.*

**For:** Large inventory (>2,000 SKUs), barcode-driven. Pharmacy, hardware, grocery, distribution.

**Why it exists:** A catalog nobody browses is 40% of the screen spent on nothing. Removing it is the single biggest calm-down available.

| Viewport | Layout | Panes | Catalog | Cart |
|---|---|---|---|---|
| `360×560` | bands | cart stacked/minimal · tender stacked/compact | — | 360px = 5 lines |
| `390×745` | bands | cart stacked/minimal · tender stacked/compact | — | 545px = 8 lines |
| `414×790` | bands | cart stacked/relay · tender stacked/full | — | 590px = 9 lines |
| `768×950` | bands | cart stacked/table · tender stacked/full | — | 734px = 11 lines |
| `820×1100` | bands | cart stacked/table · tender stacked/full | — | 884px = 14 lines |
| `1024×695` | columns | cart resident/table @575px · tender resident/full @377px | — | 591px = 9 lines |
| `1180×750` | columns | cart resident/table @627px · tender resident/full @409px | — | 646px = 10 lines |
| `1265×570` | columns | cart resident/table @680px · tender resident/full @441px | — | 466px = 6 lines |
| `1351×620` | columns | cart resident/table @733px · tender resident/full @474px | — | 516px = 7 lines |
| `1425×750` | columns | cart resident/table @779px · tender resident/full @502px | — | 646px = 10 lines |
| `1521×715` | columns | cart resident/table @805px · tender resident/full @538px | — | 611px = 9 lines |
| `1585×780` | columns | cart resident/table @805px · tender resident/full @551px | — | 676px = 10 lines |
| `1905×940` | columns | cart resident/table @805px · tender resident/full @551px | — | 836px = 13 lines |
| `2545×1290` | columns | cart resident/table @805px · tender resident/full @551px | — | 1186px = 19 lines |
| `3425×1290` | columns | cart resident/table @805px · tender resident/full @551px | — | 1186px = 19 lines |

#### Column — *Catalog as a left column.*

**For:** Mixed inventory (200-2,000 SKUs) where staff both scan and browse. General retail.

**Why it exists:** The familiar shape, but ranked: the catalog is a column, not a competitor.

**On small screens:** On a phone the catalog column becomes a picker sheet: open, choose, it closes. That is a step, not a hidden pane -- and it is exactly the Counter variant, which is why Counter exists as a first-class choice rather than as Column's failure mode.

| Viewport | Layout | Panes | Catalog | Cart |
|---|---|---|---|---|
| `360×560` | bands | catalog sheet · cart stacked/minimal · tender stacked/compact | sheet | 360px = 5 lines |
| `390×745` | bands | catalog stacked/grid-2up · cart stacked/minimal · tender stacked/compact | column · 2-up | 369px = 5 lines |
| `414×790` | bands | catalog stacked/grid-2up · cart stacked/relay · tender stacked/full | column · 2-up | 414px = 6 lines |
| `768×950` | bands | catalog stacked/grid-3up · cart stacked/table · tender stacked/full | column · 4-up | 558px = 8 lines |
| `820×1100` | bands | catalog stacked/grid-3up · cart stacked/table · tender stacked/full | column · 4-up | 708px = 11 lines |
| `1024×695` | columns | catalog resident/list @271px · cart resident/relay @379px · tender resident/compact @277px | column · 1-up | 591px = 9 lines |
| `1180×750` | columns | catalog resident/grid-2up @349px · cart resident/relay @383px · tender resident/compact @280px | column · 2-up | 646px = 10 lines |
| `1265×570` | columns | catalog resident/grid-2up @343px · cart resident/relay @376px · tender resident/full @378px | column · 2-up | 466px = 6 lines |
| `1351×620` | columns | catalog resident/grid-2up @372px · cart resident/relay @411px · tender resident/full @400px | column · 2-up | 516px = 7 lines |
| `1425×750` | columns | catalog resident/grid-3up @500px · cart resident/relay @378px · tender resident/full @379px | column · 3-up | 646px = 10 lines |
| `1521×715` | columns | catalog resident/grid-3up @533px · cart resident/relay @416px · tender resident/full @404px | column · 3-up | 611px = 9 lines |
| `1585×780` | columns | catalog resident/grid-3up @486px · cart resident/table @562px · tender resident/full @369px | column · 3-up | 676px = 10 lines |
| `1905×940` | columns | catalog resident/grid-3up @595px · cart resident/table @690px · tender resident/full @452px | column · 3-up | 836px = 13 lines |
| `2545×1290` | columns | catalog resident/grid-3up @1021px · cart resident/table @805px · tender resident/full @551px | column · 6-up | 1186px = 19 lines |
| `3425×1290` | columns | catalog resident/grid-3up @1901px · cart resident/table @805px · tender resident/full @551px | column · 12-up | 1186px = 19 lines |

#### Row — *Catalog as a top row of tiles.*

**For:** Small inventory (<200 SKUs), fast repeat items. Cafe, bakery, kiosk, pharmacy counter.

**Why it exists:** Rehan's observation: on a wide screen a 2-row tile strip is reachable by thumb and leaves the full width for the cart underneath.

| Viewport | Layout | Panes | Catalog | Cart |
|---|---|---|---|---|
| `360×560` | bands | cart stacked/minimal · tender stacked/compact | sheet | 360px = 5 lines |
| `390×745` | bands | cart stacked/minimal · tender stacked/compact | 1 row × 2 tiles | 369px = 5 lines |
| `414×790` | bands | cart stacked/relay · tender stacked/full | 1 row × 2 tiles | 414px = 6 lines |
| `768×950` | bands | cart stacked/table · tender stacked/full | 2 row × 4 tiles | 382px = 5 lines |
| `820×1100` | bands | cart stacked/table · tender stacked/full | 2 row × 5 tiles | 532px = 8 lines |
| `1024×695` | columns | cart resident/table @576px · tender resident/full @376px | 1 row × 6 tiles | 415px = 6 lines |
| `1180×750` | columns | cart resident/table @629px · tender resident/full @407px | 1 row × 6 tiles | 470px = 7 lines |
| `1265×570` | columns | cart resident/table @684px · tender resident/full @437px | 1 row × 7 tiles | 290px = 3 lines |
| `1351×620` | columns | cart resident/table @739px · tender resident/full @468px | 1 row × 8 tiles | 340px = 4 lines |
| `1425×750` | columns | cart resident/table @786px · tender resident/full @495px | 1 row × 8 tiles | 470px = 7 lines |
| `1521×715` | columns | cart resident/table @805px · tender resident/full @529px | 1 row × 9 tiles | 435px = 6 lines |
| `1585×780` | columns | cart resident/table @805px · tender resident/full @551px | 1 row × 9 tiles | 500px = 7 lines |
| `1905×940` | columns | cart resident/table @805px · tender resident/full @551px | 2 row × 11 tiles | 484px = 7 lines |
| `2545×1290` | columns | cart resident/table @805px · tender resident/full @551px | 2 row × 15 tiles | 834px = 13 lines |
| `3425×1290` | columns | cart resident/table @805px · tender resident/full @551px | 2 row × 21 tiles | 834px = 13 lines |

#### Grid — *Catalog dominant, cart as a rail.*

**For:** Visual products, walk-up counters, staff who point rather than type. Cafe, QSR, boutique.

**Why it exists:** When the product IS the interface, the cart only needs to confirm.

**On small screens:** The catalog is the interface, the cart rail confirms, and settling is a discrete step that takes the whole surface. Below tablet the catalog becomes a picker sheet.

| Viewport | Layout | Panes | Catalog | Cart |
|---|---|---|---|---|
| `360×560` | bands | catalog stacked/grid-2up · cart stacked/minimal · tender sheet | dominant · 2-up | 296px = 3 lines |
| `390×745` | bands | catalog stacked/grid-2up · cart stacked/minimal · tender sheet | dominant · 2-up | 481px = 7 lines |
| `414×790` | bands | catalog stacked/grid-2up · cart stacked/relay · tender sheet | dominant · 2-up | 526px = 8 lines |
| `768×950` | bands | catalog stacked/grid-3up · cart stacked/table · tender sheet | dominant · 4-up | 670px = 10 lines |
| `820×1100` | bands | catalog stacked/grid-3up · cart stacked/table · tender sheet | dominant · 4-up | 820px = 13 lines |
| `1024×695` | columns | catalog resident/grid-2up @366px · cart resident/table @586px · tender sheet | dominant · 2-up | 591px = 9 lines |
| `1180×750` | columns | catalog resident/grid-2up @414px · cart resident/table @622px · tender sheet | dominant · 2-up | 646px = 10 lines |
| `1265×570` | columns | catalog resident/grid-3up @529px · cart resident/table @592px · tender sheet | dominant · 3-up | 466px = 6 lines |
| `1351×620` | columns | catalog resident/grid-3up @579px · cart resident/table @628px · tender sheet | dominant · 3-up | 516px = 7 lines |
| `1425×750` | columns | catalog resident/grid-3up @622px · cart resident/table @659px · tender sheet | dominant · 3-up | 646px = 10 lines |
| `1521×715` | columns | catalog resident/grid-3up @678px · cart resident/table @699px · tender sheet | dominant · 4-up | 611px = 9 lines |
| `1585×780` | columns | catalog resident/grid-3up @715px · cart resident/table @726px · tender sheet | dominant · 4-up | 676px = 10 lines |
| `1905×940` | columns | catalog resident/grid-3up @956px · cart resident/table @805px · tender sheet | dominant · 6-up | 836px = 13 lines |
| `2545×1290` | columns | catalog resident/grid-3up @1596px · cart resident/table @805px · tender sheet | dominant · 10-up | 1186px = 19 lines |
| `3425×1290` | columns | catalog resident/grid-3up @2476px · cart resident/table @805px · tender sheet | dominant · 15-up | 1186px = 19 lines |

#### Counter — *One column. Cart first.*

**For:** Phone and small tablet, market stalls, delivery riders, single-hand use.

**Why it exists:** Below 600px nothing else survives; making it a first-class variant means it is designed, not degraded.

**On small screens:** one column, one thing at a time. Settling takes the surface.

| Viewport | Layout | Panes | Catalog | Cart |
|---|---|---|---|---|
| `360×560` | bands | cart stacked/minimal · tender stacked/compact | sheet | 360px = 5 lines |
| `390×745` | bands | cart stacked/minimal · tender stacked/compact | sheet | 545px = 8 lines |
| `414×790` | bands | cart stacked/relay · tender stacked/full | sheet | 590px = 9 lines |
| `768×950` | bands | cart stacked/table · tender stacked/full | sheet | 734px = 11 lines |
| `820×1100` | bands | cart stacked/table · tender stacked/full | sheet | 884px = 14 lines |
| `1024×695` | bands | cart stacked/table · tender stacked/full | sheet | 479px = 7 lines |
| `1180×750` | bands | cart stacked/table · tender stacked/full | sheet | 534px = 8 lines |
| `1265×570` | bands | cart stacked/table · tender stacked/full | sheet | 354px = 4 lines |
| `1351×620` | bands | cart stacked/table · tender stacked/full | sheet | 404px = 5 lines |
| `1425×750` | bands | cart stacked/table · tender stacked/full | sheet | 534px = 8 lines |
| `1521×715` | bands | cart stacked/table · tender stacked/full | sheet | 499px = 7 lines |
| `1585×780` | bands | cart stacked/table · tender stacked/full | sheet | 564px = 8 lines |
| `1905×940` | bands | cart stacked/table · tender stacked/full | sheet | 724px = 11 lines |
| `2545×1290` | bands | cart stacked/table · tender stacked/full | sheet | 1074px = 17 lines |
| `3425×1290` | bands | cart stacked/table · tender stacked/full | sheet | 1074px = 17 lines |

#### Table — *Floor plan first, then order.*

**For:** Restaurants, cafes with table service, salons, any seat/slot business.

**Why it exists:** The unit of work is the table, not the sale. Sale is a property of a table.

**On small screens:** pick a table -> take the order -> settle. On a phone the floor plan is the screen you come FROM, not a pane you squeeze in beside the order.

| Viewport | Layout | Panes | Catalog | Cart |
|---|---|---|---|---|
| `360×560` | bands | floor route · cart stacked/minimal · tender stacked/compact | sheet | 360px = 5 lines |
| `390×745` | bands | floor stacked/list · cart stacked/minimal · tender stacked/compact | sheet | 369px = 5 lines |
| `414×790` | bands | floor stacked/list · cart stacked/relay · tender stacked/full | sheet | 414px = 6 lines |
| `768×950` | bands | floor stacked/map · cart stacked/table · tender stacked/full | 1 row × 4 tiles | 382px = 5 lines |
| `820×1100` | bands | floor stacked/map · cart stacked/table · tender stacked/full | 2 row × 5 tiles | 356px = 5 lines |
| `1024×695` | columns | floor resident/list @269px · cart resident/relay @381px · tender resident/compact @277px | 1 row × 6 tiles | 415px = 6 lines |
| `1180×750` | columns | floor resident/list @264px · cart resident/relay @373px · tender resident/full @375px | 1 row × 6 tiles | 470px = 7 lines |
| `1265×570` | columns | floor resident/list @289px · cart resident/relay @410px · tender resident/full @397px | 1 row × 7 tiles | 290px = 3 lines |
| `1351×620` | columns | floor resident/list @255px · cart resident/table @560px · tender resident/full @368px | 1 row × 8 tiles | 340px = 4 lines |
| `1425×750` | columns | floor resident/list @277px · cart resident/table @593px · tender resident/full @387px | 1 row × 8 tiles | 470px = 7 lines |
| `1521×715` | columns | floor resident/list @306px · cart resident/table @635px · tender resident/full @412px | 1 row × 9 tiles | 435px = 6 lines |
| `1585×780` | columns | floor resident/map @486px · cart resident/table @562px · tender resident/full @369px | 1 row × 9 tiles | 500px = 7 lines |
| `1905×940` | columns | floor resident/map @582px · cart resident/table @703px · tender resident/full @452px | 2 row × 11 tiles | 484px = 7 lines |
| `2545×1290` | columns | floor resident/map @1021px · cart resident/table @805px · tender resident/full @551px | 2 row × 15 tiles | 834px = 13 lines |
| `3425×1290` | columns | floor resident/map @1901px · cart resident/table @805px · tender resident/full @551px | 2 row × 21 tiles | 834px = 13 lines |
...
- JS engine vs. the independent Python solver: **22,731 checks, 0 disagreements**
  across every POS variant × viewport, every document width, every nav row, every
  category × breakpoint, and a continuous 320–3840 sweep of all six categories.
