        ...
        <div className="min-h-screen bg-void-950 text-white font-sans flex items-center justify-center p-8">
            ...
            <div className="fixed inset-0 pointer-events-none">
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-[500px] h-[500px] bg-sunken rounded-full blur-[120px]" />
                </div>
            </div>

            <div className="relative z-10 max-w-lg w-full text-center">
                <div className="w-20 h-20 mx-auto rounded-xl bg-white/5 border border-white/10 flex items-center justify-center mb-8">
                    <Icon size={32} className="text-ink-muted" />
                </div>

                <h1 className="text-2xl font-bold mb-3">{copy.title}</h1>
                <p className="text-ink-muted text-base leading-relaxed mb-8">{copy.body}</p>
