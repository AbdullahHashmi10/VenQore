...
use App\Queries\PartyBalanceQuery as LedgerService;
...
class FinancialCoreVerificationTest extends VenQoreTestCase implements RequiresGoldenCompany
{
    ...
    private function assertMoney(float $expected, float $actual, string $label): void
    {
        ClaimLogger::log(new VerificationClaim(
            ...
            actualValue: $actual,
            metric: $label,
            surface: 'FinancialCoreVerificationTest'
        ));
    ...
    private function assertBalanceSheetIsBalanced(array $bs, string $context = ''): void
    {
        ...
        ClaimLogger::log(new VerificationClaim(
            expectedValue: $bs['total_assets'],
            actualValue: $liabPlusEquity,
            metric: 'Balance Sheet Balanced' . ($context ? " ({$context})" : ''),
            surface: 'FinancialCoreVerificationTest'
        ));
