...
class Phase5TruthAndTrustTest extends VenQoreTestCase
{
    ...
    public function it_verifies_pricing_tech_specs_contain_no_false_claims()
    {
        ...
        // 2026-09-10: the pricing page was rebuilt (V6 → Inertia) and no longer
        // carries the SmartCapture tech-spec table these three phrases came from.
        // The guard that matters stays: none of the false claims above may return,
        // and the SmartCapture allowance the page does state is still present.
        $this->assertStringContainsString('SmartCapture', $pricingFile);
    }
