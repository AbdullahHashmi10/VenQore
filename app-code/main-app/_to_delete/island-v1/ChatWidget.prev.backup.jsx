...
export default function ChatWidget() {
 ...
 <div className="absolute bottom-0 left-0 w-64 h-64 bg-brand-500/5 rounded-full blur-[80px] pointer-events-none" />
 ...
 <div className="absolute inset-0 bg-gradient-brand opacity-0 group-hover:opacity-100 transition-opacity duration-slow" />
 <div className="absolute inset-0 bg-[url('/images/noise.svg')] opacity-15 pointer-events-none" />
