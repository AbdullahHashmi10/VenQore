...
export default function LandingPage() {
    ...
    const archLayers = [
        ...
        { label: 'Intelligence', desc: 'Three AI models: Customer Return Predictor, Stock Depletion Forecaster, and Churn Risk Detector — plus a floating AI assistant that answers ledger questions in plain English.', icon: Cpu },
        { label: 'Reporting', desc: '40+ verified reports from a single source of truth. P&L, Balance Sheet, Cash Flow — every number traces to an entry.', icon: BarChart3 },
    ];
                ...
                <section id="features" className="py-32 px-6">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                            ...
                            <BentoCard delay={0.24} icon={BarChart3} title="40+ Master Reports" body="P&L, Balance Sheet, Aged Receivables, Stock Valuation — all from the same verified ledger. Not approximations." color="pink" />
                            <BentoCard delay={0.30} icon={Globe} title="Multi-Channel Commerce" body="WooCommerce syncs in real time. VenSynQ is expanding to Amazon, TikTok Shop, and eBay — one dashboard, zero double-selling." color="violet" />
                        </div>
                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        <Reveal delay={0.1}>
                            <div>
                                ...
                                <FaqItem question="Can I sync VenQore with my online store?" answer="Yes. WooCommerce orders sync in real time and deduct inventory automatically. VenSynQ is expanding that same sync engine to Amazon, TikTok Shop, and eBay, with Just-in-Time supplier purchase orders for dropshippers." />
                                <FaqItem question="Can I try it before I sign up?" answer="Yes. Launch a fully pre-populated, interactive demo store with a single click, right from this page — scan items, run reports, test checkout. No account required." />
