...
return [
    ...
    */
    ...
    'services' => [
        ...
        'routes'       => [
            ...
            'store.service-jobs.quick-book',
            'store.service-jobs.show',
            'store.service-jobs.status',
            'store.service-jobs.assign',
            'store.service-jobs.unassign',
            'store.service-jobs.update-schedule',
            'store.service-jobs.checkout-tool',
            'store.service-jobs.return-tool',
            'store.service-jobs.convert-invoice',
            'store.tools.index',
            'store.tools.store',
            'store.tools.update',
            'store.tools.maintenance',
            'store.tools.checkout',
            'store.tools.checkin',
            'store.tools.destroy',
            'api.work-orders.*',
        ],
        'pages'        => [
            'Services/ServiceJobs.jsx',
            'Services/CreateServiceJob.jsx',
            'Services/ServiceJobDetail.jsx',
            'Services/ServiceCalendar.jsx',
            'Services/Tools.jsx',
        ],
        'permissions'  => ['sales.create', 'sales.view'],
        'cards'        => [],
        'terms'        => ['service', 'job', 'technician', 'contract'],
        'nav'          => [['route' => 'store.service-jobs.index', 'term' => 'job', 'icon' => 'Wrench', 'order' => 47]],
        'aliases'      => ['services', 'jobs', 'work', 'labour', 'labor', 'repair', 'appointment', 'job card', 'consulting', 'kaam', 'mazdoori', 'servcies'],
        'billing'      => 'included',
        'legacy_gate'  => null,
        'status'       => 'live',
        'verify'       => [
            'Web UI: ServiceJobController (index/create/store/show/updateStatus/convertInvoice), ToolController (index/store/update/maintenance/checkout/checkin/destroy) and pages (Services/ServiceJobs, Services/CreateServiceJob, Services/ServiceJobDetail, Services/ServiceCalendar, Services/Tools) built on ServiceEngine.',
        ],
        'features'     => [],
        ...
        'owns_data'    => ['service_jobs', 'job_assignments', 'tools', 'job_tools', 'service_tools'],
        'history_probe' => ['sales'],
    ],
    ...
    'suppliers' => [
        ...
        'routes'       => ['store.suppliers.*', 'store.v3.suppliers.*', 'api.sync.suppliers'],
        'pages'        => ['Suppliers/'],
    ...
    */
    ...
    'pos' => [
        ...
        'routes'       => [
            ...
            'store.sales.approvers',
            'store.api.custom-charges',
            'api.pos.*',
            'api.sync.orders.batch',
        ],
        'pages'        => ['Pos.jsx'],
    ...
    'sales_returns' => [
        ...
        'routes'       => [
            ...
            'store.sales.return',
            'store.sales.cancel',
            'store.api.sales.returnable',
            'store.api.sales.returnable.show',
        ],
        'pages'        => ['Returns/'],
        'permissions'  => ['sales.returns', 'pos.refund', 'sales.void'],
        'cards'        => [],
        'terms'        => ['return'],
        'nav'          => [['route' => 'store.returns-history.index', 'term' => 'return', 'icon' => 'RefreshCcw', 'order' => 40]],
    ...
    */
    ...
    'purchases' => [
        ...
        'routes'       => ['store.purchases.*', 'store.v3.purchases.*', 'store.api.purchases.for-party'],
        'pages'        => ['V3/Purchases'],
    ...
    'purchase_orders' => [
        ...
        'routes'       => ['store.purchase-orders.*', 'store.purchases.receive.*'],
    ...
    'purchase_returns' => [
        ...
        'routes'       => ['store.debit-notes.*', 'store.v3.purchases.return.*'],
        'pages'        => ['DebitNotes/'],
    ...
    */
    ...
    'bank_accounts' => [
        ...
        'routes'       => ['store.bank-accounts.*', 'store.v3.bank-transfers.*', 'store.api.bank-accounts'],
        'pages'        => ['BankAccounts/'],
