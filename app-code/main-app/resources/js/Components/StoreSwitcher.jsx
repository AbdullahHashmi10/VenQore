...
export default function StoreSwitcher() {
 ...
 {/* Store avatar */}
 <div className="w-6 h-6 rounded-lg bg-gradient-brand flex items-center justify-center text-2xs font-bold text-white shrink-0 shadow-sm leading-none">
