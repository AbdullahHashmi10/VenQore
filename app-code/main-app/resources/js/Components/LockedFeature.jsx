            ...
            <div className="relative border border-amber-200 dark:border-amber-900/50 bg-amber-50/50 dark:bg-amber-950/20 rounded-xl p-5 text-center">
                <div className="flex flex-col items-center justify-center space-y-3">
                    ...
                    <button
                        ...
                        className="inline-flex items-center px-4 py-2 text-xs font-semibold rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 transition shadow-sm"
                    >
                    ...
                    <Modal show={showComingSoon} onClose={() => setShowComingSoon(false)} maxWidth="sm">
                        <div className="relative overflow-hidden bg-slate-900 border border-slate-700 rounded-lg shadow-2xl">
                            ...
                            <div className="p-8 text-center relative z-10">
                                <div className="w-16 h-16 bg-gradient-to-br from-amber-400 to-orange-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-amber-900/20 rotate-3 transform hover:rotate-6 transition-transform">
