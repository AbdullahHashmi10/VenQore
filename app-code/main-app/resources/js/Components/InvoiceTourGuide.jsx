...
export default function InvoiceTourGuide({ store }) {
    ...
    const getTargetId = (step) => {
        if (isCustomerCreationPath) {
            switch (step) {
                case 0: return 'tour-invoice-customer';
                ...
                case 6: return 'tour-invoice-product';
                case 7: return 'tour-invoice-paid';
                case 8: return 'tour-invoice-complete';
                case 9: return 'tour-new-transaction';
                default: return null;
            }
        } else {
            switch (step) {
                case 0: return 'tour-invoice-customer';
                case 1: return 'tour-invoice-product';
                case 2: return 'tour-invoice-paid';
                case 3: return 'tour-invoice-complete';
                case 4: return 'tour-new-transaction';
                default: return null;
            }
        }
    };
                    ...
                    <div className="relative flex flex-col w-full bg-neutral-900/90 dark:bg-app border border-brand-500/20 rounded-2xl shadow-[0_20px_50px_rgba(99,102,241,0.15)] overflow-hidden">
                        ...
                        <div className="p-8 flex flex-col items-center text-center relative z-10">
                            ...
                            <p className="text-ink-muted text-sm font-semibold mb-2">
                                Your B2B sale invoice has been successfully created!
                            </p>
                            ...
                            <p className="text-neutral-300 text-sm leading-relaxed max-w-sm mb-6">
                                ...
                                {isPosDone 
                                    ...
                                    : " Let's check out our fast-speed Retail POS Register next, or proceed to record expenses!"}
                            </p>
                ...
                <div className="space-y-4">
                    {isCustomerCreationPath ? (
                        <>
                            ...
                            {currentStep === 8 && (
                                <p className="text-xs text-neutral-300 leading-relaxed font-medium">
                                    Click <span className="text-white font-bold">Complete Sale</span> to generate the B2B invoice.
                                </p>
                            )}
                            {currentStep === 9 && (
                                <p className="text-xs text-neutral-300 leading-relaxed font-medium">
                        ...
                        <>
                            ...
                            {currentStep === 3 && (
                                <p className="text-xs text-neutral-300 leading-relaxed font-medium">
                                    Click <span className="text-white font-bold">Complete Sale</span> to generate the B2B invoice and update stock!
                                </p>
                            )}
                            {currentStep === 4 && (
                                <p className="text-xs text-neutral-300 leading-relaxed font-medium">
                    ...
                    <div className="flex gap-2 justify-between items-center">
                        ...
                        {currentStep < (isCustomerCreationPath ? 9 : 4) && (
                            <button
                                onClick={() => setCurrentStep(currentStep + 1)}
