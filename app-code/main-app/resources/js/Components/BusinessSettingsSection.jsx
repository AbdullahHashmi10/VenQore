    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-2 duration-slow">
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="col-span-12 xl:col-span-8 p-6 bg-surface rounded-xl border border-line shadow-sm">
                    <div className="flex items-center gap-3 mb-6">
                        <div className="p-2 bg-brand-50 dark:bg-brand-900/20 rounded-lg text-brand-600">
                            <Building2 size={18} />
                        </div>
                        <h3 className="font-bold text-ink">Business Identity</h3>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-1.5 group/input">
                            ...
                            <div className="relative">
                                ...
                                />
                                <Building2 className="absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-muted" size={16} />
                            </div>
                        </div>
                        <div className="space-y-1.5 group/input">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="Tax ID"
                                />
                                <Hash className="absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-muted" size={16} />
                            </div>
                        </div>
                        <div className="space-y-1.5 group/input">
                            ...
                            <div className="relative">
                                ...
                                />
                                <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-muted" size={16} />
                            </div>
                        </div>
                        <div className="space-y-1.5 group/input">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="space-y-5">
                            <div className="space-y-2">
                                <label className="text-2xs font-bold uppercase tracking-wider text-ink-muted">Currency</label>
                                <div className="relative">
                                    <select
                                        value={data.currency}
                                        onChange={(e) => {
                            ...
                            <div className="space-y-2">
                                <label className="text-2xs font-bold uppercase tracking-wider text-ink-muted">Currency Symbol</label>
                                <div className="relative">
                                    <input
                                        type="text"
                            ...
                            <div className="space-y-2">
                                <label className="text-2xs font-bold uppercase tracking-wider text-ink-muted">Timezone</label>
                                <div className="relative">
                                    <select
                                        value={data.timezone}
                ...
                <div className="col-span-12 p-6 bg-surface rounded-xl border border-line shadow-sm relative group hover:border-brand-500/30 transition-all">
