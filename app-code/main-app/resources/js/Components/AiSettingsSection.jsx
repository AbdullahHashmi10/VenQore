...
export default function AiSettingsSection({ data, setData, handleVerifyKey, verifyingKey, verificationResult }) {
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-slow">
            {/* Compact Banner */}
            <div className="p-6 bg-gradient-to-br from-brand-900 via-brand-800 to-purple-900 rounded-xl shadow-xl relative overflow-hidden group">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    onChange={e => setData('openai_api_key', e.target.value)}
                                    className="w-full pl-4 pr-24 py-3 bg-white dark:bg-black/20 border border-line rounded-xl text-sm font-mono focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 outline-none transition-all shadow-sm"
                                    placeholder="sk-proj-..."
                                    autoComplete="off"
                                />
                                <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-2">
