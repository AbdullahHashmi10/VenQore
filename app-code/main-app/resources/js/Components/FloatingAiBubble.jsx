...
export default function FloatingAiBubble({
 ...
 <div
 onClick={handleClick}
 className={`relative group w-16 h-16 rounded-full bg-gradient-brand shadow-2xl flex items-center justify-center transition-transform ${isDragging ? 'scale-110' : ''}`}
 >
 {/* Animated ring */}
