 ...
 *
 * ── Local addition to the design-system source ──────────────────────────────
 *
 * The original took a closed prop list and dropped everything else, so `name`,
 * `required`, `autoComplete`, `maxLength` and every other real form attribute
 * silently vanished — fine for a component gallery, fatal for a login form. It
 * also could not be focused programmatically.
 *
 * So: a forwarded ref, and `...rest` spread onto the inner <input> rather than
 * the wrapper. Both additive; nothing about the styling moved.
 */
