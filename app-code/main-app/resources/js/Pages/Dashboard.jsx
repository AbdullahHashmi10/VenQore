    ...
    return (
        <OneGlanceLayout activeMenu="Dashboard">
                ...
                <div className="lg:hidden">
                    ...
                    >
                        <button
                            ...
                            className={`absolute left-[-24px] top-1/2 -translate-y-1/2 z-modal lg:hidden w-6 h-32 flex items-center justify-center text-slate-400 dark:text-slate-500 hover:text-indigo-500 transition-colors pointer-events-auto ${!mobileRightPanelOpen ? 'animate-nudge-left' : ''}`}
            ...
            <div className="w-full max-w-full py-2 px-1 sm:px-2">
                <div className="grid grid-cols-12 gap-5 sm:gap-6 w-full animate-in fade-in duration-500">
                    ...
                    <div className={`col-span-12 ${showRightPanel ? 'xl:col-span-9' : 'col-span-12'} flex flex-col gap-6 min-w-0`}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-6 gap-4 sm:gap-4.5 w-full">
                            ...
                            {canSales && (
                                <div
                                    ...
                                    className="bg-white dark:bg-slate-900 rounded-[20px] p-4 sm:p-4.5 border border-slate-100 dark:border-slate-800 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none hover:-translate-y-0.5 hover:shadow-md transition-all duration-300 cursor-pointer flex flex-col justify-between relative overflow-hidden group min-h-[148px]"
                                >
                                    <div className="absolute -right-4 -top-4 w-16 h-16 bg-emerald-500/10 rounded-full blur-xl group-hover:scale-150 transition-transform duration-500 pointer-events-none" />
                                    ...
                                    <div className="flex items-center justify-between gap-2 relative z-10">
                                        <div className="flex items-center gap-2 min-w-0">
                                            ...
                                            <h3 className="font-bold text-slate-500 dark:text-slate-400 text-3xs uppercase tracking-wider truncate">Revenue</h3>
                                        </div>
                                    ...
                                    <div className="mt-2.5 relative z-10 min-w-0">
                                        <h2 className="text-lg sm:text-xl font-extrabold text-slate-800 dark:text-white tracking-tight truncate leading-tight">
                            ...
                            {canSales && (
                                <div
                                    ...
                                    className="bg-white dark:bg-slate-900 rounded-[20px] p-4 sm:p-4.5 border border-slate-100 dark:border-slate-800 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none hover:-translate-y-0.5 hover:shadow-md transition-all duration-300 cursor-pointer flex flex-col justify-between relative overflow-hidden group min-h-[148px]"
                                >
                                    <div className="absolute -right-4 -top-4 w-16 h-16 bg-violet-500/10 rounded-full blur-xl group-hover:scale-150 transition-transform duration-500 pointer-events-none" />
                                    
                                    <div className="flex items-center justify-between gap-2 relative z-10">
                                        <div className="flex items-center gap-2 min-w-0">
                                            <div className="p-1.5 rounded-xl bg-violet-50 dark:bg-violet-500/10 text-violet-600 dark:text-violet-400 border border-violet-500/20 shrink-0">
                                                <Percent size={15} />
                                            </div>
                                            <h3 className="font-bold text-slate-500 dark:text-slate-400 text-3xs uppercase tracking-wider truncate">Gross Profit</h3>
                                        </div>
                                        <div onClick={(e) => e.stopPropagation()} className="shrink-0">
                                            <PremiumDropdown
                                                options={timeframeOptions}
                                    ...
                                    <div className="mt-2.5 relative z-10 min-w-0">
                                        ...
                                        <p className="text-3xs text-violet-600 dark:text-violet-400 font-semibold mt-1 truncate">
                            ...
                            {canFinance && (
                                <div
                                    ...
                                    className="bg-white dark:bg-slate-900 rounded-[20px] p-4 sm:p-4.5 border border-slate-100 dark:border-slate-800 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none hover:-translate-y-0.5 hover:shadow-md transition-all duration-300 cursor-pointer flex flex-col justify-between relative overflow-hidden group min-h-[148px]"
                                >
                                    <div className="absolute -right-4 -top-4 w-16 h-16 bg-blue-500/10 rounded-full blur-xl group-hover:scale-150 transition-transform duration-500 pointer-events-none" />
                                    ...
                                    <div className="flex items-center justify-between gap-2 relative z-10">
                                        <div className="flex items-center gap-2 min-w-0">
                                            ...
                                            <h3 className="font-bold text-slate-500 dark:text-slate-400 text-3xs uppercase tracking-wider truncate">To Receive</h3>
                                        </div>
                                        <div onClick={(e) => e.stopPropagation()} className="shrink-0">
                                            <PremiumDropdown
                                                options={timeframeOptions}
                                    ...
                                    <div className="mt-2.5 relative z-10 min-w-0">
                                        <h2 className="text-lg sm:text-xl font-extrabold text-blue-600 dark:text-blue-400 tracking-tight truncate leading-tight">
                                            {formatCurrency(toReceiveVal, store)}
                                        </h2>
                                        <p className="text-3xs text-slate-400 dark:text-slate-500 font-medium mt-1 truncate">
                            ...
                            {canFinance && (
                                <div
                                    ...
                                    className="bg-white dark:bg-slate-900 rounded-[20px] p-4 sm:p-4.5 border border-slate-100 dark:border-slate-800 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none hover:-translate-y-0.5 hover:shadow-md transition-all duration-300 cursor-pointer flex flex-col justify-between relative overflow-hidden group min-h-[148px]"
                                >
                                    <div className="absolute -right-4 -top-4 w-16 h-16 bg-amber-500/10 rounded-full blur-xl group-hover:scale-150 transition-transform duration-500 pointer-events-none" />
                                    ...
                                    <div className="flex items-center justify-between gap-2 relative z-10">
                                        <div className="flex items-center gap-2 min-w-0">
                                            ...
                                            <h3 className="font-bold text-slate-500 dark:text-slate-400 text-3xs uppercase tracking-wider truncate">To Pay</h3>
                                        </div>
                                        <div onClick={(e) => e.stopPropagation()} className="shrink-0">
                                            <PremiumDropdown
                                                options={timeframeOptions}
                                    ...
                                    <div className="mt-2.5 relative z-10 min-w-0">
                                        <h2 className="text-lg sm:text-xl font-extrabold text-amber-600 dark:text-amber-400 tracking-tight truncate leading-tight">
                            ...
                            {canFinance && (
                                <div
                                    ...
                                    className="bg-white dark:bg-slate-900 rounded-[20px] p-4 sm:p-4.5 border border-slate-100 dark:border-slate-800 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none hover:-translate-y-0.5 hover:shadow-md transition-all duration-300 cursor-pointer flex flex-col justify-between relative overflow-hidden group min-h-[148px]"
                                >
                                    <div className="absolute -right-4 -top-4 w-16 h-16 bg-teal-500/10 rounded-full blur-xl group-hover:scale-150 transition-transform duration-500 pointer-events-none" />
                                    ...
                                    <div className="flex items-center justify-between gap-2 relative z-10">
                                        <div className="flex items-center gap-2 min-w-0">
                                            ...
                                            <h3 className="font-bold text-slate-500 dark:text-slate-400 text-3xs uppercase tracking-wider truncate">Net Profit</h3>
                                        </div>
                                        <div onClick={(e) => e.stopPropagation()} className="shrink-0">
                                            <PremiumDropdown
                                                options={timeframeOptions}
                                    ...
                                    <div className="mt-2.5 relative z-10 min-w-0">
                                        <h2 className="text-lg sm:text-xl font-extrabold text-teal-600 dark:text-teal-400 tracking-tight truncate leading-tight">
                                            {formatCurrency(netProfitVal, store)}
                                        </h2>
                                        <div className="flex items-center gap-1.5 mt-1 text-3xs text-slate-400 dark:text-slate-500 font-medium truncate">
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between gap-2 relative z-10">
                                        <div className="flex items-center gap-2 min-w-0">
                                            ...
                                            <h3 className="font-bold text-slate-500 dark:text-slate-400 text-3xs uppercase tracking-wider truncate">Store Health</h3>
                                        </div>
                                    ...
                                    <div className="mt-2.5 relative z-10 min-w-0">
                                        <div className="flex items-center gap-1.5">
                                            <span className="px-2 py-0.5 text-2xs font-extrabold rounded-lg bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-500/20 uppercase tracking-wide">
                                                {healthStatus}
                                            </span>
                                        </div>
                                        <p className="text-3xs text-slate-400 dark:text-slate-500 font-medium mt-1.5 truncate">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-6 w-full min-w-0">
                            ...
                            {/* Top Selling Items */}
                            {canSales && (
                                <div id="tour-top-products" className="bg-white dark:bg-slate-900 rounded-[20px] p-5 sm:p-6 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none border border-slate-100 dark:border-slate-800 flex flex-col min-h-[340px] group min-w-0">
                                    <div className="flex justify-between items-center mb-4 shrink-0">
                                        <h3 className="font-bold text-slate-800 dark:text-white text-sm flex items-center gap-2">
                                            <div className="w-1.5 h-4 bg-emerald-500 rounded-full" />
                                            Top Products
                                        </h3>
                                        <button className="p-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors text-slate-400 hover:text-indigo-600">
                                    ...
                                    <div className="flex-1 min-h-0 pr-1">
                                        <table className="w-full text-left border-collapse">
                                            <thead>
                                                <tr className="text-3xs font-bold uppercase tracking-wider text-slate-400 border-b border-slate-100 dark:border-slate-800">
                                            ...
                                            <tbody>
                                                {topSellingItems.map((item, i) => (
                                                    <tr key={i} className="group/row hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors cursor-default rounded-xl">
                                                        <td className="py-2.5 pl-1 border-b border-slate-50 dark:border-slate-800/50 group-last/row:border-none">
                                                            <div className="flex items-center gap-2.5">
                                                                <div className="w-7 h-7 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-sm shadow-2xs border border-slate-200 dark:border-slate-700 shrink-0 group-hover/row:scale-105 transition-transform">
                                                                    {item.image}
                                                                </div>
                                                                <div className="min-w-0">
                                                                    <p className="text-xs font-bold text-slate-700 dark:text-slate-200 truncate">{item.name}</p>
                                                                    <p className="text-3xs text-slate-400 font-medium truncate">{item.category}</p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td className="py-2.5 text-xs text-center font-bold text-slate-600 dark:text-slate-300 border-b border-slate-50 dark:border-slate-800/50 group-last/row:border-none">
                                                            <span className="bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded-md text-3xs font-semibold">{item.sold}</span>
                                                        </td>
                                                        <td className="py-2.5 pr-1 text-xs text-right font-extrabold text-emerald-600 dark:text-emerald-400 border-b border-slate-50 dark:border-slate-800/50 group-last/row:border-none whitespace-nowrap">
                                                            {item.revenue}
                                                        </td>
                                                    </tr>
                                                ))}
                                                {topSellingItems.length === 0 && (
                                                    <tr>
                                                        <td colSpan="3" className="py-8 text-center text-slate-400 text-xs">No sales data recorded yet.</td>
                                                    </tr>
                                                )}
                                            </tbody>
                                        </table>
                            ...
                            {/* Low Stock Items */}
                            {canInventory && (
                                <div id="tour-low-stock" className="bg-white dark:bg-slate-900 rounded-[20px] p-5 sm:p-6 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none border border-slate-100 dark:border-slate-800 flex flex-col min-h-[340px] min-w-0">
                                    <div className="flex justify-between items-center mb-4 shrink-0">
                                        <h3 className="font-bold text-slate-800 dark:text-white text-sm flex items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            className="text-3xs text-indigo-600 dark:text-indigo-400 font-bold hover:underline"
                                        >
                                            View Inventory
                                        </button>
                                    </div>
                                    ...
                                    <div className="flex-1 min-h-0 pr-1 space-y-2.5">
                                            ...
                                            <div key={item.id} className="flex items-center justify-between p-2.5 bg-rose-50/70 dark:bg-rose-950/20 rounded-xl border border-rose-100 dark:border-rose-900/30 gap-2">
                                                ...
                                                {canPurchases && (
                                                    <button
                                                        ...
                                                        className="px-2.5 py-1 bg-white dark:bg-slate-800 text-3xs font-bold text-slate-700 dark:text-slate-200 rounded-lg shadow-2xs border border-slate-200 dark:border-slate-700 hover:text-indigo-600 dark:hover:text-indigo-400 shrink-0 transition-colors"
                                                    >
                                                        Order
                                                    </button>
                                                )}
                                        ...
                                        {lowStockItems.length === 0 && (
                                            <div className="flex flex-col items-center justify-center h-full text-slate-400 py-8">
                                                ...
                                                <p className="text-xs font-semibold text-slate-600 dark:text-slate-300">All Stock Healthy</p>
                                                <p className="text-3xs text-slate-400 mt-0.5">No products below alert threshold</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                            ...
                            {/* Recent Purchases */}
                            {canPurchases && (
                                <div id="tour-purchases" className="bg-white dark:bg-slate-900 rounded-[20px] p-5 sm:p-6 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none border border-slate-100 dark:border-slate-800 flex flex-col min-h-[340px] min-w-0">
                                    <div className="flex justify-between items-center mb-4 shrink-0">
                                    ...
                                    <div className="flex-1 min-h-0 pr-1 space-y-2.5">
                                        {purchasesList.map((item) => (
                                            ...
                                            >
                                                <div className="min-w-0 flex-1">
                                                    <p className="text-xs font-bold text-slate-700 dark:text-slate-200 truncate">{item.supplier_name}</p>
                                                    <p className="text-3xs text-slate-400 font-medium">{item.date}</p>
                                                </div>
                                                <div className="text-right shrink-0">
                                                    <span className="text-xs font-extrabold text-amber-600 dark:text-amber-400">{item.total_amount}</span>
                                        ...
                                        {purchasesList.length === 0 && (
                                            <div className="flex flex-col items-center justify-center h-full text-slate-400 py-8">
                                                <Package size={28} className="text-slate-300 dark:text-slate-600 mb-1" />
                                                <p className="text-xs font-semibold text-slate-600 dark:text-slate-300">No Purchases</p>
                                                <p className="text-3xs text-slate-400 mt-0.5">No recent purchases for this period</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
