...
function PartySearchField({ value, selectedParty, onSelect, onClear, accentClass, ringClass }) {
    ...
    // On focus: show defaults immediately if no query, else reopen last results
    const handleFocus = () => {
        if (!query) {
    ...
    return (
        <div ref={containerRef} className="relative">
            <div style={{ outline: 'none' }} className={`flex items-center gap-2 w-full px-3 py-3 rounded-xl bg-app border ${selectedParty ? 'border-emerald-500' : 'border-line'} transition-all focus-within:border-emerald-500`}>
                ...
                />
                {loading && <div className="w-4 h-4 border-2 border-line border-t-emerald-500 rounded-full animate-spin shrink-0" />}
...
export default function PaymentIn({ parties = [], bankAccounts = [], selected_party_id = null }) {
    const {
        store
    } = usePage().props;
    ...
    return (
        <OneGlanceLayout title="Payment In">
            <Head title="Record Payment In" />
            ...
            <div className="h-full flex flex-col items-center justify-center overflow-auto py-6 px-4">
                ...
                <div className="w-full max-w-xl relative">
                    ...
                    {/* Glow */}
                    <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500/20 to-teal-500/10 rounded-2xl blur-xl pointer-events-none" />
                    ...
                    <div className="relative bg-surface rounded-2xl border border-line shadow-2xl overflow-hidden">
                        ...
                        <div className="relative bg-gradient-to-r from-emerald-600 to-teal-600 px-6 py-5 overflow-hidden">
                            ...
                            <div className="relative flex items-center gap-4">
                                ...
                                <div>
                                    <h1 className="text-xl font-bold text-white tracking-tight">Record Payment In</h1>
                                    <p className="text-emerald-100 text-sm">Money received from a contact</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-5">
                            ...
                            <div>
                                <label className="block text-2xs font-bold uppercase tracking-wider text-ink-muted mb-1.5">
                                    Receive From <span className="text-red-500">*</span>
                                </label>
                                <PartySearchField
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <FileText size={13} className="absolute left-3 top-3 text-ink-muted" />
                                        <input
                                            type="text"
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                >
                                    {success ? (
                                        ...
                                        <><ArrowDownCircle size={16} /> Record Payment In</>
                                    )}
                                </button>
                            </div>
                        </form>
