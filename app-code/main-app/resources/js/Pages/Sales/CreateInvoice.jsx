                                            ...
                                            <td className="bg-slate-50 dark:bg-slate-800/50 py-3 pr-3 align-middle">
                                                <div className="flex items-center justify-end gap-1.5">
                                                    <button
                                                        ...
                                                        disabled={isPosted}
                                                        className={`w-7 h-7 rounded-md text-2xs font-black transition-all shrink-0 border flex items-center justify-center disabled:opacity-60 disabled:cursor-not-allowed ${
                            ...
                            <div className={`grid gap-1.5 px-3 py-1.5 bg-slate-50 dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 shrink-0 ${
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        disabled={isPosted}
                                        className="w-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg px-1.5 h-9 text-slate-800 dark:text-white text-xs font-bold text-right outline-none disabled:opacity-60 disabled:cursor-not-allowed"
                                        placeholder="0"
                                    />
                                </div>
                                {showDeliveryCharges && (
                                ...
                                {showExtraField && (
                                    <div>
                                        <span className="text-4xs text-slate-400 font-bold block mb-0.5 uppercase">Extra</span>
                                        <input
                                            type="number"
