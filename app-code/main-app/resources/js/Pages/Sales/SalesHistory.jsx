                    ...
                    {showMobileFilters && (
                        <div className="w-full mt-1 border-t border-line pt-2 flex flex-col gap-2">
                            <div className="flex flex-wrap gap-1.5">
                                ...
                                <button
                                    onClick={() => setActiveFilter('custom')}
                                    className={`px-2.5 py-1 text-2xs font-bold uppercase rounded-full transition-all ${activeFilter === 'custom' ? 'bg-gradient-to-r from-purple-600 to-brand-600 text-white' : 'bg-sunken text-ink-muted'}`}
                                >Custom</button>
                            </div>
                            {activeFilter === 'custom' && (
