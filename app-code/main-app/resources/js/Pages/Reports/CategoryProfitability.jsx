    ...
    return (
        <ReportsLayout title="Category Profitability">
            ...
            <div className="flex flex-col h-full gap-4 w-full relative">
                    ...
                    <div className="flex items-center gap-3 pl-2">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-ink tracking-tight flex items-center gap-2">
                                Profit <span className="text-ink-muted font-medium text-sm">By Category</span>
                            </h1>
                            <p className="text-xs text-ink-muted font-medium">Category-level profitability analysis</p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 flex-1 min-h-0">
                    ...
                    <div className="xl:col-span-2 bg-surface rounded-2xl border border-line shadow-sm flex flex-col overflow-hidden">
                        <div className="p-5 border-b border-line flex flex-col sm:flex-row justify-between items-start sm:items-center bg-sunken/50 dark:bg-surface gap-4">
                            <h2 className="text-lg font-bold text-ink shrink-0">Category Breakdown</h2>
                            ...
                            <table className="w-full text-sm text-left">
                                ...
                                <tbody className="divide-y divide-line">
                                    {filteredCategories.map((row, idx) => (
                                        ...
                                        >
                                            <td className="px-6 py-4 font-bold text-ink group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors flex justify-between items-center">
                                                <span>{row.name}</span>
                                                <ChevronRight size={16} className="text-neutral-300 dark:text-ink-secondary group-hover:text-brand-500 group-hover:translate-x-0.5 transition-all" />
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    <div className="bg-white/5 backdrop-blur-sm p-3 rounded-xl border border-white/10">
                                        ...
                                        <p className="text-1xs text-neutral-300 leading-relaxed">Run the AI analyzer to detect margin leaks and find hidden pricing opportunities in your category catalog.</p>
                                    </div>
                                    <div className="bg-white/5 backdrop-blur-sm p-3 rounded-xl border border-white/10">
                                        <h4 className="text-xs font-bold text-amber-300 mb-1 flex items-center gap-2"><Lightbulb size={12} /> Insight</h4>
                                        <p className="text-1xs text-neutral-300">Identify low-profit or loss-making categories that are draining overall margins.</p>
                                    </div>
                                </div>
                            </div>

                            <button onClick={runAnalysis} disabled={isAnalyzing} className="w-full mt-6 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-xs font-bold uppercase tracking-wide transition-all shadow-lg flex items-center justify-center gap-2 active:scale-95 disabled:opacity-50 disabled:cursor-wait shrink-0">
                        ...
                        <div className="bg-surface w-full max-w-md rounded-2xl shadow-2xl border border-line overflow-hidden animate-in zoom-in-95 duration-normal">
                            <div className="bg-brand-600 p-6 text-white relative overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h2 className="text-2xl font-bold tracking-tight">Category Intelligence</h2>
                        ...
                        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-900/60 backdrop-blur-sm animate-in fade-in duration-normal">
                            <div className="bg-surface w-full max-w-6xl w-[92vw] rounded-2xl shadow-2xl border border-line overflow-hidden animate-in zoom-in-95 duration-normal flex flex-col max-h-[90vh]">
                                ...
                                <div className="bg-brand-600 p-6 text-white relative overflow-hidden shrink-0">
                                    ...
                                    <div className="relative z-10 flex justify-between items-center">
                                        <div className="space-y-1">
                                            ...
                                            <h2 className="text-2xl font-bold tracking-tight mt-1">{activeCategory.name}</h2>
                                ...
                                <div className="p-6 space-y-6 overflow-y-auto flex-1">
                                    ...
                                    <div className="grid grid-cols-3 gap-6">
                                        ...
                                        <div className="bg-app p-4 rounded-xl border border-line">
                                            ...
                                            <p className={`text-3xl font-bold mt-1 ${activeCategory.profit < 0 ? 'text-rose-500' : 'text-emerald-500'}`}>
                                    ...
                                    <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
                                                ...
                                                <table className="w-full text-xs sm:text-sm">
                                                    <tbody className="divide-y divide-line">
                                                        <tr>
                                                            ...
                                                            <td className="py-3 px-4 text-right font-mono text-ink-secondary dark:text-ink font-bold">{formatCurrency(activeCategory.revenue, store)}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr className="border-t border-line bg-sunken/50 dark:bg-surface">
                                                            ...
                                                            <td className="py-3 px-4 text-right font-mono text-ink-muted">{formatCurrency(activeCategory.purchase_cost || 0, store)}</td>
                                                        </tr>
                                                        <tr className="bg-sunken/50 dark:bg-surface">
                                                            <td className="py-3 px-4 text-ink-muted italic">Current stock value</td>
                                                            <td className="py-3 px-4 text-right font-mono text-ink-muted">{formatCurrency(activeCategory.stock_value || 0, store)}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                        ...
                                        <div className="xl:col-span-7 flex flex-col">
                                            ...
                                            <div className="flex border-b border-line mb-4 shrink-0">
                                                <button
                                                        ...
                                                        <table className="w-full text-xs sm:text-sm text-left">
                                                            <thead className="text-ink-muted uppercase bg-app border-b border-line">
                                                                <tr>
                                                                    ...
                                                                    <th className="text-right py-3 px-4 font-bold">Margin</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody className="divide-y divide-line">
                                                                {activeCategory.products.map((p, pi) => {
                                                                    ...
                                                                    return (
                                                                        ...
                                                                        >
                                                                            <td className="py-3 px-4 font-bold text-ink-secondary dark:text-ink group-hover:text-brand-600 dark:group-hover:text-brand-400 underline">
                                                                                {p.name}
                                                                            </td>
                                                                            <td className="py-3 px-4 text-right text-ink-muted font-semibold">{p.quantity}</td>
                                                                            <td className="py-3 px-4 text-right font-mono text-ink-secondary font-semibold">{formatCurrency(p.net_revenue, store)}</td>
                                                                            <td className={`py-3 px-4 text-right font-mono font-bold ${p.gross_profit < 0 ? 'text-rose-500' : 'text-emerald-600'}`}>
                                                                                {formatCurrency(p.gross_profit, store)}
                                                                            </td>
                                                                            <td className="py-3 px-4 text-right font-semibold">
                                                                                <span className={`px-2 py-0.5 rounded text-2xs font-bold ${pMargin > 20 ? 'bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400' : pMargin < 0 ? 'bg-rose-100 text-rose-600 dark:bg-rose-900/30 dark:text-rose-400' : 'bg-amber-100 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400'}`}>
                                                                                    {pMargin.toFixed(1)}%
                                                                                </span>
                                                                            </td>
                                                                        </tr>
                                ...
                                <div className="p-4 border-t border-line bg-app flex justify-end shrink-0">
                                    <button onClick={() => setSelectedCategory(null)} className="px-5 py-2 bg-neutral-800 hover:bg-interactive-hover dark:hover:bg-interactive-hover text-white text-xs sm:text-sm font-bold rounded-lg transition-colors">Close</button>
                                </div>
                            </div>
                        </div>
                    );
                ...
                {/* Product Detail Modal (opened when clicking a product inside the Category Detail Modal) */}
                {selectedProduct && (() => {
                    ...
                    return (
                        <div className="fixed inset-0 z-sticky flex items-center justify-center p-4 bg-neutral-900/60 backdrop-blur-sm animate-in fade-in duration-normal">
                            <div className="bg-surface w-full max-w-6xl w-[92vw] rounded-2xl shadow-2xl border border-line overflow-hidden animate-in zoom-in-95 duration-normal flex flex-col max-h-[90vh]">
                                {/* Modal Header */}
                                <div className="bg-brand-600 p-6 text-white relative overflow-hidden shrink-0">
                                    <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2" />
                                    <div className="relative z-10 flex justify-between items-center">
                                        <div className="space-y-1">
                                            ...
                                            <h2 className="text-2xl font-bold tracking-tight mt-1">{selectedProduct.name}</h2>
                                            <p className="text-brand-100 text-xs font-semibold">
                                ...
                                <div className="p-6 space-y-6 overflow-y-auto flex-1">
                                    ...
                                    <div className="grid grid-cols-3 gap-6">
                                        ...
                                        <div className="bg-app p-4 rounded-xl border border-line">
                                            <p className="text-xs font-bold text-ink-muted uppercase">Profit in Period</p>
                                            <p className={`text-3xl font-bold mt-1 ${selectedProduct.gross_profit < 0 ? 'text-rose-500' : 'text-emerald-500'}`}>
                                                {formatCurrency(selectedProduct.gross_profit, store)}
                                            </p>
                                        </div>
                                        <div className="bg-app p-4 rounded-xl border border-line">
                                            <p className="text-xs font-bold text-ink-muted uppercase">Profit Margin</p>
                                            ...
                                            <div className="bg-app rounded-xl border border-line overflow-hidden">
                                                <table className="w-full text-xs sm:text-sm">
                                                    <tbody className="divide-y divide-line">
                                                        <tr>
                                                            <td className="py-3 px-4 text-ink-muted">Revenue (net of returns)</td>
                                                            <td className="py-3 px-4 text-right font-mono text-ink-secondary dark:text-ink font-bold">{formatCurrency(selectedProduct.net_revenue, store)}</td>
                                                        </tr>
                                                        <tr>
                                                            <td className="py-3 px-4 text-ink-muted">Less: Cost of Goods Sold</td>
                                                            <td className="py-3 px-4 text-right font-mono text-rose-500 font-medium">({formatCurrency((selectedProduct.net_revenue || 0) - (selectedProduct.gross_profit || 0), store)})</td>
                                                        </tr>
                                                        <tr className="bg-sunken">
                                                            <td className="py-3 px-4 font-bold text-ink-secondary dark:text-ink">Gross Profit</td>
                                                            <td className={`py-3 px-4 text-right font-mono font-bold ${selectedProduct.gross_profit < 0 ? 'text-rose-500' : 'text-emerald-600'}`}>{formatCurrency(selectedProduct.gross_profit, store)}</td>
                                                        </tr>
                                                        <tr>
                                                            <td className="py-3 px-4 text-ink-muted">Gross Margin</td>
                                                            <td className="py-3 px-4 text-right font-mono text-ink-secondary dark:text-ink font-bold">{margin.toFixed(1)}%</td>
                                                        ...
                                                        <tr className="border-t border-line bg-sunken/50 dark:bg-surface">
                                                            <td className="py-3 px-4 text-ink-muted italic">Purchases in period</td>
                                                            <td className="py-3 px-4 text-right font-mono text-ink-muted">{formatCurrency(selectedProduct.purchase_cost || 0, store)}</td>
                                                        </tr>
                                                        <tr className="bg-sunken/50 dark:bg-surface">
                                                            <td className="py-3 px-4 text-ink-muted italic">Current stock value</td>
                                                            <td className="py-3 px-4 text-right font-mono text-ink-muted">{formatCurrency(selectedProduct.stock_value || 0, store)}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
