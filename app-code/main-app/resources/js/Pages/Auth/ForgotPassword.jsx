            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl sm:rounded-2xl p-6 sm:p-10 backdrop-blur-sm">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-white tracking-tight" style={{ fontFamily: "'Space Grotesk', 'Inter', sans-serif" }}>Reset Password</h2>
                            <p className="text-xs text-ink-muted">We'll send you a secure reset link</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-5 sm:space-y-6">
                        ...
                        <Link href={route('login')}
                            className="w-full flex items-center justify-center gap-2 py-3 sm:py-3.5 px-4 bg-white/[0.03] border border-white/[0.06] text-ink-muted hover:text-white hover:bg-white/[0.06] rounded-2xl font-bold text-sm transition-all active:scale-[0.98]">
