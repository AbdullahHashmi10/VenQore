                ...
                <div className="w-full max-w-md relative z-10">
                    ...
                    <form onSubmit={submit} className="space-y-3 sm:space-y-5">
                        ...
                        <div className="flex items-start gap-3 pt-0.5">
                            ...
                            <label className="text-sm text-slate-400 leading-relaxed cursor-pointer" onClick={() => setAgreedToTerms(!agreedToTerms)}>
                                I agree to VenQore's{' '}
                                <Link href={route('terms')} target="_blank" className="text-indigo-400 hover:text-indigo-300 transition-colors" onClick={e => e.stopPropagation()}>Terms</Link>
                                {' '}and{' '}
                                <Link href={route('privacy')} target="_blank" className="text-indigo-400 hover:text-indigo-300 transition-colors" onClick={e => e.stopPropagation()}>Privacy Policy</Link>
                            </label>
                        </div>
