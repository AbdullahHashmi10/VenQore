        ...
        <OneGlanceLayout title="WooCommerce Sync" activeMenu="Marketing">
            ...
            <div className="space-y-6">
                ...
                <div className="bg-surface rounded-2xl p-6 border border-line">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="flex items-center gap-4">
                            <div className="w-16 h-16 bg-sunken rounded-2xl flex items-center justify-center">
                                <ShoppingCart size={32} className="text-ink-muted" />
                            </div>
                            <div>
                                <h3 className="text-lg font-bold text-ink">Store Connection</h3>
                        ...
                        <button className="px-6 py-2.5 bg-sunken text-ink-secondary rounded-xl hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-colors font-bold flex items-center gap-2">
                            <Settings size={18} />
                            Configure Settings
                        </button>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Products Sync */}
                    <div className="bg-surface rounded-2xl p-6 border border-line hover:border-violet-200 dark:hover:border-violet-800 transition-colors group">
                    ...
                    {/* Orders Sync */}
                    <div className="bg-surface rounded-2xl p-6 border border-line hover:border-blue-200 dark:hover:border-blue-800 transition-colors group">
                    ...
                    {/* Customers Sync */}
                    <div className="bg-surface rounded-2xl p-6 border border-line hover:border-emerald-200 dark:hover:border-emerald-800 transition-colors group">
