    ...
    return (
        <OneGlanceLayout title="WooCommerce Setup" activeMenu="Marketing">
            ...
            <div className="max-w-5xl mx-auto space-y-6 px-4 sm:px-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-ink-muted text-sm">
                            Store: <strong className="text-ink-secondary dark:text-white font-semibold">{connection.name}</strong>
                        </span>
                    </div>
                    {status === 'pending' && (
                ...
                {status === 'pending' ? (
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            <div className="bg-surface dark:backdrop-blur-xl border border-line rounded-2xl p-6 shadow-sm">
                                <div className="flex items-center gap-2 mb-4">
                                    <Sparkles className="text-violet-500 w-5 h-5 animate-pulse" />
                                    <h2 className="text-lg font-bold text-ink">Zero-Configuration Setup</h2>
                                </div>
                                ...
                                <div className="space-y-6 relative before:absolute before:left-6 before:top-2 before:bottom-2 before:w-[2px] before:bg-sunken dark:before:bg-neutral-800/60">
                                    ...
                                    <div className="relative flex gap-5 items-start group">
                                        ...
                                        <div className="flex-1 space-y-2.5">
                                            <div>
                                                <h3 className="font-semibold text-ink text-sm">Download your Custom Plugin</h3>
                                    ...
                                    {/* Step 2: Upload */}
                                    <div className="relative flex gap-5 items-start group">
                                        <div className="w-12 h-12 rounded-2xl bg-app border border-line flex items-center justify-center font-bold text-ink-secondary text-base z-10 shadow-sm transition-transform">
                                            <Globe className="w-5 h-5" />
                                        </div>
                                        <div className="flex-1 space-y-2">
                                            <h3 className="font-semibold text-ink text-sm">Install & Activate on WordPress</h3>
                                            <p className="text-ink-muted text-xs leading-relaxed">
                                                Go to your WordPress Admin Dashboard, click <strong className="text-ink-secondary">Plugins → Add New → Upload Plugin</strong>, choose the downloaded ZIP, and click <strong className="text-ink-secondary">Activate</strong>.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="relative flex gap-5 items-start group">
                                        ...
                                        <div className="flex-1">
                                            <h3 className="font-semibold text-ink text-sm">Watch the connection happen</h3>
                        ...
                        <div className="lg:col-span-5">
                            <div className="bg-gradient-to-b from-neutral-900 to-neutral-950 dark:from-neutral-950 dark:to-black text-white rounded-2xl p-8 text-center relative overflow-hidden border border-neutral-800 dark:border-line shadow-xl shadow-neutral-900/10 flex flex-col justify-between min-h-[480px] gap-6">
                                ...
                                <div className="space-y-2 mt-2 relative z-10">
                                    ...
                                    <h3 className="text-lg font-bold text-neutral-100">Connecting to WooCommerce</h3>
                                    <p className="text-xs text-ink-muted max-w-[280px] mx-auto">
                                ...
                                <div className="relative flex items-center justify-center my-2 h-24 z-10">
                                    ...
                                    <div className="w-12 h-12 rounded-xl bg-gradient-to-tr from-violet-600 to-brand-600 text-white flex items-center justify-center shadow-lg relative z-20">
                                ...
                                <div className="space-y-4 relative z-10 mb-2">
                                    ...
                                    <div className="bg-neutral-900/50 border border-neutral-800/80 rounded-2xl p-4 space-y-3 text-left">
                                        <div className="flex justify-between items-center">
                                            <span className="text-2xs font-bold text-ink-muted uppercase tracking-wider">WordPress Site URL</span>
                                            {!isEditingUrl && (
                                                <button
                                        ...
                                        {isEditingUrl ? (
                                            ...
                                            <div className="space-y-2">
                                                <div className="text-xs font-mono text-neutral-300 break-all bg-neutral-950/40 p-2 rounded-lg border border-neutral-800 truncate select-all" title={siteUrl}>
                                                    {siteUrl}
                                                </div>
                                                <a
                                            ...
                                            <div className="space-y-2">
                                                <p className="text-2xs text-ink-muted">Not provided. Add site URL to enable remote handshake execution.</p>
                                                <button
                                                    onClick={() => setIsEditingUrl(true)}
                                    ...
                                    <div className="space-y-2">
                                        <div className="text-xs font-semibold text-ink-muted">STATUS</div>
                    ...
                    <div className="max-w-3xl mx-auto py-8">
                        <div className="bg-surface dark:backdrop-blur-xl border border-emerald-100 dark:border-emerald-950/60 rounded-2xl p-8 md:p-12 text-center shadow-xl relative overflow-hidden">
                            ...
                            <div className="relative z-10 space-y-6">
                                <div className="w-20 h-20 rounded-2xl bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-100 dark:border-emerald-800/40 flex items-center justify-center mx-auto shadow-md animate-bounce">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <h2 className="text-2xl md:text-3xl font-bold text-ink">Store Successfully Synced! 🎉</h2>
                                    <p className="text-ink-muted text-sm max-w-lg mx-auto leading-relaxed">
                                        Secure handshake completed with WooCommerce at <span className="font-semibold text-ink-secondary dark:text-ink">{siteUrl}</span>. VenQore has automatically initiated the initial product import.
                                    </p>
                                </div>

                                <div className="py-2.5 max-w-sm mx-auto bg-app rounded-2xl border border-line flex items-center justify-center gap-3">
                                    <Loader2 className="w-4 h-4 animate-spin text-emerald-500" />
                                    <span className="text-xs text-ink-secondary font-medium">Redirecting to operations control...</span>
                                </div>
                ...
                {showManual && (
                    <div className="border border-line bg-surface rounded-2xl p-6 shadow-sm animate-slide-up space-y-5">
                        <div className="flex items-start gap-3">
                            <AlertCircle className="text-amber-500 w-5 h-5 flex-shrink-0 mt-0.5" />
                            <div>
                                <h4 className="font-bold text-ink text-sm">Manual Setup Protocol</h4>
                                <p className="text-ink-muted text-xs mt-0.5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-semibold text-ink-muted uppercase tracking-wider">VenQore Host URL</label>
                                <div className="flex items-center gap-2 bg-app rounded-xl p-3 border border-line">
                                    <code className="text-xs font-mono text-ink-secondary flex-1 truncate">
                            ...
                            {/* Token */}
                            <div className="space-y-1.5">
                                <label className="text-xs font-semibold text-ink-muted uppercase tracking-wider">Authentication Token</label>
                                <div className="flex items-center gap-2 bg-app rounded-xl p-3 border border-line">
                                    <code className="text-xs font-mono text-ink-secondary flex-1 truncate">
                        ...
                        <div className="p-4 bg-app rounded-xl text-xs text-ink-muted leading-relaxed border border-line">
                            <strong>How to use manual credentials:</strong> Open your WordPress Dashboard, navigate to <strong className="text-ink-secondary">VenQore Sync</strong>, scroll to the bottom, paste the Host URL and the Authentication Token, and click <strong className="text-ink-secondary">Save & Connect</strong>.
                        </div>
                    </div>
                )}
            </div>
