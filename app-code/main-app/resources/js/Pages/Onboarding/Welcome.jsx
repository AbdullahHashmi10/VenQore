...
export default function Welcome({ storeSlug, tenantName, onNext, onSelectMode }) {
    ...
    return (
        <div className="w-full max-w-5xl mx-auto space-y-10 animate-fadeIn relative z-10">
            ...
            <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-indigo-600/20 rounded-full blur-[140px] pointer-events-none" />
            ...
            <div className="text-center space-y-5">
                <div className="inline-flex items-center gap-2.5 px-4 py-1.5 bg-indigo-500/10 border border-indigo-500/30 rounded-full text-indigo-300 text-xs font-medium tracking-wide shadow-xl shadow-indigo-500/10 backdrop-blur-md">
            ...
            {/* Quick Setup Bar */}
            <div className="p-6 md:p-8 bg-slate-900/60 border border-white/10 backdrop-blur-2xl rounded-3xl space-y-6 max-w-2xl mx-auto shadow-2xl shadow-black/60 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                    <div className="md:col-span-7 space-y-1.5">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-slate-950/90 border border-slate-700/80 rounded-2xl text-white placeholder-slate-500 text-sm focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all"
                        />
                    </div>
                    <div className="md:col-span-5 space-y-1.5">
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="w-full px-4 py-3 bg-slate-950/90 border border-slate-700/80 rounded-2xl text-white text-sm focus:outline-none focus:border-indigo-500 transition-all appearance-none pr-8 cursor-pointer"
                            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                ...
                <div
                    ...
                    className="group relative cursor-pointer p-6 bg-gradient-to-b from-slate-900/90 via-slate-900/70 to-indigo-950/40 hover:from-slate-900 hover:to-indigo-900/50 border border-indigo-500/30 hover:border-indigo-500/70 rounded-3xl transition-all duration-500 shadow-2xl shadow-indigo-500/10 hover:shadow-indigo-500/25 flex flex-col justify-between overflow-hidden"
                >
                    ...
                    <div className="h-44 -mx-6 -mt-6 mb-4 overflow-hidden relative">
                        ...
                        <div className="absolute top-4 right-4 px-3 py-1 bg-indigo-600/90 backdrop-blur-md text-white text-[10px] font-bold uppercase tracking-wider rounded-full flex items-center gap-1.5 shadow-lg">
                            <Sparkles size={12} />
                    ...
                    <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-between text-indigo-400 text-xs font-bold group-hover:text-indigo-300">
                ...
                <div
                    ...
                    className="group relative cursor-pointer p-6 bg-gradient-to-b from-slate-900/90 via-slate-900/70 to-purple-950/40 hover:from-slate-900 hover:to-purple-900/50 border border-purple-500/30 hover:border-purple-500/70 rounded-3xl transition-all duration-500 shadow-2xl shadow-purple-500/10 hover:shadow-purple-500/25 flex flex-col justify-between overflow-hidden"
                >
                    {/* Background Hero Image */}
                    <div className="h-44 -mx-6 -mt-6 mb-4 overflow-hidden relative">
                        <img
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/40 to-transparent" />
                        <div className="absolute top-4 right-4 px-3 py-1 bg-purple-600/90 backdrop-blur-md text-white text-[10px] font-bold uppercase tracking-wider rounded-full flex items-center gap-1.5 shadow-lg">
                            <LayoutGrid size={12} />
