...
export default function AiDiscovery({ onNext, onBack, onAiResult, storeSlug }) {
 ...
 className="w-full py-4 px-6 bg-gradient-brand text-white font-bold text-sm rounded-2xl shadow-xl flex items-center justify-center gap-2.5 transition-all transform active:scale-98"
 >
 {isAnalyzing ? (
 <>
