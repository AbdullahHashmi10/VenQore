...
const CreateProposal = ({ proposal, existingProposal }) => {
    ...
    const handleSave = async (shouldPrint = false) => {
        ...
        // For proposals, we don't need overpayment checks - just proceed to save
    ...
    return (
        ...
        >
            ...
            <div
                className={`h-full flex-1 flex flex-col bg-sunken dark:bg-void-800 transition-all duration-slower ${isSeniorMode ? "text-[20px] senior-mode" : ""}`}
            >
                <style>{`
...
`}
                                >
                                    <div
                                        className={`w-2 h-2 rounded-full ${currentInvoiceId === inv.id ? "bg-brand-500 animate-pulse" : "bg-neutral-400"}`}
                                    ></div>
                            ...
                            <div className="flex items-center justify-between w-full relative">
                                ...
                                >
                                    ...
                                    <span className="truncate">
                                        {currentInvoice.customer?.name || `Proposal #${activeInvoices.findIndex(inv => inv.id === currentInvoice.id) + 1}`}
                                    </span>
                                </button>
                            ...
                            <div className="flex items-center gap-2">
                                <div className="flex items-center gap-0.5 bg-sunken rounded-xl p-1 border border-line">
                                    <button
                                        ...
                                        className={`px-3 py-1.5 rounded-lg text-2xs font-bold flex items-center gap-1.5 transition-all ${
                                ...
                                <div className="relative group/accounts">
                                    <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-sunken text-ink-secondary hover:bg-interactive-hover dark:hover:bg-interactive-hover transition-all border border-line text-2xs font-bold min-w-[120px] justify-between">
                                        ...
                                        <ChevronRight
                                            size={12}
                                            className="rotate-90 text-ink-muted"
                                        />
                                    </button>
                                    ...
                                    <div className="absolute top-full pt-2 right-0 w-48 z-50 overflow-hidden hidden group-hover/accounts:block animate-in fade-in slide-in-from-top-2">
                                        <div className="bg-surface rounded-xl shadow-xl border border-line overflow-hidden">
                                            <div className="p-2 border-b border-line bg-app">
                                                <p className="text-2xs font-bold text-ink-muted uppercase">
                                                    Deposit To
                                                </p>
                                            </div>
                                ...
                                <div className="relative">
                                    <button
                                        ...
                                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl transition-all border text-2xs font-bold ${
                                            textSize > 1
                                    ...
                                    {currentInvoice.items.map((item, idx) => (
                                        ...
                                        >
                                            ...
                                            >
                                                <GripVertical
                                                    size={16}
                                                    className="text-neutral-300 hover:text-ink-muted transition-colors"
                                                />
                                            </td>
                                            {/* Row Number */}
                        ...
                        <div className="lg:hidden flex flex-col shrink-0">
                            ...
                            {/* Row 2: Cancel (25%) & Complete Proposal (75%) */}
                    ...
                    <div className="hidden lg:flex w-80 bg-void-700 flex-col overflow-hidden rounded-2xl shadow-2xl border border-neutral-800 shrink-0">
                            ...
                            {currentInvoice.customer ? (
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3">
                                        <div
                                            className={`rounded-xl bg-gradient-to-br from-brand-500 to-purple-600 flex items-center justify-center text-white font-bold shrink-0 ${textSize >= 4 ? "w-16 h-16 text-xl" : textSize >= 3 ? "w-14 h-14 text-lg" : "w-12 h-12 text-lg"}`}
                                        >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p
                                                className={`text-ink-muted font-medium ${textSize >= 4 ? "text-sm" : textSize >= 3 ? "text-xs" : "text-2xs"}`}
                                            >
                                                {currentInvoice.customer
                                                    .phone || "No Phone"}
                                            </p>
                                    ...
                                    {/* Balance & Address */}
                                    <div
                                        className={`space-y-1 bg-neutral-800/30 rounded-lg p-2 ${textSize >= 3 ? "text-sm" : "text-xs"}`}
                                    >
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span
                                                className={`font-bold ${currentInvoice.customer.current_balance >= 0 ? "text-emerald-400" : "text-red-400"}`}
                                            >
                                                {currentInvoice.customer
                                                    .current_balance >= 0
                                                    ? getCurrencySymbol()
                                        ...
                                        <div className="flex justify-between items-start gap-2">
                                            ...
                                            <span
                                                className={`text-right ${currentInvoice.customer.address ? "text-neutral-300" : "text-ink-secondary italic"}`}
                                            >
                                                {currentInvoice.customer
                                                    .address || "Not set"}
                                            </span>
                                ...
                                <div className="text-center py-4 border border-dashed border-neutral-700 rounded-xl">
                                    ...
                                    <p
                                        className={`text-ink-muted font-bold ${textSize >= 3 ? "text-sm" : "text-xs"}`}
                                    >
                        ...
                        <div className="flex-1 p-3 space-y-3 overflow-y-auto hide-scrollbar">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <div>
                                    <label className="text-3xs text-ink-muted font-bold uppercase block mb-1">
                                        Invoice #
                                    </label>
                                    <input
                                        type="text"
                            ...
                            {showDeliveryCharges && (
                                <div className="flex items-center justify-between p-2 hover:bg-interactive-hover rounded-lg transition-colors group">
                                    <span className="text-xs text-ink-muted font-bold group-hover:text-ink-muted">
                                        Delivery Charges
                                    </span>
                                    <div className="flex items-center gap-2">
                                        <span className="text-ink-secondary text-2xs">
                                            {getCurrencySymbol()}
                                        </span>
                                        <input
                                            type="number"
                                    ...
                                    {!enableMultipleExtras ? (
                                        ...
                                        <div className="space-y-1">
                                            {(
                                                ...
                                                <div
                                                    key={field.id || idx}
                                                    className="flex items-center justify-between p-2 hover:bg-interactive-hover rounded-lg transition-colors group"
                                                >
                                                    <div className="flex items-center gap-1">
                                                        <input
                                                            type="text"
                        ...
                        <div className="p-3 bg-neutral-900 space-y-2 shrink-0 border-t border-neutral-800">
                            <div className="flex justify-between items-center">
                                <span className="text-2xs text-ink-muted font-bold uppercase">
                                    Total
                                </span>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <button
                                        ...
                                        className="w-full py-3 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all shadow-lg active:scale-95 disabled:opacity-50"
                                    >
                                    ...
                                    {showConvertMenu && (
                                        <div className="absolute bottom-full left-0 right-0 mb-2 bg-neutral-800 rounded-xl border border-neutral-700 shadow-2xl overflow-hidden z-50 animate-in slide-in-from-bottom-2">
                                            <button
                                                onClick={() => {
                                                ...
                                                className="w-full px-4 py-3 text-left hover:bg-emerald-600/20 flex items-center gap-3 transition-colors border-b border-neutral-700"
                                            >
                    ...
                    <div className="bg-surface rounded-2xl shadow-2xl border border-line w-full max-w-2xl overflow-hidden animate-in zoom-in-95 duration-slow">
                        <div className="p-8 border-b border-line flex items-center justify-between bg-gradient-to-r from-neutral-50 to-white dark:from-neutral-800/50 dark:to-neutral-900">
                            ...
                            <button
                                ...
                                className="p-4 hover:bg-interactive-hover dark:hover:bg-interactive-hover rounded-2xl transition-all"
                            >
                            ...
                            <div className="max-h-80 overflow-y-auto space-y-4 custom-scrollbar pr-2">
                                {scannedItems.length === 0 ? (
                                    ...
                                    scannedItems.map((item, idx) => (
                                        <div
                                            key={item.id}
                                            className="flex items-center justify-between p-5 bg-app rounded-2xl border-2 border-line animate-in slide-in-from-bottom-2 duration-normal"
                                        >
                                            <div className="flex items-center gap-5">
                                                <span className="w-10 h-10 rounded-full bg-sunken flex items-center justify-center text-xs font-bold text-ink-muted shadow-sm">
                                                    {idx + 1}
                                                </span>
                                                <div>
                                            ...
                                            <button
                                                ...
                                                className="p-3 text-neutral-300 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-all"
                                            >
                                                <Trash2 size={24} />
                                            </button>
                                        </div>
                        ...
                        <div className="p-8 bg-app flex items-center justify-between border-t border-line">
                            <p className="text-base font-bold text-ink-muted uppercase tracking-widest">
                                Total:{""}
                            ...
                            <div className="flex gap-4">
                                <button
                                    ...
                                    className="px-8 py-4 text-sm font-bold text-ink-muted hover:text-red-500 transition-colors uppercase tracking-widest"
                                >
                                    Clear All
                                </button>
                                <button
                                    ...
                                    {currentInvoice.items
                                        ...
                                        .map((item, idx) => {
                                            ...
                                            return (
                                                <tr
                                                    key={item.id}
                                                    className="border-b border-line hover:bg-interactive-hover dark:hover:bg-interactive-hover"
                                                >
                        ...
                        <div className="p-4 bg-app border-t border-line shrink-0">
                            <div className="grid grid-cols-3 gap-4">
                                <div className="bg-surface rounded-xl p-3 border border-line">
                                    <p className="text-2xs text-ink-muted font-bold uppercase mb-1">
                                        Total Cost
                                    </p>
                        ...
                        <div className="flex-1 p-4 space-y-4 overflow-y-auto">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center justify-between p-3 bg-app rounded-xl">
                                    <div className="flex items-center gap-3">
                                        ...
                                        />
                                        <div>
                                            <p className="text-sm font-bold text-ink-secondary dark:text-white">
                                                Large Text
                                            </p>
                                            <p className="text-xs text-ink-muted">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="p-3 bg-brand-50 dark:bg-brand-900/20 rounded-xl space-y-2 border border-brand-100 dark:border-brand-800/50">
                                    <p className="text-xs font-bold text-brand-600 dark:text-brand-400 uppercase">
                                        Default Delivery
                                    </p>
                                    <div className="flex items-center gap-2">
