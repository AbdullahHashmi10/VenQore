...
`}
                                        ...
                                        <button
                                            ...
                                            className="w-full py-4 bg-gradient-to-r from-brand-600 to-violet-600 hover:from-brand-500 hover:to-violet-500 disabled:from-neutral-300 disabled:to-neutral-400 disabled:cursor-not-allowed text-white rounded-xl font-bold text-lg shadow-xl flex items-center justify-center gap-2 transition-all active:scale-95 group"
                                        >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-full animate-in fade-in duration-slow">
                            ...
                            <div className="lg:col-span-6">
                                <div className="bg-surface border border-line rounded-2xl p-8 flex flex-col gap-6 shadow-sm min-h-[360px] justify-between">
                                    ...
                                    <div>
                                        <label className="w-full py-4 bg-purple-600 hover:bg-purple-500 text-white rounded-xl font-bold text-base shadow-xl flex items-center justify-center gap-2 transition-all active:scale-95 cursor-pointer select-none text-center">
