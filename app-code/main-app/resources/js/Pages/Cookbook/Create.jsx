...
export default function CookbookCreate({ products = [], recipe = null, warehouses = [], categories = [], attributes = [] }) {
 ...
 <div className="bg-brand-50 dark:bg-brand-900/20 rounded-2xl border border-brand-200 dark:border-brand-800 p-5 shadow-sm">
 ...
 {/* Cost Summary Card */}
 <div className="bg-gradient-brand rounded-2xl p-6 text-white shadow-xl sticky top-0">
