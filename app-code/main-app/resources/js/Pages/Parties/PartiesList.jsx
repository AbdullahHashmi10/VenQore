                    ...
                    <div className="flex items-center justify-between px-3 py-2">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <button
                                ...
                                className="ml-1 px-2.5 py-1.5 bg-gradient-to-r from-brand-600 to-purple-600 text-white rounded-lg flex items-center gap-1 transition-all shadow-md font-bold text-2xs"
                            >
                                <Plus size={12} /> Add
                            </button>
                        </div>
                ...
                <div className="hidden sm:flex flex-row items-center justify-between gap-2 bg-surface px-3 py-2 rounded-xl border border-line shadow-sm shrink-0">
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-2 w-full sm:w-auto">
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                            ...
                            <button
                                onClick={handleCreate}
                                className="flex items-center gap-1 px-2.5 py-1 text-xs bg-gradient-to-r from-brand-600 to-purple-600 text-white rounded-lg hover:from-brand-700 hover:to-purple-700 transition-all font-bold shadow-md shrink-0"
                            >
                                <Plus size={12} />
                                <span>Add Party</span>
                            </button>
