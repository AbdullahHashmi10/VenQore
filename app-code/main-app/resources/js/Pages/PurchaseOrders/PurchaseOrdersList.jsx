...
`}
 ...
 <span className="text-3xs font-bold uppercase bg-brand-100 text-brand-700 dark:bg-brand-500/20 dark:text-brand-400 px-2 py-0.5 rounded border border-brand-200/30">
 Pre-Purchase
 </span>
