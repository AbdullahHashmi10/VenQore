            ...
            <div className="flex flex-col h-full bg-app p-2 gap-1 overflow-hidden">
                    ...
                    {!isStatsExpanded && (
                        <div className="flex flex-col gap-1 items-end text-xs font-bold text-ink-secondary">
                            <div className="flex items-center gap-2">
                                <span className="text-brand-600 dark:text-brand-400">Total: {formatCurrency(totalValue, store)}</span>
                ...
                <div className={`grid grid-cols-2 md:grid-cols-4 gap-1 shrink-0 ${isStatsExpanded ? 'grid' : 'hidden md:grid'}`}>
                    ...
                    <div className="bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between">
                        ...
                        <p className="text-base font-bold text-amber-600">{pendingOrders}</p>
                    </div>
                    <div className="bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-xs font-bold text-ink-muted uppercase">Received</p>
                        </div>
                        <p className="text-base font-bold text-emerald-600">{receivedOrders}</p>
                    </div>
                    <div className="bg-surface px-3 py-2 rounded-xl border border-line shadow-sm flex items-center justify-between">
                        <div className="flex items-center gap-2">
                        ...
                        <p className="text-base font-bold text-ink">{formatCurrency(totalValue, store)}</p>
                    </div>
                </div>
                    ...
                    <div className="flex items-center gap-2">
                        <div className="w-64 relative">
                            <input
                                ...
                                className="w-full pl-9 pr-4 py-2 text-sm bg-app border border-line rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-shadow outline-none"
                            />
                    ...
                    {showMobileSearch && (
                        <div className="w-full relative mt-1 border-t border-line pt-2">
                            <input
                                ...
                                onKeyDown={handleServerSearch}
                                placeholder="Search purchase orders..."
                                className="w-full pl-9 pr-4 py-1.5 text-sm bg-app border border-line rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-shadow outline-none text-ink"
                            />
...
`}
                                    >
                                        ...
                                        <td className="p-4 text-sm">
                                            <span className="font-bold text-ink">{formatCurrency(row.total_amount, store)}</span>
                                        </td>
                                        <td className="p-4 text-sm">
                                            {(() => {
                                                const statusStyles = {
                                                ...
                                                return <span className={`px-2 py-1 rounded-md text-xs font-bold uppercase ${statusStyles[row.status] || 'bg-sunken text-ink-secondary'}`}>{row.status}</span>;
                                            })()}
                                        </td>
...
`}
                                    >
                                        ...
                                        <div className="flex items-center gap-1.5">
                                            <span className="text-3xs font-bold uppercase bg-purple-100 text-purple-700 dark:bg-purple-500/20 dark:text-purple-400 px-2 py-0.5 rounded border border-purple-200/30">
                                                Pre-Purchase
                                            </span>
                                        ...
                                        <div className="flex items-center justify-between border-t border-line pt-2 mt-1">
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div>
                                                    <span className="text-3xs text-ink-muted font-bold uppercase block tracking-wider">Items</span>
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between p-4 border-b border-line bg-gradient-to-r from-neutral-50 to-white dark:from-neutral-800 dark:to-neutral-900 shrink-0">
                            <div className="flex items-center gap-4">
                                <div>
                                    ...
                                    <h3 className="text-xl font-bold text-purple-600">{quickViewItem.reference_number}</h3>
                                </div>
                                {(() => {
                                    const statusStyles = {
                                        received: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400',
                        ...
                        <div className="flex-1 overflow-auto p-4">
                            ...
                            <div className="grid grid-cols-3 gap-3 mb-4">
                                ...
                                <div className="bg-gradient-to-br from-purple-100 to-brand-100 dark:from-purple-900/30 dark:to-brand-900/30 p-3 rounded-xl border border-purple-200 dark:border-purple-800">
                                    <p className="text-2xs font-bold text-purple-600 uppercase mb-1">Total</p>
                                    <p className="font-bold text-purple-600 text-lg">{formatCurrency(quickViewItem.total_amount, store)}</p>
                                </div>
                            </div>
                                            ...
                                            {quickViewItem.items && quickViewItem.items.length > 0 ? (
                                                quickViewItem.items.map((item, idx) => (
                                                    <tr key={idx} className="hover:bg-interactive-hover dark:hover:bg-interactive-hover">
                                                        ...
                                                        <td className="p-3 text-center font-bold text-ink-secondary">{item.quantity}</td>
                                ...
                                <div className="bg-app px-4 py-3 border-t border-line">
                                    <div className="flex justify-end">
                                        <div className="text-right">
                                            ...
                                            <p className="font-bold text-lg text-purple-600">{formatCurrency(quickViewItem.total_amount, store)}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="p-3 border-t border-line bg-app text-center shrink-0">
                            <p className="text-2xs text-ink-muted">Double-click row to view details • Press <kbd className="px-1.5 py-0.5 bg-sunken rounded text-ink-secondary font-mono">Esc</kbd> to close</p>
                        </div>
                    </div>
                </div>
            )}
