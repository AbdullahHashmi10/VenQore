        ...
        >
            <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 pt-32 md:pt-36 pb-14">
                ...
                <Section id="account-registration" title="3. Account Registration & Security">
                    ...
                    <p>You are solely responsible for safeguarding the credentials of all accounts created under your tenant workspace. You are fully responsible for all activities and transactions executed under your credentials. You must notify us immediately at <a href="mailto:security@venqore.com" className="text-brand-600 dark:text-brand-400 hover:underline">security@venqore.com</a> if you discover or suspect any unauthorized access or breach of security.</p>
                ...
                <Section id="subscriptions-billing" title="4. Subscriptions, Payments & Merchant of Record">
                    <p><strong className="text-ink">Merchant of Record:</strong> Our international order processing, subscription billing, payment handling, and tax remittance (including VAT, GST, and sales tax) are managed exclusively by our authorized online reseller and Merchant of Record, <strong>Lemon Squeezy, LLC</strong> (&quot;Lemon Squeezy&quot;). When you purchase a subscription or add-on internationally, your transaction is processed by Lemon Squeezy and subject to Lemon Squeezy&apos;s Terms of Service and Privacy Policy, in addition to these Terms.</p>
                    <p><strong className="text-ink">Local Pakistani Payments:</strong> For eligible customers operating in Pakistan billed directly in Pakistani Rupees (PKR), subscriptions and direct bank transfers are managed through our authorized local corporate accounts in Pakistan.</p>
                    <p><strong className="text-ink">Recurring Billing:</strong> Paid subscriptions are billed in advance on a recurring monthly or annual basis. By initiating a subscription, you authorize Lemon Squeezy (or our direct local payment gateway) to automatically charge your designated payment method at each renewal interval until cancelled.</p>
                    <p><strong className="text-ink">Cancellations & Refunds:</strong> You may cancel your subscription at any time via the Tenant Billing settings. Cancellation takes effect at the end of the current paid billing period. Subscriptions are non-refundable for partial billing periods except as expressly detailed in our <Link href="/refund-policy" className="text-brand-600 dark:text-brand-400 hover:underline">Refund Policy</Link> or required by applicable consumer law.</p>
                </Section>
                ...
                <Section id="data-ownership-dpa" title="6. Data Ownership & Data Processing Agreement (DPA)">
                    <p><strong className="text-ink">Customer Ownership:</strong> You retain all right, title, and interest, including all intellectual property rights, in and to the proprietary business data, inventory records, financial transactions, customer lists, and documents you input or store within the Service (&quot;Customer Data&quot;). VenQore claims no ownership over your Customer Data.</p>
                    <p><strong className="text-ink">Data Processing Agreement (GDPR Art. 28):</strong> To the extent that Customer Data contains Personal Data protected under the General Data Protection Regulation (EU GDPR) or UK Data Protection Act 2018, the parties agree that you are the Data Controller and VenQore is the Data Processor. Our standard Data Processing Agreement (DPA), incorporating Standard Contractual Clauses (SCCs), is incorporated by reference into these Terms and available upon request at <a href="mailto:legal@venqore.com" className="text-brand-600 dark:text-brand-400 hover:underline">legal@venqore.com</a>.</p>
                    <p>For complete information regarding data handling practices and subprocessors, review our <Link href="/privacy" className="text-brand-600 dark:text-brand-400 hover:underline">Privacy Policy</Link>.</p>
                </Section>
                ...
                <Section id="warranty-disclaimer" title="10. Express Disclaimer of Warranties">
                    <div className="p-4 rounded-xl bg-sunken dark:bg-white/5 border border-line dark:border-white/10 text-xs sm:text-sm uppercase tracking-wide leading-relaxed font-mono text-ink-secondary">
                ...
                <Section id="limitation-liability" title="11. Limitation of Liability & Liability Cap">
                    <p className="uppercase text-xs sm:text-sm font-semibold tracking-wide text-ink">
                ...
                <Section id="shared-catalogue" title="12. Shared Product Catalogue (Optional Community Knowledge Base)">
                    ...
                    <p><strong className="text-ink">What is shared:</strong> Anonymous product titles, brand names, and barcode numbers. Global catalogue publication occurs only after a product listing has been independently verified across multiple distinct merchants.</p>
                    <p><strong className="text-ink">What is NEVER shared:</strong> We never share, expose, or pool your sales figures, retail pricing, cost prices, inventory quantities, margins, profit, supplier names, customer records, or business identity.</p>
                    <p><strong className="text-ink">Opt-out:</strong> Participation in the shared catalogue is optional and may be disabled at any time under Settings → Data. Opting out immediately halts all metadata contribution from your workspace.</p>
                </Section>
                ...
                <Section id="contact" title="16. Contact & Legal Notices">
                    ...
                    <p>Email: <a href="mailto:legal@venqore.com" className="text-brand-600 dark:text-brand-400 hover:underline">legal@venqore.com</a> · Support: <a href="mailto:support@venqore.com" className="text-brand-600 dark:text-brand-400 hover:underline">support@venqore.com</a></p>
