                    ...
                    <div className={`${sidebarCollapsed ? 'px-2 py-4' : 'px-4 py-6'} border-b border-neutral-800/50 mb-3 relative z-20`}>
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                className="w-10 h-10 rounded-xl bg-gradient-to-tr from-brand-600 to-purple-600 flex items-center justify-center text-white shadow-lg transition-transform shrink-0"
                            >
                        ...
                        <div className="p-10 border-b border-line shrink-0 bg-white/80 dark:bg-app backdrop-blur-xl">
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className={`relative group px-10 py-4 rounded-2xl font-bold text-sm transition-all duration-slower transform active:scale-95 overflow-hidden shadow-2xl hover: ${(!isAdmin || (data.pos_return_mode === 'open' && !acknowledgeOpenReturn)) ? 'opacity-50 grayscale cursor-not-allowed' : ''}`}
                                >
