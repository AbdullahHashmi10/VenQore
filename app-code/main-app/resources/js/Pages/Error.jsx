...
export default function Error({ status = 500, message }) {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-app p-6">
            <div className="max-w-lg w-full">

                {/* Card */}
                <div className={`bg-surface rounded-2xl shadow-2xl border ${colors.border} overflow-hidden`}>
                ...
                {/* Ref code */}
                <p className="text-center mt-4 text-1xs text-ink-muted font-mono">
