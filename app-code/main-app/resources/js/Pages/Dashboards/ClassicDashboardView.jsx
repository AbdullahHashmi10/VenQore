...
export default function ClassicDashboardView({
    performance = {},
    outstanding = {},
    netProfit = {},
    salesData,
    ...
    // Listen for reset events from Start Fresh
    useEffect(() => {
        const handleReset = () => {
            ...
            {showRightPanel && (
                <div className="lg:hidden">
                    {mobileRightPanelOpen && (
                        <div className="fixed inset-0 bg-black/50 z-drawer lg:hidden" onClick={() => setMobileRightPanelOpen && setMobileRightPanelOpen(false)} />
                    )}
                    <div
                        className={`
