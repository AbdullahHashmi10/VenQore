                        ...
                        <div className="fixed inset-0 z-command bg-neutral-950/80 backdrop-blur-2xl flex items-center justify-center p-6 select-none">
                            <div className="max-w-md w-full bg-neutral-900/90 border border-neutral-800/80 rounded-2xl p-8 text-center shadow-2xl relative overflow-hidden">
                                ...
                                <div className="relative flex items-center justify-center mb-8 h-24">
                                    <div className="absolute w-20 h-20 rounded-full border border-brand-500/20 bg-brand-500/5 animate-ping opacity-60" />
                                    <div className="absolute w-16 h-16 rounded-full border border-brand-500/30 bg-brand-500/10 animate-pulse" />
                                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-brand-600 to-violet-600 text-white flex items-center justify-center shadow-lg relative z-20">
                                ...
                                <div className="space-y-4">
                                    <h2 className="text-xl font-bold text-neutral-100 tracking-tight">System Upgrade in Progress</h2>
                                    <p className="text-ink-muted text-xs leading-relaxed max-w-[320px] mx-auto">
                                        We are currently applying a live system update to your app. To prevent any data loss, <strong className="text-brand-400">please do not refresh, close the page, or perform any actions</strong> right now.
                                    </p>
                                    
                                    <div className="pt-3 border-t border-neutral-800/60 max-w-[280px] mx-auto">
                                    ...
                                    <div className="flex items-center justify-center gap-2 text-xs font-semibold text-ink-muted pt-4">
