...
export default function Welcome({ storeSlug, tenantName, onNext, onSelectMode }) {
 ...
 <div className="absolute top-1/2 -left-32 w-[350px] h-[350px] bg-brand-600/15 rounded-full blur-[120px] pointer-events-none" />
 ...
 className="group relative cursor-pointer p-6 bg-gradient-brand border border-brand-500/30 hover:border-brand-500/70 rounded-2xl transition-all duration-slower shadow-2xl flex flex-col justify-between overflow-hidden"
 >
 {/* Background Hero Image */}
 <div className="h-44 -mx-6 -mt-6 mb-4 overflow-hidden relative">
 <img
 ...
 <div className="space-y-3 relative z-10">
 <div className="flex items-center gap-3">
 <div className="p-2.5 bg-brand-500/10 border border-brand-500/30 rounded-2xl text-brand-400">
 <LayoutGrid size={28} />
 </div>
 <div>
 <h3 className="text-xl font-bold text-white group-hover:text-brand-300 transition-colors">
